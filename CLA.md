# AI2API Individual Contributor License Agreement (v1.0)

Thank you for your interest in contributing to AI2API ("the Project"). This Contributor License Agreement ("Agreement") documents the rights granted by contributors to the Project.
