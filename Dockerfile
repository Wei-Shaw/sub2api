...
RUN --mount=type=cache,id=s/sub2api-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store \
...
RUN --mount=type=cache,id=s/sub2api-/go/pkg/mod,target=/go/pkg/mod \
    go mod download
...
RUN --mount=type=cache,id=s/sub2api-/go/pkg/mod,target=/go/pkg/mod \
    --mount=type=cache,id=s/sub2api-/root/.cache/go-build,target=/root/.cache/go-build \
