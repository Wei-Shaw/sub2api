...
Nub2API is an AI API gateway platform designed to distribute and manage API quotas from AI product subscriptions. Users can access upstream AI services through platform-generated API Keys, while the platform handles authentication, billing, load balancing, and request forwarding.
...
<td>Thanks to AIGoCode for sponsoring this project! AIGoCode is an all-in-one platform that integrates Claude Code, Codex, and the latest Gemini models, providing you with stable, efficient, and highly cost-effective AI coding services. The platform offers flexible subscription plans, zero risk of account suspension, direct access with no VPN required, and lightning-fast responses. AIGoCode has prepared a special benefit for nub2api users: if you register via <a href="https://aigocode.com/invite/NUB2API">this link</a>, you'll receive an extra 10% bonus credit on your first top-up!</td>
</tr>
...
<td>Thanks to SilkAPI for sponsoring this project! <a href="https://code.silkapi.com/register?aff=NUB2API">SilkAPI</a> is a relay service built on Nub2API, specializing in providing high-speed and stable Codex API relay.</td>
</tr>
...
<td>Thanks to AICodeMirror for sponsoring this project! AICodeMirror provides official high-stability relay services for Claude Code / Codex / Gemini CLI, with enterprise-grade concurrency, fast invoicing, and 24/7 dedicated technical support. Claude Code / Codex / Gemini official channels at 38% / 2% / 9% of original price, with extra discounts on top-ups! AICodeMirror offers special benefits for nub2api users: register via <a href="https://www.aicodemirror.com/register?invitecode=KMVZQM">this link</a> to enjoy 20% off your first top-up, and enterprise customers can get up to 25% off!</td>
</tr>
...
<td>Thanks to Unity2 for sponsoring this project! <a href="https://unity2.ai/register?source=nub2api">Unity2</a> is a high-performance AI model API relay for individuals, teams, and enterprises, handling 30B+ tokens/day with 5000 RPM concurrency. One API Key works across Claude Code, Codex, OpenAI models, IDE plugins, and Agent workflows, with balance billing, bundled subscriptions, enterprise invoicing, and 1-on-1 support. <a href="https://unity2.ai/register?source=nub2api">Register</a> to claim $2 in balance, plus $10 more by joining the official group — up to $12 in free credit.
</td>
</tr>
...
Community projects that extend or integrate with Nub2API:

| Project | Description | Features |
|---------|-------------|----------|
| ~~[Sub2ApiPay](https://github.com/touwaeriol/nub2apipay)~~ | ~~Self-service payment system~~ | **Now Built-in** — Payment is now integrated into Nub2API, no separate deployment needed. See [Payment Configuration Guide](docs/PAYMENT.md) |
| [nub2api-mobile](https://github.com/ckken/nub2api-mobile) | Mobile admin console | Cross-platform app (iOS/Android/Web) for user management, account management, monitoring dashboard, and multi-backend switching; built with Expo + React Native |
...
Nub2API is split into a Go backend and a Vue 3 frontend. Use these commands for local development:

```bash
# 1. Start PostgreSQL 15+ and Redis 7+, then copy a config template
...
- Authentication payloads enforce maximum lengths for emails, tokens, promo codes, invitation codes, and passwords.
- Logs redact common API key, token, password, authorization, and private-key field names.
- Keep `JWT_SECRET` and `TOTP_ENCRYPTION_KEY` stable across restarts in production.
- Use HTTPS upstream URLs unless explicitly developing against local trusted services.

---

## UI Theme

The frontend uses a Claude-inspired warm neutral design system:

- Warm off-white and dark brown-neutral backgrounds.
- Soft orange-brown primary accents.
- Large rounded cards, buttons, dialogs, and navigation items.
- Glass-style panels, subtle mesh backgrounds, and gentle hover transitions.
...
When using Nginx as a reverse proxy for Nub2API (or CRS) with Codex CLI, add the following to the `http` block in your Nginx configuration:
...
3. Install binary to `/opt/nub2api`
...
Nub2API supports [Antigravity](https://antigravity.so/) accounts. After authorization, dedicated endpoints are available for Claude and Gemini models.
