...
| [sub2api-skills](https://github.com/deltrivx/sub2api-skills) | Assistant skill, Telegram operations bot, and Docker sidecar templates | Community integration for account, group, token, config, diagnostics, account import, and confirmation-protected host or Docker maintenance workflows. See [integration notes](docs/community/sub2api-skills.md) |
