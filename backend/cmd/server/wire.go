...
func provideCleanup(
	...
	upstreamReconciliation *service.UpstreamReconciliationService,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"UpstreamReconciliationService", func() error {
				if upstreamReconciliation != nil {
					upstreamReconciliation.Stop()
				}
				return nil
			}},
