...
func provideCleanup(
	...
	upstreamStationService *upstreamstation.Service,
) func() {
	return func() {
		...
		parallelSteps := []cleanupStep{
			{"UpstreamStationService", func() error {
				if upstreamStationService != nil {
					upstreamStationService.Stop()
				}
				return nil
			}},
