...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	codexGoalBridgeService := service.NewCodexGoalBridgeService(accountRepository, configConfig)
	...
	codexGoalBridgeHandler := handler.NewCodexGoalBridgeHandler(codexGoalBridgeService, gatewayService, apiKeyService, usageRecordWorkerPool)
