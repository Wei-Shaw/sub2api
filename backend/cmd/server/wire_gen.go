...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	chatSessionHandler := handler.NewChatSessionHandler(client)
	...
	imageTaskService := service.ProvideImageTaskService(imageTaskRepository, timingWheelService)
	...
	openAIGatewayHandler := handler.NewOpenAIGatewayHandler(openAIGatewayService, imageTaskService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, configConfig)
