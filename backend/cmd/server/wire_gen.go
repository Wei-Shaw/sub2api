...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	defaultProxyGroupResolver := service.NewDefaultProxyGroupResolver(proxyGroupRepository, proxyRepository)
	...
	grokQuotaService := service.ProvideGrokQuotaService(accountRepository, proxyRepository, grokTokenProvider, httpUpstream, configConfig, usageLogRepository, openAIGatewayService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, compositeRouteResolver, redisClient, connectionSignalEmitter)
