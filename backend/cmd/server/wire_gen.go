...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountBatchTestTaskRepository := repository.NewAccountBatchTestTaskRepository(db)
	accountBatchTestResultRepository := repository.NewAccountBatchTestResultRepository(db)
	accountHealthCheckRepository := repository.NewAccountHealthCheckRepository(client, db)
	accountHealthCheckService := service.NewAccountHealthCheckService(accountBatchTestTaskRepository, accountBatchTestResultRepository, accountHealthCheckRepository, accountTestService)
	accountHealthCheckHandler := admin.NewAccountHealthCheckHandler(accountHealthCheckService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, accountHealthCheckHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, paymentHandler, affiliateHandler)
	...
	accountHealthCheckRunnerService := service.ProvideAccountHealthCheckRunnerService(accountHealthCheckService, configConfig)
	paymentOrderExpiryService := service.ProvidePaymentOrderExpiryService(paymentService)
	channelMonitorRunner := service.ProvideChannelMonitorRunner(channelMonitorService, settingService)
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, schedulerSnapshotService, tokenRefreshService, accountExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, openAIGatewayService, scheduledTestRunnerService, accountHealthCheckRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner)
