...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	codexIdentityTemplateRepository := repository.NewCodexIdentityTemplateRepository(db, accountRepository, schedulerCache)
	codexIdentityTemplateService := service.NewCodexIdentityTemplateService(codexIdentityTemplateRepository, proxyRepository)
	codexIdentityTemplateHandler := admin.NewCodexIdentityTemplateHandler(codexIdentityTemplateService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, codexIdentityTemplateHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
