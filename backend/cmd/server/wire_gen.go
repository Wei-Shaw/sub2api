...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	redeemService := service.NewRedeemService(redeemCodeRepository, userRepository, subscriptionService, affiliateService, redeemCache, billingCacheService, client, apiKeyAuthCacheInvalidator)
	...
	imageGenerationHandler := handler.NewImageGenerationHandler(apiKeyService, gatewayService)
