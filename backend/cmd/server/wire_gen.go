...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	notificationEmailDeliveryWorker := service.ProvideNotificationEmailDeliveryWorker(notificationEmailDeliveryRepository, notificationEmailService)
	...
	contentModerationService := service.ProvideContentModerationService(settingRepository, contentModerationRepository, contentModerationHashCache, groupRepository, userRepository, apiKeyAuthCacheInvalidator, emailService, notificationEmailDispatcher)
