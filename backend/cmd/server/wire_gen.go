...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	// Gateway Pipeline (Phase 1 M4): registry + pipeline wired for future handler switchover.
	providerRegistry := gateway.ProvideProviderRegistry(gatewayService, openAIGatewayService, antigravityGatewayService)
	_ = gateway.ProvideGatewayPipeline(providerRegistry, gatewayService, billingCacheService, concurrencyService, settingService, configConfig)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, serviceQuotaHandler, serviceQuotaMonitorHandler, affiliateHandler, pluginHandler, pluginSettingsHandler, adminUploadHandler)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, userServiceQuotaHandler, uploadHandler, idempotencyCoordinator, idempotencyCleanupService)
