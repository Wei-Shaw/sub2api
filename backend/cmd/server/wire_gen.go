...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	upstreamReconciliationService := service.ProvideUpstreamReconciliationService(db, secretEncryptor, configConfig)
	upstreamReconciliationHandler := handler.NewUpstreamReconciliationHandler(upstreamReconciliationService)
