...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	proxyHealthService := service.NewProxyHealthService(configConfig, proxyRepository, proxyGroupRepository, proxyExitInfoProber, proxyHealthCache, proxyLatencyCache, defaultProxyGroupResolver, proxyHealthMetrics)
	...
	warpSyncWorker := service.ProvideWarpSyncWorker(configConfig, warpSyncService)
