...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	extraConcurrencySettingsNotifier := repository.NewExtraConcurrencySettingsNotifier(redisClient)
	settingService := service.ProvideSettingService(settingRepository, groupRepository, proxyRepository, extraConcurrencySettingsNotifier, configConfig)
	...
	gatewayAdmission := service.ProvideGatewayAdmission(gatewayAdmissionStore, gatewayService, settingService)
