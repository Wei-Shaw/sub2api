...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	modelEvaluationService := service.NewModelEvaluationService(accountRepository, groupRepository, openAIGatewayService, concurrencyService)
	modelEvaluationRepository := repository.NewModelEvaluationRepository(db)
	modelEvaluationHistoryService := service.NewModelEvaluationHistoryService(modelEvaluationService, modelEvaluationRepository)
	modelEvaluationHandler := admin.NewModelEvaluationHandler(modelEvaluationHistoryService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, proxyGroupHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, modelEvaluationHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, checkInHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService, openCodeGoUsageService)
