...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	apiKeyCredentialRotator := service.ProvideAPIKeyCredentialRotator(apiKeyService)
	adminService := service.NewAdminService(userRepository, adminGroupRepository, adminAccountRepository, proxyRepository, apiKeyRepository, redeemCodeRepository, userGroupRateRepository, userRPMCache, billingCacheService, proxyExitInfoProber, proxyLatencyCache, apiKeyAuthCacheInvalidator, apiKeyCredentialRotator, client, settingService, subscriptionService, userSubscriptionRepository, privacyClientFactory, openAIGatewayService, affiliateService, compositeModelRouteRepository, compositeRouteResolver, channelService)
