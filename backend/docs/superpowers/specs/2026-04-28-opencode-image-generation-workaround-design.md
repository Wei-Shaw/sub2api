...
```json
{
  ...
  "name": "bash",
  "arguments": "{\"command\":\"echo \\\"sub2api generated image is ready; use the preceding Download URL if you need the file, and continue the user's original request\\\"\",\"description\":\"Reports generated image availability\"}"
}
```
