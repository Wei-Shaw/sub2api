...
type Account struct {
	...
	Credentials map[string]interface{REDACTED `json:"credentials,omitempty"`
	// Extra holds the value of the "extra" field.
	Extra map[string]interface{REDACTED `json:"extra,omitempty"`
...
func (e AccountEdges) GroupsOrErr() ([]*Group, error) {
	if e.loadedTypes[0] {
		return e.Groups, nil
REDACTED
	return nil, &NotLoadedError{edge: "groups"REDACTED
REDACTED
...
REDACTED else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: proxy.LabelREDACTED
REDACTED
	return nil, &NotLoadedError{edge: "proxy"REDACTED
REDACTED
...
REDACTED
	return nil, &NotLoadedError{edge: "parent"REDACTED
REDACTED
...
REDACTED
	return nil, &NotLoadedError{edge: "children"REDACTED
REDACTED
...
REDACTED
	return nil, &NotLoadedError{edge: "account_groups"REDACTED
REDACTED
