...
var (
	...
	GroupsPrimaryKey = []string{"account_id", "group_id"REDACTED
)
...
var (
	...
	DefaultCredentials func() map[string]interface{REDACTED
	// DefaultExtra holds the default value on creation for the "extra" field.
	DefaultExtra func() map[string]interface{REDACTED
...
func ByGroups(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newGroupsStep(), append([]sql.OrderTerm{termREDACTED, terms...)...)
REDACTED
REDACTED
...
func ByChildren(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newChildrenStep(), append([]sql.OrderTerm{termREDACTED, terms...)...)
REDACTED
REDACTED
