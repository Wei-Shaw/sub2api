...
func (_u *AccountUpdate) SetCredentials(v map[string]interface{REDACTED) *AccountUpdate {
	_u.mutation.SetCredentials(v)
	return _u
REDACTED

// SetExtra sets the "extra" field.
func (_u *AccountUpdate) SetExtra(v map[string]interface{REDACTED) *AccountUpdate {
...
// SetCredentials sets the "credentials" field.
func (_u *AccountUpdateOne) SetCredentials(v map[string]interface{REDACTED) *AccountUpdateOne {
	_u.mutation.SetCredentials(v)
	return _u
REDACTED

// SetExtra sets the "extra" field.
func (_u *AccountUpdateOne) SetExtra(v map[string]interface{REDACTED) *AccountUpdateOne {
	_u.mutation.SetExtra(v)
	return _u
REDACTED
...
REDACTED
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "Account.id" for update`)REDACTED
REDACTED
...
REDACTED
	...
	REDACTED
		_spec.Edges.Add = append(_spec.Edges.Add, edge)
REDACTED
	_node = &Account{config: _u.configREDACTED
