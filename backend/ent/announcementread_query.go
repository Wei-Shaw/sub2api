...
func (_q *AnnouncementReadQuery) QueryAnnouncement() *AnnouncementQuery {
	query := (&AnnouncementClient{config: _q.configREDACTED).Query()
...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{announcementread.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	if len(ids) == 0 {
		err = &NotFoundError{announcementread.LabelREDACTED
		return
REDACTED
	return ids[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{announcementread.LabelREDACTED
	default:
		return nil, &NotSingularError{announcementread.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{announcementread.LabelREDACTED
	default:
		err = &NotSingularError{announcementread.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &AnnouncementReadQuery{
		config:           _q.config,
		ctx:              _q.ctx.Clone(),
		order:            append([]announcementread.OrderOption{REDACTED, _q.order...),
		inters:           append([]Interceptor{REDACTED, _q.inters...),
		predicates:       append([]predicate.AnnouncementRead{REDACTED, _q.predicates...),
...
func (_q *AnnouncementReadQuery) GroupBy(field string, fields ...string) *AnnouncementReadGroupBy {
	...
	grbuild := &AnnouncementReadGroupBy{build: _qREDACTED
...
func (_q *AnnouncementReadQuery) Select(fields ...string) *AnnouncementReadSelect {
	...
	sbuild := &AnnouncementReadSelect{AnnouncementReadQuery: _qREDACTED
...
func (_q *AnnouncementReadQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AnnouncementRead, error) {
	var (
		nodes       = []*AnnouncementRead{REDACTED
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &AnnouncementRead{config: _q.configREDACTED
...
REDACTED
	if query := _q.withAnnouncement; query != nil {
		if err := _q.loadAnnouncement(ctx, query, nodes, nil,
			func(n *AnnouncementRead, e *Announcement) { n.Edges.Announcement = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *AnnouncementRead, e *User) { n.Edges.User = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	return nodes, nil
