...
type AuthIdentity struct {
	...
	Metadata map[string]interface{REDACTED `json:"metadata,omitempty"`
...
REDACTED
	return nil, &NotLoadedError{edge: "channels"REDACTED
REDACTED
...
REDACTED
	return nil, &NotLoadedError{edge: "adoption_decisions"REDACTED
REDACTED
