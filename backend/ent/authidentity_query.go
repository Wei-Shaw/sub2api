...
func (_q *AuthIdentityQuery) QueryChannels() *AuthIdentityChannelQuery {
	query := (&AuthIdentityChannelClient{config: _q.configREDACTED).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	REDACTED
...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{authidentity.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{authidentity.LabelREDACTED
	default:
		return nil, &NotSingularError{authidentity.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{authidentity.LabelREDACTED
	default:
		err = &NotSingularError{authidentity.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &AuthIdentityQuery{
		config:                _q.config,
		ctx:                   _q.ctx.Clone(),
		order:                 append([]authidentity.OrderOption{REDACTED, _q.order...),
		inters:                append([]Interceptor{REDACTED, _q.inters...),
		predicates:            append([]predicate.AuthIdentity{REDACTED, _q.predicates...),
...
func (_q *AuthIdentityQuery) GroupBy(field string, fields ...string) *AuthIdentityGroupBy {
	...
	grbuild := &AuthIdentityGroupBy{build: _qREDACTED
...
func (_q *AuthIdentityQuery) Select(fields ...string) *AuthIdentitySelect {
	...
	sbuild := &AuthIdentitySelect{AuthIdentityQuery: _qREDACTED
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &AuthIdentity{config: _q.configREDACTED
...
REDACTED
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *AuthIdentity, e *User) { n.Edges.User = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	if query := _q.withChannels; query != nil {
		if err := _q.loadChannels(ctx, query, nodes,
			func(n *AuthIdentity) { n.Edges.Channels = []*AuthIdentityChannel{REDACTED REDACTED,
			func(n *AuthIdentity, e *AuthIdentityChannel) { n.Edges.Channels = append(n.Edges.Channels, e) REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	if query := _q.withAdoptionDecisions; query != nil {
		if err := _q.loadAdoptionDecisions(ctx, query, nodes,
			func(n *AuthIdentity) { n.Edges.AdoptionDecisions = []*IdentityAdoptionDecision{REDACTED REDACTED,
