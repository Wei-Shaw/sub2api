...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{authidentitychannel.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{authidentitychannel.LabelREDACTED
	default:
		return nil, &NotSingularError{authidentitychannel.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{authidentitychannel.LabelREDACTED
	default:
		err = &NotSingularError{authidentitychannel.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &AuthIdentityChannelQuery{
		config:       _q.config,
		ctx:          _q.ctx.Clone(),
		order:        append([]authidentitychannel.OrderOption{REDACTED, _q.order...),
		inters:       append([]Interceptor{REDACTED, _q.inters...),
		predicates:   append([]predicate.AuthIdentityChannel{REDACTED, _q.predicates...),
...
func (_q *AuthIdentityChannelQuery) GroupBy(field string, fields ...string) *AuthIdentityChannelGroupBy {
	...
	grbuild := &AuthIdentityChannelGroupBy{build: _qREDACTED
...
func (_q *AuthIdentityChannelQuery) Select(fields ...string) *AuthIdentityChannelSelect {
	...
	sbuild := &AuthIdentityChannelSelect{AuthIdentityChannelQuery: _qREDACTED
...
func (_q *AuthIdentityChannelQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AuthIdentityChannel, error) {
	var (
		nodes       = []*AuthIdentityChannel{REDACTED
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
			_q.withIdentity != nil,
	REDACTED
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &AuthIdentityChannel{config: _q.configREDACTED
...
REDACTED
	if query := _q.withIdentity; query != nil {
		if err := _q.loadIdentity(ctx, query, nodes, nil,
			func(n *AuthIdentityChannel, e *AuthIdentity) { n.Edges.Identity = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	return nodes, nil
