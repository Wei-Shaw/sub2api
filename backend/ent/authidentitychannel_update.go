...
func (_u *AuthIdentityChannelUpdate) SetMetadata(v map[string]interface{REDACTED) *AuthIdentityChannelUpdate {
...
REDACTED
	if _node, err = sqlgraph.UpdateNodes(ctx, _u.driver, _spec); err != nil {
		if _, ok := err.(*sqlgraph.NotFoundError); ok {
			err = &NotFoundError{authidentitychannel.LabelREDACTED
...
// SetMetadata sets the "metadata" field.
func (_u *AuthIdentityChannelUpdateOne) SetMetadata(v map[string]interface{REDACTED) *AuthIdentityChannelUpdateOne {
	_u.mutation.SetMetadata(v)
	return _u
REDACTED
...
REDACTED
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "AuthIdentityChannel.id" for update`)REDACTED
REDACTED
...
REDACTED
	...
	REDACTED
		_spec.Edges.Add = append(_spec.Edges.Add, edge)
REDACTED
	_node = &AuthIdentityChannel{config: _u.configREDACTED
