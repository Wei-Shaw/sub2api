...
func (_c *BatchImageEventCreate) SetPayload(v map[string]interface{REDACTED) *BatchImageEventCreate {
...
func (_c *BatchImageEventCreate) check() error {
	if _, ok := _c.mutation.JobID(); !ok {
		return &ValidationError{Name: "job_id", err: errors.New(`ent: missing required field "BatchImageEvent.job_id"`)REDACTED
REDACTED
...
REDACTED
	if _, ok := _c.mutation.EventType(); !ok {
		return &ValidationError{Name: "event_type", err: errors.New(`ent: missing required field "BatchImageEvent.event_type"`)REDACTED
REDACTED
...
REDACTED
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "BatchImageEvent.created_at"`)REDACTED
REDACTED
	return nil
REDACTED
...
func (_c *BatchImageEventCreate) createSpec() (*BatchImageEvent, *sqlgraph.CreateSpec) {
	var (
		_node = &BatchImageEvent{config: _c.configREDACTED
...
// SetPayload sets the "payload" field.
func (u *BatchImageEventUpsert) SetPayload(v map[string]interface{REDACTED) *BatchImageEventUpsert {
...
func (u *BatchImageEventUpsertOne) Update(set func(*BatchImageEventUpsert)) *BatchImageEventUpsertOne {
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(update *sql.UpdateSet) {
		set(&BatchImageEventUpsert{UpdateSet: updateREDACTED)
REDACTED))
	return u
REDACTED
...
// SetPayload sets the "payload" field.
func (u *BatchImageEventUpsertOne) SetPayload(v map[string]interface{REDACTED) *BatchImageEventUpsertOne {
	return u.Update(func(s *BatchImageEventUpsert) {
		s.SetPayload(v)
REDACTED)
REDACTED
...
// SetPayload sets the "payload" field.
func (u *BatchImageEventUpsertBulk) SetPayload(v map[string]interface{REDACTED) *BatchImageEventUpsertBulk {
	return u.Update(func(s *BatchImageEventUpsert) {
		s.SetPayload(v)
REDACTED)
REDACTED
