...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{batchimageevent.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{batchimageevent.LabelREDACTED
	default:
		return nil, &NotSingularError{batchimageevent.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{batchimageevent.LabelREDACTED
	default:
		err = &NotSingularError{batchimageevent.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &BatchImageEventQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]batchimageevent.OrderOption{REDACTED, _q.order...),
		inters:     append([]Interceptor{REDACTED, _q.inters...),
		predicates: append([]predicate.BatchImageEvent{REDACTED, _q.predicates...),
...
func (_q *BatchImageEventQuery) GroupBy(field string, fields ...string) *BatchImageEventGroupBy {
	...
	grbuild := &BatchImageEventGroupBy{build: _qREDACTED
...
func (_q *BatchImageEventQuery) Select(fields ...string) *BatchImageEventSelect {
	...
	sbuild := &BatchImageEventSelect{BatchImageEventQuery: _qREDACTED
...
func (_q *BatchImageEventQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*BatchImageEvent, error) {
	var (
		nodes = []*BatchImageEvent{REDACTED
		_spec = _q.querySpec()
	)
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &BatchImageEvent{config: _q.configREDACTED
