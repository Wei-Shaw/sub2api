...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{batchimagejob.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{batchimagejob.LabelREDACTED
	default:
		return nil, &NotSingularError{batchimagejob.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{batchimagejob.LabelREDACTED
	default:
		err = &NotSingularError{batchimagejob.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &BatchImageJobQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]batchimagejob.OrderOption{REDACTED, _q.order...),
		inters:     append([]Interceptor{REDACTED, _q.inters...),
		predicates: append([]predicate.BatchImageJob{REDACTED, _q.predicates...),
...
func (_q *BatchImageJobQuery) GroupBy(field string, fields ...string) *BatchImageJobGroupBy {
	...
	grbuild := &BatchImageJobGroupBy{build: _qREDACTED
...
func (_q *BatchImageJobQuery) Select(fields ...string) *BatchImageJobSelect {
	...
	sbuild := &BatchImageJobSelect{BatchImageJobQuery: _qREDACTED
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &BatchImageJob{config: _q.configREDACTED
