...
type ChannelMonitor struct {
	...
	BodyOverride map[string]interface{REDACTED `json:"body_override,omitempty"`
...
REDACTED
	return nil, &NotLoadedError{edge: "history"REDACTED
REDACTED
...
REDACTED
	return nil, &NotLoadedError{edge: "daily_rollups"REDACTED
REDACTED
...
REDACTED else if e.loadedTypes[2] {
		return nil, &NotFoundError{label: channelmonitorrequesttemplate.LabelREDACTED
REDACTED
	return nil, &NotLoadedError{edge: "request_template"REDACTED
REDACTED
