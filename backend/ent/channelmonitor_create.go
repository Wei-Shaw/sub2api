...
func (_c *ChannelMonitorCreate) SetBodyOverride(v map[string]interface{REDACTED) *ChannelMonitorCreate {
...
func (_c *ChannelMonitorCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "ChannelMonitor.created_at"`)REDACTED
REDACTED
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "ChannelMonitor.updated_at"`)REDACTED
REDACTED
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "ChannelMonitor.name"`)REDACTED
REDACTED
	if v, ok := _c.mutation.Name(); ok {
		if err := channelmonitor.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`ent: validator failed for field "ChannelMonitor.name": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.Provider(); !ok {
		return &ValidationError{Name: "provider", err: errors.New(`ent: missing required field "ChannelMonitor.provider"`)REDACTED
REDACTED
...
REDACTED
	if _, ok := _c.mutation.CheckMode(); !ok {
		return &ValidationError{Name: "check_mode", err: errors.New(`ent: missing required field "ChannelMonitor.check_mode"`)REDACTED
REDACTED
	if v, ok := _c.mutation.CheckMode(); ok {
		if err := channelmonitor.CheckModeValidator(v); err != nil {
			return &ValidationError{Name: "check_mode", err: fmt.Errorf(`ent: validator failed for field "ChannelMonitor.check_mode": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.APIMode(); !ok {
...
REDACTED
	if _, ok := _c.mutation.Endpoint(); !ok {
		return &ValidationError{Name: "endpoint", err: errors.New(`ent: missing required field "ChannelMonitor.endpoint"`)REDACTED
REDACTED
...
REDACTED
	if _, ok := _c.mutation.APIKeyEncrypted(); !ok {
		return &ValidationError{Name: "api_key_encrypted", err: errors.New(`ent: missing required field "ChannelMonitor.api_key_encrypted"`)REDACTED
REDACTED
	if v, ok := _c.mutation.APIKeyEncrypted(); ok {
		if err := channelmonitor.APIKeyEncryptedValidator(v); err != nil {
			return &ValidationError{Name: "api_key_encrypted", err: fmt.Errorf(`ent: validator failed for field "ChannelMonitor.api_key_encrypted": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.PrimaryModel(); !ok {
		return &ValidationError{Name: "primary_model", err: errors.New(`ent: missing required field "ChannelMonitor.primary_model"`)REDACTED
REDACTED
	if v, ok := _c.mutation.PrimaryModel(); ok {
		if err := channelmonitor.PrimaryModelValidator(v); err != nil {
			return &ValidationError{Name: "primary_model", err: fmt.Errorf(`ent: validator failed for field "ChannelMonitor.primary_model": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.ExtraModels(); !ok {
		return &ValidationError{Name: "extra_models", err: errors.New(`ent: missing required field "ChannelMonitor.extra_models"`)REDACTED
REDACTED
	if v, ok := _c.mutation.GroupName(); ok {
		if err := channelmonitor.GroupNameValidator(v); err != nil {
			return &ValidationError{Name: "group_name", err: fmt.Errorf(`ent: validator failed for field "ChannelMonitor.group_name": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.Enabled(); !ok {
		return &ValidationError{Name: "enabled", err: errors.New(`ent: missing required field "ChannelMonitor.enabled"`)REDACTED
REDACTED
	if _, ok := _c.mutation.IntervalSeconds(); !ok {
		return &ValidationError{Name: "interval_seconds", err: errors.New(`ent: missing required field "ChannelMonitor.interval_seconds"`)REDACTED
REDACTED
	if v, ok := _c.mutation.IntervalSeconds(); ok {
		if err := channelmonitor.IntervalSecondsValidator(v); err != nil {
			return &ValidationError{Name: "interval_seconds", err: fmt.Errorf(`ent: validator failed for field "ChannelMonitor.interval_seconds": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.JitterSeconds(); !ok {
		return &ValidationError{Name: "jitter_seconds", err: errors.New(`ent: missing required field "ChannelMonitor.jitter_seconds"`)REDACTED
REDACTED
	if v, ok := _c.mutation.JitterSeconds(); ok {
		if err := channelmonitor.JitterSecondsValidator(v); err != nil {
			return &ValidationError{Name: "jitter_seconds", err: fmt.Errorf(`ent: validator failed for field "ChannelMonitor.jitter_seconds": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.CreatedBy(); !ok {
		return &ValidationError{Name: "created_by", err: errors.New(`ent: missing required field "ChannelMonitor.created_by"`)REDACTED
REDACTED
	if _, ok := _c.mutation.ExtraHeaders(); !ok {
		return &ValidationError{Name: "extra_headers", err: errors.New(`ent: missing required field "ChannelMonitor.extra_headers"`)REDACTED
REDACTED
	if _, ok := _c.mutation.BodyOverrideMode(); !ok {
		return &ValidationError{Name: "body_override_mode", err: errors.New(`ent: missing required field "ChannelMonitor.body_override_mode"`)REDACTED
REDACTED
	if v, ok := _c.mutation.BodyOverrideMode(); ok {
		if err := channelmonitor.BodyOverrideModeValidator(v); err != nil {
			return &ValidationError{Name: "body_override_mode", err: fmt.Errorf(`ent: validator failed for field "ChannelMonitor.body_override_mode": %w`, err)REDACTED
	REDACTED
REDACTED
	return nil
REDACTED
...
func (_c *ChannelMonitorCreate) createSpec() (*ChannelMonitor, *sqlgraph.CreateSpec) {
	var (
		_node = &ChannelMonitor{config: _c.configREDACTED
...
REDACTED
	if nodes := _c.mutation.HistoryIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{channelmonitor.HistoryColumnREDACTED,
			Bidi:    false,
...
REDACTED
	if nodes := _c.mutation.DailyRollupsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{channelmonitor.DailyRollupsColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
REDACTED
	if nodes := _c.mutation.RequestTemplateIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{channelmonitor.RequestTemplateColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetBodyOverride sets the "body_override" field.
func (u *ChannelMonitorUpsert) SetBodyOverride(v map[string]interface{REDACTED) *ChannelMonitorUpsert {
...
func (u *ChannelMonitorUpsertOne) Update(set func(*ChannelMonitorUpsert)) *ChannelMonitorUpsertOne {
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(update *sql.UpdateSet) {
		set(&ChannelMonitorUpsert{UpdateSet: updateREDACTED)
REDACTED))
	return u
REDACTED
...
// SetBodyOverride sets the "body_override" field.
func (u *ChannelMonitorUpsertOne) SetBodyOverride(v map[string]interface{REDACTED) *ChannelMonitorUpsertOne {
	return u.Update(func(s *ChannelMonitorUpsert) {
		s.SetBodyOverride(v)
REDACTED)
REDACTED
...
// SetBodyOverride sets the "body_override" field.
func (u *ChannelMonitorUpsertBulk) SetBodyOverride(v map[string]interface{REDACTED) *ChannelMonitorUpsertBulk {
	return u.Update(func(s *ChannelMonitorUpsert) {
		s.SetBodyOverride(v)
REDACTED)
REDACTED
