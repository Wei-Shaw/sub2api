...
func (_q *ChannelMonitorQuery) QueryHistory() *ChannelMonitorHistoryQuery {
	query := (&ChannelMonitorHistoryClient{config: _q.configREDACTED).Query()
...
func (_q *ChannelMonitorQuery) QueryRequestTemplate() *ChannelMonitorRequestTemplateQuery {
	query := (&ChannelMonitorRequestTemplateClient{config: _q.configREDACTED).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	REDACTED
...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{channelmonitor.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{channelmonitor.LabelREDACTED
	default:
		return nil, &NotSingularError{channelmonitor.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{channelmonitor.LabelREDACTED
	default:
		err = &NotSingularError{channelmonitor.LabelREDACTED
REDACTED
	return
REDACTED
...
func (_q *ChannelMonitorQuery) GroupBy(field string, fields ...string) *ChannelMonitorGroupBy {
	...
	grbuild := &ChannelMonitorGroupBy{build: _qREDACTED
...
func (_q *ChannelMonitorQuery) Select(fields ...string) *ChannelMonitorSelect {
	...
	sbuild := &ChannelMonitorSelect{ChannelMonitorQuery: _qREDACTED
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &ChannelMonitor{config: _q.configREDACTED
...
REDACTED
	if query := _q.withHistory; query != nil {
		if err := _q.loadHistory(ctx, query, nodes,
			func(n *ChannelMonitor) { n.Edges.History = []*ChannelMonitorHistory{REDACTED REDACTED,
			func(n *ChannelMonitor, e *ChannelMonitorHistory) { n.Edges.History = append(n.Edges.History, e) REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
...
REDACTED
	if query := _q.withRequestTemplate; query != nil {
		if err := _q.loadRequestTemplate(ctx, query, nodes, nil,
			func(n *ChannelMonitor, e *ChannelMonitorRequestTemplate) { n.Edges.RequestTemplate = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	return nodes, nil
