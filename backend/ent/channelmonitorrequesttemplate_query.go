...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{channelmonitorrequesttemplate.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{channelmonitorrequesttemplate.LabelREDACTED
	default:
		return nil, &NotSingularError{channelmonitorrequesttemplate.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{channelmonitorrequesttemplate.LabelREDACTED
	default:
		err = &NotSingularError{channelmonitorrequesttemplate.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &ChannelMonitorRequestTemplateQuery{
		config:       _q.config,
		ctx:          _q.ctx.Clone(),
		order:        append([]channelmonitorrequesttemplate.OrderOption{REDACTED, _q.order...),
		inters:       append([]Interceptor{REDACTED, _q.inters...),
		predicates:   append([]predicate.ChannelMonitorRequestTemplate{REDACTED, _q.predicates...),
...
func (_q *ChannelMonitorRequestTemplateQuery) GroupBy(field string, fields ...string) *ChannelMonitorRequestTemplateGroupBy {
	...
	grbuild := &ChannelMonitorRequestTemplateGroupBy{build: _qREDACTED
...
func (_q *ChannelMonitorRequestTemplateQuery) Select(fields ...string) *ChannelMonitorRequestTemplateSelect {
	...
	sbuild := &ChannelMonitorRequestTemplateSelect{ChannelMonitorRequestTemplateQuery: _qREDACTED
...
func (_q *ChannelMonitorRequestTemplateQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ChannelMonitorRequestTemplate, error) {
	var (
		nodes       = []*ChannelMonitorRequestTemplate{REDACTED
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
			_q.withMonitors != nil,
	REDACTED
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &ChannelMonitorRequestTemplate{config: _q.configREDACTED
...
REDACTED
	if query := _q.withMonitors; query != nil {
		if err := _q.loadMonitors(ctx, query, nodes,
			func(n *ChannelMonitorRequestTemplate) { n.Edges.Monitors = []*ChannelMonitor{REDACTED REDACTED,
