...
func (_u *ChannelMonitorRequestTemplateUpdate) SetBodyOverride(v map[string]interface{REDACTED) *ChannelMonitorRequestTemplateUpdate {
...
REDACTED
	if _node, err = sqlgraph.UpdateNodes(ctx, _u.driver, _spec); err != nil {
		if _, ok := err.(*sqlgraph.NotFoundError); ok {
			err = &NotFoundError{channelmonitorrequesttemplate.LabelREDACTED
...
// SetBodyOverride sets the "body_override" field.
func (_u *ChannelMonitorRequestTemplateUpdateOne) SetBodyOverride(v map[string]interface{REDACTED) *ChannelMonitorRequestTemplateUpdateOne {
	_u.mutation.SetBodyOverride(v)
	return _u
REDACTED
...
REDACTED
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "ChannelMonitorRequestTemplate.id" for update`)REDACTED
REDACTED
...
REDACTED
	...
	REDACTED
		_spec.Edges.Add = append(_spec.Edges.Add, edge)
REDACTED
	_node = &ChannelMonitorRequestTemplate{config: _u.configREDACTED
