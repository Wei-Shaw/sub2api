...
func NewClient(opts ...Option) *Client {
	client := &Client{config: newConfig(opts...)REDACTED
	client.init()
	return client
REDACTED
...
func newConfig(opts ...Option) config {
	cfg := config{log: log.Println, hooks: &hooks{REDACTED, inters: &inters{REDACTEDREDACTED
	cfg.options(opts...)
	return cfg
REDACTED
...
REDACTED
	...
	client := &Client{config: cfgREDACTED
	client.init()
	return client
REDACTED
...
func NewAPIKeyClient(c config) *APIKeyClient {
	return &APIKeyClient{config: cREDACTED
REDACTED
...
func (c *APIKeyClient) Create() *APIKeyCreate {
	...
	return &APIKeyCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *APIKeyClient) CreateBulk(builders ...*APIKeyCreate) *APIKeyCreateBulk {
	return &APIKeyCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *APIKeyClient) MapCreateBulk(slice any, setFunc func(*APIKeyCreate, int)) *APIKeyCreateBulk {
	...
	if rv.Kind() != reflect.Slice {
		return &APIKeyCreateBulk{err: fmt.Errorf("calling to APIKeyClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *APIKeyClient) Update() *APIKeyUpdate {
	...
	return &APIKeyUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *APIKeyClient) UpdateOne(_m *APIKey) *APIKeyUpdateOne {
	...
	return &APIKeyUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *APIKeyClient) Delete() *APIKeyDelete {
	...
	return &APIKeyDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *APIKeyClient) DeleteOneID(id int64) *APIKeyDeleteOne {
	...
	return &APIKeyDeleteOne{builderREDACTED
REDACTED
...
func (c *APIKeyClient) Query() *APIKeyQuery {
	return &APIKeyQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAPIKeyREDACTED,
...
func (c *APIKeyClient) QueryGroup(_m *APIKey) *GroupQuery {
	query := (&GroupClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(apikey.Table, apikey.FieldID, id),
...
func (c *APIKeyClient) QueryUsageLogs(_m *APIKey) *UsageLogQuery {
	query := (&UsageLogClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(apikey.Table, apikey.FieldID, id),
...
func (c *APIKeyClient) mutate(ctx context.Context, m *APIKeyMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&APIKeyCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&APIKeyUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&APIKeyUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&APIKeyDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewAccountClient(c config) *AccountClient {
	return &AccountClient{config: cREDACTED
REDACTED
...
func (c *AccountClient) Create() *AccountCreate {
	...
	return &AccountCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED

// CreateBulk returns a builder for creating a bulk of Account entities.
func (c *AccountClient) CreateBulk(builders ...*AccountCreate) *AccountCreateBulk {
	return &AccountCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *AccountClient) MapCreateBulk(slice any, setFunc func(*AccountCreate, int)) *AccountCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AccountCreateBulk{err: fmt.Errorf("calling to AccountClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *AccountClient) Update() *AccountUpdate {
	...
	return &AccountUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AccountClient) UpdateOne(_m *Account) *AccountUpdateOne {
	...
	return &AccountUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AccountClient) Delete() *AccountDelete {
	...
	return &AccountDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AccountClient) DeleteOneID(id int64) *AccountDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AccountDeleteOne{builderREDACTED
REDACTED
...
func (c *AccountClient) Query() *AccountQuery {
	return &AccountQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAccountREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *AccountClient) QueryProxy(_m *Account) *ProxyQuery {
	query := (&ProxyClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(account.Table, account.FieldID, id),
...
func (c *AccountClient) QueryParent(_m *Account) *AccountQuery {
	query := (&AccountClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(account.Table, account.FieldID, id),
...
func (c *AccountClient) QueryAccountGroups(_m *Account) *AccountGroupQuery {
	query := (&AccountGroupClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(account.Table, account.FieldID, id),
...
func (c *AccountClient) mutate(ctx context.Context, m *AccountMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AccountCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&AccountUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&AccountUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AccountDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewAccountGroupClient(c config) *AccountGroupClient {
	return &AccountGroupClient{config: cREDACTED
REDACTED
...
func (c *AccountGroupClient) Create() *AccountGroupCreate {
	...
	return &AccountGroupCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AccountGroupClient) CreateBulk(builders ...*AccountGroupCreate) *AccountGroupCreateBulk {
	return &AccountGroupCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *AccountGroupClient) MapCreateBulk(slice any, setFunc func(*AccountGroupCreate, int)) *AccountGroupCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AccountGroupCreateBulk{err: fmt.Errorf("calling to AccountGroupClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *AccountGroupClient) Update() *AccountGroupUpdate {
	...
	return &AccountGroupUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AccountGroupClient) UpdateOne(_m *AccountGroup) *AccountGroupUpdateOne {
	...
	return &AccountGroupUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AccountGroupClient) Delete() *AccountGroupDelete {
	...
	return &AccountGroupDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AccountGroupClient) Query() *AccountGroupQuery {
	return &AccountGroupQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAccountGroupREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *AccountGroupClient) mutate(ctx context.Context, m *AccountGroupMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AccountGroupCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&AccountGroupUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&AccountGroupUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AccountGroupDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewAnnouncementClient(c config) *AnnouncementClient {
	return &AnnouncementClient{config: cREDACTED
REDACTED
...
func (c *AnnouncementClient) Create() *AnnouncementCreate {
	...
	return &AnnouncementCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AnnouncementClient) CreateBulk(builders ...*AnnouncementCreate) *AnnouncementCreateBulk {
	return &AnnouncementCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *AnnouncementClient) MapCreateBulk(slice any, setFunc func(*AnnouncementCreate, int)) *AnnouncementCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AnnouncementCreateBulk{err: fmt.Errorf("calling to AnnouncementClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *AnnouncementClient) Update() *AnnouncementUpdate {
	...
	return &AnnouncementUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AnnouncementClient) UpdateOne(_m *Announcement) *AnnouncementUpdateOne {
	...
	return &AnnouncementUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AnnouncementClient) Delete() *AnnouncementDelete {
	...
	return &AnnouncementDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AnnouncementClient) DeleteOneID(id int64) *AnnouncementDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AnnouncementDeleteOne{builderREDACTED
REDACTED
...
func (c *AnnouncementClient) Query() *AnnouncementQuery {
	return &AnnouncementQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAnnouncementREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *AnnouncementClient) QueryReads(_m *Announcement) *AnnouncementReadQuery {
	query := (&AnnouncementReadClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *AnnouncementClient) mutate(ctx context.Context, m *AnnouncementMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AnnouncementCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&AnnouncementUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&AnnouncementUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AnnouncementDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewAnnouncementReadClient(c config) *AnnouncementReadClient {
	return &AnnouncementReadClient{config: cREDACTED
REDACTED
...
func (c *AnnouncementReadClient) Create() *AnnouncementReadCreate {
	...
	return &AnnouncementReadCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AnnouncementReadClient) CreateBulk(builders ...*AnnouncementReadCreate) *AnnouncementReadCreateBulk {
	return &AnnouncementReadCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *AnnouncementReadClient) MapCreateBulk(slice any, setFunc func(*AnnouncementReadCreate, int)) *AnnouncementReadCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AnnouncementReadCreateBulk{err: fmt.Errorf("calling to AnnouncementReadClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *AnnouncementReadClient) Update() *AnnouncementReadUpdate {
	...
	return &AnnouncementReadUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AnnouncementReadClient) UpdateOne(_m *AnnouncementRead) *AnnouncementReadUpdateOne {
	...
	return &AnnouncementReadUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AnnouncementReadClient) Delete() *AnnouncementReadDelete {
	...
	return &AnnouncementReadDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AnnouncementReadClient) DeleteOneID(id int64) *AnnouncementReadDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AnnouncementReadDeleteOne{builderREDACTED
REDACTED
...
func (c *AnnouncementReadClient) Query() *AnnouncementReadQuery {
	return &AnnouncementReadQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAnnouncementReadREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *AnnouncementReadClient) QueryAnnouncement(_m *AnnouncementRead) *AnnouncementQuery {
	query := (&AnnouncementClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *AnnouncementReadClient) mutate(ctx context.Context, m *AnnouncementReadMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AnnouncementReadCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&AnnouncementReadUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&AnnouncementReadUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AnnouncementReadDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewAuthIdentityClient(c config) *AuthIdentityClient {
	return &AuthIdentityClient{config: cREDACTED
REDACTED
...
func (c *AuthIdentityClient) Create() *AuthIdentityCreate {
	...
	return &AuthIdentityCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AuthIdentityClient) CreateBulk(builders ...*AuthIdentityCreate) *AuthIdentityCreateBulk {
	return &AuthIdentityCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *AuthIdentityClient) MapCreateBulk(slice any, setFunc func(*AuthIdentityCreate, int)) *AuthIdentityCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AuthIdentityCreateBulk{err: fmt.Errorf("calling to AuthIdentityClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *AuthIdentityClient) Update() *AuthIdentityUpdate {
	...
	return &AuthIdentityUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AuthIdentityClient) UpdateOne(_m *AuthIdentity) *AuthIdentityUpdateOne {
	...
	return &AuthIdentityUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AuthIdentityClient) Delete() *AuthIdentityDelete {
	...
	return &AuthIdentityDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AuthIdentityClient) DeleteOneID(id int64) *AuthIdentityDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AuthIdentityDeleteOne{builderREDACTED
REDACTED
...
func (c *AuthIdentityClient) Query() *AuthIdentityQuery {
	return &AuthIdentityQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAuthIdentityREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *AuthIdentityClient) QueryChannels(_m *AuthIdentity) *AuthIdentityChannelQuery {
	query := (&AuthIdentityChannelClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(authidentity.Table, authidentity.FieldID, id),
...
func (c *AuthIdentityClient) QueryAdoptionDecisions(_m *AuthIdentity) *IdentityAdoptionDecisionQuery {
	query := (&IdentityAdoptionDecisionClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(authidentity.Table, authidentity.FieldID, id),
...
func (c *AuthIdentityClient) mutate(ctx context.Context, m *AuthIdentityMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AuthIdentityCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&AuthIdentityUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&AuthIdentityUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AuthIdentityDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewAuthIdentityChannelClient(c config) *AuthIdentityChannelClient {
	return &AuthIdentityChannelClient{config: cREDACTED
REDACTED
...
func (c *AuthIdentityChannelClient) Create() *AuthIdentityChannelCreate {
	...
	return &AuthIdentityChannelCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AuthIdentityChannelClient) CreateBulk(builders ...*AuthIdentityChannelCreate) *AuthIdentityChannelCreateBulk {
	return &AuthIdentityChannelCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *AuthIdentityChannelClient) MapCreateBulk(slice any, setFunc func(*AuthIdentityChannelCreate, int)) *AuthIdentityChannelCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AuthIdentityChannelCreateBulk{err: fmt.Errorf("calling to AuthIdentityChannelClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *AuthIdentityChannelClient) Update() *AuthIdentityChannelUpdate {
	...
	return &AuthIdentityChannelUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AuthIdentityChannelClient) UpdateOne(_m *AuthIdentityChannel) *AuthIdentityChannelUpdateOne {
	...
	return &AuthIdentityChannelUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AuthIdentityChannelClient) Delete() *AuthIdentityChannelDelete {
	...
	return &AuthIdentityChannelDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *AuthIdentityChannelClient) DeleteOneID(id int64) *AuthIdentityChannelDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AuthIdentityChannelDeleteOne{builderREDACTED
REDACTED
...
func (c *AuthIdentityChannelClient) Query() *AuthIdentityChannelQuery {
	return &AuthIdentityChannelQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAuthIdentityChannelREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *AuthIdentityChannelClient) QueryIdentity(_m *AuthIdentityChannel) *AuthIdentityQuery {
	query := (&AuthIdentityClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *AuthIdentityChannelClient) mutate(ctx context.Context, m *AuthIdentityChannelMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AuthIdentityChannelCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&AuthIdentityChannelUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&AuthIdentityChannelUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AuthIdentityChannelDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewBatchImageEventClient(c config) *BatchImageEventClient {
	return &BatchImageEventClient{config: cREDACTED
REDACTED
...
func (c *BatchImageEventClient) Create() *BatchImageEventCreate {
	...
	return &BatchImageEventCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *BatchImageEventClient) CreateBulk(builders ...*BatchImageEventCreate) *BatchImageEventCreateBulk {
	return &BatchImageEventCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *BatchImageEventClient) MapCreateBulk(slice any, setFunc func(*BatchImageEventCreate, int)) *BatchImageEventCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &BatchImageEventCreateBulk{err: fmt.Errorf("calling to BatchImageEventClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *BatchImageEventClient) Update() *BatchImageEventUpdate {
	...
	return &BatchImageEventUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *BatchImageEventClient) UpdateOne(_m *BatchImageEvent) *BatchImageEventUpdateOne {
	...
	return &BatchImageEventUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *BatchImageEventClient) Delete() *BatchImageEventDelete {
	...
	return &BatchImageEventDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *BatchImageEventClient) DeleteOneID(id int64) *BatchImageEventDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &BatchImageEventDeleteOne{builderREDACTED
REDACTED
...
func (c *BatchImageEventClient) Query() *BatchImageEventQuery {
	return &BatchImageEventQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeBatchImageEventREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *BatchImageEventClient) mutate(ctx context.Context, m *BatchImageEventMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&BatchImageEventCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&BatchImageEventUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&BatchImageEventUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&BatchImageEventDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewBatchImageItemClient(c config) *BatchImageItemClient {
	return &BatchImageItemClient{config: cREDACTED
REDACTED
...
func (c *BatchImageItemClient) Create() *BatchImageItemCreate {
	...
	return &BatchImageItemCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *BatchImageItemClient) CreateBulk(builders ...*BatchImageItemCreate) *BatchImageItemCreateBulk {
	return &BatchImageItemCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *BatchImageItemClient) MapCreateBulk(slice any, setFunc func(*BatchImageItemCreate, int)) *BatchImageItemCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &BatchImageItemCreateBulk{err: fmt.Errorf("calling to BatchImageItemClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *BatchImageItemClient) Update() *BatchImageItemUpdate {
	...
	return &BatchImageItemUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *BatchImageItemClient) UpdateOne(_m *BatchImageItem) *BatchImageItemUpdateOne {
	...
	return &BatchImageItemUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *BatchImageItemClient) Delete() *BatchImageItemDelete {
	...
	return &BatchImageItemDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *BatchImageItemClient) DeleteOneID(id int64) *BatchImageItemDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &BatchImageItemDeleteOne{builderREDACTED
REDACTED
...
func (c *BatchImageItemClient) Query() *BatchImageItemQuery {
	return &BatchImageItemQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeBatchImageItemREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *BatchImageItemClient) mutate(ctx context.Context, m *BatchImageItemMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&BatchImageItemCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&BatchImageItemUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&BatchImageItemUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&BatchImageItemDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewBatchImageJobClient(c config) *BatchImageJobClient {
	return &BatchImageJobClient{config: cREDACTED
REDACTED
...
func (c *BatchImageJobClient) Create() *BatchImageJobCreate {
	...
	return &BatchImageJobCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *BatchImageJobClient) CreateBulk(builders ...*BatchImageJobCreate) *BatchImageJobCreateBulk {
	return &BatchImageJobCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *BatchImageJobClient) MapCreateBulk(slice any, setFunc func(*BatchImageJobCreate, int)) *BatchImageJobCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &BatchImageJobCreateBulk{err: fmt.Errorf("calling to BatchImageJobClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *BatchImageJobClient) Update() *BatchImageJobUpdate {
	...
	return &BatchImageJobUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *BatchImageJobClient) UpdateOne(_m *BatchImageJob) *BatchImageJobUpdateOne {
	...
	return &BatchImageJobUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *BatchImageJobClient) Delete() *BatchImageJobDelete {
	...
	return &BatchImageJobDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *BatchImageJobClient) DeleteOneID(id int64) *BatchImageJobDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &BatchImageJobDeleteOne{builderREDACTED
REDACTED
...
func (c *BatchImageJobClient) Query() *BatchImageJobQuery {
	return &BatchImageJobQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeBatchImageJobREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *BatchImageJobClient) mutate(ctx context.Context, m *BatchImageJobMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&BatchImageJobCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&BatchImageJobUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&BatchImageJobUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&BatchImageJobDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewChannelMonitorClient(c config) *ChannelMonitorClient {
	return &ChannelMonitorClient{config: cREDACTED
REDACTED
...
func (c *ChannelMonitorClient) Create() *ChannelMonitorCreate {
	...
	return &ChannelMonitorCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorClient) CreateBulk(builders ...*ChannelMonitorCreate) *ChannelMonitorCreateBulk {
	return &ChannelMonitorCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *ChannelMonitorClient) MapCreateBulk(slice any, setFunc func(*ChannelMonitorCreate, int)) *ChannelMonitorCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ChannelMonitorCreateBulk{err: fmt.Errorf("calling to ChannelMonitorClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *ChannelMonitorClient) Update() *ChannelMonitorUpdate {
	...
	return &ChannelMonitorUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorClient) UpdateOne(_m *ChannelMonitor) *ChannelMonitorUpdateOne {
	...
	return &ChannelMonitorUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorClient) Delete() *ChannelMonitorDelete {
	...
	return &ChannelMonitorDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorClient) DeleteOneID(id int64) *ChannelMonitorDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ChannelMonitorDeleteOne{builderREDACTED
REDACTED
...
func (c *ChannelMonitorClient) Query() *ChannelMonitorQuery {
	return &ChannelMonitorQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeChannelMonitorREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *ChannelMonitorClient) QueryHistory(_m *ChannelMonitor) *ChannelMonitorHistoryQuery {
	query := (&ChannelMonitorHistoryClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *ChannelMonitorClient) QueryDailyRollups(_m *ChannelMonitor) *ChannelMonitorDailyRollupQuery {
	query := (&ChannelMonitorDailyRollupClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(channelmonitor.Table, channelmonitor.FieldID, id),
...
func (c *ChannelMonitorClient) QueryRequestTemplate(_m *ChannelMonitor) *ChannelMonitorRequestTemplateQuery {
	query := (&ChannelMonitorRequestTemplateClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(channelmonitor.Table, channelmonitor.FieldID, id),
...
func (c *ChannelMonitorClient) mutate(ctx context.Context, m *ChannelMonitorMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ChannelMonitorCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&ChannelMonitorUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&ChannelMonitorUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ChannelMonitorDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewChannelMonitorDailyRollupClient(c config) *ChannelMonitorDailyRollupClient {
	return &ChannelMonitorDailyRollupClient{config: cREDACTED
REDACTED
...
func (c *ChannelMonitorDailyRollupClient) Create() *ChannelMonitorDailyRollupCreate {
	...
	return &ChannelMonitorDailyRollupCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorDailyRollupClient) CreateBulk(builders ...*ChannelMonitorDailyRollupCreate) *ChannelMonitorDailyRollupCreateBulk {
	return &ChannelMonitorDailyRollupCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *ChannelMonitorDailyRollupClient) MapCreateBulk(slice any, setFunc func(*ChannelMonitorDailyRollupCreate, int)) *ChannelMonitorDailyRollupCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ChannelMonitorDailyRollupCreateBulk{err: fmt.Errorf("calling to ChannelMonitorDailyRollupClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *ChannelMonitorDailyRollupClient) Update() *ChannelMonitorDailyRollupUpdate {
	...
	return &ChannelMonitorDailyRollupUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorDailyRollupClient) UpdateOne(_m *ChannelMonitorDailyRollup) *ChannelMonitorDailyRollupUpdateOne {
	...
	return &ChannelMonitorDailyRollupUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorDailyRollupClient) Delete() *ChannelMonitorDailyRollupDelete {
	...
	return &ChannelMonitorDailyRollupDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorDailyRollupClient) DeleteOneID(id int64) *ChannelMonitorDailyRollupDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ChannelMonitorDailyRollupDeleteOne{builderREDACTED
REDACTED
...
func (c *ChannelMonitorDailyRollupClient) Query() *ChannelMonitorDailyRollupQuery {
	return &ChannelMonitorDailyRollupQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeChannelMonitorDailyRollupREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *ChannelMonitorDailyRollupClient) QueryMonitor(_m *ChannelMonitorDailyRollup) *ChannelMonitorQuery {
	query := (&ChannelMonitorClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *ChannelMonitorDailyRollupClient) mutate(ctx context.Context, m *ChannelMonitorDailyRollupMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ChannelMonitorDailyRollupCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&ChannelMonitorDailyRollupUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&ChannelMonitorDailyRollupUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ChannelMonitorDailyRollupDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewChannelMonitorHistoryClient(c config) *ChannelMonitorHistoryClient {
	return &ChannelMonitorHistoryClient{config: cREDACTED
REDACTED
...
func (c *ChannelMonitorHistoryClient) Create() *ChannelMonitorHistoryCreate {
	...
	return &ChannelMonitorHistoryCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorHistoryClient) CreateBulk(builders ...*ChannelMonitorHistoryCreate) *ChannelMonitorHistoryCreateBulk {
	return &ChannelMonitorHistoryCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *ChannelMonitorHistoryClient) MapCreateBulk(slice any, setFunc func(*ChannelMonitorHistoryCreate, int)) *ChannelMonitorHistoryCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ChannelMonitorHistoryCreateBulk{err: fmt.Errorf("calling to ChannelMonitorHistoryClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *ChannelMonitorHistoryClient) Update() *ChannelMonitorHistoryUpdate {
	...
	return &ChannelMonitorHistoryUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorHistoryClient) UpdateOne(_m *ChannelMonitorHistory) *ChannelMonitorHistoryUpdateOne {
	...
	return &ChannelMonitorHistoryUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorHistoryClient) Delete() *ChannelMonitorHistoryDelete {
	...
	return &ChannelMonitorHistoryDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorHistoryClient) DeleteOneID(id int64) *ChannelMonitorHistoryDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ChannelMonitorHistoryDeleteOne{builderREDACTED
REDACTED
...
func (c *ChannelMonitorHistoryClient) Query() *ChannelMonitorHistoryQuery {
	return &ChannelMonitorHistoryQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeChannelMonitorHistoryREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *ChannelMonitorHistoryClient) mutate(ctx context.Context, m *ChannelMonitorHistoryMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ChannelMonitorHistoryCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&ChannelMonitorHistoryUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&ChannelMonitorHistoryUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ChannelMonitorHistoryDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewChannelMonitorRequestTemplateClient(c config) *ChannelMonitorRequestTemplateClient {
	return &ChannelMonitorRequestTemplateClient{config: cREDACTED
REDACTED
...
func (c *ChannelMonitorRequestTemplateClient) Create() *ChannelMonitorRequestTemplateCreate {
	...
	return &ChannelMonitorRequestTemplateCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorRequestTemplateClient) CreateBulk(builders ...*ChannelMonitorRequestTemplateCreate) *ChannelMonitorRequestTemplateCreateBulk {
	return &ChannelMonitorRequestTemplateCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *ChannelMonitorRequestTemplateClient) MapCreateBulk(slice any, setFunc func(*ChannelMonitorRequestTemplateCreate, int)) *ChannelMonitorRequestTemplateCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ChannelMonitorRequestTemplateCreateBulk{err: fmt.Errorf("calling to ChannelMonitorRequestTemplateClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *ChannelMonitorRequestTemplateClient) Update() *ChannelMonitorRequestTemplateUpdate {
	...
	return &ChannelMonitorRequestTemplateUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorRequestTemplateClient) UpdateOne(_m *ChannelMonitorRequestTemplate) *ChannelMonitorRequestTemplateUpdateOne {
	...
	return &ChannelMonitorRequestTemplateUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorRequestTemplateClient) Delete() *ChannelMonitorRequestTemplateDelete {
	...
	return &ChannelMonitorRequestTemplateDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ChannelMonitorRequestTemplateClient) DeleteOneID(id int64) *ChannelMonitorRequestTemplateDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ChannelMonitorRequestTemplateDeleteOne{builderREDACTED
REDACTED
...
func (c *ChannelMonitorRequestTemplateClient) Query() *ChannelMonitorRequestTemplateQuery {
	return &ChannelMonitorRequestTemplateQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeChannelMonitorRequestTemplateREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *ChannelMonitorRequestTemplateClient) mutate(ctx context.Context, m *ChannelMonitorRequestTemplateMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ChannelMonitorRequestTemplateCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&ChannelMonitorRequestTemplateUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&ChannelMonitorRequestTemplateUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ChannelMonitorRequestTemplateDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewCompositeModelRouteClient(c config) *CompositeModelRouteClient {
	return &CompositeModelRouteClient{config: cREDACTED
REDACTED
...
func (c *CompositeModelRouteClient) Create() *CompositeModelRouteCreate {
	...
	return &CompositeModelRouteCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *CompositeModelRouteClient) CreateBulk(builders ...*CompositeModelRouteCreate) *CompositeModelRouteCreateBulk {
	return &CompositeModelRouteCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *CompositeModelRouteClient) MapCreateBulk(slice any, setFunc func(*CompositeModelRouteCreate, int)) *CompositeModelRouteCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &CompositeModelRouteCreateBulk{err: fmt.Errorf("calling to CompositeModelRouteClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *CompositeModelRouteClient) Update() *CompositeModelRouteUpdate {
	...
	return &CompositeModelRouteUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *CompositeModelRouteClient) UpdateOne(_m *CompositeModelRoute) *CompositeModelRouteUpdateOne {
	...
	return &CompositeModelRouteUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *CompositeModelRouteClient) Delete() *CompositeModelRouteDelete {
	...
	return &CompositeModelRouteDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *CompositeModelRouteClient) DeleteOneID(id int64) *CompositeModelRouteDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &CompositeModelRouteDeleteOne{builderREDACTED
REDACTED
...
func (c *CompositeModelRouteClient) Query() *CompositeModelRouteQuery {
	return &CompositeModelRouteQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeCompositeModelRouteREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *CompositeModelRouteClient) mutate(ctx context.Context, m *CompositeModelRouteMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&CompositeModelRouteCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&CompositeModelRouteUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&CompositeModelRouteUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&CompositeModelRouteDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewErrorPassthroughRuleClient(c config) *ErrorPassthroughRuleClient {
	return &ErrorPassthroughRuleClient{config: cREDACTED
REDACTED
...
func (c *ErrorPassthroughRuleClient) Create() *ErrorPassthroughRuleCreate {
	...
	return &ErrorPassthroughRuleCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ErrorPassthroughRuleClient) CreateBulk(builders ...*ErrorPassthroughRuleCreate) *ErrorPassthroughRuleCreateBulk {
	return &ErrorPassthroughRuleCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *ErrorPassthroughRuleClient) MapCreateBulk(slice any, setFunc func(*ErrorPassthroughRuleCreate, int)) *ErrorPassthroughRuleCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ErrorPassthroughRuleCreateBulk{err: fmt.Errorf("calling to ErrorPassthroughRuleClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *ErrorPassthroughRuleClient) Update() *ErrorPassthroughRuleUpdate {
	...
	return &ErrorPassthroughRuleUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ErrorPassthroughRuleClient) UpdateOne(_m *ErrorPassthroughRule) *ErrorPassthroughRuleUpdateOne {
	...
	return &ErrorPassthroughRuleUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ErrorPassthroughRuleClient) Delete() *ErrorPassthroughRuleDelete {
	...
	return &ErrorPassthroughRuleDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ErrorPassthroughRuleClient) DeleteOneID(id int64) *ErrorPassthroughRuleDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ErrorPassthroughRuleDeleteOne{builderREDACTED
REDACTED
...
func (c *ErrorPassthroughRuleClient) Query() *ErrorPassthroughRuleQuery {
	return &ErrorPassthroughRuleQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeErrorPassthroughRuleREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *ErrorPassthroughRuleClient) mutate(ctx context.Context, m *ErrorPassthroughRuleMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ErrorPassthroughRuleCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&ErrorPassthroughRuleUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&ErrorPassthroughRuleUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ErrorPassthroughRuleDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewGroupClient(c config) *GroupClient {
	return &GroupClient{config: cREDACTED
REDACTED
...
func (c *GroupClient) Create() *GroupCreate {
	...
	return &GroupCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED

// CreateBulk returns a builder for creating a bulk of Group entities.
func (c *GroupClient) CreateBulk(builders ...*GroupCreate) *GroupCreateBulk {
	return &GroupCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *GroupClient) MapCreateBulk(slice any, setFunc func(*GroupCreate, int)) *GroupCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &GroupCreateBulk{err: fmt.Errorf("calling to GroupClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *GroupClient) Update() *GroupUpdate {
	...
	return &GroupUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED

// UpdateOne returns an update builder for the given entity.
func (c *GroupClient) UpdateOne(_m *Group) *GroupUpdateOne {
	mutation := newGroupMutation(c.config, OpUpdateOne, withGroup(_m))
	return &GroupUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *GroupClient) Delete() *GroupDelete {
	...
	return &GroupDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *GroupClient) DeleteOneID(id int64) *GroupDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &GroupDeleteOne{builderREDACTED
REDACTED
...
func (c *GroupClient) Query() *GroupQuery {
	return &GroupQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeGroupREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *GroupClient) QueryAPIKeys(_m *Group) *APIKeyQuery {
	query := (&APIKeyClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *GroupClient) QueryRedeemCodes(_m *Group) *RedeemCodeQuery {
	query := (&RedeemCodeClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(group.Table, group.FieldID, id),
...
func (c *GroupClient) QuerySubscriptions(_m *Group) *UserSubscriptionQuery {
	query := (&UserSubscriptionClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(group.Table, group.FieldID, id),
...
func (c *GroupClient) mutate(ctx context.Context, m *GroupMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&GroupCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&GroupUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&GroupUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&GroupDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewIdempotencyRecordClient(c config) *IdempotencyRecordClient {
	return &IdempotencyRecordClient{config: cREDACTED
REDACTED
...
func (c *IdempotencyRecordClient) Create() *IdempotencyRecordCreate {
	...
	return &IdempotencyRecordCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *IdempotencyRecordClient) CreateBulk(builders ...*IdempotencyRecordCreate) *IdempotencyRecordCreateBulk {
	return &IdempotencyRecordCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *IdempotencyRecordClient) MapCreateBulk(slice any, setFunc func(*IdempotencyRecordCreate, int)) *IdempotencyRecordCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &IdempotencyRecordCreateBulk{err: fmt.Errorf("calling to IdempotencyRecordClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *IdempotencyRecordClient) Update() *IdempotencyRecordUpdate {
	...
	return &IdempotencyRecordUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *IdempotencyRecordClient) UpdateOne(_m *IdempotencyRecord) *IdempotencyRecordUpdateOne {
	...
	return &IdempotencyRecordUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *IdempotencyRecordClient) Delete() *IdempotencyRecordDelete {
	...
	return &IdempotencyRecordDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *IdempotencyRecordClient) DeleteOneID(id int64) *IdempotencyRecordDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &IdempotencyRecordDeleteOne{builderREDACTED
REDACTED
...
func (c *IdempotencyRecordClient) Query() *IdempotencyRecordQuery {
	return &IdempotencyRecordQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeIdempotencyRecordREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *IdempotencyRecordClient) mutate(ctx context.Context, m *IdempotencyRecordMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&IdempotencyRecordCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&IdempotencyRecordUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&IdempotencyRecordUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&IdempotencyRecordDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewIdentityAdoptionDecisionClient(c config) *IdentityAdoptionDecisionClient {
	return &IdentityAdoptionDecisionClient{config: cREDACTED
REDACTED
...
func (c *IdentityAdoptionDecisionClient) Create() *IdentityAdoptionDecisionCreate {
	...
	return &IdentityAdoptionDecisionCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *IdentityAdoptionDecisionClient) CreateBulk(builders ...*IdentityAdoptionDecisionCreate) *IdentityAdoptionDecisionCreateBulk {
	return &IdentityAdoptionDecisionCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *IdentityAdoptionDecisionClient) MapCreateBulk(slice any, setFunc func(*IdentityAdoptionDecisionCreate, int)) *IdentityAdoptionDecisionCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &IdentityAdoptionDecisionCreateBulk{err: fmt.Errorf("calling to IdentityAdoptionDecisionClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *IdentityAdoptionDecisionClient) Update() *IdentityAdoptionDecisionUpdate {
	...
	return &IdentityAdoptionDecisionUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *IdentityAdoptionDecisionClient) UpdateOne(_m *IdentityAdoptionDecision) *IdentityAdoptionDecisionUpdateOne {
	...
	return &IdentityAdoptionDecisionUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *IdentityAdoptionDecisionClient) Delete() *IdentityAdoptionDecisionDelete {
	...
	return &IdentityAdoptionDecisionDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *IdentityAdoptionDecisionClient) DeleteOneID(id int64) *IdentityAdoptionDecisionDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &IdentityAdoptionDecisionDeleteOne{builderREDACTED
REDACTED
...
func (c *IdentityAdoptionDecisionClient) Query() *IdentityAdoptionDecisionQuery {
	return &IdentityAdoptionDecisionQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeIdentityAdoptionDecisionREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *IdentityAdoptionDecisionClient) QueryPendingAuthSession(_m *IdentityAdoptionDecision) *PendingAuthSessionQuery {
	query := (&PendingAuthSessionClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *IdentityAdoptionDecisionClient) mutate(ctx context.Context, m *IdentityAdoptionDecisionMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&IdentityAdoptionDecisionCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&IdentityAdoptionDecisionUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&IdentityAdoptionDecisionUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&IdentityAdoptionDecisionDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewPaymentAuditLogClient(c config) *PaymentAuditLogClient {
	return &PaymentAuditLogClient{config: cREDACTED
REDACTED
...
func (c *PaymentAuditLogClient) Create() *PaymentAuditLogCreate {
	...
	return &PaymentAuditLogCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PaymentAuditLogClient) CreateBulk(builders ...*PaymentAuditLogCreate) *PaymentAuditLogCreateBulk {
	return &PaymentAuditLogCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *PaymentAuditLogClient) MapCreateBulk(slice any, setFunc func(*PaymentAuditLogCreate, int)) *PaymentAuditLogCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &PaymentAuditLogCreateBulk{err: fmt.Errorf("calling to PaymentAuditLogClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *PaymentAuditLogClient) Update() *PaymentAuditLogUpdate {
	...
	return &PaymentAuditLogUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PaymentAuditLogClient) UpdateOne(_m *PaymentAuditLog) *PaymentAuditLogUpdateOne {
	...
	return &PaymentAuditLogUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PaymentAuditLogClient) Delete() *PaymentAuditLogDelete {
	...
	return &PaymentAuditLogDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PaymentAuditLogClient) DeleteOneID(id int64) *PaymentAuditLogDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &PaymentAuditLogDeleteOne{builderREDACTED
REDACTED
...
func (c *PaymentAuditLogClient) Query() *PaymentAuditLogQuery {
	return &PaymentAuditLogQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypePaymentAuditLogREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *PaymentAuditLogClient) mutate(ctx context.Context, m *PaymentAuditLogMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&PaymentAuditLogCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&PaymentAuditLogUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&PaymentAuditLogUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&PaymentAuditLogDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewPaymentOrderClient(c config) *PaymentOrderClient {
	return &PaymentOrderClient{config: cREDACTED
REDACTED
...
func (c *PaymentOrderClient) Create() *PaymentOrderCreate {
	...
	return &PaymentOrderCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PaymentOrderClient) CreateBulk(builders ...*PaymentOrderCreate) *PaymentOrderCreateBulk {
	return &PaymentOrderCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *PaymentOrderClient) MapCreateBulk(slice any, setFunc func(*PaymentOrderCreate, int)) *PaymentOrderCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &PaymentOrderCreateBulk{err: fmt.Errorf("calling to PaymentOrderClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *PaymentOrderClient) Update() *PaymentOrderUpdate {
	...
	return &PaymentOrderUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PaymentOrderClient) UpdateOne(_m *PaymentOrder) *PaymentOrderUpdateOne {
	...
	return &PaymentOrderUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PaymentOrderClient) Delete() *PaymentOrderDelete {
	...
	return &PaymentOrderDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PaymentOrderClient) DeleteOneID(id int64) *PaymentOrderDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &PaymentOrderDeleteOne{builderREDACTED
REDACTED
...
func (c *PaymentOrderClient) Query() *PaymentOrderQuery {
	return &PaymentOrderQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypePaymentOrderREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *PaymentOrderClient) mutate(ctx context.Context, m *PaymentOrderMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&PaymentOrderCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&PaymentOrderUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&PaymentOrderUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&PaymentOrderDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewPaymentProviderInstanceClient(c config) *PaymentProviderInstanceClient {
	return &PaymentProviderInstanceClient{config: cREDACTED
REDACTED
...
func (c *PaymentProviderInstanceClient) Create() *PaymentProviderInstanceCreate {
	...
	return &PaymentProviderInstanceCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PaymentProviderInstanceClient) CreateBulk(builders ...*PaymentProviderInstanceCreate) *PaymentProviderInstanceCreateBulk {
	return &PaymentProviderInstanceCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *PaymentProviderInstanceClient) MapCreateBulk(slice any, setFunc func(*PaymentProviderInstanceCreate, int)) *PaymentProviderInstanceCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &PaymentProviderInstanceCreateBulk{err: fmt.Errorf("calling to PaymentProviderInstanceClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *PaymentProviderInstanceClient) Update() *PaymentProviderInstanceUpdate {
	...
	return &PaymentProviderInstanceUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PaymentProviderInstanceClient) UpdateOne(_m *PaymentProviderInstance) *PaymentProviderInstanceUpdateOne {
	...
	return &PaymentProviderInstanceUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PaymentProviderInstanceClient) Delete() *PaymentProviderInstanceDelete {
	...
	return &PaymentProviderInstanceDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PaymentProviderInstanceClient) DeleteOneID(id int64) *PaymentProviderInstanceDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &PaymentProviderInstanceDeleteOne{builderREDACTED
REDACTED
...
func (c *PaymentProviderInstanceClient) Query() *PaymentProviderInstanceQuery {
	return &PaymentProviderInstanceQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypePaymentProviderInstanceREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *PaymentProviderInstanceClient) mutate(ctx context.Context, m *PaymentProviderInstanceMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&PaymentProviderInstanceCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&PaymentProviderInstanceUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&PaymentProviderInstanceUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&PaymentProviderInstanceDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewPendingAuthSessionClient(c config) *PendingAuthSessionClient {
	return &PendingAuthSessionClient{config: cREDACTED
REDACTED
...
func (c *PendingAuthSessionClient) Create() *PendingAuthSessionCreate {
	...
	return &PendingAuthSessionCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PendingAuthSessionClient) CreateBulk(builders ...*PendingAuthSessionCreate) *PendingAuthSessionCreateBulk {
	return &PendingAuthSessionCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *PendingAuthSessionClient) MapCreateBulk(slice any, setFunc func(*PendingAuthSessionCreate, int)) *PendingAuthSessionCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &PendingAuthSessionCreateBulk{err: fmt.Errorf("calling to PendingAuthSessionClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *PendingAuthSessionClient) Update() *PendingAuthSessionUpdate {
	...
	return &PendingAuthSessionUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PendingAuthSessionClient) UpdateOne(_m *PendingAuthSession) *PendingAuthSessionUpdateOne {
	...
	return &PendingAuthSessionUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PendingAuthSessionClient) Delete() *PendingAuthSessionDelete {
	...
	return &PendingAuthSessionDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PendingAuthSessionClient) DeleteOneID(id int64) *PendingAuthSessionDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &PendingAuthSessionDeleteOne{builderREDACTED
REDACTED
...
func (c *PendingAuthSessionClient) Query() *PendingAuthSessionQuery {
	return &PendingAuthSessionQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypePendingAuthSessionREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *PendingAuthSessionClient) mutate(ctx context.Context, m *PendingAuthSessionMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&PendingAuthSessionCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&PendingAuthSessionUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&PendingAuthSessionUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&PendingAuthSessionDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewPromoCodeClient(c config) *PromoCodeClient {
	return &PromoCodeClient{config: cREDACTED
REDACTED
...
func (c *PromoCodeClient) Create() *PromoCodeCreate {
	...
	return &PromoCodeCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PromoCodeClient) CreateBulk(builders ...*PromoCodeCreate) *PromoCodeCreateBulk {
	return &PromoCodeCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *PromoCodeClient) MapCreateBulk(slice any, setFunc func(*PromoCodeCreate, int)) *PromoCodeCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &PromoCodeCreateBulk{err: fmt.Errorf("calling to PromoCodeClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *PromoCodeClient) Update() *PromoCodeUpdate {
	...
	return &PromoCodeUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PromoCodeClient) UpdateOne(_m *PromoCode) *PromoCodeUpdateOne {
	...
	return &PromoCodeUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PromoCodeClient) Delete() *PromoCodeDelete {
	...
	return &PromoCodeDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PromoCodeClient) DeleteOneID(id int64) *PromoCodeDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &PromoCodeDeleteOne{builderREDACTED
REDACTED
...
func (c *PromoCodeClient) Query() *PromoCodeQuery {
	return &PromoCodeQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypePromoCodeREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *PromoCodeClient) QueryUsageRecords(_m *PromoCode) *PromoCodeUsageQuery {
	query := (&PromoCodeUsageClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *PromoCodeClient) mutate(ctx context.Context, m *PromoCodeMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&PromoCodeCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&PromoCodeUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&PromoCodeUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&PromoCodeDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewPromoCodeUsageClient(c config) *PromoCodeUsageClient {
	return &PromoCodeUsageClient{config: cREDACTED
REDACTED
...
func (c *PromoCodeUsageClient) Create() *PromoCodeUsageCreate {
	...
	return &PromoCodeUsageCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PromoCodeUsageClient) CreateBulk(builders ...*PromoCodeUsageCreate) *PromoCodeUsageCreateBulk {
	return &PromoCodeUsageCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *PromoCodeUsageClient) MapCreateBulk(slice any, setFunc func(*PromoCodeUsageCreate, int)) *PromoCodeUsageCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &PromoCodeUsageCreateBulk{err: fmt.Errorf("calling to PromoCodeUsageClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *PromoCodeUsageClient) Update() *PromoCodeUsageUpdate {
	...
	return &PromoCodeUsageUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PromoCodeUsageClient) UpdateOne(_m *PromoCodeUsage) *PromoCodeUsageUpdateOne {
	...
	return &PromoCodeUsageUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PromoCodeUsageClient) Delete() *PromoCodeUsageDelete {
	...
	return &PromoCodeUsageDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *PromoCodeUsageClient) DeleteOneID(id int64) *PromoCodeUsageDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &PromoCodeUsageDeleteOne{builderREDACTED
REDACTED
...
func (c *PromoCodeUsageClient) Query() *PromoCodeUsageQuery {
	return &PromoCodeUsageQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypePromoCodeUsageREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *PromoCodeUsageClient) QueryPromoCode(_m *PromoCodeUsage) *PromoCodeQuery {
	query := (&PromoCodeClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *PromoCodeUsageClient) mutate(ctx context.Context, m *PromoCodeUsageMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&PromoCodeUsageCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&PromoCodeUsageUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&PromoCodeUsageUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&PromoCodeUsageDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewProxyClient(c config) *ProxyClient {
	return &ProxyClient{config: cREDACTED
REDACTED
...
func (c *ProxyClient) Create() *ProxyCreate {
	...
	return &ProxyCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ProxyClient) CreateBulk(builders ...*ProxyCreate) *ProxyCreateBulk {
	return &ProxyCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *ProxyClient) MapCreateBulk(slice any, setFunc func(*ProxyCreate, int)) *ProxyCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ProxyCreateBulk{err: fmt.Errorf("calling to ProxyClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *ProxyClient) Update() *ProxyUpdate {
	...
	return &ProxyUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED

// UpdateOne returns an update builder for the given entity.
func (c *ProxyClient) UpdateOne(_m *Proxy) *ProxyUpdateOne {
	mutation := newProxyMutation(c.config, OpUpdateOne, withProxy(_m))
	return &ProxyUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ProxyClient) Delete() *ProxyDelete {
	...
	return &ProxyDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *ProxyClient) DeleteOneID(id int64) *ProxyDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ProxyDeleteOne{builderREDACTED
REDACTED
...
func (c *ProxyClient) Query() *ProxyQuery {
	return &ProxyQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeProxyREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *ProxyClient) mutate(ctx context.Context, m *ProxyMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ProxyCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&ProxyUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&ProxyUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ProxyDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewRedeemCodeClient(c config) *RedeemCodeClient {
	return &RedeemCodeClient{config: cREDACTED
REDACTED
...
func (c *RedeemCodeClient) Create() *RedeemCodeCreate {
	...
	return &RedeemCodeCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *RedeemCodeClient) CreateBulk(builders ...*RedeemCodeCreate) *RedeemCodeCreateBulk {
	return &RedeemCodeCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *RedeemCodeClient) MapCreateBulk(slice any, setFunc func(*RedeemCodeCreate, int)) *RedeemCodeCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &RedeemCodeCreateBulk{err: fmt.Errorf("calling to RedeemCodeClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *RedeemCodeClient) Update() *RedeemCodeUpdate {
	...
	return &RedeemCodeUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *RedeemCodeClient) UpdateOne(_m *RedeemCode) *RedeemCodeUpdateOne {
	...
	return &RedeemCodeUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *RedeemCodeClient) Delete() *RedeemCodeDelete {
	...
	return &RedeemCodeDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *RedeemCodeClient) DeleteOneID(id int64) *RedeemCodeDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &RedeemCodeDeleteOne{builderREDACTED
REDACTED
...
func (c *RedeemCodeClient) Query() *RedeemCodeQuery {
	return &RedeemCodeQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeRedeemCodeREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *RedeemCodeClient) mutate(ctx context.Context, m *RedeemCodeMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&RedeemCodeCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&RedeemCodeUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&RedeemCodeUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&RedeemCodeDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewSecuritySecretClient(c config) *SecuritySecretClient {
	return &SecuritySecretClient{config: cREDACTED
REDACTED
...
func (c *SecuritySecretClient) Create() *SecuritySecretCreate {
	...
	return &SecuritySecretCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *SecuritySecretClient) CreateBulk(builders ...*SecuritySecretCreate) *SecuritySecretCreateBulk {
	return &SecuritySecretCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *SecuritySecretClient) MapCreateBulk(slice any, setFunc func(*SecuritySecretCreate, int)) *SecuritySecretCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SecuritySecretCreateBulk{err: fmt.Errorf("calling to SecuritySecretClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *SecuritySecretClient) Update() *SecuritySecretUpdate {
	...
	return &SecuritySecretUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *SecuritySecretClient) UpdateOne(_m *SecuritySecret) *SecuritySecretUpdateOne {
	...
	return &SecuritySecretUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *SecuritySecretClient) Delete() *SecuritySecretDelete {
	...
	return &SecuritySecretDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *SecuritySecretClient) DeleteOneID(id int64) *SecuritySecretDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &SecuritySecretDeleteOne{builderREDACTED
REDACTED
...
func (c *SecuritySecretClient) Query() *SecuritySecretQuery {
	return &SecuritySecretQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeSecuritySecretREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *SecuritySecretClient) mutate(ctx context.Context, m *SecuritySecretMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&SecuritySecretCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&SecuritySecretUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&SecuritySecretUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&SecuritySecretDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewSettingClient(c config) *SettingClient {
	return &SettingClient{config: cREDACTED
REDACTED
...
func (c *SettingClient) Create() *SettingCreate {
	...
	return &SettingCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED

// CreateBulk returns a builder for creating a bulk of Setting entities.
func (c *SettingClient) CreateBulk(builders ...*SettingCreate) *SettingCreateBulk {
	return &SettingCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *SettingClient) MapCreateBulk(slice any, setFunc func(*SettingCreate, int)) *SettingCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SettingCreateBulk{err: fmt.Errorf("calling to SettingClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *SettingClient) Update() *SettingUpdate {
	...
	return &SettingUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *SettingClient) UpdateOne(_m *Setting) *SettingUpdateOne {
	...
	return &SettingUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *SettingClient) Delete() *SettingDelete {
	...
	return &SettingDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *SettingClient) DeleteOneID(id int64) *SettingDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &SettingDeleteOne{builderREDACTED
REDACTED
...
func (c *SettingClient) Query() *SettingQuery {
	return &SettingQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeSettingREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *SettingClient) mutate(ctx context.Context, m *SettingMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&SettingCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&SettingUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&SettingUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&SettingDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewSubscriptionPlanClient(c config) *SubscriptionPlanClient {
	return &SubscriptionPlanClient{config: cREDACTED
REDACTED
...
func (c *SubscriptionPlanClient) Create() *SubscriptionPlanCreate {
	...
	return &SubscriptionPlanCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *SubscriptionPlanClient) CreateBulk(builders ...*SubscriptionPlanCreate) *SubscriptionPlanCreateBulk {
	return &SubscriptionPlanCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *SubscriptionPlanClient) MapCreateBulk(slice any, setFunc func(*SubscriptionPlanCreate, int)) *SubscriptionPlanCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SubscriptionPlanCreateBulk{err: fmt.Errorf("calling to SubscriptionPlanClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *SubscriptionPlanClient) Update() *SubscriptionPlanUpdate {
	...
	return &SubscriptionPlanUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *SubscriptionPlanClient) UpdateOne(_m *SubscriptionPlan) *SubscriptionPlanUpdateOne {
	...
	return &SubscriptionPlanUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *SubscriptionPlanClient) Delete() *SubscriptionPlanDelete {
	...
	return &SubscriptionPlanDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *SubscriptionPlanClient) DeleteOneID(id int64) *SubscriptionPlanDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &SubscriptionPlanDeleteOne{builderREDACTED
REDACTED
...
func (c *SubscriptionPlanClient) Query() *SubscriptionPlanQuery {
	return &SubscriptionPlanQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeSubscriptionPlanREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *SubscriptionPlanClient) mutate(ctx context.Context, m *SubscriptionPlanMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&SubscriptionPlanCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&SubscriptionPlanUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&SubscriptionPlanUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&SubscriptionPlanDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewTLSFingerprintProfileClient(c config) *TLSFingerprintProfileClient {
	return &TLSFingerprintProfileClient{config: cREDACTED
REDACTED
...
func (c *TLSFingerprintProfileClient) Create() *TLSFingerprintProfileCreate {
	...
	return &TLSFingerprintProfileCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *TLSFingerprintProfileClient) CreateBulk(builders ...*TLSFingerprintProfileCreate) *TLSFingerprintProfileCreateBulk {
	return &TLSFingerprintProfileCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *TLSFingerprintProfileClient) MapCreateBulk(slice any, setFunc func(*TLSFingerprintProfileCreate, int)) *TLSFingerprintProfileCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &TLSFingerprintProfileCreateBulk{err: fmt.Errorf("calling to TLSFingerprintProfileClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *TLSFingerprintProfileClient) Update() *TLSFingerprintProfileUpdate {
	...
	return &TLSFingerprintProfileUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *TLSFingerprintProfileClient) UpdateOne(_m *TLSFingerprintProfile) *TLSFingerprintProfileUpdateOne {
	...
	return &TLSFingerprintProfileUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *TLSFingerprintProfileClient) Delete() *TLSFingerprintProfileDelete {
	...
	return &TLSFingerprintProfileDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *TLSFingerprintProfileClient) DeleteOneID(id int64) *TLSFingerprintProfileDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &TLSFingerprintProfileDeleteOne{builderREDACTED
REDACTED
...
func (c *TLSFingerprintProfileClient) Query() *TLSFingerprintProfileQuery {
	return &TLSFingerprintProfileQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeTLSFingerprintProfileREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *TLSFingerprintProfileClient) mutate(ctx context.Context, m *TLSFingerprintProfileMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&TLSFingerprintProfileCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&TLSFingerprintProfileUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&TLSFingerprintProfileUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&TLSFingerprintProfileDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewUsageLogClient(c config) *UsageLogClient {
	return &UsageLogClient{config: cREDACTED
REDACTED
...
func (c *UsageLogClient) Create() *UsageLogCreate {
	...
	return &UsageLogCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UsageLogClient) CreateBulk(builders ...*UsageLogCreate) *UsageLogCreateBulk {
	return &UsageLogCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *UsageLogClient) MapCreateBulk(slice any, setFunc func(*UsageLogCreate, int)) *UsageLogCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &UsageLogCreateBulk{err: fmt.Errorf("calling to UsageLogClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *UsageLogClient) Update() *UsageLogUpdate {
	...
	return &UsageLogUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UsageLogClient) UpdateOne(_m *UsageLog) *UsageLogUpdateOne {
	...
	return &UsageLogUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UsageLogClient) Delete() *UsageLogDelete {
	...
	return &UsageLogDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UsageLogClient) DeleteOneID(id int64) *UsageLogDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &UsageLogDeleteOne{builderREDACTED
REDACTED
...
func (c *UsageLogClient) Query() *UsageLogQuery {
	return &UsageLogQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeUsageLogREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *UsageLogClient) mutate(ctx context.Context, m *UsageLogMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&UsageLogCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&UsageLogUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&UsageLogUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&UsageLogDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewUserClient(c config) *UserClient {
	return &UserClient{config: cREDACTED
REDACTED
...
func (c *UserClient) Create() *UserCreate {
	...
	return &UserCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED

// CreateBulk returns a builder for creating a bulk of User entities.
func (c *UserClient) CreateBulk(builders ...*UserCreate) *UserCreateBulk {
	return &UserCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *UserClient) MapCreateBulk(slice any, setFunc func(*UserCreate, int)) *UserCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &UserCreateBulk{err: fmt.Errorf("calling to UserClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *UserClient) Update() *UserUpdate {
	...
	return &UserUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED

// UpdateOne returns an update builder for the given entity.
func (c *UserClient) UpdateOne(_m *User) *UserUpdateOne {
	mutation := newUserMutation(c.config, OpUpdateOne, withUser(_m))
	return &UserUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserClient) Delete() *UserDelete {
	...
	return &UserDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserClient) DeleteOneID(id int64) *UserDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &UserDeleteOne{builderREDACTED
REDACTED
...
func (c *UserClient) Query() *UserQuery {
	return &UserQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeUserREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *UserClient) QueryPaymentOrders(_m *User) *PaymentOrderQuery {
	query := (&PaymentOrderClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(user.Table, user.FieldID, id),
...
func (c *UserClient) QueryPlatformQuotas(_m *User) *UserPlatformQuotaQuery {
	query := (&UserPlatformQuotaClient{config: c.configREDACTED).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(user.Table, user.FieldID, id),
...
func (c *UserClient) mutate(ctx context.Context, m *UserMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&UserCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&UserUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&UserUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&UserDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewUserAllowedGroupClient(c config) *UserAllowedGroupClient {
	return &UserAllowedGroupClient{config: cREDACTED
REDACTED
...
func (c *UserAllowedGroupClient) Create() *UserAllowedGroupCreate {
	...
	return &UserAllowedGroupCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserAllowedGroupClient) CreateBulk(builders ...*UserAllowedGroupCreate) *UserAllowedGroupCreateBulk {
	return &UserAllowedGroupCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *UserAllowedGroupClient) MapCreateBulk(slice any, setFunc func(*UserAllowedGroupCreate, int)) *UserAllowedGroupCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &UserAllowedGroupCreateBulk{err: fmt.Errorf("calling to UserAllowedGroupClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *UserAllowedGroupClient) Update() *UserAllowedGroupUpdate {
	...
	return &UserAllowedGroupUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserAllowedGroupClient) UpdateOne(_m *UserAllowedGroup) *UserAllowedGroupUpdateOne {
	...
	mutation.group = &_m.GroupID
	return &UserAllowedGroupUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserAllowedGroupClient) Delete() *UserAllowedGroupDelete {
	...
	return &UserAllowedGroupDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserAllowedGroupClient) Query() *UserAllowedGroupQuery {
	return &UserAllowedGroupQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeUserAllowedGroupREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *UserAllowedGroupClient) mutate(ctx context.Context, m *UserAllowedGroupMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&UserAllowedGroupCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&UserAllowedGroupUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&UserAllowedGroupUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
...
func NewUserPlatformQuotaClient(c config) *UserPlatformQuotaClient {
	return &UserPlatformQuotaClient{config: cREDACTED
REDACTED
...
func (c *UserPlatformQuotaClient) Create() *UserPlatformQuotaCreate {
	...
	return &UserPlatformQuotaCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserPlatformQuotaClient) CreateBulk(builders ...*UserPlatformQuotaCreate) *UserPlatformQuotaCreateBulk {
	return &UserPlatformQuotaCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *UserPlatformQuotaClient) MapCreateBulk(slice any, setFunc func(*UserPlatformQuotaCreate, int)) *UserPlatformQuotaCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &UserPlatformQuotaCreateBulk{err: fmt.Errorf("calling to UserPlatformQuotaClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *UserPlatformQuotaClient) Update() *UserPlatformQuotaUpdate {
	...
	return &UserPlatformQuotaUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserPlatformQuotaClient) UpdateOne(_m *UserPlatformQuota) *UserPlatformQuotaUpdateOne {
	...
	return &UserPlatformQuotaUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserPlatformQuotaClient) Delete() *UserPlatformQuotaDelete {
	...
	return &UserPlatformQuotaDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserPlatformQuotaClient) DeleteOneID(id int64) *UserPlatformQuotaDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &UserPlatformQuotaDeleteOne{builderREDACTED
REDACTED
...
func (c *UserPlatformQuotaClient) Query() *UserPlatformQuotaQuery {
	return &UserPlatformQuotaQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeUserPlatformQuotaREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *UserPlatformQuotaClient) mutate(ctx context.Context, m *UserPlatformQuotaMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&UserPlatformQuotaCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&UserPlatformQuotaUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&UserPlatformQuotaUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&UserPlatformQuotaDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
...
func NewUserSubscriptionClient(c config) *UserSubscriptionClient {
	return &UserSubscriptionClient{config: cREDACTED
REDACTED
...
func (c *UserSubscriptionClient) Create() *UserSubscriptionCreate {
	...
	return &UserSubscriptionCreate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserSubscriptionClient) CreateBulk(builders ...*UserSubscriptionCreate) *UserSubscriptionCreateBulk {
	return &UserSubscriptionCreateBulk{config: c.config, builders: buildersREDACTED
REDACTED
...
func (c *UserSubscriptionClient) MapCreateBulk(slice any, setFunc func(*UserSubscriptionCreate, int)) *UserSubscriptionCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &UserSubscriptionCreateBulk{err: fmt.Errorf("calling to UserSubscriptionClient.MapCreateBulk with wrong type %T, need slice", slice)REDACTED
REDACTED
...
func (c *UserSubscriptionClient) Update() *UserSubscriptionUpdate {
	...
	return &UserSubscriptionUpdate{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserSubscriptionClient) UpdateOne(_m *UserSubscription) *UserSubscriptionUpdateOne {
	...
	return &UserSubscriptionUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserSubscriptionClient) Delete() *UserSubscriptionDelete {
	...
	return &UserSubscriptionDelete{config: c.config, hooks: c.Hooks(), mutation: mutationREDACTED
REDACTED
...
func (c *UserSubscriptionClient) DeleteOneID(id int64) *UserSubscriptionDeleteOne {
	...
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &UserSubscriptionDeleteOne{builderREDACTED
REDACTED
...
func (c *UserSubscriptionClient) Query() *UserSubscriptionQuery {
	return &UserSubscriptionQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeUserSubscriptionREDACTED,
		inters: c.Interceptors(),
REDACTED
REDACTED
...
func (c *UserSubscriptionClient) mutate(ctx context.Context, m *UserSubscriptionMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&UserSubscriptionCreate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdate:
		return (&UserSubscriptionUpdate{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpUpdateOne:
		return (&UserSubscriptionUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&UserSubscriptionDelete{config: c.config, hooks: c.Hooks(), mutation: mREDACTED).Exec(ctx)
	default:
