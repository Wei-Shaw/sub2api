...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			cacheinvalidationoutbox.Table:       cacheinvalidationoutbox.ValidColumn,
			...
			userpoolgroupgrant.Table:            userpoolgroupgrant.ValidColumn,
			userpoolmember.Table:                userpoolmember.ValidColumn,
