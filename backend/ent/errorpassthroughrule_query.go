...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{errorpassthroughrule.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{errorpassthroughrule.LabelREDACTED
	default:
		return nil, &NotSingularError{errorpassthroughrule.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{errorpassthroughrule.LabelREDACTED
	default:
		err = &NotSingularError{errorpassthroughrule.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &ErrorPassthroughRuleQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]errorpassthroughrule.OrderOption{REDACTED, _q.order...),
		inters:     append([]Interceptor{REDACTED, _q.inters...),
		predicates: append([]predicate.ErrorPassthroughRule{REDACTED, _q.predicates...),
...
func (_q *ErrorPassthroughRuleQuery) GroupBy(field string, fields ...string) *ErrorPassthroughRuleGroupBy {
	...
	grbuild := &ErrorPassthroughRuleGroupBy{build: _qREDACTED
...
func (_q *ErrorPassthroughRuleQuery) Select(fields ...string) *ErrorPassthroughRuleSelect {
	...
	sbuild := &ErrorPassthroughRuleSelect{ErrorPassthroughRuleQuery: _qREDACTED
...
func (_q *ErrorPassthroughRuleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ErrorPassthroughRule, error) {
	var (
		nodes = []*ErrorPassthroughRule{REDACTED
		_spec = _q.querySpec()
	)
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &ErrorPassthroughRule{config: _q.configREDACTED
