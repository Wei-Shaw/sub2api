...
type GroupEdges struct {
	...
	// BillingPoolMemberships holds the value of the billing_pool_memberships edge.
	BillingPoolMemberships []*BillingPoolGroup `json:"billing_pool_memberships,omitempty"`
...
// BillingPoolMembershipsOrErr returns the BillingPoolMemberships value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) BillingPoolMembershipsOrErr() ([]*BillingPoolGroup, error) {
	if e.loadedTypes[1] {
		return e.BillingPoolMemberships, nil
	}
	return nil, &NotLoadedError{edge: "billing_pool_memberships"}
}
...
// QueryBillingPoolMemberships queries the "billing_pool_memberships" edge of the Group entity.
func (_m *Group) QueryBillingPoolMemberships() *BillingPoolGroupQuery {
	return NewGroupClient(_m.config).QueryBillingPoolMemberships(_m)
}
