...
type GroupEdges struct {
	...
	// PoolGrants holds the value of the pool_grants edge.
	PoolGrants []*UserPoolGroupGrant `json:"pool_grants,omitempty"`
...
// was not loaded in eager-loading.
func (e GroupEdges) UserPoolsOrErr() ([]*UserPool, error) {
	if e.loadedTypes[6] {
...
// PoolGrantsOrErr returns the PoolGrants value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) PoolGrantsOrErr() ([]*UserPoolGroupGrant, error) {
	if e.loadedTypes[9] {
		return e.PoolGrants, nil
	}
	return nil, &NotLoadedError{edge: "pool_grants"}
}
...
// QueryUserPools queries the "user_pools" edge of the Group entity.
func (_m *Group) QueryUserPools() *UserPoolQuery {
	return NewGroupClient(_m.config).QueryUserPools(_m)
}
...
// QueryPoolGrants queries the "pool_grants" edge of the Group entity.
func (_m *Group) QueryPoolGrants() *UserPoolGroupGrantQuery {
	return NewGroupClient(_m.config).QueryPoolGrants(_m)
}
