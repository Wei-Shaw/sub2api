...
var (
	...
	AccountsPrimaryKey = []string{"account_id", "group_id"REDACTED
	...
	AllowedUsersPrimaryKey = []string{"user_id", "group_id"REDACTED
)
...
func ByAccounts(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newAccountsStep(), append([]sql.OrderTerm{termREDACTED, terms...)...)
REDACTED
REDACTED
...
func ByAllowedUsers(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newAllowedUsersStep(), append([]sql.OrderTerm{termREDACTED, terms...)...)
REDACTED
REDACTED
...
func ByAccountGroups(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newAccountGroupsStep(), append([]sql.OrderTerm{termREDACTED, terms...)...)
REDACTED
REDACTED
