...
const (
	...
	// FieldJshandlerScriptIds holds the string denoting the jshandler_script_ids field in the database.
	FieldJshandlerScriptIds = "jshandler_script_ids"
