...
REDACTED
	if v, ok := _c.mutation.DuplicateOperationID(); ok {
		if err := group.DuplicateOperationIDValidator(v); err != nil {
			return &ValidationError{Name: "duplicate_operation_id", err: fmt.Errorf(`ent: validator failed for field "Group.duplicate_operation_id": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.Platform(); !ok {
...
REDACTED
	if _, ok := _c.mutation.VideoRateIndependent(); !ok {
		return &ValidationError{Name: "video_rate_independent", err: errors.New(`ent: missing required field "Group.video_rate_independent"`)REDACTED
REDACTED
	if _, ok := _c.mutation.VideoRateMultiplier(); !ok {
...
REDACTED
	if _, ok := _c.mutation.LongContextPricingEnabled(); !ok {
		return &ValidationError{Name: "long_context_pricing_enabled", err: errors.New(`ent: missing required field "Group.long_context_pricing_enabled"`)REDACTED
REDACTED
	if _, ok := _c.mutation.ClaudeCodeOnly(); !ok {
...
REDACTED
	if _, ok := _c.mutation.AllowLive(); !ok {
		return &ValidationError{Name: "allow_live", err: errors.New(`ent: missing required field "Group.allow_live"`)REDACTED
REDACTED
	if _, ok := _c.mutation.RequireOauthOnly(); !ok {
...
REDACTED
	if _, ok := _c.mutation.MaxReasoningEffort(); !ok {
		return &ValidationError{Name: "max_reasoning_effort", err: errors.New(`ent: missing required field "Group.max_reasoning_effort"`)REDACTED
REDACTED
	if v, ok := _c.mutation.MaxReasoningEffort(); ok {
		if err := group.MaxReasoningEffortValidator(v); err != nil {
			return &ValidationError{Name: "max_reasoning_effort", err: fmt.Errorf(`ent: validator failed for field "Group.max_reasoning_effort": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.ReasoningEffortMappings(); !ok {
