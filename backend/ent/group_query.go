...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{group.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	if len(ids) == 0 {
		err = &NotFoundError{group.LabelREDACTED
		return
REDACTED
	return ids[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{group.LabelREDACTED
	default:
		return nil, &NotSingularError{group.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{group.LabelREDACTED
	default:
		err = &NotSingularError{group.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &GroupQuery{
		config:                _q.config,
		ctx:                   _q.ctx.Clone(),
		order:                 append([]group.OrderOption{REDACTED, _q.order...),
		inters:                append([]Interceptor{REDACTED, _q.inters...),
		predicates:            append([]predicate.Group{REDACTED, _q.predicates...),
...
func (_q *GroupQuery) GroupBy(field string, fields ...string) *GroupGroupBy {
	...
	grbuild := &GroupGroupBy{build: _qREDACTED
...
func (_q *GroupQuery) Select(fields ...string) *GroupSelect {
	...
	sbuild := &GroupSelect{GroupQuery: _qREDACTED
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &Group{config: _q.configREDACTED
...
REDACTED
	if query := _q.withRedeemCodes; query != nil {
		if err := _q.loadRedeemCodes(ctx, query, nodes,
			func(n *Group) { n.Edges.RedeemCodes = []*RedeemCode{REDACTED REDACTED,
			func(n *Group, e *RedeemCode) { n.Edges.RedeemCodes = append(n.Edges.RedeemCodes, e) REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	if query := _q.withSubscriptions; query != nil {
		if err := _q.loadSubscriptions(ctx, query, nodes,
			func(n *Group) { n.Edges.Subscriptions = []*UserSubscription{REDACTED REDACTED,
			func(n *Group, e *UserSubscription) { n.Edges.Subscriptions = append(n.Edges.Subscriptions, e) REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	if query := _q.withUsageLogs; query != nil {
		if err := _q.loadUsageLogs(ctx, query, nodes,
			func(n *Group) { n.Edges.UsageLogs = []*UsageLog{REDACTED REDACTED,
			func(n *Group, e *UsageLog) { n.Edges.UsageLogs = append(n.Edges.UsageLogs, e) REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	if query := _q.withAccounts; query != nil {
		if err := _q.loadAccounts(ctx, query, nodes,
			func(n *Group) { n.Edges.Accounts = []*Account{REDACTED REDACTED,
			func(n *Group, e *Account) { n.Edges.Accounts = append(n.Edges.Accounts, e) REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	if query := _q.withAllowedUsers; query != nil {
		if err := _q.loadAllowedUsers(ctx, query, nodes,
			func(n *Group) { n.Edges.AllowedUsers = []*User{REDACTED REDACTED,
			func(n *Group, e *User) { n.Edges.AllowedUsers = append(n.Edges.AllowedUsers, e) REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	if query := _q.withAccountGroups; query != nil {
		if err := _q.loadAccountGroups(ctx, query, nodes,
			func(n *Group) { n.Edges.AccountGroups = []*AccountGroup{REDACTED REDACTED,
			func(n *Group, e *AccountGroup) { n.Edges.AccountGroups = append(n.Edges.AccountGroups, e) REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	if query := _q.withUserAllowedGroups; query != nil {
		if err := _q.loadUserAllowedGroups(ctx, query, nodes,
			func(n *Group) { n.Edges.UserAllowedGroups = []*UserAllowedGroup{REDACTED REDACTED,
			func(n *Group, e *UserAllowedGroup) { n.Edges.UserAllowedGroups = append(n.Edges.UserAllowedGroups, e) REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	return nodes, nil
...
func (_q *GroupQuery) loadAccounts(ctx context.Context, query *AccountQuery, nodes []*Group, init func(*Group), assign func(*Group, *Account)) error {
	...
	nids := make(map[int64]map[*Group]struct{REDACTED)
	...
	qr := QuerierFunc(func(ctx context.Context, q Query) (Value, error) {
		...
		REDACTED
			spec.Assign = func(columns []string, values []any) error {
				...
				if nids[inValue] == nil {
					nids[inValue] = map[*Group]struct{REDACTED{byID[outValue]: {REDACTEDREDACTED
