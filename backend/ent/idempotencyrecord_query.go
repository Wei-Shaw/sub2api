...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{idempotencyrecord.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{idempotencyrecord.LabelREDACTED
	default:
		return nil, &NotSingularError{idempotencyrecord.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{idempotencyrecord.LabelREDACTED
	default:
		err = &NotSingularError{idempotencyrecord.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &IdempotencyRecordQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]idempotencyrecord.OrderOption{REDACTED, _q.order...),
		inters:     append([]Interceptor{REDACTED, _q.inters...),
		predicates: append([]predicate.IdempotencyRecord{REDACTED, _q.predicates...),
...
func (_q *IdempotencyRecordQuery) GroupBy(field string, fields ...string) *IdempotencyRecordGroupBy {
	...
	grbuild := &IdempotencyRecordGroupBy{build: _qREDACTED
...
func (_q *IdempotencyRecordQuery) Select(fields ...string) *IdempotencyRecordSelect {
	...
	sbuild := &IdempotencyRecordSelect{IdempotencyRecordQuery: _qREDACTED
...
func (_q *IdempotencyRecordQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*IdempotencyRecord, error) {
	var (
		nodes = []*IdempotencyRecord{REDACTED
		_spec = _q.querySpec()
	)
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &IdempotencyRecord{config: _q.configREDACTED
