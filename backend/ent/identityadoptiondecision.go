...
REDACTED else if e.loadedTypes[0] {
		return nil, &NotFoundError{label: pendingauthsession.LabelREDACTED
REDACTED
	return nil, &NotLoadedError{edge: "pending_auth_session"REDACTED
REDACTED
...
REDACTED else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: authidentity.LabelREDACTED
REDACTED
	return nil, &NotLoadedError{edge: "identity"REDACTED
REDACTED
