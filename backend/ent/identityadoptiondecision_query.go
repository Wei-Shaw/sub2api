...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{identityadoptiondecision.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{identityadoptiondecision.LabelREDACTED
	default:
		return nil, &NotSingularError{identityadoptiondecision.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{identityadoptiondecision.LabelREDACTED
	default:
		err = &NotSingularError{identityadoptiondecision.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &IdentityAdoptionDecisionQuery{
		config:                 _q.config,
		ctx:                    _q.ctx.Clone(),
		order:                  append([]identityadoptiondecision.OrderOption{REDACTED, _q.order...),
		inters:                 append([]Interceptor{REDACTED, _q.inters...),
		predicates:             append([]predicate.IdentityAdoptionDecision{REDACTED, _q.predicates...),
...
func (_q *IdentityAdoptionDecisionQuery) GroupBy(field string, fields ...string) *IdentityAdoptionDecisionGroupBy {
	...
	grbuild := &IdentityAdoptionDecisionGroupBy{build: _qREDACTED
...
func (_q *IdentityAdoptionDecisionQuery) Select(fields ...string) *IdentityAdoptionDecisionSelect {
	...
	sbuild := &IdentityAdoptionDecisionSelect{IdentityAdoptionDecisionQuery: _qREDACTED
...
func (_q *IdentityAdoptionDecisionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*IdentityAdoptionDecision, error) {
	var (
		nodes       = []*IdentityAdoptionDecision{REDACTED
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &IdentityAdoptionDecision{config: _q.configREDACTED
...
REDACTED
	if query := _q.withPendingAuthSession; query != nil {
		if err := _q.loadPendingAuthSession(ctx, query, nodes, nil,
			func(n *IdentityAdoptionDecision, e *PendingAuthSession) { n.Edges.PendingAuthSession = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	if query := _q.withIdentity; query != nil {
		if err := _q.loadIdentity(ctx, query, nodes, nil,
			func(n *IdentityAdoptionDecision, e *AuthIdentity) { n.Edges.Identity = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	return nodes, nil
