...
const (
	// Label holds the string label denoting the innerapiapp type in the database.
	Label = "inner_api_app"
	...
	// Table holds the table name of the innerapiapp in the database.
	Table = "inner_api_apps"
)

// Columns holds all SQL columns for innerapiapp fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the InnerAPIApp queries.
