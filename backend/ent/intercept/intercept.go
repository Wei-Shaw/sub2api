...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.SoraAccountQuery:
		return &query[*ent.SoraAccountQuery, predicate.SoraAccount, soraaccount.OrderOption]{typ: ent.TypeSoraAccount, tq: qREDACTED, nil
	case *ent.SoraCacheFileQuery:
		return &query[*ent.SoraCacheFileQuery, predicate.SoraCacheFile, soracachefile.OrderOption]{typ: ent.TypeSoraCacheFile, tq: qREDACTED, nil
	case *ent.SoraTaskQuery:
		return &query[*ent.SoraTaskQuery, predicate.SoraTask, soratask.OrderOption]{typ: ent.TypeSoraTask, tq: qREDACTED, nil
	case *ent.SoraUsageStatQuery:
		return &query[*ent.SoraUsageStatQuery, predicate.SoraUsageStat, sorausagestat.OrderOption]{typ: ent.TypeSoraUsageStat, tq: qREDACTED, nil
