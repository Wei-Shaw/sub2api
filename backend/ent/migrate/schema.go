...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "routing_mode", Type: field.TypeString, Size: 32, Default: "fixed"},
		{Name: "auto_candidate_group_ids", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "auto_group_id", Type: field.TypeInt64, Nullable: true},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usagelog_auto_group_id_created_at",
				Unique:  false,
