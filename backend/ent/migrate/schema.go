...
var (
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "trial_balance", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "trial_balance_expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "concurrency", Type: field.TypeInt, Default: 5},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "registration_ip", Type: field.TypeString, Size: 64, Default: ""},
