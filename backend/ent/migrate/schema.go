...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "routing_effective_model", Type: field.TypeString, Nullable: true, Size: 100},
		{Name: "routing_failover_count", Type: field.TypeInt, Nullable: true},
		{Name: "routing_failover_final_reason", Type: field.TypeString, Nullable: true, Size: 128},
		...
		{Name: "priority_account_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "effective_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "effective_input_unit_price", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "effective_output_unit_price", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "effective_cache_read_unit_price", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "pricing_source", Type: field.TypeString, Nullable: true, Size: 255},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usagelog_routing_target_group",
				Unique:  false,
