...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{paymentauditlog.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{paymentauditlog.LabelREDACTED
	default:
		return nil, &NotSingularError{paymentauditlog.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{paymentauditlog.LabelREDACTED
	default:
		err = &NotSingularError{paymentauditlog.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &PaymentAuditLogQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]paymentauditlog.OrderOption{REDACTED, _q.order...),
		inters:     append([]Interceptor{REDACTED, _q.inters...),
		predicates: append([]predicate.PaymentAuditLog{REDACTED, _q.predicates...),
...
func (_q *PaymentAuditLogQuery) GroupBy(field string, fields ...string) *PaymentAuditLogGroupBy {
	...
	grbuild := &PaymentAuditLogGroupBy{build: _qREDACTED
...
func (_q *PaymentAuditLogQuery) Select(fields ...string) *PaymentAuditLogSelect {
	...
	sbuild := &PaymentAuditLogSelect{PaymentAuditLogQuery: _qREDACTED
...
func (_q *PaymentAuditLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*PaymentAuditLog, error) {
	var (
		nodes = []*PaymentAuditLog{REDACTED
		_spec = _q.querySpec()
	)
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &PaymentAuditLog{config: _q.configREDACTED
