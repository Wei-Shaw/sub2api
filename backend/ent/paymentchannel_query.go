...
func (_q *PaymentChannelQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PaymentChannelQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *PaymentChannelQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PaymentChannelQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *PaymentChannelQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *PaymentChannelQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(paymentchannel.FieldGroupID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.PaymentChannel.Query().
//		Select(paymentchannel.FieldGroupID).
//		Scan(ctx, &v)
...
func (_q *PaymentChannelQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(paymentchannel.Table, paymentchannel.Columns, sqlgraph.NewFieldSpec(paymentchannel.FieldID, field.TypeInt64))
	_spec.From = _q.sql
...
func (_q *PaymentChannelQuery) ForUpdate(opts ...sql.LockOption) *PaymentChannelQuery {
...
func (_q *PaymentChannelQuery) ForShare(opts ...sql.LockOption) *PaymentChannelQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
