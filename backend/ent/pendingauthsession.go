...
type PendingAuthSession struct {
	...
	UpstreamIdentityClaims map[string]interface{REDACTED `json:"upstream_identity_claims,omitempty"`
	// LocalFlowState holds the value of the "local_flow_state" field.
	LocalFlowState map[string]interface{REDACTED `json:"local_flow_state,omitempty"`
...
REDACTED
	return nil, &NotLoadedError{edge: "target_user"REDACTED
REDACTED
...
REDACTED else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: identityadoptiondecision.LabelREDACTED
REDACTED
	return nil, &NotLoadedError{edge: "adoption_decision"REDACTED
REDACTED
