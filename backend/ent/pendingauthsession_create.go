...
func (_c *PendingAuthSessionCreate) SetUpstreamIdentityClaims(v map[string]interface{REDACTED) *PendingAuthSessionCreate {
	_c.mutation.SetUpstreamIdentityClaims(v)
	return _c
REDACTED

// SetLocalFlowState sets the "local_flow_state" field.
func (_c *PendingAuthSessionCreate) SetLocalFlowState(v map[string]interface{REDACTED) *PendingAuthSessionCreate {
...
func (_c *PendingAuthSessionCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "PendingAuthSession.created_at"`)REDACTED
REDACTED
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "PendingAuthSession.updated_at"`)REDACTED
REDACTED
	if _, ok := _c.mutation.SessionToken(); !ok {
		return &ValidationError{Name: "session_token", err: errors.New(`ent: missing required field "PendingAuthSession.session_token"`)REDACTED
REDACTED
...
REDACTED
	if _, ok := _c.mutation.Intent(); !ok {
		return &ValidationError{Name: "intent", err: errors.New(`ent: missing required field "PendingAuthSession.intent"`)REDACTED
REDACTED
...
REDACTED
	if _, ok := _c.mutation.ProviderType(); !ok {
		return &ValidationError{Name: "provider_type", err: errors.New(`ent: missing required field "PendingAuthSession.provider_type"`)REDACTED
REDACTED
...
REDACTED
	if _, ok := _c.mutation.ProviderKey(); !ok {
		return &ValidationError{Name: "provider_key", err: errors.New(`ent: missing required field "PendingAuthSession.provider_key"`)REDACTED
REDACTED
...
REDACTED
	if _, ok := _c.mutation.ProviderSubject(); !ok {
		return &ValidationError{Name: "provider_subject", err: errors.New(`ent: missing required field "PendingAuthSession.provider_subject"`)REDACTED
REDACTED
...
REDACTED
	if _, ok := _c.mutation.RedirectTo(); !ok {
		return &ValidationError{Name: "redirect_to", err: errors.New(`ent: missing required field "PendingAuthSession.redirect_to"`)REDACTED
REDACTED
	if _, ok := _c.mutation.ResolvedEmail(); !ok {
		return &ValidationError{Name: "resolved_email", err: errors.New(`ent: missing required field "PendingAuthSession.resolved_email"`)REDACTED
REDACTED
	if _, ok := _c.mutation.RegistrationPasswordHash(); !ok {
		return &ValidationError{Name: "registration_password_hash", err: errors.New(`ent: missing required field "PendingAuthSession.registration_password_hash"`)REDACTED
REDACTED
	if _, ok := _c.mutation.UpstreamIdentityClaims(); !ok {
		return &ValidationError{Name: "upstream_identity_claims", err: errors.New(`ent: missing required field "PendingAuthSession.upstream_identity_claims"`)REDACTED
REDACTED
	if _, ok := _c.mutation.LocalFlowState(); !ok {
		return &ValidationError{Name: "local_flow_state", err: errors.New(`ent: missing required field "PendingAuthSession.local_flow_state"`)REDACTED
REDACTED
	if _, ok := _c.mutation.BrowserSessionKey(); !ok {
		return &ValidationError{Name: "browser_session_key", err: errors.New(`ent: missing required field "PendingAuthSession.browser_session_key"`)REDACTED
REDACTED
	if _, ok := _c.mutation.CompletionCodeHash(); !ok {
		return &ValidationError{Name: "completion_code_hash", err: errors.New(`ent: missing required field "PendingAuthSession.completion_code_hash"`)REDACTED
REDACTED
	if _, ok := _c.mutation.ExpiresAt(); !ok {
		return &ValidationError{Name: "expires_at", err: errors.New(`ent: missing required field "PendingAuthSession.expires_at"`)REDACTED
REDACTED
	return nil
REDACTED
...
func (_c *PendingAuthSessionCreate) createSpec() (*PendingAuthSession, *sqlgraph.CreateSpec) {
	var (
		_node = &PendingAuthSession{config: _c.configREDACTED
...
// SetUpstreamIdentityClaims sets the "upstream_identity_claims" field.
func (u *PendingAuthSessionUpsert) SetUpstreamIdentityClaims(v map[string]interface{REDACTED) *PendingAuthSessionUpsert {
...
// SetLocalFlowState sets the "local_flow_state" field.
func (u *PendingAuthSessionUpsert) SetLocalFlowState(v map[string]interface{REDACTED) *PendingAuthSessionUpsert {
...
func (u *PendingAuthSessionUpsertOne) Update(set func(*PendingAuthSessionUpsert)) *PendingAuthSessionUpsertOne {
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(update *sql.UpdateSet) {
		set(&PendingAuthSessionUpsert{UpdateSet: updateREDACTED)
REDACTED))
	return u
REDACTED
...
// SetUpstreamIdentityClaims sets the "upstream_identity_claims" field.
func (u *PendingAuthSessionUpsertOne) SetUpstreamIdentityClaims(v map[string]interface{REDACTED) *PendingAuthSessionUpsertOne {
	return u.Update(func(s *PendingAuthSessionUpsert) {
...
// SetLocalFlowState sets the "local_flow_state" field.
func (u *PendingAuthSessionUpsertOne) SetLocalFlowState(v map[string]interface{REDACTED) *PendingAuthSessionUpsertOne {
	return u.Update(func(s *PendingAuthSessionUpsert) {
...
// SetUpstreamIdentityClaims sets the "upstream_identity_claims" field.
func (u *PendingAuthSessionUpsertBulk) SetUpstreamIdentityClaims(v map[string]interface{REDACTED) *PendingAuthSessionUpsertBulk {
	return u.Update(func(s *PendingAuthSessionUpsert) {
		s.SetUpstreamIdentityClaims(v)
REDACTED)
REDACTED
...
// SetLocalFlowState sets the "local_flow_state" field.
func (u *PendingAuthSessionUpsertBulk) SetLocalFlowState(v map[string]interface{REDACTED) *PendingAuthSessionUpsertBulk {
	return u.Update(func(s *PendingAuthSessionUpsert) {
		s.SetLocalFlowState(v)
REDACTED)
REDACTED
