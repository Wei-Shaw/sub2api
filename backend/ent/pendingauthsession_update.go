...
func (_u *PendingAuthSessionUpdate) SetUpstreamIdentityClaims(v map[string]interface{REDACTED) *PendingAuthSessionUpdate {
	_u.mutation.SetUpstreamIdentityClaims(v)
	return _u
REDACTED

// SetLocalFlowState sets the "local_flow_state" field.
func (_u *PendingAuthSessionUpdate) SetLocalFlowState(v map[string]interface{REDACTED) *PendingAuthSessionUpdate {
...
func (_u *PendingAuthSessionUpdate) check() error {
	if v, ok := _u.mutation.SessionToken(); ok {
		if err := pendingauthsession.SessionTokenValidator(v); err != nil {
			return &ValidationError{Name: "session_token", err: fmt.Errorf(`ent: validator failed for field "PendingAuthSession.session_token": %w`, err)REDACTED
	REDACTED
REDACTED
	if v, ok := _u.mutation.Intent(); ok {
		if err := pendingauthsession.IntentValidator(v); err != nil {
			return &ValidationError{Name: "intent", err: fmt.Errorf(`ent: validator failed for field "PendingAuthSession.intent": %w`, err)REDACTED
	REDACTED
REDACTED
	if v, ok := _u.mutation.ProviderType(); ok {
		if err := pendingauthsession.ProviderTypeValidator(v); err != nil {
			return &ValidationError{Name: "provider_type", err: fmt.Errorf(`ent: validator failed for field "PendingAuthSession.provider_type": %w`, err)REDACTED
	REDACTED
REDACTED
	if v, ok := _u.mutation.ProviderKey(); ok {
		if err := pendingauthsession.ProviderKeyValidator(v); err != nil {
			return &ValidationError{Name: "provider_key", err: fmt.Errorf(`ent: validator failed for field "PendingAuthSession.provider_key": %w`, err)REDACTED
	REDACTED
REDACTED
	if v, ok := _u.mutation.ProviderSubject(); ok {
		if err := pendingauthsession.ProviderSubjectValidator(v); err != nil {
			return &ValidationError{Name: "provider_subject", err: fmt.Errorf(`ent: validator failed for field "PendingAuthSession.provider_subject": %w`, err)REDACTED
	REDACTED
REDACTED
	return nil
REDACTED
...
REDACTED
	if _u.mutation.TargetUserCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{pendingauthsession.TargetUserColumnREDACTED,
			Bidi:    false,
...
REDACTED
	if _u.mutation.AdoptionDecisionCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{pendingauthsession.AdoptionDecisionColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
REDACTED
	if _node, err = sqlgraph.UpdateNodes(ctx, _u.driver, _spec); err != nil {
		if _, ok := err.(*sqlgraph.NotFoundError); ok {
			err = &NotFoundError{pendingauthsession.LabelREDACTED
...
// SetUpstreamIdentityClaims sets the "upstream_identity_claims" field.
func (_u *PendingAuthSessionUpdateOne) SetUpstreamIdentityClaims(v map[string]interface{REDACTED) *PendingAuthSessionUpdateOne {
	_u.mutation.SetUpstreamIdentityClaims(v)
	return _u
REDACTED

// SetLocalFlowState sets the "local_flow_state" field.
func (_u *PendingAuthSessionUpdateOne) SetLocalFlowState(v map[string]interface{REDACTED) *PendingAuthSessionUpdateOne {
	_u.mutation.SetLocalFlowState(v)
	return _u
REDACTED
...
REDACTED
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "PendingAuthSession.id" for update`)REDACTED
REDACTED
...
REDACTED
	...
	REDACTED
		_spec.Edges.Add = append(_spec.Edges.Add, edge)
REDACTED
	_node = &PendingAuthSession{config: _u.configREDACTED
