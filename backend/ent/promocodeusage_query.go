...
func (_q *PromoCodeUsageQuery) QueryPromoCode() *PromoCodeQuery {
	query := (&PromoCodeClient{config: _q.configREDACTED).Query()
...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{promocodeusage.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{promocodeusage.LabelREDACTED
	default:
		return nil, &NotSingularError{promocodeusage.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{promocodeusage.LabelREDACTED
	default:
		err = &NotSingularError{promocodeusage.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &PromoCodeUsageQuery{
		config:        _q.config,
		ctx:           _q.ctx.Clone(),
		order:         append([]promocodeusage.OrderOption{REDACTED, _q.order...),
		inters:        append([]Interceptor{REDACTED, _q.inters...),
		predicates:    append([]predicate.PromoCodeUsage{REDACTED, _q.predicates...),
...
func (_q *PromoCodeUsageQuery) GroupBy(field string, fields ...string) *PromoCodeUsageGroupBy {
	...
	grbuild := &PromoCodeUsageGroupBy{build: _qREDACTED
...
func (_q *PromoCodeUsageQuery) Select(fields ...string) *PromoCodeUsageSelect {
	...
	sbuild := &PromoCodeUsageSelect{PromoCodeUsageQuery: _qREDACTED
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &PromoCodeUsage{config: _q.configREDACTED
...
REDACTED
	if query := _q.withPromoCode; query != nil {
		if err := _q.loadPromoCode(ctx, query, nodes, nil,
			func(n *PromoCodeUsage, e *PromoCode) { n.Edges.PromoCode = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *PromoCodeUsage, e *User) { n.Edges.User = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	return nodes, nil
