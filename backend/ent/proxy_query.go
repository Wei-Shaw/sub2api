...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{proxy.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{proxy.LabelREDACTED
	default:
		return nil, &NotSingularError{proxy.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{proxy.LabelREDACTED
	default:
		err = &NotSingularError{proxy.LabelREDACTED
REDACTED
	return
REDACTED
...
func (_q *ProxyQuery) GroupBy(field string, fields ...string) *ProxyGroupBy {
	...
	grbuild := &ProxyGroupBy{build: _qREDACTED
...
func (_q *ProxyQuery) Select(fields ...string) *ProxySelect {
	...
	sbuild := &ProxySelect{ProxyQuery: _qREDACTED
...
REDACTED
	if query := _q.withBackupProxy; query != nil {
		if err := _q.loadBackupProxy(ctx, query, nodes, nil,
			func(n *Proxy, e *Proxy) { n.Edges.BackupProxy = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	return nodes, nil
