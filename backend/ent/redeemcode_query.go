...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{redeemcode.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{redeemcode.LabelREDACTED
	default:
		return nil, &NotSingularError{redeemcode.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{redeemcode.LabelREDACTED
	default:
		err = &NotSingularError{redeemcode.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &RedeemCodeQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]redeemcode.OrderOption{REDACTED, _q.order...),
		inters:     append([]Interceptor{REDACTED, _q.inters...),
		predicates: append([]predicate.RedeemCode{REDACTED, _q.predicates...),
...
func (_q *RedeemCodeQuery) GroupBy(field string, fields ...string) *RedeemCodeGroupBy {
	...
	grbuild := &RedeemCodeGroupBy{build: _qREDACTED
...
func (_q *RedeemCodeQuery) Select(fields ...string) *RedeemCodeSelect {
	...
	sbuild := &RedeemCodeSelect{RedeemCodeQuery: _qREDACTED
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &RedeemCode{config: _q.configREDACTED
...
REDACTED
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *RedeemCode, e *User) { n.Edges.User = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	if query := _q.withGroup; query != nil {
		if err := _q.loadGroup(ctx, query, nodes, nil,
			func(n *RedeemCode, e *Group) { n.Edges.Group = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	return nodes, nil
