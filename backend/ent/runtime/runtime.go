...
func init() {
	...
	// userDescCashBalance is the schema descriptor for cash_balance field.
	userDescCashBalance := userFields[4].Descriptor()
	// user.DefaultCashBalance holds the default value on creation for the cash_balance field.
	user.DefaultCashBalance = userDescCashBalance.Default.(float64)
	...
	usersubscriptionDescFiveHourUsageUsd := usersubscriptionFields[10].Descriptor()
