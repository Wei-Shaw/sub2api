...
func init() {
	...
	// apikeyDescCodexResponsesStreamCompat is the schema descriptor for codex_responses_stream_compat field.
	apikeyDescCodexResponsesStreamCompat := apikeyFields[8].Descriptor()
	// apikey.DefaultCodexResponsesStreamCompat holds the default value on creation for the codex_responses_stream_compat field.
	apikey.DefaultCodexResponsesStreamCompat = apikeyDescCodexResponsesStreamCompat.Default.(bool)
