...
func init() {
	...
	apikeyplatformusageMixin := schema.APIKeyPlatformUsage{}.Mixin()
	apikeyplatformusageMixinFields0 := apikeyplatformusageMixin[0].Fields()
	_ = apikeyplatformusageMixinFields0
	apikeyplatformusageFields := schema.APIKeyPlatformUsage{}.Fields()
	_ = apikeyplatformusageFields
	// apikeyplatformusageDescCreatedAt is the schema descriptor for created_at field.
	apikeyplatformusageDescCreatedAt := apikeyplatformusageMixinFields0[0].Descriptor()
	// apikeyplatformusage.DefaultCreatedAt holds the default value on creation for the created_at field.
	apikeyplatformusage.DefaultCreatedAt = apikeyplatformusageDescCreatedAt.Default.(func() time.Time)
	// apikeyplatformusageDescUpdatedAt is the schema descriptor for updated_at field.
	apikeyplatformusageDescUpdatedAt := apikeyplatformusageMixinFields0[1].Descriptor()
	// apikeyplatformusage.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	apikeyplatformusage.DefaultUpdatedAt = apikeyplatformusageDescUpdatedAt.Default.(func() time.Time)
	// apikeyplatformusage.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	apikeyplatformusage.UpdateDefaultUpdatedAt = apikeyplatformusageDescUpdatedAt.UpdateDefault.(func() time.Time)
	// apikeyplatformusageDescPlatform is the schema descriptor for platform field.
	apikeyplatformusageDescPlatform := apikeyplatformusageFields[1].Descriptor()
	// apikeyplatformusage.PlatformValidator is a validator for the "platform" field. It is called by the builders before save.
	apikeyplatformusage.PlatformValidator = func() func(string) error {
		validators := apikeyplatformusageDescPlatform.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
	...
	// apikeyplatformusageDescQuotaUsed is the schema descriptor for quota_used field.
	apikeyplatformusageDescQuotaUsed := apikeyplatformusageFields[2].Descriptor()
	// apikeyplatformusage.DefaultQuotaUsed holds the default value on creation for the quota_used field.
	apikeyplatformusage.DefaultQuotaUsed = apikeyplatformusageDescQuotaUsed.Default.(float64)
	// apikeyplatformusageDescUsage5h is the schema descriptor for usage_5h field.
	apikeyplatformusageDescUsage5h := apikeyplatformusageFields[3].Descriptor()
	// apikeyplatformusage.DefaultUsage5h holds the default value on creation for the usage_5h field.
	apikeyplatformusage.DefaultUsage5h = apikeyplatformusageDescUsage5h.Default.(float64)
	// apikeyplatformusageDescUsage1d is the schema descriptor for usage_1d field.
	apikeyplatformusageDescUsage1d := apikeyplatformusageFields[4].Descriptor()
	// apikeyplatformusage.DefaultUsage1d holds the default value on creation for the usage_1d field.
	apikeyplatformusage.DefaultUsage1d = apikeyplatformusageDescUsage1d.Default.(float64)
	// apikeyplatformusageDescUsage7d is the schema descriptor for usage_7d field.
	apikeyplatformusageDescUsage7d := apikeyplatformusageFields[5].Descriptor()
	// apikeyplatformusage.DefaultUsage7d holds the default value on creation for the usage_7d field.
	apikeyplatformusage.DefaultUsage7d = apikeyplatformusageDescUsage7d.Default.(float64)
