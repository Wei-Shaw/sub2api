...
func init() {
	...
	// groupDescCcsDefaultModel is the schema descriptor for ccs_default_model field.
	groupDescCcsDefaultModel := groupFields[56].Descriptor()
	// group.DefaultCcsDefaultModel holds the default value on creation for the ccs_default_model field.
	group.DefaultCcsDefaultModel = groupDescCcsDefaultModel.Default.(string)
	// group.CcsDefaultModelValidator is a validator for the "ccs_default_model" field. It is called by the builders before save.
	group.CcsDefaultModelValidator = groupDescCcsDefaultModel.Validators[0].(func(string) error)
