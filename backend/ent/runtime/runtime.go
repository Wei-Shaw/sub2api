...
func init() {
	...
	groupDescQuotaDailyResetMode := groupFields[14].Descriptor()
	...
	groupDescQuotaWeeklyResetMode := groupFields[16].Descriptor()
	...
	groupDescQuotaMonthlyResetMode := groupFields[19].Descriptor()
	...
	groupDescQuotaResetTimezone := groupFields[22].Descriptor()
