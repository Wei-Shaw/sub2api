...
func init() {
	...
	// groupDescMaxSessions is the schema descriptor for max_sessions field.
	groupDescMaxSessions := groupFields[56].Descriptor()
	// group.DefaultMaxSessions holds the default value on creation for the max_sessions field.
	group.DefaultMaxSessions = groupDescMaxSessions.Default.(int)
	// group.MaxSessionsValidator is a validator for the "max_sessions" field. It is called by the builders before save.
	group.MaxSessionsValidator = groupDescMaxSessions.Validators[0].(func(int) error)
