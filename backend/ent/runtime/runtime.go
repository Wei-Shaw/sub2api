...
func init() {
	...
	// userDescExtraConcurrency is the schema descriptor for extra_concurrency field.
	userDescExtraConcurrency := userFields[6].Descriptor()
	// user.DefaultExtraConcurrency holds the default value on creation for the extra_concurrency field.
	user.DefaultExtraConcurrency = userDescExtraConcurrency.Default.(int)
	// user.ExtraConcurrencyValidator is a validator for the "extra_concurrency" field. It is called by the builders before save.
	user.ExtraConcurrencyValidator = userDescExtraConcurrency.Validators[0].(func(int) error)
