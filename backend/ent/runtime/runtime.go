...
func init() {
	...
	groupDescImagePreferFal := groupFields[18].Descriptor()
	...
	groupDescImageDecodeSizeOnRsp := groupFields[19].Descriptor()
	...
	groupDescImageUpscaleOnRsp := groupFields[20].Descriptor()
