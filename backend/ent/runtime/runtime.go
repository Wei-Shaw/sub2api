...
func init() {
	...
	// groupDescEndpointDefaultRoutingEnabled is the schema descriptor for endpoint_default_routing_enabled field.
	groupDescEndpointDefaultRoutingEnabled := groupFields[48].Descriptor()
	// group.DefaultEndpointDefaultRoutingEnabled holds the default value on creation for the endpoint_default_routing_enabled field.
	group.DefaultEndpointDefaultRoutingEnabled = groupDescEndpointDefaultRoutingEnabled.Default.(bool)
