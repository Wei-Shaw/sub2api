...
func init() {
	...
	// groupDescCodexOfficialOnly is the schema descriptor for codex_official_only field.
	groupDescCodexOfficialOnly := groupFields[20].Descriptor()
	// group.DefaultCodexOfficialOnly holds the default value on creation for the codex_official_only field.
	group.DefaultCodexOfficialOnly = groupDescCodexOfficialOnly.Default.(bool)
