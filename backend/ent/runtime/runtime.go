...
func init() {
	...
	customdomain.StatusValidator = func() func(string) error {
		validators := customdomainDescStatus.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	customdomainDescAllUsers := customdomainFields[3].Descriptor()
	...
	customdomain.CnameTargetValidator = func() func(string) error {
		validators := customdomainDescCnameTarget.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(cname_target string) error {
			for _, fn := range fns {
				if err := fn(cname_target); err != nil {
					return err
				}
			}
			return nil
	...
	usagelogDescCustomDomain := usagelogFields[14].Descriptor()
	// usagelog.CustomDomainValidator is a validator for the "custom_domain" field. It is called by the builders before save.
	usagelog.CustomDomainValidator = func() func(string) error {
		validators := usagelogDescCustomDomain.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(custom_domain string) error {
			for _, fn := range fns {
				if err := fn(custom_domain); err != nil {
					return err
				}
			}
			return nil
