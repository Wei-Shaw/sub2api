...
func init() {
	...
	// groupDescRoutingMode is the schema descriptor for routing_mode field.
	groupDescRoutingMode := groupFields[10].Descriptor()
	// group.DefaultRoutingMode holds the default value on creation for the routing_mode field.
	group.DefaultRoutingMode = groupDescRoutingMode.Default.(string)
	// group.RoutingModeValidator is a validator for the "routing_mode" field. It is called by the builders before save.
	group.RoutingModeValidator = groupDescRoutingMode.Validators[0].(func(string) error)
	// groupDescAutoCandidateGroupIds is the schema descriptor for auto_candidate_group_ids field.
	groupDescAutoCandidateGroupIds := groupFields[11].Descriptor()
	// group.DefaultAutoCandidateGroupIds holds the default value on creation for the auto_candidate_group_ids field.
	group.DefaultAutoCandidateGroupIds = groupDescAutoCandidateGroupIds.Default.([]int64)
