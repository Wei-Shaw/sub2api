...
func init() {
	apikeyMixin := schema.APIKey{REDACTED.Mixin()
	...
	apikeyFields := schema.APIKey{REDACTED.Fields()
	_ = apikeyFields
...
REDACTED()
	...
	accountMixin := schema.Account{REDACTED.Mixin()
	...
	accountFields := schema.Account{REDACTED.Fields()
	_ = accountFields
...
REDACTED()
	...
	account.DefaultCredentials = accountDescCredentials.Default.(func() map[string]interface{REDACTED)
	...
	account.DefaultExtra = accountDescExtra.Default.(func() map[string]interface{REDACTED)
	...
	accountgroupFields := schema.AccountGroup{REDACTED.Fields()
	...
	announcementFields := schema.Announcement{REDACTED.Fields()
...
REDACTED()
	...
	announcementreadFields := schema.AnnouncementRead{REDACTED.Fields()
	...
	authidentityMixin := schema.AuthIdentity{REDACTED.Mixin()
	authidentityMixinFields0 := authidentityMixin[0].Fields()
	_ = authidentityMixinFields0
	authidentityFields := schema.AuthIdentity{REDACTED.Fields()
...
REDACTED()
	...
	authidentity.DefaultMetadata = authidentityDescMetadata.Default.(func() map[string]interface{REDACTED)
	authidentitychannelMixin := schema.AuthIdentityChannel{REDACTED.Mixin()
	authidentitychannelMixinFields0 := authidentitychannelMixin[0].Fields()
	_ = authidentitychannelMixinFields0
	authidentitychannelFields := schema.AuthIdentityChannel{REDACTED.Fields()
...
REDACTED()
	...
	authidentitychannel.DefaultMetadata = authidentitychannelDescMetadata.Default.(func() map[string]interface{REDACTED)
	batchimageeventFields := schema.BatchImageEvent{REDACTED.Fields()
	...
	batchimageitemFields := schema.BatchImageItem{REDACTED.Fields()
	...
	batchimagejobFields := schema.BatchImageJob{REDACTED.Fields()
	...
	batchimagejobDescStatus := batchimagejobFields[6].Descriptor()
	...
	batchimagejobDescProviderJobName := batchimagejobFields[7].Descriptor()
	...
	batchimagejobDescProviderInputRef := batchimagejobFields[8].Descriptor()
	...
	batchimagejobDescProviderOutputRef := batchimagejobFields[9].Descriptor()
	...
	batchimagejobDescGcsInputURI := batchimagejobFields[10].Descriptor()
	...
	batchimagejobDescGcsOutputURI := batchimagejobFields[11].Descriptor()
	...
	batchimagejobDescSuccessCount := batchimagejobFields[13].Descriptor()
	...
	batchimagejobDescFailCount := batchimagejobFields[14].Descriptor()
	...
	batchimagejobDescCancelledCount := batchimagejobFields[15].Descriptor()
	...
	batchimagejobDescEstimatedCost := batchimagejobFields[16].Descriptor()
	...
	batchimagejobDescCurrency := batchimagejobFields[19].Descriptor()
	...
	batchimagejobDescHoldID := batchimagejobFields[20].Descriptor()
	...
	batchimagejobDescIdempotencyKey := batchimagejobFields[21].Descriptor()
	...
	batchimagejobDescRequestHash := batchimagejobFields[22].Descriptor()
	...
	batchimagejobDescManifestHash := batchimagejobFields[23].Descriptor()
	...
	batchimagejobDescRetryCount := batchimagejobFields[24].Descriptor()
	...
	batchimagejobDescVersion := batchimagejobFields[25].Descriptor()
	...
	batchimagejobDescLastErrorCode := batchimagejobFields[29].Descriptor()
	...
	batchimagejobDescCreatedAt := batchimagejobFields[31].Descriptor()
	...
	batchimagejobDescUpdatedAt := batchimagejobFields[32].Descriptor()
	...
	channelmonitorMixin := schema.ChannelMonitor{REDACTED.Mixin()
	channelmonitorMixinFields0 := channelmonitorMixin[0].Fields()
	_ = channelmonitorMixinFields0
	channelmonitorFields := schema.ChannelMonitor{REDACTED.Fields()
...
REDACTED()
	...
	channelmonitordailyrollupFields := schema.ChannelMonitorDailyRollup{REDACTED.Fields()
...
REDACTED()
	...
	channelmonitorhistoryFields := schema.ChannelMonitorHistory{REDACTED.Fields()
...
REDACTED()
	...
	channelmonitorrequesttemplateMixin := schema.ChannelMonitorRequestTemplate{REDACTED.Mixin()
	...
	channelmonitorrequesttemplateFields := schema.ChannelMonitorRequestTemplate{REDACTED.Fields()
...
REDACTED()
	...
	errorpassthroughruleMixin := schema.ErrorPassthroughRule{REDACTED.Mixin()
	errorpassthroughruleMixinFields0 := errorpassthroughruleMixin[0].Fields()
	_ = errorpassthroughruleMixinFields0
	errorpassthroughruleFields := schema.ErrorPassthroughRule{REDACTED.Fields()
...
REDACTED()
	...
	groupMixin := schema.Group{REDACTED.Mixin()
	...
	_ = groupMixinFields0
	groupFields := schema.Group{REDACTED.Fields()
	_ = groupFields
...
REDACTED()
	...
	idempotencyrecordMixin := schema.IdempotencyRecord{REDACTED.Mixin()
	idempotencyrecordMixinFields0 := idempotencyrecordMixin[0].Fields()
	_ = idempotencyrecordMixinFields0
	idempotencyrecordFields := schema.IdempotencyRecord{REDACTED.Fields()
	...
	identityadoptiondecisionMixin := schema.IdentityAdoptionDecision{REDACTED.Mixin()
	identityadoptiondecisionMixinFields0 := identityadoptiondecisionMixin[0].Fields()
	_ = identityadoptiondecisionMixinFields0
	identityadoptiondecisionFields := schema.IdentityAdoptionDecision{REDACTED.Fields()
	...
	paymentauditlogFields := schema.PaymentAuditLog{REDACTED.Fields()
	...
	paymentorderFields := schema.PaymentOrder{REDACTED.Fields()
	...
	paymentproviderinstanceFields := schema.PaymentProviderInstance{REDACTED.Fields()
...
REDACTED()
	...
	pendingauthsessionMixin := schema.PendingAuthSession{REDACTED.Mixin()
	pendingauthsessionMixinFields0 := pendingauthsessionMixin[0].Fields()
	_ = pendingauthsessionMixinFields0
	pendingauthsessionFields := schema.PendingAuthSession{REDACTED.Fields()
...
REDACTED()
	...
	pendingauthsession.DefaultUpstreamIdentityClaims = pendingauthsessionDescUpstreamIdentityClaims.Default.(func() map[string]interface{REDACTED)
	...
	pendingauthsession.DefaultLocalFlowState = pendingauthsessionDescLocalFlowState.Default.(func() map[string]interface{REDACTED)
	...
	promocodeFields := schema.PromoCode{REDACTED.Fields()
	_ = promocodeFields
...
REDACTED()
	...
	promocodeusageFields := schema.PromoCodeUsage{REDACTED.Fields()
	...
	proxyMixin := schema.Proxy{REDACTED.Mixin()
	...
	_ = proxyMixinFields0
	proxyFields := schema.Proxy{REDACTED.Fields()
	_ = proxyFields
...
REDACTED()
	...
	redeemcodeFields := schema.RedeemCode{REDACTED.Fields()
	_ = redeemcodeFields
...
REDACTED()
	...
	securitysecretMixin := schema.SecuritySecret{REDACTED.Mixin()
	securitysecretMixinFields0 := securitysecretMixin[0].Fields()
	_ = securitysecretMixinFields0
	securitysecretFields := schema.SecuritySecret{REDACTED.Fields()
...
REDACTED()
	...
	settingFields := schema.Setting{REDACTED.Fields()
	_ = settingFields
...
REDACTED()
	...
	subscriptionplanFields := schema.SubscriptionPlan{REDACTED.Fields()
...
REDACTED()
	...
	tlsfingerprintprofileMixin := schema.TLSFingerprintProfile{REDACTED.Mixin()
	tlsfingerprintprofileMixinFields0 := tlsfingerprintprofileMixin[0].Fields()
	_ = tlsfingerprintprofileMixinFields0
	tlsfingerprintprofileFields := schema.TLSFingerprintProfile{REDACTED.Fields()
...
REDACTED()
	...
	usagecleanuptaskMixin := schema.UsageCleanupTask{REDACTED.Mixin()
	usagecleanuptaskMixinFields0 := usagecleanuptaskMixin[0].Fields()
	_ = usagecleanuptaskMixinFields0
	usagecleanuptaskFields := schema.UsageCleanupTask{REDACTED.Fields()
...
REDACTED()
	...
	usagelogFields := schema.UsageLog{REDACTED.Fields()
	_ = usagelogFields
...
REDACTED()
	...
	userMixin := schema.User{REDACTED.Mixin()
	...
	_ = userMixinFields0
	userFields := schema.User{REDACTED.Fields()
	_ = userFields
...
REDACTED()
	...
	userallowedgroupFields := schema.UserAllowedGroup{REDACTED.Fields()
	...
	userattributedefinitionMixin := schema.UserAttributeDefinition{REDACTED.Mixin()
	...
	userattributedefinitionFields := schema.UserAttributeDefinition{REDACTED.Fields()
...
REDACTED()
	...
	userattributedefinition.DefaultOptions = userattributedefinitionDescOptions.Default.([]map[string]interface{REDACTED)
	...
	userattributedefinition.DefaultValidation = userattributedefinitionDescValidation.Default.(map[string]interface{REDACTED)
	...
	userattributevalueMixin := schema.UserAttributeValue{REDACTED.Mixin()
	userattributevalueMixinFields0 := userattributevalueMixin[0].Fields()
	_ = userattributevalueMixinFields0
	userattributevalueFields := schema.UserAttributeValue{REDACTED.Fields()
	...
	userplatformquotaMixin := schema.UserPlatformQuota{REDACTED.Mixin()
	...
	userplatformquotaFields := schema.UserPlatformQuota{REDACTED.Fields()
...
REDACTED()
	...
	usersubscriptionMixin := schema.UserSubscription{REDACTED.Mixin()
	...
	usersubscriptionFields := schema.UserSubscription{REDACTED.Fields()
