...
func init() {
	...
	usagelogDescRoutingTargetGroup := usagelogFields[7].Descriptor()
	...
	usagelogDescRoutingScheduleLayer := usagelogFields[8].Descriptor()
	...
	usagelogDescRoutingSelectedAccountName := usagelogFields[10].Descriptor()
	...
	usagelogDescRoutingEffectiveModel := usagelogFields[11].Descriptor()
	...
	usagelogDescRoutingFailoverFinalReason := usagelogFields[13].Descriptor()
	...
	usagelogDescPricingSource := usagelogFields[35].Descriptor()
	...
	usagelogDescMediaType := usagelogFields[44].Descriptor()
