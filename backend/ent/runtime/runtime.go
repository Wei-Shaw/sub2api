...
func init() {
	...
	// accountDescVisibility is the schema descriptor for visibility field.
	accountDescVisibility := accountFields[29].Descriptor()
	// account.VisibilityValidator is a validator for the "visibility" field. It is called by the builders before save.
	account.VisibilityValidator = accountDescVisibility.Validators[0].(func(string) error)
	// accountDescUpstreamPlan is the schema descriptor for upstream_plan field.
	accountDescUpstreamPlan := accountFields[30].Descriptor()
	// account.UpstreamPlanValidator is a validator for the "upstream_plan" field. It is called by the builders before save.
	account.UpstreamPlanValidator = accountDescUpstreamPlan.Validators[0].(func(string) error)
	...
	// groupDescIsSharePool is the schema descriptor for is_share_pool field.
	groupDescIsSharePool := groupFields[8].Descriptor()
	// group.DefaultIsSharePool holds the default value on creation for the is_share_pool field.
	group.DefaultIsSharePool = groupDescIsSharePool.Default.(bool)
	...
	// groupDescUpstreamPlan is the schema descriptor for upstream_plan field.
	groupDescUpstreamPlan := groupFields[12].Descriptor()
	// group.UpstreamPlanValidator is a validator for the "upstream_plan" field. It is called by the builders before save.
	group.UpstreamPlanValidator = groupDescUpstreamPlan.Validators[0].(func(string) error)
