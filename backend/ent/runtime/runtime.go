...
func init() {
	...
	groupDescImagePreferFal := groupFields[23].Descriptor()
	...
	groupDescImageDecodeSizeOnRsp := groupFields[24].Descriptor()
	...
	groupDescImageUpscaleOnRsp := groupFields[25].Descriptor()
