...
func init() {
	...
	groupDescImagePreferFal := groupFields[22].Descriptor()
	...
	groupDescImageDecodeSizeOnRsp := groupFields[23].Descriptor()
	...
	groupDescImageUpscaleOnRsp := groupFields[24].Descriptor()
