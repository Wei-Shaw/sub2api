...
func init() {
	...
	// userDescTrialBalance is the schema descriptor for trial_balance field.
	userDescTrialBalance := userFields[4].Descriptor()
	// user.DefaultTrialBalance holds the default value on creation for the trial_balance field.
	user.DefaultTrialBalance = userDescTrialBalance.Default.(float64)
	...
	userDescRegistrationIP := userFields[8].Descriptor()
