...
func init() {
	...
	// apikeyDescSmartRoutingEnabled is the schema descriptor for smart_routing_enabled field.
	apikeyDescSmartRoutingEnabled := apikeyFields[4].Descriptor()
	// apikey.DefaultSmartRoutingEnabled holds the default value on creation for the smart_routing_enabled field.
	apikey.DefaultSmartRoutingEnabled = apikeyDescSmartRoutingEnabled.Default.(bool)
