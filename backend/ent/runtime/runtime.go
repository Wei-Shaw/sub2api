...
func init() {
	...
	apikeyDescAllowedModels := apikeyFields[8].Descriptor()
	...
	// apikeyDescOpenaiDefaultFastMode is the schema descriptor for openai_default_fast_mode field.
	apikeyDescOpenaiDefaultFastMode := apikeyFields[9].Descriptor()
	// apikey.DefaultOpenaiDefaultFastMode holds the default value on creation for the openai_default_fast_mode field.
	apikey.DefaultOpenaiDefaultFastMode = apikeyDescOpenaiDefaultFastMode.Default.(bool)
