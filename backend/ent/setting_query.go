...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{setting.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{setting.LabelREDACTED
	default:
		return nil, &NotSingularError{setting.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{setting.LabelREDACTED
	default:
		err = &NotSingularError{setting.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &SettingQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]setting.OrderOption{REDACTED, _q.order...),
		inters:     append([]Interceptor{REDACTED, _q.inters...),
		predicates: append([]predicate.Setting{REDACTED, _q.predicates...),
...
func (_q *SettingQuery) GroupBy(field string, fields ...string) *SettingGroupBy {
	...
	grbuild := &SettingGroupBy{build: _qREDACTED
...
func (_q *SettingQuery) Select(fields ...string) *SettingSelect {
	...
	sbuild := &SettingSelect{SettingQuery: _qREDACTED
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &Setting{config: _q.configREDACTED
