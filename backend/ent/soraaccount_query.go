...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{soraaccount.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	if len(ids) == 0 {
		err = &NotFoundError{soraaccount.LabelREDACTED
		return
REDACTED
	return ids[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{soraaccount.LabelREDACTED
	default:
		return nil, &NotSingularError{soraaccount.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{soraaccount.LabelREDACTED
	default:
		err = &NotSingularError{soraaccount.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &SoraAccountQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]soraaccount.OrderOption{REDACTED, _q.order...),
		inters:     append([]Interceptor{REDACTED, _q.inters...),
		predicates: append([]predicate.SoraAccount{REDACTED, _q.predicates...),
...
func (_q *SoraAccountQuery) GroupBy(field string, fields ...string) *SoraAccountGroupBy {
	...
	grbuild := &SoraAccountGroupBy{build: _qREDACTED
...
func (_q *SoraAccountQuery) Select(fields ...string) *SoraAccountSelect {
	...
	sbuild := &SoraAccountSelect{SoraAccountQuery: _qREDACTED
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &SoraAccount{config: _q.configREDACTED
