...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{soratask.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	if len(ids) == 0 {
		err = &NotFoundError{soratask.LabelREDACTED
		return
REDACTED
	return ids[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{soratask.LabelREDACTED
	default:
		return nil, &NotSingularError{soratask.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{soratask.LabelREDACTED
	default:
		err = &NotSingularError{soratask.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &SoraTaskQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]soratask.OrderOption{REDACTED, _q.order...),
		inters:     append([]Interceptor{REDACTED, _q.inters...),
		predicates: append([]predicate.SoraTask{REDACTED, _q.predicates...),
...
func (_q *SoraTaskQuery) GroupBy(field string, fields ...string) *SoraTaskGroupBy {
	...
	grbuild := &SoraTaskGroupBy{build: _qREDACTED
...
func (_q *SoraTaskQuery) Select(fields ...string) *SoraTaskSelect {
	...
	sbuild := &SoraTaskSelect{SoraTaskQuery: _qREDACTED
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &SoraTask{config: _q.configREDACTED
