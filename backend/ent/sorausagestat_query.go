...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{sorausagestat.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	if len(ids) == 0 {
		err = &NotFoundError{sorausagestat.LabelREDACTED
		return
REDACTED
	return ids[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{sorausagestat.LabelREDACTED
	default:
		return nil, &NotSingularError{sorausagestat.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{sorausagestat.LabelREDACTED
	default:
		err = &NotSingularError{sorausagestat.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &SoraUsageStatQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]sorausagestat.OrderOption{REDACTED, _q.order...),
		inters:     append([]Interceptor{REDACTED, _q.inters...),
		predicates: append([]predicate.SoraUsageStat{REDACTED, _q.predicates...),
...
func (_q *SoraUsageStatQuery) GroupBy(field string, fields ...string) *SoraUsageStatGroupBy {
	...
	grbuild := &SoraUsageStatGroupBy{build: _qREDACTED
...
func (_q *SoraUsageStatQuery) Select(fields ...string) *SoraUsageStatSelect {
	...
	sbuild := &SoraUsageStatSelect{SoraUsageStatQuery: _qREDACTED
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &SoraUsageStat{config: _q.configREDACTED
