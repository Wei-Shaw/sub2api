...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{subscriptionplan.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	if len(ids) == 0 {
		err = &NotFoundError{subscriptionplan.LabelREDACTED
		return
REDACTED
	return ids[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{subscriptionplan.LabelREDACTED
	default:
		return nil, &NotSingularError{subscriptionplan.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{subscriptionplan.LabelREDACTED
	default:
		err = &NotSingularError{subscriptionplan.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &SubscriptionPlanQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]subscriptionplan.OrderOption{REDACTED, _q.order...),
		inters:     append([]Interceptor{REDACTED, _q.inters...),
		predicates: append([]predicate.SubscriptionPlan{REDACTED, _q.predicates...),
...
func (_q *SubscriptionPlanQuery) GroupBy(field string, fields ...string) *SubscriptionPlanGroupBy {
	...
	grbuild := &SubscriptionPlanGroupBy{build: _qREDACTED
...
func (_q *SubscriptionPlanQuery) Select(fields ...string) *SubscriptionPlanSelect {
	...
	sbuild := &SubscriptionPlanSelect{SubscriptionPlanQuery: _qREDACTED
...
func (_q *SubscriptionPlanQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SubscriptionPlan, error) {
	var (
		nodes = []*SubscriptionPlan{REDACTED
		_spec = _q.querySpec()
	)
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &SubscriptionPlan{config: _q.configREDACTED
