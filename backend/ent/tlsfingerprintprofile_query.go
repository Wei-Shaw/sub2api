...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{tlsfingerprintprofile.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{tlsfingerprintprofile.LabelREDACTED
	default:
		return nil, &NotSingularError{tlsfingerprintprofile.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{tlsfingerprintprofile.LabelREDACTED
	default:
		err = &NotSingularError{tlsfingerprintprofile.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &TLSFingerprintProfileQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]tlsfingerprintprofile.OrderOption{REDACTED, _q.order...),
		inters:     append([]Interceptor{REDACTED, _q.inters...),
		predicates: append([]predicate.TLSFingerprintProfile{REDACTED, _q.predicates...),
...
func (_q *TLSFingerprintProfileQuery) GroupBy(field string, fields ...string) *TLSFingerprintProfileGroupBy {
	...
	grbuild := &TLSFingerprintProfileGroupBy{build: _qREDACTED
...
func (_q *TLSFingerprintProfileQuery) Select(fields ...string) *TLSFingerprintProfileSelect {
	...
	sbuild := &TLSFingerprintProfileSelect{TLSFingerprintProfileQuery: _qREDACTED
...
func (_q *TLSFingerprintProfileQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*TLSFingerprintProfile, error) {
	var (
		nodes = []*TLSFingerprintProfile{REDACTED
		_spec = _q.querySpec()
	)
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &TLSFingerprintProfile{config: _q.configREDACTED
