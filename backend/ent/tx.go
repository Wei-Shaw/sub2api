...
func (tx *Tx) init() {
	...
	tx.CacheInvalidationOutbox = NewCacheInvalidationOutboxClient(tx.config)
	...
	tx.UserPoolGroupGrant = NewUserPoolGroupGrantClient(tx.config)
	tx.UserPoolMember = NewUserPoolMemberClient(tx.config)
