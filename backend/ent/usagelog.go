...
func (e UsageLogEdges) UserOrErr() (*User, error) {
	if e.User != nil {
		return e.User, nil
REDACTED else if e.loadedTypes[0] {
		return nil, &NotFoundError{label: user.LabelREDACTED
REDACTED
	return nil, &NotLoadedError{edge: "user"REDACTED
REDACTED
...
func (e UsageLogEdges) APIKeyOrErr() (*APIKey, error) {
	if e.APIKey != nil {
		return e.APIKey, nil
REDACTED else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: apikey.LabelREDACTED
REDACTED
	return nil, &NotLoadedError{edge: "api_key"REDACTED
REDACTED
...
REDACTED else if e.loadedTypes[2] {
		return nil, &NotFoundError{label: account.LabelREDACTED
REDACTED
	return nil, &NotLoadedError{edge: "account"REDACTED
REDACTED
...
func (e UsageLogEdges) GroupOrErr() (*Group, error) {
	if e.Group != nil {
		return e.Group, nil
REDACTED else if e.loadedTypes[3] {
		return nil, &NotFoundError{label: group.LabelREDACTED
REDACTED
	return nil, &NotLoadedError{edge: "group"REDACTED
REDACTED
...
REDACTED else if e.loadedTypes[4] {
		return nil, &NotFoundError{label: usersubscription.LabelREDACTED
REDACTED
	return nil, &NotLoadedError{edge: "subscription"REDACTED
REDACTED
...
REDACTED
	for i := range columns {
		...
		REDACTED else if value != nil && len(*value) > 0 {
