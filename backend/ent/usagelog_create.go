...
func (_c *UsageLogCreate) check() error {
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent: missing required field "UsageLog.user_id"`)REDACTED
REDACTED
	if _, ok := _c.mutation.APIKeyID(); !ok {
		return &ValidationError{Name: "api_key_id", err: errors.New(`ent: missing required field "UsageLog.api_key_id"`)REDACTED
REDACTED
	if _, ok := _c.mutation.AccountID(); !ok {
		return &ValidationError{Name: "account_id", err: errors.New(`ent: missing required field "UsageLog.account_id"`)REDACTED
REDACTED
	if _, ok := _c.mutation.RequestID(); !ok {
		return &ValidationError{Name: "request_id", err: errors.New(`ent: missing required field "UsageLog.request_id"`)REDACTED
REDACTED
	if v, ok := _c.mutation.RequestID(); ok {
		if err := usagelog.RequestIDValidator(v); err != nil {
			return &ValidationError{Name: "request_id", err: fmt.Errorf(`ent: validator failed for field "UsageLog.request_id": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.Model(); !ok {
		return &ValidationError{Name: "model", err: errors.New(`ent: missing required field "UsageLog.model"`)REDACTED
REDACTED
...
REDACTED
	if v, ok := _c.mutation.UpstreamResponseModel(); ok {
		if err := usagelog.UpstreamResponseModelValidator(v); err != nil {
			return &ValidationError{Name: "upstream_response_model", err: fmt.Errorf(`ent: validator failed for field "UsageLog.upstream_response_model": %w`, err)REDACTED
	REDACTED
REDACTED
	if v, ok := _c.mutation.ModelMappingChain(); ok {
		if err := usagelog.ModelMappingChainValidator(v); err != nil {
			return &ValidationError{Name: "model_mapping_chain", err: fmt.Errorf(`ent: validator failed for field "UsageLog.model_mapping_chain": %w`, err)REDACTED
	REDACTED
REDACTED
	if v, ok := _c.mutation.BillingTier(); ok {
		if err := usagelog.BillingTierValidator(v); err != nil {
			return &ValidationError{Name: "billing_tier", err: fmt.Errorf(`ent: validator failed for field "UsageLog.billing_tier": %w`, err)REDACTED
	REDACTED
REDACTED
	if v, ok := _c.mutation.BillingMode(); ok {
		if err := usagelog.BillingModeValidator(v); err != nil {
			return &ValidationError{Name: "billing_mode", err: fmt.Errorf(`ent: validator failed for field "UsageLog.billing_mode": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.InputTokens(); !ok {
		return &ValidationError{Name: "input_tokens", err: errors.New(`ent: missing required field "UsageLog.input_tokens"`)REDACTED
REDACTED
	if _, ok := _c.mutation.OutputTokens(); !ok {
		return &ValidationError{Name: "output_tokens", err: errors.New(`ent: missing required field "UsageLog.output_tokens"`)REDACTED
REDACTED
	if _, ok := _c.mutation.CacheCreationTokens(); !ok {
		return &ValidationError{Name: "cache_creation_tokens", err: errors.New(`ent: missing required field "UsageLog.cache_creation_tokens"`)REDACTED
REDACTED
	if _, ok := _c.mutation.CacheReadTokens(); !ok {
		return &ValidationError{Name: "cache_read_tokens", err: errors.New(`ent: missing required field "UsageLog.cache_read_tokens"`)REDACTED
REDACTED
	if _, ok := _c.mutation.CacheCreation5mTokens(); !ok {
		return &ValidationError{Name: "cache_creation_5m_tokens", err: errors.New(`ent: missing required field "UsageLog.cache_creation_5m_tokens"`)REDACTED
REDACTED
	if _, ok := _c.mutation.CacheCreation1hTokens(); !ok {
		return &ValidationError{Name: "cache_creation_1h_tokens", err: errors.New(`ent: missing required field "UsageLog.cache_creation_1h_tokens"`)REDACTED
REDACTED
	if _, ok := _c.mutation.InputCost(); !ok {
		return &ValidationError{Name: "input_cost", err: errors.New(`ent: missing required field "UsageLog.input_cost"`)REDACTED
REDACTED
	if _, ok := _c.mutation.OutputCost(); !ok {
		return &ValidationError{Name: "output_cost", err: errors.New(`ent: missing required field "UsageLog.output_cost"`)REDACTED
REDACTED
	if _, ok := _c.mutation.CacheCreationCost(); !ok {
		return &ValidationError{Name: "cache_creation_cost", err: errors.New(`ent: missing required field "UsageLog.cache_creation_cost"`)REDACTED
REDACTED
	if _, ok := _c.mutation.CacheReadCost(); !ok {
		return &ValidationError{Name: "cache_read_cost", err: errors.New(`ent: missing required field "UsageLog.cache_read_cost"`)REDACTED
REDACTED
	if _, ok := _c.mutation.TotalCost(); !ok {
		return &ValidationError{Name: "total_cost", err: errors.New(`ent: missing required field "UsageLog.total_cost"`)REDACTED
REDACTED
	if _, ok := _c.mutation.ActualCost(); !ok {
		return &ValidationError{Name: "actual_cost", err: errors.New(`ent: missing required field "UsageLog.actual_cost"`)REDACTED
REDACTED
	if _, ok := _c.mutation.RateMultiplier(); !ok {
		return &ValidationError{Name: "rate_multiplier", err: errors.New(`ent: missing required field "UsageLog.rate_multiplier"`)REDACTED
REDACTED
	if _, ok := _c.mutation.LongContextBillingApplied(); !ok {
		return &ValidationError{Name: "long_context_billing_applied", err: errors.New(`ent: missing required field "UsageLog.long_context_billing_applied"`)REDACTED
REDACTED
	if _, ok := _c.mutation.BillingType(); !ok {
		return &ValidationError{Name: "billing_type", err: errors.New(`ent: missing required field "UsageLog.billing_type"`)REDACTED
REDACTED
	if _, ok := _c.mutation.Stream(); !ok {
...
REDACTED
	if _, ok := _c.mutation.VideoCount(); !ok {
		return &ValidationError{Name: "video_count", err: errors.New(`ent: missing required field "UsageLog.video_count"`)REDACTED
REDACTED
	if v, ok := _c.mutation.VideoResolution(); ok {
		if err := usagelog.VideoResolutionValidator(v); err != nil {
			return &ValidationError{Name: "video_resolution", err: fmt.Errorf(`ent: validator failed for field "UsageLog.video_resolution": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.CacheTTLOverridden(); !ok {
...
REDACTED
	if len(_c.mutation.UserIDs()) == 0 {
		return &ValidationError{Name: "user", err: errors.New(`ent: missing required edge "UsageLog.user"`)REDACTED
REDACTED
	if len(_c.mutation.APIKeyIDs()) == 0 {
		return &ValidationError{Name: "api_key", err: errors.New(`ent: missing required edge "UsageLog.api_key"`)REDACTED
REDACTED
	if len(_c.mutation.AccountIDs()) == 0 {
		return &ValidationError{Name: "account", err: errors.New(`ent: missing required edge "UsageLog.account"`)REDACTED
REDACTED
	return nil
REDACTED
...
func (_c *UsageLogCreate) createSpec() (*UsageLog, *sqlgraph.CreateSpec) {
	var (
		_node = &UsageLog{config: _c.configREDACTED
...
REDACTED
	if nodes := _c.mutation.UserIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{usagelog.UserColumnREDACTED,
			Bidi:    false,
...
REDACTED
	if nodes := _c.mutation.APIKeyIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{usagelog.APIKeyColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
REDACTED
	if nodes := _c.mutation.AccountIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{usagelog.AccountColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
REDACTED
	if nodes := _c.mutation.GroupIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{usagelog.GroupColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
REDACTED
	if nodes := _c.mutation.SubscriptionIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{usagelog.SubscriptionColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
func (u *UsageLogUpsertOne) Update(set func(*UsageLogUpsert)) *UsageLogUpsertOne {
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(update *sql.UpdateSet) {
		set(&UsageLogUpsert{UpdateSet: updateREDACTED)
REDACTED))
	return u
REDACTED
