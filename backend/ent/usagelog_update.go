...
REDACTED
	if _node, err = sqlgraph.UpdateNodes(ctx, _u.driver, _spec); err != nil {
		if _, ok := err.(*sqlgraph.NotFoundError); ok {
			err = &NotFoundError{usagelog.LabelREDACTED
...
REDACTED
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "UsageLog.id" for update`)REDACTED
REDACTED
...
REDACTED
	...
	REDACTED
		_spec.Edges.Add = append(_spec.Edges.Add, edge)
REDACTED
	_node = &UsageLog{config: _u.configREDACTED
