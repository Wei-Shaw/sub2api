...
type User struct {
	...
	// SystemTokenHash holds the value of the "system_token_hash" field.
	SystemTokenHash *string `json:"system_token_hash,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldEmail, user.FieldPasswordHash, user.FieldRole, user.FieldStatus, user.FieldUsername, user.FieldNotes, user.FieldTotpSecretEncrypted, user.FieldSignupSource, user.FieldBalanceNotifyThresholdType, user.FieldBalanceNotifyExtraEmails, user.FieldSystemTokenHash:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldSystemTokenHash:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field system_token_hash", values[i])
			} else if value.Valid {
				_m.SystemTokenHash = new(string)
				*_m.SystemTokenHash = value.String
			}
		default:
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	if v := _m.SystemTokenHash; v != nil {
		builder.WriteString("system_token_hash=")
		builder.WriteString(*v)
	}
	builder.WriteByte(')')
