...
type UserEdges struct {
	...
	// AllowedAccounts holds the value of the allowed_accounts edge.
	AllowedAccounts []*Account `json:"allowed_accounts,omitempty"`
...
// AllowedAccountsOrErr returns the AllowedAccounts value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) AllowedAccountsOrErr() ([]*Account, error) {
	if e.loadedTypes[6] {
		return e.AllowedAccounts, nil
	}
	return nil, &NotLoadedError{edge: "allowed_accounts"}
}
...
// was not loaded in eager-loading.
func (e UserEdges) UserAllowedAccountsOrErr() ([]*UserAllowedAccount, error) {
	if e.loadedTypes[14] {
...
// QueryAllowedAccounts queries the "allowed_accounts" edge of the User entity.
func (_m *User) QueryAllowedAccounts() *AccountQuery {
	return NewUserClient(_m.config).QueryAllowedAccounts(_m)
}
...
// QueryUserAllowedAccounts queries the "user_allowed_accounts" edge of the User entity.
func (_m *User) QueryUserAllowedAccounts() *UserAllowedAccountQuery {
	return NewUserClient(_m.config).QueryUserAllowedAccounts(_m)
}
