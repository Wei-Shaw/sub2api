...
func (_c *UserCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "User.created_at"`)REDACTED
REDACTED
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "User.updated_at"`)REDACTED
REDACTED
	if _, ok := _c.mutation.Email(); !ok {
		return &ValidationError{Name: "email", err: errors.New(`ent: missing required field "User.email"`)REDACTED
REDACTED
	if v, ok := _c.mutation.Email(); ok {
		if err := user.EmailValidator(v); err != nil {
			return &ValidationError{Name: "email", err: fmt.Errorf(`ent: validator failed for field "User.email": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.PasswordHash(); !ok {
		return &ValidationError{Name: "password_hash", err: errors.New(`ent: missing required field "User.password_hash"`)REDACTED
REDACTED
	if v, ok := _c.mutation.PasswordHash(); ok {
		if err := user.PasswordHashValidator(v); err != nil {
			return &ValidationError{Name: "password_hash", err: fmt.Errorf(`ent: validator failed for field "User.password_hash": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.Role(); !ok {
		return &ValidationError{Name: "role", err: errors.New(`ent: missing required field "User.role"`)REDACTED
REDACTED
	if v, ok := _c.mutation.Role(); ok {
		if err := user.RoleValidator(v); err != nil {
			return &ValidationError{Name: "role", err: fmt.Errorf(`ent: validator failed for field "User.role": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.Balance(); !ok {
		return &ValidationError{Name: "balance", err: errors.New(`ent: missing required field "User.balance"`)REDACTED
REDACTED
	if _, ok := _c.mutation.FrozenBalance(); !ok {
		return &ValidationError{Name: "frozen_balance", err: errors.New(`ent: missing required field "User.frozen_balance"`)REDACTED
REDACTED
	if _, ok := _c.mutation.Concurrency(); !ok {
		return &ValidationError{Name: "concurrency", err: errors.New(`ent: missing required field "User.concurrency"`)REDACTED
REDACTED
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`ent: missing required field "User.status"`)REDACTED
REDACTED
	if v, ok := _c.mutation.Status(); ok {
		if err := user.StatusValidator(v); err != nil {
			return &ValidationError{Name: "status", err: fmt.Errorf(`ent: validator failed for field "User.status": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.Username(); !ok {
		return &ValidationError{Name: "username", err: errors.New(`ent: missing required field "User.username"`)REDACTED
REDACTED
	if v, ok := _c.mutation.Username(); ok {
		if err := user.UsernameValidator(v); err != nil {
			return &ValidationError{Name: "username", err: fmt.Errorf(`ent: validator failed for field "User.username": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.Notes(); !ok {
...
REDACTED
	if _, ok := _c.mutation.SignupSource(); !ok {
		return &ValidationError{Name: "signup_source", err: errors.New(`ent: missing required field "User.signup_source"`)REDACTED
REDACTED
	if v, ok := _c.mutation.SignupSource(); ok {
		if err := user.SignupSourceValidator(v); err != nil {
			return &ValidationError{Name: "signup_source", err: fmt.Errorf(`ent: validator failed for field "User.signup_source": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.BalanceNotifyEnabled(); !ok {
		return &ValidationError{Name: "balance_notify_enabled", err: errors.New(`ent: missing required field "User.balance_notify_enabled"`)REDACTED
REDACTED
	if _, ok := _c.mutation.BalanceNotifyThresholdType(); !ok {
		return &ValidationError{Name: "balance_notify_threshold_type", err: errors.New(`ent: missing required field "User.balance_notify_threshold_type"`)REDACTED
REDACTED
	if _, ok := _c.mutation.BalanceNotifyExtraEmails(); !ok {
		return &ValidationError{Name: "balance_notify_extra_emails", err: errors.New(`ent: missing required field "User.balance_notify_extra_emails"`)REDACTED
REDACTED
	if _, ok := _c.mutation.TotalRecharged(); !ok {
		return &ValidationError{Name: "total_recharged", err: errors.New(`ent: missing required field "User.total_recharged"`)REDACTED
REDACTED
	if _, ok := _c.mutation.RpmLimit(); !ok {
		return &ValidationError{Name: "rpm_limit", err: errors.New(`ent: missing required field "User.rpm_limit"`)REDACTED
REDACTED
	return nil
REDACTED
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	var (
		_node = &User{config: _c.configREDACTED
...
REDACTED
	if nodes := _c.mutation.APIKeysIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{user.APIKeysColumnREDACTED,
			Bidi:    false,
...
REDACTED
	if nodes := _c.mutation.RedeemCodesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{user.RedeemCodesColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
REDACTED
	if nodes := _c.mutation.SubscriptionsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{user.SubscriptionsColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
REDACTED
	if nodes := _c.mutation.AssignedSubscriptionsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{user.AssignedSubscriptionsColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(usersubscription.FieldID, field.TypeInt64),
		REDACTED,
...
REDACTED
	if nodes := _c.mutation.UsageLogsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{user.UsageLogsColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
REDACTED
	if nodes := _c.mutation.AttributeValuesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{user.AttributeValuesColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
REDACTED
	if nodes := _c.mutation.PromoCodeUsagesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{user.PromoCodeUsagesColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
REDACTED
	if nodes := _c.mutation.PaymentOrdersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{user.PaymentOrdersColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
REDACTED
	if nodes := _c.mutation.AuthIdentitiesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{user.AuthIdentitiesColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
REDACTED
	if nodes := _c.mutation.PendingAuthSessionsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{user.PendingAuthSessionsColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
REDACTED
	if nodes := _c.mutation.PlatformQuotasIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{user.PlatformQuotasColumnREDACTED,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
func (u *UserUpsertOne) Update(set func(*UserUpsert)) *UserUpsertOne {
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(update *sql.UpdateSet) {
		set(&UserUpsert{UpdateSet: updateREDACTED)
REDACTED))
	return u
REDACTED
