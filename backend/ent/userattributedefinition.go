...
type UserAttributeDefinition struct {
	...
	Options []map[string]interface{REDACTED `json:"options,omitempty"`
	// Required holds the value of the "required" field.
	Required bool `json:"required,omitempty"`
	// Validation holds the value of the "validation" field.
	Validation map[string]interface{REDACTED `json:"validation,omitempty"`
...
func (e UserAttributeDefinitionEdges) ValuesOrErr() ([]*UserAttributeValue, error) {
	if e.loadedTypes[0] {
		return e.Values, nil
REDACTED
	return nil, &NotLoadedError{edge: "values"REDACTED
REDACTED
