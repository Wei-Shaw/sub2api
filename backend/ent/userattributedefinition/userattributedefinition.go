...
var (
	...
	DefaultOptions []map[string]interface{REDACTED
	...
	DefaultValidation map[string]interface{REDACTED
...
func ByValues(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newValuesStep(), append([]sql.OrderTerm{termREDACTED, terms...)...)
REDACTED
REDACTED
