...
func (_c *UserAttributeDefinitionCreate) SetOptions(v []map[string]interface{REDACTED) *UserAttributeDefinitionCreate {
...
func (_c *UserAttributeDefinitionCreate) SetValidation(v map[string]interface{REDACTED) *UserAttributeDefinitionCreate {
...
func (_c *UserAttributeDefinitionCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "UserAttributeDefinition.created_at"`)REDACTED
REDACTED
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "UserAttributeDefinition.updated_at"`)REDACTED
REDACTED
	if _, ok := _c.mutation.Key(); !ok {
		return &ValidationError{Name: "key", err: errors.New(`ent: missing required field "UserAttributeDefinition.key"`)REDACTED
REDACTED
	if v, ok := _c.mutation.Key(); ok {
		if err := userattributedefinition.KeyValidator(v); err != nil {
			return &ValidationError{Name: "key", err: fmt.Errorf(`ent: validator failed for field "UserAttributeDefinition.key": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "UserAttributeDefinition.name"`)REDACTED
REDACTED
	if v, ok := _c.mutation.Name(); ok {
		if err := userattributedefinition.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`ent: validator failed for field "UserAttributeDefinition.name": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.Description(); !ok {
		return &ValidationError{Name: "description", err: errors.New(`ent: missing required field "UserAttributeDefinition.description"`)REDACTED
REDACTED
	if _, ok := _c.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`ent: missing required field "UserAttributeDefinition.type"`)REDACTED
REDACTED
	if v, ok := _c.mutation.GetType(); ok {
		if err := userattributedefinition.TypeValidator(v); err != nil {
			return &ValidationError{Name: "type", err: fmt.Errorf(`ent: validator failed for field "UserAttributeDefinition.type": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.Options(); !ok {
		return &ValidationError{Name: "options", err: errors.New(`ent: missing required field "UserAttributeDefinition.options"`)REDACTED
REDACTED
	if _, ok := _c.mutation.Required(); !ok {
		return &ValidationError{Name: "required", err: errors.New(`ent: missing required field "UserAttributeDefinition.required"`)REDACTED
REDACTED
	if _, ok := _c.mutation.Validation(); !ok {
		return &ValidationError{Name: "validation", err: errors.New(`ent: missing required field "UserAttributeDefinition.validation"`)REDACTED
REDACTED
	if _, ok := _c.mutation.Placeholder(); !ok {
		return &ValidationError{Name: "placeholder", err: errors.New(`ent: missing required field "UserAttributeDefinition.placeholder"`)REDACTED
REDACTED
	if v, ok := _c.mutation.Placeholder(); ok {
		if err := userattributedefinition.PlaceholderValidator(v); err != nil {
			return &ValidationError{Name: "placeholder", err: fmt.Errorf(`ent: validator failed for field "UserAttributeDefinition.placeholder": %w`, err)REDACTED
	REDACTED
REDACTED
	if _, ok := _c.mutation.DisplayOrder(); !ok {
		return &ValidationError{Name: "display_order", err: errors.New(`ent: missing required field "UserAttributeDefinition.display_order"`)REDACTED
REDACTED
	if _, ok := _c.mutation.Enabled(); !ok {
		return &ValidationError{Name: "enabled", err: errors.New(`ent: missing required field "UserAttributeDefinition.enabled"`)REDACTED
REDACTED
	return nil
REDACTED
...
func (_c *UserAttributeDefinitionCreate) createSpec() (*UserAttributeDefinition, *sqlgraph.CreateSpec) {
	var (
		_node = &UserAttributeDefinition{config: _c.configREDACTED
...
REDACTED
	if nodes := _c.mutation.ValuesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{userattributedefinition.ValuesColumnREDACTED,
			Bidi:    false,
...
// SetOptions sets the "options" field.
func (u *UserAttributeDefinitionUpsert) SetOptions(v []map[string]interface{REDACTED) *UserAttributeDefinitionUpsert {
...
// SetValidation sets the "validation" field.
func (u *UserAttributeDefinitionUpsert) SetValidation(v map[string]interface{REDACTED) *UserAttributeDefinitionUpsert {
...
func (u *UserAttributeDefinitionUpsertOne) Update(set func(*UserAttributeDefinitionUpsert)) *UserAttributeDefinitionUpsertOne {
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(update *sql.UpdateSet) {
		set(&UserAttributeDefinitionUpsert{UpdateSet: updateREDACTED)
REDACTED))
	return u
REDACTED
...
// SetOptions sets the "options" field.
func (u *UserAttributeDefinitionUpsertOne) SetOptions(v []map[string]interface{REDACTED) *UserAttributeDefinitionUpsertOne {
	return u.Update(func(s *UserAttributeDefinitionUpsert) {
		s.SetOptions(v)
REDACTED)
REDACTED
...
// SetValidation sets the "validation" field.
func (u *UserAttributeDefinitionUpsertOne) SetValidation(v map[string]interface{REDACTED) *UserAttributeDefinitionUpsertOne {
	return u.Update(func(s *UserAttributeDefinitionUpsert) {
		s.SetValidation(v)
REDACTED)
REDACTED
...
// SetOptions sets the "options" field.
func (u *UserAttributeDefinitionUpsertBulk) SetOptions(v []map[string]interface{REDACTED) *UserAttributeDefinitionUpsertBulk {
	return u.Update(func(s *UserAttributeDefinitionUpsert) {
		s.SetOptions(v)
REDACTED)
REDACTED
...
// SetValidation sets the "validation" field.
func (u *UserAttributeDefinitionUpsertBulk) SetValidation(v map[string]interface{REDACTED) *UserAttributeDefinitionUpsertBulk {
	return u.Update(func(s *UserAttributeDefinitionUpsert) {
		s.SetValidation(v)
REDACTED)
REDACTED
