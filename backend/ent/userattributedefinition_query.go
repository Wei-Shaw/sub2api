...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{userattributedefinition.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{userattributedefinition.LabelREDACTED
	default:
		return nil, &NotSingularError{userattributedefinition.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{userattributedefinition.LabelREDACTED
	default:
		err = &NotSingularError{userattributedefinition.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &UserAttributeDefinitionQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]userattributedefinition.OrderOption{REDACTED, _q.order...),
		inters:     append([]Interceptor{REDACTED, _q.inters...),
		predicates: append([]predicate.UserAttributeDefinition{REDACTED, _q.predicates...),
...
func (_q *UserAttributeDefinitionQuery) GroupBy(field string, fields ...string) *UserAttributeDefinitionGroupBy {
	...
	grbuild := &UserAttributeDefinitionGroupBy{build: _qREDACTED
...
func (_q *UserAttributeDefinitionQuery) Select(fields ...string) *UserAttributeDefinitionSelect {
	...
	sbuild := &UserAttributeDefinitionSelect{UserAttributeDefinitionQuery: _qREDACTED
...
func (_q *UserAttributeDefinitionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserAttributeDefinition, error) {
	var (
		nodes       = []*UserAttributeDefinition{REDACTED
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
			_q.withValues != nil,
	REDACTED
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &UserAttributeDefinition{config: _q.configREDACTED
...
REDACTED
	if query := _q.withValues; query != nil {
		if err := _q.loadValues(ctx, query, nodes,
			func(n *UserAttributeDefinition) { n.Edges.Values = []*UserAttributeValue{REDACTED REDACTED,
			func(n *UserAttributeDefinition, e *UserAttributeValue) { n.Edges.Values = append(n.Edges.Values, e) REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	return nodes, nil
