...
func (_u *UserAttributeDefinitionUpdate) SetOptions(v []map[string]interface{REDACTED) *UserAttributeDefinitionUpdate {
	_u.mutation.SetOptions(v)
	return _u
REDACTED

// AppendOptions appends value to the "options" field.
func (_u *UserAttributeDefinitionUpdate) AppendOptions(v []map[string]interface{REDACTED) *UserAttributeDefinitionUpdate {
...
func (_u *UserAttributeDefinitionUpdate) SetValidation(v map[string]interface{REDACTED) *UserAttributeDefinitionUpdate {
...
REDACTED
	if _node, err = sqlgraph.UpdateNodes(ctx, _u.driver, _spec); err != nil {
		if _, ok := err.(*sqlgraph.NotFoundError); ok {
			err = &NotFoundError{userattributedefinition.LabelREDACTED
...
// SetOptions sets the "options" field.
func (_u *UserAttributeDefinitionUpdateOne) SetOptions(v []map[string]interface{REDACTED) *UserAttributeDefinitionUpdateOne {
	_u.mutation.SetOptions(v)
	return _u
REDACTED

// AppendOptions appends value to the "options" field.
func (_u *UserAttributeDefinitionUpdateOne) AppendOptions(v []map[string]interface{REDACTED) *UserAttributeDefinitionUpdateOne {
	_u.mutation.AppendOptions(v)
	return _u
REDACTED
...
// SetValidation sets the "validation" field.
func (_u *UserAttributeDefinitionUpdateOne) SetValidation(v map[string]interface{REDACTED) *UserAttributeDefinitionUpdateOne {
	_u.mutation.SetValidation(v)
	return _u
REDACTED
...
REDACTED
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "UserAttributeDefinition.id" for update`)REDACTED
REDACTED
...
REDACTED
	...
	REDACTED
		_spec.Edges.Add = append(_spec.Edges.Add, edge)
REDACTED
	_node = &UserAttributeDefinition{config: _u.configREDACTED
