...
func (_q *UserAttributeValueQuery) QueryDefinition() *UserAttributeDefinitionQuery {
	query := (&UserAttributeDefinitionClient{config: _q.configREDACTED).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	REDACTED
...
REDACTED
	if len(nodes) == 0 {
		return nil, &NotFoundError{userattributevalue.LabelREDACTED
REDACTED
	return nodes[0], nil
REDACTED
...
REDACTED
	...
	case 0:
		return nil, &NotFoundError{userattributevalue.LabelREDACTED
	default:
		return nil, &NotSingularError{userattributevalue.LabelREDACTED
REDACTED
REDACTED
...
REDACTED
	...
	case 0:
		err = &NotFoundError{userattributevalue.LabelREDACTED
	default:
		err = &NotSingularError{userattributevalue.LabelREDACTED
REDACTED
	return
REDACTED
...
REDACTED
	return &UserAttributeValueQuery{
		config:         _q.config,
		ctx:            _q.ctx.Clone(),
		order:          append([]userattributevalue.OrderOption{REDACTED, _q.order...),
		inters:         append([]Interceptor{REDACTED, _q.inters...),
		predicates:     append([]predicate.UserAttributeValue{REDACTED, _q.predicates...),
...
func (_q *UserAttributeValueQuery) GroupBy(field string, fields ...string) *UserAttributeValueGroupBy {
	...
	grbuild := &UserAttributeValueGroupBy{build: _qREDACTED
...
func (_q *UserAttributeValueQuery) Select(fields ...string) *UserAttributeValueSelect {
	...
	sbuild := &UserAttributeValueSelect{UserAttributeValueQuery: _qREDACTED
...
func (_q *UserAttributeValueQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserAttributeValue, error) {
	var (
		nodes       = []*UserAttributeValue{REDACTED
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
			_q.withUser != nil,
...
REDACTED
	_spec.Assign = func(columns []string, values []any) error {
		node := &UserAttributeValue{config: _q.configREDACTED
...
REDACTED
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *UserAttributeValue, e *User) { n.Edges.User = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	if query := _q.withDefinition; query != nil {
		if err := _q.loadDefinition(ctx, query, nodes, nil,
			func(n *UserAttributeValue, e *UserAttributeDefinition) { n.Edges.Definition = e REDACTED); err != nil {
			return nil, err
	REDACTED
REDACTED
	return nodes, nil
