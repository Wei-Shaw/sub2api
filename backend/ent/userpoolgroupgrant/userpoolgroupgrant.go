...
const (
	// Label holds the string label denoting the userpoolgroupgrant type in the database.
	Label = "user_pool_group_grant"
	...
	// FieldRpmOverride holds the string denoting the rpm_override field in the database.
	FieldRpmOverride = "rpm_override"
	...
	GroupFieldID = "id"
	// Table holds the table name of the userpoolgroupgrant in the database.
	Table = "user_pool_group_grants"
	// PoolTable is the table that holds the pool relation/edge.
	PoolTable = "user_pool_group_grants"
	...
	GroupTable = "user_pool_group_grants"
...
// Columns holds all SQL columns for userpoolgroupgrant fields.
var Columns = []string{
	FieldPoolID,
	FieldGroupID,
	FieldRateMultiplier,
...
// OrderOption defines the ordering options for the UserPoolGroupGrant queries.
...
// ByRpmOverride orders the results by the rpm_override field.
func ByRpmOverride(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldRpmOverride, opts...).ToFunc()
}
