...
func (*UserSubscription) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case usersubscription.FieldDailyUsageUsd, usersubscription.FieldFiveHourUsageUsd, usersubscription.FieldWeeklyUsageUsd, usersubscription.FieldMonthlyUsageUsd:
