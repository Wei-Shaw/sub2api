...
func load(allowMissingJWTSecret bool) (*Config, error) {
	...
	viper.AddConfigPath("/etc/ai2api")
...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "ai2api")
	...
	viper.SetDefault("database.dbname", "ai2api")
	...
	viper.SetDefault("dashboard_cache.key_prefix", "ai2api:")
