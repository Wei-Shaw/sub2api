...
func load(allowMissingJWTSecret bool) (*Config, error) {
	...
	viper.AddConfigPath("/etc/nub2api")
...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "nub2api")
	...
	viper.SetDefault("database.dbname", "nub2api")
	...
	viper.SetDefault("dashboard_cache.key_prefix", "nub2api:")
