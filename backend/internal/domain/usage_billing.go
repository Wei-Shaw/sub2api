...
// Batch image balance hold error sentinels shared with the service package.
var (
...
// batchImageHoldRequestPrefix is the dedup request-id prefix for the hold phase.
// Capture / release prefixes remain private to the service package.
const batchImageHoldRequestPrefix = "batch_image_hold:"

// BatchImageHoldRequestID builds the dedup request id for a batch image balance hold.
