...
func setupAvailableModelsRouter(adminSvc service.AdminService) *gin.Engine {
	...
	router := gin.New()
	handler := NewAccountHandler(adminSvc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func setupSyncUpstreamModelsRouter(adminSvc service.AdminService, upstream service.HTTPUpstream) *gin.Engine {
	...
	handler := NewAccountHandler(adminSvc, nil, nil, accountTestSvc, nil, nil, nil, nil, nil, nil, nil)
...
func TestAccountHandlerGetAvailableModels_OpenAIOAuthUsesExplicitModelMapping(t *testing.T) {
	...
	// Model lists are now handled by plugins. Without a plugin,
	// GetAvailableModels returns an empty list.
