	...
	adminSvc.accounts = []service.Account{
		{
			...
			AccountGroups: []service.AccountGroup{
				{AccountID: 101, GroupID: groupID, Priority: 100, Group: &service.Group{ID: groupID, Name: "openai"REDACTEDREDACTED,
		REDACTED,
	...
	REDACTED,
		{
			...
			Priority:    100000,
			AccountGroups: []service.AccountGroup{
				{AccountID: 102, GroupID: groupID, Priority: 1, Group: &service.Group{ID: groupID, Name: "openai"REDACTEDREDACTED,
		REDACTED,
			GroupIDs:  []int64{groupIDREDACTED,
			CreatedAt: now,
			UpdatedAt: now,
...
func TestAccountHandlerListKeepsSchedulerScoreScopedToFilter(t *testing.T) {
	...
	visibleAccount := service.Account{
		...
		Priority:    100000,
		AccountGroups: []service.AccountGroup{
			{AccountID: 201, GroupID: groupID, Priority: 1, Group: &service.Group{ID: groupID, Name: "openai"REDACTEDREDACTED,
	REDACTED,
		GroupIDs:  []int64{groupIDREDACTED,
		CreatedAt: now,
		UpdatedAt: now,
REDACTED
	hiddenGroupPeer := service.Account{
		...
		Priority:    1,
		AccountGroups: []service.AccountGroup{
			{AccountID: 202, GroupID: groupID, Priority: 2, Group: &service.Group{ID: groupID, Name: "openai"REDACTEDREDACTED,
	REDACTED,
		GroupIDs:  []int64{groupIDREDACTED,
		CreatedAt: now,
		UpdatedAt: now,
REDACTED
	adminSvc.accounts = []service.Account{visibleAccountREDACTED
	adminSvc.accountSchedulerScoreFilterAccounts = []service.Account{visibleAccount, hiddenGroupPeerREDACTED
	adminSvc.openAISchedulerScorePoolAccounts = []service.Account{visibleAccount, hiddenGroupPeerREDACTED
...
REDACTED
	adminSvc.accounts = []service.Account{visibleAccountREDACTED
	adminSvc.accountSchedulerScoreFilterAccounts = []service.Account{visibleAccount, hiddenFilterPeerREDACTED
