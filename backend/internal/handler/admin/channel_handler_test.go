...
REDACTED{
		{
			...
			pricing: []service.ChannelModelPricing{
				{BillingMode: service.BillingModeTokenREDACTED,
		REDACTED,
			wantErr: false,
	REDACTED,
		{
			...
			pricing: []service.ChannelModelPricing{
				{
					BillingMode: service.BillingModePerRequest,
					Intervals: []service.PricingInterval{
						{MinTokens: 0, MaxTokens: intPtr(1000), PerRequestPrice: float64Ptr(0.1)REDACTED,
				REDACTED,
			REDACTED,
		REDACTED,
			wantErr: false,
	REDACTED,
		{
			...
			pricing: []service.ChannelModelPricing{
				{BillingMode: service.BillingModePerRequestREDACTED,
		REDACTED,
			wantErr: true,
	REDACTED,
		{
	...
	REDACTED,
		{
			...
			pricing: []service.ChannelModelPricing{
				{BillingMode: service.BillingModeImageREDACTED,
		REDACTED,
			wantErr: true,
	REDACTED,
		{
			name:    "empty list - valid",
			pricing: []service.ChannelModelPricing{REDACTED,
			wantErr: false,
	REDACTED,
		{
