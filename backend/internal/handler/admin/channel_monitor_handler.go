...
func NewChannelMonitorHandler(monitorService *service.ChannelMonitorService) *ChannelMonitorHandler {
	return &ChannelMonitorHandler{monitorService: monitorServiceREDACTED
REDACTED
...
REDACTED
	response.Success(c, gin.H{"results": outREDACTED)
REDACTED
...
REDACTED
	response.Success(c, gin.H{"items": outREDACTED)
REDACTED
