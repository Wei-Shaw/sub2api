...
func (r *userBreakdownRepoCapture) GetUserBreakdownStats(
	...
	if r.result != nil {
		return r.result, nil
REDACTED
	return []usagestats.UserBreakdownItem{REDACTED, nil
REDACTED
...
func TestGetUserBreakdown_GroupIDFilter(t *testing.T) {
	repo := &userBreakdownRepoCapture{REDACTED
...
func TestGetUserBreakdown_ResponseFormat(t *testing.T) {
	repo := &userBreakdownRepoCapture{
		result: []usagestats.UserBreakdownItem{
			{UserID: 1, Email: "alice@test.com", Requests: 100, TotalTokens: 50000, Cost: 1.5, ActualCost: 1.2REDACTED,
			{UserID: 2, Email: "bob@test.com", Requests: 50, TotalTokens: 25000, Cost: 0.8, ActualCost: 0.6REDACTED,
	REDACTED,
REDACTED
	router := newUserBreakdownRouter(repo)
...
func TestGetUserBreakdown_RequestTypeStringFilter(t *testing.T) {
	cases := []struct {
		...
		want  int16
REDACTED{
		{"ws_v2", "ws_v2", int16(service.RequestTypeWSV2)REDACTED,
		{"stream", "stream", int16(service.RequestTypeStream)REDACTED,
		{"sync", "sync", int16(service.RequestTypeSync)REDACTED,
REDACTED
