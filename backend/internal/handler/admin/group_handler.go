...
func (h *GroupHandler) GetLiveCapability(c *gin.Context) {
	...
	result := gin.H{"supported": err == nilREDACTED
	if err != nil {
...
REDACTED
	if err := h.adminService.DeleteCompositeRoute(c.Request.Context(), groupID, routeID); err != nil {
		...
		return
REDACTED
	response.Success(c, gin.H{"message": "Composite route deleted"REDACTED)
REDACTED
...
REDACTED
	...
	response.Success(c, gin.H{"message": "Group deleted successfully"REDACTED)
REDACTED
...
REDACTED
	...
	response.Success(c, gin.H{"message": "RPM overrides updated successfully"REDACTED)
REDACTED
...
REDACTED
	...
	response.Success(c, gin.H{"message": "RPM overrides cleared successfully"REDACTED)
REDACTED
...
REDACTED `json:"updates" binding:"required,min=1"`
REDACTED
...
REDACTED
	...
	response.Success(c, gin.H{"message": "Sort order updated successfully"REDACTED)
REDACTED
