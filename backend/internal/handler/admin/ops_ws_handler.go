...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["nub2api-admin", "jwt.<token>"].
	// - We always select "nub2api-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"nub2api-admin"},
}
