...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["ai2api-admin", "jwt.<token>"].
	// - We always select "ai2api-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"ai2api-admin"},
}
