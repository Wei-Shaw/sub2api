...
REDACTED
	if in.ExpiresAt.Set {
		out.ExpiresAt = service.NullableTimeUpdate{Set: true, Value: in.ExpiresAt.ValueREDACTED
REDACTED
	if in.GroupID.Set {
		out.GroupID = service.NullableInt64Update{Set: true, Value: in.GroupID.ValueREDACTED
REDACTED
	return out
REDACTED
