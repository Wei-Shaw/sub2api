...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		DefaultExtraConcurrency:                                settings.DefaultExtraConcurrency,
		ExtraConcurrencyEnabled:                                settings.ExtraConcurrencyEnabled,
		ExtraConcurrencyWaitTimeoutSeconds:                     settings.ExtraConcurrencyWaitTimeoutSeconds,
		ExtraConcurrencyReservePercent:                         settings.ExtraConcurrencyReservePercent,
		ExtraConcurrencyMinReservedSlots:                       settings.ExtraConcurrencyMinReservedSlots,
		ExtraConcurrencyPlatformReserves:                       settings.ExtraConcurrencyPlatformReserves,
