...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		DefaultClaudeCodeTLSFingerprintProfileID: func() int64 {
			if req.DefaultClaudeCodeTLSFingerprintProfileID != nil {
				return *req.DefaultClaudeCodeTLSFingerprintProfileID
			}
