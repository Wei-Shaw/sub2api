...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		PaymentRechargeCustomEnabled:           paymentCfg.RechargeCustomEnabled,
...
type UpdateSettingsRequest struct {
	...
	PaymentRechargePackages          []service.BalanceRechargePackage `json:"payment_recharge_packages"`
	PaymentRechargeCustomEnabled     *bool                            `json:"payment_recharge_custom_amount_enabled"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	if h.paymentConfigService != nil && hasPaymentFields(req) {
		paymentReq := service.UpdatePaymentConfigRequest{
			...
			RechargeCustomEnabled:     req.PaymentRechargeCustomEnabled,
	...
	payload := dto.SystemSettings{
		...
		PaymentRechargeCustomEnabled:           updatedPaymentCfg.RechargeCustomEnabled,
...
func hasPaymentFields(req UpdateSettingsRequest) bool {
	return req.PaymentEnabled != nil || req.PaymentMinAmount != nil ||
		...
		req.PaymentRechargePackages != nil || req.PaymentRechargeCustomEnabled != nil ||
