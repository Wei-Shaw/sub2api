...
func (h *SystemHandler) PerformUpdate(c *gin.Context) {
	...
	payload := gin.H{"operation_id": operationIDREDACTED
...
// left by the last in-place update. With {"version": "x.y.z"REDACTED it downloads and
...
REDACTED
	...
	payload := gin.H{"operation_id": operationID, "version": targetVersionREDACTED
