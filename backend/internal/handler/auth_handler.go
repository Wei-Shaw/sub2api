...
func (h *AuthHandler) Register(c *gin.Context) {
	...
	if err := h.authService.VerifyTurnstileForRegister(c.Request.Context(), req.TurnstileToken, ip.ExactClientIP(c), req.VerifyCode); err != nil {
		response.ErrorFrom(c, err)
		return
	}
...
func (h *AuthHandler) SendVerifyCode(c *gin.Context) {
	...
	// Turnstile 验证
	if err := h.authService.VerifyTurnstile(c.Request.Context(), req.TurnstileToken, ip.ExactClientIP(c)); err != nil {
		response.ErrorFrom(c, err)
		return
	}
