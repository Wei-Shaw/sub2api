...
func TestRedactCredentials_StripsSensitiveKeysAndReportsStatus(t *testing.T) {
	in := map[string]any{
		...
		"service_account_json":  map[string]any{"private_key": "..."REDACTED,
		"private_key":           "raw-key",
		"agent_private_key":     "agent-key-secret",
		// 非敏感
		"base_url":      "https://api.example.com",
		"model_mapping": map[string]any{"foo": "bar"REDACTED,
		"project_id":    "proj-1",
...
REDACTED
	...
	require.Equal(t, map[string]any{"foo": "bar"REDACTED, out["model_mapping"])
