...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		PriorityAccountMultiplier:   l.PriorityAccountMultiplier,
		EffectiveMultiplier:         l.EffectiveMultiplier,
		EffectiveInputUnitPrice:     l.EffectiveInputUnitPrice,
		EffectiveOutputUnitPrice:    l.EffectiveOutputUnitPrice,
		EffectiveCacheReadUnitPrice: l.EffectiveCacheReadUnitPrice,
