...
type Account struct {
	...
	RateMultiplier                       float64                          `json:"rate_multiplier"`
	Status                               string                           `json:"status"`
	ProvisioningState                    service.AccountProvisioningState `json:"provisioning_state"`
	CodexIdentityPolicy                  service.CodexIdentityPolicySpec  `json:"codex_identity_policy"`
