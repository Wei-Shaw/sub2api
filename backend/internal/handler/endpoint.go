...
func GetUpstreamEndpoint(c *gin.Context, platform string) string {
	...
	if platform == service.PlatformOpenAI || platform == service.PlatformGrok || platform == service.PlatformGemini || service.IsCNProvider(platform) || service.IsMultiProtocolAPIKeyProvider(platform) {
