...
REDACTED
	...
	for _, platform := range []string{service.PlatformAnthropic, service.PlatformGemini, service.PlatformOpenAI, service.PlatformGrokREDACTED {
...
func defaultModelIDsForPlatform(platform string) []string {
	...
	case service.PlatformComposite:
		ids := make([]string, 0)
		seen := make(map[string]struct{REDACTED)
		for _, concretePlatform := range []string{service.PlatformAnthropic, service.PlatformGemini, service.PlatformOpenAI, service.PlatformGrokREDACTED {
