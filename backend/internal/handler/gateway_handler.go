...
func NewGatewayHandler(
	...
	if cfg != nil {
		concurrencyHelper.SetWaitTimeout(cfg.Gateway.Scheduling.ConcurrencyWaitTimeout)
	}
...
func (h *GatewayHandler) Messages(c *gin.Context) {
	...
	platform := resolveMessagesRequestPlatform(c, apiKey)
...
func (h *GatewayHandler) mapUpstreamError(statusCode int) (int, string, string) {
	...
	case 429:
		return http.StatusTooManyRequests, "rate_limit_error", service.UpstreamRateLimitClientMessage
	case 529:
