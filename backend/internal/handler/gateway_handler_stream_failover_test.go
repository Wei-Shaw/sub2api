...
const partialMessageStartSSE = "event: message_start\ndata: {\"type\":\"message_start\",\"message\":{\"id\":\"msg_01\",\"type\":\"message\",\"role\":\"assistant\",\"content\":[],\"model\":\"claude-sonnet-4-5\",\"stop_reason\":null,\"stop_sequence\":null,\"usage\":{\"input_tokens\":10,\"output_tokens\":1REDACTEDREDACTEDREDACTED\n\n" +
...
REDACTED
	...
	failoverErr := &service.UpstreamFailoverError{
		...
		ResponseBody: []byte(`{"error":{"type":"permission_error","message":"forbidden"REDACTEDREDACTED`),
REDACTED
	...
	// 断言 B：响应体以 SSE 错误事件结尾（data: {"type":"error",...REDACTED\n\n）
