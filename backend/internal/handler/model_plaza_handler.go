...
REDACTED
	...
	var allowedExclusive map[int64]struct{REDACTED
...
func filterPlazaVisibleGroups(
	...
	allowedExclusive map[int64]struct{REDACTED,
) []service.PlazaGroup {
...
REDACTED
	...
	REDACTED)
REDACTED
	return &modelPlazaTimePricing{Timezone: p.Timezone, WeekdaysOnly: p.WeekdaysOnly, Periods: periodsREDACTED
REDACTED
