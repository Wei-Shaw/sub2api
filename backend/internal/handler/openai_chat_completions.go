...
func (h *OpenAIGatewayHandler) ChatCompletions(c *gin.Context) {
	...
	if service.IsGPTImageGenerationModel(reqModel) {
		h.errorResponse(c, http.StatusBadRequest, "invalid_request_error", "This model is not supported on the Chat Completions endpoint. Use /v1/images/generations instead.")
		return
	}
