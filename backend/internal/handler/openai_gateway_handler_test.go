...
func TestOpenAIResponsesHandler_OpenCodeMetadataImageGenerationContinuesServerSide(t *testing.T) {
	...
	gatewayService := service.NewOpenAIGatewayService(
		...
		upstream, nil, nil, nil, nil, nil, store, nil, nil,
	)
...
func TestOpenAIResponsesWebSocket_PassthroughUsageLogPersistsUserAgentAndReasoningEffort(t *testing.T) {
	got := runOpenAIResponsesWebSocketUsageLogCase(t, openAIResponsesWSUsageLogCase{
		firstPayload: `{"type":"response.create","model":"gpt-5.4-Sys","stream":false,"reasoning":{"effort":"HIGH"}}`,
...
func TestOpenAIResponsesWebSocket_PassthroughUsageLogInfersReasoningFromInitialRequestModel(t *testing.T) {
	got := runOpenAIResponsesWebSocketUsageLogCase(t, openAIResponsesWSUsageLogCase{
		firstPayload: `{"type":"response.create","model":"gpt-5.4-xhigh-Sys","stream":false}`,
		userAgent:    testStringPtr("codex_cli_rs/0.125.0 mapped"),
		channelMapping: map[string]string{
			"gpt-5.4-xhigh-Sys": "gpt-5.4",
		},
	})
...
func TestOpenAIResponsesWebSocket_PassthroughUsageLogLeavesUserAgentNilWhenMissing(t *testing.T) {
	got := runOpenAIResponsesWebSocketUsageLogCase(t, openAIResponsesWSUsageLogCase{
		firstPayload: `{"type":"response.create","model":"gpt-5.4-Sys","stream":false,"reasoning":{"effort":"medium"}}`,
