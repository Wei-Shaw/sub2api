...
func TestResolveOpenAIMessagesDispatchMappedModel(t *testing.T) {
	...
	t.Run("uses_family_default_when_no_override", func(t *testing.T) {
		...
		require.Equal(t, "gpt-5.6-sol", resolveOpenAIMessagesDispatchMappedModel(nil, apiKey, "claude-opus-4-6"))
		require.Equal(t, "gpt-5.6-terra", resolveOpenAIMessagesDispatchMappedModel(nil, apiKey, "claude-sonnet-4-5-20250929"))
		require.Equal(t, "gpt-5.6-luna", resolveOpenAIMessagesDispatchMappedModel(nil, apiKey, "claude-haiku-4-5-20251001"))
	})
