...
REDACTED{
		{
			...
			body:        `{"code":1,"trade_status":"TRADE_SUCCESS","status":0,"money":"12.34","trade_no":"gateway-123"REDACTED`,
	...
	REDACTED,
		{
			...
			body:        `{"code":1,"trade_status":"WAITING","status":1,"money":"12.34","trade_no":"gateway-123"REDACTED`,
	...
	REDACTED,
		{
			...
			body:        `{"code":1,"trade_status":"","status":1,"money":"12.34"REDACTED`,
			wantStatus:  payment.ProviderStatusPending,
			wantTradeNo: orderID,
			wantAmount:  12.34,
	REDACTED,
		{
			...
			body:        `{"code":1,"data":{"trade_status":"TRADE_SUCCESS","status":0,"money":"9.99","trade_no":"data-456"REDACTEDREDACTED`,
			wantStatus:  payment.ProviderStatusPaid,
	...
	REDACTED,
		{
			...
			body:        `{"code":1,"status":1,"money":"3.21"REDACTED`,
			wantStatus:  payment.ProviderStatusPaid,
			wantTradeNo: orderID,
			wantAmount:  3.21,
	REDACTED,
		{
			...
			body:        `{"code":1,"status":0,"money":"3.21"REDACTED`,
			wantStatus:  payment.ProviderStatusPending,
			wantTradeNo: orderID,
			wantAmount:  3.21,
	REDACTED,
		{
			...
			body:        `{"code":0,"msg":"订单不存在"REDACTED`,
			wantStatus:  payment.ProviderStatusPending,
			wantTradeNo: orderID,
	REDACTED,
		{
