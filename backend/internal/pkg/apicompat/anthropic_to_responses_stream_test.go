...
REDACTED
	...
	idx := 0
	feed(&AnthropicStreamEvent{Type: "message_start", Message: &AnthropicResponse{ID: "msg_1", Model: "claude-sonnet-4-5"REDACTEDREDACTED)
	feed(&AnthropicStreamEvent{Type: "content_block_start", Index: &idx, ContentBlock: &AnthropicContentBlock{Type: "text"REDACTEDREDACTED)
	feed(&AnthropicStreamEvent{Type: "content_block_delta", Index: &idx, Delta: &AnthropicDelta{Type: "text_delta", Text: "Hel"REDACTEDREDACTED)
	feed(&AnthropicStreamEvent{Type: "content_block_delta", Index: &idx, Delta: &AnthropicDelta{Type: "text_delta", Text: "lo"REDACTEDREDACTED)
	feed(&AnthropicStreamEvent{Type: "content_block_stop", Index: &idxREDACTED)
	feed(&AnthropicStreamEvent{Type: "message_stop"REDACTED)
...
REDACTED
	...
	idx := 0
	feed(&AnthropicStreamEvent{Type: "message_start", Message: &AnthropicResponse{ID: "msg_1"REDACTEDREDACTED)
	feed(&AnthropicStreamEvent{Type: "content_block_start", Index: &idx, ContentBlock: &AnthropicContentBlock{Type: "text"REDACTEDREDACTED)
	feed(&AnthropicStreamEvent{Type: "content_block_delta", Index: &idx, Delta: &AnthropicDelta{Type: "text_delta", Text: "Hello "REDACTEDREDACTED)
	feed(&AnthropicStreamEvent{Type: "content_block_delta", Index: &idx, Delta: &AnthropicDelta{Type: "text_delta", Text: "world"REDACTEDREDACTED)
	feed(&AnthropicStreamEvent{Type: "content_block_stop", Index: &idxREDACTED)
...
REDACTED
	...
	feed(&AnthropicStreamEvent{Type: "message_start", Message: &AnthropicResponse{ID: "msg_1"REDACTEDREDACTED)
	feed(&AnthropicStreamEvent{Type: "content_block_start", Index: &idx, ContentBlock: &AnthropicContentBlock{Type: "text"REDACTEDREDACTED)
	feed(&AnthropicStreamEvent{Type: "content_block_delta", Index: &idx, Delta: &AnthropicDelta{Type: "text_delta", Text: "4826"REDACTEDREDACTED)
	feed(&AnthropicStreamEvent{Type: "content_block_stop", Index: &idxREDACTED)
	feed(&AnthropicStreamEvent{Type: "message_stop"REDACTED)
...
REDACTEDREDACTED)
	feed(&AnthropicStreamEvent{Type: "content_block_delta", Index: &idx, Delta: &AnthropicDelta{
		Type: "input_json_delta", PartialJSON: `"SH"REDACTED`,
REDACTEDREDACTED)
	feed(&AnthropicStreamEvent{Type: "content_block_stop", Index: &idxREDACTED)
	feed(&AnthropicStreamEvent{Type: "message_stop"REDACTED)
...
REDACTED
	if fc.Arguments != `{"city":"SH"REDACTED` {
		t.Errorf("arguments = %q, want %q", fc.Arguments, `{"city":"SH"REDACTED`)
REDACTED
