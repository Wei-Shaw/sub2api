...
REDACTED
	...
	done, changed, err := restorer.RestoreEvent([]byte(`{"type":"response.function_call_arguments.done","sequence_number":5,"output_index":0,"item_id":"i1","name":"browser__open","arguments":"{REDACTED"REDACTED`))
REDACTED
	require.True(t, changed)
