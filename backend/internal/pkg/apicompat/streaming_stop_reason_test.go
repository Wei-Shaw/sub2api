...
func TestAnthropicStreamingMaxTokens_MapsToIncomplete(t *testing.T) {
	...
	AnthropicEventToResponsesEvents(&AnthropicStreamEvent{
		Type:    "message_start",
		Message: &AnthropicResponse{ID: "msg_test", Model: "claude-opus-4-6", Role: "assistant"REDACTED,
REDACTED, state)
	...
	REDACTED,
		Usage: &AnthropicUsage{OutputTokens: 4096REDACTED,
REDACTED, state)
...
REDACTED, state)
	AnthropicEventToResponsesEvents(&AnthropicStreamEvent{
		Type:  "message_delta",
		Delta: &AnthropicDelta{StopReason: "max_tokens"REDACTED,
		Usage: &AnthropicUsage{OutputTokens: 4096REDACTED,
REDACTED, state)
...
REDACTED, state)
	...
	AnthropicEventToResponsesEvents(&AnthropicStreamEvent{
		Type:  "message_delta",
		Delta: &AnthropicDelta{StopReason: "end_turn"REDACTED,
		Usage: &AnthropicUsage{OutputTokens: 100REDACTED,
REDACTED, state)
