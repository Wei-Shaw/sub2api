...
const (
	...
	BetaInterleavedThinking      = "REDACTED"
...
var DroppedBetas = []string{REDACTED
...
// 用于 billing attribution block 中的 cc_version=X.Y.Z.{fpREDACTED 前缀以及 fingerprint 计算。
