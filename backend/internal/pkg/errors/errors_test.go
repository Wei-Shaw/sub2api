	...
	REDACTED,
		{
			...
			want:   Status{Code: 401, Reason: "UNAUTHORIZED", Message: "nope"REDACTED,
...
REDACTED{
		{name: "non_nil", md: map[string]string{"a": "1"REDACTEDREDACTED,
		{name: "nil", md: nilREDACTED,
REDACTED
...
REDACTED{
		{
			...
			wantBody:       Status{Code: int32(http.StatusOK)REDACTED,
	REDACTED,
		{
