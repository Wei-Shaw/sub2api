...
func TestMatchClientEntry_ReturnsHitEntry(t *testing.T) {
	entries := []AllowedClientEntry{
		{Originator: "opencode", UAContains: []string{"opencode/"REDACTED, SkipEngineFingerprint: trueREDACTED,
		{Originator: "Claude Code", UAContains: []string{"Claude Code/"REDACTEDREDACTED,
REDACTED
