	...
	REDACTED,
		{
			...
			wantOK:         true,
	REDACTED,
		{name: "含斜杠的尾部 name 拒绝配对（防自不一致身份）", ua: "foo/1.0 (Codex Desktop/2; 1.0)", wantOK: falseREDACTED,
		{
	...
	REDACTED,
		{
			...
			wantOK:         true,
	REDACTED,
		{name: "家族前缀夹带不可打印字节拒绝", ua: "Codex \x01evil/1.0.0", wantOK: falseREDACTED,
		{name: "家族前缀夹带非 ASCII 字节拒绝", ua: "Codex \xc3\xa9vil/1.0.0", wantOK: falseREDACTED,
		{name: "超长首段拒绝", ua: "Codex " + strings.Repeat("a", 80) + "/1.0.0", wantOK: falseREDACTED,
		{name: "第三方 UA 不可配对", ua: "luna/1.0.0", wantOK: falseREDACTED,
		{name: "伪造前缀不可配对", ua: "codex_cli_rs_evil/1.0.0", wantOK: falseREDACTED,
		{name: "浏览器 UA 不可配对", ua: "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0 Safari/537.36", wantOK: falseREDACTED,
		{name: "无斜杠不可配对", ua: "curl", wantOK: falseREDACTED,
		{name: "空 UA 不可配对", ua: "", wantOK: falseREDACTED,
REDACTED
