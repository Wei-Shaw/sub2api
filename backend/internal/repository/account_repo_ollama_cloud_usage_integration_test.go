...
REDACTED
	...
	REDACTED"api_key": "precision-" + name, "base_url": "https://ollama.com"REDACTED,
			Extra: map[string]any{
				service.OllamaCloudUsageSessionExtraKey:     "cipher:wos-session=fixture",
				service.OllamaCloudUsageAutoRefreshExtraKey: true,
...
REDACTED"api_key": "precision-due", "base_url": "https://ollama.com"REDACTED,
		Extra: map[string]any{
			service.OllamaCloudUsageSessionExtraKey:     "cipher:wos-session=fixture",
			service.OllamaCloudUsageAutoRefreshExtraKey: true,
			service.OllamaCloudUsageSnapshotExtraKey: map[string]any{
...
REDACTED"api_key": "shared-key", "base_url": "https://ollama.com"REDACTED,
		Extra: map[string]any{
			service.OllamaCloudUsageSessionExtraKey:     "cipher:wos-session=fixture",
			service.OllamaCloudUsageAutoRefreshExtraKey: true,
			service.OllamaCloudUsageSnapshotExtraKey: map[string]any{
...
REDACTED"api_key": "shared-key", "base_url": "https://www.ollama.com/v1"REDACTED,
		LastUsedAt:  &newer,
REDACTED)
...
REDACTED"api_key": "invalid-key", "base_url": "https://ollama.com"REDACTED,
		Extra: map[string]any{
			service.OllamaCloudUsageSessionExtraKey:     "cipher:wos-session=fixture",
			service.OllamaCloudUsageAutoRefreshExtraKey: true,
			service.OllamaCloudUsageSnapshotExtraKey: map[string]any{
...
REDACTED"api_key": "idle-key", "base_url": "https://ollama.com"REDACTED,
		Extra: map[string]any{
			service.OllamaCloudUsageSessionExtraKey:     "cipher:wos-session=fixture",
			service.OllamaCloudUsageAutoRefreshExtraKey: true,
			service.OllamaCloudUsageSnapshotExtraKey: map[string]any{
...
REDACTED"api_key": "sk-probe", "base_url": "https://relay.example.com/v1"REDACTED,
		Extra: map[string]any{
			service.UpstreamBillingProbeEnabledExtraKey: true,
			service.UpstreamBillingProbeExtraKey:        map[string]any{"status": "ok"REDACTED,
	REDACTED,
REDACTED)
...
REDACTED"api_key": "ollama-key", "base_url": "https://ollama.com"REDACTED,
		Extra: map[string]any{
			service.OllamaCloudUsageSessionExtraKey:     "cipher:wos-session=fixture",
			service.OllamaCloudUsageAutoRefreshExtraKey: true,
			service.OllamaCloudUsageSnapshotExtraKey: map[string]any{
...
REDACTED
	...
	notDueIDs := make(map[int64]struct{REDACTED, 21)
	for i := 0; i < 21; i++ {
		...
		notDueIDs[acc.ID] = struct{REDACTED{REDACTED
REDACTED
	...
	failInvalidNext := createFailed("ollama-fail-invalid-next", now.Add(-30*time.Minute), now.Add(-2*time.Minute), time.Time{REDACTED, "not-a-timestamp")
