...
func (s *ClaudeUsageServiceSuite) TestFetchUsage_Success() {
  ...
  "five_hour": {"utilization": 12.5, "resets_at": "2025-01-01T00:00:00Z"REDACTED,
  "seven_day": {"utilization": 34.0, "resets_at": "2025-01-08T00:00:00Z"REDACTED,
  "seven_day_sonnet": {"utilization": 56.0, "resets_at": "2025-01-08T00:00:00Z"REDACTED
REDACTED`)
REDACTED))

	s.fetcher = &claudeUsageService{usageURL: s.srv.URLREDACTED
