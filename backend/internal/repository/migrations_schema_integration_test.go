...
func TestMigrationsRunner_IsIdempotent_AndSchemaIsUpToDate(t *testing.T) {
	...
	requireColumn(t, tx, "usage_logs", "image_generation_cost", "numeric", 0, false)
	requireColumn(t, tx, "usage_logs", "image_actual_cost", "numeric", 0, false)
	requireColumn(t, tx, "usage_logs", "image_rate_multiplier", "numeric", 0, false)
