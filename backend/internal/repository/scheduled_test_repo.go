...
func NewScheduledTestPlanRepository(db *sql.DB) scheduledtest.ScheduledTestPlanRepository {
...
func NewScheduledTestResultRepository(db *sql.DB) scheduledtest.ScheduledTestResultRepository {
