...
REDACTED
	...
	keys := []string{activeKey, readyKey, schedulerBucketSetKey, snapshotKeyREDACTED
	args := []any{versionStr, bucket.String(), snapshotKeyPrefix, snapshotGraceTTLSecondsREDACTED
