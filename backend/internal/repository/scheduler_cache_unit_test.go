...
func TestBuildSchedulerMetadataAccount_KeepsOpenAIWSFlags(t *testing.T) {
	account := service.Account{
		...
		Extra: map[string]any{
			...
			service.OpenAIPromptCacheModeExtraKey:          service.OpenAIPromptCacheModeImplicitBreakpoints,
	...
	require.Equal(t, service.OpenAIPromptCacheModeImplicitBreakpoints, got.Extra[service.OpenAIPromptCacheModeExtraKey])
