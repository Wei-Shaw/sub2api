...
func NewUsageBillingRepository(_ *dbent.Client, sqlDB *sql.DB) service.UsageBillingRepository {
	return &usageBillingRepository{db: sqlDBREDACTED
REDACTED

func (r *usageBillingRepository) Apply(ctx context.Context, cmd *service.UsageBillingCommand) (_ *service.UsageBillingApplyResult, err error) {
	if cmd == nil {
		return &service.UsageBillingApplyResult{REDACTED, nil
REDACTED
	if r == nil || r.db == nil {
...
REDACTED
	if !applied {
		return &service.UsageBillingApplyResult{Applied: falseREDACTED, nil
REDACTED

	result := &service.UsageBillingApplyResult{Applied: trueREDACTED
