...
func (s *UsageLogRepoSuite) TestCreate() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "create@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-create", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-create"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetByID() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "getbyid@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-getbyid", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-getbyid"REDACTED)
...
func (s *UsageLogRepoSuite) TestDelete() {
	...
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-delete", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-delete"REDACTED)
...
func (s *UsageLogRepoSuite) TestListByUser() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "listbyuser@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-listbyuser", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-listbyuser"REDACTED)
...
func (s *UsageLogRepoSuite) TestListByApiKey() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "listbyapikey@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-listbyapikey", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-listbyapikey"REDACTED)
...
func (s *UsageLogRepoSuite) TestListByAccount() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "listbyaccount@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-listbyaccount", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-listbyaccount"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetUserStats() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "userstats@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-userstats", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-userstats"REDACTED)
...
func (s *UsageLogRepoSuite) TestListWithFilters() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "filters@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-filters", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-filters"REDACTED)
...
REDACTED)
	...
	group := mustCreateGroup(s.T(), s.db, &model.Group{Name: "g-ul"REDACTED)
	apiKey1 := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: userToday.ID, Key: "sk-ul-1", Name: "ul1"REDACTED)
	mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: userOld.ID, Key: "sk-ul-2", Name: "ul2", Status: model.StatusDisabledREDACTED)

	resetAt := now.Add(10 * time.Minute)
	accNormal := mustCreateAccount(s.T(), s.db, &model.Account{Name: "a-normal", Schedulable: trueREDACTED)
	mustCreateAccount(s.T(), s.db, &model.Account{Name: "a-error", Status: model.StatusError, Schedulable: trueREDACTED)
	mustCreateAccount(s.T(), s.db, &model.Account{Name: "a-rl", RateLimitedAt: &now, RateLimitResetAt: &resetAt, Schedulable: trueREDACTED)
	mustCreateAccount(s.T(), s.db, &model.Account{Name: "a-ov", OverloadUntil: &resetAt, Schedulable: trueREDACTED)
...
func (s *UsageLogRepoSuite) TestGetUserDashboardStats() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "userdash@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-userdash", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-userdash"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetAccountTodayStats() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "acctoday@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-acctoday", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-today"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetBatchUserUsageStats() {
	user1 := mustCreateUser(s.T(), s.db, &model.User{Email: "batch1@test.com"REDACTED)
	user2 := mustCreateUser(s.T(), s.db, &model.User{Email: "batch2@test.com"REDACTED)
	apiKey1 := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user1.ID, Key: "sk-batch1", Name: "k"REDACTED)
	apiKey2 := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user2.ID, Key: "sk-batch2", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-batch"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetBatchApiKeyUsageStats() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "batchkey@test.com"REDACTED)
	apiKey1 := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-batchkey1", Name: "k1"REDACTED)
	apiKey2 := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-batchkey2", Name: "k2"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-batchkey"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetGlobalStats() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "global@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-global", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-global"REDACTED)
...
func (s *UsageLogRepoSuite) TestListByUserAndTimeRange() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "timerange@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-timerange", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-timerange"REDACTED)
...
func (s *UsageLogRepoSuite) TestListByApiKeyAndTimeRange() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "keytimerange@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-keytimerange", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-keytimerange"REDACTED)
...
func (s *UsageLogRepoSuite) TestListByAccountAndTimeRange() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "acctimerange@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-acctimerange", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-acctimerange"REDACTED)
...
func (s *UsageLogRepoSuite) TestListByModelAndTimeRange() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "modeltimerange@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-modeltimerange", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-modeltimerange"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetAccountWindowStats() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "windowstats@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-windowstats", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-windowstats"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetUserUsageTrendByUserID() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "usertrend@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-usertrend", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-usertrend"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetUserUsageTrendByUserID_HourlyGranularity() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "usertrendhourly@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-usertrendhourly", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-usertrendhourly"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetUserModelStats() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "modelstats@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-modelstats", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-modelstats"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetUsageTrendWithFilters() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "trendfilters@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-trendfilters", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-trendfilters"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetUsageTrendWithFilters_HourlyGranularity() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "trendfilters-h@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-trendfilters-h", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-trendfilters-h"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetModelStatsWithFilters() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "modelfilters@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-modelfilters", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-modelfilters"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetAccountUsageStats() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "accstats@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-accstats", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-accstats"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetAccountUsageStats_EmptyRange() {
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-emptystats"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetUserUsageTrend() {
	user1 := mustCreateUser(s.T(), s.db, &model.User{Email: "usertrend1@test.com"REDACTED)
	user2 := mustCreateUser(s.T(), s.db, &model.User{Email: "usertrend2@test.com"REDACTED)
	apiKey1 := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user1.ID, Key: "sk-usertrend1", Name: "k1"REDACTED)
	apiKey2 := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user2.ID, Key: "sk-usertrend2", Name: "k2"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-usertrends"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetApiKeyUsageTrend() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "keytrend@test.com"REDACTED)
	apiKey1 := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-keytrend1", Name: "k1"REDACTED)
	apiKey2 := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-keytrend2", Name: "k2"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-keytrends"REDACTED)
...
func (s *UsageLogRepoSuite) TestGetApiKeyUsageTrend_HourlyGranularity() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "keytrendh@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-keytrendh", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-keytrendh"REDACTED)
...
func (s *UsageLogRepoSuite) TestListWithFilters_ApiKeyFilter() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "filterskey@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-filterskey", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-filterskey"REDACTED)
...
func (s *UsageLogRepoSuite) TestListWithFilters_TimeRange() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "filterstime@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-filterstime", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-filterstime"REDACTED)
...
func (s *UsageLogRepoSuite) TestListWithFilters_CombinedFilters() {
	user := mustCreateUser(s.T(), s.db, &model.User{Email: "filterscombined@test.com"REDACTED)
	apiKey := mustCreateApiKey(s.T(), s.db, &model.ApiKey{UserID: user.ID, Key: "sk-filterscombined", Name: "k"REDACTED)
	account := mustCreateAccount(s.T(), s.db, &model.Account{Name: "acc-filterscombined"REDACTED)
