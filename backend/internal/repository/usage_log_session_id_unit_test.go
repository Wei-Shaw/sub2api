...
// is followed by request_parameters, with created_at always last.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 68, "arg-type table must include image quality, enterprise fields, upstream response model, session_id and request parameters")
	...
	// created_at is last; request_parameters follows session_id.
