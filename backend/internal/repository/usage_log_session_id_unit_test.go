...
// is followed by billing_status and created_at.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 61, "arg-type table must include requested reasoning effort, session_id, and billing_status")
	...
	// billing_status and created_at follow session_id.
