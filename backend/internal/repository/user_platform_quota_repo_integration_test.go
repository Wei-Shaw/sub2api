...
func TestUserPlatformQuotaRepository_BulkInsertInitial_Idempotent(t *testing.T) {
	...
	records := []UserPlatformQuotaRecord{
		{UserID: userID, Platform: "anthropic", DailyLimitUSD: &dailyREDACTED,
		{UserID: userID, Platform: "openai"REDACTED,
REDACTED
...
func TestUserPlatformQuotaRepository_BulkInsertInitial_Empty(t *testing.T) {
	...
	require.NoError(t, repo.BulkInsertInitial(txCtx, []UserPlatformQuotaRecord{REDACTED))
REDACTED
...
func TestUserPlatformQuotaRepository_BulkInsertInitial_GrokAllowed(t *testing.T) {
	...
	daily := 9.0
	records := []UserPlatformQuotaRecord{
		{UserID: userID, Platform: "grok", DailyLimitUSD: &dailyREDACTED,
REDACTED
...
func TestUserPlatformQuotaRepository_BulkInsertInitial_CNProvidersAllowed(t *testing.T) {
	...
	daily := 12.0
	records := []UserPlatformQuotaRecord{
		{UserID: userID, Platform: "kimi", DailyLimitUSD: &dailyREDACTED,
		{UserID: userID, Platform: "zhipu"REDACTED,
		{UserID: userID, Platform: "deepseek"REDACTED,
REDACTED
	require.NoError(t, repo.BulkInsertInitial(txCtx, records),
...
func TestUserPlatformQuotaRepository_BulkInsertInitial_MultiRow(t *testing.T) {
	...
	records := []UserPlatformQuotaRecord{
		...
		{UserID: userID, Platform: "openai", DailyLimitUSD: &d2REDACTED,
		{UserID: userID, Platform: "gemini", DailyLimitUSD: &d3REDACTED,
REDACTED
...
REDACTED
	...
	byPlatform := map[string]*UserPlatformQuotaRecord{REDACTED
	for i := range list {
