...
const (
	...
	EventPromptRecordDropped       = "prompt_record.enqueue_dropped"
	EventPromptRecordPersistFailed = "prompt_record.persist_failed"
)
...
var knownLogEvents = map[string]struct{}{
	...
	EventPromptRecordDropped: {}, EventPromptRecordPersistFailed: {},
}
