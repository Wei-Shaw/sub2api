		...
		REDACTED,
			...
			wantJSON: `{
				...
				"data": {
					...
					"default_platform_quotas": {"anthropic":{"daily":null,"weekly":null,"monthly":nullREDACTED,"antigravity":{"daily":null,"weekly":null,"monthly":nullREDACTED,"gemini":{"daily":null,"weekly":null,"monthly":nullREDACTED,"openai":{"daily":null,"weekly":null,"monthly":nullREDACTEDREDACTED,
