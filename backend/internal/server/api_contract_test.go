...
import (
	...
	adminhandler "github.com/Wei-Shaw/Nub2api/internal/handler/admin"
		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName: "Nub2API",
					...
					service.SettingKeySiteName:     "Nub2API",
