...
import (
	...
	adminhandler "github.com/Usersxiao/ai2api/internal/handler/admin"
		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName: "AI2API",
					...
					service.SettingKeySiteName:     "AI2API",
