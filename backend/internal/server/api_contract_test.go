				...
				deps.groupRepo.SetActive([]service.Group{
					{
						...
						ModelRouting: map[string][]int64{
							"claude-3-*": []int64{101, 102REDACTED,
					REDACTED,
						AccountCount: 2,
						CreatedAt:    deps.now,
						UpdatedAt:    deps.now,
		...
		REDACTED,
			...
			wantJSON: `{
				...
				"data": {
					...
					"password_reset_enabled": false,
						...
						"login_agreement_documents": [
							{"id": "terms", "title": "服务条款", "content_md": ""REDACTED,
							{"id": "usage-policy", "title": "使用政策", "content_md": ""REDACTED,
							{"id": "supported-regions", "title": "支持的国家和地区", "content_md": ""REDACTED,
							{"id": "service-specific-terms", "title": "服务特定条款", "content_md": ""REDACTED
						],
					...
					"default_platform_quotas": {"anthropic":{"daily":null,"weekly":null,"monthly":nullREDACTED,"antigravity":{"daily":null,"weekly":null,"monthly":nullREDACTED,"deepseek":{"daily":null,"weekly":null,"monthly":nullREDACTED,"gemini":{"daily":null,"weekly":null,"monthly":nullREDACTED,"grok":{"daily":null,"weekly":null,"monthly":nullREDACTED,"kimi":{"daily":null,"weekly":null,"monthly":nullREDACTED,"openai":{"daily":null,"weekly":null,"monthly":nullREDACTED,"zhipu":{"daily":null,"weekly":null,"monthly":nullREDACTEDREDACTED,
					...
					"codex_cli_only_engine_fingerprint_signals": "[{\"type\":\"header_prefix\",\"match\":[\"x-codex-\"],\"required\":trueREDACTED,{\"type\":\"header_exact\",\"match\":[\"session-id\",\"session_id\"],\"required\":falseREDACTED,{\"type\":\"header_exact\",\"match\":[\"thread-id\",\"thread_id\"],\"required\":falseREDACTED,{\"type\":\"body_path\",\"match\":[\"client_metadata.x-codex-window-id\",\"client_metadata.x-codex-installation-id\"],\"required\":falseREDACTED]",
				...
				REDACTED,
					...
					"account_scheduling_thresholds": {"anthropic":100,"grok":100,"openai":100REDACTED,
	...
	REDACTED,
		{
			...
			body:   `{"account_ids":[101,102],"schedulable":falseREDACTED`,
			headers: map[string]string{
				"Content-Type": "application/json",
		REDACTED,
			wantStatus: http.StatusOK,
			wantJSON: `{
				...
				"data": {
					...
					"failed_ids": [],
					"results": [
						{"account_id": 101, "success": trueREDACTED,
						{"account_id": 102, "success": trueREDACTED
					]
			REDACTED
		REDACTED`,
	REDACTED,
...
REDACTED
	...
	accountRepo := stubAccountRepo{REDACTED
	proxyRepo := stubProxyRepo{REDACTED
	redeemRepo := &stubRedeemCodeRepo{REDACTED
...
func (r *stubUserRepo) AdjustBalance(ctx context.Context, id int64, delta float64) (service.BalanceChange, error) {
	return service.BalanceChange{REDACTED, errors.New("not implemented")
REDACTED
...
type stubProxyRepo struct{REDACTED
...
func (r *stubUsageLogRepo) GetStatsWithFilters(ctx context.Context, filters usagestats.UsageLogFilters) (*usagestats.UsageStats, error) {
	logs, _, err := r.ListWithFilters(ctx, pagination.PaginationParams{Page: 1, PageSize: 100000REDACTED, filters)
	if err != nil {
		return nil, err
REDACTED
...
REDACTED
	...
	return &usagestats.UsageStats{
		...
		TotalActualCost:          totalActualCost,
		AverageDurationMs:        avgDuration,
		Endpoints:                []usagestats.EndpointStat{REDACTED,
REDACTED, nil
REDACTED
