...
func (s *stubUserRepo) UpdateGiftBalance(context.Context, int64, float64) error { panic("unexpected UpdateGiftBalance call") }

func (s *stubUserRepo) UpdateFrozenGiftBalance(context.Context, int64, float64) error {
