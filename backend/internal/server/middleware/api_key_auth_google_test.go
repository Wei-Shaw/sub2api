...
func (f fakeGoogleSubscriptionRepo) ActivateWindows(ctx context.Context, id int64, fiveHourStart, start time.Time) error {
	if f.activateWindow != nil {
		return f.activateWindow(ctx, id, fiveHourStart, start)
	}
	return errors.New("not implemented")
}
