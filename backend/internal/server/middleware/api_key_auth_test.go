...
func TestSimpleModeBypassesQuotaCheck(t *testing.T) {
	...
	t.Run("standard_mode_needs_maintenance_does_not_block_request", func(t *testing.T) {
		...
		subscriptionRepo := &stubUserSubscriptionRepo{
			...
			activateWindow: func(ctx context.Context, id int64, fiveHourStart, start time.Time) error { return nil },
...
type stubUserSubscriptionRepo struct {
	...
	activateWindow func(ctx context.Context, id int64, fiveHourStart, start time.Time) error
...
func (r *stubUserSubscriptionRepo) ActivateWindows(ctx context.Context, id int64, fiveHourStart, start time.Time) error {
	if r.activateWindow != nil {
		return r.activateWindow(ctx, id, fiveHourStart, start)
	}
	return errors.New("not implemented")
}
