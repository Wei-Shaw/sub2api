...
var auditSensitiveReads = map[string]string{
	...
	"GET /api/v1/admin/accounts/:id/codex-device-slots": "admin.accounts.codex_device_slots.read",
}
...
var auditActionOverrides = map[string]string{
	...
	"POST /api/v1/admin/accounts/:id/codex-device-slots/finalize-draining": "admin.accounts.codex_device_slots.finalize_draining",
