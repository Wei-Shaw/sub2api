...
func NewOptionalJWTAuthMiddleware(
	...
	// mismatchSignal is nil: optional auth is used for public surfaces (e.g. model plaza)
	// where session-mismatch risk signaling is not required.
	strict := jwtAuth(authService, userService, userService, settingService, auditService, nil)
