...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.GET("/:id/usage-override", h.Admin.User.GetUserUsageOverride)
		users.PUT("/:id/usage-override", h.Admin.User.UpdateUserUsageOverride)
		users.DELETE("/:id/usage-override", h.Admin.User.DeleteUserUsageOverride)
