...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.GET("/:id/usage-ips", h.Admin.User.GetUserUsageIPs)
		users.POST("/usage-ips/test", h.Admin.User.TestUserUsageIPs)
		users.POST("/usage-ips/block", h.Admin.User.BlockUserUsageIPs)
		users.POST("/usage-ips/unblock", h.Admin.User.UnblockUserUsageIPs)
