...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.GET("/:id/api-keys", h.Admin.APIKey.List)
		users.GET("/:id/api-keys/:key_id", h.Admin.APIKey.Get)
		users.PUT("/:id/api-keys/:key_id", h.Admin.APIKey.Update)
		users.DELETE("/:id/api-keys/:key_id", h.Admin.APIKey.Delete)
