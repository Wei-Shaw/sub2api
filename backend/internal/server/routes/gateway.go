...
func RegisterGatewayRoutes(
	...
	r.POST("/images/generations", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, archiveCapture, gin.HandlerFunc(apiKeyAuth), requireGroupAnthropic, imagesHandler)
	r.POST("/images/edits", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, archiveCapture, gin.HandlerFunc(apiKeyAuth), requireGroupAnthropic, imagesHandler)
