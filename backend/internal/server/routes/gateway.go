...
// isOpenAICompatiblePlatform checks if the platform should be routed through the OpenAI gateway.
func isOpenAICompatiblePlatform(c *gin.Context) bool {
	p := getGroupPlatform(c)
	return p == service.PlatformOpenAI || p == service.PlatformDeepseek
}
