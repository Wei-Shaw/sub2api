...
REDACTED
	...
	REDACTED
		...
		if pointer.Prompt != "" {
			s.sendEvent(c, TestEvent{Type: "content", Text: pointer.PromptREDACTED)
	REDACTED
		s.sendEvent(c, TestEvent{
			Type:     "image",
...
REDACTED
	return map[string]any{
		...
		"client_contextual_info":   map[string]any{"app_name": "chatgpt.com"REDACTED,
