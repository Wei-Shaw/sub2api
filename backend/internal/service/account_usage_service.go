...
type UsageLogRepository interface {
	...
	GetAPIKeyUsageTrend(ctx context.Context, startTime, endTime time.Time, granularity string, limit int, userID int64) ([]usagestats.APIKeyUsageTrendPoint, error)
	...
	GetAPIKeyUsageRanking(ctx context.Context, startTime, endTime time.Time, limit int, sortBy string, userID int64) (*usagestats.APIKeyUsageRankingResponse, error)
