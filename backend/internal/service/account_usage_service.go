...
//
// Alias: 契约已迁移至 internal/domain。
type ClaudeUsageWindow = domain.ClaudeUsageWindow

// ClaudeUsageResponse Anthropic API返回的usage结构
//
// Alias: 契约已迁移至 internal/domain。
type ClaudeUsageResponse = domain.ClaudeUsageResponse

// ClaudeUsageFetchOptions 包含获取 Claude 用量数据所需的所有选项
//
// Alias: 契约已迁移至 internal/domain。
type ClaudeUsageFetchOptions = domain.ClaudeUsageFetchOptions

// ClaudeUsageFetcher fetches usage data from Anthropic OAuth API
//
// Alias: 接口契约已迁移至 internal/port/claudeusage。
type ClaudeUsageFetcher = claudeusage.ClaudeUsageFetcher
