...
type usageBatchLogRepoStub struct{REDACTED
...
func (r *usageBatchLogRepoStub) GetByID(context.Context, int64) (*UsageLog, error) {
	return nil, nil
REDACTED
func (r *usageBatchLogRepoStub) Delete(context.Context, int64) error { return nil REDACTED
...
REDACTED
	...
	svc := &AccountUsageService{
		accountRepo:  repo,
		usageLogRepo: &usageBatchLogRepoStub{REDACTED,
		cache:        NewUsageCache(),
REDACTED

	usageByAccount, errorsByAccount, err := svc.GetUsageBatch(context.Background(), []int64{7001, 7002, 7003, 7002REDACTED, false)
	if err != nil {
