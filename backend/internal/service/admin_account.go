...
func buildAccountForCreate(input *CreateAccountInput, accountExtra map[string]any) (*Account, error) {
	if err := validateAccountQuotaWindowThresholds(accountExtra); err != nil {
		return nil, err
	}
...
func (s *adminServiceImpl) CreateAccount(ctx context.Context, input *CreateAccountInput) (*Account, error) {
	if err := validateAccountQuotaWindowThresholds(input.Extra); err != nil {
		return nil, err
	}
	accountExtra, err := normalizeOpenAILongContextBillingExtra(input.Platform, input.Extra)
	if err != nil {
...
func (s *adminServiceImpl) UpdateAccount(ctx context.Context, id int64, input *UpdateAccountInput) (*Account, error) {
	...
	if input.Extra != nil {
		...
		normalizedExtra = preserveCNQuotaRuntimeExtra(account.Extra, normalizedExtra)
...
func (s *adminServiceImpl) UpdateAccountExtra(ctx context.Context, id int64, updates map[string]any) error {
	if err := validateAccountQuotaWindowThresholds(updates); err != nil {
		return err
	}
