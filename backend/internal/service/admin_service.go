...
type AdminService interface {
	...
	GetUserUsageStats(ctx context.Context, userID int64, period string) (interface{REDACTED, error)
...
func (s *adminServiceImpl) ListUsers(ctx context.Context, page, pageSize int, status, role, search string) ([]model.User, int64, error) {
	params := repository.PaginationParams{Page: page, PageSize: pageSizeREDACTED
...
func (s *adminServiceImpl) GetUserUsageStats(ctx context.Context, userID int64, period string) (interface{REDACTED, error) {
...
REDACTED
	...
	REDACTED
		...
		// 5. 删除分组本身
		if err := tx.Delete(&model.Group{REDACTED, id).Error; err != nil {
