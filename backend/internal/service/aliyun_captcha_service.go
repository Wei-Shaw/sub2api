...
var aliyunInvalidCredentialCodes = map[string]struct{REDACTED{
	"InvalidAccessKeyId.NotFound":  {REDACTED,
	"InvalidAccessKeyId.Inactive":  {REDACTED,
	"SignatureDoesNotMatch":        {REDACTED,
	"Forbidden.AccessKeyDisabled":  {REDACTED,
	"IncompleteSignature":          {REDACTED,
	"InvalidSecurityToken.Expired": {REDACTED,
REDACTED
...
func NewAliyunCaptchaService(settingService *SettingService, verifier AliyunCaptchaVerifier) *AliyunCaptchaService {
	return &AliyunCaptchaService{settingService: settingService, verifier: verifierREDACTED
REDACTED
...
REDACTED
	if cred.AccessKeyID == "" || cred.AccessKeySecret == "" || cred.SceneID == "" {
		return AliyunCaptchaCredentials{REDACTED, false
REDACTED
	return cred, true
REDACTED
