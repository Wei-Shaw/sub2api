...
REDACTED)
	...
	t.Run("单模型配额耗尽不标记（积分对此无效）", func(t *testing.T) {
		resp := &http.Response{StatusCode: http.StatusTooManyRequestsREDACTED
		body := []byte(`{"error":{"code":429,"message":"You have exhausted your capacity on this model. Your quota will reset after 146h11m17s.","status":"RESOURCE_EXHAUSTED"REDACTEDREDACTED`)
	...
	REDACTED,
		{
			...
			info: &UsageInfo{AICredits: []AICredit{REDACTEDREDACTED,
			want: false,
	REDACTED,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "GOOGLE_ONE_AI", Amount: 18778, MinimumBalance: 50REDACTED,
			REDACTED,
		REDACTED,
			want: true,
	REDACTED,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "GOOGLE_ONE_AI", Amount: 3, MinimumBalance: 5REDACTED,
			REDACTED,
		REDACTED,
			want: false,
	REDACTED,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "GOOGLE_ONE_AI", Amount: 6, MinimumBalance: 0REDACTED,
			REDACTED,
		REDACTED,
			want: true,
	REDACTED,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "GOOGLE_ONE_AI", Amount: 4, MinimumBalance: 0REDACTED,
			REDACTED,
		REDACTED,
			want: false,
	REDACTED,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "GOOGLE_ONE_AI", Amount: 5, MinimumBalance: 5REDACTED,
			REDACTED,
		REDACTED,
			want: true,
	REDACTED,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "OTHER_CREDIT", Amount: 10000, MinimumBalance: 5REDACTED,
			REDACTED,
		REDACTED,
			want: false,
	REDACTED,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "OTHER_CREDIT", Amount: 0, MinimumBalance: 5REDACTED,
					{CreditType: "GOOGLE_ONE_AI", Amount: 100, MinimumBalance: 10REDACTED,
			REDACTED,
		REDACTED,
			want: true,
	REDACTED,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "GOOGLE_ONE_AI", Amount: 6, MinimumBalance: -1REDACTED,
			REDACTED,
		REDACTED,
			want: true,
	REDACTED,
