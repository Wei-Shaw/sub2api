...
const apiKeyAuthSnapshotVersion = 11 // v11: include billing pool config fields
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		BillingPoolID:          apiKey.BillingPoolID,
		Name:                   apiKey.Name,
		Status:                 apiKey.Status,
		BillingMode:            apiKey.BillingMode,
		UsePoolDefaultOrder:    apiKey.UsePoolDefaultOrder,
		CustomFallbackGroupIDs: append([]int64(nil), apiKey.CustomFallbackGroupIDs...),
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	apiKey := &APIKey{
		...
		BillingPoolID:          snapshot.BillingPoolID,
		Key:                    key,
		Name:                   snapshot.Name,
		Status:                 snapshot.Status,
		BillingMode:            snapshot.BillingMode,
		UsePoolDefaultOrder:    snapshot.UsePoolDefaultOrder,
		CustomFallbackGroupIDs: append([]int64(nil), snapshot.CustomFallbackGroupIDs...),
