...
type UpdateAPIKeyRequest struct {
	...
	BillingMode               *string  `json:"billing_mode"`
	BillingPoolID             *int64   `json:"billing_pool_id"`
	ClearBillingPool          bool     `json:"-"`
	UsePoolDefaultOrder       *bool    `json:"use_pool_default_order"`
	CustomFallbackGroupIDs    []int64  `json:"custom_fallback_group_ids"`
	SetCustomFallbackGroupIDs bool     `json:"-"`
...
func (s *APIKeyService) Create(ctx context.Context, userID int64, req CreateAPIKeyRequest) (*APIKey, error) {
	...
	apiKey := &APIKey{
		...
		Name:                   req.Name,
		GroupID:                req.GroupID,
		BillingMode:            NormalizeAPIKeyBillingMode(req.BillingMode),
		BillingPoolID:          req.BillingPoolID,
	...
	if req.UsePoolDefaultOrder != nil {
		apiKey.UsePoolDefaultOrder = *req.UsePoolDefaultOrder
	}
...
func (s *APIKeyService) Update(ctx context.Context, id int64, userID int64, req UpdateAPIKeyRequest) (*APIKey, error) {
	...
	if req.BillingMode != nil {
		apiKey.BillingMode = NormalizeAPIKeyBillingMode(*req.BillingMode)
	}
	if req.BillingPoolID != nil || req.ClearBillingPool {
		apiKey.BillingPoolID = req.BillingPoolID
	}
	if req.UsePoolDefaultOrder != nil {
		apiKey.UsePoolDefaultOrder = *req.UsePoolDefaultOrder
	}
	if req.SetCustomFallbackGroupIDs {
		apiKey.CustomFallbackGroupIDs = append([]int64(nil), req.CustomFallbackGroupIDs...)
	}
