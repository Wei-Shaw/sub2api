...
type CreateAPIKeyRequest struct {
	...
	ExpiresInDays *int       `json:"expires_in_days"` // Legacy relative expiry (nil = never expires)
	ExpiresAt     *time.Time `json:"expires_at"`      // Exact expiry; takes precedence over ExpiresInDays
