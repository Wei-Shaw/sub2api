...
REDACTED
	parser := jwt.NewParser(jwt.WithValidMethods([]string{jwt.SigningMethodHS256.NameREDACTED))
	token, parseErr := parser.ParseWithClaims(tokenStr, &pendingOAuthClaims{REDACTED, func(t *jwt.Token) (any, error) {
