...
const (
	// MaxTokenLength limits token size to avoid excessive allocation while parsing headers.
	maxTokenLength = 8192
	// MinPasswordLength is the minimum accepted password length for all password-creation flows.
