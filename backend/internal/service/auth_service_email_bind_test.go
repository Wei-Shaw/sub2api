...
func (s *emailBindUserRepoStub) UpdateGiftBalance(context.Context, int64, float64) error { return nil }

func (s *emailBindUserRepoStub) UpdateFrozenGiftBalance(context.Context, int64, float64) error {
	return nil
}
