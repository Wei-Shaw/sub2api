...
func TestComputeCustomMenuVersion_Empty(t *testing.T) {
	v1 := ComputeCustomMenuVersion("", false)
	v2 := ComputeCustomMenuVersion("[]", false)
	v3 := ComputeCustomMenuVersion("   ", false)
	if v1 == "" || len(v1) != 12 {
...
func TestComputeCustomMenuVersion_Deterministic(t *testing.T) {
	...
	v1 := ComputeCustomMenuVersion(items, true)
	v2 := ComputeCustomMenuVersion(items, true)
	if v1 != v2 {
...
func TestComputeCustomMenuVersion_ArrayOrderInvariant(t *testing.T) {
	...
	if ComputeCustomMenuVersion(a, true) != ComputeCustomMenuVersion(b, true) {
...
func TestComputeCustomMenuVersion_FieldOrderInvariant(t *testing.T) {
	...
	if ComputeCustomMenuVersion(a, false) != ComputeCustomMenuVersion(b, false) {
...
func TestComputeCustomMenuVersion_EnabledToggleMatters(t *testing.T) {
	items := `[{"id":"a","label":"A","sort_order":1}]`
	if ComputeCustomMenuVersion(items, true) == ComputeCustomMenuVersion(items, false) {
		t.Fatalf("enabled toggle should mint new version")
	}
}
...
func TestComputeCustomMenuVersion_InvalidJSONFallsBackToEmpty(t *testing.T) {
	invalid := ComputeCustomMenuVersion("{not json", false)
	empty := ComputeCustomMenuVersion("[]", false)
	if invalid != empty {
