...
// key: "{groupIDREDACTED:{prefixHashREDACTED|{digestChainREDACTED" → *sessionEntry
...
REDACTED
	...
	s.cache.Set(ns+digestChain, &sessionEntry{uuid: uuid, accountID: accountIDREDACTED, gocache.DefaultExpiration)
