...
const (
	CustomerTypeRetail  = domain.CustomerTypeRetail
	CustomerTypeManaged = domain.CustomerTypeManaged
)
...
const (
	...
	SettingKeyInternalHomeDomains         = "internal_home_domains"         // 内部客户首页域名列表（换行/逗号分隔）
