...
func TestHandleResponsesStreamingResponse_NormalizesTerminalUsage(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			startUsage: `"input_tokens":173306`,
			deltaUsage: `"output_tokens":8,"cache_read_input_tokens":173306`,
			wantOutput: 8,
			wantCached: 173306,
		},
		{
			...
			startUsage: `"input_tokens":173306`,
			deltaUsage: `"output_tokens":8,"cached_tokens":173306`,
			wantOutput: 8,
			wantCached: 173306,
		},
		{
			...
			startUsage: `"input_tokens":173306`,
			deltaUsage: `"output_tokens":8,"prompt_tokens_details":{"cached_tokens":173306}`,
			wantOutput: 8,
			wantCached: 173306,
		},
		{
		...
		{
			name:              "cache creation only without prompt total or miss bucket",
			startUsage:        `"input_tokens":1200`,
			deltaUsage:        `"output_tokens":30,"cache_creation_input_tokens":800`,
			wantInput:         400,
			wantOutput:        30,
