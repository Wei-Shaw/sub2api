...
REDACTED{
		// groupID == nil（无分组 API Key）
		{
			...
			&Account{ID: 1, AccountGroups: nilREDACTED,
			nil, true,
	REDACTED,
		{
			"nil_groupID_ungrouped_account_empty_slice",
			&Account{ID: 2, AccountGroups: []AccountGroup{REDACTEDREDACTED,
			nil, true,
	REDACTED,
		{
			"nil_groupID_grouped_account_single",
			&Account{ID: 3, AccountGroups: []AccountGroup{{GroupID: 100REDACTEDREDACTEDREDACTED,
			nil, false,
	REDACTED,
		{
			"nil_groupID_grouped_account_multiple",
			&Account{ID: 4, AccountGroups: []AccountGroup{{GroupID: 100REDACTED, {GroupID: 200REDACTEDREDACTEDREDACTED,
			nil, false,
	REDACTED,
		// groupID != nil（有分组 API Key）
		{
			"with_groupID_account_in_group",
			&Account{ID: 5, AccountGroups: []AccountGroup{{GroupID: 100REDACTEDREDACTEDREDACTED,
			&groupID100, true,
	REDACTED,
		{
			"with_groupID_account_not_in_group",
			&Account{ID: 6, AccountGroups: []AccountGroup{{GroupID: 200REDACTEDREDACTEDREDACTED,
			&groupID100, false,
	REDACTED,
		{
			"with_groupID_ungrouped_account",
			&Account{ID: 7, AccountGroups: nilREDACTED,
			&groupID100, false,
	REDACTED,
		{
			"with_groupID_multi_group_account_match_one",
			&Account{ID: 8, AccountGroups: []AccountGroup{{GroupID: 100REDACTED, {GroupID: 200REDACTEDREDACTEDREDACTED,
			&groupID200, true,
	REDACTED,
		{
			"with_groupID_multi_group_account_no_match",
			&Account{ID: 9, AccountGroups: []AccountGroup{{GroupID: 300REDACTED, {GroupID: 400REDACTEDREDACTEDREDACTED,
			&groupID100, false,
	REDACTED,
		// 防御性边界
		{
...
func TestGroupIsolation_UngroupedKey_ShouldNotScheduleGroupedAccounts(t *testing.T) {
	...
	accounts := []Account{
		{ID: 1, Platform: PlatformOpenAI, Priority: 1, Status: StatusActive, Schedulable: true,
			AccountGroups: []AccountGroup{{GroupID: 100REDACTEDREDACTEDREDACTED,
		{ID: 2, Platform: PlatformOpenAI, Priority: 2, Status: StatusActive, Schedulable: true,
			AccountGroups: []AccountGroup{{GroupID: 200REDACTEDREDACTEDREDACTED,
REDACTED
...
func TestGroupIsolation_GroupedKey_ShouldNotScheduleUngroupedAccounts(t *testing.T) {
	...
	accounts := []Account{
		{ID: 1, Platform: PlatformOpenAI, Priority: 1, Status: StatusActive, Schedulable: true,
			AccountGroups: nilREDACTED,
		{ID: 2, Platform: PlatformOpenAI, Priority: 2, Status: StatusActive, Schedulable: true,
			AccountGroups: []AccountGroup{REDACTEDREDACTED,
REDACTED
	repo := newGroupAwareMockRepo(accounts)
	cache := &mockGatewayCacheForPlatform{REDACTED
...
func TestGroupIsolation_UngroupedKey_ShouldOnlyScheduleUngroupedAccounts(t *testing.T) {
	...
	accounts := []Account{
		{ID: 1, Platform: PlatformOpenAI, Priority: 1, Status: StatusActive, Schedulable: true,
			AccountGroups: []AccountGroup{{GroupID: 100REDACTEDREDACTEDREDACTED, // 已分组，不应被选中
		{ID: 2, Platform: PlatformOpenAI, Priority: 2, Status: StatusActive, Schedulable: true,
			AccountGroups: nilREDACTED, // 未分组，应被选中
		{ID: 3, Platform: PlatformOpenAI, Priority: 3, Status: StatusActive, Schedulable: true,
			AccountGroups: []AccountGroup{{GroupID: 200REDACTEDREDACTEDREDACTED, // 已分组，不应被选中
REDACTED
	repo := newGroupAwareMockRepo(accounts)
	cache := &mockGatewayCacheForPlatform{REDACTED
...
func TestGroupIsolation_GroupedKey_ShouldOnlyScheduleMatchingGroupAccounts(t *testing.T) {
	...
	accounts := []Account{
		{ID: 1, Platform: PlatformOpenAI, Priority: 1, Status: StatusActive, Schedulable: true,
			AccountGroups: nilREDACTED, // 未分组，不应被选中
		{ID: 2, Platform: PlatformOpenAI, Priority: 2, Status: StatusActive, Schedulable: true,
			AccountGroups: []AccountGroup{{GroupID: 200REDACTEDREDACTEDREDACTED, // 属于分组 200，不应被选中
		{ID: 3, Platform: PlatformOpenAI, Priority: 3, Status: StatusActive, Schedulable: true,
			AccountGroups: []AccountGroup{{GroupID: 100REDACTEDREDACTEDREDACTED, // 属于分组 100，应被选中
REDACTED
	repo := newGroupAwareMockRepo(accounts)
	cache := &mockGatewayCacheForPlatform{REDACTED
...
func TestGroupIsolation_SimpleMode_SkipsGroupIsolation(t *testing.T) {
	...
	accounts := []Account{
		{ID: 1, Platform: PlatformOpenAI, Priority: 2, Status: StatusActive, Schedulable: true,
			AccountGroups: []AccountGroup{{GroupID: 100REDACTEDREDACTEDREDACTED, // 已分组
		{ID: 2, Platform: PlatformOpenAI, Priority: 1, Status: StatusActive, Schedulable: true,
			AccountGroups: nilREDACTED, // 未分组
REDACTED
