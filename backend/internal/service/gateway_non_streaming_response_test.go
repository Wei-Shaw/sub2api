...
REDACTED{
		{
			...
			body: `{"id":"msg_1","type":"message","content":[{"type":"text","text":"unchanged"REDACTED],"usage":{"input_tokens":5,"output_tokens":3REDACTEDREDACTED`,
			want: `{"id":"msg_1","type":"message","content":[{"type":"text","text":"unchanged"REDACTED],"usage":{"input_tokens":0,"output_tokens":3,"cache_read_input_tokens":5REDACTEDREDACTED`,
	REDACTED,
		{
			name: "adds to genuine cache reads",
			body: `{"id":"msg_2","type":"message","usage":{"input_tokens":5,"output_tokens":3,"cache_read_input_tokens":7,"cache_creation_input_tokens":11REDACTEDREDACTED`,
			want: `{"id":"msg_2","type":"message","usage":{"input_tokens":0,"output_tokens":3,"cache_read_input_tokens":12,"cache_creation_input_tokens":11REDACTEDREDACTED`,
	REDACTED,
		{
			name: "zero input leaves response unchanged",
			body: `{"id":"msg_3","type":"message","usage":{"input_tokens":0,"output_tokens":3,"cache_read_input_tokens":7REDACTEDREDACTED`,
			want: `{"id":"msg_3","type":"message","usage":{"input_tokens":0,"output_tokens":3,"cache_read_input_tokens":7REDACTEDREDACTED`,
	REDACTED,
REDACTED
	...
	for _, tt := range tests {
		...
		REDACTED
			...
			usage, err := svc.handleNonStreamingResponseAnthropicAPIKeyPassthrough(WithForceCacheBilling(context.Background()), resp, c, &Account{ID: 2REDACTED)
