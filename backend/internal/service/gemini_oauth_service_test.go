...
func TestValidateTierID(t *testing.T) {
	...
	tests := []struct {
		...
		wantErr bool
REDACTED{
		{name: "空字符串合法", tierID: "", wantErr: falseREDACTED,
		{name: "正常 tier_id", tierID: "google_one_free", wantErr: falseREDACTED,
		{name: "包含斜杠", tierID: "tier/sub", wantErr: falseREDACTED,
		{name: "包含连字符", tierID: "gcp-standard", wantErr: falseREDACTED,
		{name: "纯数字", tierID: "12345", wantErr: falseREDACTED,
		{name: "超长字符串（65个字符）", tierID: strings.Repeat("a", 65), wantErr: trueREDACTED,
		{name: "刚好64个字符", tierID: strings.Repeat("b", 64), wantErr: falseREDACTED,
		{name: "非法字符_空格", tierID: "tier id", wantErr: trueREDACTED,
		{name: "非法字符_中文", tierID: "tier_中文", wantErr: trueREDACTED,
		{name: "非法字符_特殊符号", tierID: "tier@id", wantErr: trueREDACTED,
		{name: "非法字符_感叹号", tierID: "tier!id", wantErr: trueREDACTED,
REDACTED
...
REDACTED{
		// 空值
		{name: "空字符串", raw: "", want: ""REDACTED,
		{name: "纯空白", raw: "   ", want: ""REDACTED,

		// 已规范化的值（直接返回）
		{name: "google_one_free", raw: "google_one_free", want: GeminiTierGoogleOneFreeREDACTED,
		{name: "google_ai_pro", raw: "google_ai_pro", want: GeminiTierGoogleAIProREDACTED,
		{name: "google_ai_ultra", raw: "google_ai_ultra", want: GeminiTierGoogleAIUltraREDACTED,
		{name: "gcp_standard", raw: "gcp_standard", want: GeminiTierGCPStandardREDACTED,
		{name: "gcp_enterprise", raw: "gcp_enterprise", want: GeminiTierGCPEnterpriseREDACTED,
		{name: "aistudio_free", raw: "aistudio_free", want: GeminiTierAIStudioFreeREDACTED,
		{name: "aistudio_paid", raw: "aistudio_paid", want: GeminiTierAIStudioPaidREDACTED,
		{name: "google_one_unknown", raw: "google_one_unknown", want: GeminiTierGoogleOneUnknownREDACTED,

		// 大小写不敏感
		{name: "Google_One_Free 大写", raw: "Google_One_Free", want: GeminiTierGoogleOneFreeREDACTED,
		{name: "GCP_STANDARD 全大写", raw: "GCP_STANDARD", want: GeminiTierGCPStandardREDACTED,

		// legacy 映射: Google One
		{name: "AI_PREMIUM -> google_ai_pro", raw: "AI_PREMIUM", want: GeminiTierGoogleAIProREDACTED,
		{name: "FREE -> google_one_free", raw: "FREE", want: GeminiTierGoogleOneFreeREDACTED,
		{name: "GOOGLE_ONE_BASIC -> google_one_free", raw: "GOOGLE_ONE_BASIC", want: GeminiTierGoogleOneFreeREDACTED,
		{name: "GOOGLE_ONE_STANDARD -> google_one_free", raw: "GOOGLE_ONE_STANDARD", want: GeminiTierGoogleOneFreeREDACTED,
		{name: "GOOGLE_ONE_UNLIMITED -> google_ai_ultra", raw: "GOOGLE_ONE_UNLIMITED", want: GeminiTierGoogleAIUltraREDACTED,
		{name: "GOOGLE_ONE_UNKNOWN -> google_one_unknown", raw: "GOOGLE_ONE_UNKNOWN", want: GeminiTierGoogleOneUnknownREDACTED,

		// legacy 映射: Code Assist
		{name: "STANDARD -> gcp_standard", raw: "STANDARD", want: GeminiTierGCPStandardREDACTED,
		{name: "PRO -> gcp_standard", raw: "PRO", want: GeminiTierGCPStandardREDACTED,
		{name: "LEGACY -> gcp_standard", raw: "LEGACY", want: GeminiTierGCPStandardREDACTED,
		{name: "ENTERPRISE -> gcp_enterprise", raw: "ENTERPRISE", want: GeminiTierGCPEnterpriseREDACTED,
		{name: "ULTRA -> gcp_enterprise", raw: "ULTRA", want: GeminiTierGCPEnterpriseREDACTED,

		// kebab-case
		{name: "standard-tier -> gcp_standard", raw: "standard-tier", want: GeminiTierGCPStandardREDACTED,
		{name: "pro-tier -> gcp_standard", raw: "pro-tier", want: GeminiTierGCPStandardREDACTED,
		{name: "ultra-tier -> gcp_enterprise", raw: "ultra-tier", want: GeminiTierGCPEnterpriseREDACTED,

		// 未知值
		{name: "unknown_value -> 空", raw: "unknown_value", want: ""REDACTED,
		{name: "random-text -> 空", raw: "random-text", want: ""REDACTED,

		// 带空白
		{name: "带前后空白", raw: "  google_one_free  ", want: GeminiTierGoogleOneFreeREDACTED,
REDACTED
...
REDACTED{
		// google_one 类型过滤
		{name: "google_one + google_one_free", oauthType: "google_one", tierID: "google_one_free", want: GeminiTierGoogleOneFreeREDACTED,
		{name: "google_one + google_ai_pro", oauthType: "google_one", tierID: "google_ai_pro", want: GeminiTierGoogleAIProREDACTED,
		{name: "google_one + google_ai_ultra", oauthType: "google_one", tierID: "google_ai_ultra", want: GeminiTierGoogleAIUltraREDACTED,
		{name: "google_one + gcp_standard 被过滤", oauthType: "google_one", tierID: "gcp_standard", want: ""REDACTED,
		{name: "google_one + aistudio_free 被过滤", oauthType: "google_one", tierID: "aistudio_free", want: ""REDACTED,
		{name: "google_one + AI_PREMIUM 遗留映射", oauthType: "google_one", tierID: "AI_PREMIUM", want: GeminiTierGoogleAIProREDACTED,

		// code_assist 类型过滤
		{name: "code_assist + gcp_standard", oauthType: "code_assist", tierID: "gcp_standard", want: GeminiTierGCPStandardREDACTED,
		{name: "code_assist + gcp_enterprise", oauthType: "code_assist", tierID: "gcp_enterprise", want: GeminiTierGCPEnterpriseREDACTED,
		{name: "code_assist + google_one_free 被过滤", oauthType: "code_assist", tierID: "google_one_free", want: ""REDACTED,
		{name: "code_assist + aistudio_free 被过滤", oauthType: "code_assist", tierID: "aistudio_free", want: ""REDACTED,
		{name: "code_assist + STANDARD 遗留映射", oauthType: "code_assist", tierID: "STANDARD", want: GeminiTierGCPStandardREDACTED,
		{name: "code_assist + standard-tier kebab", oauthType: "code_assist", tierID: "standard-tier", want: GeminiTierGCPStandardREDACTED,

		// ai_studio 类型过滤
		{name: "ai_studio + aistudio_free", oauthType: "ai_studio", tierID: "aistudio_free", want: GeminiTierAIStudioFreeREDACTED,
		{name: "ai_studio + aistudio_paid", oauthType: "ai_studio", tierID: "aistudio_paid", want: GeminiTierAIStudioPaidREDACTED,
		{name: "ai_studio + gcp_standard 被过滤", oauthType: "ai_studio", tierID: "gcp_standard", want: ""REDACTED,
		{name: "ai_studio + google_one_free 被过滤", oauthType: "ai_studio", tierID: "google_one_free", want: ""REDACTED,

		// 空值
		{name: "空 tierID", oauthType: "google_one", tierID: "", want: ""REDACTED,
		{name: "空 oauthType + 有效 tierID", oauthType: "", tierID: "gcp_standard", want: GeminiTierGCPStandardREDACTED,
		{name: "未知 oauthType 接受规范化值", oauthType: "unknown_type", tierID: "gcp_standard", want: GeminiTierGCPStandardREDACTED,

		// oauthType 大小写和空白
		{name: "GOOGLE_ONE 大写", oauthType: "GOOGLE_ONE", tierID: "google_one_free", want: GeminiTierGoogleOneFreeREDACTED,
		{name: "oauthType 带空白", oauthType: "  code_assist  ", tierID: "gcp_standard", want: GeminiTierGCPStandardREDACTED,
REDACTED
...
REDACTED{
	...
	REDACTED,
		{
			name:         "空列表返回 LEGACY",
			allowedTiers: []geminicli.AllowedTier{REDACTED,
			want:         "LEGACY",
	REDACTED,
		{
			name: "有 IsDefault 的 tier",
			allowedTiers: []geminicli.AllowedTier{
				{ID: "STANDARD", IsDefault: falseREDACTED,
				{ID: "PRO", IsDefault: trueREDACTED,
				{ID: "ENTERPRISE", IsDefault: falseREDACTED,
		REDACTED,
			want: "PRO",
	REDACTED,
		{
	...
	REDACTED,
		{
			...
			allowedTiers: []geminicli.AllowedTier{
				{ID: "", IsDefault: trueREDACTED,
				{ID: "PRO", IsDefault: falseREDACTED,
		REDACTED,
			want: "PRO",
	REDACTED,
		{
	...
	REDACTED,
		{
			name: "ID 带空白会被 trim",
			allowedTiers: []geminicli.AllowedTier{
				{ID: "  STANDARD  ", IsDefault: trueREDACTED,
		REDACTED,
			want: "STANDARD",
	REDACTED,
		{
			...
			allowedTiers: []geminicli.AllowedTier{
				{ID: "ENTERPRISE", IsDefault: trueREDACTED,
		REDACTED,
			want: "ENTERPRISE",
	REDACTED,
		{
...
REDACTED{
		// 边界：<= 0
		{name: "0 bytes -> unknown", storageBytes: 0, want: GeminiTierGoogleOneUnknownREDACTED,
		{name: "负数 -> unknown", storageBytes: -1, want: GeminiTierGoogleOneUnknownREDACTED,

		// > 100TB -> ultra
		{name: "> 100TB -> ultra", storageBytes: int64(StorageTierUnlimited) + 1, want: GeminiTierGoogleAIUltraREDACTED,
		{name: "200TB -> ultra", storageBytes: 200 * int64(TB), want: GeminiTierGoogleAIUltraREDACTED,

		// >= 2TB -> pro (但 <= 100TB)
		{name: "正好 2TB -> pro", storageBytes: int64(StorageTierAIPremium), want: GeminiTierGoogleAIProREDACTED,
		{name: "5TB -> pro", storageBytes: 5 * int64(TB), want: GeminiTierGoogleAIProREDACTED,
		{name: "100TB 正好 -> pro (不是 > 100TB)", storageBytes: int64(StorageTierUnlimited), want: GeminiTierGoogleAIProREDACTED,

		// >= 15GB -> free (但 < 2TB)
		{name: "正好 15GB -> free", storageBytes: int64(StorageTierFree), want: GeminiTierGoogleOneFreeREDACTED,
		{name: "100GB -> free", storageBytes: 100 * int64(GB), want: GeminiTierGoogleOneFreeREDACTED,
		{name: "略低于 2TB -> free", storageBytes: int64(StorageTierAIPremium) - 1, want: GeminiTierGoogleOneFreeREDACTED,

		// < 15GB -> unknown
		{name: "1GB -> unknown", storageBytes: int64(GB), want: GeminiTierGoogleOneUnknownREDACTED,
		{name: "略低于 15GB -> unknown", storageBytes: int64(StorageTierFree) - 1, want: GeminiTierGoogleOneUnknownREDACTED,
		{name: "1 byte -> unknown", storageBytes: 1, want: GeminiTierGoogleOneUnknownREDACTED,
REDACTED
...
func TestIsNonRetryableGeminiOAuthError(t *testing.T) {
	...
	tests := []struct {
		...
		want bool
REDACTED{
		{name: "invalid_grant", err: fmt.Errorf("error: invalid_grant"), want: trueREDACTED,
		{name: "invalid_client", err: fmt.Errorf("oauth error: invalid_client"), want: trueREDACTED,
		{name: "unauthorized_client", err: fmt.Errorf("unauthorized_client: mismatch"), want: trueREDACTED,
		{name: "access_denied", err: fmt.Errorf("access_denied by user"), want: trueREDACTED,
		{name: "普通网络错误", err: fmt.Errorf("connection timeout"), want: falseREDACTED,
		{name: "HTTP 500 错误", err: fmt.Errorf("server error 500"), want: falseREDACTED,
		{name: "空错误信息", err: fmt.Errorf(""), want: falseREDACTED,
		{name: "包含 invalid 但不是完整匹配", err: fmt.Errorf("invalid request"), want: falseREDACTED,
REDACTED
...
func TestGeminiOAuthService_BuildAccountCredentials(t *testing.T) {
	...
	svc := NewGeminiOAuthService(nil, nil, nil, nil, &config.Config{REDACTED)
	defer svc.Stop()
...
REDACTED)
	...
	REDACTED
		...
		// 可选字段不应存在
		for _, key := range []string{"refresh_token", "token_type", "scope", "project_id", "tier_id", "oauth_type"REDACTED {
...
func (m *mockGeminiProxyRepo) Create(ctx context.Context, proxy *Proxy) error { panic("not impl") REDACTED
...
func (m *mockGeminiProxyRepo) ListByIDs(ctx context.Context, ids []int64) ([]Proxy, error) {
	panic("not impl")
REDACTED
func (m *mockGeminiProxyRepo) Update(ctx context.Context, proxy *Proxy) error { panic("not impl") REDACTED
func (m *mockGeminiProxyRepo) Delete(ctx context.Context, id int64) error     { panic("not impl") REDACTED
...
func (m *mockGeminiProxyRepo) ListWithFiltersAndAccountCount(ctx context.Context, params pagination.PaginationParams, protocol, status, search string) ([]ProxyWithAccountCount, *pagination.PaginationResult, error) {
	panic("not impl")
REDACTED
func (m *mockGeminiProxyRepo) ListActive(ctx context.Context) ([]Proxy, error) { panic("not impl") REDACTED
...
REDACTED
	...
	svc := NewGeminiOAuthService(nil, client, nil, nil, &config.Config{REDACTED)
	defer svc.Stop()
...
REDACTED
	...
	svc := NewGeminiOAuthService(&mockGeminiProxyRepo{REDACTED, client, nil, nil, &config.Config{REDACTED)
	defer svc.Stop()
...
REDACTED
	...
	svc := NewGeminiOAuthService(proxyRepo, client, nil, nil, &config.Config{REDACTED)
	defer svc.Stop()
	...
	codeAssist := &mockGeminiCodeAssistClient{
		loadCodeAssistFunc: func(ctx context.Context, accessToken, proxyURL string, req *geminicli.LoadCodeAssistRequest) (*geminicli.LoadCodeAssistResponse, error) {
			return &geminicli.LoadCodeAssistResponse{
				...
				CurrentTier:             &geminicli.TierInfo{ID: "STANDARD"REDACTED,
		REDACTED, nil
	REDACTED,
REDACTED

	svc := NewGeminiOAuthService(&mockGeminiProxyRepo{REDACTED, client, codeAssist, nil, &config.Config{REDACTED)
	defer svc.Stop()
...
REDACTED
	...
	svc := NewGeminiOAuthService(&mockGeminiProxyRepo{REDACTED, client, nil, &mockDriveClient{REDACTED, &config.Config{REDACTED)
	defer svc.Stop()
...
REDACTED
	...
	svc := NewGeminiOAuthService(&mockGeminiProxyRepo{REDACTED, client, nil, nil, cfg)
	defer svc.Stop()
