...
var geminiAIStudioActions = map[string]struct{REDACTED{
	"generateContent":       {REDACTED,
	"streamGenerateContent": {REDACTED,
	"countTokens":           {REDACTED,
REDACTED

// buildGeminiAIStudioModelActionURL 组装 AI Studio 的
// /v1beta/models/{modelREDACTED:{actionREDACTED 上游 URL。
//
