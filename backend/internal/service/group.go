...
type Group struct {
	...
	// 1K/2K/4K 三档 × 3 quality。nil/空 map 表示分组未启用矩阵定价。
	...
	// b64_json 内容做最小代价的头部解码，回填真实分辨率用于三档阈值计费；URL 模式不解码。
...
func (g *Group) ImagePricingTiers() []ImagePricingTier {
	if g == nil {
		return nil
	}
	return []ImagePricingTier{
		{Label: "1K", Resolution: g.ImageResolution1K, Price: g.ImagePrice1K},
		{Label: "2K", Resolution: g.ImageResolution2K, Price: g.ImagePrice2K},
		{Label: "4K", Resolution: g.ImageResolution4K, Price: g.ImagePrice4K},
	}
}
