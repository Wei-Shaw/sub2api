...
func TestClassifyImageBillingTier(t *testing.T) {
	tests := []struct {
		...
		{name: "long edge 1k square boundary", size: "2048x2048", wantTier: "1K", wantOK: true},
		{name: "long edge 1k landscape boundary", size: "2048x1152", wantTier: "1K", wantOK: true},
		...
		{name: "long edge 1k landscape", size: "1024X768", wantTier: "1K", wantOK: true},
		{name: "long edge 1k wide custom", size: "1280x768", wantTier: "1K", wantOK: true},
		{name: "long edge 1k portrait", size: "1024x1536", wantTier: "1K", wantOK: true},
		{name: "long edge 2k boundary", size: "2560x1440", wantTier: "2K", wantOK: true},
		{name: "long edge 2k tall boundary", size: "1440x2560", wantTier: "2K", wantOK: true},
