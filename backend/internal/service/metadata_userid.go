...
//
//	user_{64hexREDACTED_account_{optional_uuidREDACTED_session_{uuidREDACTED
var legacyUserIDRegex = regexp.MustCompile(`^user_([a-fA-F0-9]{64REDACTED)_account_([a-fA-F0-9-]*)_session_([a-fA-F0-9-]{36REDACTED)$`)
