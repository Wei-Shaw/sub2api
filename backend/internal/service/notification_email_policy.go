...
var notificationEmailChannelDefinitions = []notificationEmailChannelDefinition{
	...
	{ID: NotificationEmailChannelRefundUser, RecipientKind: NotificationEmailRecipientKindUser, DefaultEnabled: false, AllowUserPrimary: true, DefaultIncludePrimary: true},
