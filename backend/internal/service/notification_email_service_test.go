...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "AI2API", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "AI2API", "https://example.com/reset", "en-US"))
