...
func (s *defaultOpenAIAccountScheduler) selectBySessionHash(
	...
	if shouldClearStickySession(account, req.RequestedModel) || !accountMatchesOpenAIEndpointPlatform(account, req.Platform, req.RequiredCapability) || !account.IsSchedulable() {
		clearBinding()
		return nil, false, nil
	}
...
func (s *defaultOpenAIAccountScheduler) selectByLoadBalance(
	...
	for i := range accounts {
		...
		if !accountMatchesOpenAIEndpointPlatform(account, req.Platform, req.RequiredCapability) {
