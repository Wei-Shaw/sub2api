		...
		"input": []map[string]any{
			{
				...
				"content": []map[string]any{
					{"type": "input_text", "text": "Call the probe_ping function with ok=true to acknowledge readiness. You must use the tool."REDACTED,
			REDACTED,
		REDACTED,
	REDACTED,
		"tools": []map[string]any{
			{
				...
				"parameters": map[string]any{
					...
					"properties": map[string]any{
						"ok": map[string]any{"type": "boolean"REDACTED,
				REDACTED,
					"required": []string{"ok"REDACTED,
			REDACTED,
		REDACTED,
	REDACTED,
