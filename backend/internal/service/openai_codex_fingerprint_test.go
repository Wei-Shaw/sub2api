...
func TestGetCodexFingerprintMode(t *testing.T) {
	tests := []struct {
		...
		{"OpenAI setup token", &Account{Platform: PlatformOpenAI, Type: AccountTypeSetupToken, Extra: map[string]any{codexFingerprintModeExtraKey: "session"}}, codexFingerprintOff},
