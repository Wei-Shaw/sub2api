...
func (s *OpenAIGatewayService) ForwardAsChatCompletions(
	...
	// 4. Patch Responses request body for OAuth transforms and local continuations.
	// Metadata is intentionally not re-added here: raw Responses-shape requests
	// already strip unsupported top-level metadata before forwarding upstream.
