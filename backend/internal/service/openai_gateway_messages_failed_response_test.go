...
func buildResponsesFailedSSEStream(errType, errorMessage string) string {
	failed := fmt.Sprintf(`{"type":"response.failed","response":{"id":"resp_err","object":"response","status":"failed","error":{"type":"%s","message":"%s"REDACTED,"output":[],"usage":{"input_tokens":10,"output_tokens":0,"total_tokens":10REDACTEDREDACTEDREDACTED`, errType, errorMessage)
...
func TestForwardAsAnthropic_StreamingBareErrorAfterOutputIsVisible(t *testing.T) {
	...
	ssePayload := strings.Join([]string{
		`data: {"type":"response.created","response":{"id":"resp_bare_error","object":"response","model":"gpt-5.4","status":"in_progress","output":[]REDACTEDREDACTED`,
		"",
		`data: {"type":"response.output_text.delta","output_index":0,"content_index":0,"delta":"partial"REDACTED`,
		"",
		`event: error`,
		`data: {"type":"error","error":{"type":"server_error","code":"upstream_error","message":"mixed tools failed"REDACTEDREDACTED`,
		"",
		`data: [DONE]`,
		"",
REDACTED, "\n")
...
func TestForwardAsAnthropic_StreamingBareErrorBeforeOutputFailsOver(t *testing.T) {
	...
	ssePayload := strings.Join([]string{
		`event: error`,
		`data: {"type":"error","error":{"type":"server_error","code":"upstream_error","message":"temporary upstream failure"REDACTEDREDACTED`,
		"",
		`data: [DONE]`,
		"",
REDACTED, "\n")
