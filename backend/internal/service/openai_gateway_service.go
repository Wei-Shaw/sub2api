...
type OpenAIForwardResult struct {
	...
	// GrokVideoStatus is the normalized status of an asynchronous xAI video task.
	GrokVideoStatus string
...
type OpenAIGatewayService struct {
	...
	grokVideoSettlementRepo GrokVideoSettlementRepository
...
func NewOpenAIGatewayService(
	...
	if settlementRepo, ok := usageBillingRepo.(GrokVideoSettlementRepository); ok {
