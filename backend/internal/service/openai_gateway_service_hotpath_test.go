...
REDACTED
	...
	require.JSONEq(t, `{"model":"gpt-5","stream":false,"reasoning":{"effort":"none"REDACTED,"instructions":"You are a helpful coding assistant.","input":[{"type":"message","content":[{"type":"input_text","text":"hi","nonce":9007199254740993REDACTED]REDACTED]REDACTED`, string(upstream.lastBody))
