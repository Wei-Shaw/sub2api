...
func TestHandleSSEToJSON_CompletedEventReturnsJSON(t *testing.T) {
	...
	usage, err := svc.handleSSEToJSON(context.Background(), resp, c, nil, body, "gpt-4o", "gpt-4o", nil, "")
	require.NoError(t, err)
...
func TestHandleNonStreamingResponse_ObservesUpstreamModelBeforeClientRewrite(t *testing.T) {
	...
	result, err := svc.handleNonStreamingResponse(context.Background(), resp, c, account, "gpt-5.6-sol", "gpt-5.5", nil, "")
	require.NoError(t, err)
	require.NotNil(t, result)
...
func TestHandleSSEToJSON_ReconstructsImageGenerationOutputItemDone(t *testing.T) {
	...
	usage, err := svc.handleSSEToJSON(context.Background(), resp, c, nil, body, "gpt-5.4", "gpt-5.4", nil, "")
	require.NoError(t, err)
	require.NotNil(t, usage)
