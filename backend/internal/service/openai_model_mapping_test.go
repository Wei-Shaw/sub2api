...
func TestNormalizeCodexModel_UnknownMinorFallsBackToGPT54(t *testing.T) {
	t.Parallel()
...
func TestNormalizeOpenAIModelForUpstream_OAuthUnknownMinorFallsBackToGPT54(t *testing.T) {
	t.Parallel()
