...
func TestOpenAIGatewayService_OfficialAPIKeyRetriesExplicitNamespaceRejection(t *testing.T) {
	body := []byte(`{"model":"gpt-5.6","stream":false,"input":[{"type":"function_call","name":"spawn_agent","namespace":"collaboration","arguments":"{}"}]}`)
	upstream := &httpUpstreamRecorder{responses: []*http.Response{
