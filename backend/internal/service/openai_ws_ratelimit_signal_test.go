...
func (r *openAICodexExtraListRepo) ListWithFilters(_ context.Context, params pagination.PaginationParams, platform, accountType, status, search string, groupID int64, privacyMode string, healthStatus string) ([]Account, *pagination.PaginationResult, error) {
	_ = platform
	_ = accountType
	_ = status
	_ = search
...
func (r *openAICodexExtraListRepo) GetHealthSummary(_ context.Context) (*AccountHealthSummary, error) {
	return nil, nil
}
