...
func CategoryToFilter(category string) (phases []string, errorTypes []string) {
	switch category {
	case "auth":
		return []string{"auth"REDACTED, nil
	case "service_unavailable":
		return []string{"routing"REDACTED, nil
	case "upstream":
		return []string{"account_auth", "upstream", "network"REDACTED, nil
	case "internal":
		return []string{"internal"REDACTED, nil
	case "rate_limit":
		return nil, []string{"rate_limit_error"REDACTED
	case "quota":
		return nil, []string{"billing_error", "subscription_error"REDACTED
	case "invalid_request":
		return nil, []string{"invalid_request_error"REDACTED
	case "cyber":
		return []string{"request"REDACTED, []string{"cyber_policy"REDACTED
	default:
		return nil, nil
REDACTED
REDACTED
