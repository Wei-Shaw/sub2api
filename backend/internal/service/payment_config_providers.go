...
var providerSensitiveConfigFields = map[string]map[string]struct{}{
	payment.TypeSePay:       {"apikey": {}, "apitoken": {}},
...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	payment.TypeSePay:       {"apikey": {}, "apitoken": {}, "accountnumber": {}, "bankcode": {}, "bankbin": {}},
	payment.TypeNowPayments: {"apikey": {}, "ipnsecret": {}, "apibase": {}, "currency": {}},
}
...
var validProviderKeys = map[string]bool{
	payment.TypeSePay: true, payment.TypeNowPayments: true,
}
...
func (s *PaymentConfigService) UpdateProviderInstance(ctx context.Context, id int64, req UpdateProviderInstanceRequest) (*dbent.PaymentProviderInstance, error) {
	...
	// This surfaces provider-level errors (e.g. sepay missing bankCode) at save
	// time, so admins see them in the dialog instead of only when an order is
	// created.
