...
func (s *PaymentConfigService) UpdatePaymentConfig(ctx context.Context, req UpdatePaymentConfigRequest) error {
	...
	if req.RefundRequestUserEmailEnabled != nil {
		m[SettingRefundRequestUserEmailEnabled] = formatBoolOrEmpty(req.RefundRequestUserEmailEnabled)
	}
	if req.RefundRequestAdminEmailEnabled != nil {
		m[SettingRefundRequestAdminEmailEnabled] = formatBoolOrEmpty(req.RefundRequestAdminEmailEnabled)
	}
	if req.RefundResultUserEmailEnabled != nil {
		m[SettingRefundResultUserEmailEnabled] = formatBoolOrEmpty(req.RefundResultUserEmailEnabled)
	}
	if req.EasyPayAutoReconcileEnabled != nil {
		m[SettingEasyPayAutoReconcileEnabled] = formatBoolOrEmpty(req.EasyPayAutoReconcileEnabled)
	}
