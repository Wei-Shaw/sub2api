...
var (
	openAIModelDatePattern     = regexp.MustCompile(`-\d{8REDACTED$`)
...
REDACTED
	...
	REDACTED
		if _, ok := seen[c]; ok {
			continue
	REDACTED
		seen[c] = struct{REDACTED{REDACTED
		out = append(out, c)
REDACTED
	if len(out) == 0 {
		return []string{modelLowerREDACTED
REDACTED
	return out
REDACTED
...
REDACTED
	...
	families := []modelFamily{
		...
		{name: "opus-5", match: []string{"claude-opus-5"REDACTED, pricing: []string{"claude-opus-5", "claude-opus-4-8"REDACTEDREDACTED,
		{name: "opus-4.8", match: []string{"claude-opus-4-8", "claude-opus-4.8"REDACTED, pricing: []string{"claude-opus-4-8", "claude-opus-4.8", "claude-opus-4-7"REDACTEDREDACTED,
		{name: "opus-4.7", match: []string{"claude-opus-4-7", "claude-opus-4.7"REDACTED, pricing: []string{"claude-opus-4-7", "claude-opus-4.7", "claude-opus-4-6"REDACTEDREDACTED,
		{name: "opus-4.6", match: []string{"claude-opus-4-6", "claude-opus-4.6"REDACTEDREDACTED,
		{name: "opus-4.5", match: []string{"claude-opus-4-5", "claude-opus-4.5"REDACTEDREDACTED,
		{name: "opus-4", match: []string{"claude-opus-4", "claude-3-opus"REDACTEDREDACTED,
		{name: "sonnet-4.5", match: []string{"claude-sonnet-4-5", "claude-sonnet-4.5"REDACTEDREDACTED,
		{name: "sonnet-4", match: []string{"claude-sonnet-4", "claude-3-5-sonnet"REDACTEDREDACTED,
		{name: "sonnet-3.5", match: []string{"claude-3-5-sonnet", "claude-3.5-sonnet"REDACTEDREDACTED,
		{name: "sonnet-3", match: []string{"claude-3-sonnet"REDACTEDREDACTED,
		{name: "haiku-3.5", match: []string{"claude-3-5-haiku", "claude-3.5-haiku"REDACTEDREDACTED,
		{name: "haiku-3", match: []string{"claude-3-haiku"REDACTEDREDACTED,
REDACTED
