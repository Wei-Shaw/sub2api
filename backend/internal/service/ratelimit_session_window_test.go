...
func (m *sessionWindowMockRepo) ListWithFilters(context.Context, pagination.PaginationParams, string, string, string, string, int64, string, string, string, string) ([]Account, *pagination.PaginationResult, error) {
	panic("unexpected")
}
