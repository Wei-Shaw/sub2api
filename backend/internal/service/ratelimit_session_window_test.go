...
func (m *sessionWindowMockRepo) UpdateSessionWindow(_ context.Context, id int64, start, end *time.Time, status string) error {
	m.sessionWindowCalls = append(m.sessionWindowCalls, swCall{ID: id, Start: start, End: end, Status: statusREDACTED)
	return nil
REDACTED
...
func (m *sessionWindowMockRepo) UpdateExtra(_ context.Context, id int64, updates map[string]any) error {
	m.updateExtraCalls = append(m.updateExtraCalls, ueCall{ID: id, Updates: updatesREDACTED)
	return nil
REDACTED
...
func (m *sessionWindowMockRepo) Create(context.Context, *Account) error { panic("unexpected") REDACTED
...
func (m *sessionWindowMockRepo) ListCRSAccountIDs(context.Context) (map[string]int64, error) {
	panic("unexpected")
REDACTED
func (m *sessionWindowMockRepo) Update(context.Context, *Account) error { panic("unexpected") REDACTED
func (m *sessionWindowMockRepo) Delete(context.Context, int64) error    { panic("unexpected") REDACTED
...
func (m *sessionWindowMockRepo) ListByPlatform(context.Context, string) ([]Account, error) {
	panic("unexpected")
REDACTED
func (m *sessionWindowMockRepo) UpdateLastUsed(context.Context, int64) error { panic("unexpected") REDACTED
...
func (m *sessionWindowMockRepo) SetError(context.Context, int64, string) error {
	panic("unexpected")
REDACTED
func (m *sessionWindowMockRepo) ClearError(context.Context, int64) error { panic("unexpected") REDACTED
...
func (m *sessionWindowMockRepo) IncrementQuotaUsed(context.Context, int64, float64) error {
	panic("unexpected")
REDACTED
func (m *sessionWindowMockRepo) ResetQuotaUsed(context.Context, int64) error { panic("unexpected") REDACTED
...
func newRateLimitServiceForTest(repo AccountRepository) *RateLimitService {
	return &RateLimitService{accountRepo: repoREDACTED
REDACTED
...
func TestUpdateSessionWindow_UsesResetHeader(t *testing.T) {
	...
	repo := &sessionWindowMockRepo{REDACTED
	svc := newRateLimitServiceForTest(repo)

	account := &Account{ID: 42REDACTED // no existing window → needInitWindow=true
...
func TestUpdateSessionWindow_FallbackPredictionWhenNoResetHeader(t *testing.T) {
	...
	account := &Account{ID: 10REDACTED // no existing window
	headers := http.Header{REDACTED
...
func TestUpdateSessionWindow_ClearsUtilizationOnWindowReset(t *testing.T) {
	...
	account := &Account{ID: 33REDACTED // no existing window → needInitWindow=true
	headers := http.Header{REDACTED
	headers.Set("anthropic-ratelimit-unified-5h-status", "allowed")
	headers.Set("anthropic-ratelimit-unified-5h-reset", fmt.Sprintf("%d", resetUnix))
...
func TestUpdateSessionWindow_SamplesFable7dOiHeaders(t *testing.T) {
	...
	account := &Account{ID: 90, SessionWindowEnd: &existingEndREDACTED // needInitWindow=false
	headers := http.Header{REDACTED
	headers.Set("anthropic-ratelimit-unified-5h-status", "allowed")
...
func TestUpdateSessionWindow_ClearsFable7dOiOnWindowReset(t *testing.T) {
	...
	account := &Account{ID: 91REDACTED // no existing window → needInitWindow=true
	headers := http.Header{REDACTED
	headers.Set("anthropic-ratelimit-unified-5h-status", "allowed")
	headers.Set("anthropic-ratelimit-unified-5h-reset", fmt.Sprintf("%d", resetUnix))
...
REDACTED
	...
	for _, key := range []string{"passive_usage_7d_oi_utilization", "passive_usage_7d_oi_reset"REDACTED {
...
func TestUpdateSessionWindow_NoStatusHeader(t *testing.T) {
	...
	svc.UpdateSessionWindow(context.Background(), account, http.Header{REDACTED)
