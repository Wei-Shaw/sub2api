...
// usage_logs.session_id and grok_video_settlements.session_id column widths
// (VARCHAR(255)). Longer values are rejected so distinct identifiers can never alias
// through truncation.
...
//
// This value feeds usage-log and deferred-settlement correlation persistence. It does
// NOT affect sticky routing, account selection, request_id semantics, or upstream
// prompt caching, which keep their own (intentionally broader) session-signal
// resolution.
