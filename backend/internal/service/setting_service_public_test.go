...
func TestSettingService_GetPublicSettings_ExposesImageGenerationFeatureFlag(t *testing.T) {
...
func TestSettingService_GetPublicSettings_DefaultsImageGenerationFeatureFlagOff(t *testing.T) {
