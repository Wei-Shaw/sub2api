...
REDACTED)
	...
	t.Run("routing_invariant", func(t *testing.T) {
		...
		pid := int64(1)
		sparkShadow := &Account{ID: 2, ParentAccountID: &pid, Platform: PlatformOpenAI, Credentials: sparkCredsREDACTED
		...
		normalWithSpark := &Account{ID: 3, Platform: PlatformOpenAI, Credentials: sparkCredsREDACTED
