...
const (
	...
	UpstreamBillingProbeExtraKey        = domain.UpstreamBillingProbeExtraKey
	UpstreamBillingProbeEnabledExtraKey = domain.UpstreamBillingProbeEnabledExtraKey
...
var (
	ErrUpstreamBillingProbeUnavailable     = domain.ErrUpstreamBillingProbeUnavailable
	ErrUpstreamBillingProbeAccountInvalid  = domain.ErrUpstreamBillingProbeAccountInvalid
	ErrUpstreamBillingProbeIdentityChanged = domain.ErrUpstreamBillingProbeIdentityChanged
)

const (
	UpstreamBillingProbeStatusOK          = domain.UpstreamBillingProbeStatusOK
	UpstreamBillingProbeStatusUnsupported = domain.UpstreamBillingProbeStatusUnsupported
	UpstreamBillingProbeStatusFailed      = domain.UpstreamBillingProbeStatusFailed
)

// UpstreamBillingProbeSettings controls the periodic probe runner.
type UpstreamBillingProbeSettings = domain.UpstreamBillingProbeSettings
...
type UpstreamBillingProbeSnapshot = domain.UpstreamBillingProbeSnapshot

// UpstreamBillingProbeResult is returned by manual probe endpoints.
type UpstreamBillingProbeResult = domain.UpstreamBillingProbeResult
