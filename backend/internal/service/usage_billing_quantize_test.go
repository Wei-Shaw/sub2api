...
func TestQuantizeUsageBillingAmountBoundaries(t *testing.T) {
	cases := []struct {
		...
		in   float64
REDACTED{
		{"below_half", 0.000078120REDACTED,
		{"just_below_half", 0.000078124REDACTED,
		{"exact_half", 0.000078125REDACTED,
		{"just_above_half", 0.000078126REDACTED,
		{"above_half", 0.000078130REDACTED,
		{"long_tail", 0.0000781234567REDACTED,
		{"already_quantized", 0.00007813REDACTED,
REDACTED
...
REDACTED
	...
	for _, n := range []int64{1, 10, 100, 1000REDACTED {
