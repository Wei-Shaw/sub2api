...
func ProvideDashboardAggregationService(repo DashboardAggregationRepository, timingWheel *TimingWheelService, redisClient *redis.Client, db *sql.DB, cfg *config.Config) *DashboardAggregationService {
	svc := NewDashboardAggregationService(repo, timingWheel, cfg)
	svc.SetLeaderLockBackends(redisClient, db)
	svc.Start()
	return svc
}
...
func ProvideSubscriptionExpiryService(userSubRepo UserSubscriptionRepository, settingRepo SettingRepository, notificationEmailService *NotificationEmailService, redisClient *redis.Client, db *sql.DB) *SubscriptionExpiryService {
...
func ProvidePaymentOrderExpiryService(paymentSvc *PaymentService, redisClient *redis.Client, db *sql.DB) *PaymentOrderExpiryService {
