...
// 编译期接口断言
var _ service.ConcurrencyCache = StubConcurrencyCache{REDACTED
...
func (c StubConcurrencyCache) IncrementWaitCount(_ context.Context, _ int64, _ int) (bool, error) {
	return true, nil
REDACTED
func (c StubConcurrencyCache) DecrementWaitCount(_ context.Context, _ int64) error { return nil REDACTED
...
func (c StubConcurrencyCache) GetUsersLoadBatch(_ context.Context, users []service.UserWithConcurrency) (map[int64]*service.UserLoadInfo, error) {
	...
	for _, u := range users {
		result[u.ID] = &service.UserLoadInfo{UserID: u.ID, LoadRate: 0REDACTED
REDACTED
	return result, nil
REDACTED
...
var _ service.GatewayCache = StubGatewayCache{REDACTED

type StubGatewayCache struct{REDACTED
...
var _ service.SessionLimitCache = StubSessionLimitCache{REDACTED

type StubSessionLimitCache struct{REDACTED
