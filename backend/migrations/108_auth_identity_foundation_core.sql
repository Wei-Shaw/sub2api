...
CREATE TABLE IF NOT EXISTS auth_identities (
    ...
    issuer TEXT NULL,
    metadata JSONB NOT NULL DEFAULT '{REDACTED'::jsonb,
...
CREATE TABLE IF NOT EXISTS pending_auth_sessions (
    ...
    upstream_identity_claims JSONB NOT NULL DEFAULT '{REDACTED'::jsonb,
    local_flow_state JSONB NOT NULL DEFAULT '{REDACTED'::jsonb,
...
CREATE TABLE IF NOT EXISTS auth_identity_migration_reports (
    ...
    details JSONB NOT NULL DEFAULT '{REDACTED'::jsonb,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
