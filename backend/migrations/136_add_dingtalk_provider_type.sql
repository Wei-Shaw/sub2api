...
ALTER TABLE users
    ...
    CHECK (signup_source IN ('email', 'linuxdo', 'wechat', 'wecom', 'oidc', 'github', 'google', 'dingtalk'));
...
ALTER TABLE auth_identities
    ...
    CHECK (provider_type IN ('email', 'linuxdo', 'wechat', 'wecom', 'oidc', 'github', 'google', 'dingtalk'));
