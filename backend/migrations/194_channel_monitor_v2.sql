...
CREATE TABLE IF NOT EXISTS channel_monitor_v2_config (
    ...
    platforms JSONB NOT NULL DEFAULT '[{"platform":"anthropic","enabled":true,"models":[]REDACTED,{"platform":"openai","enabled":true,"models":[]REDACTED,{"platform":"grok","enabled":true,"models":[]REDACTED,{"platform":"kiro","enabled":true,"models":[]REDACTED,{"platform":"gemini","enabled":true,"models":[]REDACTED,{"platform":"antigravity","enabled":true,"models":[]REDACTED]'::jsonb,
    group_ids BIGINT[] NOT NULL DEFAULT '{REDACTED',
    updated_by BIGINT,
