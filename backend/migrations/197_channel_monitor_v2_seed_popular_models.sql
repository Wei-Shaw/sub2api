...
WHERE id = 1
  ...
  AND platforms = '[{"platform":"anthropic","enabled":true,"models":[]REDACTED,{"platform":"openai","enabled":true,"models":[]REDACTED,{"platform":"grok","enabled":true,"models":[]REDACTED,{"platform":"kiro","enabled":true,"models":[]REDACTED,{"platform":"gemini","enabled":true,"models":[]REDACTED,{"platform":"antigravity","enabled":true,"models":[]REDACTED]'::jsonb;
