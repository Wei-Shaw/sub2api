...
func TestMigration137AllowsWeComAuthProvider(t *testing.T) {
	content, err := FS.ReadFile("137_allow_wecom_auth_provider_types.sql")
	require.NoError(t, err)
...
func TestMigration140RestoresDingTalkAfterWeComProviderConstraint(t *testing.T) {
	content, err := FS.ReadFile("140_restore_dingtalk_provider_constraints.sql")
	require.NoError(t, err)
...
func TestMigration142RestoresFinalAuthProviderConstraintsAfterUpstreamFollowups(t *testing.T) {
	content, err := FS.ReadFile("142_restore_auth_provider_constraints_after_upstream.sql")
	require.NoError(t, err)
