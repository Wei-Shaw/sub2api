#!/usr/bin/env python3
"""Replay a captured CLIENT_ORIGINAL_OPENAI request body."""
...
DEFAULT_HEADERS = {
    ...
    "X-Client-Request-Id": "019f02eb-6187-7071-855f-d8b1a4ae1304",
    "X-Codex-Beta-Features": "remote_compaction_v2",
    "X-Codex-Window-Id": "019f02eb-6187-7071-855f-d8b1a4ae1304:232",
    "Thread-Id": "019f02eb-6187-7071-855f-d8b1a4ae1304",
    ...
    "Session-Id": "019f02eb-6187-7071-855f-d8b1a4ae1304",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Replay a hard-coded CLIENT_ORIGINAL_OPENAI request with a body file."
    )
