...
main() {
    ...
    echo "     Direct access: uncomment the sub2api 'ports' mapping in"
    echo "     docker-compose.yml, then http://localhost:8080"
    echo "     Behind the bundled caddy service: https://<your-domain>"
    echo "     (see CLOUDFLARE_VPS_VI.md)"
    echo ""
