...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/a515642/sub2api/main/deploy/install.sh | bash
#
...
Documentation=https://github.com/a515642/sub2api
