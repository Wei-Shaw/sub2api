...
GET  /v1/images/tasks/{task_idREDACTED
```

The aliases are `/images/generations/async`, `/images/edits/async`, and `/images/tasks/{task_idREDACTED`.
