...
- Settlement request id is `batch_image_settlement:{batch_idREDACTED`.
...
batch_image:
  ...
  vertex_managed_gcs_prefix: "batch-image/{envREDACTED/{batch_idREDACTED"
