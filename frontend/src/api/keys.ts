 ...
 * @param platformLimits - Optional per-upstream-platform sub-limits
...
export async function create(
  ...
  if (platformLimits && Object.keys(platformLimits).length > 0) {
    payload.platform_limits = platformLimits
  }
