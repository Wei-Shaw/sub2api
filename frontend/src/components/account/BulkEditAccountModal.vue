    ...
    <form id="bulk-edit-account-form" class="space-y-5" @submit.prevent="() => handleSubmit()">
      ...
      <div class="rounded-lg bg-blue-50 p-4 dark:bg-blue-900/20">
        <p class="text-sm text-blue-700 dark:text-blue-400">
          ...
          {{ t('admin.accounts.bulkEdit.selectionInfo', { count: targetMode === 'filtered' ? targetPreviewCount : accountIds.length REDACTED) REDACTEDREDACTED
        </p>
      </div>
      ...
      <div v-if="isMixedPlatform" class="rounded-lg bg-amber-50 p-4 dark:bg-amber-900/20">
        <p class="text-sm text-amber-700 dark:text-amber-400">
          ...
          {{ t('admin.accounts.bulkEdit.mixedPlatformWarning', { platforms: targetSelectedPlatforms.join(', ') REDACTED) REDACTEDREDACTED
        </p>
      </div>
      ...
      >
        <div class="mb-3 flex items-center justify-between">
          <div class="flex-1 pr-4">
            ...
            >
              {{ t('admin.accounts.openai.oauthPassthrough') REDACTEDREDACTED
            </label>
      ...
      >
        <div class="mb-3 flex items-center justify-between">
          <div class="flex-1 pr-4">
            ...
            >
              {{ t('admin.accounts.openai.flattenNamespaces') REDACTEDREDACTED
            </label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
      ...
      >
        <div class="mb-3 flex items-center justify-between gap-4">
          <div class="flex-1">
            ...
            >
              {{ t('admin.accounts.openai.longContextBilling') REDACTEDREDACTED
            </label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
        ...
        >
          {{ t('admin.accounts.bulkEdit.longContextShadowHint') REDACTEDREDACTED
        </p>
      </div>
      ...
      <div v-if="allHeaderOverrideCapable" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="flex items-center justify-between">
          <div class="flex-1 pr-4">
            ...
            >
              {{ t('admin.accounts.headerOverride.title') REDACTEDREDACTED
            </label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
        ...
        <div v-if="enableHeaderOverride" id="bulk-edit-header-override-body" class="mt-3 space-y-3">
          ...
          <div v-if="headerOverrideEnabled" class="space-y-3">
            ...
            <p class="text-xs text-amber-600 dark:text-amber-400">
              {{ t('admin.accounts.headerOverride.bulkReplaceHint') REDACTEDREDACTED
            </p>
          ...
          <p v-else class="text-xs text-gray-500 dark:text-gray-400">
            {{ t('admin.accounts.headerOverride.bulkDisableHint') REDACTEDREDACTED
          </p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4 border-t border-gray-200 pt-4 dark:border-dark-600 lg:grid-cols-4">
        ...
        <div>
          <div class="mb-3 flex items-center justify-between">
            ...
            >
              {{ t('admin.accounts.loadFactor') REDACTEDREDACTED
            </label>
            <input
        ...
        <div>
          ...
          >
            ...
            <span>{{ t('admin.accounts.bulkEdit.rateSyncWarning') REDACTEDREDACTED</span>
          </p>
        </div>
      </div>
      ...
      <div v-if="allOpenAIOAuth" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between">
          ...
          >
            {{ t('admin.accounts.openai.wsMode') REDACTEDREDACTED
          </label>
          <input
      ...
      <div v-if="allOpenAIOAuth" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between">
          ...
          >
            {{ t('admin.accounts.openai.codexCLIOnly') REDACTEDREDACTED
          </label>
          <input
      ...
      <div v-if="allOpenAIOAuth" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between">
          ...
          >
            {{ t('admin.accounts.openai.codexCLIOnlyAppServer') REDACTEDREDACTED
          </label>
          <input
      ...
      <div v-if="allBillingProbeCapable" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between">
          <div class="flex-1 pr-4">
            ...
            >
              {{ t('admin.accounts.upstreamBilling.autoProbe') REDACTEDREDACTED
            </label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
      ...
      <div v-if="allOpenAIAPIKey" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between gap-4">
          <div class="flex-1">
            ...
            >
              {{ t('admin.accounts.openai.endpointCapabilities') REDACTEDREDACTED
            </label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.openai.endpointCapabilitiesDesc') REDACTEDREDACTED
            </p>
          </div>
          <input
          ...
          <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
            ...
            >
              <input
                ...
                :data-testid="`bulk-edit-openai-endpoint-capability-${option.valueREDACTED`"
      ...
      <div v-if="allOpenAIAPIKey" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between gap-4">
          <div class="flex-1">
            ...
            >
              {{ t('admin.accounts.openai.responsesMode') REDACTEDREDACTED
            </label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
      ...
      <div v-if="allOpenAIAPIKey" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        ...
        >
          ...
          <p class="mb-3 text-xs text-gray-500 dark:text-gray-400">
            {{ t(openAIAPIKeyWSModeConcurrencyHintKey) REDACTEDREDACTED
          </p>
          <Select
      ...
      <div v-if="allOpenAIPassthroughCapable" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between">
          <div class="flex-1 pr-4">
            ...
            >
              {{ t('admin.accounts.openai.compactMode') REDACTEDREDACTED
            </label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
      ...
      <div v-if="allOpenAIPassthroughCapable" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between">
          <div class="flex-1 pr-4">
            ...
            >
              {{ t('admin.accounts.openai.compactModelMapping') REDACTEDREDACTED
            </label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.openai.compactModelMappingDesc') REDACTEDREDACTED
            </p>
          </div>
          <input
      ...
      <div v-if="allAnthropicOAuthOrSetupToken" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between">
          ...
          >
            {{ t('admin.accounts.quotaControl.rpmLimit.label') REDACTEDREDACTED
          </label>
          <input
        ...
        >
          <div class="mb-3 flex items-center justify-between">
            <span class="text-sm text-gray-700 dark:text-gray-300">{{ t('admin.accounts.quotaControl.rpmLimit.hint') REDACTEDREDACTED</span>
            <button
              type="button"
          ...
          <div v-if="rpmLimitEnabled" class="space-y-3">
            <div>
              <label class="input-label text-xs">{{ t('admin.accounts.quotaControl.rpmLimit.baseRpm') REDACTEDREDACTED</label>
              <input
            ...
            <div>
              <label class="input-label text-xs">{{ t('admin.accounts.quotaControl.rpmLimit.strategy') REDACTEDREDACTED</label>
              <div class="flex gap-2">
                ...
                >
                  {{ t('admin.accounts.quotaControl.rpmLimit.strategyTiered') REDACTEDREDACTED
                </button>
                <button
                  type="button"
                ...
                >
                  {{ t('admin.accounts.quotaControl.rpmLimit.strategyStickyExempt') REDACTEDREDACTED
                </button>
              </div>
            </div>

            <div v-if="bulkRpmStrategy === 'tiered'">
              <label class="input-label text-xs">{{ t('admin.accounts.quotaControl.rpmLimit.stickyBuffer') REDACTEDREDACTED</label>
              <input
...
import type { OpenAIWSMode REDACTED from '@/utils/openaiWsMode'
interface Props {
  show: boolean
  accountIds: number[]
...
const upstreamBillingAutoProbeOptions = computed(() => [
  { value: 'enabled', label: t('common.enabled') REDACTED,
  { value: 'disabled', label: t('common.disabled') REDACTED
])
...
const openAIEndpointCapabilityOptions = computed<
  Array<{ value: OpenAIEndpointCapability; label: string REDACTED>
>(() => [
...
const buildUpdatePayload = (): Record<string, unknown> | null => {
  ...
  if (enableModelRestriction.value && !isOpenAIModelRestrictionDisabled.value) {
    ...
    REDACTED else {
      ...
      credentials.model_mapping = modelMapping ?? {REDACTED
      credentialsChanged = true
    REDACTED
  REDACTED
  ...
  if (enableOpenAICompactModelMapping.value) {
    credentials.compact_model_mapping = buildOpenAICompactModelMapping() ?? {REDACTED
    credentialsChanged = true
  REDACTED
...
const submitBulkUpdate = async (baseUpdates: Record<string, unknown>) => {
  ...
  const updates = mixedChannelConfirmed.value
    ? { ...baseUpdates, confirm_mixed_channel_risk: true REDACTED
    : baseUpdates
  ...
  try {
    ...
    REDACTED else if (success > 0) {
      ...
      appStore.showError(t(key, { success, failed, inherited REDACTED))
    REDACTED else {
  ...
  REDACTED catch (error: any) {
    ...
    if (error.status === 409 && error.error === 'mixed_channel_warning') {
      ...
      showMixedChannelWarning.value = true
    REDACTED else if (error.reason === 'UPSTREAM_BILLING_RATE_SYNC_BULK_CONFLICT') {
      appStore.showError(t('admin.accounts.bulkEdit.rateSyncConflict', {
        count: error.metadata?.count ?? 1
      REDACTED))
    REDACTED else if (error.reason === 'OPENAI_LONG_CONTEXT_PARENT_REQUIRED') {
