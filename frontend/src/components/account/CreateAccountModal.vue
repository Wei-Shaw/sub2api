  ...
  >
    ...
    >
      ...
      <div v-if="form.platform === 'grok'">
        ...
        <div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2" data-tour="account-form-type">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-gray-900 dark:text-white">OAuth</span>
              <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.accounts.types.grokOauth') REDACTEDREDACTED</span>
            </div>
          </button>
      ...
      <div v-if="isCNPlatform">
        <label class="input-label">{{ t('admin.accounts.cnProviders.accountMode.title') REDACTEDREDACTED</label>
        <div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2" data-tour="account-form-mode">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-gray-900 dark:text-white">{{ t('admin.accounts.cnProviders.accountMode.payg') REDACTEDREDACTED</span>
              <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.accounts.cnProviders.accountMode.paygDesc') REDACTEDREDACTED</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-gray-900 dark:text-white">{{ t('admin.accounts.cnProviders.accountMode.coding') REDACTEDREDACTED</span>
              <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.accounts.cnProviders.accountMode.codingDesc') REDACTEDREDACTED</span>
            </div>
          </button>
        </div>
      </div>
      ...
      <div v-if="isCNPlatform" class="mt-4">
        <label class="input-label">{{ t('admin.accounts.cnProviders.apiProtocol.title') REDACTEDREDACTED</label>
        <div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-3">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-gray-900 dark:text-white">{{ t(`admin.accounts.cnProviders.apiProtocol.${opt.labelKeyREDACTED`) REDACTEDREDACTED</span>
              <span class="text-xs text-gray-500 dark:text-gray-400">{{ t(`admin.accounts.cnProviders.apiProtocol.${opt.labelKeyREDACTEDDesc`) REDACTEDREDACTED</span>
            </div>
          </button>
        </div>
      </div>
          ...
          <div class="mt-2 grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <span class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.accounts.gemini.oauthType.googleOneDesc') REDACTEDREDACTED
                </span>
                <div class="mt-2 flex flex-wrap gap-1">
                  ...
                  >
                    {{ t('admin.accounts.gemini.oauthType.badges.individuals') REDACTEDREDACTED
                  </span>
                  <span
                  ...
                  >
                    {{ t('admin.accounts.gemini.oauthType.badges.noGcp') REDACTEDREDACTED
                  </span>
                </div>
              </div>
            </button>
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <span class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.accounts.gemini.oauthType.codeAssistDesc') REDACTEDREDACTED
                </span>
                <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.accounts.gemini.oauthType.codeAssistRequirement') REDACTEDREDACTED
                  <a
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  ...
                  >
                    {{ t('admin.accounts.gemini.oauthType.badges.enterprise') REDACTEDREDACTED
                  </span>
                  <span
                    class="rounded bg-emerald-100 px-2 py-0.5 text-[10px] font-semibold text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300"
                  >
                    {{ t('admin.accounts.gemini.oauthType.badges.highConcurrency') REDACTEDREDACTED
                  </span>
                </div>
              </div>
            </button>
      ...
      <div v-if="form.platform === 'antigravity' && antigravityAccountType === 'upstream'" class="space-y-4">
        ...
        <div class="flex items-center justify-between gap-4 border-t border-gray-200 pt-4 dark:border-dark-600">
          <div>
            <label class="input-label mb-0">{{ t('admin.accounts.upstreamBilling.autoProbe') REDACTEDREDACTED</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.upstreamBilling.autoProbeHint') REDACTEDREDACTED
            </p>
          </div>
          <Toggle
      ...
      <div v-if="form.type === 'apikey' && form.platform !== 'antigravity'" class="space-y-4">
        <div v-if="!isCNPlatform || apiProtocol !== 'adaptive'">
          ...
          />
          <p v-if="baseUrlHint" class="input-hint">{{ baseUrlHint REDACTEDREDACTED</p>
          <GrokBaseUrlPresets
        ...
        <div v-else>
          <label class="input-label">{{ t('admin.accounts.cnProviders.apiProtocol.endpoints') REDACTEDREDACTED</label>
          <div class="mt-2 space-y-3">
            <div v-for="item in cnAdaptiveProtocolOptions" :key="item.value">
              <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">
                {{ t(`admin.accounts.cnProviders.apiProtocol.${item.labelKeyREDACTED`) REDACTEDREDACTED
              </label>
              <input
                v-model="adaptiveBaseUrls[item.value]"
                type="text"
                class="input"
                :data-testid="`cn-adaptive-base-url-${item.valueREDACTED`"
              />
            </div>
          </div>
          <p v-if="form.platform !== 'deepseek'" class="input-hint">
            {{ t('admin.accounts.cnProviders.apiProtocol.responsesFallbackDesc') REDACTEDREDACTED
          </p>
        </div>
        <div>
          ...
          />
          <p v-if="apiKeyHint" class="input-hint">{{ apiKeyHint REDACTEDREDACTED</p>
        </div>
        ...
        >
          <div class="mb-3 flex items-center justify-between">
            <div>
              <label class="input-label mb-0">{{ t('admin.accounts.headerOverride.title') REDACTEDREDACTED</label>
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                {{ t('admin.accounts.headerOverride.hint') REDACTEDREDACTED
              </p>
            </div>
            <button
              type="button"
          ...
          <div v-if="headerOverrideEnabled" class="space-y-3">
            <div class="rounded-lg bg-blue-50 p-3 dark:bg-blue-900/20">
              <p class="text-xs text-blue-700 dark:text-blue-400">
                <Icon name="exclamationCircle" size="sm" class="mr-1 inline" :stroke-width="2" />
                {{ t('admin.accounts.headerOverride.info') REDACTEDREDACTED
              </p>
            </div>
      ...
      >
        <div class="mb-3 flex items-center justify-between">
          <div>
            <label class="input-label mb-0">{{ t('admin.accounts.grokCustomBaseUrl.title') REDACTEDREDACTED</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.grokCustomBaseUrl.hint') REDACTEDREDACTED
            </p>
          </div>
          <button
            type="button"
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <label class="input-label mb-0">{{ t('admin.accounts.openai.flattenNamespaces') REDACTEDREDACTED</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.openai.flattenNamespacesDesc') REDACTEDREDACTED
            </p>
          </div>
          <button
            type="button"
      ...
      >
        <div class="flex items-center justify-between gap-4">
          <div>
            <label class="input-label mb-0">{{ t('admin.accounts.anthropic.apiKeyAuthScheme') REDACTEDREDACTED</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.anthropic.apiKeyAuthSchemeDesc') REDACTEDREDACTED
            </p>
          </div>
          <select v-model="anthropicAPIKeyAuthScheme" class="input w-52 text-sm">
            <option value="x_api_key">{{ t('admin.accounts.anthropic.apiKeyAuthSchemeXApiKey') REDACTEDREDACTED</option>
            <option value="authorization_bearer">{{ t('admin.accounts.anthropic.apiKeyAuthSchemeBearer') REDACTEDREDACTED</option>
          </select>
        </div>
      </div>
      ...
      >
        <div class="flex items-center justify-between gap-4">
          <div>
            <label class="input-label mb-0">{{ t('admin.accounts.openai.longContextBilling') REDACTEDREDACTED</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.openai.longContextBillingDesc') REDACTEDREDACTED
            </p>
          </div>
          <button
            type="button"
      ...
      >
        ...
        >
          <div>
            <label class="input-label mb-0">{{ t('admin.accounts.openai.codexCLIOnlyAppServer') REDACTEDREDACTED</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.openai.codexCLIOnlyAppServerDesc') REDACTEDREDACTED
            </p>
          </div>
          <button
            type="button"
      ...
      >
        <div class="flex items-center justify-between gap-4">
          <div class="min-w-0">
            <label class="input-label mb-0">{{ t('admin.accounts.openai.codexFingerprintMode') REDACTEDREDACTED</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.openai.codexFingerprintModeDesc') REDACTEDREDACTED
            </p>
          </div>
          ...
          <div>
            ...
            <div class="mt-2 flex flex-wrap gap-2">
              ...
              <a
                ...
                class="text-sm text-blue-600 hover:underline dark:text-blue-400"
              >
                {{ t('admin.accounts.gemini.setupGuide.links.countryChange') REDACTEDREDACTED
              </a>
              <span class="text-gray-400">·</span>
              <a
...
import { useGrokOAuth REDACTED from '@/composables/useGrokOAuth'
import type {
  Proxy,
  AdminGroup,
  AccountPlatform,
...
import { allSelectedGroupsEnableLongContextPricing REDACTED from '@/components/account/longContextBilling'
import {
...
const cnProtocolOptions = computed<Array<{ value: CnApiProtocol; labelKey: string REDACTED>>(() => {
  const opts: Array<{ value: CnApiProtocol; labelKey: string REDACTED> = [
    { value: 'adaptive', labelKey: 'adaptive' REDACTED,
    { value: 'chat_completions', labelKey: 'chatCompletions' REDACTED,
    { value: 'anthropic', labelKey: 'anthropic' REDACTED
  ]
  if (form.platform === 'deepseek') {
    opts.push({ value: 'responses', labelKey: 'responses' REDACTED)
  REDACTED
  return opts
REDACTED)
const cnAdaptiveProtocolOptions = computed<Array<{ value: CnNativeApiProtocol; labelKey: string REDACTED>>(() => {
  const opts: Array<{ value: CnNativeApiProtocol; labelKey: string REDACTED> = [
    { value: 'chat_completions', labelKey: 'chatCompletions' REDACTED,
    { value: 'anthropic', labelKey: 'anthropic' REDACTED
  ]
  if (form.platform === 'deepseek') opts.push({ value: 'responses', labelKey: 'responses' REDACTED)
  return opts
REDACTED)
...
function onCnPresetSelect(preset: { mode: CnAccountMode; protocol: CnApiProtocol; url: string REDACTED) {
...
const validateGrokOAuthUpstreamConfig = (): boolean => {
  ...
  if (headerOverrideEnabled.value) {
    ...
    if (headerError) {
      appStore.showError(t(`admin.accounts.headerOverride.${headerErrorREDACTED`))
      return false
    REDACTED
  REDACTED
  return true
...
const codexFingerprintModeOptions = computed(() => [
  { value: 'off' as CodexFingerprintMode, label: t('admin.accounts.openai.codexFingerprintOff') REDACTED,
  { value: 'device' as CodexFingerprintMode, label: t('admin.accounts.openai.codexFingerprintDevice') REDACTED,
  { value: 'session' as CodexFingerprintMode, label: t('admin.accounts.openai.codexFingerprintSession') REDACTED,
  { value: 'full' as CodexFingerprintMode, label: t('admin.accounts.openai.codexFingerprintFull') REDACTED,
])
...
const openAIWSModeOptions = computed(() => [
  ...
  { value: OPENAI_WS_MODE_HTTP_BRIDGE, label: t('admin.accounts.openai.wsModeHttpBridge') REDACTED
])
...
const resetForm = () => {
  ...
  accountMode.value = 'payg'
  apiProtocol.value = 'adaptive'
  adaptiveBaseUrls.value = { chat_completions: '', anthropic: '', responses: '' REDACTED
...
const handleSubmit = async () => {
  ...
  if (form.platform === 'kimi' || form.platform === 'zhipu' || form.platform === 'deepseek') {
    ...
    if (apiProtocol.value === 'adaptive') {
      ...
      const protocolBaseUrls: Record<string, string> = {REDACTED
      for (const item of cnAdaptiveProtocolOptions.value) {
...
const handleGenerateUrl = async () => {
  ...
  REDACTED else if (form.platform === 'grok') {
  ...
  try {
    for (let i = 0; i < refreshTokens.length; i++) {
      try {
        ...
        if (!tokenInfo) {
          failedCount++
          errors.push(`#${i + 1REDACTED: ${grokOAuth.error.value || 'Validation failed'REDACTED`)
          grokOAuth.error.value = ''
          continue
        REDACTED
        ...
        const accountName = refreshTokens.length > 1 ? `${form.name || tokenInfo.email || 'Grok OAuth Account'REDACTED #${i + 1REDACTED` : (form.name || tokenInfo.email || 'Grok OAuth Account')
    ...
    if (successCount > 0 && failedCount === 0) {
      ...
      emit('created')
      handleClose()
    REDACTED else if (successCount > 0) {
      appStore.showWarning(t('admin.accounts.oauth.batchPartialSuccess', { success: successCount, failed: failedCount REDACTED))
  ...
  try {
    ...
    REDACTED else if (successCount > 0 && failedCount > 0) {
      ...
      grokOAuth.error.value = (result.failed || [])
        .map((item) => `#${item.indexREDACTED: ${item.error || 'Unknown error'REDACTED`)
        .join('\n')
      emit('created')
    REDACTED else {
      grokOAuth.error.value = (result.failed || [])
  ...
  try {
    for (let i = 0; i < lines.length; i++) {
      try {
        ...
        if (!tokenInfo) {
          failedCount++
          errors.push(`#${i + 1REDACTED: ${grokOAuth.error.value || 'Authorization failed'REDACTED`)
          grokOAuth.error.value = ''
          continue
        REDACTED
        ...
        const accountName =
          lines.length > 1
            ? `${form.name || tokenInfo.email || 'Grok OAuth Account'REDACTED #${i + 1REDACTED`
