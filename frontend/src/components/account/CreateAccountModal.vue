<template>
  ...
  >
    ...
    >
      ...
      <!-- TLS Fingerprint (Anthropic OAuth/SetupToken + OpenAI OAuth) -->
      <div
        v-if="(form.platform === 'anthropic' && accountCategory === 'oauth-based') || (form.platform === 'openai' && accountCategory === 'oauth-based')"
        class="border-t border-gray-200 pt-4 dark:border-dark-600 space-y-4"
      >
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
...
const buildOpenAIExtra = (base?: Record<string, unknown>): Record<string, unknown> | undefined => {
  ...
  // TLS fingerprint setting (OpenAI OAuth only)
  if (accountCategory.value === 'oauth-based') {
