        ...
        <div class="grid grid-cols-2 gap-3 mt-2">
          ...
          >
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                <span class="block text-sm font-semibold text-gray-900 dark:text-white">{{ t('admin.accounts.claudeCode') REDACTEDREDACTED</span>
          ...
          >
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                <span class="block text-sm font-semibold text-gray-900 dark:text-white">{{ t('admin.accounts.claudeConsole') REDACTEDREDACTED</span>
    ...
    <div v-else class="space-y-5">
      ...
      <div class="flex justify-between gap-3 pt-4">
        ...
        >
          ...
          {{ oauth.loading.value ? t('admin.accounts.oauth.verifying') : t('admin.accounts.oauth.completeAuth') REDACTEDREDACTED
        </button>
      </div>
    </div>
  </Modal>
