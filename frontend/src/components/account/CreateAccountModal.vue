  ...
  >
      ...
      <div class="flex items-center space-x-4">
        <div class="flex items-center">
          <div
            :class="[
              ...
              step >= 1 ? 'bg-primary-500 text-white' : 'bg-gray-200 text-ink-secondary dark:bg-dark-600'
            ]"
          >
            1
          </div>
          <span class="ml-2 text-sm font-medium text-ink-secondary">{{
        ...
        <div class="flex items-center">
          <div
            :class="[
              'flex h-8 w-8 items-center justify-center rounded-full text-sm font-semibold',
              step >= 2 ? 'bg-primary-500 text-white' : 'bg-gray-200 text-ink-secondary dark:bg-dark-600'
            ]"
          >
            2
          </div>
    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 flex flex-wrap rounded-lg bg-surface-sunken p-1" data-tour="account-form-platform">
          <button
            type="button"
            ...
            :class="[
              ...
              form.platform === 'anthropic'
                ...
                : 'text-ink-secondary hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'
            ]"
          >
      ...
      <div v-if="form.platform === 'anthropic'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3 sm:grid-cols-4" data-tour="account-form-type">
            ...
            <div
              :class="[
                ...
                accountCategory === 'oauth-based'
                  ...
                  : 'bg-gray-100 text-ink-secondary dark:bg-dark-600 dark:text-gray-400'
              ]"
            >
              <Icon name="sparkles" size="sm" />
            </div>
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'bedrock'
                ? 'border-amber-500 border border-warn/40 bg-warn-tint'
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'service_account'
                ? 'border-sky-500 border border-info/40 bg-info-tint'
          ...
          >
            ...
            <div>
              ...
              <span class="text-xs text-ink-secondary">Service Account</span>
            </div>
          </button>
        ...
        <div
          ...
          class="mt-3 rounded-lg border border-sky-200 border border-info/40 bg-info-tint px-3 py-2 text-xs text-info dark:border-sky-800/40"
        >
        ...
        <div class="mt-2 grid grid-cols-2 gap-3" data-tour="account-form-type">
          <button
            ...
            :class="[
              'flex items-center gap-3 rounded-lg border-2 p-3 text-left transition-all',
              accountCategory === 'oauth-based'
                ? 'border-green-500 border border-success/40 bg-success-tint'
          ...
          >
            ...
            <div>
              ...
              <span class="text-xs text-ink-secondary">{{ t('admin.accounts.types.chatgptOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <span class="text-xs text-ink-secondary">{{ t('admin.accounts.types.responsesApi') }}</span>
            </div>
          </button>
      ...
      <div v-if="form.platform === 'grok'">
        ...
        <div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2" data-tour="account-form-type">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-ink">OAuth</span>
              <span class="text-xs text-ink-secondary">{{ t('admin.accounts.types.grokOauth') }}</span>
            </div>
          </button>
        ...
        <div class="mt-2 grid grid-cols-3 gap-3" data-tour="account-form-type">
          <button
            ...
            :class="[
              'flex items-center gap-3 rounded-lg border-2 p-3 text-left transition-all',
              accountCategory === 'oauth-based'
                ? 'border-blue-500 border border-info/40 bg-info-tint'
        ...
        <div v-if="accountCategory === 'oauth-based'" class="mt-4">
          ...
          <div class="mt-2 grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  ...
                  <span
                    class="rounded bg-emerald-100 px-2 py-0.5 text-[10px] font-semibold text-success dark:bg-emerald-900/40"
                  >
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded bg-blue-100 px-2 py-0.5 text-[10px] font-semibold text-info dark:bg-blue-900/40"
                  >
          ...
          <div class="mt-3">
            <button
              ...
              class="flex items-center gap-2 text-sm text-ink-secondary hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200"
            >
              <svg
          ...
          <div v-if="showAdvancedOAuth" class="mt-3 group relative">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded bg-amber-100 px-2 py-0.5 text-[10px] font-semibold text-warn dark:bg-amber-900/40"
                  >
              ...
              <span
                ...
                class="ml-auto shrink-0 rounded bg-amber-100 px-2 py-0.5 text-xs text-warn dark:bg-amber-900/30"
              >
            ...
            <div
              v-if="!geminiAIStudioOAuthEnabled"
              class="pointer-events-none absolute right-0 top-full z-50 mt-2 w-80 rounded-md border border-amber-200 border border-warn/40 bg-warn-tint px-3 py-2 text-xs text-warn opacity-0 shadow-lg transition-opacity group-hover:opacity-100 dark:border-amber-700"
            >
      ...
      <div v-if="form.platform === 'antigravity'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-ink">OAuth</span>
              <span class="text-xs text-ink-secondary">{{ t('admin.accounts.types.antigravityOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-ink">API Key</span>
              <span class="text-xs text-ink-secondary">{{ t('admin.accounts.types.antigravityApikey') }}</span>
            </div>
          </button>
        </div>
      </div>
        ...
        <div>
          ...
          <div
            :class="[
              ...
              vertexServiceAccountDragActive
                ? 'border-sky-500 border border-info/40 bg-info-tint dark:border-sky-500'
          ...
          >
            ...
            <div
              ...
              class="mt-3 rounded-md border border-sky-200 bg-surface px-3 py-2 text-xs text-sky-900 dark:border-sky-800/50 dark:text-sky-200"
            >
      ...
      <div v-if="form.platform === 'antigravity'" class="border-t border-line pt-4">
          ...
          <div v-if="antigravityModelMappings.length > 0" class="mb-3 space-y-2">
            ...
            >
              <div class="flex items-center gap-2">
                ...
                />
                <svg class="h-4 w-4 flex-shrink-0 text-ink-tertiary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div v-if="form.platform === 'anthropic' && isOAuthFlow">
        ...
        <div class="mt-2 flex gap-4">
          <label class="flex cursor-pointer items-center">
            ...
            />
            <span class="text-sm text-ink-secondary">{{ t('admin.accounts.types.oauth') }}</span>
          </label>
          <label class="flex cursor-pointer items-center">
            <input
              v-model="addMethod"
      ...
      <div v-if="form.type === 'apikey' && form.platform !== 'antigravity'" class="space-y-4">
        ...
        <div class="border-t border-line pt-4">
          ...
          <div
            ...
            class="mb-3 rounded-lg border border-warn/40 bg-warn-tint p-3"
          >
        ...
        <div class="border-t border-line pt-4">
          ...
          <div v-if="poolModeEnabled" class="rounded-lg border border-info/40 bg-info-tint p-3">
      ...
      <div v-if="form.platform === 'anthropic' && accountCategory === 'bedrock'" class="space-y-4">
          ...
          <div class="mt-2 flex gap-4">
            <label class="flex cursor-pointer items-center">
              <input
                ...
                class="mr-2 text-primary-600 focus:ring-primary-500"
              />
              <span class="text-sm text-ink-secondary">{{ t('admin.accounts.bedrockAuthModeSigv4') }}</span>
            </label>
            <label class="flex cursor-pointer items-center">
              <input
                v-model="bedrockAuthMode"
                ...
                class="mr-2 text-primary-600 focus:ring-primary-500"
              />
              <span class="text-sm text-ink-secondary">{{ t('admin.accounts.bedrockAuthModeApikey') }}</span>
            </label>
          </div>
        </div>
        ...
        <div>
          <label class="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span class="text-sm text-ink-secondary">{{ t('admin.accounts.bedrockForceGlobal') }}</span>
          </label>
        ...
        <div v-if="tempUnschedEnabled" class="space-y-3">
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              class="rounded-lg bg-gray-100 px-3 py-1.5 text-xs font-medium text-ink-secondary transition-colors hover:bg-gray-200 dark:bg-dark-600 dark:hover:bg-dark-500"
            >
              + {{ preset.label }}
            </button>
          </div>
              ...
              <div class="mb-2 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    class="rounded p-1 text-ink-tertiary transition-colors hover:text-gray-600 disabled:cursor-not-allowed disabled:opacity-40 dark:hover:text-gray-200"
                  >
          ...
          <button
            ...
            class="w-full rounded-lg border-2 border-dashed border-gray-300 px-4 py-2 text-sm text-ink-secondary transition-colors hover:border-gray-400 hover:text-gray-700 dark:border-dark-500 dark:text-gray-400 dark:hover:border-dark-400 dark:hover:text-gray-300"
          >
            <svg
              class="mr-1 inline h-4 w-4"
              fill="none"
        ...
        <div class="rounded-lg border border-line p-4">
          ...
          <div v-if="windowCostEnabled" class="grid grid-cols-2 gap-4">
            <div>
              ...
              <div class="relative">
                <span class="absolute left-3 top-1/2 -translate-y-1/2 text-ink-secondary">$</span>
                <input
          ...
          <div v-if="sessionLimitEnabled" class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div class="relative">
                ...
                />
                <span class="absolute right-3 top-1/2 -translate-y-1/2 text-ink-secondary">{{ t('common.minutes') }}</span>
              </div>
        ...
        <div class="rounded-lg border border-line p-4">
          ...
          <div v-if="cacheTTLOverrideEnabled" class="mt-3">
            ...
            <select
              ...
              class="mt-1 block w-full rounded-md border border-gray-300 bg-surface px-3 py-2 text-sm shadow-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 dark:border-dark-500 dark:text-white"
            >
      ...
      >
        ...
        <p
          ...
          class="rounded-lg border border-warn/40 bg-warn-tint px-3 py-2 text-xs text-warn"
        ...
        <div>
          ...
          <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
            ...
            >
              ...
              />
              <span class="text-ink-secondary">{{ option.label }}</span>
            </label>
          </div>
      ...
      <div class="border-t border-line pt-4">
        ...
        <div v-if="form.platform === 'antigravity'" class="flex items-center gap-2">
          ...
          <div class="group relative">
            <span
              class="inline-flex h-4 w-4 cursor-help items-center justify-center rounded-full bg-gray-200 text-xs text-ink-secondary hover:bg-gray-300 dark:bg-dark-600 dark:text-gray-400 dark:hover:bg-dark-500"
            >
              ?
            </span>
            <!-- Tooltip（向下显示避免被弹窗裁剪） -->
  ...
  >
    <div class="space-y-6">
      ...
      <div>
        ...
        <div class="space-y-4">
          <div>
            <p class="mb-2 text-sm font-medium text-ink-secondary">
              {{ t('admin.accounts.gemini.setupGuide.checklistTitle') }}
            </p>
            <ul class="list-inside list-disc space-y-1 text-sm text-ink-secondary">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-xs">
            <thead class="bg-gray-50 dark:bg-dark-600">
              <tr>
                <th class="px-3 py-2 text-left font-medium text-ink-secondary">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-dark-600">
              <tr>
                ...
                <td class="px-3 py-2 text-ink-secondary">Free</td>
              ...
              <tr>
                ...
                <td class="px-3 py-2 text-ink-secondary">Pro</td>
                <td class="px-3 py-2 text-ink-secondary">
              ...
              <tr>
                <td class="px-3 py-2 text-ink"></td>
                <td class="px-3 py-2 text-ink-secondary">Ultra</td>
                <td class="px-3 py-2 text-ink-secondary">
              ...
              <tr>
                ...
                <td class="px-3 py-2 text-ink-secondary">Standard</td>
                <td class="px-3 py-2 text-ink-secondary">
              ...
              <tr>
                <td class="px-3 py-2 text-ink"></td>
                <td class="px-3 py-2 text-ink-secondary">Enterprise</td>
                <td class="px-3 py-2 text-ink-secondary">
              ...
              <tr>
                <td class="px-3 py-2 text-ink"></td>
                <td class="px-3 py-2 text-ink-secondary">Paid</td>
                <td class="px-3 py-2 text-ink-secondary">
