        ...
        <div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2" data-tour="account-form-type">
          ...
          >
            ...
            <div>
              ...
              <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.accounts.types.agentIdentity') REDACTEDREDACTED</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.accounts.types.codexPat') REDACTEDREDACTED</span>
            </div>
          </button>
        ...
        >
          ...
          <div v-if="headerOverrideEnabled" class="space-y-3">
            ...
            >
              ...
              {{ t('admin.accounts.headerOverride.addRow') REDACTEDREDACTED
            </button>
            ...
            <div class="flex flex-wrap gap-2">
              ...
              >
                + {{ t('admin.accounts.headerOverride.fillTemplate') REDACTEDREDACTED
              </button>
            </div>

            <p class="text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.headerOverride.emptyValueHint') REDACTEDREDACTED
            </p>
          </div>
        </div>
...
const addHeaderOverrideRow = () => {
  headerOverrideRows.value.push({ name: '', value: '' REDACTED)
REDACTED
...
watch(
  ...
  ([category, method, agType]) => {
    ...
    REDACTED else if (category === 'oauth-based' || category === 'agent-identity' || category === 'codex-pat') {
