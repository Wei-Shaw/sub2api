<template>
  ...
  >
    ...
    >
      <div>
        <label class="input-label">{{ t('common.name') REDACTEDREDACTED</label>
      ...
      <div v-if="account.type === 'apikey'" class="space-y-4">
        ...
        <div v-if="isCNApiKeyAccount">
          ...
          <div class="mt-2 flex flex-wrap gap-2">
            ...
            >
              {{ t(`admin.accounts.cnProviders.accountMode.${opt.labelKeyREDACTED`) REDACTEDREDACTED
            </button>
          </div>
          <p class="input-hint">{{ t(`admin.accounts.cnProviders.accountMode.${editAccountModeREDACTEDDesc`) REDACTEDREDACTED</p>
        </div>
        ...
        <div v-if="isCNApiKeyAccount">
          ...
          <div class="mt-2 flex flex-wrap gap-2">
            ...
            >
              {{ t(`admin.accounts.cnProviders.apiProtocol.${opt.labelKeyREDACTED`) REDACTEDREDACTED
            </button>
          </div>
          <p class="input-hint">{{ t(`admin.accounts.cnProviders.apiProtocol.${cnProtocolDescKeyREDACTEDDesc`) REDACTEDREDACTED</p>
        </div>
        <div>
          ...
          <input
            ...
            "
          />
          <p class="input-hint">{{ t('admin.accounts.leaveEmptyToKeep') REDACTEDREDACTED</p>
        </div>
      ...
      >
        <div class="flex items-center justify-between gap-4">
          <div class="min-w-0">
            <label class="input-label mb-0">{{ t('admin.accounts.grokClientToolCache.title') REDACTEDREDACTED</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.grokClientToolCache.hint') REDACTEDREDACTED
            </p>
          </div>
          <Toggle
      ...
      <div v-if="(account.platform === 'gemini' || account.platform === 'anthropic') && account.type === 'service_account'" class="space-y-4">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            />
            <p class="input-hint">{{ t('admin.accounts.vertexSaJsonEditHint') REDACTEDREDACTED</p>
          </div>
          <div>
      ...
      <div v-if="account.type === 'bedrock'" class="space-y-4">
        ...
        <template v-if="!isBedrockAPIKeyMode">
          ...
          <div>
            ...
            />
            <p class="input-hint">{{ t('admin.accounts.bedrockSecretKeyLeaveEmpty') REDACTEDREDACTED</p>
          </div>
          <div>
        ...
        <div v-if="isBedrockAPIKeyMode">
          ...
          />
          <p class="input-hint">{{ t('admin.accounts.bedrockApiKeyLeaveEmpty') REDACTEDREDACTED</p>
        </div>
          ...
          <div v-else class="space-y-3">
            ...
            <div class="flex flex-wrap gap-2">
              <button
                ...
                :key="preset.from"
                type="button"
                @click="modelMappings.push({ from: preset.from, to: preset.to REDACTED)"
                :class="['rounded-lg px-3 py-1 text-xs transition-colors', preset.color]"
              >
                + {{ preset.label REDACTEDREDACTED
              </button>
      ...
      <div v-if="account.platform === 'antigravity'" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        ...
        <div>
          <div class="mb-3 rounded-lg bg-purple-50 p-3 dark:bg-purple-900/20">
            <p class="text-xs text-purple-700 dark:text-purple-400">{{ t('admin.accounts.mapRequestModels') REDACTEDREDACTED</p>
          </div>
          ...
          <div class="mb-3 flex flex-wrap gap-2">
            ...
            >
              {{ isSyncingAntigravityUpstream ? t('admin.accounts.syncUpstreamModelsLoading') : t('admin.accounts.syncUpstreamModels') REDACTEDREDACTED
            </button>
          </div>
      ...
      >
        <div class="mb-3 flex items-center justify-between">
          <div>
            <label class="input-label mb-0">{{ t('admin.accounts.accountSchedulingThresholdOverride') REDACTEDREDACTED</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.accountSchedulingThresholdOverrideHint') REDACTEDREDACTED
            </p>
          </div>
          <input
        ...
        <div v-if="accountSchedulingThresholdOverrideEnabled">
          <label class="input-label">{{ t('admin.accounts.accountSchedulingThresholdOverrideValue') REDACTEDREDACTED</label>
          <input
            ...
            class="input"
          />
          <p class="input-hint">{{ t('admin.accounts.accountSchedulingThresholdOverrideDisabledHint') REDACTEDREDACTED</p>
        </div>
      </div>
          ...
          >
            <div class="min-w-0">
              <p class="text-xs font-medium text-gray-700 dark:text-gray-200">
                {{ t('admin.accounts.upstreamBilling.syncRate') REDACTEDREDACTED
              </p>
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                {{ t('admin.accounts.upstreamBilling.syncRateHint') REDACTEDREDACTED
              </p>
            </div>
            <Toggle
          ...
          <div class="flex items-start gap-3 px-4 py-3">
            ...
            <div class="min-w-0 flex-1">
              <div class="flex flex-wrap items-center gap-2">
                <label class="input-label mb-0">{{ t('admin.accounts.openai.codexImageTool') REDACTEDREDACTED</label>
                <span
                  class="rounded-full px-2 py-0.5 text-[11px] font-medium"
                  :class="codexImageToolBadgeClass"
                >
                  {{ codexImageToolBadgeLabel REDACTEDREDACTED
                </span>
              </div>
              <p class="mt-1 text-xs leading-5 text-slate-600 dark:text-slate-300">
                {{ t('admin.accounts.openai.codexImageToolDesc') REDACTEDREDACTED
              </p>
            </div>
          </div>
          <div class="border-t border-sky-100 bg-white/70 p-2 dark:border-sky-900/50 dark:bg-dark-800/70">
            <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
              <button
                ...
                :key="option.value"
                type="button"
                :data-testid="`codex-image-tool-${option.valueREDACTED`"
              ...
              >
                ...
                <span class="min-w-0">
                  <span class="block text-sm font-medium">{{ option.label REDACTEDREDACTED</span>
                  <span class="mt-0.5 block text-xs leading-4 text-slate-500 dark:text-slate-400">{{ option.description REDACTEDREDACTED</span>
                </span>
              </button>
            </div>
          </div>
      ...
      >
        ...
        >
          <span class="font-medium">{{ t(openAIResponsesStatusKey) REDACTEDREDACTED</span>
        </div>
        <div
          v-else
      ...
      >
        <div class="flex items-center justify-between gap-4">
          <div class="min-w-0">
            <label class="input-label mb-0">{{ t('admin.accounts.openai.planType') REDACTEDREDACTED</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.openai.planTypeDesc') REDACTEDREDACTED
            </p>
          </div>
      ...
      >
        ...
        <div class="rounded-lg bg-gray-50 px-3 py-2 text-xs text-gray-600 dark:bg-dark-700 dark:text-gray-300">
          <span class="font-medium">{{ t(openAICompactStatusKey) REDACTEDREDACTED</span>
          <span
            v-if="account?.extra?.openai_compact_checked_at"
            class="ml-2 text-gray-500 dark:text-gray-400"
          >
            {{ t('admin.accounts.openai.compactLastChecked') REDACTEDREDACTED:
            {{ formatDateTime(new Date(String(account.extra.openai_compact_checked_at))) REDACTEDREDACTED
          </span>
        </div>
        <div>
      ...
      >
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            <label class="input-label mb-0">{{ t('admin.accounts.autoPause5hDisabled') REDACTEDREDACTED</label>
            <button
              type="button"
          ...
          <p class="input-hint">{{ t('admin.accounts.autoPauseDisabledHint') REDACTEDREDACTED</p>
        </div>
        <div>
          <label class="input-label">{{ t('admin.accounts.autoPause5hThreshold') REDACTEDREDACTED</label>
          <input
          ...
          />
          <p class="input-hint">{{ t('admin.accounts.autoPauseThresholdHint') REDACTEDREDACTED</p>
        </div>
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            <label class="input-label mb-0">{{ t('admin.accounts.autoPause7dDisabled') REDACTEDREDACTED</label>
            <button
              type="button"
        ...
        <div>
          <label class="input-label">{{ t('admin.accounts.autoPause7dThreshold') REDACTEDREDACTED</label>
          <input
      ...
      >
        <div class="flex items-center justify-between gap-4">
          <div class="min-w-0">
            <label class="input-label mb-0">{{ t('admin.accounts.autoResetCredit.title') REDACTEDREDACTED</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.autoResetCredit.hint') REDACTEDREDACTED
            </p>
          </div>
          <button
            type="button"
        ...
        <div class="grid gap-4 sm:grid-cols-2">
          <div>
            <label class="input-label">{{ t('admin.accounts.autoResetCredit.threshold5h') REDACTEDREDACTED</label>
            <input
          ...
          <div>
            <label class="input-label">{{ t('admin.accounts.autoResetCredit.threshold7d') REDACTEDREDACTED</label>
            <input
        ...
        <p class="input-hint">{{ t('admin.accounts.autoResetCredit.thresholdHint') REDACTEDREDACTED</p>
      </div>
      ...
      <div class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div>
          <label class="input-label">{{ t('common.status') REDACTEDREDACTED</label>
    ...
    <template #footer>
      <div v-if="account" class="flex justify-end gap-3">
        ...
        >
          ...
          {{ submitting ? t('admin.accounts.updating') : t('common.update') REDACTEDREDACTED
        </button>
      </div>
    </template>
  </BaseDialog>
...
import { ref, reactive, computed, watch, nextTick REDACTED from 'vue'
...
const handleOllamaCloudUsageUpdated = (state: OllamaCloudUsageState) => {
  if (props.account) emit('updated', { ...props.account, ollama_cloud_usage: state REDACTED)
REDACTED
...
const cnAccountModeOptions = computed<Array<{ value: CnAccountMode; labelKey: 'payg' | 'coding' REDACTED>>(
  () => {
    // DeepSeek 无 coding 套餐（与创建弹窗一致），仅保留按量付费。
    if (props.account?.platform === 'deepseek') {
      return [{ value: 'payg', labelKey: 'payg' REDACTED]
    REDACTED
    return [
      { value: 'payg', labelKey: 'payg' REDACTED,
      { value: 'coding', labelKey: 'coding' REDACTED
    ]
  REDACTED
)
const cnProtocolOptions = computed<Array<{ value: CnApiProtocol; labelKey: string REDACTED>>(() => {
  ...
  return opts
REDACTED)
const editAdaptiveProtocolOptions = computed<Array<{ value: CnNativeApiProtocol; labelKey: string REDACTED>>(() => {
  const opts: Array<{ value: CnNativeApiProtocol; labelKey: string REDACTED> = [
    { value: 'chat_completions', labelKey: 'chatCompletions' REDACTED,
    { value: 'anthropic', labelKey: 'anthropic' REDACTED
  ]
  if (props.account?.platform === 'deepseek') opts.push({ value: 'responses', labelKey: 'responses' REDACTED)
  return opts
REDACTED)
...
const statusOptions = computed(() => {
  ...
  if (form.status === 'error') {
    options.push({ value: 'error', label: t('admin.accounts.status.error') REDACTED)
  REDACTED
  return options
REDACTED)
...
const applyOpenAIModelMappingCredentials = (credentials: Record<string, unknown>) => {
  ...
  if (shouldApplyModelMapping) {
    ...
    REDACTED
  REDACTED else if (!credentials.model_mapping) {
    delete credentials.model_mapping
  REDACTED
...
const syncFormFromAccount = (newAccount: Account | null) => {
  ...
  if (newAccount.platform === 'openai' && (newAccount.type === 'oauth' || newAccount.type === 'setup-token' || newAccount.type === 'apikey')) {
    ...
    REDACTED else if (codexImageGenerationBridgeValue === true) {
      codexImageToolMode.value = 'enabled'
    REDACTED else if (codexImageGenerationBridgeValue === false) {
    ...
    if (compactMappings && typeof compactMappings === 'object') {
      openAICompactModelMappings.value = Object.entries(compactMappings).map(([from, to]) => ({ from, to REDACTED))
    REDACTED
  REDACTED
  ...
  if (newAccount.platform === 'antigravity') {
    ...
    if (rawAgMapping && typeof rawAgMapping === 'object') {
      ...
      antigravityModelMappings.value = entries.map(([from, to]) => ({ from, to REDACTED))
    REDACTED else {
  ...
  if (newAccount.type === 'apikey' && newAccount.credentials) {
    ...
    if (newAccount.platform === 'kimi' || newAccount.platform === 'zhipu' || newAccount.platform === 'deepseek') {
      ...
      const storedBaseUrls = (credentials.api_base_urls as Record<string, unknown> | undefined) || {REDACTED
  ...
  REDACTED else if (newAccount.type === 'bedrock' && newAccount.credentials) {
    ...
    const bedrockExtra = (newAccount.extra as Record<string, unknown>) || {REDACTED
  ...
  REDACTED else if ((newAccount.platform === 'gemini' || newAccount.platform === 'anthropic') && newAccount.type === 'service_account' && newAccount.credentials) {
    const credentials = newAccount.credentials as Record<string, unknown>
...
async function loadTLSProfiles() {
  try {
    ...
    tlsFingerprintProfiles.value = profiles.map(p => ({ id: p.id, name: p.name REDACTED))
  REDACTED catch {
...
const syncAntigravityUpstreamModels = async () => {
  ...
  try {
    ...
    for (const model of upstreamModels) {
      ...
      if (!exists) {
        antigravityModelMappings.value.push({ from: model, to: model REDACTED)
        addedCount += 1
      REDACTED
    REDACTED
...
REDACTED
  ...
  const updatePayload: Record<string, unknown> = { ...form REDACTED
  try {
    ...
    if (props.account.type === 'apikey') {
      ...
      REDACTED else if (!hasExistingApiKey) {
    ...
    REDACTED else if (props.account.type === 'upstream') {
      const currentCredentials = (props.account.credentials as Record<string, unknown>) || {REDACTED
      ...
      updatePayload.credentials = newCredentials
    REDACTED else if ((props.account.platform === 'gemini' || props.account.platform === 'anthropic') && props.account.type === 'service_account') {
      const currentCredentials = (props.account.credentials as Record<string, unknown>) || {REDACTED
      const newCredentials: Record<string, unknown> = { ...currentCredentials REDACTED
      ...
      updatePayload.credentials = newCredentials
    REDACTED else if (props.account.type === 'bedrock') {
      const currentCredentials = (props.account.credentials as Record<string, unknown>) || {REDACTED
      const newCredentials: Record<string, unknown> = { ...currentCredentials REDACTED
    ...
    if ((props.account.platform === 'openai' || props.account.platform === 'grok') && props.account.type === 'oauth') {
      const currentCredentials = isSparkShadow.value
        ...
        : (updatePayload.credentials as Record<string, unknown>) ||
          ((props.account.credentials as Record<string, unknown>) || {REDACTED)
      const newCredentials: Record<string, unknown> = { ...currentCredentials REDACTED
      if (props.account.platform === 'openai') {
    ...
    if (props.account.platform === 'grok' && props.account.type === 'oauth') {
      ...
      const newExtra: Record<string, unknown> = {
        ...((props.account.extra as Record<string, unknown>) || {REDACTED)
      REDACTED
    ...
    if (props.account.platform === 'openai' && props.account.type === 'oauth' && !isSparkShadow.value) {
      const currentCredentials = (updatePayload.credentials as Record<string, unknown>) ||
        ((props.account.credentials as Record<string, unknown>) || {REDACTED)
      updatePayload.credentials = applyPlanType({ ...currentCredentials REDACTED, editPlanType.value)
    REDACTED
    ...
    if (props.account.platform === 'antigravity') {
      const currentExtra = (props.account.extra as Record<string, unknown>) || {REDACTED
      const newExtra: Record<string, unknown> = { ...currentExtra REDACTED
    ...
    if (props.account.platform === 'anthropic' && (props.account.type === 'oauth' || props.account.type === 'setup-token')) {
      const currentExtra = (updatePayload.extra as Record<string, unknown>) || (props.account.extra as Record<string, unknown>) || {REDACTED
      const newExtra: Record<string, unknown> = { ...currentExtra REDACTED
    ...
    if (props.account.platform === 'openai' && (props.account.type === 'oauth' || props.account.type === 'setup-token' || props.account.type === 'apikey')) {
      ...
      REDACTED else if (props.account.type === 'apikey') {
	...
	REDACTED
      ...
      if (props.account.type === 'oauth' || props.account.type === 'setup-token') {
        ...
        REDACTED else if (hadCodexCLIOnlyEnabled) {
