  ...
  >
    ...
    >
      ...
      <div class="border-t border-gray-200 pt-4 dark:border-dark-600">
        ...
        <div v-if="account?.platform === 'anthropic' || account?.platform === 'openai'" class="mb-3 flex items-center gap-2">
...
const syncFormFromAccount = (newAccount: Account | null) => {
  ...
  crossPlatformScheduling.value = extra?.cross_platform_scheduling === true
  ...
  try {
    ...
    if (props.account.platform === 'anthropic' || props.account.platform === 'openai') {
      ...
      if (crossPlatformScheduling.value) {
        newExtra.cross_platform_scheduling = true
      } else {
        delete newExtra.cross_platform_scheduling
      }
      updatePayload.extra = newExtra
    }
