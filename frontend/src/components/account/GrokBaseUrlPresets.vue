<template>
  <div class="flex flex-wrap gap-2">
    <button
      ...
      class="rounded-lg bg-gray-100 px-3 py-1 text-xs text-ink-secondary transition-colors hover:bg-primary-50 hover:text-primary-700 dark:bg-dark-600 dark:hover:bg-primary-900/30 dark:hover:text-primary-400"
