  ...
  >
      ...
      <div class="flex-1">
        ...
        <div v-if="inputMethod === 'codex_session'" class="space-y-4">
          ...
          >
            <p class="mb-3 text-sm text-blue-700 dark:text-blue-300">
              {{ t(agentIdentityOnly ? 'admin.accounts.oauth.openai.agentIdentityDesc' : 'admin.accounts.oauth.openai.codexSessionDesc') REDACTEDREDACTED
            </p>
            ...
            <div class="mb-4">
              ...
              >
                <Icon name="key" size="sm" class="text-blue-500" />
                {{ t(agentIdentityOnly ? 'admin.accounts.oauth.openai.agentIdentityInputLabel' : 'admin.accounts.oauth.openai.codexSessionInputLabel') REDACTEDREDACTED
                <span
              ...
              ></textarea>
              <p class="mt-1 text-xs text-blue-600 dark:text-blue-400">
                {{ t(agentIdentityOnly ? 'admin.accounts.oauth.openai.agentIdentityHint' : 'admin.accounts.oauth.openai.codexSessionHint') REDACTEDREDACTED
              </p>
            </div>
