<template>
  <div class="rounded-lg border border-blue-200 bg-blue-50 dark:border-blue-700 dark:bg-blue-900/30 p-6">
    <div class="flex items-start gap-4">
      ...
      <div class="flex-1">
        <h4 class="mb-3 font-semibold text-blue-900 dark:text-blue-200">{{ t('admin.accounts.oauth.title') REDACTEDREDACTED</h4>
        ...
        <div class="mb-4">
          ...
          <div class="flex gap-4">
            <label class="flex cursor-pointer items-center gap-2">
              ...
              />
              <span class="text-sm text-blue-900 dark:text-blue-200">{{ t('admin.accounts.oauth.manualAuth') REDACTEDREDACTED</span>
            </label>
            <label class="flex cursor-pointer items-center gap-2">
              <input
                v-model="inputMethod"
                ...
                class="text-blue-600 focus:ring-blue-500"
              />
              <span class="text-sm text-blue-900 dark:text-blue-200">{{ t('admin.accounts.oauth.cookieAutoAuth') REDACTEDREDACTED</span>
            </label>
          </div>
        </div>
        ...
        <div v-if="inputMethod === 'cookie'" class="space-y-4">
          <div class="rounded-lg border border-blue-300 dark:border-blue-600 bg-white/80 dark:bg-gray-800/80 p-4">
            ...
            >
              ...
              {{ loading ? t('admin.accounts.oauth.authorizing') : t('admin.accounts.oauth.startAutoAuth') REDACTEDREDACTED
            </button>
          </div>
        </div>
        ...
        <div v-else class="space-y-4">
          <p class="mb-4 text-sm text-blue-800 dark:text-blue-300">
            {{ t('admin.accounts.oauth.followSteps') REDACTEDREDACTED
          </p>
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <p class="mb-2 font-medium text-blue-900 dark:text-blue-200">
                  {{ t('admin.accounts.oauth.step1GenerateUrl') REDACTEDREDACTED
                </p>
                <button
                  v-if="!authUrl"
                  type="button"
                ...
                >
                  ...
                  {{ loading ? t('admin.accounts.oauth.generating') : t('admin.accounts.oauth.generateAuthUrl') REDACTEDREDACTED
                </button>
          ...
          <div class="rounded-lg border border-blue-300 dark:border-blue-600 bg-white/80 dark:bg-gray-800/80 p-4">
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <p class="mb-2 font-medium text-blue-900 dark:text-blue-200">
                  {{ t('admin.accounts.oauth.step2OpenUrl') REDACTEDREDACTED
                </p>
                <p class="text-sm text-blue-700 dark:text-blue-300">
                  {{ t('admin.accounts.oauth.openUrlDesc') REDACTEDREDACTED
                </p>
          ...
          <div class="rounded-lg border border-blue-300 dark:border-blue-600 bg-white/80 dark:bg-gray-800/80 p-4">
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <p class="mb-2 font-medium text-blue-900 dark:text-blue-200">
                  {{ t('admin.accounts.oauth.step3EnterCode') REDACTEDREDACTED
                </p>
                ...
                <div>
                  <label class="input-label">
                    ...
                    {{ t('admin.accounts.oauth.authCode') REDACTEDREDACTED
                  </label>
                  <textarea
                  ...
                  <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    {{ t('admin.accounts.oauth.authCodeHint') REDACTEDREDACTED
                  </p>
                </div>
