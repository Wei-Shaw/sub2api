  ...
  <div v-if="visible" class="space-y-1">
    ...
    <div v-if="primaryResetCreditExpiry" class="space-y-1">
      <div class="flex flex-wrap items-center gap-1">
        <span
          class="inline-flex max-w-full items-center rounded bg-gray-100 px-1.5 py-0.5 text-[10px] leading-4 text-ink-secondary tabular-nums dark:bg-dark-800"
        ...
        <button
          ...
          class="inline-flex items-center rounded-full bg-gray-100 px-1.5 py-0.5 text-[10px] font-medium leading-4 text-ink-secondary transition-colors hover:bg-gray-200 dark:bg-dark-800 dark:hover:bg-dark-700"
      ...
      <div
        ...
        class="inline-grid max-w-full gap-0.5 rounded border border-line bg-surface px-1.5 py-1 text-[10px] leading-4 text-ink-secondary shadow-sm"
      >
