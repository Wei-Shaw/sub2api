...
<template>
  <span
    ...
    :title="tooltip"
  >
    <span v-if="label" class="font-semibold opacity-70">{{ label REDACTEDREDACTED</span>
    ...
    <span class="font-mono">${{ fmt(used) REDACTEDREDACTED</span>
    <span class="text-gray-400 dark:text-gray-500">/</span>
    <span class="font-mono">${{ fmt(limit) REDACTEDREDACTED</span>
  </span>
</template>
