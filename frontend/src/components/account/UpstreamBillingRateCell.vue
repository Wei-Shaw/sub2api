...
// 探测资格与后端 IsUpstreamBillingProbeIdentity 对齐：受支持文本平台的 apikey 账号。
// 媒体平台（fal / atlascloud / apiz）不实现 /v1/sub2api/billing，不显示该列内容。
const eligible = computed(() => supportsUpstreamBillingProbe(props.account.platform, props.account.type))
