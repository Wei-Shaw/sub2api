...
const labelClass = computed(() => {
  const colors = {
    indigo: 'bg-indigo-100 text-accent dark:bg-indigo-900/40',
    emerald: 'bg-emerald-100 text-success dark:bg-emerald-900/40',
    purple: 'bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300',
    amber: 'bg-amber-100 text-warn dark:bg-amber-900/40'
  }
