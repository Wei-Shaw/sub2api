...
const pOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlatforms') }, { value: 'anthropic', label: 'Anthropic' }, { value: 'openai', label: 'OpenAI' }, { value: 'gemini', label: 'Gemini' }, { value: 'antigravity', label: 'Antigravity' }, { value: 'kiro', label: 'Kiro' }, { value: 'grok', label: 'Grok' }, { value: 'fal', label: 'fal' }, { value: 'leonardo', label: 'Leonardo' }, { value: 'atlascloud', label: 'AtlasCloud' }, { value: 'apiz', label: 'apiz' }, { value: 'higgsfield', label: 'Higgsfield' }])
