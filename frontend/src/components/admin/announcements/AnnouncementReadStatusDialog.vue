...
import { computed, onMounted, reactive, ref, watch REDACTED from 'vue'
...
const columns = computed<Column[]>(() => [
  { key: 'email', label: t('common.email') REDACTED,
  { key: 'username', label: t('admin.users.columns.username') REDACTED,
  { key: 'balance', label: t('common.balance') REDACTED,
