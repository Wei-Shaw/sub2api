<template>
  <div class="flex items-start gap-2 rounded border border-gray-200 bg-white p-2 dark:border-dark-500 dark:bg-dark-700">
    ...
    <template v-if="mode === 'token'">
      ...
      <div class="flex-1">
        <label class="text-xs text-gray-400">{{ t('admin.channels.form.inputPrice', '输入') REDACTEDREDACTED <span class="text-gray-300">$/M</span></label>
      ...
      <div class="flex-1">
        <label class="text-xs text-gray-400">{{ t('admin.channels.form.outputPrice', '输出') REDACTEDREDACTED <span class="text-gray-300">$/M</span></label>
    ...
    <template v-else>
      ...
      <div class="flex-1">
        <label class="text-xs text-gray-400">{{ t('admin.channels.form.perRequestPrice', '单次价格') REDACTEDREDACTED <span class="text-gray-300">$</span></label>
