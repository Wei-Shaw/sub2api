<template>
  <div>
    ...
    <p class="mt-1 text-xs text-gray-400">
      {{ t('admin.channels.form.modelInputHint', 'Press Enter to add, supports paste for batch import.') REDACTEDREDACTED
    </p>
  </div>
</template>
...
import { getPlatformTagClass REDACTED from './types'
