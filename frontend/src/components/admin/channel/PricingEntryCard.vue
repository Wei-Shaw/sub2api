  ...
  <div class="rounded-lg border border-line bg-surface-sunken p-3">
    ...
    >
      <Icon
        ...
        size="sm"
        :stroke-width="2"
        class="flex-shrink-0 text-ink-tertiary transition-transform duration-200"
      />
      ...
      <div v-if="collapsed" class="flex min-w-0 flex-1 items-center gap-2 overflow-hidden">
        ...
        <div class="flex min-w-0 flex-1 flex-wrap items-center gap-1">
          ...
          <span
            ...
            class="whitespace-nowrap text-xs text-ink-tertiary"
          >
            +{{ entry.models.length - 3 }}
          </span>
          <span
            v-if="entry.models.length === 0"
            class="text-xs italic text-ink-tertiary"
          >
      ...
      <div v-else class="flex-1 text-xs font-medium text-ink-secondary">
      ...
      <button
        ...
        class="flex-shrink-0 rounded p-1 text-ink-tertiary hover:text-red-500"
      >
    ...
    >
      <div class="collapsible-inner">
        ...
        <div v-if="entry.billing_mode === 'token'">
          ...
          <label class="mt-3 block text-xs font-medium text-ink-secondary">
            {{ t('admin.channels.form.defaultPrices') }}
            <span class="ml-1 font-normal text-ink-tertiary">$/MTok</span>
          </label>
          <div class="mt-1 grid grid-cols-2 gap-2 sm:grid-cols-6">
            <div>
              <label class="text-xs text-ink-tertiary">{{ t('admin.channels.form.inputPrice') }}</label>
          ...
          <div v-if="!hideTokenIntervals" class="mt-3">
            <div class="flex items-center justify-between">
              <label class="text-xs font-medium text-ink-secondary">
                ...
                <span class="ml-1 font-normal text-ink-tertiary">(min, max]</span>
              </label>
        ...
        <div v-else-if="entry.billing_mode === 'per_request'">
          ...
          <label class="mt-3 block text-xs font-medium text-ink-secondary">
            ...
            <span class="ml-1 font-normal text-ink-tertiary">$</span>
          </label>
          <div class="mt-1 w-48">
          ...
          <div v-else class="mt-2 rounded border border-dashed border-gray-300 p-3 text-center text-xs text-ink-tertiary dark:border-dark-500">
