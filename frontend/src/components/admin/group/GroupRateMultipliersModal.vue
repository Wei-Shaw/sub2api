    ...
    <div v-if="group" class="space-y-4">
      ...
      <div class="flex flex-wrap items-center gap-3 rounded-lg bg-gray-50 px-4 py-2.5 text-sm dark:bg-dark-700">
        ...
        <span class="text-gray-600 dark:text-gray-400">
          {{ t('admin.groups.columns.rateMultiplier') REDACTEDREDACTED: {{ group.rate_multiplier REDACTEDREDACTEDx
        </span>
      </div>
      ...
      <div class="rounded-lg border border-gray-200 p-3 dark:border-dark-600">
        ...
        <h4 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
          {{ t('admin.groups.addUserRate') REDACTEDREDACTED
        </h4>
        ...
        <div v-if="localEntries.length > 0" class="mt-3 flex items-center gap-3 border-t border-gray-100 pt-3 dark:border-dark-600">
          <span class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('admin.groups.batchAdjust') REDACTEDREDACTED</span>
          <div class="flex items-center gap-1.5">
            ...
            >
              {{ t('admin.groups.applyMultiplier') REDACTEDREDACTED
            </button>
          </div>
          <div class="ml-auto">
            <button
      ...
      <div v-else>
        <h4 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
          {{ t('admin.groups.rateMultipliers') REDACTEDREDACTED ({{ localEntries.length REDACTEDREDACTED)
        </h4>

        <div v-if="localEntries.length === 0" class="py-6 text-center text-sm text-gray-400 dark:text-gray-500">
          {{ t('admin.groups.noRateMultipliers') REDACTEDREDACTED
        </div>
              ...
              <table class="w-full min-w-max text-sm">
                <thead class="sticky top-0 z-[1]">
                  <tr class="border-b border-gray-200 bg-gray-50 dark:border-dark-600 dark:bg-dark-700">
                    ...
                    <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('admin.groups.columns.rateMultiplier') REDACTEDREDACTED</th>
                    <th v-if="showFinalRate" class="px-3 py-2 text-left text-xs font-medium text-primary-600 dark:text-primary-400">{{ t('admin.groups.finalRate') REDACTEDREDACTED</th>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-dark-600">
                  ...
                  >
                    ...
                    <td v-if="showFinalRate" class="whitespace-nowrap px-3 py-2 font-medium text-primary-600 dark:text-primary-400">
                      {{ computeFinalRate(entry.rate_multiplier) REDACTEDREDACTED
                    </td>
                    <td class="px-2 py-2">
                      <button
                        type="button"
...
import type { GroupRateMultiplierEntry REDACTED from '@/api/admin/groups'
...
interface LocalEntry extends GroupRateMultiplierEntry {REDACTED
