    ...
    <div v-if="group" class="space-y-4">
      ...
      <div class="rounded-lg border border-line p-3">
        ...
        <div v-if="localEntries.length > 0" class="mt-3 flex items-center gap-3 border-t border-gray-100 pt-3 dark:border-dark-600">
          <span class="text-xs font-medium text-ink-secondary">{{ t('admin.groups.batchAdjust') }}</span>
          <div class="flex items-center gap-1.5">
            ...
            <input
              ...
              min="0"
              autocomplete="off"
              class="hide-spinner w-20 rounded border border-gray-200 bg-surface px-2 py-1 text-center text-sm transition-colors focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500/20 dark:border-dark-500 dark:focus:border-primary-500"
              placeholder="0.5"
            />
            <button
              type="button"
          ...
          <div class="ml-auto">
            <button
              type="button"
              class="rounded-lg border border-red-200 border border-danger/40 bg-danger-tint px-3 py-1.5 text-sm font-medium text-red-600 transition-colors hover:bg-red-100 dark:border-red-800 dark:text-red-400 dark:hover:bg-red-900/40"
              @click="clearAllLocal"
            >
              ...
              <table class="w-full min-w-max text-sm">
                <thead class="sticky top-0 z-[1]">
                  <tr class="border-b border-line bg-surface-sunken">
                    ...
                    <th class="px-3 py-2 text-left text-xs font-medium text-ink-secondary">{{ t('admin.groups.columns.rateMultiplier') }}</th>
