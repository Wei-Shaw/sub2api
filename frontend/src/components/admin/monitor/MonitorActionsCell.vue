<template>
  <div class="flex items-center gap-1">
    ...
    >
      ...
      <span class="text-xs">{{ t('admin.channelMonitor.runNow') REDACTEDREDACTED</span>
    </button>
    <button
    ...
    >
      ...
      <span class="text-xs">
        {{ duplicating ? t('admin.channelMonitor.duplicating') : t('admin.channelMonitor.duplicate') REDACTEDREDACTED
      </span>
    </button>
    <button
      @click="$emit('edit', row)"
