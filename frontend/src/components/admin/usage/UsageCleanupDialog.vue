    ...
    <div class="space-y-4">
      ...
      <div class="rounded-xl border border-gray-200 p-4 dark:border-dark-700">
        ...
        <div class="mt-3 space-y-2">
          <div v-if="tasksLoading" class="text-sm text-ink-secondary">
            {{ t('admin.usage.cleanup.loadingTasks') }}
          </div>
          <div v-else-if="tasks.length === 0" class="text-sm text-ink-secondary">
            ...
            >
              <div class="flex flex-wrap items-center justify-between gap-2">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-xs text-ink-tertiary">#{{ task.id }}</span>
                  <button
                    v-if="canCancel(task)"
                    type="button"
              ...
              <div class="flex flex-wrap items-center gap-4 text-xs text-ink-secondary">
