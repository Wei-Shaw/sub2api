<template>
  ...
  >
    <div v-if="user" class="space-y-4">
      ...
      <div v-if="loading" class="py-10 text-center text-ink-secondary">{{ t('common.loading') }}</div>
      <div v-else class="overflow-x-auto">
            ...
            <tr v-for="row in quotas" :key="row.platform" class="border-b border-line-subtle">
              ...
              <td class="px-3 py-2">
                <div class="flex items-center gap-1">
                  ...
                  <button
                    type="button"
                    class="text-xs text-ink-tertiary hover:text-amber-500 disabled:opacity-50"
        ...
        <p class="mt-3 text-xs text-ink-secondary">{{ t('admin.users.platformQuota.hint') }}</p>
        <div class="mt-3">
