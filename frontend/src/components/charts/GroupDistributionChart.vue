        ...
        <table class="w-full text-xs">
          <thead>
            <tr class="text-gray-500 dark:text-gray-400">
              ...
              <th class="pb-2 text-right">{{ t('admin.dashboard.accountCost') REDACTEDREDACTED</th>
              ...
              >
                ...
                >
                  <span class="inline-flex items-center gap-1">
                    <svg v-if="group.group_id > 0 && expandedKey === `group-${group.group_idREDACTED`" class="h-3 w-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
