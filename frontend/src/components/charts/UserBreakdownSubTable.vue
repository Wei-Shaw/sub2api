    ...
    <table v-else class="w-full text-xs">
      <thead>
        <tr class="text-gray-400 dark:text-gray-500">
          <th class="py-1 pl-6 text-left">{{ t('admin.dashboard.spendingRankingUser') REDACTEDREDACTED</th>
          <th class="py-1 text-right">{{ t('admin.dashboard.requests') REDACTEDREDACTED</th>
          <th class="py-1 text-right">{{ t('admin.dashboard.tokens') REDACTEDREDACTED</th>
          <th class="py-1 text-right">{{ t('admin.dashboard.actual') REDACTEDREDACTED</th>
          <th class="py-1 pr-1 text-right">{{ t('admin.dashboard.standard') REDACTEDREDACTED</th>
        </tr>
      </thead>
      <tbody>
        <tr
