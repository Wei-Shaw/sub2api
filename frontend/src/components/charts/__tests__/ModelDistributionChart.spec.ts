  ...
  it('renders Others in the spending ranking table and uses a dedicated chart color', async () => {
    const wrapper = mount(ModelDistributionChart, {
      props: {
        ...
        rankingItems: [
          { user_id: 1, email: 'alpha@example.com', actual_cost: 12, requests: 10, tokens: 1000 REDACTED,
          { user_id: 2, email: 'beta@example.com', actual_cost: 8, requests: 6, tokens: 600 REDACTED,
        ],
