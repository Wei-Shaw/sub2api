          ...
          <div class="relative overflow-hidden border-b border-amber-100/80 bg-gradient-to-br from-amber-50/80 via-orange-50/50 to-yellow-50/30 px-8 py-6 dark:border-dark-700/50 dark:from-amber-900/20 dark:via-orange-900/10 dark:to-yellow-900/5">
            ...
            <div class="relative z-10">
              ...
              <h2 class="mb-2 text-2xl font-bold leading-tight text-gray-900 dark:text-white">
                {{ displayedAnnouncement.title REDACTEDREDACTED
              </h2>
              ...
              <div class="flex items-center gap-1.5 text-sm text-gray-600 dark:text-gray-400">
                ...
                <time>{{ formatRelativeWithDateTime(displayedAnnouncement.created_at) REDACTEDREDACTED</time>
              </div>
            </div>
          </div>
            ...
            <div class="flex items-center justify-end">
              ...
              >
                <span class="flex items-center gap-2">
                  ...
                  {{ preview ? t('common.close') : t('announcements.markRead') REDACTEDREDACTED
                </span>
              </button>
            </div>
          </div>
...
import { computed, onBeforeUnmount, watch REDACTED from 'vue'
...
import type { Announcement, UserAnnouncement REDACTED from '@/types'
...
watch(
  ...
  (popup) => {
    ...
    REDACTED else if (props.preview) {
