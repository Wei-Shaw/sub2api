<template>
  <div class="relative" ref="dropdownRef">
    ...
    >
      ...
      <span>
        {{ enabled
          ? t('common.autoRefresh.countdown', { seconds: countdown REDACTED)
    ...
    >
      <div class="p-1.5">
        ...
        >
          <span>{{ t('common.autoRefresh.enable') REDACTEDREDACTED</span>
        ...
        <button
          ...
          class="flex w-full items-center justify-between rounded-md px-3 py-1.5 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-dark-700"
        >
          <span>{{ t('common.autoRefresh.seconds', { n: sec REDACTED) REDACTEDREDACTED</span>
...
import { ref, onMounted, onBeforeUnmount REDACTED from 'vue'
