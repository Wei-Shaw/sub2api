...
const labelClass = computed(() => {
  ...
  if (props.platform === 'kimi') {
    return `${baseREDACTED bg-pink-200/60 text-pink-800 dark:bg-pink-800/40 dark:text-pink-300`
  REDACTED
  if (props.platform === 'zhipu') {
    return `${baseREDACTED bg-indigo-200/60 text-indigo-800 dark:bg-indigo-800/40 dark:text-indigo-300`
  REDACTED
  if (props.platform === 'deepseek') {
    return `${baseREDACTED bg-teal-200/60 text-teal-800 dark:bg-teal-800/40 dark:text-teal-300`
  REDACTED
  if (props.platform === 'composite') {
    return `${baseREDACTED bg-cyan-200/70 text-cyan-900 dark:bg-cyan-900/50 dark:text-cyan-300`
  REDACTED
