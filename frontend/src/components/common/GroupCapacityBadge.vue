  ...
  <div class="flex flex-col gap-1">
    ...
    <div class="flex items-center gap-1">
      ...
      >
        ...
        <span class="font-mono">{{ concurrencyUsed REDACTEDREDACTED</span>
        <span class="text-gray-400 dark:text-gray-500">/</span>
        <span class="font-mono">{{ concurrencyMax REDACTEDREDACTED</span>
      </span>
    </div>
    ...
    <div v-if="sessionsMax > 0" class="flex items-center gap-1">
      ...
      >
        ...
        <span class="font-mono">{{ sessionsUsed REDACTEDREDACTED</span>
        <span class="text-gray-400 dark:text-gray-500">/</span>
        <span class="font-mono">{{ sessionsMax REDACTEDREDACTED</span>
      </span>
    </div>
    ...
    <div v-if="rpmMax > 0" class="flex items-center gap-1">
      ...
      >
        ...
        <span class="font-mono">{{ rpmUsed REDACTEDREDACTED</span>
        <span class="text-gray-400 dark:text-gray-500">/</span>
        <span class="font-mono">{{ rpmMax REDACTEDREDACTED</span>
      </span>
    </div>
  </div>
</template>
