          ...
          <transition name="dropdown">
            ...
            >
              ...
              <div class="px-4 py-3 border-b border-gray-100 dark:border-dark-700">
                <div class="text-sm font-medium text-gray-900 dark:text-white">{{ displayName REDACTEDREDACTED</div>
              ...
              <div class="sm:hidden px-4 py-2 border-b border-gray-100 dark:border-dark-700">
                <div class="text-xs text-gray-500 dark:text-dark-400">{{ t('common.balance') REDACTEDREDACTED</div>
              ...
              <div v-if="contactInfo" class="border-t border-gray-100 dark:border-dark-700 px-4 py-2.5">
                <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <span class="font-medium text-gray-700 dark:text-gray-300">{{ contactInfo REDACTEDREDACTED</span>
                </div>
              </div>
