...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/quota-monitor', label: t('nav.myQuota'), icon: ChartIcon, hideInSimpleMode: true, featureFlag: flagServiceQuota },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/subscriptions', label: t('nav.subscriptions'), icon: CreditCardIcon, hideInSimpleMode: true },
    {
      ...
      expandOnly: true,
      children: [
        { path: '/admin/service-quotas/monitor', label: t('nav.serviceQuotaMonitor'), icon: SignalIcon },
        { path: '/admin/service-quotas/config', label: t('nav.serviceQuotaConfig'), icon: CogIcon },
      ],
    },
