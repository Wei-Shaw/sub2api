...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/llm-tester', label: t('nav.llmTester'), icon: TesterIcon, hideInSimpleMode: true REDACTED,
...
const adminNavItems = computed((): NavItem[] => {
  ...
  if (authStore.isSimpleMode) {
    ...
    filtered.push({ path: '/llm-tester', label: t('nav.llmTester'), icon: TesterIcon REDACTED)
