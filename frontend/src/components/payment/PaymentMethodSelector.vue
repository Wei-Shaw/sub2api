...
import dogpayIcon from '@/assets/icons/dogpay.png'
...
function methodIcon(type: string): string {
  ...
  if (type === 'dogpay') return METHOD_ICONS.dogpay
...
function methodSelectedClass(type: string): string {
  ...
  if (type === 'dogpay') return 'border-[#10B981] bg-emerald-50 text-gray-900 shadow-sm dark:border-[#34D399] dark:bg-emerald-950 dark:text-gray-100'
