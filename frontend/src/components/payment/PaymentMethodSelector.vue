...
function methodIcon(type: string): string {
  ...
  if (type === 'epusdt') return METHOD_ICONS.epusdt
...
function methodSelectedClass(type: string): string {
  ...
  if (type === 'epusdt') return 'border-[#26A17B] bg-emerald-50 text-gray-900 shadow-sm dark:border-[#26A17B] dark:bg-emerald-950 dark:text-gray-100'
