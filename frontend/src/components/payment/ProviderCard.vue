  ...
  >
    <div :class="[
      ...
      <div class="flex items-center gap-4">
        ...
        <span v-else class="text-xs text-gray-400 dark:text-gray-500" data-testid="provider-refund-unsupported">
          {{ t('admin.settings.payment.refundUnsupported') }}
        </span>
...
const supportsRefund = computed(() => providerSupportsRefund(props.provider.provider_key))
