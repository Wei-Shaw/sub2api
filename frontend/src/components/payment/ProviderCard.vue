  ...
  >
    <div :class="[
      ...
      <div class="flex items-center gap-3">
        ...
        <span class="text-sm font-medium text-gray-900 dark:text-white">{{ provider.name REDACTEDREDACTED</span>
        <span class="text-xs text-gray-400 dark:text-gray-500">{{ keyLabel REDACTEDREDACTED</span>
        <span v-if="provider.payment_mode" class="text-xs text-gray-400 dark:text-gray-500">· {{ modeLabel REDACTEDREDACTED</span>
...
import type { TypeOption REDACTED from './providerConfig'
import { PAYMENT_MODE_QRCODE, PAYMENT_MODE_POPUP, PAYMENT_MODE_REDIRECT REDACTED from './providerConfig'
