    ...
    <div class="flex flex-1 flex-col p-4">
      ...
      <div class="mb-3 flex items-start justify-between gap-2">
        ...
        <div class="shrink-0 text-right">
          <!--
            Plan prices are CNY-native (see backend dto.PlazaCurrencyMetaDTO.PlanNative = "CNY").
            Daily/weekly/monthly group quotas below are still USD because they reflect upstream
            LiteLLM cost windows; do not unify the symbols.
          -->
