...
export const METHOD_ORDER = ['ipayees', 'alipay', 'alipay_direct', 'wxpay', 'wxpay_direct', 'stripe', 'airwallex'] as const
...
export const WEBHOOK_PATHS: Record<string, string> = {
  ...
  ipayees: '/api/v1/payment/webhook/ipayees',
}
...
export const PROVIDER_CALLBACK_PATHS: Record<string, CallbackPaths> = {
  ...
  ipayees: { notifyUrl: WEBHOOK_PATHS.ipayees, returnUrl: RETURN_PATH },
...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  ipayees: [
    { key: 'apiBase', label: '', sensitive: false, hintKey: 'admin.settings.payment.field_ipayeesApiBaseHint' },
    { key: 'apiKey', label: '', sensitive: true },
    { key: 'currency', label: '', sensitive: false, defaultValue: 'BDT', options: PAYMENT_CURRENCY_OPTIONS },
    { key: 'contact', label: 'Fallback Contact (email / mobile)', sensitive: false, hintKey: 'admin.settings.payment.field_ipayeesContactHint' },
    { key: 'customerName', label: 'Customer Name', sensitive: false, optional: true },
  ],
}
