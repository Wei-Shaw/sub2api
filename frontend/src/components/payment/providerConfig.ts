...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  easypay: [
    ...
    { key: 'customType', label: '', sensitive: false, optional: true, clearable: true, hintKey: 'admin.settings.payment.field_easypayCustomTypeHint' },
    { key: 'customUpstreamType', label: '', sensitive: false, optional: true, clearable: true, hintKey: 'admin.settings.payment.field_easypayCustomUpstreamTypeHint' },
    { key: 'customDisplayName', label: '', sensitive: false, optional: true, clearable: true, hintKey: 'admin.settings.payment.field_easypayCustomDisplayNameHint' },
