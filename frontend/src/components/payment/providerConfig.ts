...
export const METHOD_ORDER = ['alipay', 'alipay_direct', 'wxpay', 'wxpay_direct', 'stripe', 'airwallex', 'dogpay'] as const
...
export const WEBHOOK_PATHS: Record<string, string> = {
  ...
  dogpay: '/api/v1/payment/webhook/dogpay',
}
...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  dogpay: [
    { key: 'appId', label: 'App ID', sensitive: false },
    { key: 'secret', label: 'App Secret', sensitive: true },
    { key: 'apiBase', label: '', sensitive: false, defaultValue: 'https://api.dogpay.com', hintKey: 'admin.settings.payment.field_dogpayApiBaseHint' },
  ],
}
