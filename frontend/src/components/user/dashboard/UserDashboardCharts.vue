            ...
            <table class="w-full text-xs">
              ...
              <tbody>
                <tr v-for="model in models" :key="model.model" class="border-t border-gray-100 dark:border-dark-700">
                  ...
                  <td class="py-1.5 text-right text-gray-600 dark:text-gray-400">${{ formatCost(model.actual_cost) }}</td>
...
const modelData = computed(() => !props.models?.length ? null : {
  ...
  datasets: [{
    ...
    backgroundColor: ['#3b82f6', '#737373', '#f59e0b', '#ef4444', '#8b5cf6', '#ec4899', '#06b6d4', '#84cc16']
  }]
})
