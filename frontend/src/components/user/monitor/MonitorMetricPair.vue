  ...
  <div class="mt-5 grid grid-cols-2 gap-2">
    ...
    >
      ...
      >
        ...
        <span>{{ primaryLabel REDACTEDREDACTED</span>
      </div>
      <div class="mt-1.5 text-lg font-bold font-mono tabular-nums text-gray-900 dark:text-gray-100">
        {{ primaryValue REDACTEDREDACTED<span class="text-xs font-normal text-gray-400 ml-0.5">{{ primaryUnit REDACTEDREDACTED</span>
      </div>
    </div>
    <div
      class="rounded-xl p-3 bg-gray-50/80 dark:bg-dark-900/40 border border-gray-100 dark:border-dark-700/50"
    >
      ...
      >
        ...
        <span>{{ secondaryLabel REDACTEDREDACTED</span>
      </div>
      <div class="mt-1.5 text-lg font-bold font-mono tabular-nums text-gray-900 dark:text-gray-100">
        {{ secondaryValue REDACTEDREDACTED<span class="text-xs font-normal text-gray-400 ml-0.5">{{ secondaryUnit REDACTEDREDACTED</span>
      </div>
    </div>
  </div>
</template>
