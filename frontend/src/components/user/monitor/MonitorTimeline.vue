<template>
  <div class="mt-4 pt-3 border-t border-gray-100 dark:border-dark-700/60">
    <div
      class="flex justify-between text-[10px] font-semibold uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-2"
    >
    ...
    <div
      v-if="maintenance"
      class="flex h-5 w-full items-center justify-center rounded border border-dashed border-gray-300 dark:border-dark-600 text-[10px] uppercase tracking-widest text-gray-500 dark:text-gray-400"
    >
    ...
    <div
      class="mt-1 flex justify-between text-[9px] uppercase tracking-widest text-gray-500 dark:text-gray-400"
    >
