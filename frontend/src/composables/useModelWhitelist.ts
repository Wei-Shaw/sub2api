...
const antigravityPresetMappings = [
  // Claude 通配符映射（所有 Claude 统一指向 Opus）
  { label: 'Claude→Opus', from: 'claude-*', to: 'claude-opus-4-6-thinking', color: 'bg-purple-100 text-purple-700 hover:bg-purple-200 dark:bg-purple-900/30 dark:text-purple-400' },
  { label: 'Sonnet→Opus', from: 'claude-sonnet-*', to: 'claude-opus-4-6-thinking', color: 'bg-indigo-100 text-indigo-700 hover:bg-indigo-200 dark:bg-indigo-900/30 dark:text-indigo-400' },
  ...
  { label: 'Haiku→Opus', from: 'claude-haiku-*', to: 'claude-opus-4-6-thinking', color: 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400' },
  ...
  // 精确映射
  { label: 'Sonnet 4.6→Opus', from: 'claude-sonnet-4-6', to: 'claude-opus-4-6-thinking', color: 'bg-cyan-100 text-cyan-700 hover:bg-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-400' },
  { label: 'Sonnet 4.5→Opus', from: 'claude-sonnet-4-5', to: 'claude-opus-4-6-thinking', color: 'bg-cyan-100 text-cyan-700 hover:bg-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-400' },
