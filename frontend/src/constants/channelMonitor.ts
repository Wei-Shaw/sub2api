 ...
 *
 * Single source of truth for provider/status string values used by the
 * admin (`views/admin/ChannelMonitorView.vue`) screen and the shared
 * composable `useChannelMonitorFormat`.
 */
