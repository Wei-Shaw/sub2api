<template>
  ...
  >
    ...
    <span v-if="showTrophy" class="sr-only">{{ ariaLabel REDACTEDREDACTED</span>
    <span
...
const ariaLabel = computed(() => {
  ...
  return t('channelMonitorV2.rank.place', { n: rankNum.value REDACTED)
REDACTED)
