...
REDACTED from '../monitorFormat'
import type { MonitorHealth REDACTED from '@/api/channelMonitorV2'
...
describe('monitorFormat accuracy', () => {
  ...
  it('builds score-based health classes for matrix cells', () => {
    ...
    expect(healthScoreClass({ ...health, score: null REDACTED, 'overall', 0)).toBe('health-unknown')
  REDACTED)
