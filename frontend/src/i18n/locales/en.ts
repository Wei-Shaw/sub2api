export default {
  ...
  profile: {
    ...
    checkIn: {
      ...
      pageDescription: 'Claim your daily account balance reward',
      ...
      action: 'Check In',
      success: 'Daily check-in successful, reward credited: {amount}',
      failed: 'Failed to complete daily check-in',
      never: 'Never checked in',
      days: '{count} day | {count} days',
      disabledTitle: 'Daily check-in is not enabled',
      disabledDescription: 'The administrator has not enabled daily check-in.',
    },
  ...
  admin: {
    ...
    settings: {
      ...
      features: {
        ...
        dailyCheckIn: {
          title: 'Daily Check-In',
          description: 'Allow users to claim a reward once per day from their profile page.',
          enabled: 'Enable Daily Check-In',
          enabledHint: 'When off, the profile check-in card is hidden and the endpoint returns disabled status.',
          rewardAmount: 'Reward Amount',
          rewardAmountHint: 'Balance credited per successful daily check-in. Minimum 0.',
        },
        riskControl: {
          title: 'Risk Control',
