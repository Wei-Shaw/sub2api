  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        validationEasyPayCustomTypeInvalid: 'EasyPay custom payment type may only contain lowercase letters, digits, underscores, and hyphens',
        validationEasyPayCustomUpstreamTypeInvalid: 'EasyPay upstream type may only contain lowercase letters, digits, underscores, and hyphens',
        validationEasyPayCustomUpstreamTypeRequired: 'EasyPay upstream type is required when a custom payment type is set',
        ...
        field_customType: 'Custom payment type',
        field_customUpstreamType: 'EasyPay upstream type',
        field_customDisplayName: 'Custom display name',
        field_easypayCustomTypeHint: 'Optional. Adds a user-facing payment method such as ldc.',
        field_easypayCustomUpstreamTypeHint: 'Optional. The type sent to EasyPay, such as epay; only used when a custom payment type is set.',
        field_easypayCustomDisplayNameHint: 'Optional. Used in admin selectors; user pages fall back to the payment type code when no translation exists.',
