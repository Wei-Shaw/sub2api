export default {
  ...
  admin: {
    ...
    // plugin via sdk.i18n.registerNamespace at runtime. Do not re-add them
    // here.
    ...
    accounts: {
      ...
      pleaseSelectType: 'Please select an account type',
      selectPlatform: 'Select Platform',
      accountDetails: 'Account Details',
      loadingForm: 'Loading form...',
      failedToLoadForm: 'Failed to load account form',
    ...
    settings: {
      ...
      payment: {
        movedToPlugin: "Payment settings have moved to a plugin page.",
  ...
  plugin: {
    ...
    loadError: 'Failed to load plugin page.',
    contextUnavailable: 'Plugin context unavailable.'
  },
