export default {
  ...
  keys: {
    ...
    billingStrategyHint: 'Routing always follows the primary group. The settings below only affect billing order.',
    billingPoolNotice: 'Billing pool: {name}',
    billingPoolMixedPlatformNotice: 'This billing pool allows cross-platform fallback, but it does not change the routing platform of the primary group.',
    billingBalanceFallbackNotice: 'When the entire subscription chain is exhausted, billing will automatically fall back to account balance.',
    billingMode: {
      strict: 'Use primary subscription only',
      primaryThenBalance: 'Use balance after primary subscription is exhausted',
      primaryThenPoolThenBalance: 'Use same-pool subscriptions after primary, then fall back to balance'
    },
    billingModeDescriptions: {
      strict: 'Reject the request when the primary group subscription is unavailable.',
      primaryThenBalance: 'Fall back to account balance after the primary subscription is exhausted.',
      primaryThenPoolThenBalance: 'Try other subscriptions in the same billing pool before falling back to balance.'
    },
    billingAdvancedSettings: 'Advanced Settings',
    usePoolDefaultOrder: 'Use admin recommended order',
    usePoolDefaultOrderHint: 'Turn this off to customize the fallback group order within the pool.',
    customFallbackGroups: 'Custom fallback groups',
    customFallbackEmpty: 'No same-pool fallback groups are currently available.',
    addFallbackGroup: 'Add',
    removeFallbackGroup: 'Remove',
    moveUp: 'Move up',
    moveDown: 'Move down',
    billingPreview: 'Current billing order',
    billingPreviewEmpty: 'Select a group to preview the billing order',
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
  ...
  admin: {
    ...
    billingPools: {
      ...
      description: 'Manage subscription billing pools and fallback group order',
      searchPlaceholder: 'Search name, code, or description...',
      createPool: 'Create Billing Pool',
      editPool: 'Edit Billing Pool',
      deletePool: 'Delete Billing Pool',
      members: 'Members',
      membersTitle: '{name} Members',
      membersHint: 'Only subscription-billing groups are available. The order is saved as fallback chain_order.',
      addMember: 'Add Member',
      noMembers: 'No members yet',
      noMembersHint: 'Add subscription groups to build the billing chain.',
      noPools: 'No billing pools yet',
      noPoolsHint: 'Create a billing pool to configure cross-group subscription fallback.',
      noAvailableGroups: 'No subscription groups available to add',
      allStatus: 'All Status',
      allPlatformScopes: 'All Platform Scopes',
      groupCount: '{count} groups',
      allowUserReorderShort: 'User reorder',
      requirePrimaryShort: 'Require primary',
      balanceFallbackShort: 'Balance fallback',
      canBePrimary: 'Can be primary',
      canBeFallback: 'Can be fallback',
      moveUp: 'Move up',
      moveDown: 'Move down',
      nameCodeRequired: 'Please enter name and code',
      invalidMember: 'Please select a valid group',
      duplicateMember: 'Member groups cannot be duplicated',
      poolCreated: 'Billing pool created',
      poolUpdated: 'Billing pool updated',
      poolDeleted: 'Billing pool deleted',
      membersUpdated: 'Members saved',
      failedToLoad: 'Failed to load billing pools',
      failedToSave: 'Failed to save billing pool',
      failedToDelete: 'Failed to delete billing pool',
      failedToLoadGroups: 'Failed to load subscription groups',
      failedToLoadMembers: 'Failed to load billing pool members',
      failedToSaveMembers: 'Failed to save billing pool members',
      deleteConfirm: "Are you sure you want to delete billing pool '{name}'?",
      platformScopes: {
        same_platform: 'Same platform',
        mixed_platform: 'Mixed platform'
      },
      columns: {
        name: 'Name / Code',
        status: 'Status',
      ...
      form: {
        ...
        platformScope: 'Platform Scope',
        options: 'Options',
        allowUserReorder: 'Allow users to customize fallback order',
        requirePrimarySubscription: 'Require active primary subscription',
        allowBalanceFallback: 'Allow balance fallback after subscription chain is exhausted'
      }
    },
