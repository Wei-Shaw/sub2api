  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        joinHealthPool: 'Join Health Pool',
        leaveHealthPool: 'Leave Health Pool',
        protectHealth: 'Protect Accounts',
      ...
      health: {
        batchTitle: 'Batch Account Health Test',
        model: 'Test Model',
        concurrency: 'Concurrency',
        autoDisable: 'Disable after 3 other consecutive failures; 401 disables immediately, 429/rate limits count as healthy',
        startSelected: 'Test {count} Selected',
        recentTasks: 'Recent Tasks',
        noTasks: 'No batch test tasks yet',
        selectTask: 'Select a task to view results',
        progress: 'Progress',
        success: 'Success',
        failed: 'Failed',
        disabled: 'Disabled',
        ...
        failStreakShort: '{count} failures',
        error: 'Error',
        noResults: 'No results yet',
        inPool: 'In Pool',
        notInPool: 'Not Joined',
        protected: 'Protected',
        joinedPool: 'Added {count} account(s) to the health pool',
        leftPool: 'Removed {count} account(s) from the health pool',
        protectedUpdated: 'Updated protection for {count} account(s)',
        started: 'Batch test started',
        startFailed: 'Failed to start batch test',
        loadFailed: 'Failed to load batch test results',
        taskStatus: {
          pending: 'Pending',
          running: 'Running',
          completed: 'Completed',
