export default {
  ...
  auth: {
    ...
    accountIdentifierLabel: 'Email or phone',
    accountIdentifierPlaceholder: 'Enter email or phone',
    accountIdentifierRequired: 'Please enter an email or phone number',
    invalidAccountIdentifier: 'Enter a valid email or phone number without special symbols',
    emailLabel: 'Email',
  ...
  admin: {
    ...
    users: {
      ...
      usageOverride: {
        menuItem: 'Usage Override',
        title: 'Usage Override',
        currentBalance: 'Current Balance',
        usageSection: 'Usage Display',
        balanceSection: 'Remaining Balance',
        todayActualCost: 'Today Cost (USD)',
        totalActualCost: 'Total Cost (USD)',
        todayRequests: 'Today Requests',
        todayTokens: 'Today Tokens',
        totalTokens: 'Total Tokens',
        setBalance: 'Set Balance',
        notesPlaceholder: 'e.g., manual customer usage correction, legacy data migration, compensation adjustment',
        blankHint: 'Leave blank to use the real system stats. Filled fields override displayed usage stats.',
        balanceHint: 'Leave blank to keep balance unchanged. Filled value sets the user balance directly.',
        realValue: 'real value',
        invalidNumber: 'Please enter a valid non-negative number',
        save: 'Save Override',
        clear: 'Clear Usage Override',
        loadFailed: 'Failed to load usage override',
        saveSuccess: 'Usage override saved',
        saveFailed: 'Failed to save usage override',
        clearSuccess: 'Usage override cleared',
        clearFailed: 'Failed to clear usage override',
      },
      roles: {
        admin: 'Admin',
        user: 'User'
