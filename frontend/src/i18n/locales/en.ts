  ...
  admin: {
    ...
    accounts: {
      ...
      status: {
        ...
        activeExcludingQuotaStopped: 'Active (excluding quota-stopped)',
        openAI5HUsedZero: '5H used 0%',
        openAI7DUsedZero: '7D used 0%',
        openAIQuotaUsedRange: 'Specific quota',
        openAIQuotaUsedRangeValue: 'Specific quota ({window} {min}%~{max}%)',
        openAIQuotaWindow: 'Quota window',
        openAIQuotaRangeMin: 'Minimum used percent',
        openAIQuotaRangeMax: 'Maximum used percent',
        openAIQuotaRangeInvalid: 'Enter percentages from 0 to 100 with min not greater than max',
        openAIQuotaUsedRangeHint: 'This filter first applies “Active (excluding quota-stopped)”, then filters by the selected window used percentage.',
        openAIQuotaFull: 'Quota full',
        openAIQuotaFullValue: 'Quota full ({window})',
        openAIQuotaFullHint: 'This filter searches all statuses for OpenAI OAuth accounts whose selected window usage is 100% or higher.',
