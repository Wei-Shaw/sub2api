  ...
  admin: {
    ...
    settings: {
      ...
      site: {
        ...
        aiToolRewriteRules: {
          title: 'AI Tool Config Rewrite Rules',
          description: 'Run plain string replacements on generated "Use Key" tool config content, in rule order',
          publicWarning: 'Rules are delivered through public settings. Do not enter API keys, tokens, or other secrets.',
          itemLabel: 'Rule #{n}',
          platform: 'Platform',
          client: 'Tool',
          anyPlatform: 'All platforms',
          anyClient: 'All tools',
          find: 'Find',
          findPlaceholder: 'e.g., model = "gpt-5.4"',
          replace: 'Replace with',
          replacePlaceholder: 'e.g., model = "gpt-5.5"',
          add: 'Add Rule',
        },
