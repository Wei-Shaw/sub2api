export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "Reset the 5h, daily, weekly, and monthly usage quota for '{user}'? Usage will be zeroed and windows restarted from now.",
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
      ...
      guide: {
        ...
        subtitle: 'Subscription mode lets you assign time-based usage quotas to users, with 5h/daily/weekly/monthly limits. Follow these steps to get started.',
        showGuide: 'Usage Guide',
        step1: {
          title: 'Create a Subscription Group',
          line1: 'Go to "Group Management" page, click "Create Group"',
          line2: 'Set billing type to "Subscription", configure 5h/daily/weekly/monthly quota limits',
        ...
        actions: {
          ...
          resetQuota: 'Reset Quota',
          resetQuotaDesc: 'Reset 5h/daily/weekly/monthly usage to zero',
          revoke: 'Revoke',
