export default {
  ...
  // Setup Wizard
  setup: {
    title: 'DevRouter Setup',
    description: 'Configure your DevRouter instance',
    database: {
  ...
  channelStatus: {
    ...
    summary: {
      ...
      partialUnavailable: 'Partially unavailable',
      channelDown: 'Channel down',
      normalCount: 'Normal {n}',
      abnormalCount: 'Abnormal {n}'
    },
    modelsTitle: 'Model Status',
    modelCount: '{n} models',
    quickNav: 'Quick Nav',
    global: {
      operational: 'All channels are operational',
      degraded: 'Service fluctuation detected',
    ...
    disabled: {
      title: 'Service status is not public',
      description: 'Channel status monitoring display has been disabled by the administrator.'
    },
    columns: {
      name: 'Name',
      provider: 'Provider',
  ...
  chatCompletion: {
    title: 'Chat',
    description: 'Select one of your API keys and an available model, then send streaming chat through the existing gateway.',
    disabled: 'Chat is currently disabled. Ask an administrator to enable it in system settings.',
    apiKey: 'API Key',
    selectApiKey: 'Select API Key',
    loadingKeys: 'Loading available API keys...',
    noApiKeys: 'No available API keys. Create one and bind it to a group first.',
    baseUrl: 'Request endpoint Base URL',
    baseUrlUnavailable: 'Shown after selecting a model',
    model: 'Model',
    selectModel: 'Select model',
    selectKeyFirst: 'Select an API key first',
    selectModelFirst: 'Select a model first',
    loadingModels: 'Loading channel pricing models...',
    noModels: 'No channel pricing models are available for this key group.',
    message: 'Message',
    messagePlaceholder: 'Type a message. Enter sends, Shift+Enter inserts a newline',
    send: 'Send',
    attachImage: 'Attach image',
    removeImage: 'Remove image',
    closeImagePreview: 'Close image preview',
    unsupportedImageType: 'Only PNG, JPEG, WebP, or GIF images are supported.',
    imageTooLarge: 'Each image must be 10MB or smaller.',
    tooManyImages: 'Each message can include up to 4 images.',
    imageReadFailed: 'Failed to read the image. Choose it again.',
    imageModelUnsupported: 'The selected model does not support image input. Switch to a vision-capable model.',
    imagePlaceholder: '[image]',
    streaming: 'Generating...',
    streamingHint: 'Streaming with the selected key and model',
    stop: 'Stop',
    regenerate: 'Regenerate',
    clear: 'Clear chat',
    newChat: 'New chat',
    chatSettings: 'Chat settings',
    chatSettingsHint: 'Choose a key and text model to start chatting',
    history: 'Session history',
    loadingHistory: 'Loading session history...',
    noHistory: 'No session history yet. Sending your first message saves it automatically.',
    loadingMessages: 'Loading messages...',
    emptyTitle: 'Start a new conversation',
    empty: 'Your key and model are ready. Type a question or start from one of these prompts.',
    suggestions: 'Chat suggestions',
    suggestion1: 'Generate a bubble sort implementation in Java',
    suggestion2: 'Write an example for the OpenAI-compatible API',
    suggestion3: 'Explain what this model is best suited for',
    error: 'Chat request failed',
    user: 'You',
    assistant: 'Assistant',
    thinking: 'Thinking...',
    generatingReply: 'Generating response',
    emptyReply: 'No content was returned',
    copy: 'Copy',
    ...
    failed: 'Failed',
    duration: '{ms}ms',
    currentCost: 'This response ${cost}',
    currentCostPending: 'Cost is finalized in usage records',
    ready: 'Ready',
    notReady: 'Not ready',
    toolbarSelectKey: 'Select an available API key to start chatting',
    toolbarSelectModel: 'Select a model to start chatting',
    toolbarReady: '{key} · {model}',
  },
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. devrouter-backups), choose a region',
    ...
    accounts: {
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another DevRouter instance.',
    ...
    settings: {
      ...
      features: {
        ...
        chatCompletion: {
          title: 'Chat',
          description: 'Control whether the user-facing chat tool is shown. Users select their own platform API key to send requests.',
          enabled: 'Enable Chat',
          enabledHint: 'When enabled, users can select an existing grouped API key and start streaming chat conversations.',
        },
        riskControl: {
          title: 'Risk Control',
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for DevRouter end-user login',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to DevRouter',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">DevRouter is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of DevRouter, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to DevRouter',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the DevRouter AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
