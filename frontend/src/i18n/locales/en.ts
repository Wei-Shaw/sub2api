  ...
  admin: {
    ...
    settings: {
      ...
      openaiFastPolicy: {
        ...
        description: 'Intercept, filter, pass, or force OpenAI service_tier and optional reasoning effort before forwarding upstream. Applies to the OpenAI gateway only.',
        ...
        actionForceDefault: 'Force Default/Normal',
        actionForceFlex: 'Force Flex',
        scope: 'Scope',
        scopeAll: 'All accounts',
        scopeOAuth: 'OAuth only',
        scopeAPIKey: 'API Key only',
        scopeBedrock: 'Bedrock only',
        reasoningEffort: 'Reasoning effort',
        reasoningEffortNone: 'Do not force',
        endpoints: 'Endpoints',
        endpointsHint: 'Leave all unchecked to apply to every OpenAI endpoint.',
        endpointResponses: '/v1/responses',
        endpointChatCompletions: '/v1/chat/completions',
        endpointMessagesToResponses: '/v1/messages -> responses',
        endpointResponsesWebSocket: 'Responses WebSocket',
        accountIds: 'Account IDs',
        accountPoolIds: 'Account pool IDs',
        groupIds: 'Group IDs',
        idsPlaceholder: 'IDs separated by commas',
        errorMessage: 'Error message',
        errorMessagePlaceholder: 'Custom error message when blocked',
