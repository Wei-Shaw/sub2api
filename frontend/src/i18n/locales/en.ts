  ...
  admin: {
    ...
    accounts: {
      ...
      tempUnschedulable: {
        ...
        durationMinutesHint: 'Duration of temporary unschedulable state. Choose either this or "Reset at time".',
        resetAtTime: 'Reset at time',
        resetAtTimePlaceholder: 'Select time',
        resetAtTimeHint: 'Calculated in the server timezone. Current effective timezone: {timezone}. E.g., 00:00 means midnight in that timezone.',
        serverTimezoneUnknown: 'Unknown',
        resetAtMidnightShortcut: 'Next 00:00',
        resetAtTimeInvalid: 'Reset time must be between 00:00 and 23:59.',
        keywords: 'Keywords',
        ...
        rulesInvalid: 'Add at least one rule with error code, keywords, and duration or reset time.',
