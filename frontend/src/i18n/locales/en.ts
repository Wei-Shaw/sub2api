    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          accessTokenDesc: 'Enter OpenAI Access Token(s). The system validates them through ChatGPT wham/usage and reads plan/model quota before creating accounts.',
          accessTokenInputLabel: 'Access Token',
          accessTokenPlaceholder: 'Paste your OpenAI Access Token...\nSupports multiple, one per line',
          accessTokenHint: 'AT is validated through https://chatgpt.com/backend-api/wham/usage. 400/401 responses will be shown as invalid AT.',
          accessTokenImportAndCreate: 'Validate AT & Create Account',
          accessTokenEmpty: 'Please enter Access Token',
          accessTokenImportFailed: 'Save failed, invalid AT',
          accessTokenImportSuccess: 'AT import completed: created {created}, updated {updated}, skipped {skipped}',
          accessTokenImportPartial: 'AT partial success: created {created}, updated {updated}, skipped {skipped}, failed {failed}',
          codexSessionAuth: 'Codex JSON Batch Input',
