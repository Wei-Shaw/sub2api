  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_epusdtApiBaseHint: 'The public URL of your epusdt gateway (scheme + host, e.g. https://pay.example.com); no path needed. Must be a public HTTPS domain reachable by the buyer\'s browser.',
        field_epusdtTokenHint: 'Optional. Receiving token (e.g. usdt, usdc, trx). Leave empty to let the buyer choose on the epusdt cashier. If set, you must also set the receiving network.',
        field_epusdtNetworkHint: 'Optional. Receiving network (e.g. tron, ethereum, bsc, solana, polygon). Leave empty to let the buyer choose on the epusdt cashier. If set, you must also set the receiving token.',
