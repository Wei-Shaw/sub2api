  ...
  admin: {
    ...
    groups: {
      ...
      columns: {
        ...
        displayRateMultiplier: 'Display Rate Multiplier',
      ...
      displayRateMultiplierHint: 'Shown to users when they create API keys or view available channels. Actual usage is still billed with the rate multiplier.',
    ...
    accounts: {
      ...
      refreshingToken: 'Refreshing token for "{name}"...',
      noAccountsYet: 'No accounts yet',
      createFirstAccount: 'Create your first account to start using AI services.',
      tokenRefreshed: 'Token refreshed successfully',
      tokenRefreshedWithProjectWarning: 'Token refreshed, but project_id could not be fetched yet. The system will retry automatically.',
