export default {
  ...
  setup: {
    ...
    description: 'Configure your AI Bridge instance',
    database: {
  ...
  admin: {
    ...
    accounts: {
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another AI Bridge instance.',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for AI Bridge end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for AI Bridge end-user login',
