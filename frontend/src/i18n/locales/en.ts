export default {
  ...
  auth: {
    ...
    emailLocalPartPlaceholder: 'Enter email prefix',
    emailDomainSelectLabel: 'Select email domain',
    useCustomEmailDomain: 'Use another allowed domain',
    useListedEmailDomain: 'Choose from whitelisted domains',
    changeEmail: 'Change email',
    saveAndResendCode: 'Save and resend code',
