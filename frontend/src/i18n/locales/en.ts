  ...
  admin: {
    ...
    ops: {
      ...
      diagnosis: {
        ...
        // Latency diagnostics
        latencyCritical: 'Response latency critically high ({latencyREDACTEDms)',
        ...
        latencyHigh: 'Response latency elevated ({latencyREDACTEDms)',
        ...
        ttftHigh: 'Time to first byte elevated ({ttftREDACTEDms)',
