export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: 'Import will create new accounts/proxies. You can set shared groups, proxy, scheduling, and expiry options before importing; ensure existing data does not conflict.',
      ...
      dataImportSharedSettingsHint: 'These settings apply to every account in this import, so you do not need to edit paginated accounts afterward.',
      dataImportSchedulableOnHint: 'Imported accounts will join scheduling immediately. Confirm groups, proxy, and quota settings first.',
      dataImportSchedulableOffHint: 'Imported accounts will stay out of scheduling. You can filter by batch and enable them after review.',
      dataImportModelRestrictionHint: 'Apply one model whitelist to all imported accounts. When auto detection is enabled, imported accounts will sync upstream models after creation and overwrite this whitelist with the live supported models.',
      dataImportAutoDetectModelsOnHint: 'After import, each account will fetch upstream supported models and save them as its whitelist. Detection failures do not delete accounts; details appear in the import result.',
      dataImportAutoDetectModelsOffHint: 'The upstream model list will not be requested. Selected models below are saved as the whitelist; leave empty to avoid model restrictions.',
