export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: 'Import creates or reuses proxies first, then imports accounts into the selected groups. Enable inspection to skip accounts with missing credentials, expired timestamps, or invalid proxy references.',
      dataImportFile: 'Data file',
      dataImportButton: 'Start Import',
      dataImporting: 'Importing...',
      dataImportPreparing: 'Preparing import...',
      dataImportInspecting: 'Inspecting accounts...',
      dataImportInspectComplete: 'Inspection complete, waiting for confirmation',
      dataImportInspectToggle: 'Inspect accounts before import',
      dataImportInspectHint: 'Recommended for large imports. Accounts with invalid structure, missing credentials, expired timestamps, or missing proxy references will be skipped before import.',
      dataImportInspectFailed: 'Account inspection failed',
      dataImportNoHealthyAccounts: 'No healthy accounts to import after inspection',
      dataImportGroupTitle: 'Import group',
      dataImportGroupHint: 'Choose where healthy accounts should be imported. Leave empty to keep them ungrouped.',
      dataImportNewGroup: 'New group',
      dataImportNewGroupName: 'Group name',
      dataImportNewGroupNamePlaceholder: 'e.g. imported-openai',
      dataImportNewGroupPlatform: 'Platform',
      dataImportCreateGroupFailed: 'Failed to create group',
      dataImportProgressScanned: 'Scanned {count}',
      dataImportProgressHealthy: 'Healthy {count}',
      dataImportProgressSkipped: 'Skipped {count}',
      dataImportProgressAbnormal: 'Abnormal {count}',
      dataImportProgressImported: 'Imported {count}',
      ...
      dataImportImportedCount: 'Imported {count} accounts',
      dataImportConfirmImport: 'Import {count} healthy accounts',
      dataImportInspectLog: 'Inspection Log',
      dataImportInspectLogCount: '{count} items',
      dataImportInspectStatusNormal: 'Account healthy',
      dataImportInspectStatusError: 'Error',
