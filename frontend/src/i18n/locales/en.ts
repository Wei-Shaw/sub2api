  ...
  admin: {
    ...
    ops: {
      ...
      cluster: {
        ...
        help: 'Shows deployment instances, roles, heartbeat freshness, and background-job responsibility.',
        healthy: 'Healthy',
        unknown: 'Unknown',
        offline: 'Offline',
        noHeartbeats: 'No instance heartbeats received yet.',
        hoverForDetails: 'Hover to view instance details.',
        onlineInstances: 'Online instances',
        onlineMasters: 'Online masters',
        onlineSlaves: 'Online slaves',
        ...
        lastSeen: 'Last seen:',
        startedAt: 'Started at:',
        backgroundJobsOn: 'Background jobs: on',
        backgroundJobsOff: 'Background jobs: off'
      },
      active: 'active',
      idle: 'idle',
      waiting: 'waiting',
