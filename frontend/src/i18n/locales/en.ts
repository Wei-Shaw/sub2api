export default {
  ...
  auth: {
    ...
    forgotPasswordHint: 'Enter your email to get a verification code and set a new password.',
    sendResetLink: 'Send code',
    sendingResetLink: 'Sending...',
    sendResetLinkFailed: 'Failed to send code. Please try again.',
    resetEmailSent: 'Code Sent',
    resetEmailSentHint: 'If an account exists with this email, you will receive a 6-digit code shortly. Please check your inbox and spam folder.',
    enterResetCode: 'Enter code and reset password',
    changeEmail: 'Use another email',
    backToLogin: 'Back to Login',
    rememberedPassword: 'Remembered your password?',
    // Reset password
    resetPasswordTitle: 'Set New Password',
    resetPasswordHint: 'Enter your email code and new password below.',
    resetCodePlaceholder: 'Enter 6-digit code',
    resetCodeHint: 'The code is valid for 30 minutes and can only be used once.',
    verificationCodeRequired: 'Please enter the verification code',
    invalidVerificationCode: 'Please enter a 6-digit verification code',
  ...
  imageGeneration: {
    ...
    description: 'Choose one of your API keys and an available image model for text-to-image or image-to-image requests',
    apiKey: 'API Key',
    selectApiKey: 'Select API Key',
    model: 'Model',
    selectModel: 'Select model',
    modelSearchPlaceholder: 'Search key name or model',
    ...
    dropSourceImage: 'Click to upload or drop a source image',
    sourceImageHint: 'PNG, JPG, and WebP supported',
    removeSourceImage: 'Remove source image',
    prompt: 'Prompt',
    promptPlaceholder: 'Describe the subject, style, composition, and details you want...',
    editPromptPlaceholder: 'Describe what to change or generate from the source image...',
    generate: 'Generate Image',
    generating: 'Generating...',
    upscale: 'Upscale',
    upscaledResult: 'Upscaled Result',
    upscalePrompt: 'Upscale this image into a sharper, higher-definition version with richer detail. Preserve the original composition, subject, style, and colors. Do not add unrelated elements.',
    ...
    noKeysDescription: 'Image generation requires one of your active API keys.',
    createKey: 'Create API Key',
    groupDisabled: 'Image generation is not enabled for this API key group.',
    noModels: 'No image models or schedulable OpenAI image accounts are available for this API key group',
    noAvailableAccounts: 'No available OpenAI image account is assigned to this API key group. Bind a schedulable OpenAI account to the group first.',
    noImageReturned: 'The request completed, but no displayable image was returned.',
    imageLoadFailed: 'Failed to read the source image for upscaling.',
  ...
  textChat: {
    title: 'AI Chat',
    description: 'Choose one of your API keys and chat with available text models',
    selectApiKey: 'Select API Key',
    selectModel: 'Select model',
    modelSearchPlaceholder: 'Search key name or model',
    noMatchedModels: 'No matching models',
    ...
    systemPromptPlaceholder: 'Example: You are a concise, accurate assistant.',
    creativity: 'Creativity',
    clear: 'Clear Chat',
    empty: 'Ask a question to start chatting, or choose a sample prompt.',
    inputPlaceholder: 'Type a message. Enter to send, Shift + Enter for a new line. Drag or paste files supported',
    enterHint: 'Enter to send / Shift + Enter for a new line',
    send: 'Send',
    sending: 'Sending...',
    thinking: 'AI is thinking...',
    thinkingShort: 'AI is thinking',
    you: 'You',
    ...
    tooManyAttachments: 'You can upload up to {count} files.',
    fileTooLarge: 'File {name} exceeds the size limit. Max size is {size}.',
    fileReadFailed: 'Failed to read file {name}.',
    attachmentContextLabel: 'Attachment content',
    attachmentTruncated: 'The content below was too long and has been truncated.',
    imageAttachmentInstruction: 'Use this image attachment when answering',
    fileAttachmentInstruction: 'Parse this attachment if the selected model supports file input',
    noKeysTitle: 'No available API keys',
    noKeysDescription: 'AI chat requires one of your active API keys.',
    createKey: 'Create API Key',
    noModels: 'No chat models are available for this API key',
    emptyReply: 'The model returned no content.',
    loadKeysFailed: 'Failed to load API keys',
    loadModelsFailed: 'Failed to load chat models',
    sendFailed: 'Failed to send message',
    suggestionRewrite: 'Rewrite this paragraph to sound more natural and professional',
    suggestionSummary: 'Summarize the following content in three points',
    suggestionCaption: 'Write a short social media caption for me',
    suggestionExplain: 'Explain the main differences between PostgreSQL and MySQL'
  },
  ...
  admin: {
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "Reset the five-hour, weekly, and monthly usage quota for '{user}'? Usage will be zeroed and windows restarted from the current window.",
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
    ...
    redeem: {
      ...
      searchCodes: 'Search codes, email, or notes...',
      allTypes: 'All Types',
      allStatus: 'All Status',
      balance: 'Balance',
      concurrency: 'Concurrency',
      ...
      value: 'Value',
      notes: 'Notes',
      notesPlaceholder: 'e.g. Xianyu $100, customer A reissue, test subscription code',
      count: 'Count',
      generating: 'Generating...',
      generate: 'Generate',
      copyAll: 'Copy All',
  ...
  userSubscriptions: {
    ...
    daily: 'Daily quota',
    dailyDesc: 'Daily quota resets every 24 hours',
    remaining: 'Remaining',
  ...
  guide: {
    ...
    faq: {
      ...
      a6: 'For business cooperation, procurement or invoices, contact QQ 591719412 (Yinhe).',
    },
