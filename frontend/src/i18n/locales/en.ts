export default {
  ...
  llmTester: {
    ...
    modelCount: '{countREDACTED models fetched',
    lastFetched: 'Fetched {timeREDACTED',
    ...
    modelsFetched: 'Fetched {countREDACTED models',
    capabilities: {
      chat: 'Chat',
      vision: 'Vision chat',
    ...
    errors: {
      ...
      imageTooLarge: '{nameREDACTED is larger than the 5 MB image limit',
      textTooLarge: '{nameREDACTED is larger than the 240 KB text limit',
      fileReadFailed: 'Failed to read {nameREDACTED'
    REDACTED
  REDACTED,
