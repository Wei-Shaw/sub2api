export default {
  ...
  admin: {
    ...
    userPools: {
      ...
      description: 'Group users into pools and batch-grant group access',
      searchPools: 'Search user pools...',
      createPool: 'Create Pool',
      editPool: 'Edit Pool',
      deletePool: 'Delete Pool',
      deleteConfirm: "Are you sure you want to delete pool '{name}'? This action cannot be undone.",
      allStatus: 'All Status',
      columnSettings: 'Column Settings',
      columns: {
        name: 'Name',
      ...
      memberAddedAt: 'Joined At',
      selectUsersPlaceholder: 'Search user email...',
      groupGrants: 'Group Grants',
      groupGrantsTitle: 'Group Grant Management',
      addGrant: 'Add Grant',
      noGrants: 'No group grants yet',
      grantGroupId: 'Group',
      grantRateMultiplier: 'Rate Multiplier',
      grantRpmOverride: 'RPM Override',
      grantRateDefault: 'Inherit default',
      grantRpmDefault: 'Inherit default',
      grantRateHint: 'Leave empty to inherit group default rate',
      grantRpmHint: 'Leave empty to inherit group default RPM',
      ...
      failedToLoad: 'Failed to load pools',
      failedToCreate: 'Failed to create pool',
      failedToUpdate: 'Failed to update pool',
      failedToDelete: 'Failed to delete pool',
      ...
      failedToRemoveMembers: 'Failed to remove members',
      grantsSaved: 'Group grants saved successfully',
      grantDeleted: 'Group grant deleted successfully',
      failedToSaveGrants: 'Failed to save group grants',
      failedToDeleteGrant: 'Failed to delete group grant',
      noPoolsYet: 'No pools yet',
      createFirstPool: 'Create your first user pool to batch-manage user permissions.',
      detailPanel: 'Pool Details',
      basicInfo: 'Basic Info',
      saving: 'Saving...',
      creating: 'Creating...',
      selectUsers: 'Select Users',
      confirmRemove: 'Remove {count} member(s)?',
      noPools: 'No pools',
      selectGroup: 'Select group',
      noGroupsAvailable: 'No groups available',
      groupTypeSubscription: 'Subscription',
      groupTypeExclusive: 'Exclusive',
      addMembersHint: 'Enter user IDs, separated by comma or newline',
      addMembersModal: {
        title: 'Add Members',
        ...
        attrFilterLabel: 'Attribute Filters',
        selectAll: 'Select all on page',
        noResults: 'No users found',
        noResultsHint: 'Try adjusting your search criteria',
        selectedCount: '{count} selected',
        clearSelected: 'Clear',
        advancedInput: 'Enter IDs manually (advanced)',
        advancedInputPlaceholder: 'Enter user IDs, separated by comma or newline',
        advancedInputHint: 'Parsed IDs will be merged into the selection',
        mergeIds: 'Merge IDs',
        addNMembers: 'Add {count}',
        loading: 'Loading...',
        userEmail: 'Email',
        userId: 'ID',
        userGroups: 'Groups',
        moreGroups: '+{n} more',
        addMembersSuccess: 'Added {added}, skipped {skipped}',
        matchedCount: '{n} matched',
        addAllMatched: 'Add all {n} matched users',
        addAllMatchedConfirmTitle: 'Confirm bulk add',
        addAllMatchedConfirmBody: 'Add {n} matched users to Pool "{name}"?',
        addAllMatchedSuccess: 'Bulk add complete: {added} added, {skipped} already in pool, {matched} matched',
        addAllMatchedNoFilter: 'Set at least one filter before bulk-adding'
      }
    },
