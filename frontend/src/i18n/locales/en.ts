export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      userAgent: 'User-Agent',
      userAgentPlaceholder: 'Leave empty to use the default User-Agent',
      userAgentHint: 'OpenAI accounts only. When set, upstream requests use this User-Agent; leave empty to keep the default behavior.',
