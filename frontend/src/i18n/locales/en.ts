  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        providerIPayees: 'iPayees (bKash / Nagad)',
        ...
        field_ipayeesApiBaseHint: 'Your iPayees API base URL, e.g. https://yourgateway.com/api — the create-charge and verify-payments endpoints hang off this.',
        field_ipayeesContactHint: 'A real email or mobile you control. iPayees gateways that make email_mobile mandatory use this so charge creation does not fail. Shown to iPayees only, not to the buyer.',
