export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "Select the usage quota to reset for '{user}'. Selected usage will be zeroed and windows restarted from today.",
      resetQuotaDaily: 'Daily quota',
      resetQuotaWeekly: 'Weekly quota',
      resetQuotaMonthly: 'Monthly quota',
      resetQuotaSelectAtLeastOne: 'Select at least one quota window',
