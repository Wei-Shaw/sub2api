export default {
  ...
  support: {
    ...
    // Support chat widget (add-support-chat-widget D2)
    chat: {
  ...
  admin: {
    ...
    // Support Knowledge Base (add-support-knowledge-rag §12 §13)
    supportFaq: {
    ...
    settings: {
      ...
      // Support chat widget (add-support-chat-widget D2): dedicated tab.
      supportChat: {
        ...
        // change-support-chat-external-llm §6.9: external OpenAI-compatible upstream credentials + test-connection UI.
        // The legacy apiKeyIdLabel / apiKeyIdHint (pointing at the internal admin api_keys table) is replaced by base_url + api_key.
        llm: {
        ...
        rag: {
          ...
          // Crawl-now button + inline status (added on top of add-support-knowledge-rag):
      ...
      captcha: {
        ...
        tencentSecretId: 'API Key SecretId',
        ...
        tencentSecretKey: 'API Key SecretKey',
