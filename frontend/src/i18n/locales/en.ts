export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      thresholds: {
        title: 'Per-Category Score Thresholds',
        description: 'Requests whose category score meets or exceeds the threshold are flagged. Lower values catch more hits but may increase false positives.',
