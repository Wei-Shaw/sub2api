  ...
  admin: {
    ...
    accounts: {
      ...
      tempUnschedulable: {
        ...
        resetAtTimeHint: 'When set, the temp unschedulable state will be cleared at the next occurrence of this time. E.g., setting 00:00 means reset daily at midnight.',
        keywords: 'Keywords',
