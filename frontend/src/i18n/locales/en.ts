export default {
  ...
  modelList: {
    title: 'Model List',
    description: 'Browse mainstream models, context windows, and pricing',
    searchPlaceholder: 'Search model name, ID, features, or description',
    providerFilter: 'Filter by provider',
    providerAll: 'All providers',
    categoryLabel: 'Model category',
    unknownProvider: 'Other providers',
    loading: 'Loading model catalog...',
    loadFailed: 'Failed to load model catalog',
    empty: 'No matching models found',
    showingCount: 'Showing {shown} / {total} models',
    sourceUpdated: 'Updated at {time}',
    ...
    sort: {
      ...
      inputAsc: 'Input price low to high',
      outputAsc: 'Output price low to high',
      contextDesc: 'Context high to low'
    },
    pricing: {
      title: 'Pricing',
      billingPrefix: 'Billed by tokens:',
      input: 'Input',
      output: 'Output',
  ...
  imageGenerator: {
    ...
    subtitle: 'Select an API Key from the key list and generate images with gpt-image-2.',
    ...
    noKeysHint: 'No active API Key is available. Create an enabled key on the API Keys page first.',
    referenceImage: 'Reference image',
    uploadReference: 'Upload reference image',
    removeReference: 'Remove reference',
    prompt: 'Prompt',
    promptPlaceholder: 'Example: a white cat inside a glass greenhouse, morning mist, cinematic composition, ultra-realistic texture',
    size: 'Size',
    sizeRequirements: 'Size requirements',
    sizeSquare1K: '1K square · 1024 × 1024',
    sizeLandscape2K: '2K landscape · 1536 × 1024',
    sizePortrait2K: '2K portrait · 1024 × 1536',
    sizeSquare2K: '2K square · 2048 × 2048',
    sizeLandscape4K: '4K landscape · 3840 × 2160',
    sizePortrait4K: '4K portrait · 2160 × 3840',
    sizeCustom: 'Custom size',
    sizeSquare1KHint: 'Lightweight and fast for avatars, icons, and small social images.',
    sizeLandscape2KHint: 'Good for banners, covers, and landscape posters.',
    sizePortrait2KHint: 'Good for characters, vertical posters, and phone wallpapers.',
    sizeSquare2KHint: 'Good for detailed product shots, illustrations, and square compositions.',
    sizeLandscape4KHint: 'Good for wide hero images, website banners, and high-resolution posters.',
    sizePortrait4KHint: 'Good for high-resolution vertical posters, portraits, and mobile artwork.',
    sizeCustomHint: 'Enter a valid width and height. Billing tier is inferred from pixel count.',
    customWidth: 'Width',
    customHeight: 'Height',
    customSizeRequirementTitle: 'Custom size requirements',
    customSizeRequirementMaxSide: 'Maximum side <= 3840px',
    customSizeRequirementMultiple: 'Width and height must be multiples of 16',
    customSizeRequirementRatio: 'Long side / short side must not exceed 3:1',
    customSizeRequirementPixels: 'Total pixels must be between 655360 and 8294400',
    customSizeInvalidNumber: 'Enter valid width and height values',
    customSizeInvalidSide: 'Width and height must not exceed 3840px',
    customSizeInvalidMultiple: 'Width and height must be multiples of 16',
    customSizeInvalidRatio: 'Long side / short side must not exceed 3:1',
    customSizeInvalidPixels: 'Total pixels must be between 655360 and 8294400',
    quality: 'Quality',
    qualityOptions: {
      auto: 'Auto',
      low: 'Low',
    ...
    emptyTitle: 'New images will appear here',
    emptyDescription: 'Enter a prompt, or upload a reference image, then generate. Results appear directly in this workspace.',
    generatingTitle: 'Generating image',
    generatingHint: 'gpt-image-2 is processing the request. Image generation may take several seconds.',
  ...
  payment: {
    ...
    qr: {
      ...
      cashierTitle: 'Official Cashier',
      pendingStatus: 'Pending Payment',
      orderLabel: 'Order #{id}',
      qrCodeLabel: 'Scan with your phone to complete payment',
      securePayment: 'Payment details are encrypted. Confirm the amount before paying.',
      stepsTitle: 'Payment Steps',
      stepOpenApp: 'Open the {provider} app',
      stepScan: 'Scan the QR code and confirm the order details',
      stepConfirm: 'The page will confirm the payment automatically after success',
      autoConfirmHint: 'The system is checking the payment result in real time. Keep this page open.',
      expireWarning: 'Complete payment before the order expires. The QR code will become invalid after timeout.',
      redirectTitle: 'Waiting for payment completion',
      redirectDesc: 'Complete the payment in the opened payment page',
    },
    orders: {
      title: 'My Orders',
      empty: 'No orders yet',
    ...
    rechargeSupportTitle: 'If in-site recharge fails, add us on WeChat',
