export default {
  ...
  common: {
    ...
    justNow: 'just now',
    peakRateTooltip: 'Peak rate: {windowREDACTED',
  ...
  legal: {
    ...
    updatedAt: 'Updated: {dateREDACTED',
    empty: 'No content',
    ...
    loginAgreementPrompt: {
      ...
      dialogDescription: 'Our service terms were updated on {dateREDACTED. Please read and accept the following terms before continuing.',
      recently: 'recently',
  ...
  auth: {
    ...
    emailSuffixNotAllowedWithAllowed:
      'This email domain is not allowed. Allowed domains: {suffixesREDACTED',
    emailSuffixAllowedMore: 'and {countREDACTED more',
    ...
    resendCountdown: 'Resend code in {countdownREDACTEDs',
    ...
    promoCodeValid: 'Valid! You will receive ${amountREDACTED bonus balance',
    ...
    oidc: {
      ...
      callbackProcessing: 'Completing login with {providerNameREDACTED, please wait...',
      callbackHint: 'If you are not redirected automatically, go back to the login page and try again.',
      callbackMissingToken: 'Missing login token, please try again.',
      backToLogin: 'Back to Login',
      invitationRequired:
        'This {providerNameREDACTED account is not yet registered. The site requires an invitation code — please enter one to complete registration.',
    ...
    REDACTED,
    oauthFlow: {
      profileDetailsTitle: 'Use {providerNameREDACTED profile details',
      profileDetailsDescription: 'Choose whether to apply the nickname or avatar from {providerNameREDACTED to this account.',
      useDisplayName: 'Use display name',
      useAvatar: 'Use avatar',
      avatarAlt: '{providerNameREDACTED avatar',
      reviewProfileBeforeContinue: 'Review the {providerNameREDACTED profile details before continuing.',
      ...
      suggestedEmail: 'Suggested email: {emailREDACTED',
      ...
      bindLoginHint: 'Log in to an existing account to bind this {providerNameREDACTED sign-in.',
      signInThenBindDescription: 'Sign in to an existing account, then bind this {providerNameREDACTED sign-in to it.',
      bindSignInToExistingAccount: 'Bind this {providerNameREDACTED sign-in to an existing account.',
      bindCurrentAccountTitle: 'Bind the current account',
      bindCurrentAccountDescription: 'Bind this {providerNameREDACTED sign-in to the account currently signed in on this browser.',
      bindCurrentAccount: 'Bind current account',
      logInAndBind: 'Log in and bind',
      useDifferentEmail: 'Use a different email',
      backToOptions: 'Back to options',
      yourAccount: 'your account',
      totpHint: 'Enter the 6-digit verification code for {accountREDACTED to finish binding this {providerNameREDACTED sign-in.',
  ...
  dashboard: {
    ...
    platformCount: '{countREDACTED platforms',
    platformOther: 'Other',
    platformQuota: {
      title: 'Quota Usage',
      daily: 'Daily',
  ...
  keys: {
    ...
    resetQuotaConfirmMessage: 'Are you sure you want to reset the used quota (${usedREDACTED) for key "{nameREDACTED" to 0? This action cannot be undone.',
    ...
    resetRateLimitConfirmMessage: 'Are you sure you want to reset the rate limit usage for key "{nameREDACTED"? All time window usage will be reset to zero. This action cannot be undone.',
    rateLimitResetSuccess: 'Rate limit usage reset successfully',
    failedToResetRateLimit: 'Failed to reset rate limit usage',
    resetNow: 'Resetting soon',
    expiration: 'Expiration',
    expiresInDays: '{daysREDACTED days',
    extendDays: '+{daysREDACTED days',
    customDate: 'Custom',
  ...
  usage: {
    ...
    ipGeo: {
      ...
      pending: '{countREDACTED IPs pending',
    ...
    REDACTED,
    tabs: { usage: 'Usage', errors: 'Error Requests' REDACTED,
    errors: {
  ...
  monitorCommon: {
    ...
    history60pts: 'HISTORY ({nREDACTED PTS)',
    nextUpdateIn: 'NEXT UPDATE IN {nREDACTEDs',
    past: 'PAST',
    now: 'NOW',
    maintenancePaused: 'Maintenance · timeline paused',
    extraModelsCount: '+ {nREDACTED models',
    pollEvery: '{nREDACTEDs polling',
    updatedAt: 'Updated {timeREDACTED',
    relativeSecondsAgo: '{nREDACTEDs ago',
    relativeMinutesAgo: '{nREDACTEDm ago',
    relativeHoursAgo: '{nREDACTEDh ago',
    relativeDaysAgo: '{nREDACTEDd ago'
  REDACTED,
  ...
  affiliate: {
    ...
    transfer: {
      ...
      success: '{amountREDACTED has been transferred to your balance'
    REDACTED,
    invitees: {
      title: 'Invited Users',
    ...
    tips: {
      ...
      line2: 'When invitees recharge, you receive {rateREDACTED of the recharge as rebate quota.',
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      codeSentTo: 'Code sent to {emailREDACTED',
    ...
    authBindings: {
      ...
      bindAction: 'Bind {providerNameREDACTED',
      ...
      unbindAction: 'Unbind',
      unbindSuccess: '{providerNameREDACTED unbound',
      boundCount: '{countREDACTED linked records',
      status: {
        bound: 'Bound',
        notBound: 'Not bound',
      REDACTED,
      ...
      REDACTED,
      source: {
        avatar: 'Avatar is currently synced from {providerNameREDACTED',
        username: 'Nickname is currently synced from {providerNameREDACTED',
      REDACTED,
    REDACTED
  REDACTED,
  ...
  admin: {
    ...
    dataManagement: {
      ...
      sourceProfiles: {
        ...
        deleteConfirm: 'Delete source profile {profileIDREDACTED?',
        columns: {
          profile: 'Profile',
          active: 'Active',
      ...
      s3Profiles: {
        ...
        deleteConfirm: 'Delete S3 profile {profileIDREDACTED?',
        columns: {
          profile: 'Profile',
          active: 'Active',
          storage: 'Storage',
      ...
      actions: {
        ...
        jobCreated: 'Backup job created: {jobIDREDACTED ({statusREDACTED)',
    ...
    users: {
      ...
      publicGroupCount: '+{countREDACTED public',
      ...
      groupChangedWithGrant: 'Group updated. User auto-granted access to "{groupREDACTED"',
      ...
      groupConfigHint: 'Configure custom rate multipliers for user {emailREDACTED (overrides group defaults)',
      ...
      replaceGroupHint: 'Select a new group to replace "{oldREDACTED". Keys will be migrated and permissions updated automatically.',
      replaceGroupConfirm: 'Confirm Replace',
      replaceGroupSuccess: 'Group replaced successfully, {countREDACTED key(s) migrated',
      ...
      platformQuota: {
        ...
        subtitle: 'Configure daily / weekly / monthly USD usage limits for each upstream platform for user {emailREDACTED',
        columns: {
          platform: 'Platform',
          daily: 'Daily (USD)',
          weekly: 'Weekly (USD)',
        ...
        reset: {
          button: 'Reset window',
          confirm: 'Reset the {windowREDACTED usage for {platformREDACTED for this user? This is effective immediately.',
          success: 'Reset {platformREDACTED {windowREDACTED usage',
          failed: 'Reset failed',
        REDACTED,
        ...
        invalidNumber: 'The following fields contain invalid numbers. Please fix them before saving: {fieldsREDACTED',
      REDACTED
    REDACTED,
    ...
    groups: {
      ...
      modelsList: {
        ...
        selectedSummary: 'Selected {selectedREDACTED / {totalREDACTED',
        selectAll: 'Select all',
    ...
    channels: {
      ...
      intervalValidation: {
        negativeMin: 'Interval #{indexREDACTED: minimum token count ({valueREDACTED) cannot be negative',
        maxPositive: 'Interval #{indexREDACTED: maximum token count ({valueREDACTED) must be greater than 0',
        maxGreaterThanMin: 'Interval #{indexREDACTED: maximum token count ({maxREDACTED) must be greater than minimum token count ({minREDACTED)',
        negativePrice: 'Interval #{indexREDACTED: {fieldREDACTED cannot be negative',
        unboundedLast: 'Interval #{indexREDACTED: an unbounded interval (empty maximum token count) must be last',
        overlap: 'Intervals #{previousIndexREDACTED and #{currentIndexREDACTED overlap: previous upper bound ({previousMaxREDACTED) is greater than current lower bound ({currentMinREDACTED)',
        price: {
      ...
      form: {
        ...
        noGroupsAvailable: 'No groups available',
        inOtherChannel: 'In "{nameREDACTED"',
        ...
        ruleModelPricing: 'Model Pricing',
         ...
         syncModelsSuccess: 'Synced {countREDACTED new model(s)',
    ...
    riskControl: {
      ...
      apiKeyCount: '{countREDACTED keys',
      ...
      apiKeysHint: '{countREDACTED keys are currently stored. This input only adds keys; save appends and de-duplicates them.',
      ...
      apiKeyPendingDeleteCount: '{countREDACTED keys pending deletion',
      deleteApiKey: 'Delete this key',
      undoDeleteApiKey: 'Undo delete',
      inputApiKeyCount: '{countREDACTED keys in input',
      storedApiKeyCount: '{countREDACTED stored keys',
      ...
      apiKeyTestDone: 'Key test completed for {countREDACTED keys',
      ...
      apiKeyRows: '{countREDACTED keys',
      apiKeyRowsCollapsed: '{countREDACTED keys hidden',
      apiKeyRowsExpanded: 'Showing all {countREDACTED keys',
      ...
      apiKeyFailureCount: '{countREDACTED failures',
      apiKeyLatency: '{msREDACTED ms',
      apiKeyHTTPStatus: 'HTTP {statusREDACTED',
      apiKeyFrozenUntil: 'Frozen until {timeREDACTED',
      apiKeyLastChecked: 'Checked at {timeREDACTED',
      ...
      auditTestImageLimit: 'You can add up to {countREDACTED test images',
      ...
      auditTestHighest: 'Top category {categoryREDACTED, score {scoreREDACTED',
      ...
      flaggedHashCount: 'Current hash collection size: {countREDACTED',
      ...
      flaggedHashesCleared: 'Cleared {countREDACTED risk hashes',
      ...
      violationCount: '{countREDACTED hits',
      ...
      queueDelay: 'Queued {msREDACTED ms',
      allGroups: 'All Groups',
      ...
      modelFilterModelCount: '{countREDACTED models configured',
      modelFilterModelsRequired: 'This model scope requires at least 1 model',
      modelFilterAllSummary: 'Applies to all models',
      modelFilterIncludeSummary: 'Applies to {countREDACTED models',
      modelFilterExcludeSummary: 'Excludes {countREDACTED models',
      ...
      preBlockAPIKeyLoadSummary: 'Sync active {activeREDACTED / usable keys {availableREDACTED, {totalREDACTED total, worker: {workerActiveREDACTED / {workerTotalREDACTED',
      preBlockAPIKeyTotals: 'Total {totalREDACTED, success {successREDACTED, errors {errorsREDACTED',
      ...
      workerPoolMeta: '{activeREDACTED processing, {idleREDACTED idle and ready, {totalREDACTED total',
      ...
      lastCleanup: 'Last cleanup: {timeREDACTED',
      cleanupStats: 'Last cleanup deleted {hitREDACTED hits and {nonHitREDACTED non-hits',
      ...
      riskThresholdDefault: 'Default {valueREDACTED',
      ...
      blockedKeywordsModeWarning: 'Current mode is "{modeREDACTED". Keyword blocking will not run until you switch to "Pre-block" mode.',
      blockedKeywordCount: '{countREDACTED keywords configured',
      blockedKeywordsLimit: 'Up to {maxREDACTED keywords, each no longer than 200 characters. Duplicates are removed automatically.',
    ...
    channelMonitor: {
      ...
      deleteConfirm: 'Are you sure you want to delete monitor "{nameREDACTED"? This action cannot be undone.',
      ...
      advanced: {
        ...
        headerNameInvalid: 'Header name cannot contain whitespace or colon: {nameREDACTED',
        headersHint: 'Merged on top of adapter defaults (user wins). Hop-by-hop headers (Host / Content-Length / ...) are ignored.',
        headersParseError: 'Cannot parse line: {lineREDACTED',
      ...
      template: {
        ...
        applyConfirm: 'Apply',
        applyConfirmMessage: 'Overwrite {nREDACTED associated monitor(s) with the current configuration of "{nameREDACTED"? Any local customizations on those monitors will be discarded.',
        applySuccess: 'Applied to {nREDACTED monitor(s)',
        applyPickerTitle: 'Apply template "{nameREDACTED"',
        ...
        applyPickerConfirm: 'Apply to {nREDACTED monitor(s)',
        selectNone: 'Select none',
        selectedCount: 'Selected {nREDACTED / {totalREDACTED',
        deleteConfirm: 'Delete template "{nameREDACTED"? {nREDACTED associated monitor(s) will be disassociated but keep their current snapshot and continue running.',
        associatedCount: '{nREDACTED associated monitor(s)',
        headersSummary: '{nREDACTED custom header(s)',
        form: {
          name: 'Template name',
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "Reset the daily, weekly, and monthly usage quota for '{userREDACTED'? Usage will be zeroed and windows restarted from today.",
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
      ...
      revokeConfirm:
        "Are you sure you want to revoke the subscription for '{userREDACTED'? You can restore it later from the revoked list.",
      restoreConfirm:
        "Restore the subscription for '{userREDACTED'? If the original subscription has expired, it will be restored as expired.",
      guide: {
    ...
    accounts: {
      ...
      autoRefreshCountdown: 'Auto refresh: {secondsREDACTEDs',
      ...
      dataExportedSkippedShadows: 'Data exported. Skipped {countREDACTED spark shadow account(s): their scheduling config is not included in the backup; recreate and re-tune them after restore.',
      ...
      dataImportParseFailedFile: 'Failed to parse {nameREDACTED',
      dataImportInvalidFile: '{nameREDACTED is not a supported data export file',
      dataImportIgnoredFiles: 'Ignored {countREDACTED non-JSON file(s)',
      dataImportFailed: 'Data import failed',
      dataImportResult: 'Import Result',
      dataImportResultSummary: 'Proxies created {proxy_createdREDACTED, reused {proxy_reusedREDACTED, failed {proxy_failedREDACTED; Accounts created {account_createdREDACTED, failed {account_failedREDACTED',
      dataImportErrors: 'Error Details',
      dataImportSuccess: 'Import completed: accounts {account_createdREDACTED, failed {account_failedREDACTED',
      dataImportCompletedWithErrors: 'Import completed with errors: account failed {account_failedREDACTED, proxy failed {proxy_failedREDACTED',
      ...
      syncCompleted: 'Sync completed: created {createdREDACTED, updated {updatedREDACTED, skipped {skippedREDACTED',
      syncCompletedWithErrors:
        'Sync completed with errors: failed {failedREDACTED (created {createdREDACTED, updated {updatedREDACTED, skipped {skippedREDACTED)',
      ...
      crsWillUpdate: 'Will update {countREDACTED existing accounts.',
      crsSelectedCount: '{countREDACTED new accounts selected',
      ...
      groupCountTotal: '{countREDACTED groups total',
      platforms: {
        anthropic: 'Anthropic',
        claude: 'Claude',
        openai: 'OpenAI',
      ...
      status: {
        ...
        creditsExhaustedUntil: 'AI Credits exhausted, expected recovery at {timeREDACTED',
      ...
      quotaDailyLimitHintFixed: 'Resets daily at {hourREDACTED:00 ({timezoneREDACTED).',
      quotaWeeklyLimitHintFixed: 'Resets every {dayREDACTED at {hourREDACTED:00 ({timezoneREDACTED).',
      dayOfWeek: {
        monday: 'Monday',
        tuesday: 'Tuesday',
        wednesday: 'Wednesday',
      ...
      bulkSchedulablePartial: 'Scheduling updated partially: {successREDACTED succeeded, {failedREDACTED failed',
      ...
      bulkActions: {
        ...
        refreshToken: 'Refresh Token',
        resetStatusSuccess: 'Successfully reset {countREDACTED account(s) status',
        refreshTokenSuccess: 'Successfully refreshed {countREDACTED account(s) token',
        partialSuccess: 'Partially completed: {successREDACTED succeeded, {failedREDACTED failed'
      REDACTED,
      bulkEdit: {
        ...
        mixedPlatformWarning: 'Selected accounts span multiple platforms ({platformsREDACTED). Model mapping presets shown are combined — ensure mappings are appropriate for each platform.'
      REDACTED,
      ...
      fallbackActiveTip: 'Origin proxy {originREDACTED expired',
      ...
      createSparkShadowConfirm: 'Create a spark shadow account linked to "{nameREDACTED"? It shares the parent\'s credentials and serves only spark models.',
      ...
      syncUpstreamModelsSuccess: 'Synced {countREDACTED new model(s) from upstream ({totalREDACTED upstream total)',
      syncUpstreamModelsNoChanges: 'All {countREDACTED upstream model(s) are already in the whitelist',
      syncUpstreamModelsEmpty: 'Upstream returned no models to sync',
      syncUpstreamModelsFailed: 'Failed to sync upstream models',
      syncUpstreamModelsError: 'Failed to sync upstream models: {messageREDACTED',
      ...
      poolModeRetryCountHint:
        'Only applies in pool mode. Use 0 to disable in-place retry. Default {defaultREDACTED, maximum {maxREDACTED.',
      poolModeRetryStatusCodes: 'Retry Status Codes',
      poolModeRetryStatusCodesHint:
        'Comma-separated HTTP status codes (100-599) that trigger same-account retry in pool mode. Leave blank to use defaults ({defaultREDACTED).',
      ...
      affinityClients: '{countREDACTED affinity clients:',
      ...
      mixedChannelWarning: 'Warning: Group "{groupNameREDACTED" contains both {currentPlatformREDACTED and {otherPlatformREDACTED accounts. Mixing different channels may cause thinking block signature validation issues, which will fallback to non-thinking mode. Are you sure you want to continue?',
      ...
      oauth: {
        ...
        batchSuccess: 'Successfully created {countREDACTED account(s)',
        batchPartialSuccess: 'Partial success: {successREDACTED succeeded, {failedREDACTED failed',
        ...
        openai: {
          ...
          codexSessionImportSuccess: 'Import completed: created {createdREDACTED, updated {updatedREDACTED, skipped {skippedREDACTED',
          codexSessionImportPartial: 'Partial success: created {createdREDACTED, updated {updatedREDACTED, skipped {skippedREDACTED, failed {failedREDACTED',
        ...
        antigravity: {
          ...
          authCodePlaceholder:
            'Option 1: Copy the complete URL\n(http://localhost:xxx/auth/callback?code=...)\nOption 2: Copy only the code parameter value',
                    ...
                    failedToValidateRT: 'Failed to validate Refresh Token'
                  REDACTED
                REDACTED,      // Gemini specific (platform-wide)
      gemini: {
        helpButton: 'Help',
        helpDialog: {
      ...
      imageReceived: 'Received test image #{countREDACTED',
      // Stats Modal
      ...
      openaiQuotaReset: {
        ...
        expiresAt: 'Expires {timeREDACTED',
        expiresAtFull: 'Reset credit expires at {timeREDACTED',
        expandExpirations: 'Expand the other {countREDACTED reset credit expiration(s)',
    ...
    proxies: {
      ...
      dataImportResult: 'Import Result',
      dataImportResultSummary: 'Created {proxy_createdREDACTED, reused {proxy_reusedREDACTED, failed {proxy_failedREDACTED',
      dataImportErrors: 'Failure Details',
      dataImportSuccess: 'Import completed: created {proxy_createdREDACTED, reused {proxy_reusedREDACTED',
      dataImportCompletedWithErrors: 'Import completed with errors: failed {proxy_failedREDACTED',
      dataExport: 'Export',
      ...
      batchTestDone: 'Batch test completed for {countREDACTED proxies',
      batchTestFailed: 'Batch test failed',
      batchDeleteAction: 'Delete',
      batchDelete: 'Batch delete',
      batchDeleteConfirm: 'Delete {countREDACTED selected proxies? In-use ones will be skipped.',
      batchDeleteDone: 'Deleted {deletedREDACTED proxies, skipped {skippedREDACTED',
      batchDeleteSkipped: 'Skipped {skippedREDACTED proxies',
      ...
      qualityCheckDone: 'Quality check completed: score {scoreREDACTED ({gradeREDACTED)',
      qualityCheckFailed: 'Failed to run proxy quality check',
      batchQualityDone:
        'Batch quality check completed for {countREDACTED proxies: healthy {healthyREDACTED, warn {warnREDACTED, challenge {challengeREDACTED, abnormal {failedREDACTED',
      ...
      qualityGrade: 'Grade {gradeREDACTED',
      ...
      neverExpires: 'Never',
      expired: 'Expired',
      overdueDays: 'Overdue {daysREDACTEDd',
      expiringInDays: 'Expires in {daysREDACTEDd',
      remainingDays: '{daysREDACTEDd left',
      expiresAt: 'Validity',
      nDays: '{daysREDACTEDd',
    ...
    redeem: {
      ...
      expiryPresetDays: '{daysREDACTED days',
      customExpiry: 'Custom',
    ...
    announcements: {
      ...
      targetingSummaryCustom: 'Custom ({groupsREDACTED groups)',
    ...
    ops: {
      ...
      loadingText: 'loading',
      ready: 'ready',
      autoRefreshRemaining: 'Remaining {secondsREDACTEDs',
      systemLogs: {
        title: 'System Logs',
        ...
        cleanupSuccess: 'Cleanup complete. Deleted {countREDACTED log entries.',
      ...
      openaiTokenStats: {
        ...
        prevPage: 'Previous',
        nextPage: 'Next',
        pageInfo: 'Page {pageREDACTED/{totalREDACTED',
        totalModels: 'Total models: {totalREDACTED',
      ...
      diagnosis: {
        ...
        cpuCritical: 'CPU usage critically high ({usageREDACTED%)',
        ...
        upstreamCritical: 'Upstream error rate critically high ({rateREDACTED%)',
        ...
        upstreamHigh: 'Upstream error rate elevated ({rateREDACTED%)',
        ...
        // SLA diagnostics
        slaCritical: 'SLA critically below target ({slaREDACTED%)',
        ...
        slaLow: 'SLA below target ({slaREDACTED%)',
        ...
        healthCritical: 'Overall health score critically low ({scoreREDACTED)',
        ...
        healthLow: 'Overall health score low ({scoreREDACTED)',
      ...
      requestDetails: {
        ...
        details: 'Details',
        rangeLabel: 'Window: {rangeREDACTED',
        rangeMinutes: '{nREDACTED minutes',
        rangeHours: '{nREDACTED hours',
      ...
      alertRules: {
        ...
        REDACTED,
        hints: {
          recommended: 'Recommended: operator {operatorREDACTED, threshold {thresholdREDACTED{unitREDACTED',
      ...
      runtime: {
        ...
        validation: {
          ...
          lockKeyPrefix: 'Distributed lock key must start with "{prefixREDACTED"',
          lockKeyHint: 'Recommended: start with "{prefixREDACTED" to avoid conflicts',
      ...
      realtime: {
        ...
        reconnectIn: 'retry in {secondsREDACTEDs'
      REDACTED,
      queryMode: {
        auto: 'Auto',
        raw: 'Raw',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          REDACTED,
          batchModal: {
            title: 'Batch Set Rate ({countREDACTED users selected)',
      ...
      registration: {
        ...
        emailSuffixWhitelistHint:
          "Only email addresses from the specified domains can register (for example, {'@'REDACTEDqq.com, {'@'REDACTEDgmail.com, *.edu.cn)",
        emailSuffixWhitelistPlaceholder: "{'@'REDACTEDexample.com, *.edu.cn",
      ...
      defaults: {
        ...
        defaultSubscriptionsDuplicate:
          'Duplicate subscription group: {groupIdREDACTED. Each group can only appear once.',
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptBlocksPlaceholder: 'Leave empty to use the built-in 3 blocks. Supports an array or {"blocks": [...]REDACTED.',
        claudeOAuthSystemPromptBlocksHint: 'Each block is saved as JSON with enabled, type, text, and optional cache_control. {billing_headerREDACTED stays dynamic per request; the Claude Code identity and expansion prompts can be edited directly or restored from presets.',
        systemBlockTitle: 'System Block {indexREDACTED',
      ...
      site: {
        ...
        tableDefaultPageSizeRangeError: 'Default rows per page must be between {minREDACTED and {maxREDACTED',
        tablePageSizeOptionsFormatError: 'Invalid options format. Enter comma-separated integers between {minREDACTED and {maxREDACTED',
        customEndpoints: {
          title: 'Custom Endpoints',
          description: 'Add additional API endpoint URLs for users to quickly copy on the API Keys page',
          itemLabel: 'Endpoint #{nREDACTED',
          name: 'Name',
      ...
      payment: {
        ...
        balanceRechargePreview: 'Preview: 1 CNY = {usdREDACTED USD',
        ...
        rechargeFeePreview: 'Preview: Recharge 100, fee {feeREDACTED',
        ...
        validationFieldRequired: '{fieldREDACTED is required',
        ...
        stripeWebhookApiVersionHint: 'Set this Webhook endpoint API version to match the integrated Stripe SDK. Recommended: {versionREDACTED. A mismatch can cause webhook parsing errors.',
        ...
        enableConflict: '{methodREDACTED already has an enabled provider instance: {providerREDACTED. Disable the existing instance before switching.',
      REDACTED,
      balanceNotify: {
        title: 'Balance Low Notification',
      ...
      soraS3: {
        ...
        deleteConfirm: 'Delete storage profile {profileIDREDACTED?',
        columns: {
          profile: 'Profile',
          profileId: 'Profile ID',
          name: 'Name',
      ...
      paymentVisibleMethods: {
        methodLabel: '{titleREDACTED visible method',
        ...
        sourceRequiredError: 'Select a payment source before enabling {titleREDACTED.'
      REDACTED,
      openaiExperimentalScheduler: {
        ...
        defaultPlaceholder: 'config/default: {valueREDACTED',
        topKLabel: 'TopK',
    ...
    errorPassthrough: {
      ...
      deleteConfirm: 'Are you sure you want to delete rule "{nameREDACTED"?',
    ...
    tlsFingerprintProfiles: {
      ...
      deleteConfirmMessage: 'Are you sure you want to delete profile "{nameREDACTED"? Accounts using this profile will fall back to the built-in default.',
  ...
  announcements: {
    ...
    newCount: '{countREDACTED new announcement | {countREDACTED new announcements',
    readAt: 'Read at',
    read: 'Read',
    unread: 'Unread',
    startsAt: 'Starts at',
  ...
  payment: {
    ...
    REDACTED,
    currentBalance: 'Current Balance',
    groupFallback: 'Group #{idREDACTED',
    ...
    amountTooLow: 'Minimum amount is {minREDACTED',
    amountTooHigh: 'Maximum amount is {maxREDACTED',
    amountNoMethod: 'No payment method available for this amount',
    rechargeRatePreview: 'Current rate: 1 CNY = {usdREDACTED USD',
    ...
    errors: {
      tooManyPending: 'Too many pending orders (max {maxREDACTED). Please complete or cancel existing orders first.',
      ...
      TOO_MANY_PENDING: 'Too many pending orders (max {maxREDACTED). Please complete or cancel existing orders first.',
      DAILY_LIMIT_EXCEEDED: 'Daily recharge limit reached. Remaining: {remainingREDACTED.',
      ...
      WXPAY_CONFIG_MISSING_KEY: 'WeChat Pay config missing required key: {keyREDACTED.',
      WXPAY_CONFIG_INVALID_KEY_LENGTH: 'WeChat Pay {keyREDACTED length is invalid (expected {expectedREDACTED bytes, got {actualREDACTED).',
      WXPAY_CONFIG_INVALID_KEY: 'WeChat Pay {keyREDACTED is malformed. Make sure you copied the full PEM content.',
    ...
    admin: {
      ...
      price: 'Price',
      subscriptionCnyPayPreview: 'CNY channel charge preview: {amountREDACTED',
      subscriptionCnyPayPreviewWithFee: '({feeRateREDACTED% fee included: {totalREDACTED)',
      validityDays: 'Validity (days)',
