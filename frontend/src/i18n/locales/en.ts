export default {
  ...
  common: {
    ...
    contactSupport: 'Contact Support',
        ...
        saving: 'Saving...', 
        selectedCount: '({countREDACTED selected)',    refresh: 'Refresh',
    notAvailable: 'N/A',
    now: 'Now',
    unknown: 'Unknown',
    time: {
  ...
  auth: {
    ...
    signUpToStart: 'Sign up to start using {siteNameREDACTED',
    signUp: 'Sign up',
    ...
    accountCreatedSuccess: 'Account created successfully! Welcome to {siteNameREDACTED.',
  ...
  keys: {
    ...
    deleteConfirmMessage: "Are you sure you want to delete '{nameREDACTED'? This action cannot be undone.",
    apiKey: 'API Key',
    group: 'Group',
    noGroup: 'No group',
    created: 'Created',
  ...
  usage: {
    ...
    exportedCount: 'Exported {currentREDACTED/{totalREDACTED records',
    estimatedTime: 'Estimated time remaining: {timeREDACTED',
  ...
  redeem: {
    ...
    subscriptionAssignedDesc: 'You have been granted access to {groupNameREDACTED',
    subscriptionDays: '{daysREDACTED days',
    days: ' days',
  ...
  pagination: {
    ...
    results: 'results',
    page: 'Page',
    pageOf: 'Page {pageREDACTED of {totalREDACTED',
    previous: 'Previous',
    next: 'Next',
    perPage: 'Per page',
  ...
  admin: {
    ...
    users: {
      ...
      deleteConfirm: "Are you sure you want to delete '{emailREDACTED'? This action cannot be undone.",
      ...
      attributes: {
        ...
        deleteConfirm: "Are you sure you want to delete attribute '{nameREDACTED'? All user values for this attribute will be deleted.",
    ...
    groups: {
      ...
      REDACTED,
      rateAndAccounts: '{rateREDACTEDx rate · {countREDACTED accounts',
      accountsCount: '{countREDACTED accounts',
      form: {
        name: 'Name',
      ...
      REDACTED,
      deleteConfirm:
        "Are you sure you want to delete '{nameREDACTED'? All associated API keys will no longer belong to any group.",
      deleteConfirmSubscription:
        "Are you sure you want to delete subscription group '{nameREDACTED'? This will invalidate all API keys bound to this subscription and delete all related subscription records. This action cannot be undone.",
      subscription: {
    ...
    subscriptions: {
      ...
      revokeConfirm:
        "Are you sure you want to revoke the subscription for '{userREDACTED'? This action cannot be undone."
    REDACTED,
    ...
    accounts: {
      ...
      syncResultSummary: 'Created {createdREDACTED, updated {updatedREDACTED, skipped {skippedREDACTED, failed {failedREDACTED',
      syncErrors: 'Errors / Skipped Details',
      syncCompleted: 'Sync completed: created {createdREDACTED, updated {updatedREDACTED',
      syncCompletedWithErrors:
        'Sync completed with errors: failed {failedREDACTED (created {createdREDACTED, updated {updatedREDACTED)',
      ...
      tempUnschedulable: {
        ...
        expired: 'Expired',
        remainingMinutes: 'About {minutesREDACTED minutes',
        remainingHours: 'About {hoursREDACTED hours',
        remainingHoursMinutes: 'About {hoursREDACTED hours {minutesREDACTED minutes',
        presets: {
      ...
      bulkEdit: {
        ...
        selectionInfo:
          '{countREDACTED account(s) selected. Only checked or filled fields will be updated; others stay unchanged.',
        ...
        updating: 'Updating...',
        success: 'Updated {countREDACTED account(s)',
        partialSuccess: 'Partially updated: {successREDACTED succeeded, {failedREDACTED failed',
      ...
      bulkDeleteConfirm: 'Delete the selected {countREDACTED account(s)? This action cannot be undone.',
      bulkDeleteSuccess: 'Deleted {countREDACTED account(s)',
      bulkDeletePartial: 'Partially deleted: {successREDACTED succeeded, {failedREDACTED failed',
      ...
      deleteConfirm: "Are you sure you want to delete '{nameREDACTED'? This action cannot be undone.",
      ...
      selectedModels: 'Selected {countREDACTED model(s)',
      supportsAllModels: '(supports all models)',
      requestModel: 'Request model',
      actualModel: 'Actual model',
      addMapping: 'Add Mapping',
      mappingExists: 'Mapping for {modelREDACTED already exists',
      ...
      modelCount: '{countREDACTED models',
      ...
      oauth: {
        ...
        keysCount: '{countREDACTED keys',
        batchCreateAccounts: 'Will batch create {countREDACTED accounts',
        ...
        keyAuthFailed: 'Key {indexREDACTED: {errorREDACTED',
        successCreated: 'Successfully created {countREDACTED account(s)',
        // OpenAI specific
        openai: {
      ...
      usingModel: 'Using model: {modelREDACTED',
      ...
      startingTestForAccount: 'Starting test for account: {nameREDACTED',
      testAccountTypeLabel: 'Account type: {typeREDACTED',
      ...
      stats: {
        ...
        basedOnActualDays: 'Based on {daysREDACTED actual usage days',
    ...
    proxies: {
      ...
      batchInputPlaceholder:
        "Enter one proxy per line in the following formats:\nsocks5://user:pass{'@'REDACTED192.168.1.1:1080\nhttp://192.168.1.1:8080\nhttps://user:pass{'@'REDACTEDproxy.example.com:443",
      batchInputHint:
        "Supports http, https, socks5 protocols. Format: protocol://[user:pass{'@'REDACTED]host:port",
      parsedCount: '{countREDACTED valid',
      invalidCount: '{countREDACTED invalid',
      duplicateCount: '{countREDACTED duplicate',
      importing: 'Importing...',
      importProxies: 'Import {countREDACTED proxies',
      batchImportSuccess: 'Successfully imported {createdREDACTED proxies, skipped {skippedREDACTED duplicates',
      batchImportAllSkipped: 'All {skippedREDACTED proxies already exist, skipped import',
      ...
      proxyWorkingWithLatency: 'Proxy is working! Latency: {latencyREDACTEDms',
      ...
      deleteConfirm:
        "Are you sure you want to delete '{nameREDACTED'? Accounts using this proxy will have their proxy removed."
    REDACTED,
    ...
    redeem: {
      ...
      codesCreated: '{countREDACTED redeem code(s) created',
      codeType: 'Code Type',
      amount: 'Amount ($)',
      value: 'Value',
      count: 'Count',
      ...
      codesDeleted: 'Successfully deleted {countREDACTED unused code(s)',
    ...
    settings: {
      ...
      turnstile: {
        ...
        secretKeyConfiguredHint: 'Secret key configured. Leave empty to keep the current value.'      REDACTED,
      defaults: {
      ...
      site: {
        ...
        logoSizeError: 'Image size exceeds 300KB limit ({sizeREDACTEDKB)',
      ...
      smtp: {
        ...
        usernamePlaceholder: "your-email{'@'REDACTEDgmail.com",
        ...
        fromEmailPlaceholder: "noreply{'@'REDACTEDexample.com",
        fromName: 'From Name',
      ...
      testEmail: {
        ...
        recipientEmailPlaceholder: "test{'@'REDACTEDexample.com",
  ...
  subscriptionProgress: {
    ...
    activeCount: '{countREDACTED active subscription(s)',
    daily: 'Daily',
    weekly: 'Weekly',
    monthly: 'Monthly',
    daysRemaining: '{daysREDACTED days left',
    expired: 'Expired',
