export default {
  ...
  admin: {
    ...
    ops: {
      ...
      tooltips: {
        ...
        storage: 'Disk usage of the volume holding the server process working directory, including used and total capacity (live-sampled, not persisted).',
  ...
  invoice: {
    ...
    admin: {
      ...
      description: 'Review user invoice requests, upload invoice files, record invoice numbers',
