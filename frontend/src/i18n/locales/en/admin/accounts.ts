export default {
    accounts: {
      ...
      status: {
        ...
        tempUnschedulableUntil: 'Resumes {timeREDACTED'
      REDACTED,
      columns: {
        name: 'Name',
        id: 'Account ID',
      ...
      ollamaCloud: {
        ...
        windowWithReset: '{percentREDACTED used, resets {resetREDACTED',
        ...
        errors: {
          ...
          OLLAMA_CLOUD_USAGE_REFRESH_RATE_LIMITED: 'Refresh is limited. Try again in {retry_after_secondsREDACTED seconds.'
        REDACTED
      REDACTED,
      upstreamBilling: {
        ...
        groupRate: 'Group default: {valueREDACTEDx',
        userRate: 'User rate: {valueREDACTEDx',
        peakRate: 'Peak: {startREDACTED-{endREDACTED, {valueREDACTEDx ({timezoneREDACTED)',
        noPeakRate: 'Peak rate: disabled',
        effectiveRate: 'Current rate: {valueREDACTEDx',
        updatedAt: 'Updated: {valueREDACTED',
        nextProbeAt: 'Next probe: {valueREDACTED',
        lastDetectedRate: 'Last detected rate: {valueREDACTEDx',
        lastDetectedAt: 'Last detected: {valueREDACTED',
        elapsedSince: 'Elapsed: {valueREDACTED',
        justNow: 'less than 1 minute',
        minutesAgo: '{countREDACTED minutes',
        hoursAgo: '{countREDACTED hours',
        daysAgo: '{countREDACTED days',
        ...
        batchCompleted: 'Probed {countREDACTED account(s)',
        batchPartial: 'Probe partially completed: {successREDACTED succeeded, {failedREDACTED failed'
      REDACTED,
      ...
      tempUnschedulable: {
        ...
        multipleErrorTrigger: '{countREDACTED matching errors in {minutesREDACTED minutes reached the trigger threshold ({thresholdREDACTED).',
        multipleErrorTriggerNoWindow: '{countREDACTED matching errors reached the trigger threshold ({thresholdREDACTED).',
        multipleErrorCountInWindow: '{countREDACTED matching errors occurred within {minutesREDACTED minutes.',
        multipleErrorCount: '{countREDACTED matching errors contributed to this block.',
      ...
      bulkActions: {
        ...
        selectedAll: 'All {countREDACTED account(s) selected',
        selectCurrentPage: 'Select this page',
        selectAllResults: 'Select all results ({countREDACTED)',
        selectingAll: 'Selecting all results...',
        selectAllFailed: 'Failed to load all accounts. The previous selection was kept.',
        clear: 'Clear selection',
        edit: 'Bulk Edit',
        delete: 'Bulk Delete',
        confirmDelete: 'Delete the selected {countREDACTED account(s)? This action cannot be undone.',
        deleteSuccess: 'Deleted {countREDACTED account(s)',
      ...
      bulkEdit: {
        ...
        successWithInherited: 'Updated {countREDACTED account(s). {inheritedREDACTED selected shadow account(s) still follow their parent account.',
        partialSuccess: 'Partially updated: {successREDACTED succeeded, {failedREDACTED failed',
        partialSuccessWithInherited: 'Partially updated: {successREDACTED succeeded, {failedREDACTED failed. {inheritedREDACTED selected shadow account(s) still follow their parent account.',
        ...
        rateSyncConflict: 'Cannot change account rates: {countREDACTED target account(s) have upstream rate sync enabled.',
      ...
      duplicateSuccess: 'Account duplicated as "{nameREDACTED" and paused. Review its credentials before enabling it.',
      ...
      grok: {
        ...
        selectedTestMode: 'Test mode: {modeREDACTED',
      ...
      oauth: {
        ...
        grok: {
          ...
          emailPasswordPlaceholder: "user{'@'REDACTEDexample.com----your-password\nMultiple lines supported",
          emailPasswordHint:
      ...
      errorPrefix: 'Error: {messageREDACTED',
      imagePreviewAlt: 'Test image {indexREDACTED',
      ...
      audioReceived: 'Received test audio #{countREDACTED',
      videoPreview: 'Generated video:',
      videoReceived: 'Received test video #{countREDACTED',
      // Stats Modal
      ...
      openaiQuotaReset: {
        ...
        resetSuccess: 'Reset {windowsREDACTED window(s); credits and account state updated',
