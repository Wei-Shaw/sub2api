    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          codexSessionAuth: 'Codex auth.json / OAuth JSON / AT',
          codexSessionDesc: 'Paste a Codex Agent Identity auth.json, OAuth session JSON, or accessToken. Accounts use the step 1 settings.',
          codexSessionInputLabel: 'Codex auth.json, OAuth JSON, or accessToken',
          codexSessionPlaceholder: 'Paste a complete auth.json; OAuth tokens/JSON support one entry per line',
          codexSessionHint: 'Agent Identity signs requests with its PKCS#8 key and needs no access_token or refresh_token. OAuth sessions without refresh_token still expire with their accessToken.',
          codexSessionImportAndCreate: 'Import & Create Account',
          codexSessionEmpty: 'Please enter a Codex auth.json, OAuth JSON, or accessToken',
