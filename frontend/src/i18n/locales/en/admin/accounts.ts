export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        newAPIGroup: 'New API group (optional)',
        newAPIGroupHint: 'Used only for New API-compatible upstreams. Leave blank to use the default group; the API key group is never guessed.',
