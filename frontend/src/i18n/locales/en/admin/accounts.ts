export default {
    accounts: {
      ...
      openai: {
        ...
        fastMode: 'Fast mode',
        fastModeDesc:
          'Controls whether this account uses the Fast (high-priority) channel. With Force On or Force Off, the setting carried by the client request itself is ignored.',
        fastModeFollow: 'Follow request',
        fastModeForce: 'Force On',
        fastModeOff: 'Force Off',
