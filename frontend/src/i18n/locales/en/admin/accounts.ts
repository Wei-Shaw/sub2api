export default {
    accounts: {
      ...
      columns: {
        ...
        upstreamBillingRate: 'Upstream Info',
        weight: 'Weight',
      ...
      upstreamBilling: {
        trustWarning: 'Relay rates are declared by the upstream site and cannot be independently verified. Official provider balances come from the provider API. Verify upstream information against bills and actual usage.',
        autoProbe: 'Automatically probe upstream billing info',
        autoProbeHint: 'Refresh supported upstream rates or official provider balances on the global interval. This switch alone does not change the account rate.',
        syncRate: 'Sync upstream declared rate',
        syncRateHint: 'Update the account rate after each successful relay-rate probe, using the base rate excluding peak hours. Failed probes, provider balances, or declarations outside the allowed range leave it unchanged. Enabling this also turns on "Automatically probe upstream billing info".',
        ...
        manualProbe: 'Probe upstream info now',
        stale: 'Stale',
        ...
        configuredRate: 'Configured account rate: {value}x',
        deepSeekAvailable: 'DeepSeek API balance is available',
        deepSeekUnavailable: 'DeepSeek API balance is unavailable',
        deepSeekUnavailableShort: 'Unavailable',
        deepSeekTotalBalance: '{currency} total balance: {value}',
        deepSeekBalanceBreakdown: 'Granted: {granted}; topped up: {toppedUp}',
        ...
        enabled: 'On',
        disabled: 'Off',
        probeFailed: 'Failed to probe upstream info',
        noEligibleAccounts: 'Select API key accounts',
        batchLimit: 'A batch can probe at most 20 accounts',
        batchCompleted: 'Probed upstream info for {count} account(s)',
        batchPartial: 'Upstream info probe partially completed: {success} succeeded, {failed} failed'
      },
