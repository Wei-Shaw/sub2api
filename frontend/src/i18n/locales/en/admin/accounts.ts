export default {
    accounts: {
      ...
      concurrency: 'Concurrency',
		loadFactor: 'Scheduling Capacity',
		loadFactorHint: 'Normalizes account pressure and traffic share; the hard limit is still controlled by Concurrency',
      priority: 'Priority',
		priorityHint: 'Lower values are higher tiers; grouped scheduling uses the account priority in the current group',
