export default {
    accounts: {
      ...
      quotaHistory: {
        retry: 'Retry',
        statsTab: "Cost statistics",
        historyTab: "Quota cycles",
        subtitle: "OpenAI / Codex quota cycle history",
        description: "USD values use locally recorded usage and API reference prices, without account or group multipliers. Estimates depend on model mix and usage outside this proxy; observing 100% does not establish an official dollar allowance.",
        window: "Window type",
        loadFailed: "Failed to load quota cycles. Please retry.",
        current: "Current cycle",
        recent: "Completed cycles (within 90 days)",
        showMore: "Show older cycles",
        noCurrent: "No current cycle has been observed yet. Future usage observations will be recorded automatically.",
        noHistory: "No completed cycles yet. History will be retained when observed cycles reset; unobserved past cycles cannot be reconstructed.",
        referenceCost: "Recorded API reference cost",
        lastPercent: "Last observed usage",
        observedExhausted: "Exhaustion observed",
        estimatedLimit: "Estimated full-cycle allowance",
        approximate: "Approx. {amount}",
        unavailable: "Insufficient data",
        requests: "Local requests",
        observation: "First observed {first} · Last observed {last} · {count} samples",
        estimateBasis: "Estimate based on {amount} / {percent} recorded at {time}; this may precede the last observation.",
        inProgress: "Collecting observations",
        expired: "Expired",
        earlyReset: "Early reset",
        windowChanged: "Window changed",
        resetObserved: "Reset observed",
        ended: "Completed",
        partialStart: "Observation began partway through the cycle; no full-cycle estimate is generated.",
        missingPricing: "Some requests lack reference prices; the recorded cost may be incomplete.",
        lowUtilization: "Current usage is below 5%; no new full-cycle estimate is generated.",
        observationGap: "Gaps between observations may omit usage before the reset.",
        ambiguousReset: "The reset boundary is uncertain; this cycle may be incomplete.",
        pendingUsage: "Waiting for asynchronous usage records to be aggregated.",
        incompleteData: "Some data is incomplete; the estimate is for reference only.",
        externalUsage: "Usage outside this proxy is not included.",
      },
      usageWindow: {
