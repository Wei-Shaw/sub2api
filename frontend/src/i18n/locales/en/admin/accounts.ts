export default {
    accounts: {
      ...
      usageWindow: {
        ...
        grokProbe: 'Probe',
        grokProbing: 'Probing…',
        grokProbeTooltip: 'Refresh weekly limit and monthly credits from Grok CLI billing',
        ...
        grokBillingEmpty: 'No weekly/monthly billing data yet — click Probe',
        grokWeeklyLimit: 'Weekly',
        grokMonthlyCredits: 'Monthly',
        grokPayAsYouGo: 'Pay-as-you-go',
        grokWeeklyShort: 'Wk',
        grokMonthlyShort: 'Mo',
        grokOnDemandShort: 'OD',
        grokFreeNoAPICredits: 'Grok Free: no API monthly credits',
        grokFreeLimitedQuota: 'Grok Free: no monthly $; limited request quota via CLI proxy',
        grokFreeBillingNote: 'Billing monthlyLimit=$0; show remaining requests/tokens from cli-chat-proxy',
        grokFreePeriodEnd: 'Billing period ends {time}',



        grokUsedPct: '{pct}% used',
        grokResetIn: 'resets {time}',
        grokPlanSupergrok: 'SuperGrok',
        grokPlanSupergrokHeavy: 'SuperGrok Heavy',
        grokPlanFree: 'Grok Free',
