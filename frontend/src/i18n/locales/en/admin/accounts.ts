export default {
    accounts: {
      ...
      grokProbeAll: 'Probe All',
      grokProbeAllStarting: 'Starting...',
      grokProbeAllRunning: 'Probing {completed}/{total}',
      grokProbeAllTooltip: 'Probe every Grok OAuth account at low concurrency and update scheduling from each response',
      grokProbeAllProgress: 'Progress {completed}/{total}, succeeded {succeeded}, failed {failed}',
      grokProbeAllCompleted: 'Grok probe completed: {succeeded} succeeded, {failed} failed',
      grokProbeAllStartFailed: 'Failed to start Grok account probe',
