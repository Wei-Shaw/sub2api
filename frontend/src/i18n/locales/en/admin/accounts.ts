export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'Off by default and passes client identifiers through unchanged. Enabling this replaces device/session identifiers with account-level stable values; enable it only when explicitly needed.',
