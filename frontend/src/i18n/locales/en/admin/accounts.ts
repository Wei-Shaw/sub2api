export default {
    accounts: {
      ...
      availabilitySchedule: {
        ...
        hint: 'Force-enable or force-disable scheduling on daily or weekly windows. Rules match in order; first hit wins. When nothing matches, the manual Schedulable toggle applies.',
        notice: 'Disabled windows keep the account out of the pool. Enable cannot override a manual Schedulable=off. End ≤ start means an overnight window.',
        addRule: 'Add schedule rule',
        ruleIndex: 'Rule #{index}',
        kind: 'Type',
        kindDaily: 'Daily',
        kindWeekly: 'Weekly',
        action: 'Action',
        actionEnable: 'Enable scheduling',
        actionDisable: 'Disable scheduling',
        start: 'Start time',
        end: 'End time',
        overnightHint: 'End ≤ start means overnight',
        weekdays: 'Weekdays',
        weekday: {
          mon: 'Mon',
          tue: 'Tue',
        ...
        previewOn: 'Right now: matched an enable rule',
        previewOff: 'Right now: matched a disable rule (not schedulable)',
        previewNone: 'Right now: no rule matched; follows manual Schedulable',
        rulesInvalidEmpty: 'Add at least one rule when the schedule is enabled',
        rulesInvalidTime: 'Enter valid start/end times',
        rulesInvalidWeekdays: 'Weekly rules need at least one weekday',
        rulesInvalidTooMany: 'At most 20 schedule rules are allowed'
      },
      ...
      priority: 'Priority',
      priorityHint:
        'Only the account priority field is used for scheduling (lower is preferred). Group binding priority is not used. With the advanced scheduler, sticky sessions, load/error scoring, and TopK weighted random can still spread traffic.',
