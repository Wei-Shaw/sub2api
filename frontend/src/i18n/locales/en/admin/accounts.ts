export default {
    accounts: {
      ...
      codexIdentity: {
        ...
        deviceSharedRestriction: 'Only this mode: each device slot allows at most one in-progress request stream or WebSocket session at a time; it is released when finished. Other strategies have no extra restriction.',
        ...
        validation: {
          ...
          deviceSharedRestrictionsInvalid: 'Device sharing requires one active conversation per slot and disabled cross-key continuation.',
