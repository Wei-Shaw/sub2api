    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          codexSessionReauthDesc: 'Paste this account\'s Codex OAuth auth.json or accessToken. Only credentials are replaced; concurrency, priority and groups stay unchanged.',
          codexSessionReauthPlaceholder: 'Paste one token or one auth.json object (must belong to this account)',
          codexSessionReauthSubmit: 'Import & Update Account',
