    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          refreshTokenReauthDesc: 'Enter a new OpenAI refresh token to replace this account\'s current authorization credentials after validation.',
          refreshTokenReauthPlaceholder: 'Paste one new OpenAI refresh token...',
          ...
          codexSessionReauthDesc: 'Paste one Codex auth.json or accessToken to replace this account\'s authorization credentials after validation.',
          codexSessionReauthPlaceholder: 'Paste one token or auth.json object',
          codexSessionImportAndReauthorize: 'Import & Reauthorize',
          ...
          codexPatReauthDesc: 'Enter one Codex at- personal access token to replace this account\'s authorization credentials after validation.',
          codexPatReauthPlaceholder: 'at-...',
          codexPatImportAndReauthorize: 'Validate & Reauthorize',
          ...
          validateAndReauthorize: 'Validate & Reauthorize',
          reauthSingleCredential: 'Submit one credential at a time when reauthorizing an account',
