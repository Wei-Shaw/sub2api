export default {
    accounts: {
      ...
      codexIdentity: {
        ...
        profilesDesc: 'Enable only the environments this account should accept. Desktop and CLI can converge within the same OS; cross-OS conversion is never allowed.',
        fixErrors: 'Complete the identity policy before saving.',
        valid: 'Identity policy is ready to validate on the server.',
        windows: 'Windows',
        windowsDesc: 'Canonical Windows Desktop or CLI identity.',
        macos: 'macOS',
        macosDesc: 'Canonical macOS Desktop or CLI identity.',
        linux: 'Linux',
        linuxDesc: 'Canonical Linux Desktop or CLI identity.',
        generic: 'Generic SDK / third-party',
        genericOS: 'Generic',
        genericDesc: 'Python, Node, curl and supported third-party clients.',
        ...
        validation: {
          ...
          bindingScopeInvalid: 'Binding scope must be API key plus OS.',
          ...
          duplicateProfile: 'Each operating-system Profile can appear only once.',
