export default {
    accounts: {
      ...
      cnProviders: {
        ...
        reset: 'Reset',
        resetTooltip: 'Use a Zhipu usage-reset credit to restore the weekly quota immediately (5-hour quota resets with it)',
        resetExpire: 'Valid until',
        resetConfirmTitle: 'Reset weekly quota',
        resetConfirmMessage: 'This immediately restores the weekly quota (and resets the 5-hour quota) for this account. It consumes 1 reset credit and cannot be undone.',
