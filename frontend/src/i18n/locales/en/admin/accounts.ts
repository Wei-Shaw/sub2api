export default {
    accounts: {
      ...
      jshandlerScript: 'Gateway JS scripts (ordered chain)',
      jshandlerScriptNone: 'No scripts bound (no JS hooks)',
      jshandlerScriptHint: 'Requires global JS handler enabled in Settings → Gateway. Add multiple scripts and drag or use arrows to set execution order.',
