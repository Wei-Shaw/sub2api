export default {
    accounts: {
      ...
      tempUnschedulable: {
        ...
        ruleOrderHint: 'Rules match in order and the first match wins: put broader-scope rules (e.g. account-wide) first.',
        description: 'Description',
        descriptionPlaceholder: 'Optional note for this rule',
        accountWide: 'Account-wide block (enable when quota is shared across all models on the account)',
        blockScope: 'Block scope',
        blockScopeAccount: 'Account-wide (all models)',
        blockScopeAccountRule: 'Account-wide (all models, account_wide rule)',
