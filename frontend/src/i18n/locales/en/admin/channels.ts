export default {
    ...
    channels: {
      ...
      intervalValidation: {
        ...
        multiplierPositive: 'Interval #{indexREDACTED: {fieldREDACTED must be greater than 0',
    ...
    channelMonitor: {
      ...
      duplicateSuccess: 'Monitor duplicated as "{nameREDACTED" and disabled. Review its configuration before enabling it.',
    ...
    subscriptions: {
      ...
      hoursMinutesRemaining: '{hoursREDACTEDh {minutesREDACTEDm remaining',
      minutesRemaining: '{minutesREDACTEDm remaining',
