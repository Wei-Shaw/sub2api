export default {
    ...
    subscriptions: {
      resetObserver: {
        ...
        observationOff: 'Observation is off. Enable Observe only to collect fresh upstream evidence.',
        ...
        reasons: {
          ...
          observation_quorum_met: 'The observation threshold was reached. No subscription quota was reset.',
        ...
        entry: 'Upstream reset observation',
        title: 'Reset observation · {group}',
        ...
        dimensionHint: 'These choices are saved for preview only. If automatic following is enabled in a future release, daily usage would clear while retaining the next local-midnight reset; weekly and monthly windows would restart at the confirmed time. Subscription expiration would stay unchanged.',
        ...
        invalidSettings: 'Enter a confirmation percentage from 1 to 100, an aggregation window from 1 to 60 minutes, and at least one preview dimension.',
        ...
        evidenceHint: 'Only fresh upstream observations can confirm a reset. Missing values, errors, an expired countdown, and locally consumed reset credits do not count. An early usage drop requires review.',
        ...
        batchSource: '7d · {kind} · Preview dimensions: {dimensions}',
        ...
        eventStates: {
          ...
          confirmed: 'Confirmed · observation only',
          timed_out: 'Timed out',
          needs_review: 'Needs review',
