export default {
    ...
    subscriptions: {
      ...
      bulk: {
        ...
        set_quota_windows: 'Bulk Set Reset Cycle',
        revoke: 'Bulk Revoke',
        ...
        setWindowsHint: 'This only changes the next reset time. Used quota is left unchanged. Set at least one window start.',
        selectWindow: 'Select at least one quota window',
        selectWindowStart: 'Set at least one reset-cycle start time',
      ...
      setQuotaWindows: 'Set Reset Cycle',
      setQuotaWindowsTitle: 'Set Reset Cycle',
      setQuotaWindowsHint: 'This only changes the next reset time. Used quota is left unchanged.',
      weeklyWindowStart: 'Weekly window start',
      monthlyWindowStart: 'Monthly window start',
      alignToGroupPeer: 'Align to group peer {time}',
      quotaWindowsUpdated: 'Reset cycle updated',
      failedToSetQuotaWindows: 'Failed to update reset cycle',
