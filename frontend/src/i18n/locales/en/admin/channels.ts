export default {
    ...
    subscriptions: {
      ...
      adjusting: 'Adjusting...',
      editLimits: 'Limits',
      editLimitsTitle: 'Set User Subscription Limits',
      editLimitsFor: 'Set individual subscription limits for {user}',
      userLimits: 'Individual User Limits (Optional)',
      userLimitsHint: 'Leave blank to use the group limit. A configured value takes priority for this user.',
      dailyLimit: 'Daily Limit (USD)',
      weeklyLimit: 'Weekly Limit (USD)',
      monthlyLimit: 'Monthly Limit (USD)',
      clearLimitHint: 'Leave a field blank and save to clear the user override and fall back to the group limit.',
      groupLimitPlaceholder: 'Group limit ${limit}',
      invalidLimit: 'Limits must be greater than 0',
      limitsUpdated: 'User subscription limits updated',
      failedToUpdateLimits: 'Failed to update user subscription limits',
      revoke: 'Revoke',
      restore: 'Restore',
      ...
      guide: {
        ...
        actions: {
          ...
          limits: 'User Limits',
          limitsDesc: 'Override daily/weekly/monthly limits for one user; blank values fall back to the group',
          resetQuota: 'Reset Quota',
