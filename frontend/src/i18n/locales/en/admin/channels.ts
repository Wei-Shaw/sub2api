export default {
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "Reset the selected usage quotas for '{user}'? Only the selected windows will be zeroed and restarted.",
      resetQuotaSelectHint: 'Select the usage windows to reset. Unselected windows will not be changed.',
      noResettableQuota: 'This subscription has no configured quotas to reset.',
      ...
      guide: {
        ...
        actions: {
          ...
          resetQuota: 'Reset Quota',
          resetQuotaDesc: 'Choose which daily/weekly/monthly usage windows to reset',
          revoke: 'Revoke',
