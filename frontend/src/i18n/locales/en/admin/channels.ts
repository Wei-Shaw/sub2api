export default {
    ...
    subscriptions: {
      ...
      resetGroupQuotaTitle: 'Reset Group Usage Quota',
      resetGroupQuotaConfirm: "Reset the daily, weekly, and monthly usage quota for all active subscriptions in group '{group}'? Usage will be zeroed and windows restarted from today.",
      groupQuotaResetSuccess: 'Quota reset for {count} active subscriptions',
      groupQuotaResetPartial: 'Reset {success} subscriptions; {failed} failed',
