export default {
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: 'Metrics outside these bounds are highlighted in red on the ops dashboard.',
        slaMinPercent: 'SLA Minimum (%)',
        slaMinPercentHint: 'Success rate below this is flagged (default 99.5).',
        ttftP99MaxMs: 'TTFT P99 Maximum (ms)',
        ttftP99MaxMsHint: 'P99 time to first token above this is flagged (default 500).',
        requestErrorRateMaxPercent: 'Request Error Rate Maximum (%)',
        requestErrorRateMaxPercentHint: 'Share of failed requests above this is flagged (default 5).',
        upstreamErrorRateMaxPercent: 'Upstream Error Rate Maximum (%)',
        upstreamErrorRateMaxPercentHint: 'Share of upstream failures above this is flagged (default 5).',
        validation: {
          title: 'Please fix the following issues',
