export default {
    ...
    users: {
      ...
      rotateKey: {
        action: 'Rotate',
        title: 'Rotate User API Key',
        description: 'Generate a new credential for {email}\'s key “{name}” while preserving its record and configuration.',
        warning: 'The old key stops working immediately. Deliver the new key securely and remind the user to update every client.',
        acknowledge: 'I understand that the old key will stop working immediately',
        confirm: 'Confirm rotation',
        rotating: 'Rotating...',
        successTitle: 'User API Key Rotated',
        successMessage: 'The new key is active',
        oldKeyInvalid: 'The old key can no longer be used.',
        preserved: 'Key ID, user, group, quota, limits, and billing history are unchanged.',
        copied: 'New API key copied',
        done: 'I saved it, done',
        failed: 'Failed to rotate user API key'
      },
      group: 'Group',
      none: 'None',
