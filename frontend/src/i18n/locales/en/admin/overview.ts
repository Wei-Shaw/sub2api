export default {
    ...
    groups: {
      ...
      smartRouting: {
        title: 'Smart Routing Member Groups',
        hint: 'Requests go to the highest-priority (lowest number) member first; on failure they retry from high to low priority. Within the same priority, traffic is split by weight (higher weight gets more requests).',
        addMember: 'Add member group',
        removeMember: 'Remove',
        memberGroup: 'Member group',
        priority: 'Priority',
        priorityHint: '1 is the highest priority; lower numbers are tried first',
        weight: 'Weight',
        weightHint: 'Traffic share within the same priority; minimum is 1',
        selectGroup: 'Select group',
        empty: 'Please add at least one member group',
        membersRequired: 'A smart routing group requires at least one member group',
        memberColumns: 'Member group / Priority / Weight',
      },
      saving: 'Saving...',
