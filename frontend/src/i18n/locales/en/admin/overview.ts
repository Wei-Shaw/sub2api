export default {
    ...
    users: {
      ...
      deposit: 'Deposit',
      temporaryBalance: {
        title: 'Add temporary balance',
        action: 'Add temporary balance',
        regularBalance: 'Regular balance',
        amount: 'Amount',
        amountHint: 'Available only before expiry; permanent balance is unchanged.',
        expiresAt: 'Expires at',
        today: 'Today',
        tomorrow: 'Tomorrow',
        thisWeek: 'This week',
        ...
        notes: 'Notes',
        expiryRequired: 'Choose a future expiry time',
        submit: 'Grant temporary balance',
        success: 'Temporary balance granted',
        failed: 'Failed to grant temporary balance',
        preview: 'Temporary balance granted',
        previewHint: 'Permanent balance remains unchanged',
        expired: 'Expired'
      },
      withdraw: 'Withdraw',
