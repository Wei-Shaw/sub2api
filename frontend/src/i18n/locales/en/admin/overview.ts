export default {
    ...
    groups: {
      ...
      openaiMessages: {
        ...
        familyMappingHint: 'Requests that match the Fable, Opus, Sonnet, or Haiku families will prefer the target model configured here.',
        fableModel: 'Fable Target Model',
        fableModelPlaceholder: 'e.g., model-id',
