export default {
    ...
    groups: {
      ...
      form: {
        ...
        modelReasoningEffortRules: 'Model-specific rules',
        modelReasoningEffortRulesHint: 'Matches the client-requested model exactly. Delete a rule to inherit the group defaults again.',
        addModelReasoningEffortRule: 'Add model rule',
        removeModelReasoningEffortRule: 'Remove model rule',
        reasoningEffortModel: 'Model name',
        reasoningEffortModelPlaceholder: 'For example, gpt-5.6-luna',
        modelReasoningEffortUnlimited: 'Unlimited (override group default)',
        modelRequired: 'Enter a model name',
        duplicateModel: 'Model names must be unique',
