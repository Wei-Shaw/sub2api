export default {
    ...
    users: {
      ...
      searchPlaceholder: 'Search by ID, email, username, notes, or API key...',
    ...
    groups: {
      ...
      modelsList: {
        ...
        manualPlaceholder: 'Search or enter a model ID, then press Enter',
        noSearchResults: 'No matching models; press Enter to add it',
        addModel: 'Add model',
