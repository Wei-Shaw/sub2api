export default {
    ...
    groups: {
      ...
      form: {
        ...
        maxReasoningEffortHint: 'Limits explicit OpenAI reasoning effort requests only. For Composite groups, it applies only to requests resolved to OpenAI. Higher values are capped; omitted effort stays omitted. The ceiling takes precedence over mappings. A mapping can target one exact client-requested model; leave the model blank to match all models.',
        ...
        reasoningEffortModel: 'Model scope (optional)',
        ...
        reasoningEffortFromPlaceholder: 'Select or enter A',
        reasoningEffortToPlaceholder: 'Select B',
        fromRequired: 'Select request value A',
        toRequired: 'Select forwarded value B',
        unsupportedFrom: 'Reasoning effort mappings are not supported by this platform',
        ...
        modelTooLong: 'Model name cannot exceed 64 characters',
        fromTooLong: 'Request value cannot exceed 64 characters',
