export default {
    ...
    users: {
      ...
      bulkLimits: {
        action: 'Set limits ({countREDACTED)',
        title: 'Set user limits',
        selectedCount: '{countREDACTED users selected',
        selectionLimit: 'Select no more than {maxREDACTED users at a time.',
        selectUser: 'Select {emailREDACTED',
        ...
        apply: 'Apply limits',
        applying: 'Applying...',
        concurrencyValue: 'Concurrency: {valueREDACTED',
        rpmValue: 'RPM: {valueREDACTED',
        rpmUnlimitedValue: 'RPM: Unlimited',
        confirm: 'Overwrite limits for {countREDACTED users?\n{fieldsREDACTED',
        success: 'Updated limits for {countREDACTED users',
        failed: 'Failed to update user limits'
      REDACTED,
      editUser: 'Edit User',
      deleteUser: 'Delete User',
      deleteConfirmMessage: "Are you sure you want to delete user '{emailREDACTED'? This action cannot be undone.",
    ...
    groups: {
      ...
      duplicateSuccess: 'Group duplicated as "{nameREDACTED" and disabled. Review its configuration before enabling it.',
      ...
      webSearchPricing: {
        ...
        finalPricePreview: 'Per-call price after current multiplier: {priceREDACTED'
      REDACTED,
      peakRate: {
      ...
      compositeRoutes: {
        ...
        titleWithGroup: 'Composite Routes: {nameREDACTED',
        routes: 'Saved Routes',
