export default {
    ...
    groups: {
      ...
      form: {
		...
		quotaOptimization: 'Quota usage optimization',
		quotaStickyDefault: 'Enable quota-first sticky routing by default',
		quotaStickyOverride: 'Allow API key users to override the default',
		sessionModelStability: 'Keep upstream model stable within a session',
		unifiedRetryBudget: 'Enable unified retry budget',
