export default {
    ...
    users: {
      ...
      apiKeyCustomKey: 'Custom Key (optional)',
      apiKeyCustomKeyPlaceholder: 'Leave empty to auto-generate',
      apiKeyGroup: 'Group',
      apiKeyGroupNone: 'No group',
      apiKeyQuota: 'Quota (USD, 0 = unlimited)',
      apiKeyExpiresInDays: 'Valid days (empty = never expires)',
      apiKeyRateLimit5h: '5h limit',
      apiKeyRateLimit1d: '1d limit',
      apiKeyRateLimit7d: '7d limit',
      apiKeyNameRequired: 'Please enter a key name',
      apiKeyLimitInvalid: 'Quota, rate limits and valid days must be non-negative numbers; valid days must be greater than 0',
      createKeySuccess: 'API key created successfully',
      createKeyFailed: 'Failed to create API key',
      createdKeyNotice: 'Copy and store it now — this key is shown in full only once.',
      copyKey: 'Copy key',
      submitCreate: 'Create',
      cancelCreate: 'Cancel',
