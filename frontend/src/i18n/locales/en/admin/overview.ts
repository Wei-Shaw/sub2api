export default {
    ...
    groups: {
      ...
      setQuotaWindows: 'Align Reset Cycle',
      setQuotaWindowsTitle: 'Align Group Reset Cycle',
      setQuotaWindowsHint: 'Move weekly/monthly windows of every active subscription in this group to the same start. Used quota is left unchanged.',
      weeklyWindowStart: 'Weekly window start',
      monthlyWindowStart: 'Monthly window start',
      quotaWindowsUpdated: 'Updated the reset cycle for {success} subscriptions',
      quotaWindowsPartial: 'Reset cycle update finished: {success} succeeded, {failed} failed',
      failedToSetQuotaWindows: 'Failed to align group reset cycle',
      pleaseSetWindowStart: 'Set at least one reset-cycle start time',
      resetGroupQuota: 'Reset Group Quota',
      resetGroupQuotaTitle: 'Reset Group Quota',
      resetGroupQuotaHint: 'Same as Reset Quota on the subscription page: zero selected usage for every active subscription in this group and restart those windows (daily at midnight, weekly/monthly from now).',
      resetGroupQuotaSuccess: 'Reset quota for {success} subscriptions',
      resetGroupQuotaPartial: 'Group quota reset finished: {success} succeeded, {failed} failed',
      failedToResetGroupQuota: 'Failed to reset group quota',
