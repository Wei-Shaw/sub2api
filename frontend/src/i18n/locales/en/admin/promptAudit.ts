export default {
  promptAudit: {
    ...
    pool: {
      ...
      engineType: 'Audit engine', systemGuidance: 'Additional audit guidance', confidence: 'Confidence threshold', sampleRate: 'Sample rate', maxOutputTokens: 'Maximum output tokens', jsonMode: 'JSON output mode', stage: 'Enforcement stage', failurePolicy: 'Failure policy', compositionMode: 'Keyword composition mode',
