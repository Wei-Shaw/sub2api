export default {
    ...
    proxies: {
      ...
      REDACTED,
      deleteConfirmMessage: "Are you sure you want to delete proxy '{nameREDACTED'?",
    ...
    redeem: {
      ...
      codesGeneratedSuccess: 'Redeem codes generated successfully, {countREDACTED total',
