export default {
    scheduledTests: {
      ...
      running: 'Running',
      schedule: 'Schedule',
      createMissing: 'Create Missing Schedules',
      createMissingTitle: 'Create scheduled tests for accounts without plans',
      createMissingConfirm: 'This creates a scheduled test only for accounts without an existing plan. Tests run every 30 minutes with low-cost models and auto recovery enabled. Initial runs are staggered. Continue?',
      createMissingSuccess: 'Created {count} scheduled test plans',
      createMissingFailed: 'Failed to create scheduled test plans',
