export default {
    ...
    proxies: {
      ...
      subscriptionUrlHint: 'Use a Clash/Mihomo subscription URL, or leave it empty and paste content below.',
      subscriptionContent: 'Subscription Content',
      subscriptionContentPlaceholder: 'Paste Clash/Mihomo YAML, a Base64 subscription, or one http/socks proxy URL per line',
      subscriptionContentHint: 'URL or content is required. Pasted content takes precedence when both are provided.',
      subscriptionNamePrefix: 'Name Prefix',
      subscriptionNamePrefixPlaceholder: 'For example: sub',
      subscriptionQualityPolicy: 'Quality Policy',
      qualityPolicyApply: 'Apply Quality Policy',
      qualityPolicyTitle: 'Apply Proxy Quality Policy',
      qualityPolicy: 'Policy',
      qualityPolicyHint: 'Runs quality checks, then disables proxies whose grade is below the selected threshold.',
      qualityPolicySelectedScope: 'This will check and apply the policy to {count} selected proxies.',
      qualityPolicyFilteredScope: 'This will check and apply the policy to every proxy matching the current filters.',
      qualityPolicyConfirm: 'Apply Policy',
      qualityPolicyApplying: 'Applying...',
      qualityPolicyEmpty: 'No proxies to check',
      qualityPolicyDone: 'Quality policy applied: checked {checked}/{count}, disabled {disabled}',
      qualityPolicyPartial: 'Quality policy applied with issues: checked {checked}/{count}, disabled {disabled}, failed {failed}',
      qualityPolicyFailed: 'Failed to apply quality policy',
      subscriptionQualityPolicyHint: 'Imported proxies can be quality-checked and disabled when their grade is below your selected threshold.',
      subscriptionQualityDisableD: 'Enable C and above (disable D/F)',
      subscriptionQualityDisableCOrBelow: 'Enable B and above (disable C/D/F)',
      subscriptionQualityDisableBOrBelow: 'Enable A only (disable B/C/D/F)',
      subscriptionQualityNone: 'Skip quality filtering',
      subscriptionSupportedHint: 'Only http, https, socks5, and socks5h nodes are imported. SS/VLESS/Hysteria/Trojan nodes are skipped; use a local Clash/Mihomo SOCKS bridge for those protocols.',
      subscriptionImportButton: 'Import Subscription',
      subscriptionImportRequired: 'Enter a subscription URL or paste subscription content',
      subscriptionImportSuccess: 'Subscription import completed: created {created}, skipped {skipped}, unsupported {unsupported}, quality checked {quality_checked}, disabled {quality_disabled}',
      subscriptionImportPartial: 'Subscription import completed with issues: created {created}, skipped {skipped}, unsupported {unsupported}, invalid {invalid}, failed {failed}, quality failed {quality_failed}, disabled {quality_disabled}',
