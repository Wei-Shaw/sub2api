export default {
    ...
    proxies: {
      ...
      consoleTitle: 'Proxy Console',
      consoleDescription: 'Load available proxies from IP Management and open each configured console page.',
      consoleURL: 'Console URL (optional)',
      consoleURLPlaceholder: 'For example, https://proxy.example.com/console',
      consoleURLHint: 'MetaCubeXD /ui URLs connect automatically; other HTTP/HTTPS panels open unchanged. Do not include credentials or a secret.',
      manageConsoleAddresses: 'Manage Console URLs',
      noConsoleProxies: 'No proxy consoles configured',
      noConsoleProxiesHint: 'Edit a proxy in IP Management and add its console URL first.',
      goToProxyManagement: 'Go to IP Management',
