export default {
    ...
    proxies: {
      ...
      accountNotes: 'Notes',
      abnormalCount: '{count} error',
      abnormalTooltip: '{count} account(s) in error state',
      platformAccountsTooltip: '{platform}: {count} account(s)',
      accountsFilteredBy: 'Filtered: {platform}',
      accountsAllPlatforms: 'All platforms',
      reassignAccounts: 'Reassign to another IP ({count})',
      reassignTitle: 'Reassign to another IP',
      reassignHint: 'Reassign the {count} displayed account(s) to the selected IP (pick "No Proxy" to unbind)',
      reassignSkippedShadows: 'Excluded {count} shadow account(s) — their proxy is inherited from the parent',
      reassignSuccess: 'Reassigned {count} account(s)',
      reassignPartial: '{success} succeeded, {failed} failed',
      reassignFailed: 'Failed to reassign accounts',
      name: 'Name',
      protocol: 'Protocol',
      host: 'Host',
      port: 'Port',
