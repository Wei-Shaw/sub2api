    ...
    settings: {
      ...
      registration: {
        ...
        emailSuffixWhitelistHint:
          "Emails from allowlist domains can register without a quota. When the allowlist is not empty, every other registrable domain can register one account. Empty the allowlist to remove the quota for all domains (for example, {'@'REDACTEDqq.com, {'@'REDACTEDgmail.com, *.edu.cn).",
      ...
      apiKeyAcl: {
        ...
        forwardedClientIpHeadersLimit: 'At most {maxREDACTED custom client-IP headers are allowed.',
        removeForwardedClientIpHeader: 'Remove {headerREDACTED'
      REDACTED,
      linuxdo: {
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptBlocksHint: "Each block is saved as JSON with enabled, type, text, and optional cache_control. {'{'REDACTEDbilling_header{'REDACTED'REDACTED stays dynamic per request; the Claude Code identity and expansion prompts can be edited directly or restored from presets.",
        ...
        openaiCodexVersionSyncedValue: 'Currently synced: {versionREDACTED',
