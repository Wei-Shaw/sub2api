export default {
    settings: {
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'Pause until the native window resets when usage reaches this percentage. Supports OpenAI, Anthropic, Grok, Kimi/Zhipu/MiniMax Coding Plans and OpenCode GO. Requires provider usage snapshots; balance-only accounts do not apply. 100 disables this default.',
        ...
        accountSchedulingThresholdsRangeHint: 'Integer 1–100 (percent). Account editing supports separate 5h/7d limits; OpenCode GO also supports monthly limits.'
      },
