export default {
    settings: {
      ...
      jshandler: {
        ...
        accountBindingHint: 'Assign a script per account under Account management. Unassigned accounts do not run JS hooks.',
        ...
        previewLoading: 'Loading script…',
        previewFailed: 'Failed to load script content',
        previewEmpty: 'Script content is empty',
        copyCode: 'Copy code',
        copied: 'Copied',
        ...
        editNamePlaceholder: 'Display name',
        editContent: 'Script source',
        editContentHint: 'Hooks: on_after_auth_request / on_after_nonstream_response / on_after_stream_response',
        editLoading: 'Loading script…',
        editSave: 'Save script',
        editSaving: 'Saving…',
        editSaved: 'Script saved',
        editFailed: 'Failed to save script',
        editLoadFailed: 'Failed to load script',
        editEmptyContent: 'Script content cannot be empty',
        editFromPreview: 'Edit',
        hooksReference: 'Hooks: on_after_auth_request, on_after_nonstream_response, on_after_stream_response (on_before_request requires account context).',
