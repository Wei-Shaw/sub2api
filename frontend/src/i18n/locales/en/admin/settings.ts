export default {
    settings: {
      ...
      payment: {
        ...
        sepayWebhookHint: 'Configure the following URL as the webhook in your SePay dashboard:',
        nowpaymentsWebhookHint: 'Configure the following URL as the IPN callback in NOWPayments:',
