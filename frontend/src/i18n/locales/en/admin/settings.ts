export default {
    settings: {
      ...
      tabs: {
        ...
        users: 'Users',
        gateway: 'Gateway',
        codexProfiles: 'Codex Egress',
        email: 'Email',
        backup: 'Backup',
        payment: 'Payment',
      },
      codexProfiles: {
        title: 'Codex OS Egress Templates',
        description: 'Centrally manage reusable operating-system, client-surface, device-slot, and proxy policies. Template changes save independently from other system settings.',
        create: 'New template',
        createTitle: 'Create Codex egress template',
        editTitle: 'Edit Codex egress template',
        edit: 'Edit',
        copy: 'Copy',
        delete: 'Delete',
        deleteTitle: 'Delete Codex egress template',
        deleteConfirm: 'Delete “{name}”? It is currently assigned to {count} account(s). Assigned templates cannot be deleted.',
        updateImpactTitle: 'Confirm assigned template update',
        updateImpactMessage: 'This template is used by {count} account(s). Saving immediately updates their runtime configuration and rotates changed device slots. Continue?',
        confirmUpdate: 'Update and rotate',
        loading: 'Loading Codex egress templates...',
        loadFailed: 'Failed to load Codex egress templates.',
        retry: 'Retry',
        emptyTitle: 'No egress templates yet',
        emptyDescription: 'Create a template to manage identity slots and proxy policies for Windows, macOS, Linux, and generic clients.',
        ...
        save: 'Save template',
        saving: 'Saving...',
        created: 'Codex egress template created.',
        updated: 'Codex egress template updated.',
        deleted: 'Codex egress template deleted.',
        saveFailed: 'Failed to save the Codex egress template.',
        deleteFailed: 'Failed to delete the Codex egress template.',
        form: {
          name: 'Template name',
          namePlaceholder: 'For example: Asia Desktop and CLI egress',
          description: 'Description',
          descriptionPlaceholder: 'Describe the intended accounts or egress policy',
          profilesTitle: 'Operating systems and client surfaces',
          profilesDescription: 'Desktop and CLI can be enabled together for each OS, with independent architecture, slot, and proxy settings.',
        },
        validation: {
          nameRequired: 'Enter a template name.',
          profilesInvalid: 'Enable at least one client surface and fix the template configuration errors.',
        },
        errors: {
          CODEX_IDENTITY_TEMPLATE_NOT_FOUND: 'This template no longer exists. Refresh the list.',
          CODEX_IDENTITY_TEMPLATE_NAME_EXISTS: 'A template with this name already exists.',
          CODEX_IDENTITY_TEMPLATE_REVISION_CONFLICT: 'Another request updated this template (current revision: {current_revision}). Reopen it before editing.',
          CODEX_IDENTITY_TEMPLATE_IN_USE: 'This template is assigned to {assigned_account_count} account(s) and cannot be deleted.',
          CODEX_IDENTITY_TEMPLATE_UPDATE_CONFIRMATION_REQUIRED: 'This template is assigned to accounts. Confirm the runtime update and rotation of changed slots.',
          INVALID_CODEX_IDENTITY_TEMPLATE: 'The template is invalid. Check its name, session policy, and Profiles.',
          INVALID_CODEX_IDENTITY_TEMPLATE_PROXY: 'The template references a proxy that does not exist.',
          INVALID_CODEX_IDENTITY_TEMPLATE_ID: 'The template ID is invalid.',
          INVALID_CODEX_IDENTITY_TEMPLATE_REVISION: 'The template revision is invalid. Reopen the template.',
          CODEX_IDENTITY_TEMPLATE_CONFLICT: 'The template conflicts with existing data.',
          VALIDATION_ERROR: 'Template validation failed. Check required fields and length limits.',
        },
      },
      features: {
        channelMonitor: {
      ...
      gatewayForwarding: {
        ...
        openaiCodexClientVersionHint: 'The Codex client version this gateway declares upstream, shared by the User-Agent and the version header. Leave empty to use the auto-synced latest stable release; setting a value pins it and stops following auto-sync. The minimum supported version is 0.144.0.',
        openaiCodexVersionAutoSync: 'Auto-sync Codex version',
        openaiCodexVersionAutoSyncHint: 'Fetches the latest stable client version from the official repository every 6 hours, so you never need to upgrade this service just to keep the version current. Disabling it stops future syncs; if the field above is empty, the last valid synced value remains in use, with the built-in version as the fallback.',
