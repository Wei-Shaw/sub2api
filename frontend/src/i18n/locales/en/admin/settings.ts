export default {
    settings: {
      ...
      overloadCooldown: {
        title: 'Upstream Overload Cooldown',
        description: 'Configure account scheduling pauses for HTTP 529 and repeated OpenAI OAuth capacity-shed errors',
        enabled: 'Enable 529 overload cooldown',
        enabledHint: 'Pause account scheduling on 529 errors, then recover automatically',
        cooldownMinutes: '529 cooldown duration (minutes)',
        cooldownMinutesHint: 'Duration to pause account scheduling after HTTP 529 (1-120 minutes)',
        oauthCapacityEnabled: 'Enable OpenAI OAuth capacity cooldown',
        oauthCapacityEnabledHint: 'After repeated server_is_overloaded or slow_down errors, temporarily exclude only the affected OAuth account from new requests',
        oauthCapacityWindowMinutes: 'Detection window (minutes)',
        oauthCapacityWindowMinutesHint: 'Count capacity-shed events for each OAuth account within this rolling window (1-60 minutes)',
        oauthCapacityFailureThreshold: 'Failure threshold',
        oauthCapacityFailureThresholdHint: 'Events within the detection window required to trigger cooldown (1-10000)',
        oauthCapacityCooldownMinutes: 'OAuth cooldown duration (minutes)',
        oauthCapacityCooldownMinutesHint: 'How long new requests avoid the affected account before automatic recovery (1-120 minutes)',
