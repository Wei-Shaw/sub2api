export default {
    settings: {
      ...
      payment: {
        ...
        field_storeId: 'Store ID',
        field_variantId: 'Variant ID',
        ...
        lemonsqueezyWebhookHint: 'Configure the following URL as a Webhook endpoint in Lemon Squeezy. Select at least the Order created event so paid orders can be fulfilled.',
