export default {
    settings: {
      ...
      openaiFastPolicy: {
        ...
        description: 'Intercept, filter, or pass OpenAI fast(priority), ultrafast, or flex requests based on the request body service_tier field. Applies to the OpenAI gateway only. "All tier values" also includes requests that omit the tier.',
