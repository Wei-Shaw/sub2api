    ...
    settings: {
      ...
      payment: {
        ...
        subscriptionUsdToVndRateHint:
          'VND charged per 1 USD on VND channels (e.g. 26000), applied to plan prices and balance top-ups alike. 0 or empty = disabled, the USD figure is charged as-is. When enabled, all plan prices must be set in USD',
