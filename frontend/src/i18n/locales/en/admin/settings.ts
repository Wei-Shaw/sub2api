export default {
    settings: {
      ...
      customMenu: {
        ...
        uri: 'Same-origin URI path',
        uriPlaceholder: '/help or /docs/index.html',
        uriHint: 'Opens a path on the current site origin. Use either this or Page URL.',
        hideOpenButton: 'Hide the “Open in new tab” button',
        openInNewTab: 'Open the menu entry in a new tab',
        iconSvg: 'SVG Icon',
