export default {
    settings: {
      ...
      features: {
        ...
        modelPlaza: {
          title: 'Model Prices',
          description: 'Dynamically show signed-in users the models, prices, and effective rates currently available to them.',
          enabled: 'Enable Model Prices',
          enabledHint: 'When enabled, Model Prices appears in the user sidebar.',
          requireAuth: 'Access scope',
          requireAuthHint: 'Model pricing is available only from the signed-in user sidebar; there is no standalone public page.',
          authOnly: 'Signed-in users only',
