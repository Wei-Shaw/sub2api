export default {
    settings: {
      ...
      payment: {
        ...
        field_dogpayApiBaseHint: 'DogPay API base URL. Use https://api.dogpay.com for production.',
        ...
        dogpayWebhookHint: 'Configure the following URL as a Webhook endpoint in DogPay merchant backend. DogPay will send payment notifications to this URL.',
