export default {
  batchImage: {
    ...
    REDACTED,
    list: {
      selectedJobs: 'Selected {countREDACTED job | Selected {countREDACTED jobs',
      expandChildren: 'Expand {nREDACTED subtask | Expand {nREDACTED subtasks',
      collapseChildren: 'Collapse subtasks',
      childCount: '{nREDACTED subtask | {nREDACTED subtasks',
      childBadge: 'Subtask',
      keyNotRecorded: 'Not recorded',
      totalCount: 'of {nREDACTED',
      notDownloaded: 'Not downloaded',
      empty: 'No batch jobs yet',
      emptyHint: 'Use the button in the top-right corner to create a batch job.',
    REDACTED,
    pagination: {
      pageNumber: 'Page {pageREDACTED',
      pageItems: '{countREDACTED on this page',
    REDACTED,
    promptPopover: {
      title: 'Full prompt',
    ...
    detail: {
      ...
      items: 'Items',
      preview: 'Preview',
      previewZoom: 'Zoom compressed preview {idREDACTED',
      ...
      mainTask: 'Main job: {nameREDACTED',
      childTask: 'Subtask: {nameREDACTED',
      holdCost: 'Hold {amountREDACTED',
    REDACTED,
    itemResult: {
    ...
    create: {
      ...
      estimatedOutputValue: '{imagesREDACTED images / {promptsREDACTED prompts',
      promptAdded: '{countREDACTED added',
      ...
      outputCountOption: '{nREDACTED image | {nREDACTED images',
      referenceImage: 'Reference images',
      removeReferenceImage: 'Remove reference image',
      limitsHint: 'Up to {maxPerItemREDACTED images per prompt and {maxPerJobREDACTED per job. The current model allows up to {refLimitREDACTED reference images per prompt; reference images consume input tokens once per generated image.',
      referenceCount: '{nREDACTED reference image | {nREDACTED reference images',
      ...
      refLimitReached: 'The current model allows up to {limitREDACTED reference images per prompt.',
      refLimitExceededIgnored: 'The current model allows up to {limitREDACTED reference images per prompt. Extra files were ignored.',
      refFormatUnsupported: 'Reference images must be PNG, JPEG, or WebP.',
      refFileTooLarge: '{nameREDACTED exceeds 10MB and was ignored.',
    REDACTED,
    guide: {
    ...
    messages: {
      ...
      errorCodeRef: 'code: {codeREDACTED',
      requestIdRef: 'request ID: {idREDACTED',
      httpStatusRef: 'HTTP status: {statusREDACTED',
    REDACTED,
  REDACTED,
REDACTED
