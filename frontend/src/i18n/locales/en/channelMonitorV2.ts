...
export default {
  channelMonitorV2: {
    ...
    metrics: {
      ...
      successRateValue: 'Success rate {valueREDACTED',
      errorRateValue: 'Error rate {valueREDACTED',
      rpmValue: 'RPM {valueREDACTED',
      tpmValue: 'TPM {valueREDACTED',
      tpsValue: 'Tokens/s {valueREDACTED',
      ttftValue: 'First token {valueREDACTED',
      durationValue: 'Duration {valueREDACTED',
      cacheRateValue: 'Cache rate {valueREDACTED',
    REDACTED,
    ...
    matrix: {
      title: 'Availability trend', description: 'Each row is a channel dimension and each block is an aggregate interval; hover for details', wheelZoom: 'Scroll over blocks to zoom in (narrower range, wider blocks)', wheelZoomX: 'Scroll over blocks to zoom in (narrower range, wider blocks)', dimension: 'Channel dimension', emptyTitle: 'No matrix data for the selected window', legendAria: 'Health score legend', bad: 'Bad', good: 'Good', healthyLegend: 'Healthy (≥80)', warningLegend: 'Watch (50–79)', criticalLegend: 'Critical (<50)', unknownLegend: 'No traffic / insufficient samples', noTraffic: 'No traffic in this interval', noTrafficAt: '{timeREDACTED · no traffic', scoreLine: 'Health score {scoreREDACTED', resetZoom: 'Reset zoom'
    REDACTED,
    chart: {
