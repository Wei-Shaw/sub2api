export default {
	common: {
		...
		peakRateImageNote:
			"; image tokens billed as tokens are also affected, per-image billing is unaffected",
		save: "Save",
	...
	adminCompliance: {
		...
		inputMismatch:
			"The confirmation phrase does not match. Type the displayed text exactly.",
		legalNote:
	...
	legal: {
		...
		notFoundDescription:
			"This legal document does not exist or has been removed by an administrator.",
		...
		loginAgreementPrompt: {
			...
			noticeDescription:
				"Account/password login and quick sign-in stay disabled until you accept.",
			viewTerms: "View terms",
			dialogTitle: "Terms Update Notice",
			dialogDescription:
				"Our service terms were updated on {date}. Please read and accept the following terms before continuing.",
			recently: "recently",
			relatedDocuments: "Related documents",
			reject: "Reject",
			accept: "Accept and continue",
			loginRejectedWarning:
				"Account/password login and quick sign-in are disabled until you accept the latest terms.",
			loginRequiredWarning:
				"Please read and accept the latest terms before logging in.",
			registerRejectedWarning:
				"Registration and quick sign-in are disabled until you accept the latest terms.",
			registerRequiredWarning:
				"Please read and accept the latest terms before registering.",
		},
	},
	...
	auth: {
		...
		dingtalk: {
			...
			invalidPendingToken:
				"The registration token has expired. Please sign in with DingTalk again.",
			completeRegistration: "Complete Registration",
			completing: "Completing registration…",
			completeRegistrationFailed:
				"Registration failed. Please check your invitation code and try again.",
			...
			registrationDisabledRedirectToBind:
				"New account registration is currently disabled. Please bind to your existing account with its email and password.",
			error: {
				title: "DingTalk Sign-in Failed",
				csrf: "Login session expired, please scan again",
				corp_rejected:
					"Your DingTalk account is not part of this organization. Please contact administrator",
				dingtalk_not_enabled: "DingTalk login is not enabled",
				upstream_error:
					"DingTalk service is temporarily unavailable. Please try again later",
	...
	stepUp: {
		...
		verifyFailed: "Verification failed, please try again",
		notEnabled:
			"This operation requires two-factor authentication. Please enable TOTP in your profile first.",
