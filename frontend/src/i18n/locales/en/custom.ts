...
decodeSizeOnRspHint: 'When the upstream response omits the size field or returns size=auto, decode the b64_json content to recover the real width and height for billing. URL-only responses are not affected.',
    ...
    modelIntros: {
      ...
      fields: {
        ...
        schemaImportTitle: 'Import Schema',
        schemaImportHint: 'Paste JSON below or pick a local .json file. Clicking “Apply Import” overwrites the current form: input params / output params / result field / result type.',
        ...
        schemaImportShape: 'Invalid JSON shape. Expected { default_params, output_fields, result_field, result_type }',
