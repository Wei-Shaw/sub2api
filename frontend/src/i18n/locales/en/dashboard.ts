export default {
  ...
  keys: {
    ...
    editGroupPriority: 'Edit group priority',
    groupPriorityTitle: 'Group priority',
    groupPriorityHint: 'Requests stay on the first group. Standby groups are used only when the primary group has no available account for the requested model.',
    groupPrioritySelected: '{count} group(s) selected. Selection order is priority order.',
    groupPrioritySaved: 'Group priority saved',
