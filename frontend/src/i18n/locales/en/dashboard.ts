export default {
  ...
  usage: {
    ...
    endpoint: 'Endpoint',
    uaDistribution: 'Client Distribution (User-Agent)',
    uaClient: 'Client',
    uaRequests: 'Requests',
    uaShare: 'Share',
    uaVersion: 'Version',
    uaOther: 'Other',
    uaBrowser: 'Browser',
    uaMissing: 'Not provided',
    uaUnknown: 'Unrecognized',
    uaUnknownVersion: 'Unknown version',
    uaLoadError: 'Failed to load client distribution',
    uaRetry: 'Retry',
    uaNoData: 'No usage data for the selected filters',
