export default {
  ...
  keys: {
    ...
    maxRateMultiplier: 'Maximum Allowed Multiplier',
    maxRateMultiplierPlaceholder: 'Leave empty for unlimited',
    maxRateMultiplierHint: 'Reject requests when the effective group multiplier (including your custom rate and peak multiplier) exceeds this value. Leave empty to disable; 0 only allows a zero multiplier.',
