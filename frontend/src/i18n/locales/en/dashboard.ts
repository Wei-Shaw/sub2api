export default {
  ...
  redeem: {
    title: 'Redeem Code',
    description: 'Enter your redeem code to add balance or increase standard concurrency',
    currentBalance: 'Current Balance',
    concurrency: 'Standard Concurrency',
    standardConcurrency: 'Standard Concurrency',
    ...
    newConcurrency: 'New Standard Concurrency',
    aboutCodes: 'About Redeem Codes',
    codeRule1: 'Each code can only be used once',
    codeRule2: 'Codes may add balance, increase standard concurrency, or grant trial access',
    codeRule3: 'Contact support if you have issues redeeming a code',
    codeRule4: 'Balance and standard concurrency updates are immediate',
    ...
    concurrencyAddedRedeem: 'Standard Concurrency Added (Redeem)',
    concurrencyAddedAdmin: 'Standard Concurrency Added (Admin)',
    concurrencyReducedAdmin: 'Standard Concurrency Reduced (Admin)',
    extraConcurrencyAddedAdmin: 'Extra Concurrency Added (Admin)',
    extraConcurrencyReducedAdmin: 'Extra Concurrency Reduced (Admin)',
  ...
  profile: {
    ...
    standardConcurrencyLimit: 'Standard Concurrency',
    extraConcurrencyLimit: 'Extra Concurrency',
    rpmLimit: 'RPM Limit',
