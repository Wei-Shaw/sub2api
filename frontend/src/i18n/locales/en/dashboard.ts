export default {
  ...
  usage: {
    ...
    diagnosis: {
      title: 'Request Diagnosis Details',
      close: 'Close',
      copy: 'Copy',
      copied: 'Copied',
      download: 'Download',
      loadFailed: 'Failed to load diagnosis details',
      tabOverview: 'Overview',
      tabRequest: 'Request Info',
      tabUpstream: 'Upstream',
      tabRequestShort: 'Request',
      tabResponse: 'Response',
      tabErrorResponse: 'Error Response',
      ...
      upstreamRequestBodyJson: 'Upstream Request Body · JSON',
      responseBodyJson: 'Response Body · JSON',
      responseHeaders: 'Response Headers',
      emptyBody: 'No body recorded.',
      emptyHeaders: 'No headers recorded.',
      emptyUpstreamRequest: 'No upstream request recorded.',
      jsonTruncated: 'JSON (truncated preview)',
      attempts: 'Attempts',
      attempt: 'Attempt #{n}',
      upstream: 'Upstream',
