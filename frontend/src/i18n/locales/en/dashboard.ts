export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      apiExamples: {
        hint: 'Copy this complete example to make a request. The expected response is included as a comment.',
        modelLabel: 'Test model',
        modelHint: 'Defaults to the group mapping. If unavailable, enter a model enabled by the administrator for this group.',
        sampleResponse: 'Sample response:',
        sampleOutput: 'Sample output:',
      },
      connection: {
        title: 'Test connection',
        description: 'Send a real request with this API key to verify the key, group routing, quota, and model. This request is recorded as normal usage.',
        inputLabel: 'Test input',
        loadModels: 'Load models',
        loadingModels: 'Loading…',
        loadModelsFailed: 'Failed to load models. Enter a model name manually.',
        noModels: 'The group returned no available models. Enter a model name manually.',
        test: 'Send test',
        testing: 'Sending…',
        success: 'Connected',
        failed: 'Failed',
        outputLabel: 'Actual response',
        timeout: 'The request exceeded 90 seconds and was cancelled.',
      },
      opencode: {
