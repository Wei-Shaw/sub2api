export default {
  ...
  keys: {
    ...
    rotate: {
      ...
      description: 'A new credential will be generated for this key record. Its name, group, concurrency limits, and usage history stay unchanged.',
      warning: 'The old key stops working immediately after rotation. Update every client that currently uses it.',
      acknowledge: 'I understand that the old key will stop working immediately',
      confirm: 'Confirm rotation',
      rotating: 'Rotating...',
      successTitle: 'API Key Rotated',
      successMessage: 'The new key is active',
      oldKeyInvalid: 'The old key can no longer be used.',
      preserved: 'Name, group, concurrency limits, quota, IP rules, expiration, and billing history are unchanged.',
      copied: 'New API key copied',
      done: 'I saved it, done',
      failed: 'Failed to rotate API key'
    },
    id: 'ID',
    apiKey: 'API Key',
    group: 'Group',
