export default {
  ...
  keys: {
    ...
    smartRoutingBadge: 'Smart routing',
    smartRoutingLabel: 'Smart routing',
    smartRoutingHint: 'When enabled, no fixed group is bound. The gateway automatically selects a group based on the requested model (you can exclude groups and set priorities/weights).',
    smartRoutingPriority: 'Priority',
    smartRoutingWeight: 'Weight',
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
