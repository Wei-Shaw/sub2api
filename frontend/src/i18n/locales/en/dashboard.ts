export default {
  ...
  keys: {
    ...
    orgSubscriptionLabel: 'Company Subscription',
    orgSubscriptionNone: 'None (use personal group)',
    orgSubscriptionHint: 'When bound, this key consumes the selected company subscription quota; the group is linked automatically.',
