export default {
  ...
  keys: {
    ...
    platformLimitsHint: 'In a composite group one key routes to several upstream platforms. These limits apply per source on top of the key-level limits above (either one being hit rejects the request). Sources not listed are not limited further.',
    platformLimitsAdd: 'Add source',
    platformLimitsPlatform: 'Upstream source',
    platformLimitsQuota: 'Total Quota (USD)',
    platformLimitsRemove: 'Remove this source',
    platformLimitsEmpty: 'No per-source limit configured yet.',
    platformLimitsAllUsed: 'All sources are already configured.',
    platformLimitsUsage: 'Usage on this source',
    resetPlatformUsage: 'Reset Per-Source Usage',
    resetPlatformUsageTitle: 'Confirm Reset Per-Source Usage',
    resetPlatformUsageConfirmMessage: 'Are you sure you want to reset the per-source limit usage for key "{name}"? Total quota and all time window usage on every source will be reset to zero. This action cannot be undone.',
    platformUsageResetSuccess: 'Per-source usage reset successfully',
    failedToResetPlatformUsage: 'Failed to reset per-source usage',
