export default {
  ...
  payment: {
    ...
    qr: {
      ...
      transferCopy: 'Copy transfer content',
      transferHint: 'Scan the QR with your banking app, or transfer manually. The amount and transfer content must match exactly — the order completes automatically once the transfer arrives.',
