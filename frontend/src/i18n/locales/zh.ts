export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "确定要重置 '{user}' 的 5h、每日、每周和每月用量配额吗？用量将归零并从当前时间重新计算。",
      ...
      guide: {
        title: '订阅管理教程',
        subtitle: '订阅模式允许你按时间周期为用户分配使用额度，支持 5h/日/周/月配额限制。按照以下步骤即可完成配置。',
        showGuide: '使用指南',
        step1: {
          title: '创建订阅分组',
          line1: '前往「分组管理」页面，点击「创建分组」',
          line2: '将计费类型设为「订阅」，配置 5h/日/周/月额度限制',
          line3: '保存分组，确保状态为「正常」',
          link: '前往分组管理'
        },
        step2: {
        ...
        actions: {
          ...
          resetQuota: '重置配额',
          resetQuotaDesc: '将 5h/日/周/月用量归零，重新开始计算',
          revoke: '撤销',
