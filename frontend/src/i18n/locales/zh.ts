export default {
  ...
  usage: {
    ...
    grossInputTokens: '总输入',
    netInputTokens: '净输入',
    effectiveInputUnitPrice: '实际输入单价',
    effectiveOutputUnitPrice: '实际输出单价',
    effectiveCacheReadUnitPrice: '实际缓存读取单价',
    ...
    rate: '倍率',
    baseRateMultiplier: '基础倍率',
    accountRateMultiplier: '账号倍率',
    priorityAccountMultiplier: '优先账号',
    effectiveMultiplier: '最终倍率',
    pricingSource: '价格来源',
    pricingSourcePriority: 'Fast/priority 单价生效',
    pricingSourcePriorityAccount: '优先账号 100x',
    sysHint: '如需避免优先账号高倍率，请优先使用 -Sys 变体',
    original: '原始',
    billed: '计费',
  ...
  admin: {
    ...
    usage: {
      ...
      allGroups: '全部分组',
      allTypes: '全部类型',
      allRoutingTargetGroups: '全部目标组',
      allRoutingScheduleLayers: '全部调度层',
      inputCost: '输入成本',
      outputCost: '输出成本',
      ...
      routedAccount: '命中账号',
      effectiveModel: '实际模型',
      routingFailover: '失败切换',
      routingFailoverReason: '切换结论',
      ipAddress: 'IP',
