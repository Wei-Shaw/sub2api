export default {
  ...
  admin: {
    ...
    ops: {
      ...
      cluster: {
        title: '集群状态',
        help: '展示部署实例的角色、在线状态、最近心跳和后台任务职责。',
        healthy: '健康',
        unknown: '未知',
        offline: '离线',
        noHeartbeats: '尚未收到实例心跳。',
        hoverForDetails: '鼠标悬浮查看实例详情。',
        onlineInstances: '在线实例',
        onlineMasters: '在线 Master',
        onlineSlaves: '在线 Slave',
        jobWarnings: '任务告警',
        master: 'Master',
        slave: 'Slave',
        standalone: '单机',
        lastSeen: '最近心跳：',
        startedAt: '启动时间：',
        backgroundJobsOn: '后台任务：开启',
        backgroundJobsOff: '后台任务：关闭'
      },
      active: '活跃',
      idle: '空闲',
      waiting: '等待',
