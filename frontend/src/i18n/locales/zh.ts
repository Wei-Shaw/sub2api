export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      sendingTestMessage: '发送测试消息："{message}"',
      ...
      testMessage: '测试信息',
      testMessagePlaceholder: '请输入测试信息',
      testClient: '测试客户端',
      testClientPlaceholder: 'User-Agent',
      testClientCodex: 'Codex CLI',
      testClientClaudeCode: 'Claude Code Codex 插件',
      testClientGemini: 'Gemini CLI',
      testClientAntigravity: 'Antigravity',
      testModel: '测试模型',
