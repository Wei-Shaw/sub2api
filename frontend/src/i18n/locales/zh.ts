export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: '导入会先创建或复用代理，再把账号导入到所选分组。开启巡查后，会在导入前跳过缺少凭证、已过期或代理引用无效的账号。',
      dataImportFile: '数据文件',
      dataImportButton: '开始导入',
      dataImporting: '导入中...',
      dataImportPreparing: '准备导入...',
      dataImportInspecting: '正在巡查账号...',
      dataImportInspectComplete: '巡查完成，等待确认导入',
      dataImportInspectToggle: '导入前巡查账号',
      dataImportInspectHint: '大批量导入建议开启。会在导入前跳过结构无效、缺少凭证、已过期或代理引用不存在的账号。',
      dataImportInspectFailed: '账号巡查失败',
      dataImportNoHealthyAccounts: '巡查后没有可导入的正常账号',
      dataImportGroupTitle: '导入分组',
      dataImportGroupHint: '选择正常账号要导入到哪个分组；不选则保持未分组。',
      dataImportNewGroup: '新建分组',
      dataImportNewGroupName: '分组名称',
      dataImportNewGroupNamePlaceholder: '例如 imported-openai',
      dataImportNewGroupPlatform: '平台',
      dataImportCreateGroupFailed: '创建分组失败',
      dataImportProgressScanned: '已巡查 {count}',
      dataImportProgressHealthy: '正常 {count}',
      dataImportProgressSkipped: '已跳过 {count}',
      dataImportProgressAbnormal: '异常 {count}',
      dataImportProgressImported: '已导入 {count}',
      ...
      dataImportImportedCount: '已导入 {count} 个账号',
      dataImportConfirmImport: '导入正常账号 {count} 个',
      dataImportInspectLog: '巡查输出',
      dataImportInspectLogCount: '共 {count} 条',
      dataImportInspectStatusNormal: '账号正常',
      dataImportInspectStatusError: '异常',
