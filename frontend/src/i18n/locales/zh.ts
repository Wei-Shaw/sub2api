export default {
  ...
  common: {
    ...
    submitting: '提交中...',
    justNow: '刚刚',
    peakRateTooltip: '高峰倍率：{windowREDACTED',
    ...
    time: {
      never: '从未',
      justNow: '刚刚',
      minutesAgo: '{nREDACTED分钟前',
      hoursAgo: '{nREDACTED小时前',
      daysAgo: '{nREDACTED天前',
      countdown: {
        daysHours: '{dREDACTEDd {hREDACTEDh',
        hoursMinutes: '{hREDACTEDh {mREDACTEDm',
        minutes: '{mREDACTEDm',
        withSuffix: '{timeREDACTED 后解除'
      REDACTED
    REDACTED
  REDACTED,
  ...
  legal: {
    ...
    loginAgreementPrompt: {
      ...
      viewTerms: '查看条款',
      dialogTitle: '条款更新通知',
      dialogDescription: '我们的服务条款已于 {dateREDACTED 更新。在继续使用服务之前，请仔细阅读并同意以下条款。',
      recently: '近期',
  ...
  auth: {
    ...
    signingIn: '登录中...',
    createAccount: '创建账户',
    signUpToStart: '注册以开始使用 {siteNameREDACTED',
    signUp: '注册',
    processing: '处理中...',
    continue: '继续',
    rememberMe: '记住我',
    ...
    emailSuffixNotAllowedWithAllowed: '该邮箱域名不被允许。可用域名：{suffixesREDACTED',
    emailSuffixAllowedMore: '等 {countREDACTED 项',
    loginSuccess: '登录成功！欢迎回来。',
    accountCreatedSuccess: '账户创建成功！欢迎使用 {siteNameREDACTED。',
    ...
    resendCountdown: '{countdownREDACTED秒后可重新发送',
    ...
    promoCodeValid: '有效！注册后将获得 ${amountREDACTED 赠送余额',
    ...
    REDACTED,
    emailOAuth: {
      signIn: '使用 {providerNameREDACTED 登录'
    REDACTED,
    oidc: {
      signIn: '使用 {providerNameREDACTED 登录',
      callbackTitle: '正在完成 {providerNameREDACTED 登录',
      callbackProcessing: '正在验证 {providerNameREDACTED 登录信息，请稍候...',
      callbackHint: '如果页面未自动跳转，请返回登录页重试。',
      callbackMissingToken: '登录信息缺失，请返回重试。',
      backToLogin: '返回登录',
      invitationRequired: '该 {providerNameREDACTED 账号尚未注册，站点已开启邀请码注册，请输入邀请码以完成注册。',
    ...
    REDACTED,
    oauthFlow: {
      profileDetailsTitle: '使用 {providerNameREDACTED 资料',
      profileDetailsDescription: '选择是否将 {providerNameREDACTED 的昵称或头像应用到当前账户。',
      useDisplayName: '使用昵称',
      useAvatar: '使用头像',
      avatarAlt: '{providerNameREDACTED 头像',
      reviewProfileBeforeContinue: '请先确认 {providerNameREDACTED 资料后再继续。',
      chooseHowToContinue: '选择后续操作',
      chooseAccountActionHint: '请选择绑定已有账户，或创建一个新账户。',
      suggestedEmail: '建议邮箱：{emailREDACTED',
      bindExistingAccount: '绑定已有账户',
      createNewAccount: '创建新账户',
      createAccountHint: '请输入邮箱地址以创建账户并继续。',
      bindLoginHint: '登录一个已有账户以绑定此次 {providerNameREDACTED 登录。',
      signInThenBindDescription: '请先登录已有账户，再将此次 {providerNameREDACTED 登录绑定到该账户。',
      bindSignInToExistingAccount: '将此次 {providerNameREDACTED 登录绑定到已有账户。',
      bindCurrentAccountTitle: '绑定当前账户',
      bindCurrentAccountDescription: '将此次 {providerNameREDACTED 登录绑定到当前浏览器已登录的账户。',
      bindCurrentAccount: '绑定当前账户',
      logInAndBind: '登录并绑定',
      useDifferentEmail: '使用其他邮箱',
      backToOptions: '返回选项',
      yourAccount: '当前账户',
      totpHint: '请输入 {accountREDACTED 的 6 位验证码，以完成此次 {providerNameREDACTED 登录绑定。',
  ...
  dashboard: {
    ...
    platformCount: '{countREDACTED 个平台',
    platformOther: '其他',
    platformQuota: {
      title: '配额用量',
      daily: '日',
  ...
  keys: {
    ...
    editKey: '编辑密钥',
    deleteKey: '删除密钥',
    deleteConfirmMessage: "确定要删除 '{nameREDACTED' 吗？此操作无法撤销。",
    apiKey: 'API 密钥',
    group: '分组',
    ...
    resetQuotaConfirmMessage: '确定要将密钥 "{nameREDACTED" 的已用额度（${usedREDACTED）重置为 0 吗？此操作不可撤销。',
    ...
    resetRateLimitConfirmMessage: '确定要重置密钥 "{nameREDACTED" 的速率限制用量吗？所有时间窗口的已用额度将归零。此操作不可撤销。',
    rateLimitResetSuccess: '速率限制已重置',
    failedToResetRateLimit: '重置速率限制失败',
    resetNow: '即将重置',
    expiration: '密钥有效期',
    expiresInDays: '{daysREDACTED 天',
    extendDays: '+{daysREDACTED 天',
    customDate: '自定义',
    expirationDate: '过期时间',
  ...
  usage: {
    ...
    exportedCount: '已导出 {currentREDACTED/{totalREDACTED 条',
    estimatedTime: '预计剩余时间：{timeREDACTED',
    cancelExport: '取消导出',
    ...
    ipGeo: {
      ...
      batchFetch: '批量获取地区',
      batchFetching: '获取中...',
      pending: '{countREDACTED 个 IP 待获取地区',
    ...
    REDACTED,
    tabs: { usage: '用量明细', errors: '错误请求' REDACTED,
    errors: {
  ...
  monitorCommon: {
    ...
    history60pts: '近 {nREDACTED 次记录',
    nextUpdateIn: '{nREDACTEDs 后刷新',
    past: 'PAST',
    now: 'NOW',
    maintenancePaused: '维护中 · 已暂停时间线采集',
    extraModelsCount: '+ {nREDACTED 模型',
    pollEvery: '{nREDACTEDs 轮询',
    updatedAt: '更新于 {timeREDACTED',
    relativeSecondsAgo: '{nREDACTED 秒前',
    relativeMinutesAgo: '{nREDACTED 分钟前',
    relativeHoursAgo: '{nREDACTED 小时前',
    relativeDaysAgo: '{nREDACTED 天前'
  REDACTED,
  ...
  affiliate: {
    ...
    tips: {
      ...
      line2: '被邀请用户充值后，你可获得 {rateREDACTED 的返利额度。',
      line3: '返利额度可随时转入账户余额。',
  ...
  redeem: {
    ...
    subscriptionAssignedDesc: '您已获得 {groupNameREDACTED 的访问权限',
    subscriptionDays: '{daysREDACTED 天',
    days: '天',
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      resend: '重发',
      codeSent: '验证码已发送',
      codeSentTo: '验证码已发送到 {emailREDACTED',
      enterCode: '输入验证码',
    ...
    authBindings: {
      ...
      bindAction: '绑定 {providerNameREDACTED',
      bindSuccess: '账号绑定成功',
      emailPlaceholder: '输入邮箱地址',
      ...
      unbindAction: '解绑',
      unbindSuccess: '{providerNameREDACTED 已解绑',
      boundCount: '已关联 {countREDACTED 条记录',
      status: {
        bound: '已绑定',
        notBound: '未绑定',
      REDACTED,
      ...
      REDACTED,
      source: {
        avatar: '头像当前来自 {providerNameREDACTED',
        username: '昵称当前来自 {providerNameREDACTED',
      REDACTED,
    REDACTED
  REDACTED,
  ...
  pagination: {
    ...
    results: '条结果',
    page: '页',
    pageOf: '第 {pageREDACTED / {totalREDACTED 页',
    previous: '上一页',
    next: '下一页',
    perPage: '每页',
    goToPage: '跳转到第 {pageREDACTED 页',
    jumpTo: '跳转页',
    jumpPlaceholder: '页码',
    jumpAction: '跳转'
  REDACTED,
  ...
  admin: {
    ...
    dataManagement: {
      ...
      sourceProfiles: {
        ...
        editTitle: '编辑数据源配置',
        empty: '暂无配置，请先创建',
        deleteConfirm: '确定删除配置 {profileIDREDACTED 吗？',
        columns: {
          profile: '配置',
          active: '激活状态',
          connection: '连接信息',
      ...
      s3Profiles: {
        ...
        deleteConfirm: '确定删除 S3 账号 {profileIDREDACTED 吗？',
        columns: {
          profile: '账号',
          active: '激活状态',
          storage: '存储配置',
      ...
      actions: {
        ...
        createBackup: '创建备份任务',
        jobCreated: '备份任务已创建：{jobIDREDACTED（{statusREDACTED）',
        refreshJobs: '刷新任务',
        loadMore: '加载更多'
      REDACTED
    REDACTED,
    ...
    users: {
      ...
      editUser: '编辑用户',
      deleteUser: '删除用户',
      deleteConfirmMessage: "确定要删除用户 '{emailREDACTED' 吗？此操作无法撤销。",
      ...
      noSubscription: '暂无订阅',
      publicGroupCount: '+{countREDACTED 公开',
      exclusiveLabel: '专属',
      publicLabel: '公开',
      daysRemaining: '{daysREDACTED天',
      expired: '已过期',
      disable: '禁用',
      enable: '启用',
      disableUser: '禁用用户',
      ...
      groupChangedWithGrant: '分组修改成功，已自动为用户添加「{groupREDACTED」分组权限',
      ...
      deleteConfirm: "确定要删除用户 '{emailREDACTED' 吗？此操作无法撤销。",
      roles: {
        admin: '管理员',
        user: '用户'
      REDACTED,
      ...
      // 用户分组配置
      groupConfig: '用户分组配置',
      groupConfigHint: '为用户 {emailREDACTED 配置专属分组倍率（覆盖分组默认倍率）',
      ...
      replaceGroupHint: '选择新分组替换「{oldREDACTED」，将自动迁移绑定的 Key 并更新分组权限',
      replaceGroupConfirm: '确认替换',
      replaceGroupSuccess: '分组替换成功，已迁移 {countREDACTED 个 Key',
      ...
      attributes: {
        ...
        deleteConfirm: "确定要删除属性 '{nameREDACTED' 吗？所有用户的该属性值将被删除。",
      ...
      platformQuota: {
        menuItem: '平台限额',
        title: '平台限额',
        subtitle: '为用户 {emailREDACTED 配置各上游平台的日 / 周 / 月用量上限',
        columns: {
          platform: '平台',
          daily: '日 (USD)',
          weekly: '周 (USD)',
        ...
        reset: {
          button: '重置该窗口',
          confirm: '确认重置该用户 {platformREDACTED 平台的 {windowREDACTED 用量？此操作立即生效。',
          success: '已重置 {platformREDACTED {windowREDACTED 用量',
          failed: '重置失败',
        REDACTED,
        ...
        invalidNumber: '以下字段填写不是合法数字，请修正后再保存：{fieldsREDACTED',
      REDACTED
    REDACTED,
    ...
    groups: {
      ...
      deleteConfirm: "确定要删除分组 '{nameREDACTED' 吗？所有关联的 API 密钥将不再属于任何分组。",
      deleteConfirmSubscription:
        "确定要删除订阅分组 '{nameREDACTED' 吗？此操作会让所有绑定此订阅的用户的 API Key 失效，并删除所有相关的订阅记录。此操作无法撤销。",
      columns: {
        name: '名称',
        platform: '平台',
        rateMultiplier: '费率倍数',
      ...
      nonExclusive: '公开',
      public: '公开',
      rateAndAccounts: '{rateREDACTEDx 费率 · {countREDACTED 个账号',
      accountsCount: '{countREDACTED 个账号',
      rateLabel: '倍率',
      accountFilters: {
        title: '账号过滤控制',
      ...
      modelsList: {
        ...
        loading: '正在加载模型列表...',
        empty: '暂无可展示模型',
        selectedSummary: '已选 {selectedREDACTED / {totalREDACTED',
        selectAll: '全选',
        invertSelection: '反选'
      REDACTED,
      claudeCode: {
    ...
    channels: {
      ...
      duplicateModels: '模型「{0REDACTED」在多个定价条目中重复',
      modelConflict: "模型模式 '{model1REDACTED' 和 '{model2REDACTED' 冲突：匹配范围重叠。模型名称按大小写不敏感匹配，已有条目已覆盖其所有大小写变体，无需重复添加。",
      mappingConflict: "模型映射源 '{model1REDACTED' 和 '{model2REDACTED' 冲突：匹配范围重叠。源模式按大小写不敏感匹配，已有条目已覆盖其所有大小写变体。",
      intervalValidation: {
        negativeMin: '区间 #{indexREDACTED：最小 token 数（{valueREDACTED）不能为负数',
        maxPositive: '区间 #{indexREDACTED：最大 token 数（{valueREDACTED）必须大于 0',
        maxGreaterThanMin: '区间 #{indexREDACTED：最大 token 数（{maxREDACTED）必须大于最小 token 数（{minREDACTED）',
        negativePrice: '区间 #{indexREDACTED：{fieldREDACTED不能为负数',
        unboundedLast: '区间 #{indexREDACTED：无上限区间（最大 token 数为空）必须放在最后',
        overlap: '区间 #{previousIndexREDACTED 和 #{currentIndexREDACTED 重叠：前一个上界（{previousMaxREDACTED）大于当前下界（{currentMinREDACTED）',
        price: {
          inputPrice: '输入价格',
          outputPrice: '输出价格',
        ...
        REDACTED
      REDACTED,
      deleteConfirm: '确定要删除渠道「{nameREDACTED」吗？此操作不可撤销。',
      columns: {
        name: '名称',
        description: '描述',
        status: '状态',
      ...
      form: {
        ...
        inOtherChannel: '已属于「{nameREDACTED」',
        modelPricing: '模型定价',
        models: '模型列表',
        ...
        syncingModels: '同步中...',
        syncModelsSuccess: '已同步 {countREDACTED 个新模型',
    ...
    riskControl: {
      ...
      apiKeyCount: '{countREDACTED 个 Key',
      ...
      apiKeysHint: '当前已保存 {countREDACTED 个 Key；输入区只用于新增，保存时会增量追加并自动去重。',
      ...
      apiKeyPendingDeleteCount: '待删除 {countREDACTED 个 Key',
      deleteApiKey: '删除这个 Key',
      undoDeleteApiKey: '撤销删除',
      inputApiKeyCount: '输入区 {countREDACTED 个 Key',
      storedApiKeyCount: '已保存 {countREDACTED 个 Key',
      ...
      apiKeyTestDone: 'Key 测试完成，共 {countREDACTED 个',
      ...
      apiKeyRows: '{countREDACTED 个 Key',
      apiKeyRowsCollapsed: '已隐藏 {countREDACTED 个 Key',
      apiKeyRowsExpanded: '正在显示全部 {countREDACTED 个 Key',
      expandApiKeyRows: '展开',
      ...
      apiKeyFailureCount: '失败 {countREDACTED 次',
      apiKeyLatency: '{msREDACTED ms',
      apiKeyHTTPStatus: 'HTTP {statusREDACTED',
      apiKeyFrozenUntil: '冻结至 {timeREDACTED',
      apiKeyLastChecked: '检查于 {timeREDACTED',
      ...
      clearAuditTest: '清空试跑',
      auditTestImageLimit: '最多只能添加 {countREDACTED 张测试图片',
      auditTestImageTooLarge: '单张测试图片不能超过 8MB',
      auditTestImageReadFailed: '读取测试图片失败',
      auditTestResult: '审计试跑结果',
      auditTestHighest: '最高分类 {categoryREDACTED，分数 {scoreREDACTED',
      ...
      flaggedHashCount: '当前哈希集合数量：{countREDACTED 个',
      ...
      flaggedHashesCleared: '已清空 {countREDACTED 个风险哈希',
      ...
      violationCount: '{countREDACTED 次',
      emailSent: '已发邮件',
      emailNotSent: '未发邮件',
      autoBanned: '已封禁',
      unbanUser: '解封',
      ...
      modelFilterModelCount: '已配置 {countREDACTED 个模型',
      modelFilterModelsRequired: '当前模型范围至少需要配置 1 个模型',
      modelFilterAllSummary: '全部模型生效',
      modelFilterIncludeSummary: '仅 {countREDACTED 个模型生效',
      modelFilterExcludeSummary: '排除 {countREDACTED 个模型',
      emptyLogs: '暂无审核记录',
      ...
      preBlockAPIKeyLoadSummary: '同步并发 {activeREDACTED / 可用 Key {availableREDACTED，累计 {totalREDACTED 次，worker：{workerActiveREDACTED / {workerTotalREDACTED',
      preBlockAPIKeyTotals: '累计 {totalREDACTED，成功 {successREDACTED，异常 {errorsREDACTED',
      ...
      workerPool: 'Worker 池',
      workerPoolMeta: '{activeREDACTED 个处理中，{idleREDACTED 个空闲可用，共 {totalREDACTED 个',
      queueUsage: '队列占用',
      activeWorkers: '处理中',
      idleWorkers: '空闲可用',
      ...
      lastCleanup: '上次清理：{timeREDACTED',
      cleanupStats: '上次清理删除命中 {hitREDACTED 条，未命中 {nonHitREDACTED 条',
      riskSwitchOff: '系统开关关闭',
      riskThresholds: '风险阈值',
      riskThresholdsHint: '按 OpenAI Moderations 分类调整命中阈值，分数达到或超过阈值即视为命中。',
      riskThresholdDefault: '默认 {valueREDACTED',
      ...
      blockedKeywordsModeWarning: '当前为「{modeREDACTED」模式，关键词拦截不会生效；请切换到「前置拦截」模式后再保存关键词。',
      blockedKeywordCount: '已配置 {countREDACTED 个关键词',
      blockedKeywordsLimit: '最多保存 {maxREDACTED 个关键词，单个长度不超过 200 个字符；重复项会自动去重。',
    ...
    channelMonitor: {
      ...
      loadError: '加载监控列表失败',
      deleteConfirm: '确定要删除监控「{nameREDACTED」吗？此操作不可撤销。',
      ...
      advanced: {
        ...
        headerNameInvalid: 'Header 名不能包含空格或冒号：{nameREDACTED',
        headersHint: '与默认请求头合并，用户值优先。hop-by-hop 类 header（Host/Content-Length/...）会被忽略。',
        headersParseError: '无法解析这一行：{lineREDACTED',
        bodyMode: '请求体处理',
        bodyModeOff: '默认',
        bodyModeMerge: '合并',
        bodyModeReplace: '覆盖',
      ...
      template: {
        ...
        applyTitle: '应用模板',
        applyConfirm: '确认应用',
        applyConfirmMessage: '将把模板「{nameREDACTED」的当前配置覆盖到 {nREDACTED 个关联监控。监控本地已编辑的自定义修改会被丢弃，是否继续？',
        applySuccess: '已应用到 {nREDACTED 个监控',
        applyPickerTitle: '应用模板「{nameREDACTED」',
        applyPickerHint: '勾选要覆盖请求头/请求体的监控（默认全选）。监控本地已编辑的自定义修改会被丢弃。',
        applyPickerEmpty: '当前模板没有关联监控',
        applyPickerConfirm: '应用到 {nREDACTED 个监控',
        selectNone: '全不选',
        selectedCount: '已选 {nREDACTED / {totalREDACTED',
        deleteConfirm: '确定要删除模板「{nameREDACTED」吗？{nREDACTED 个关联监控会解除关联但保留自己的快照继续工作。',
        associatedCount: '{nREDACTED 个关联监控',
        headersSummary: '{nREDACTED 个自定义请求头',
        form: {
          name: '模板名称',
    ...
    subscriptions: {
      ...
      quotaEndsInMinutes: '额度将在 {minutesREDACTED 分钟后结束',
      quotaEndsInHoursMinutes: '额度将在 {hoursREDACTED 小时 {minutesREDACTED 分钟后结束',
      quotaEndsInDaysHours: '额度将在 {daysREDACTED 天 {hoursREDACTED 小时后结束',
      daysRemaining: '天剩余',
      remainingDays: '剩余天数',
      noExpiration: '无过期时间',
      status: {
      ...
      resetQuotaConfirm: "确定要重置 '{userREDACTED' 的每日、每周和每月用量配额吗？用量将归零并从今天开始重新计算。",
      ...
      revokeConfirm: "确定要撤销 '{userREDACTED' 的订阅吗？可稍后在已撤销列表中恢复。",
      restoreConfirm: "确定要恢复 '{userREDACTED' 的订阅吗？如果原订阅已过期，恢复后将显示为已过期。",
      guide: {
        title: '订阅管理教程',
    ...
    accounts: {
      ...
      autoRefreshCountdown: '自动刷新：{secondsREDACTEDs',
      ...
      toolActions: '工具',
      viewColumns: '列显示',
      selectedCount: '已选 {countREDACTED',
      dataExportConfirmMessage: '导出的数据包含账号与代理的敏感信息，请妥善保存。',
      dataExportConfirm: '确认导出',
      dataExported: '数据导出成功',
      dataExportedSkippedShadows: '数据已导出。已跳过 {countREDACTED 个 spark 影子账号：其调度配置不在备份内，还原后需在重建的影子上重新调优。',
      ...
      dataImportParseFailedFile: '文件 {nameREDACTED 解析失败',
      dataImportInvalidFile: '文件 {nameREDACTED 不是受支持的导出数据文件',
      dataImportIgnoredFiles: '已忽略 {countREDACTED 个非 JSON 文件',
      dataImportFailed: '数据导入失败',
      dataImportResult: '导入结果',
      dataImportResultSummary: '代理创建 {proxy_createdREDACTED，复用 {proxy_reusedREDACTED，失败 {proxy_failedREDACTED；账号创建 {account_createdREDACTED，失败 {account_failedREDACTED',
      dataImportErrors: '失败详情',
      dataImportSuccess: '导入完成：账号 {account_createdREDACTED，失败 {account_failedREDACTED',
      dataImportCompletedWithErrors: '导入完成但有错误：账号失败 {account_failedREDACTED，代理失败 {proxy_failedREDACTED',
      ...
      syncResult: '同步结果',
      syncResultSummary: '创建 {createdREDACTED，更新 {updatedREDACTED，跳过 {skippedREDACTED，失败 {failedREDACTED',
      syncErrors: '错误/跳过详情',
      syncCompleted: '同步完成：创建 {createdREDACTED，更新 {updatedREDACTED，跳过 {skippedREDACTED',
      syncCompletedWithErrors: '同步完成但有错误：失败 {failedREDACTED（创建 {createdREDACTED，更新 {updatedREDACTED，跳过 {skippedREDACTED）',
      syncFailed: '同步失败',
      crsPreview: '预览',
      crsPreviewing: '预览中...',
      ...
      crsWillUpdate: '将更新 {countREDACTED 个已有账号。',
      crsSelectedCount: '已选择 {countREDACTED 个新账号',
      crsUpdateBehaviorNote:
        '已有账号仅同步 CRS 返回的字段，缺失字段保持原值；凭据按键合并，不会清空未下发的键；未勾选"同步代理"时保留原有代理。',
      crsBack: '返回',
      editAccount: '编辑账号',
      deleteAccount: '删除账号',
      deleteConfirmMessage: "确定要删除账号 '{nameREDACTED' 吗？",
      ...
      groupCountTotal: '共 {countREDACTED 个分组',
      columns: {
        name: '名称',
        id: '账号ID',
        platformType: '平台/类型',
      ...
      capacity: {
        ...
        REDACTED,
        sessions: {
          full: '活跃会话已满，新会话需等待（空闲超时：{idleREDACTED分钟）',
          normal: '活跃会话正常（空闲超时：{idleREDACTED分钟）'
        REDACTED,
        rpm: {
          full: '已达 RPM 上限',
          warning: 'RPM 接近上限',
          ...
          tieredStickyOnly: 'RPM 限制 (三区模型) - 仅粘性会话 | 缓冲区: {bufferREDACTED',
          tieredBlocked: 'RPM 限制 (三区模型) - 已阻塞 | 缓冲区: {bufferREDACTED',
      ...
      quotaDailyLimitHintFixed: '每天 {hourREDACTED:00（{timezoneREDACTED）重置。',
      quotaWeeklyLimitHintFixed: '每{dayREDACTED {hourREDACTED:00（{timezoneREDACTED）重置。',
      dayOfWeek: {
        monday: '周一',
        tuesday: '周二',
        wednesday: '周三',
      ...
      apiKey: 'API Key',
      deleteConfirm: "确定要删除账号 '{nameREDACTED' 吗？此操作无法撤销。",
      ...
      status: {
        ...
        quotaExceeded: '配额超限',
        unschedulable: '不可调度',
        rateLimitedUntil: '限流中，当前不参与调度，预计 {timeREDACTED 自动恢复',
        rateLimitedAutoResume: '{timeREDACTED 自动恢复',
        modelRateLimitedUntil: '{modelREDACTED 限流至 {timeREDACTED',
        modelCreditOveragesUntil: '{modelREDACTED 正在使用 AI Credits，至 {timeREDACTED',
        creditsExhausted: '积分已用尽',
        creditsExhaustedUntil: 'AI Credits 已用尽，预计 {timeREDACTED 恢复',
        overloadedUntil: '负载过重，重置时间：{timeREDACTED',
      ...
      tempUnschedulable: {
        ...
        expired: '已到期',
        remainingMinutes: '约 {minutesREDACTED 分钟',
        remainingHours: '约 {hoursREDACTED 小时',
        remainingHoursMinutes: '约 {hoursREDACTED 小时 {minutesREDACTED 分钟',
        presets: {
      ...
      usageWindow: {
        ...
        grokRetryAfter: '{timeREDACTED 后重试',
        grokProbe: '探测',
        ...
        grokLastStatus: '状态 {statusREDACTED',
        grokLastProbe: '探测 {timeREDACTED',
        grokLastHeadersSeen: '响应头 {timeREDACTED',
        passiveSampled: '被动采样',
        activeQuery: '查询'
      REDACTED,
      openaiQuotaReset: {
        ...
        expiresAt: '到期 {timeREDACTED',
        expiresAtFull: '重置次数到期时间: {timeREDACTED',
        expandExpirations: '展开其余 {countREDACTED 张重置次数到期时间',
        collapseExpirations: '收起重置次数到期时间',
        expirationDetails: '重置次数到期明细',
        noCreditsAvailable: '没有可用的重置次数',
        resetSuccess: '已重置 {windowsREDACTED 个窗口',
        confirmTitle: '确认重置周限',
        confirmMessage: '将消耗 1 次重置次数立即恢复当前窗口，剩余 {countREDACTED 次。此操作不可撤销，确定继续吗？'
      REDACTED,
      tier: {
        free: 'Free',
        pro: 'Pro',
      ...
      bulkSchedulableEnabled: '成功启用 {countREDACTED 个账号的调度',
      bulkSchedulableDisabled: '成功停止 {countREDACTED 个账号的调度',
      bulkSchedulablePartial: '部分调度更新成功：成功 {successREDACTED 个，失败 {failedREDACTED 个',
      bulkSchedulableResultUnknown: '批量调度结果不完整，请稍后重试或刷新列表',
      bulkActions: {
        selected: '已选择 {countREDACTED 个账号',
        ...
        resetStatus: '批量重置状态',
        refreshToken: '批量刷新令牌',
        resetStatusSuccess: '已成功重置 {countREDACTED 个账号状态',
        refreshTokenSuccess: '已成功刷新 {countREDACTED 个账号令牌',
        partialSuccess: '操作部分完成：{successREDACTED 成功，{failedREDACTED 失败'
      REDACTED,
      bulkEdit: {
        title: '批量编辑账号',
        selectionInfo: '已选择 {countREDACTED 个账号。只更新您勾选或填写的字段，未勾选的字段保持不变。',
        baseUrlPlaceholder: 'https://api.anthropic.com 或 https://api.openai.com',
        baseUrlNotice: '仅适用于 API Key 账号，留空则不修改',
        submit: '批量更新',
        updating: '更新中...',
        success: '成功更新 {countREDACTED 个账号',
        partialSuccess: '部分更新成功：成功 {successREDACTED 个，失败 {failedREDACTED 个',
        failed: '批量更新失败',
        noSelection: '请选择要编辑的账号',
        noFieldsSelected: '请至少选择一个要更新的字段',
        mixedPlatformWarning: '所选账号跨越多个平台（{platformsREDACTED）。显示的模型映射预设为合并结果——请确保映射对每个平台都适用。'
      REDACTED,
      bulkDeleteTitle: '批量删除账号',
      bulkDeleteConfirm: '确定要删除选中的 {countREDACTED 个账号吗？此操作无法撤销。',
      bulkDeleteSuccess: '成功删除 {countREDACTED 个账号',
      bulkDeletePartial: '部分删除成功：成功 {successREDACTED 个，失败 {failedREDACTED 个',
      ...
      fallbackActive: '已回退',
      fallbackActiveTip: '原代理 {originREDACTED 已到期，当前使用备用代理',
      revertProxy: '切回原代理',
      revertProxySuccess: '已成功切回原代理',
      revertProxyFailed: '切回原代理失败',
      createSparkShadow: '创建 Spark 影子账号',
      createSparkShadowConfirm: '为「{nameREDACTED」创建链接型 Spark 影子账号?影子共享母账号凭据、仅服务 spark 模型。',
      ...
      selectedModels: '已选择 {countREDACTED 个模型',
      supportsAllModels: '（支持所有模型）',
      requestModel: '请求模型',
      actualModel: '实际模型',
      addMapping: '添加映射',
      mappingExists: '模型 {modelREDACTED 的映射已存在',
      ...
      syncUpstreamModelsSuccess: '已从上游同步 {countREDACTED 个新模型（上游共 {totalREDACTED 个）',
      syncUpstreamModelsNoChanges: '上游 {countREDACTED 个模型均已在白名单中',
      syncUpstreamModelsEmpty: '上游没有返回可同步的模型',
      syncUpstreamModelsFailed: '同步上游模型失败',
      syncUpstreamModelsError: '同步上游模型失败：{messageREDACTED',
      clearAllModels: '清除所有模型',
      customModelName: '自定义模型名称',
      enterCustomModelName: '输入自定义模型名称',
      addModel: '填入',
      modelExists: '该模型已存在',
      modelCount: '{countREDACTED 个模型',
      poolMode: '池模式',
      ...
      poolModeRetryCountHint: '仅在池模式下生效。0 表示不原地重试；默认 {defaultREDACTED，最大 {maxREDACTED。',
      poolModeRetryStatusCodes: '同账号重试状态码',
      poolModeRetryStatusCodesHint: '仅在池模式下生效。以英文逗号分隔的 HTTP 状态码（100-599），命中时触发同账号重试。留空使用默认值（{defaultREDACTED）。',
      ...
      affinityClients: '{countREDACTED 个亲和客户端：',
      ...
      mixedChannelWarning: '警告：分组 "{groupNameREDACTED" 中同时包含 {currentPlatformREDACTED 和 {otherPlatformREDACTED 账号。混合使用不同渠道可能导致 thinking block 签名验证问题，会自动回退到非 thinking 模式。确定要继续吗？',
      ...
      oauth: {
        ...
        keysCount: '{countREDACTED 个密钥',
        batchCreateAccounts: '将批量创建 {countREDACTED 个账号',
        ...
        keyAuthFailed: '密钥 {indexREDACTED: {errorREDACTED',
        successCreated: '成功创建 {countREDACTED 个账号',
        batchSuccess: '成功创建 {countREDACTED 个账号',
        batchPartialSuccess: '部分成功：{successREDACTED 个成功，{failedREDACTED 个失败',
        batchFailed: '批量创建失败',
        // OpenAI specific
        openai: {
          title: 'OpenAI 账户授权',
          ...
          codexSessionImportSuccess: '导入完成：新增 {createdREDACTED，更新 {updatedREDACTED，跳过 {skippedREDACTED',
          codexSessionImportPartial: '部分成功：新增 {createdREDACTED，更新 {updatedREDACTED，跳过 {skippedREDACTED，失败 {failedREDACTED',
      ...
      copyOutput: '复制输出',
      outputCopied: '输出已复制',
      startingTestForAccount: '开始测试账号：{nameREDACTED',
      testAccountTypeLabel: '账号类型：{typeREDACTED',
      ...
      imagePreview: '生成结果：',
      imageReceived: '已收到第 {countREDACTED 张测试图片',
      // Stats Modal
      viewStats: '查看统计',
      ...
      stats: {
        ...
        totalCalls: '累计调用次数',
        avgDailyCost: '日均费用',
        basedOnActualDays: '基于 {daysREDACTED 天实际使用',
    ...
    proxies: {
      ...
      ad: {
        inline: '正在寻找合适的代理 IP？'
      REDACTED,
      deleteConfirmMessage: "确定要删除代理 '{nameREDACTED' 吗？",
      testProxy: '测试代理',
      dataImport: '导入',
      dataExportSelected: '导出选中',
      ...
      dataImportFailed: '数据导入失败',
      dataImportResult: '导入结果',
      dataImportResultSummary: '创建 {proxy_createdREDACTED，复用 {proxy_reusedREDACTED，失败 {proxy_failedREDACTED',
      dataImportErrors: '失败详情',
      dataImportSuccess: '导入完成：创建 {proxy_createdREDACTED，复用 {proxy_reusedREDACTED',
      dataImportCompletedWithErrors: '导入完成但有错误：失败 {proxy_failedREDACTED',
      dataExport: '导出',
      ...
      batchTestDone: '批量测试完成，共测试 {countREDACTED 个代理',
      batchTestFailed: '批量测试失败',
      batchDeleteAction: '删除',
      batchDelete: '批量删除',
      batchDeleteConfirm: '确定删除选中的 {countREDACTED 个代理吗？已被账号使用的将自动跳过。',
      batchDeleteDone: '已删除 {deletedREDACTED 个代理，跳过 {skippedREDACTED 个',
      batchDeleteSkipped: '已跳过 {skippedREDACTED 个代理',
      ...
      batchInputHint: "支持 http、https、socks5 协议，格式：协议://[用户名:密码{'@'REDACTED]主机:端口",
      parsedCount: '有效 {countREDACTED 个',
      invalidCount: '无效 {countREDACTED 个',
      duplicateCount: '重复 {countREDACTED 个',
      importing: '导入中...',
      importProxies: '导入 {countREDACTED 个代理',
      batchImportSuccess: '成功导入 {createdREDACTED 个代理，跳过 {skippedREDACTED 个重复',
      batchImportAllSkipped: '全部 {skippedREDACTED 个代理已存在，跳过导入',
      ...
      proxyDeleted: '代理删除成功',
      proxyWorking: '代理连接正常',
      proxyWorkingWithLatency: '代理连接正常，延迟 {latencyREDACTEDms',
      proxyTestFailed: '代理测试失败',
      qualityCheckDone: '质量检测完成：评分 {scoreREDACTED（{gradeREDACTED）',
      qualityCheckFailed: '代理质量检测失败',
      batchQualityDone: '批量质量检测完成，共检测 {countREDACTED 个；优质 {healthyREDACTED 个，告警 {warnREDACTED 个，挑战 {challengeREDACTED 个，异常 {failedREDACTED 个',
      batchQualityFailed: '批量质量检测失败',
      batchQualityEmpty: '暂无可检测质量的代理',
      qualityReportTitle: '代理质量检测报告',
      qualityGrade: '等级 {gradeREDACTED',
      qualityExitIP: '出口 IP',
      qualityCountry: '出口地区',
      ...
      qualityInline: '质量 {gradeREDACTED/{scoreREDACTED',
      ...
      deleteConfirm: "确定要删除代理 '{nameREDACTED' 吗？使用此代理的账号将被移除代理设置。",
      neverExpires: '永不过期',
      expired: '已过期',
      overdueDays: '已超期 {daysREDACTED 天',
      expiringInDays: '{daysREDACTED 天后到期',
      remainingDays: '剩余 {daysREDACTED 天',
      expiresAt: '有效期',
      nDays: '{daysREDACTED 天',
    ...
    redeem: {
      ...
      selectedCount: '已选择 {countREDACTED 个兑换码',
      clearSelection: '清空选择',
      selectCodesFirst: '请先选择兑换码',
      noBatchFieldsSelected: '请至少勾选一个要修改的字段',
      batchUpdateSuccess: '成功修改 {countREDACTED 个兑换码',
      ...
      codesCreated: '已创建 {countREDACTED 个兑换码',
      codeType: '类型',
      amount: '金额 ($)',
      value: '面值',
      count: '数量',
      ...
      codeDeleted: '兑换码删除成功',
      codesDeleted: '成功删除 {countREDACTED 个未使用的兑换码',
      noUnusedCodes: '没有未使用的兑换码可删除',
      userPrefix: '用户 #{idREDACTED',
      ...
      codeExpiry: '兑换码过期',
      neverExpires: '永不过期',
      expiryPresetDays: '{daysREDACTED 天',
      customExpiry: '自定义',
      ...
      codesGeneratedSuccess: '兑换码生成成功，共 {countREDACTED 个',
    ...
    announcements: {
      ...
      targetingSummaryCustom: '自定义（{groupsREDACTED 组）',
      timeImmediate: '立即',
      timeNever: '永久',
      readStatus: '已读情况',
      eligible: '符合条件',
    ...
    ops: {
      ...
      loadingText: '加载中...',
      ready: '就绪',
      autoRefreshRemaining: '剩余 {secondsREDACTEDs',
      systemLogs: {
        title: '系统日志',
        ...
        cleanupSuccess: '清理完成，已删除 {countREDACTED 条日志。',
      ...
      openaiTokenStats: {
        ...
        prevPage: '上一页',
        nextPage: '下一页',
        pageInfo: '第 {pageREDACTED/{totalREDACTED 页',
        totalModels: '模型总数：{totalREDACTED',
      ...
      requestDetails: {
        title: '请求明细',
        details: '明细',
        rangeLabel: '窗口：{rangeREDACTED',
        rangeMinutes: '{nREDACTED 分钟',
        rangeHours: '{nREDACTED 小时',
        empty: '该窗口内暂无请求。',
      ...
      alertRules: {
        ...
        REDACTED,
        hints: {
          recommended: '推荐：运算符 {operatorREDACTED，阈值 {thresholdREDACTED{unitREDACTED',
      ...
      runtime: {
        ...
        validation: {
          ...
          lockKeyPrefix: '分布式锁 Key 必须以「{prefixREDACTED」开头',
          lockKeyHint: '建议以「{prefixREDACTED」开头以避免冲突',
      ...
      concurrency: {
        ...
        totalRows: '共 {countREDACTED 项',
        disabledHint: '已在设置中关闭实时监控。',
        empty: '暂无数据',
        queued: '队列 {countREDACTED',
        rateLimited: '限流 {countREDACTED',
        errorAccounts: '异常 {countREDACTED',
        loadFailed: '加载并发数据失败'
      REDACTED,
      realtime: {
        title: '实时信息',
        ...
        offline: '实时离线',
        closed: '实时已关闭',
        reconnectIn: '重连 {secondsREDACTEDs'
      REDACTED,
      queryMode: {
        auto: 'Auto（自动）',
        raw: 'Raw（不聚合）',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          customUsers: {
            ...
            batchButton: '批量设置比例（已选 {countREDACTED）',
            empty: '暂无专属配置用户',
            customBadge: '自定义',
            useGlobal: '沿用全局',
            resetTitle: '重置该用户的专属配置',
            resetMessage: '确认将 {emailREDACTED 的专属配置全部重置为默认？\n• 专属返利比例将清除（沿用全局）\n• 邀请码将重新生成为系统随机码（已分发的旧邀请链接将失效）',
            totalLabel: '共 {totalREDACTED 条',
            col: {
              email: '邮箱',
              username: '用户名',
              code: '邀请码',
          ...
          REDACTED,
          batchModal: {
            title: '批量设置专属比例（已选 {countREDACTED 个用户）',
      ...
      registration: {
        ...
        emailSuffixWhitelistHint:
          "仅允许使用指定域名的邮箱注册账号（例如 {'@'REDACTEDqq.com, {'@'REDACTEDgmail.com, *.edu.cn）",
      ...
      defaults: {
        ...
        defaultSubscriptionsDuplicate: '默认订阅存在重复分组：{groupIdREDACTED。每个分组只能出现一次。',
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptBlocksPlaceholder: '留空时使用内置 3 个 blocks。支持数组或 {"blocks": [...]REDACTED。',
        claudeOAuthSystemPromptBlocksHint: '每个 block 会保存为带 enabled、type、text、可选 cache_control 的 JSON。{billing_headerREDACTED 会按请求动态生成；Claude Code 身份提示词和扩展提示词可直接编辑，也可用预设恢复默认值。',
      ...
      site: {
        ...
        tableDefaultPageSizeRangeError: '默认每页条数必须在 {minREDACTED-{maxREDACTED 之间',
        tablePageSizeOptionsFormatError: '可选每页条数格式无效，请输入 {minREDACTED-{maxREDACTED 之间的整数并用英文逗号分隔',
        customEndpoints: {
          title: '自定义端点',
          description: '添加额外的 API 端点地址，用户可在「API Keys」页面快速复制',
          itemLabel: '端点 #{nREDACTED',
          name: '名称',
        ...
        logoSizeError: '图片大小超过 300KB 限制（{sizeREDACTEDKB）',
      ...
      payment: {
        ...
        balanceRechargePreview: '预览：1 CNY = {usdREDACTED USD',
        ...
        rechargeFeePreview: '预览：充值 100 元，手续费 {feeREDACTED 元',
        orderTimeout: '订单超时时间',
        ...
        validationFieldRequired: '{fieldREDACTED 不能为空',
        ...
        stripeWebhookApiVersionHint: 'Webhook 端点的 API 版本请与当前集成的 Stripe SDK 对齐，建议选择 {versionREDACTED；版本不一致可能导致回调事件解析失败。',
        ...
        enableConflict: '{methodREDACTED 已有启用中的服务商实例：{providerREDACTED。请先停用现有实例后再启用或切换。',
      REDACTED,
      balanceNotify: {
        title: '余额不足提醒',
      ...
      soraS3: {
        ...
        deleteConfirm: '确定删除存储配置 {profileIDREDACTED 吗？',
        columns: {
          profile: '配置',
      ...
      openaiExperimentalScheduler: {
        ...
        defaultPlaceholder: '配置/默认：{valueREDACTED',
        topKLabel: 'TopK',
        priorityWeight: '优先级',
        loadWeight: '负载',
        queueWeight: '排队',
    ...
    errorPassthrough: {
      ...
      ruleUpdated: '规则更新成功',
      ruleDeleted: '规则删除成功',
      deleteConfirm: '确定要删除规则 "{nameREDACTED" 吗？',
      failedToLoad: '加载规则失败',
      failedToSave: '保存规则失败',
    ...
    tlsFingerprintProfiles: {
      ...
      deleteConfirm: '删除模板',
      deleteConfirmMessage: '确定要删除模板 "{nameREDACTED" 吗？使用此模板的账号将回退到内置默认值。',
      createSuccess: '模板创建成功',
      updateSuccess: '模板更新成功',
      deleteSuccess: '模板删除成功',
      loadFailed: '加载模板失败',
