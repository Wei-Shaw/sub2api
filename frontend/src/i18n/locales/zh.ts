export default {
  ...
  admin: {
    ...
    userPools: {
      title: '用户池管理',
      description: '将用户分组到池中，批量授予分组访问权限',
      searchPools: '搜索用户池...',
      createPool: '创建用户池',
      editPool: '编辑用户池',
      deletePool: '删除用户池',
      deleteConfirm: "确定要删除用户池 '{name}' 吗？此操作无法撤销。",
      allStatus: '全部状态',
      columnSettings: '列设置',
      columns: {
        name: '名称',
      ...
      form: {
        name: '名称',
        namePlaceholder: '请输入用户池名称',
        nameRequired: '请输入用户池名称',
        description: '描述',
      ...
      memberUsername: '用户名',
      memberAddedAt: '加入时间',
      selectUsersPlaceholder: '搜索用户邮箱...',
      groupGrants: '分组授权',
      groupGrantsTitle: '分组授权管理',
      addGrant: '添加授权',
      noGrants: '暂无分组授权',
      grantGroupId: '分组',
      grantRateMultiplier: '费率倍数',
      grantRpmOverride: 'RPM 覆盖',
      grantRateDefault: '继承默认',
      grantRpmDefault: '继承默认',
      grantRateHint: '留空表示继承分组默认倍率',
      grantRpmHint: '留空表示继承分组默认 RPM',
      saveGrants: '保存授权',
      deleteGrant: '删除授权',
      poolCreated: '用户池创建成功',
      poolUpdated: '用户池更新成功',
      poolDeleted: '用户池删除成功',
      failedToLoad: '加载用户池失败',
      failedToCreate: '创建用户池失败',
      failedToUpdate: '更新用户池失败',
      failedToDelete: '删除用户池失败',
      membersAdded: '成员添加成功',
      membersRemoved: '成员移除成功',
      failedToAddMembers: '添加成员失败',
      failedToRemoveMembers: '移除成员失败',
      grantsSaved: '分组授权保存成功',
      grantDeleted: '分组授权删除成功',
      failedToSaveGrants: '保存分组授权失败',
      failedToDeleteGrant: '删除分组授权失败',
      noPoolsYet: '暂无用户池',
      createFirstPool: '创建您的第一个用户池以批量管理用户权限。',
      detailPanel: '用户池详情',
      basicInfo: '基本信息',
      saving: '保存中...',
      creating: '创建中...',
      selectUsers: '选择用户',
      confirmRemove: "确定要移除 {count} 名成员吗？",
      noPools: '暂无用户池',
      selectGroup: '选择分组',
      noGroupsAvailable: '暂无可用分组',
      groupTypeSubscription: '订阅',
      groupTypeExclusive: '专属',
      addMembersHint: '输入用户 ID，多个用逗号或换行分隔',
      addMembersModal: {
        title: '添加成员',
        ...
        groupFilter: '选择分组',
        groupFilterLabel: '分组',
        attrFilterLabel: '属性筛选',
        selectAll: '全选当前页',
        noResults: '未找到匹配的用户',
        noResultsHint: '请尝试调整搜索条件',
        selectedCount: '已选 {count} 个',
        clearSelected: '清空',
        advancedInput: '手动输入 ID（高级）',
        advancedInputPlaceholder: '输入用户 ID，多个用逗号或换行分隔',
        advancedInputHint: '解析后合并到已选列表',
        mergeIds: '合并 ID',
        addNMembers: '添加 {count} 个',
        loading: '加载中...',
        userEmail: '邮箱',
        userId: 'ID',
        userGroups: '所在分组',
        moreGroups: '+{n} 个',
        addMembersSuccess: '成功添加 {added} 个，跳过 {skipped} 个',
        matchedCount: '共匹配 {n} 条',
        addAllMatched: '添加全部 {n} 个匹配的用户',
        addAllMatchedConfirmTitle: '确认批量添加',
        addAllMatchedConfirmBody: '确认将匹配筛选条件的 {n} 个用户添加到 Pool「{name}」吗？',
        addAllMatchedSuccess: '批量添加成功：新增 {added} 个、已存在 {skipped} 个、共匹配 {matched} 个',
        addAllMatchedNoFilter: '请先设置至少一个筛选条件'
      }
    },
