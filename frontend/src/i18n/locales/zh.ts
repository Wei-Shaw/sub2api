  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        responsesModeDesc:
          '仅对 OpenAI API Key 的文本转发链路生效。自动跟随探测结果，上游同时支持两个端点时自动按入站类型原生透传；强制模式会覆盖自动探测；原生透传按入站类型直达对应端点、不做转换。',
        responsesModeAuto: '自动',
        responsesModeForceResponses: '强制 Responses',
        responsesModeForceChatCompletions: '强制 Chat Completions',
        responsesModeNative: '原生透传（两者）',
        ...
        capabilityTextNative: 'Responses + Chat Completions（原生透传）',
        ...
        responsesStatusNative: '同时支持（按入站类型透传）',
