    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          accessTokenDesc: '输入 OpenAI Access Token，系统会请求 ChatGPT wham/usage 校验并读取套餐和模型配额，校验通过后创建账号。',
          accessTokenInputLabel: 'Access Token',
          accessTokenPlaceholder: '粘贴您的 OpenAI Access Token...\n支持多个，每行一个',
          accessTokenHint: 'AT 会通过 https://chatgpt.com/backend-api/wham/usage 校验；若上游返回 400/401 将提示保存失败，at无效。',
          accessTokenImportAndCreate: '验证 AT 并创建账号',
          accessTokenEmpty: '请输入 Access Token',
          accessTokenImportFailed: '保存失败，at无效',
          accessTokenImportSuccess: 'AT 导入完成：新增 {created}，更新 {updated}，跳过 {skipped}',
          accessTokenImportPartial: 'AT 部分成功：新增 {created}，更新 {updated}，跳过 {skipped}，失败 {failed}',
          codexSessionAuth: 'Codex JSON 批量输入',
