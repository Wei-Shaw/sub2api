export default {
  ...
  keys: {
    ...
    groupRequired: '请选择分组',
    billingStrategy: '扣费策略',
    billingStrategyHint: '路由能力始终由主分组决定，以下配置仅影响扣费顺序。',
    billingPoolNotice: '订阅池：{name}',
    billingPoolMixedPlatformNotice: '该订阅池允许跨平台 fallback，但不会改变主分组的路由平台。',
    billingBalanceFallbackNotice: '当订阅链全部耗尽后，将自动从账户余额扣费。',
    billingMode: {
      strict: '严格使用主订阅',
      primaryThenBalance: '主订阅用完后使用余额',
      primaryThenPoolThenBalance: '主订阅用完后自动使用同池订阅，再使用余额'
    },
    billingModeDescriptions: {
      strict: '主分组订阅不可用时直接拒绝请求。',
      primaryThenBalance: '主分组订阅耗尽后，自动回退到账户余额。',
      primaryThenPoolThenBalance: '主分组订阅耗尽后，按订阅池顺序尝试其它订阅，再回退到余额。'
    },
    billingAdvancedSettings: '高级设置',
    usePoolDefaultOrder: '使用管理员推荐顺序',
    usePoolDefaultOrderHint: '关闭后可自定义池内 fallback 分组顺序。',
    customFallbackGroups: '自定义 fallback 分组',
    customFallbackEmpty: '当前没有可选的池内 fallback 分组。',
    addFallbackGroup: '添加',
    removeFallbackGroup: '移除',
    moveUp: '上移',
    moveDown: '下移',
    billingPreview: '当前扣费顺序',
    billingPreviewEmpty: '请选择分组后查看扣费顺序',
    usage: '用量',
    today: '今日',
    total: '近30天',
    quota: '额度',
  ...
  admin: {
    ...
    billingPools: {
      title: '订阅池管理',
      description: '管理订阅扣费池与分组 fallback 顺序',
      searchPlaceholder: '搜索名称、代码或描述...',
      createPool: '创建订阅池',
      editPool: '编辑订阅池',
      deletePool: '删除订阅池',
      members: '成员',
      membersTitle: '{name} 成员',
      membersHint: '仅可选择订阅计费类型的分组；顺序用于 fallback chain_order。',
      addMember: '添加成员',
      noMembers: '暂无成员',
      noMembersHint: '添加订阅分组以组成扣费链。',
      noPools: '暂无订阅池',
      noPoolsHint: '创建订阅池以配置跨分组订阅扣费 fallback。',
      noAvailableGroups: '没有可添加的订阅分组',
      allStatus: '全部状态',
      allPlatformScopes: '全部平台范围',
      groupCount: '{count} 个分组',
      allowUserReorderShort: '允许用户排序',
      requirePrimaryShort: '要求主订阅',
      balanceFallbackShort: '余额兜底',
      canBePrimary: '可作主分组',
      canBeFallback: '可作 fallback',
      moveUp: '上移',
      moveDown: '下移',
      nameCodeRequired: '请输入名称和代码',
      invalidMember: '请选择有效分组',
      duplicateMember: '成员分组不能重复',
      poolCreated: '订阅池创建成功',
      poolUpdated: '订阅池更新成功',
      poolDeleted: '订阅池删除成功',
      membersUpdated: '成员顺序已保存',
      failedToLoad: '加载订阅池失败',
      failedToSave: '保存订阅池失败',
      failedToDelete: '删除订阅池失败',
      failedToLoadGroups: '加载订阅分组失败',
      failedToLoadMembers: '加载订阅池成员失败',
      failedToSaveMembers: '保存订阅池成员失败',
      deleteConfirm: "确定要删除订阅池 '{name}' 吗？",
      platformScopes: {
        same_platform: '同平台',
        mixed_platform: '跨平台'
      },
      ...
      form: {
        ...
        platformScope: '平台范围',
        options: '策略选项',
        allowUserReorder: '允许用户自定义 fallback 顺序',
        requirePrimarySubscription: '要求主分组订阅有效',
        allowBalanceFallback: '订阅链耗尽后允许余额兜底'
      }
    },
