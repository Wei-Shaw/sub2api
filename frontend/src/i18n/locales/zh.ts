export default {
  ...
  llmTester: {
    ...
    fetchModels: '拉取模型',
    modelCount: '已拉取 {countREDACTED 个模型',
    lastFetched: '拉取时间 {timeREDACTED',
    ...
    modelsFetched: '已拉取 {countREDACTED 个模型',
    capabilities: {
      chat: '聊天',
      vision: '视觉聊天',
    ...
    errors: {
      ...
      cancelled: '请求已取消',
      imageTooLarge: '{nameREDACTED 超过 5 MB 图片限制',
      textTooLarge: '{nameREDACTED 超过 240 KB 文本限制',
      fileReadFailed: '读取 {nameREDACTED 失败'
    REDACTED
  REDACTED,
