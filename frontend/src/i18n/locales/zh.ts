export default {
  ...
  // Setup Wizard
  setup: {
    title: 'DevRouter 安装向导',
    description: '配置您的 DevRouter 实例',
    database: {
      title: '数据库配置',
  ...
  chatCompletion: {
    title: '对话聊天',
    description: '选择自己的 API 密钥和可用模型，通过现有网关发起流式对话。',
    disabled: '对话聊天入口当前未启用，请联系管理员在系统设置中开启。',
    apiKey: 'API 密钥',
    selectApiKey: '选择 API 密钥',
    loadingKeys: '正在加载可用密钥...',
    noApiKeys: '暂无可用 API 密钥，请先创建并绑定分组。',
    baseUrl: '请求端点 Base URL',
    baseUrlUnavailable: '选择模型后显示',
    model: '模型',
    selectModel: '选择模型',
    selectKeyFirst: '请先选择 API 密钥',
    selectModelFirst: '请先选择模型',
    loadingModels: '正在读取渠道定价支持模型...',
    noModels: '该密钥所属分组暂无渠道定价支持模型。',
    message: '消息',
    messagePlaceholder: '输入消息，按 Enter 发送，Shift+Enter 换行',
    send: '发送',
    attachImage: '添加图片',
    removeImage: '移除图片',
    closeImagePreview: '关闭图片预览',
    unsupportedImageType: '仅支持 PNG、JPEG、WebP 或 GIF 图片。',
    imageTooLarge: '单张图片不能超过 10MB。',
    tooManyImages: '每条消息最多添加 4 张图片。',
    imageReadFailed: '读取图片失败，请重新选择。',
    imageModelUnsupported: '当前模型不支持图片输入，请切换到支持视觉理解的模型。',
    imagePlaceholder: '[图片]',
    streaming: '生成中...',
    streamingHint: '使用所选密钥和模型进行流式对话',
    stop: '停止',
    regenerate: '重新生成',
    clear: '清空对话',
    newChat: '新对话',
    chatSettings: '对话设置',
    chatSettingsHint: '选择密钥和文本模型后开始对话',
    history: '会话历史',
    loadingHistory: '正在加载会话历史...',
    noHistory: '暂无会话历史，发送第一条消息后会自动保存。',
    loadingMessages: '正在加载消息...',
    emptyTitle: '开始一次新对话',
    empty: '已经为你整理好密钥与模型。输入问题，或从下面选一个提示开始。',
    suggestions: '对话建议',
    suggestion1: '帮我使用 Java 生成一个冒泡排序',
    suggestion2: '写一个调用 OpenAI 兼容接口的示例',
    suggestion3: '解释这个模型适合什么任务',
    error: '对话请求失败',
    user: '你',
    assistant: '助手',
    thinking: '正在思考...',
    ...
    failed: '失败',
    duration: '{ms}ms',
    currentCost: '本次消耗 ${cost}',
    currentCostPending: '本次消耗以使用记录为准',
    ready: '可用',
    notReady: '待配置',
    toolbarSelectKey: '选择一个可用 API 密钥后即可开始对话',
    toolbarSelectModel: '选择模型后即可开始对话',
  ...
  models: {
    ...
    priceOutput: '输出价格',
    priceCacheWrite: '缓存写',
    priceCacheRead: '缓存读价格',
    priceImage: '图片',
    pricePerRequest: '按次价格',
    pricePerImage: '图片价格',
    perImageUnit: '/张',
    defaultTier: '默认',
    discount: '折扣',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: '点击「创建存储桶」，输入名称（如 devrouter-backups），选择区域',
          line3: '点击创建完成'
        },
        step2: {
          title: '创建 API 令牌',
    ...
    accounts: {
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 DevRouter 实例的场景。',
    ...
    settings: {
      ...
      features: {
        ...
        chatCompletion: {
          title: '对话聊天',
          description: '控制用户侧对话聊天工具入口是否展示。用户需选择自己的平台 API Key 发起请求。',
          enabled: '启用对话聊天入口',
          enabledHint: '启用后用户可以选择自己已创建并绑定分组的 API Key 进行流式对话。',
        },
        riskControl: {
          title: '风控中心',
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 DevRouter 用户登录',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 DevRouter',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">DevRouter 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 DevRouter 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 DevRouter',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 DevRouter AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
