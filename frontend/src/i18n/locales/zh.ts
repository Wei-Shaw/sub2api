export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "请选择要重置的 '{user}' 用量配额。选中的用量将归零并从今天开始重新计算。",
      resetQuotaDaily: '每日配额',
      resetQuotaWeekly: '每周配额',
      resetQuotaMonthly: '每月配额',
      resetQuotaSelectAtLeastOne: '请至少选择一个配额维度',
      resettingQuota: '重置中...',
