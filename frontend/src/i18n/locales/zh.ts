export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      thresholds: {
        title: '分类阈值调节',
        description: '请求中某类别的分值达到或超过阈值时将被标记。阈值越低拦截越多，但误报也会增加。',
        resetDefault: '恢复默认值',
        defaultLabel: '默认：',
        categories: {
          harassment: '骚扰',
          harassmentThreatening: '骚扰 / 威胁',
          hate: '仇恨',
          hateThreatening: '仇恨 / 威胁',
          illicit: '违法',
          illicitViolent: '违法 / 暴力',
          selfHarm: '自残',
          selfHarmIntent: '自残 / 意图',
          selfHarmInstructions: '自残 / 指导',
          sexual: '色情',
          sexualMinors: '色情 / 未成年',
          violence: '暴力',
          violenceGraphic: '暴力 / 血腥',
        },
      },
      overview: {
        status: '运行状态',
