export default {
  ...
  admin: {
    ...
    groups: {
      ...
      rateMultiplierHint: '1.0 = 标准费率，0.5 = 半价，2.0 = 双倍',
      displayRateMultiplierHint: '仅用于用户侧创建 API 密钥和可用渠道展示，实际消耗仍按费率倍数扣费',
      platforms: {
        all: '全部平台',
        anthropic: 'Anthropic',
        openai: 'OpenAI',
    ...
    accounts: {
      ...
      reAuthorize: '重新授权',
      refreshToken: '刷新令牌',
      refreshingToken: '正在刷新账号「{name}」的令牌...',
      noAccountsYet: '暂无账号',
      createFirstAccount: '添加 AI 平台账号以开始使用 API 网关。',
      tokenRefreshed: 'Token 刷新成功',
      tokenRefreshedWithProjectWarning: 'Token 已刷新，但暂时未获取到 project_id，系统会稍后自动重试',
