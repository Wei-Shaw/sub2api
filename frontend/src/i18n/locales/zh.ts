export default {
  ...
  auth: {
    ...
    accountIdentifierLabel: '邮箱或手机号',
    accountIdentifierPlaceholder: '请输入邮箱或手机号',
    accountIdentifierRequired: '请输入邮箱或手机号',
    invalidAccountIdentifier: '请输入有效的邮箱或手机号，不要包含特殊符号',
    emailLabel: '邮箱',
  ...
  admin: {
    ...
    users: {
      ...
      usageOverride: {
        ...
        usageSection: '消耗显示',
        balanceSection: '剩余额度',
        todayActualCost: '今日消耗 (USD)',
        totalActualCost: '累计消耗 (USD)',
        todayRequests: '今日请求',
        todayTokens: '今日 Tokens',
        totalTokens: '累计 Tokens',
        setBalance: '设置余额',
        notesPlaceholder: '例如：人工修正客户展示用量、迁移旧数据、补偿调整等',
        blankHint: '留空表示使用系统真实统计值；填写后会覆盖用户列表和接口返回的展示统计。',
        balanceHint: '留空则不改余额。填写后会把用户余额直接设置为该数值。',
        realValue: '真实统计值',
        invalidNumber: '请输入有效的非负数字',
        save: '保存修正',
        clear: '清除用量修正',
        loadFailed: '加载用量修正失败',
        saveSuccess: '用量修正已保存',
        saveFailed: '保存用量修正失败',
        clearSuccess: '用量修正已清除',
        clearFailed: '清除用量修正失败',
      },
      // Settings Dropdowns
      filterSettings: '筛选设置',
      columnSettings: '列设置',
