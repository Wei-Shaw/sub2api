export default {
  ...
  // Setup Wizard
  setup: {
    title: 'AI Bridge 安装向导',
    description: '配置您的 AI Bridge 实例',
    database: {
      title: '数据库配置',
  ...
  admin: {
    ...
    accounts: {
      ...
      usageWindowsHint: '“5h / 7d”是上游账号（如 OpenAI ChatGPT、Claude）官方的滚动用量窗口限制，由上游对账号设定，并非 AI Bridge 配置，也与你映射的模型无关。窗口滚动到期后用量会自动重置，无法在 AI Bridge 端解除该限制。',
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 AI Bridge 实例的场景。',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 AI Bridge 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 AI Bridge 用户登录',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 AI Bridge',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 AI Bridge AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
