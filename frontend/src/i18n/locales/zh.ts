  ...
  admin: {
    ...
    settings: {
      ...
      site: {
        ...
        aiToolRewriteRules: {
          title: 'AI 工具配置替换规则',
          description: '对「使用密钥」弹窗生成的工具配置内容做普通字符串替换，按规则顺序执行',
          publicWarning: '规则会通过公开设置下发给用户侧，请不要填写 API Key、Token 或其他敏感信息。',
          itemLabel: '规则 #{n}',
          platform: '平台',
          client: '工具',
          anyPlatform: '全部平台',
          anyClient: '全部工具',
          find: '查找内容',
          findPlaceholder: '例如：model = "gpt-5.4"',
          replace: '替换为',
          replacePlaceholder: '例如：model = "gpt-5.5"',
          add: '添加规则',
        },
        contactInfo: '客服联系方式',
