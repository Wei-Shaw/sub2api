export default {
  ...
  auth: {
    ...
    forgotPasswordHint: '输入邮箱获取验证码，用验证码设置新密码。',
    sendResetLink: '发送验证码',
    sendingResetLink: '发送中...',
    sendResetLinkFailed: '发送验证码失败，请重试。',
    resetEmailSent: '验证码已发送',
    resetEmailSentHint:
      '如果该邮箱已注册，您将很快收到一封包含 6 位验证码的邮件。请检查收件箱和垃圾邮件文件夹。',
    enterResetCode: '输入验证码并重置密码',
    changeEmail: '换一个邮箱',
    backToLogin: '返回登录',
    rememberedPassword: '想起密码了？',
    // 重置密码
    resetPasswordTitle: '设置新密码',
    resetPasswordHint: '请输入邮箱验证码和新密码。',
    resetCodePlaceholder: '输入6位验证码',
    resetCodeHint: '验证码 30 分钟内有效，只能使用一次。',
    verificationCodeRequired: '请输入验证码',
    invalidVerificationCode: '请输入6位数字验证码',
    newPassword: '新密码',
  ...
  imageGeneration: {
    title: '图片生成',
    description: '选择自己的 API Key 和可用图片模型，发起文生图或图生图请求',
    apiKey: 'API Key',
    selectApiKey: '选择 API Key',
    model: '模型',
    selectModel: '选择模型',
    modelSearchPlaceholder: '搜索密钥名称或模型',
    ...
    imageToImage: '图生图',
    sourceImage: '源图片',
    dropSourceImage: '点击上传，或拖入源图片',
    sourceImageHint: '支持 PNG、JPG、WebP',
    removeSourceImage: '移除源图片',
    prompt: '提示词',
    promptPlaceholder: '描述你想生成的图片内容、风格、构图和细节...',
    editPromptPlaceholder: '描述基于源图片要修改或生成的内容...',
    generate: '生成图片',
    generating: '生成中...',
    upscale: '放大',
    upscaledResult: '放大结果',
    upscalePrompt: '请将这张图片放大为更高清、更清晰、更丰富细节的版本，保持原始构图、主体、风格和色彩，不要添加无关元素。',
    waiting: '图片生成中，请稍候',
    results: '生成结果',
    resultCount: '{count} 张',
    emptyResults: '生成后的图片会显示在这里',
    noKeysTitle: '还没有可用 API Key',
    noKeysDescription: '图片生成需要选择你已创建且处于启用状态的 API Key。',
    createKey: '去创建 API Key',
    groupDisabled: '该 API Key 所在分组未开启图片生成。',
    noModels: '当前 API Key 所在分组暂无可用图片模型或可调度 OpenAI 图片账号',
    noAvailableAccounts: '当前 API Key 所在分组没有可用的 OpenAI 图片账号，请先在后台把可调度 OpenAI 账号绑定到该分组。',
    noImageReturned: '请求完成，但未返回可展示的图片。',
    imageLoadFailed: '读取原图失败，无法放大该图片。',
    loadKeysFailed: '加载 API Key 失败',
    loadModelsFailed: '加载图片模型失败',
    generateFailed: '图片生成失败'
  },

  textChat: {
    title: 'AI 对话',
    description: '选择自己的 API Key，使用可用模型进行文字对话',
    selectApiKey: '选择 API Key',
    selectModel: '选择模型',
    modelSearchPlaceholder: '搜索密钥名称或模型',
    noMatchedModels: '没有匹配的模型',
    ...
    systemPrompt: '系统提示词',
    systemPromptPlaceholder: '例如：你是一个简洁、准确的中文助手。',
    creativity: '创造性',
    clear: '清空对话',
    empty: '输入问题开始对话，或点选一个示例。',
    inputPlaceholder: '输入消息，Enter 发送，Shift + Enter 换行，支持拖拽或粘贴文件',
    enterHint: 'Enter 发送 / Shift + Enter 换行',
    send: '发送',
    sending: '发送中...',
    thinking: 'AI 正在思考...',
    thinkingShort: 'AI 正在思考',
    you: '你',
    assistant: 'AI助手',
    copy: '复制回复',
    attachFile: '上传文件',
    ...
    readingFiles: '读取文件中...',
    unnamedFile: '未命名文件',
    tooManyAttachments: '最多只能上传 {count} 个文件。',
    fileTooLarge: '文件 {name} 超过大小限制，单个文件最大 {size}。',
    fileReadFailed: '读取文件 {name} 失败。',
    attachmentContextLabel: '附件内容',
    attachmentTruncated: '以下内容过长，已截断。',
    imageAttachmentInstruction: '请结合这张图片附件进行回答',
    fileAttachmentInstruction: '请在模型支持文件输入时解析这个附件',
    noKeysTitle: '还没有可用 API Key',
    noKeysDescription: 'AI 对话需要选择你已创建且处于启用状态的 API Key。',
    createKey: '去创建 API Key',
    noModels: '当前 API Key 暂无可用对话模型',
    emptyReply: '模型没有返回内容。',
    loadKeysFailed: '加载 API Key 失败',
    loadModelsFailed: '加载对话模型失败',
    sendFailed: '发送消息失败',
    suggestionRewrite: '帮我把这段话改得更自然、更专业',
    suggestionSummary: '用三点总结下面这段内容',
    suggestionCaption: '给我写一个适合朋友圈的短文案',
    suggestionExplain: '解释一下 PostgreSQL 和 MySQL 的主要区别'
  },
  ...
  affiliate: {
    ...
    tips: {
      title: '使用说明',
      line1: '邀请好友注册，双方各获 $10 注册奖励。',
      line2: '被邀请人注册后 30 天内充值、兑换或购买订阅，你可获得 {rate} 返利。',
      line3: '返利额度冻结 24 小时后自动解冻，可用于购买套餐或转入余额消费。',
      line4: '同一邀请人每日注册奖励上限 $10；严禁虚假注册、批量小号、自我邀请等作弊行为，一经发现取消所有返利并冻结账号。'
    }
  },
  ...
  admin: {
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "确定要重置 '{user}' 的 5 小时、每周和每月用量配额吗？用量将归零并从当前窗口重新计算。",
    ...
    redeem: {
      ...
      value: '面值',
      notes: '备注',
      notesPlaceholder: '例如：闲鱼100美元、客户A补发、测试订阅码',
      count: '数量',
      generate: '生成',
      copyAll: '全部复制',
      download: '下载',
  ...
  guide: {
    ...
    faq: {
      ...
      q6: '商务合作、采购或开发票怎么联系？',
      a6: '商务合作、企业采购、开票请联系 QQ 591719412（银河）。',
    },
    err401: '认证失败',
