  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_token: '收款币种',
        field_network: '收款网络',
        field_epusdtApiBaseHint: '填 epusdt 网关的公网地址（协议+域名，如 https://pay.example.com），无需带路径。必须是买家浏览器可访问的公网 HTTPS 域名。',
        field_epusdtTokenHint: '可选。收款币种（如 usdt、usdc、trx）。留空则由买家在 epusdt 收银台自行选择。填了必须同时填写收款网络。',
        field_epusdtNetworkHint: '可选。收款网络（如 tron、ethereum、bsc、solana、polygon）。留空则由买家在 epusdt 收银台自行选择。填了必须同时填写收款币种。',
        field_cid: '支付渠道 ID',
