export default {
  ...
  admin: {
    ...
    groups: {
      ...
      gatewayTypeHint: '选择分组的 API 协议类型，兼容该网关的账号将可被调度。',
      gatewayTypeNotEditable: '创建后不可更改网关类型',
      noGroupsYet: '暂无分组',
    ...
    // sdk.i18n.registerNamespace 在运行时合并到 vue-i18n 实例.
    // 不要在这里重复维护.
    ...
    accounts: {
      ...
      openai: {
        ...
        modelRestrictionDisabledByPassthrough: '自动透传已启用：模型白名单/模型映射将不会生效。',
      ...
      pleaseSelectType: '请选择账号类型',
      selectPlatform: '选择平台',
      accountDetails: '账号详情',
      loadingForm: '加载表单中...',
      failedToLoadForm: '加载账号表单失败',
      ...
      imageTestHint: '选择图片模型后，测试会发起真实的生图请求，并在下方展示返回图片。',
      imageTestMode: '模式：图片生成测试',
      imagePreview: '生成结果：',
