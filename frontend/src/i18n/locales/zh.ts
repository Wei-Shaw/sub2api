  ...
  admin: {
    ...
    accounts: {
      ...
      status: {
        ...
        openAIQuotaUsedRange: '指定额度',
        openAIQuotaUsedRangeValue: '指定额度（{window} {min}%~{max}%）',
        openAIQuotaWindow: '额度窗口',
        openAIQuotaRangeMin: '最小已用百分比',
        openAIQuotaRangeMax: '最大已用百分比',
        openAIQuotaRangeInvalid: '请输入 0~100 且最小值不大于最大值的百分比',
        openAIQuotaUsedRangeHint: '该筛选会先按“正常（排除超额度）”过滤，再按指定窗口已用百分比二次筛选。',
        openAIQuotaFull: '额度已满',
        openAIQuotaFullValue: '额度已满（{window}）',
        openAIQuotaFullHint: '该筛选会在全部状态中查找指定窗口已用达到 100% 或以上的 OpenAI OAuth 账号。',
