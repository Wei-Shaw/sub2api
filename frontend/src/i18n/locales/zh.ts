  ...
  admin: {
    ...
    settings: {
      ...
      openaiFastPolicy: {
        ...
        description: '在转发上游前拦截/过滤/透传或强制 OpenAI service_tier，并可选强制 reasoning effort；仅作用于 OpenAI 网关。',
        ...
        actionForceDefault: '强制 Default/普通',
        actionForceFlex: '强制 Flex',
        scope: '生效范围',
        scopeAll: '全部账号',
        scopeOAuth: '仅 OAuth 账号',
        scopeAPIKey: '仅 API Key 账号',
