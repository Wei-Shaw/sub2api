  ...
  admin: {
    ...
    accounts: {
      ...
      tempUnschedulable: {
        ...
        durationMinutesHint: '临时不可调度状态的持续时长，与"按时间点重置"二选一。',
        resetAtTime: '按时间点重置',
        resetAtTimePlaceholder: '选择时间点',
        resetAtTimeHint: '按服务器时区计算；当前生效时区：{timezone}。例如 00:00 表示该时区凌晨 0 点。',
        serverTimezoneUnknown: '未知',
        resetAtMidnightShortcut: '次日0点',
        resetAtTimeInvalid: '重置时间必须在 00:00 到 23:59 之间。',
        keywords: '关键词',
        keywordsPlaceholder: '例如 overloaded, too many requests',
        keywordsHint: '多个关键词用逗号分隔，匹配时必须命中其中之一。',
        description: '描述',
        descriptionPlaceholder: '可选，便于记忆规则用途',
        rulesInvalid: '请至少填写一条包含错误码、关键词和持续时间或重置时间的规则。',
