export default {
  ...
  support: {
    ...
    // 客服浮窗（add-support-chat-widget D2）
    chat: {
      title: '客服小助手',
      toggle_aria: '打开客服浮窗',
  ...
  admin: {
    ...
    // 客服知识库管理（add-support-knowledge-rag §12 §13）
    supportFaq: {
      title: '客服知识库',
    ...
    settings: {
      ...
      // 客服浮窗（add-support-chat-widget D2）：独立 tab。
      supportChat: {
        title: '客服浮窗设置',
        ...
        llmSection: 'LLM 接入',
        // change-support-chat-external-llm §6.9：外部 OpenAI-compatible 服务凭据 + 测试连接 UI。
        // 旧的 apiKeyIdLabel / apiKeyIdHint（指向内部 admin api_keys 表）已被 base_url + api_key 取代。
        llm: {
        ...
        rag: {
          ...
          // 立即抓取 + 状态简显（add-support-knowledge-rag 后续增补）：
          crawlNowTitle: '文档索引',
