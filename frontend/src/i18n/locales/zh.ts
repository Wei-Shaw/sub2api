export default {
  ...
  modelList: {
    title: '模型列表',
    description: '查看主流模型、上下文长度和价格信息',
    searchPlaceholder: '搜索模型名称、ID、能力或说明',
    providerFilter: '按厂商筛选',
    providerAll: '全部厂商',
    categoryLabel: '模型类型',
    unknownProvider: '其他厂商',
    loading: '正在加载模型列表...',
    loadFailed: '模型列表加载失败',
    empty: '没有找到匹配的模型',
    showingCount: '显示 {shown} / {total} 个模型',
    sourceUpdated: '数据更新于 {time}',
    copyModelId: '复制模型 ID',
    copyId: 'Copy ID',
  ...
  imageGenerator: {
    title: '词易生图',
    subtitle: '选择 API 密钥列表中的 Key，调用 gpt-image-2 生成图片。',
    mode: '生成模式',
    textToImage: '文生图',
    imageToImage: '图生图',
    ...
    loadingKeys: '正在加载可用 Key...',
    noKeysHint: '暂无可用 API Key。请先到 API 密钥页面创建一个启用状态的 Key。',
    referenceImage: '参考图',
    uploadReference: '上传参考图',
    removeReference: '移除参考图',
    prompt: '提示词',
    promptPlaceholder: '例如：玻璃温室里的白猫，清晨雾气，电影级构图，超写实质感',
    size: '尺寸方案',
    sizeRequirements: '尺寸要求',
    sizeSquare1K: '1K 方图 · 1024 × 1024',
    sizeLandscape2K: '2K 横图 · 1536 × 1024',
    sizePortrait2K: '2K 竖图 · 1024 × 1536',
    sizeSquare2K: '2K 方图 · 2048 × 2048',
    sizeLandscape4K: '4K 横图 · 3840 × 2160',
    sizePortrait4K: '4K 竖图 · 2160 × 3840',
    sizeCustom: '自定义尺寸',
    sizeSquare1KHint: '轻量快速，适合头像、图标和社媒小图。',
    sizeLandscape2KHint: '适合横幅、封面和横版场景海报。',
    sizePortrait2KHint: '适合人物、竖版海报和手机壁纸。',
    sizeSquare2KHint: '适合更精细的产品图、插画和正方形构图。',
    sizeLandscape4KHint: '适合宽屏大图、官网横幅和高分辨率海报。',
    sizePortrait4KHint: '适合竖版高清海报、人物写真和移动端大图。',
    sizeCustomHint: '请输入符合要求的宽高，系统会按像素自动计费分档。',
    customWidth: '宽',
    customHeight: '高',
    customSizeRequirementTitle: '自定义尺寸要求',
    customSizeRequirementMaxSide: '最大边长 <= 3840px',
    customSizeRequirementMultiple: '宽和高都必须是 16 的倍数',
    customSizeRequirementRatio: '长边 / 短边比例不能超过 3:1',
    customSizeRequirementPixels: '总像素需在 655360 到 8294400 之间',
    customSizeInvalidNumber: '请输入有效的宽高数值',
    customSizeInvalidSide: '宽和高都不能超过 3840px',
    customSizeInvalidMultiple: '宽和高都必须是 16 的倍数',
    customSizeInvalidRatio: '长边和短边比例不能超过 3:1',
    customSizeInvalidPixels: '总像素需在 655360 到 8294400 之间',
    quality: '生成质量',
    qualityOptions: {
      auto: 'Auto',
      low: 'Low',
    ...
    emptyDescription: '填写提示词，或上传参考图后开始生成，结果会直接展示在工作区。',
    generatingTitle: '正在生成图片',
    generatingHint: 'gpt-image-2 正在处理请求，图片生成可能需要几十秒。',
  ...
  payment: {
    ...
    qr: {
      ...
      pendingStatus: '待支付',
      orderLabel: '订单 #{id}',
      qrCodeLabel: '请使用手机扫码完成支付',
      securePayment: '支付信息已加密传输，请确认金额无误后完成付款',
      stepsTitle: '支付流程',
      stepOpenApp: '打开 {provider} 客户端',
      stepScan: '扫描左侧二维码并确认订单信息',
      stepConfirm: '支付成功后页面将自动确认到账',
      autoConfirmHint: '系统正在实时确认支付结果，请勿关闭当前页面。',
      expireWarning: '请在订单有效期内完成支付，超时后二维码将自动失效。',
      redirectTitle: '正在等待支付完成',
      redirectDesc: '请在打开的支付页面完成付款',
    },
    orders: {
      title: '我的订单',
      empty: '暂无订单',
    ...
    rechargeSupportTitle: '站内充值失败请添加微信',
    copyWechat: '复制微信',
    wechatCopied: '微信号已复制',
