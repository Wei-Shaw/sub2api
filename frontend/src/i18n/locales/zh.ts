export default {
  ...
  profile: {
    ...
    checkIn: {
      title: '每日签到',
      pageDescription: '每天签到一次，领取账户余额奖励',
      description: '每天签到一次，领取账户余额奖励。',
      reward: '今日奖励',
      streak: '累计签到',
      lastCheckIn: '上次签到',
      availableToday: '今日可签到',
      checkedInToday: '今日已签到',
      checkedInButton: '已签到',
      action: '立即签到',
      success: '签到成功，已发放奖励：{amount}',
      failed: '签到失败，请稍后重试',
      never: '从未签到',
      days: '{count} 天',
      disabledTitle: '每日签到未开启',
      disabledDescription: '管理员暂未开启每日签到功能。'
    },
  ...
  admin: {
    ...
    settings: {
      ...
      features: {
        ...
        dailyCheckIn: {
          title: '每日签到',
          description: '允许用户在个人资料页每天签到一次并领取奖励。',
          enabled: '启用每日签到',
          enabledHint: '关闭后个人资料页签到卡片隐藏，接口返回禁用状态。',
          rewardAmount: '奖励金额',
          rewardAmountHint: '每次签到成功发放到余额的额度，最小为 0。',
        },
        riskControl: {
          title: '风控中心',
