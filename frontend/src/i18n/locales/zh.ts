  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        validationEasyPayCustomTypeInvalid: '易支付自定义支付方式只能包含小写字母、数字、下划线和短横线',
        validationEasyPayCustomUpstreamTypeInvalid: '易支付上游类型只能包含小写字母、数字、下划线和短横线',
        validationEasyPayCustomUpstreamTypeRequired: '填写自定义支付方式时，必须填写对应的易支付上游类型',
        ...
        field_customType: '自定义支付方式',
        field_customUpstreamType: '易支付上游类型',
        field_customDisplayName: '自定义显示名称',
        field_easypayCustomTypeHint: '可选。填写后会作为用户侧可见支付方式，例如 ldc。',
        field_easypayCustomUpstreamTypeHint: '可选。提交给易支付的 type，例如 epay；未填写自定义支付方式时不会生效。',
        field_easypayCustomDisplayNameHint: '可选。用于后台选择器显示；用户侧没有翻译项时会显示支付方式代码。',
        field_cid: '支付渠道 ID',
