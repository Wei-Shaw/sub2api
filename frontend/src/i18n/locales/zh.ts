  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        delete: '批量删除',
        batchTest: '批量测试',
        joinHealthPool: '加入健康维护池',
        leaveHealthPool: '移出健康维护池',
        protectHealth: '设为保护账号',
      ...
      health: {
        ...
        model: '测试模型',
        concurrency: '并发',
        autoDisable: '其他失败连续 3 次后自动停止调度；401 立即停调度，429/限流视为正常',
        startSelected: '测试已选 {count} 个',
        recentTasks: '最近任务',
        noTasks: '暂无批测任务',
        ...
        latency: '延迟',
        failStreak: '连续失败',
        failStreakShort: '失败 {count} 次',
        error: '错误',
        noResults: '暂无结果',
        inPool: '维护池',
        notInPool: '未加入',
        protected: '保护',
        joinedPool: '已加入 {count} 个账号到健康维护池',
        leftPool: '已移出 {count} 个账号',
        protectedUpdated: '已更新 {count} 个账号的保护设置',
        started: '批量测试已开始',
        startFailed: '批量测试启动失败',
        loadFailed: '加载批测结果失败',
        taskStatus: {
          pending: '等待中',
          running: '运行中',
