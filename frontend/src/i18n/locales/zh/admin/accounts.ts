export default {
    accounts: {
      ...
      quotaHistory: {
        ...
        statsTab: "费用统计",
        historyTab: "额度周期",
        subtitle: "OpenAI / Codex 额度周期记录",
        description: "按本实例记录的用量和标准 API 参考价格折算美元，不含账号或分组倍率。估算受模型组合和代理外消费影响；观测到 100% 也不代表官方美元额度。",
        window: "周期类型",
        loadFailed: "额度周期加载失败，请重试。",
        current: "当前周期",
        recent: "已结束周期（90 天内）",
        showMore: "查看更多历史周期",
        noCurrent: "尚未采集到当前周期，后续用量观测会自动记录。",
        noHistory: "还没有已结束的周期。开始记录后，周期重置时会保留历史；未观测的旧周期无法还原。",
        referenceCost: "已记录 API 参考费用",
        lastPercent: "最后观测使用率",
        observedExhausted: "观测到额度耗尽",
        estimatedLimit: "整周期参考额度估算",
        approximate: "约 {amount}",
        unavailable: "数据不足",
        requests: "本地请求数",
        observation: "首次观测 {first} · 最后观测 {last} · {count} 次采样",
        estimateBasis: "估值依据：{time} 记录的 {amount} / {percent}，可能早于最后观测。",
        inProgress: "采集中",
        expired: "到期结束",
        earlyReset: "提前重置",
        windowChanged: "窗口变化",
        resetObserved: "观测到重置",
        ended: "已结束",
        partialStart: "从周期中途开始观测，未生成整周期估值。",
        missingPricing: "部分请求缺少参考价格，已记录费用可能不完整。",
        lowUtilization: "当前使用率不足 5%，未生成新的整周期估值。",
        observationGap: "观测存在间隔，可能遗漏重置前的用量。",
        ambiguousReset: "重置边界不确定，本周期记录可能不完整。",
        pendingUsage: "等待异步用量记录归集。",
        incompleteData: "部分数据不完整，估值仅供参考。",
        externalUsage: "本实例无法计入代理外的消费。",
      },
      usageWindow: {
