export default {
    accounts: {
      ...
      codexIdentity: {
        ...
        deviceSharedRestriction: '仅此模式：每个设备槽位同一时刻最多一个进行中的请求流或 WS 会话；结束即释放；其他策略无此额外限制。',
        ...
        validation: {
          ...
          deviceSharedRestrictionsInvalid: '设备共享必须限制每槽位 1 个活动对话，并关闭跨 API Key continuation。',
