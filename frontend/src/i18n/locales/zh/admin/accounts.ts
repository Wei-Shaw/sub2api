    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          codexSessionReauthDesc: '粘贴该账号的 Codex OAuth auth.json 或 accessToken，只替换凭据，不改并发、优先级、分组等配置。',
          codexSessionReauthPlaceholder: '粘贴一条 token 或一个 auth.json 对象（必须属于当前账号）',
          codexSessionReauthSubmit: '导入并更新账号',
