export default {
    accounts: {
      ...
      codexIdentity: {
        ...
        profilesDesc: '只启用该账号允许接收的环境。同一系统内可将 Desktop 与 CLI 统一，禁止跨系统转换。',
        fixErrors: '请先补全身份策略，再保存账号。',
        valid: '身份策略完整，保存时将由服务端再次校验。',
        windows: 'Windows',
        windowsDesc: '统一为 Windows Desktop 或 CLI 身份。',
        macos: 'macOS',
        macosDesc: '统一为 macOS Desktop 或 CLI 身份。',
        linux: 'Linux',
        linuxDesc: '统一为 Linux Desktop 或 CLI 身份。',
        generic: '通用 SDK / 第三方',
        genericOS: '通用',
        genericDesc: '适用于 Python、Node、curl 和受支持的第三方客户端。',
        surface: '客户端形态',
        desktop: '桌面版',
        cli: 'CLI',
        sdk: 'SDK',
        ...
        validation: {
          ...
          bindingScopeInvalid: '绑定范围必须是 API Key 加操作系统。',
          ...
          duplicateProfile: '每种操作系统 Profile 只能出现一次。',
