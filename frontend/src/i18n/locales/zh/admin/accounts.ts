export default {
    accounts: {
      ...
      grokProbeAll: '全部验活',
      grokProbeAllStarting: '正在启动...',
      grokProbeAllRunning: '验活 {completed}/{total}',
      grokProbeAllTooltip: '低并发探测全部 Grok OAuth 账号，并按返回状态自动更新调度状态',
      grokProbeAllProgress: '进度 {completed}/{total}，成功 {succeeded}，失败 {failed}',
      grokProbeAllCompleted: 'Grok 全部验活完成：成功 {succeeded}，失败 {failed}',
      grokProbeAllStartFailed: '启动 Grok 全部验活失败',
