export default {
    accounts: {
      ...
      tempUnschedulable: {
        ...
        ruleOrderHint: '规则按顺序匹配，首条命中即生效：请将更宽作用域的规则（如账号级熔断）排在前面。',
        description: '描述',
        descriptionPlaceholder: '可选，便于记忆规则用途',
        accountWide: '账号级熔断（额度为账号下所有模型共享时启用）',
        blockScope: '熔断作用域',
        blockScopeAccount: '账号级（所有模型）',
        blockScopeAccountRule: '账号级（所有模型，account_wide 规则触发）',
