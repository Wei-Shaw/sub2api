export default {
    accounts: {
      ...
      usageWindow: {
        ...
        grokMonthlyShort: '月',
        grokOnDemandShort: '量',
        grokFreeNoAPICredits: 'Grok Free：无 API 月度积分',
        grokFreeLimitedQuota: 'Grok Free：无月度 $，CLI 代理有限次数额度',
        grokFreeBillingNote: '账单 monthlyLimit=$0；额度看请求/Token 剩余（cli-chat-proxy）',
        grokFreePeriodEnd: '账单周期至 {time}',
