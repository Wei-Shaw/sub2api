export default {
    accounts: {
      ...
      openai: {
        ...
        codexInstallationId: 'Codex 安装实例 ID',
        codexInstallationIdDesc: '指纹策略使用的账号级 x-codex-installation-id。',
        codexInstallationIdPending: '尚未生成',
      ...
      oauth: {
        ...
        openai: {
          ...
          refreshTokenReauthDesc: '输入当前账号的新 OpenAI Refresh Token，验证后替换现有授权凭据。',
          refreshTokenReauthPlaceholder: '粘贴一个新的 OpenAI Refresh Token...',
          ...
          codexSessionReauthDesc: '粘贴一个 Codex auth.json 或 accessToken，验证后替换当前账号的授权凭据。',
          codexSessionReauthPlaceholder: '粘贴一个 token 或 auth.json 对象',
          codexSessionImportAndReauthorize: '导入并重新授权',
          ...
          codexPatReauthDesc: '输入一个 Codex at- Personal Access Token，校验后替换当前账号的授权凭据。',
          codexPatReauthPlaceholder: 'at-...',
          codexPatImportAndReauthorize: '校验并重新授权',
          ...
          validateAndReauthorize: '验证并重新授权',
          reauthSingleCredential: '重新授权一次只能提交一个凭据',
