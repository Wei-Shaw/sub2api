export default {
    accounts: {
      ...
      ollamaCloud: {
        ...
        unauthorized: '会话已过期',
        failed: '刷新失败',
        windowWithReset: '已用 {percentREDACTED，{resetREDACTED 重置',
        ...
        errors: {
          ...
          OLLAMA_CLOUD_USAGE_REFRESH_RATE_LIMITED: '刷新过于频繁，请在 {retry_after_secondsREDACTED 秒后重试。'
        REDACTED
      REDACTED,
      upstreamBilling: {
        ...
        failed: '失败',
        notProbed: '未探测',
        groupRate: '分组默认：{valueREDACTEDx',
        userRate: '用户专属倍率：{valueREDACTEDx',
        peakRate: '高峰：{startREDACTED-{endREDACTED，{valueREDACTEDx（{timezoneREDACTED）',
        noPeakRate: '高峰倍率：未启用',
        effectiveRate: '当前倍率：{valueREDACTEDx',
        updatedAt: '更新时间：{valueREDACTED',
        nextProbeAt: '下一次探测：{valueREDACTED',
        lastDetectedRate: '上次探测倍率：{valueREDACTEDx',
        lastDetectedAt: '上次探测时间：{valueREDACTED',
        elapsedSince: '已过去：{valueREDACTED',
        justNow: '不足 1 分钟',
        minutesAgo: '{countREDACTED 分钟',
        hoursAgo: '{countREDACTED 小时',
        daysAgo: '{countREDACTED 天',
        ...
        batchCompleted: '已完成 {countREDACTED 个账号的倍率探测',
        batchPartial: '倍率探测部分完成：成功 {successREDACTED 个，失败 {failedREDACTED 个'
      REDACTED,
      ...
      status: {
        ...
        tempUnschedulableUntil: '预计 {timeREDACTED 恢复'
      REDACTED,
      tempUnschedulable: {
        title: '临时不可调度',
        ...
        addRule: '添加规则',
        ruleOrder: '规则序号',
        multipleErrorTrigger: '{minutesREDACTED 分钟内累计 {countREDACTED 次匹配错误，达到触发阈值（{thresholdREDACTED）。',
        multipleErrorTriggerNoWindow: '累计 {countREDACTED 次匹配错误，达到触发阈值（{thresholdREDACTED）。',
        multipleErrorCountInWindow: '{minutesREDACTED 分钟内累计发生 {countREDACTED 次匹配错误。',
        multipleErrorCount: '本次不可调度由累计 {countREDACTED 次匹配错误触发。',
      ...
      usageWindow: {
        ...
        grokRequests: '请求',
        grokTokens: 'Token',
        grokFreeQuota24hHint: '按 sub2api 近 24 小时本地 Token 用量估算（上限 {limitREDACTED）',
        grokWeeklyUsage: '周额度已用 {percentREDACTED%',
        grokUsed: '已用 $',
        grokBalance: '余额 $',
        grokPrepaid: '预付余额',
      ...
      openaiQuotaReset: {
        ...
        resetSuccess: '已重置 {windowsREDACTED 个窗口，次数和账号状态已更新',
      ...
      bulkActions: {
        ...
        selectedAll: '已选择全部 {countREDACTED 个账号',
        selectCurrentPage: '本页全选',
        selectAllResults: '全选所有结果（{countREDACTED）',
        selectingAll: '正在选择全部结果...',
        selectAllFailed: '获取全部账号失败，原有选择未改变',
        clear: '清除选择',
        edit: '批量编辑账号',
        delete: '批量删除',
        confirmDelete: '确认删除选中的 {countREDACTED 个账号吗？此操作不可恢复。',
        deleteSuccess: '已成功删除 {countREDACTED 个账号',
      ...
      bulkEdit: {
        ...
        successWithInherited: '成功更新 {countREDACTED 个账号；其中 {inheritedREDACTED 个影子账号仍跟随母账号。',
        partialSuccess: '部分更新成功：成功 {successREDACTED 个，失败 {failedREDACTED 个',
        partialSuccessWithInherited: '部分更新成功：成功 {successREDACTED 个，失败 {failedREDACTED 个；其中 {inheritedREDACTED 个影子账号仍跟随母账号。',
        failed: '批量更新失败',
        noSelection: '请选择要编辑的账号',
        noFieldsSelected: '请至少选择一个要更新的字段',
        rateSyncWarning: '已开启上游倍率同步的账号不能批量手工修改倍率，请先在账号编辑页关闭同步。',
        rateSyncConflict: '无法修改账号倍率：{countREDACTED 个目标账号已开启上游倍率同步。',
      ...
      duplicateSuccess: '账号已复制为「{nameREDACTED」，已暂停调度，请确认凭据后再启用',
      ...
      grok: {
        ...
        selectedTestMode: '测试模式：{modeREDACTED',
      ...
      errorPrefix: '错误：{messageREDACTED',
      imagePreviewAlt: '测试图片 {indexREDACTED',
      ...
      audioPreview: '生成音频：',
      audioReceived: '已收到第 {countREDACTED 段测试音频',
      videoPreview: '生成视频：',
      videoReceived: '已收到第 {countREDACTED 段测试视频',
      // Stats Modal
      viewStats: '查看统计',
