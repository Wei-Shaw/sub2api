export default {
    ...
    subscriptions: {
      ...
      resetGroupQuota: '重置分组配额',
      resetGroupQuotaTitle: '重置分组用量配额',
      resetGroupQuotaConfirm: "确定要重置分组 '{group}' 下所有有效订阅的每日、每周和每月用量配额吗？用量将归零并从今天开始重新计算。",
      groupQuotaResetSuccess: '已重置 {count} 条有效订阅的配额',
      groupQuotaResetPartial: '成功重置 {success} 条订阅，{failed} 条失败',
      failedToResetGroupQuota: '重置分组配额失败',
