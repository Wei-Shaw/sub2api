export default {
    ...
    channels: {
      ...
      intervalValidation: {
        ...
        multiplierPositive: '区间 #{indexREDACTED：{fieldREDACTED必须大于 0',
    ...
    channelMonitor: {
      ...
      duplicate: '复制',
      duplicating: '复制中',
      duplicateSuccess: '监控已复制为「{nameREDACTED」，已默认停用，请确认配置后再启用',
    ...
    subscriptions: {
      ...
      hoursMinutesRemaining: '剩余 {hoursREDACTED 小时 {minutesREDACTED 分钟',
      minutesRemaining: '剩余 {minutesREDACTED 分钟',
      remainingDays: '剩余天数',
      noExpiration: '无过期时间',
      status: {
        active: '生效中',
