export default {
    ...
    subscriptions: {
      ...
      adjusting: '调整中...',
      editLimits: '额度',
      editLimitsTitle: '设置用户订阅额度',
      editLimitsFor: '为 {user} 设置独立订阅额度',
      userLimits: '用户独立额度（可选）',
      userLimitsHint: '留空时使用分组额度；设置后该用户优先使用这里的额度。',
      dailyLimit: '每日额度（USD）',
      weeklyLimit: '每周额度（USD）',
      monthlyLimit: '每月额度（USD）',
      clearLimitHint: '留空并保存会清除用户独立额度，随后回退到分组额度。',
      groupLimitPlaceholder: '分组额度 ${limit}',
      invalidLimit: '额度必须大于 0',
      limitsUpdated: '用户订阅额度已更新',
      failedToUpdateLimits: '更新用户订阅额度失败',
      revoke: '撤销',
      restore: '恢复',
      resetQuota: '重置配额',
      ...
      guide: {
        ...
        actions: {
          ...
          limits: '用户额度',
          limitsDesc: '为单个用户覆盖日/周/月额度，留空则回退到分组额度',
          resetQuota: '重置配额',
