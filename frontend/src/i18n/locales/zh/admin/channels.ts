export default {
    ...
    subscriptions: {
      ...
      permanentDeleteTitle: '永久删除订阅',
      permanentDeleteConfirm: "确定要永久删除 '{user}' 的已撤销订阅吗？此操作无法恢复。",
      permanentDeleteSuccess: '订阅已永久删除',
      failedToPermanentDelete: '永久删除订阅失败',
      allStatus: '全部状态',
      allGroups: '全部分组',
      allPlatforms: '全部平台',
      daily: '每日',
      ...
      batch: {
        ...
        apply: '应用',
        applying: '处理中...',
        resetWindows: '要重置的配额周期',
        selectResetWindow: '请至少选择一个配额周期',
        invalidDays: '请输入 -36500 到 36500 之间的非零整数',
        selectionLimit: '每次最多处理 {max} 个订阅',
        revokeWarning: '仅生效中的订阅会被撤销，不符合条件的订阅将被跳过。',
        permanentDeleteWarning: '仅已撤销的订阅会被永久删除，且此操作无法恢复。',
        confirmDanger: '我已了解此操作的影响',
        result: '处理完成：成功 {succeeded} 个，跳过 {skipped} 个，失败 {failed} 个',
        failed: '批量操作订阅失败',
        actions: {
          adjust: '调整有效期',
          resetQuota: '重置配额',
