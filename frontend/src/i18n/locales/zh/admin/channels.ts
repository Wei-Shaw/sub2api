export default {
    ...
    subscriptions: {
      ...
      bulk: {
        ...
        setWindowsHint: '只改下次重置时间，已用额度不变。至少填写一个窗口起点。',
        selectWindow: '请至少选择一个配额窗口',
        selectWindowStart: '请至少设置一个重置周期起点',
      ...
      setQuotaWindows: '调整重置周期',
      setQuotaWindowsTitle: '调整重置周期',
      setQuotaWindowsHint: '只改下次重置时间，已用额度不变。',
      weeklyWindowStart: '周窗口起点',
      monthlyWindowStart: '月窗口起点',
      alignToGroupPeer: '对齐到同组 {time}',
      quotaWindowsUpdated: '重置周期已更新',
      failedToSetQuotaWindows: '调整重置周期失败',
      pleaseSetWindowStart: '请至少设置一个重置周期起点',
