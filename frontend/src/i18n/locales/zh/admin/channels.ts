export default {
    ...
    channels: {
      ...
      form: {
        ...
        timezoneOptions: {
          UTC: '协调世界时 (UTC)',
          Asia_Shanghai: '北京时间 (Asia/Shanghai, UTC+08:00)',
          Asia_Hong_Kong: '香港时间 (Asia/Hong_Kong, UTC+08:00)',
          Asia_Tokyo: '日本标准时间 (Asia/Tokyo, UTC+09:00)',
          Asia_Seoul: '韩国标准时间 (Asia/Seoul, UTC+09:00)',
          Asia_Singapore: '新加坡时间 (Asia/Singapore, UTC+08:00)',
          Asia_Kolkata: '印度标准时间 (Asia/Kolkata, UTC+05:30)',
          Asia_Dubai: '海湾标准时间 (Asia/Dubai, UTC+04:00)',
          Europe_London: '英国时间 (Europe/London)',
          Europe_Paris: '中欧时间 (Europe/Paris)',
          Europe_Berlin: '中欧时间 (Europe/Berlin)',
          Europe_Moscow: '莫斯科时间 (Europe/Moscow, UTC+03:00)',
          America_New_York: '美国东部时间 (America/New_York)',
          America_Chicago: '美国中部时间 (America/Chicago)',
          America_Denver: '美国山地时间 (America/Denver)',
          America_Los_Angeles: '美国太平洋时间 (America/Los_Angeles)',
          America_Sao_Paulo: '圣保罗时间 (America/Sao_Paulo)',
          Australia_Sydney: '澳大利亚东部时间 (Australia/Sydney)',
          Pacific_Auckland: '新西兰时间 (Pacific/Auckland)'
        },
        timePeriods: '计费时段',
