export default {
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "确定要重置 '{user}' 当前选中的用量配额吗？只有选中的周期会被清零并重新计算。",
      resetQuotaSelectHint: '选择要重置的用量周期，未选中的周期不会受到影响。',
      noResettableQuota: '该订阅未配置可重置的配额。',
      ...
      guide: {
        ...
        actions: {
          ...
          resetQuota: '重置配额',
          resetQuotaDesc: '选择要重置的日/周/月用量，重新开始计算',
          revoke: '撤销',
