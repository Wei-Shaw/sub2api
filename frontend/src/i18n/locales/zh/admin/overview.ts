export default {
    ...
    groups: {
      ...
      smartRouting: {
        title: '智能路由成员分组',
        hint: '请求优先发给优先级最高（数值最小）的成员分组；失败后按优先级从高到低重试。同一优先级内按权重分流（权重越大分配请求越多）。',
        addMember: '添加成员分组',
        removeMember: '移除',
        memberGroup: '成员分组',
        priority: '优先级',
        priorityHint: '1 为最高优先级，数值越小越先请求',
        weight: '权重',
        weightHint: '同优先级内按权重比例分配流量，最小为 1',
        selectGroup: '选择分组',
        empty: '请至少添加一个成员分组',
        membersRequired: '智能路由分组必须配置至少一个成员分组',
        memberColumns: '成员分组 / 优先级 / 权重',
      },
      noGroupsYet: '暂无分组',
