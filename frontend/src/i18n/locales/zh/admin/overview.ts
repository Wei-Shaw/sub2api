export default {
    ...
    groups: {
      ...
      form: {
		...
		quotaOptimization: '额度消耗优化',
		quotaStickyDefault: '默认开启额度优先粘性调度',
		quotaStickyOverride: '允许 API Key 用户覆盖默认值',
		sessionModelStability: '保持会话内上游模型稳定',
		unifiedRetryBudget: '启用统一重试预算',
        exclusiveLabel: '专属分组',
