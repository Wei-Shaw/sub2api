export default {
    ...
    users: {
      ...
      form: {
        ...
        selectRole: '选择角色',
        balanceLabel: '余额',
        concurrencyLabel: '标准并发数',
        extraConcurrencyDefaultPlaceholder: '留空则使用系统默认值',
        statusLabel: '状态',
        selectStatus: '选择状态',
        rpmLimit: '每分钟请求数 (RPM)',
      ...
      adjustBalance: '调整余额',
      adjustConcurrency: '调整标准并发数',
      adjustmentAmount: '调整金额',
      adjustmentAmountHint: '正数增加，负数减少',
      currentBalance: '当前余额',
      currentConcurrency: '当前标准并发数',
      saving: '保存中...',
      noUsers: '暂无用户',
      ...
      failedToAdjust: '调整失败',
      emailRequired: '请输入邮箱',
      concurrencyMin: '标准并发数不能小于 1',
      extraConcurrencyMin: '额外并发数必须是非负整数',
      ...
      typeConcurrency: '标准并发（兑换码）',
      typeAdminConcurrency: '标准并发（管理员调整）',
      typeAdminExtraConcurrency: '额外并发（管理员调整）',
      typeSubscription: '订阅',
