export default {
    ...
    groups: {
      ...
      form: {
        ...
        modelReasoningEffortRules: '模型专属规则',
        modelReasoningEffortRulesHint: '精确匹配客户端请求模型；删除规则后恢复使用分组默认规则。',
        addModelReasoningEffortRule: '添加模型规则',
        removeModelReasoningEffortRule: '删除模型规则',
        reasoningEffortModel: '模型名称',
        reasoningEffortModelPlaceholder: '例如 gpt-5.6-luna',
        modelReasoningEffortUnlimited: '不限制（覆盖分组默认）',
