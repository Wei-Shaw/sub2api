export default {
    ...
    users: {
      ...
      rotateKey: {
        action: '轮换',
        title: '轮换用户 API 密钥',
        description: '将为用户 {email} 的密钥“{name}”生成新凭据，原记录和配置保持不变。',
        warning: '旧密钥将立即失效。请安全地把新密钥交付给用户，并提醒其更新所有客户端。',
        acknowledge: '我已了解旧密钥会立即失效',
        confirm: '确认轮换',
        rotating: '轮换中...',
        successTitle: '用户 API 密钥已轮换',
        successMessage: '新密钥已生效',
        oldKeyInvalid: '旧密钥现在已无法继续使用。',
        preserved: '密钥 ID、用户、分组、额度、限制和计费历史均保持不变。',
        copied: '新密钥已复制',
        done: '我已保存，完成',
        failed: '轮换用户 API 密钥失败'
      },
      group: '分组',
      none: '无',
