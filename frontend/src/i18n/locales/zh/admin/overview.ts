export default {
    ...
    groups: {
      ...
      setQuotaWindows: '对齐重置周期',
      setQuotaWindowsTitle: '对齐组内重置周期',
      setQuotaWindowsHint: '将组内所有有效订阅的周/月窗口改到同一起点。已用额度不变。',
      weeklyWindowStart: '周窗口起点',
      monthlyWindowStart: '月窗口起点',
      quotaWindowsUpdated: '已更新 {success} 条订阅的重置周期',
      quotaWindowsPartial: '重置周期更新完成：成功 {success} 条，失败 {failed} 条',
      failedToSetQuotaWindows: '对齐组内重置周期失败',
      pleaseSetWindowStart: '请至少设置一个重置周期起点',
      resetGroupQuota: '重置组内配额',
      resetGroupQuotaTitle: '重置组内配额',
      resetGroupQuotaHint: '与订阅管理页的「重置配额」相同：将组内所有有效订阅的所选窗口用量归零，并重新开始计周期（日窗回到当天 0 点，周/月窗从现在起算）。',
      resetGroupQuotaSuccess: '已重置 {success} 条订阅的配额',
      resetGroupQuotaPartial: '组内配额重置完成：成功 {success} 条，失败 {failed} 条',
      failedToResetGroupQuota: '重置组内配额失败',
