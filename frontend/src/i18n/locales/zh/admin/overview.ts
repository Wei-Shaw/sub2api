export default {
    ...
    users: {
      ...
      apiKeyName: '名称',
      apiKeyNamePlaceholder: '请输入密钥名称',
      apiKeyCustomKey: '自定义密钥（可选）',
      apiKeyCustomKeyPlaceholder: '留空则自动生成',
      apiKeyGroup: '分组',
      apiKeyGroupNone: '不绑定',
      apiKeyQuota: '配额 (USD，0 表示不限)',
      apiKeyExpiresInDays: '有效天数（留空表示永不过期）',
      apiKeyRateLimit5h: '5 小时限额',
      apiKeyRateLimit1d: '1 天限额',
      apiKeyRateLimit7d: '7 天限额',
      apiKeyNameRequired: '请输入密钥名称',
      apiKeyLimitInvalid: '配额、限额与有效天数必须为非负数字，有效天数需大于 0',
      createKeySuccess: 'API 密钥创建成功',
      createKeyFailed: '创建 API 密钥失败',
      createdKeyNotice: '请立即复制并妥善保管，此密钥仅完整显示一次。',
      copyKey: '复制密钥',
      submitCreate: '创建',
      cancelCreate: '取消',
      noUsersYet: '暂无用户',
