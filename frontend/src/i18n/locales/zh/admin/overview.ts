export default {
    ...
    users: {
      ...
      createUser: '创建用户',
      bulkLimits: {
        action: '批量设置限制（{countREDACTED）',
        title: '批量设置用户限制',
        selectedCount: '已选择 {countREDACTED 个用户',
        selectionLimit: '一次最多选择 {maxREDACTED 个用户。',
        selectUser: '选择 {emailREDACTED',
        ...
        apply: '应用限制',
        applying: '应用中...',
        concurrencyValue: '并发数：{valueREDACTED',
        rpmValue: 'RPM：{valueREDACTED',
        rpmUnlimitedValue: 'RPM：不限制',
        confirm: '确定覆盖 {countREDACTED 个用户的限制吗？\n{fieldsREDACTED',
        success: '已更新 {countREDACTED 个用户的限制',
        failed: '批量更新用户限制失败'
      REDACTED,
      editUser: '编辑用户',
      deleteUser: '删除用户',
    ...
    groups: {
      ...
      duplicate: '复制',
      duplicating: '复制中',
      duplicateSuccess: '分组已复制为「{nameREDACTED」，已默认停用，请确认配置后再启用',
      ...
      webSearchPricing: {
        ...
        finalPricePreview: '应用当前倍率后的单次价格：{priceREDACTED'
      REDACTED,
      peakRate: {
        enable: '启用高峰倍率',
        peakStart: '高峰开始',
      ...
      compositeRoutes: {
        action: '路由',
        title: 'Composite 路由',
        titleWithGroup: 'Composite 路由：{nameREDACTED',
        routes: '已保存路由',
