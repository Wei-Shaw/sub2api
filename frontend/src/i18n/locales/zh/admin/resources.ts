export default {
    ...
    proxies: {
      ...
      consoleTitle: '代理控制台',
      consoleDescription: '从 IP管理读取可用代理，并进入各代理配置的控制台页面。',
      consoleURL: '控制台地址（可选）',
      consoleURLPlaceholder: '例如 https://proxy.example.com/console',
      consoleURLHint: 'MetaCubeXD 的 /ui 地址会自动连接；其他 HTTP/HTTPS 面板按原地址打开。不要包含账号、密码或 secret。',
      manageConsoleAddresses: '管理控制台地址',
      noConsoleProxies: '暂无可进入的代理控制台',
      noConsoleProxiesHint: '请先在 IP管理中编辑代理并填写控制台地址。',
      goToProxyManagement: '前往 IP管理',
      openConsole: '进入控制台',
