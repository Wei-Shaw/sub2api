export default {
    settings: {
      ...
      jshandler: {
        ...
        accountBindingHint: '在账号管理中为每个账号选择脚本；未绑定的账号不执行 JS 钩子。',
        scriptLibrary: '脚本库',
        uploadScript: '上传 .js',
        noScripts: '尚未上传脚本。',
        uploaded: '脚本已上传',
        ...
        preview: '预览',
        previewTitle: '脚本预览',
        previewLoading: '正在加载脚本…',
        previewFailed: '加载脚本内容失败',
        previewEmpty: '脚本内容为空',
        copyCode: '复制代码',
        copied: '已复制',
        copyFailed: '复制失败',
        ...
        editTitle: '编辑脚本',
        editName: '脚本名称',
        editNamePlaceholder: '显示名称',
        editContent: '脚本代码',
        editContentHint: '支持 on_after_auth_request / on_after_nonstream_response / on_after_stream_response',
        editLoading: '正在加载脚本…',
        editSave: '保存脚本',
        editSaving: '保存中…',
        editSaved: '脚本已保存',
        editFailed: '保存脚本失败',
        editLoadFailed: '加载脚本失败',
        editEmptyContent: '脚本内容不能为空',
        editFromPreview: '编辑',
        hooksReference: '钩子：on_after_auth_request、on_after_nonstream_response、on_after_stream_response（on_before_request 需账号上下文）。',
        saved: 'JS 重写配置已保存',
