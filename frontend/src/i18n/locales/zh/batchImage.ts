export default {
  batchImage: {
    ...
    REDACTED,
    list: {
      selectedJobs: '已选择 {countREDACTED 个任务',
      expandChildren: '展开 {nREDACTED 个子任务',
      collapseChildren: '收起子任务',
      childCount: '{nREDACTED 子任务',
      childBadge: '子任务',
      keyNotRecorded: '未记录',
      totalCount: '共 {nREDACTED',
      notDownloaded: '未下载',
      empty: '暂无批量任务',
      emptyHint: '点击右上角创建批量任务。',
    REDACTED,
    pagination: {
      pageNumber: '第 {pageREDACTED 页',
      pageItems: '本页 {countREDACTED 条',
    REDACTED,
    promptPopover: {
      title: '完整 Prompt',
      copied: 'Prompt 已复制',
    ...
    detail: {
      ...
      mainTask: '主任务：{nameREDACTED',
      childTask: '子任务：{nameREDACTED',
      holdCost: '冻结 {amountREDACTED',
    REDACTED,
    itemResult: {
    ...
    create: {
      ...
      estimatedOutputValue: '{imagesREDACTED 张 / {promptsREDACTED 条',
      promptAdded: '已添加 {countREDACTED 条',
      promptPlaceholder: '粘贴 prompt，添加后进入下方列表',
      customIdPlaceholder: 'Custom ID 可选',
      outputCountPerPrompt: '每条生成张数',
      outputCountOption: '{nREDACTED 张',
      referenceImage: '参考图',
      removeReferenceImage: '移除参考图',
      limitsHint: '每条最多 {maxPerItemREDACTED 张，整组最多 {maxPerJobREDACTED 张；当前模型每条最多 {refLimitREDACTED 张参考图，参考图按生成张数重复消耗输入 token。',
      referenceCount: '{nREDACTED 参考图',
      ...
      refLimitReached: '当前模型每条最多 {limitREDACTED 张参考图。',
      refLimitExceededIgnored: '当前模型每条最多 {limitREDACTED 张参考图，已忽略超出的文件。',
      refFormatUnsupported: '参考图仅支持 PNG、JPEG 或 WebP。',
      refFileTooLarge: '{nameREDACTED 超过 10MB，已忽略。',
    REDACTED,
    guide: {
      title: '批量生图使用说明',
      uiTitle: '当前界面如何使用',
    ...
    messages: {
      ...
      errorReference: '错误信息',
      errorCodeRef: '错误码：{codeREDACTED',
      requestIdRef: '请求 ID：{idREDACTED',
      httpStatusRef: 'HTTP 状态：{statusREDACTED',
    REDACTED,
  REDACTED,
REDACTED
