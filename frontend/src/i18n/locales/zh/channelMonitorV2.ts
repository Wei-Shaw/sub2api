...
export default {
  channelMonitorV2: {
    ...
    filters: {
      ...
      empty: '暂无可选项', selectedCount: '{countREDACTED 项', labelValue: '{labelREDACTED：{valueREDACTED'
    REDACTED,
    groupBy: {
      label: '展示维度', platform: '平台', platformGroup: '平台 / 分组', platformModel: '平台 / 模型', platformGroupModel: '平台 / 分组 / 模型'
    REDACTED,
    trendView: { label: '趋势视图', pulse: '色块矩阵', line: '折线图' REDACTED,
    healthMode: { label: '健康显示', overall: '综合', success: '错误率', ttft: '首 Token', cache: '缓存率' REDACTED,
    tabs: { aria: '明细维度', models: '模型', errors: '错误原因', users: '用户排行' REDACTED,
    metrics: {
      ...
      successRateValue: '成功率 {valueREDACTED', errorRateValue: '错误率 {valueREDACTED', rpmValue: 'RPM {valueREDACTED', tpmValue: 'TPM {valueREDACTED', ttftValue: '首 Token {valueREDACTED', durationValue: '请求时长 {valueREDACTED', cacheRateValue: '缓存率 {valueREDACTED'
    REDACTED,
    table: { platformModel: '平台 / 模型', rank: '排名', user: '用户' REDACTED,
    empty: { title: '没有可展示的数据', description: '尝试调整时间范围或筛选条件' REDACTED,
    bucket: { minutes: '{countREDACTED 分钟粒度', hours: '{countREDACTED 小时粒度', days: '{countREDACTED 天粒度' REDACTED,
    matrix: {
      title: '可用性趋势', description: '每行是一种渠道组合，每个色块代表一个统计区间；悬停查看明细', wheelZoom: '在色块上滚轮缩放', wheelZoomX: '在色块上滚轮横向缩放', dimension: '渠道维度', emptyTitle: '当前筛选窗口没有矩阵数据', legendAria: '健康分数图例', bad: '差', good: '好', healthyLegend: '健康 (≥80)', warningLegend: '需关注 (50–79)', criticalLegend: '异常 (<50)', unknownLegend: '无流量 / 样本不足', noTraffic: '该区间无流量', noTrafficAt: '{timeREDACTED · 无流量', scoreLine: '健康分 {scoreREDACTED', resetZoom: '重置缩放'
    REDACTED,
    chart: {
    ...
    REDACTED,
    errorDetail: { http: 'HTTP {codeREDACTED', upstream: '上游 {codeREDACTED', noMessage: '无错误消息', empty: '仅展示分类占比（样本消息仅管理员可见）' REDACTED,
    errorCategories: {
    ...
    settings: {
      ...
      modeBanner:
        '当前系统设置为 {modeREDACTED。V2 分钟聚合不会运行；此处配置可预先保存，切换到 {modeV2REDACTED 后立即生效。可在系统设置 → 功能开关调整。',
      modeClosed: '渠道监控已关闭',
      modeV1: 'V1 主动探测',
      modeV2: 'V2 被动监控',
      ...
      badgeOther: '+ 其他',
      groupsTitle: '监控分组',
      groupsSelected: '已选择 {countREDACTED 个分组',
      groupsAll: '全部分组',
      groupsEmpty: '没有可选择的分组',
      errorsTitle: '错误分类与忽略',
      errorsHint:
        '勾选「忽略」的类别不计入错误率与健康分，仍在错误原因列表中以灰色显示并标记忽略。未匹配的错误归入「其他」。',
      ignoredSummary: '已忽略 {ignoredREDACTED 类 · 计入错误率 {countedREDACTED 类',
      healthTitle: '健康阈值',
      ...
      namedModelsCount: '将展示 {countREDACTED 个命名模型维度；名单外模型归入各平台「其他」。',
