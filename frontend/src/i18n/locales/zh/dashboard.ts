export default {
  ...
  keys: {
    ...
    platformLimitsHint: '混合分组下同一个密钥会路由到多个上游平台。这里给单个来源再加一层限额，与上面的密钥级限额同时生效（任一触顶即拒绝）。未列出的来源不额外限制。',
    platformLimitsAdd: '添加来源',
    platformLimitsPlatform: '上游来源',
    platformLimitsQuota: '总额度 (USD)',
    platformLimitsRemove: '移除该来源',
    platformLimitsEmpty: '还没有配置任何来源限额。',
    platformLimitsAllUsed: '所有来源都已配置。',
    platformLimitsUsage: '该来源用量',
    resetPlatformUsage: '重置来源用量',
    resetPlatformUsageTitle: '确认重置来源用量',
    resetPlatformUsageConfirmMessage: '确定要重置密钥 "{name}" 各来源的限额用量吗？所有来源的总额度与时间窗口用量都将归零。此操作不可撤销。',
    platformUsageResetSuccess: '来源用量已重置',
    failedToResetPlatformUsage: '重置来源用量失败',
    resetNow: '即将重置',
    expiration: '密钥有效期',
