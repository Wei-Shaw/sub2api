export default {
  ...
  usage: {
    ...
    REDACTED,
    tabs: { usage: '用量明细', errors: '错误请求', ranking: '用户排行' REDACTED,
    errors: {
  ...
  modelPlaza: {
    ...
    detail: {
      noModels: '该分组暂未配置模型',
      noPricing: '未配置定价',
      peakNote: '高峰时段 {windowREDACTED 计费倍率 ×{multiplierREDACTED',
    ...
    table: {
      ...
      timePricingRowHint: '按 {timezoneREDACTED 时间，在该时段内发起的请求按本行价格计费',
      timePricingRowHintWeekdays:
        '按 {timezoneREDACTED 时间，仅工作日（周一至周五）在该时段内发起的请求按本行价格计费，周末全天按标准价',
      timePricingRowHintPeak: '；本行价格未含高峰倍率，与高峰时段 {windowREDACTED 重叠的部分实付再乘 ×{multiplierREDACTED',
      timePricingWeekdays: '工作日',
      timePricingRateHint: '生效倍率 {rateREDACTED × 时段倍率 {multiplierREDACTED',
      paidPrice: '实付价格(折后)',
      officialPrice: '官方价格',
      rate: '折扣倍率',
      unitPerMillion: '$ / 1M token',
  ...
  profile: {
    ...
    passkey: {
      ...
      synced: '已同步',
      createdAt: '创建于 {dateREDACTED',
      lastUsed: '上次使用 {dateREDACTED',
      ...
      deleteConfirm: '删除“{nameREDACTED”？删除后将无法再使用它登录。',
      deleted: 'Passkey 已删除。',
