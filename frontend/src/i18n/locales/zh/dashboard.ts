export default {
  ...
  usage: {
    ...
    diagnosis: {
      ...
      group: '分组',
      headers: '请求头',
      requestBodyJson: '请求 Body · JSON',
      upstreamRequestBodyJson: '上游请求 Body · JSON',
      responseBodyJson: '响应 Body · JSON',
      responseHeaders: '响应头',
      emptyBody: '未记录到正文。',
      emptyHeaders: '未记录到请求头。',
      emptyUpstreamRequest: '未记录到上游请求。',
      jsonTruncated: 'JSON（截断预览）',
      attempts: '尝试',
      attempt: '尝试 #{n}',
      upstream: '上游',
      startTime: '开始时间',
      ...
      requestPath: '请求路径',
      upstreamUrl: '上游 URL',
      noErrorChain: '没有 Error Chain。',
      noDisplayContent: '没有可显示的正文。',
      roleSystem: '系统',
      roleUser: '请求',
      roleAssistant: '回复',
      roleThinking: '思考',
