export default {
  ...
  redeem: {
    title: '兑换码',
    description: '输入兑换码以充值余额或增加标准并发数',
    currentBalance: '当前余额',
    concurrency: '标准并发数',
    standardConcurrency: '标准并发数',
    extraConcurrency: '额外并发数',
    requests: '请求',
    redeemCodeLabel: '兑换码',
    ...
    newBalance: '新余额',
    newConcurrency: '新标准并发数',
    aboutCodes: '关于兑换码',
    codeRule1: '每个兑换码只能使用一次',
    codeRule2: '兑换码可以增加余额、标准并发数或试用权限',
    codeRule3: '如有兑换问题，请联系客服',
    codeRule4: '余额和标准并发数即时更新',
    recentActivity: '最近活动',
    ...
    concurrencyAddedRedeem: '标准并发增加（兑换）',
    concurrencyAddedAdmin: '标准并发增加（管理员）',
    concurrencyReducedAdmin: '标准并发减少（管理员）',
    extraConcurrencyAddedAdmin: '额外并发增加（管理员）',
    extraConcurrencyReducedAdmin: '额外并发减少（管理员）',
  ...
  profile: {
    ...
    standardConcurrencyLimit: '标准并发数',
    extraConcurrencyLimit: '额外并发数',
    rpmLimit: 'RPM 限制',
    rpmUnlimited: '不限制',
    memberSince: '注册时间',
    overviewTitle: '账户总览',
