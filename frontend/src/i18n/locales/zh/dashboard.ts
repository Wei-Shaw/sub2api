export default {
  ...
  keys: {
    ...
    rotate: {
      action: '轮换',
      title: '轮换 API 密钥',
      description: '系统会在当前密钥记录上生成新凭据，名称、分组、并发限制和用量记录保持不变。',
      warning: '轮换完成后旧密钥将立即失效。所有使用旧密钥的客户端都需要更新。',
      acknowledge: '我已了解旧密钥会立即失效',
      confirm: '确认轮换',
      rotating: '轮换中...',
      successTitle: 'API 密钥已轮换',
      successMessage: '新密钥已生效',
      oldKeyInvalid: '旧密钥现在已无法继续使用。',
      preserved: '名称、分组、并发限制、额度、IP 规则、过期时间和计费历史均保持不变。',
      copied: '新密钥已复制',
      done: '我已保存，完成',
      failed: '轮换 API 密钥失败'
    },
