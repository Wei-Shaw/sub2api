export default {
  organization: {
    ...
    upgrade: { title: '升级企业账户', backToProfile: '返回个人资料', feeLabel: '升级费用', feeNotice: '提交申请后，升级费用将从可用余额中冻结。审批通过后才会正式扣除；审批拒绝或中止申请时，冻结费用将退还至余额。', chargedFee: '费用快照', free: '免费', submit: '提交审批', withdraw: '中止', insufficientBalance: '余额不足，无法冻结升级费用', englishNameHint: '全局唯一，仅允许英文字母、数字、空格及 & . , - \' ( ) 等符号', englishNameTaken: '该公司英文名已被占用，请更换', englishNameInvalid: '公司英文名格式不正确，仅允许英文字母、数字、空格及基本符号', companySizePlaceholder: '请选择公司规模', companySizeInvalid: '请选择有效的公司规模', ineligible: { not_personal_root: '当前身份不能申请企业升级。', already_company_account: '当前账号已经是企业账户。', application_pending: '已有一项企业升级申请等待审批。', unknown: '当前账号不符合企业升级条件。' } },
