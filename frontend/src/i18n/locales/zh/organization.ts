export default {
  organization: {
    console: '企业控制台', accountId: '账号 ID', accountType: { label: '账号类型', personal: '个人账号', company: '企业账号' }, accountIdentity: { label: '账号身份', root: '主账号', iam: '子账号' }, iamUserId: 'IAM 成员 ID', principal: '登录主体', companyName: '企业名称', companyId: '公司 ID', companySize: '公司规模', role: '管理权限', policies: '权限策略', reviewReason: '审批意见',
    ...
    tabs: { members: '成员', allocation: '资金划拨', finance: '财务', dashboard: '仪表盘', subscriptions: '订阅套餐', usage: '使用记录' },
    ...
    balanceSource: { label: '扣费来源', self: '主账号余额', allocated: '子账号划拨余额', shared: '共享公司账户余额', subscription: '企业订阅套餐' },
    subscriptions: { description: '为企业开通订阅套餐（分组），企业 API 密钥可绑定这些套餐使用其额度。', createTitle: '开通订阅套餐', group: '套餐分组', selectGroup: '请选择分组', createHint: '开通订阅套餐需付费下单，与个人订阅一致，费用由当前所有者支付，订阅将开通到公司主体。', empty: '暂无订阅套餐', status: '状态', usage: '用量', expiresAt: '到期时间', daily: '日', monthly: '月', cancel: '取消订阅', statuses: { active: '生效中', expired: '已过期', cancelled: '已取消' } },
