...
<template>
  ...
  <!-- Named route -->
  <router-link :to="{ name: 'Keys' REDACTED">API Keys</router-link>

  <!-- With query parameters -->
  <router-link :to="{ path: '/usage', query: { page: 1 REDACTED REDACTED"> Usage </router-link>
</template>
```
