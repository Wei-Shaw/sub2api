...
const routes: RouteRecordRaw[] = [
	...
	},
	{
		...
		component: () =>
			import("@/views/admin/affiliates/AdminAffiliateInvitesView.vue"),
		meta: {
			requiresAuth: true,
			requiresAdmin: true,
	...
	},
	{
		...
		component: () =>
			import("@/views/admin/affiliates/AdminAffiliateRebatesView.vue"),
		meta: {
			requiresAuth: true,
			requiresAdmin: true,
	...
	},
	{
		...
		component: () =>
			import("@/views/admin/affiliates/AdminAffiliateTransfersView.vue"),
		meta: {
			requiresAuth: true,
			requiresAdmin: true,
...
router.beforeEach(async (to, _from, next) => {
	...
	if (
		(to.meta.requiresPayment || to.meta.requiresRiskControl) &&
