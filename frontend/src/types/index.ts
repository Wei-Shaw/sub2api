...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'kiro' | 'grok' | 'fal' | 'atlascloud' | 'apiz' | 'kimi' | 'zhipu' | 'deepseek' | 'composite'
...
// ==================== Account & Proxy Types ====================
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'kiro' | 'grok' | 'fal' | 'atlascloud' | 'apiz' | 'kimi' | 'zhipu' | 'deepseek'
