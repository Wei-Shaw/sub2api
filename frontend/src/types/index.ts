...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | (string & {})
export type AccountType = 'oauth' | 'setup-token' | 'apikey' | 'upstream' | 'bedrock' | 'service_account' | (string & {})
