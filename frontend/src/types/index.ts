...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'cursor' | 'kimi' | 'zhipu' | 'deepseek' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'cursor' | 'kimi' | 'zhipu' | 'deepseek'
