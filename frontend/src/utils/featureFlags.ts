 ...
 *
 * ```ts
 * import { FeatureFlags, makeSidebarFlag REDACTED from '@/utils/featureFlags'
 *
 * const flagAvailableChannels = makeSidebarFlag(FeatureFlags.availableChannels)
 * // ...
 * { path: '/available-channels', label: ..., featureFlag: flagAvailableChannels REDACTED
 * ```
 *
...
import { DEFAULT_INTERVAL_SECONDS REDACTED from '@/constants/channelMonitor'
...
function defineFlag<K extends keyof PublicSettings>(
  def: { key: K; mode: FeatureFlagMode; label: string REDACTED,
