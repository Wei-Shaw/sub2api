...
const BADGE: Record<Platform, string> = {
  ...
  cursor: 'bg-sky-500/10 text-sky-700 border-sky-500/30 dark:text-sky-300',
  devin: 'bg-lime-500/10 text-lime-700 border-lime-500/30 dark:text-lime-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  cursor: 'bg-sky-500/10 text-sky-700 dark:bg-sky-500/10 dark:text-sky-300',
  devin: 'bg-lime-500/10 text-lime-700 dark:bg-lime-500/10 dark:text-lime-300',
...
const BORDER: Record<Platform, string> = {
  ...
  cursor: 'border-sky-500/20 dark:border-sky-500/20',
  devin: 'border-lime-500/20 dark:border-lime-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  cursor: 'border-sky-500/35 dark:border-sky-500/30',
  devin: 'border-lime-500/35 dark:border-lime-500/30',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  cursor: 'bg-gradient-to-r from-sky-400 to-sky-500',
  devin: 'bg-gradient-to-r from-lime-400 to-lime-500',
...
const TEXT: Record<Platform, string> = {
  ...
  cursor: 'text-sky-700 dark:text-sky-300',
  devin: 'text-lime-700 dark:text-lime-300',
...
const ICON: Record<Platform, string> = {
  ...
  cursor: 'text-sky-500 dark:text-sky-300',
  devin: 'text-lime-500 dark:text-lime-300',
...
const BUTTON: Record<Platform, string> = {
  ...
  cursor: 'bg-sky-500 text-white hover:bg-sky-600 active:bg-sky-700 dark:bg-sky-500/80 dark:hover:bg-sky-500',
  devin: 'bg-lime-600 text-white hover:bg-lime-700 active:bg-lime-800 dark:bg-lime-600/80 dark:hover:bg-lime-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  cursor: 'bg-sky-100 text-sky-800 dark:bg-sky-900/40 dark:text-sky-300',
  devin: 'bg-lime-100 text-lime-800 dark:bg-lime-900/40 dark:text-lime-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  cursor: 'from-sky-500 to-sky-600',
  devin: 'from-lime-500 to-lime-600',
