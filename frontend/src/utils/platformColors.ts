...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'grok' | 'qoder' | 'composite'
...
const BADGE: Record<Platform, string> = {
  ...
  qoder: 'bg-rose-500/10 text-rose-600 border-rose-500/30 dark:text-rose-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  qoder: 'bg-rose-500/10 text-rose-600 dark:bg-rose-500/10 dark:text-rose-300',
...
const BORDER: Record<Platform, string> = {
  ...
  qoder: 'border-rose-500/20 dark:border-rose-500/20',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  qoder: 'bg-gradient-to-r from-rose-400 to-rose-500',
...
const TEXT: Record<Platform, string> = {
  ...
  qoder: 'text-rose-600 dark:text-rose-400',
...
const ICON: Record<Platform, string> = {
  ...
  grok: 'text-zinc-800 dark:text-zinc-200',
  qoder: 'text-rose-500 dark:text-rose-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  qoder: 'bg-rose-500 text-white hover:bg-rose-600 active:bg-rose-700 dark:bg-rose-500/80 dark:hover:bg-rose-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  qoder: 'bg-rose-100 text-rose-700 dark:bg-rose-900/40 dark:text-rose-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  qoder: 'from-rose-500 to-rose-600',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'grok' || p === 'qoder' || p === 'composite'
}
