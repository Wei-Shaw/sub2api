...
export type RemainingExpiryDuration =
  | { unit: 'days'; days: number REDACTED
  | { unit: 'hoursMinutes'; hours: number; minutes: number REDACTED
...
export function getRemainingDurationParts(
  ...
  return { days, hours, minutes REDACTED
REDACTED
...
export function getRemainingExpiryDuration(
  ...
  if (diffMs >= ONE_DAY_MS) {
    return { unit: 'days', days: Math.ceil(diffMs / ONE_DAY_MS) REDACTED
  REDACTED
