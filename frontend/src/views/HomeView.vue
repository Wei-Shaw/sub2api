      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="flex flex-wrap items-center justify-center gap-4 md:gap-6 mb-12">
          <div class="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white/80 dark:bg-dark-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-dark-700/50 shadow-sm">
            ...
            <span class="text-sm font-medium text-gray-700 dark:text-dark-200">{{ t('home.tags.subscriptionToApi') REDACTEDREDACTED</span>
          </div>
          <div class="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white/80 dark:bg-dark-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-dark-700/50 shadow-sm">
            <svg class="w-4 h-4 text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
              <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
            </svg>
            <span class="text-sm font-medium text-gray-700 dark:text-dark-200">{{ t('home.tags.stickySession') REDACTEDREDACTED</span>
          </div>
          <div class="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white/80 dark:bg-dark-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-dark-700/50 shadow-sm">
            <svg class="w-4 h-4 text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
              <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
            </svg>
            <span class="text-sm font-medium text-gray-700 dark:text-dark-200">{{ t('home.tags.realtimeBilling') REDACTEDREDACTED</span>
          </div>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <div class="group p-6 rounded-2xl bg-white/60 dark:bg-dark-800/60 backdrop-blur-sm border border-gray-200/50 dark:border-dark-700/50 hover:shadow-xl hover:shadow-primary-500/10 transition-all duration-300">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ t('home.features.unifiedGateway') REDACTEDREDACTED</h3>
          ...
          <div class="group p-6 rounded-2xl bg-white/60 dark:bg-dark-800/60 backdrop-blur-sm border border-gray-200/50 dark:border-dark-700/50 hover:shadow-xl hover:shadow-primary-500/10 transition-all duration-300">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ t('home.features.multiAccount') REDACTEDREDACTED</h3>
            <p class="text-gray-600 dark:text-dark-400 text-sm leading-relaxed">
          ...
          <div class="group p-6 rounded-2xl bg-white/60 dark:bg-dark-800/60 backdrop-blur-sm border border-gray-200/50 dark:border-dark-700/50 hover:shadow-xl hover:shadow-primary-500/10 transition-all duration-300">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ t('home.features.balanceQuota') REDACTEDREDACTED</h3>
            <p class="text-gray-600 dark:text-dark-400 text-sm leading-relaxed">
        ...
        <div class="text-center mb-8">
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">{{ t('home.providers.title') REDACTEDREDACTED</h2>
        ...
        <div class="flex flex-wrap items-center justify-center gap-4 mb-16">
          ...
          <div class="flex items-center gap-2 px-5 py-3 rounded-xl bg-white/60 dark:bg-dark-800/60 backdrop-blur-sm border border-primary-200 dark:border-primary-800 ring-1 ring-primary-500/20">
            ...
            <span class="px-1.5 py-0.5 text-[10px] font-medium bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 rounded">{{ t('home.providers.supported') REDACTEDREDACTED</span>
          </div>
          <!-- GPT - Supported -->
          <div class="flex items-center gap-2 px-5 py-3 rounded-xl bg-white/60 dark:bg-dark-800/60 backdrop-blur-sm border border-primary-200 dark:border-primary-800 ring-1 ring-primary-500/20">
          ...
          <div class="flex items-center gap-2 px-5 py-3 rounded-xl bg-white/40 dark:bg-dark-800/40 backdrop-blur-sm border border-gray-200/50 dark:border-dark-700/50 opacity-60">
            ...
            <span class="px-1.5 py-0.5 text-[10px] font-medium bg-gray-100 dark:bg-dark-700 text-gray-500 dark:text-dark-400 rounded">{{ t('home.providers.soon') REDACTEDREDACTED</span>
          </div>
          <!-- More - Coming Soon -->
          <div class="flex items-center gap-2 px-5 py-3 rounded-xl bg-white/40 dark:bg-dark-800/40 backdrop-blur-sm border border-gray-200/50 dark:border-dark-700/50 opacity-60">
...
.btn-close { background: #ef4444; REDACTED
.btn-minimize { background: #eab308; REDACTED
.btn-maximize { background: #22c55e; REDACTED
...
.line-1 { animation-delay: 0.3s; REDACTED
.line-2 { animation-delay: 1s; REDACTED
.line-3 { animation-delay: 1.8s; REDACTED
.line-4 { animation-delay: 2.5s; REDACTED

@keyframes line-appear {
  from { opacity: 0; transform: translateY(5px); REDACTED
  to { opacity: 1; transform: translateY(0); REDACTED
REDACTED

.code-prompt { color: #22c55e; font-weight: bold; REDACTED
.code-cmd { color: #38bdf8; REDACTED
.code-flag { color: #a78bfa; REDACTED
.code-url { color: #14b8a6; REDACTED
.code-comment { color: #64748b; font-style: italic; REDACTED
.code-success {
  color: #22c55e;
  ...
  font-weight: 600;
REDACTED
.code-response { color: #fbbf24; REDACTED
...
@keyframes blink {
  0%, 50% { opacity: 1; REDACTED
  51%, 100% { opacity: 0; REDACTED
REDACTED
