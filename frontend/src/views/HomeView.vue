          ...
          <div class="relative flex min-w-0 max-w-full items-center">
            ...
            >
              ...
              <router-link
                v-if="showModelPlazaEntry"
                to="/model-plaza"
                class="inline-flex shrink-0 items-center gap-1.5 rounded-lg p-2 text-sm text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:text-dark-400 dark:hover:bg-dark-800 dark:hover:text-white"
                :title="t('nav.modelPlaza')"
              >
                <Icon name="grid" size="md" />
                <span class="hidden sm:inline">{{ t('nav.modelPlaza') }}</span>
