...
import type { Account, AccountPlatform, AccountType, Proxy, AdminGroup, WindowStats REDACTED from '@/types'
...
REDACTED = useTableLoader<Account, any>({
  ...
  initialParams: { platform: '', type: '', status: '', group: '', search: '', lite: '1' REDACTED
REDACTED)
