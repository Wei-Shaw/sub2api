<template>
  <AppLayout>
    ...
    <SyncFromCrsModal :show="showSync" :proxies="proxies" @close="showSync = false" @synced="reload" />
    <ImportDataModal :show="showImportData" :proxies="proxies" @close="showImportData = false" @imported="handleDataImported" />
