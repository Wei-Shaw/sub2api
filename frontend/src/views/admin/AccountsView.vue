        ...
        <DataTable :columns="columns" :data="accounts" :loading="loading">
          ...
          <template #cell-platform="{ value REDACTED">
            <div class="flex items-center gap-2">
              ...
              />
              <span class="text-sm text-gray-700 dark:text-gray-300 capitalize">{{ value === 'anthropic' ? 'Anthropic' : value === 'openai' ? 'OpenAI' : value REDACTEDREDACTED</span>
            </div>
          </template>
          ...
          <template #cell-type="{ value REDACTED">
            ...
            >
              {{ value === 'oauth' ? 'Oauth' : value === 'setup-token' ? t('admin.accounts.setupToken') : t('admin.accounts.apiKey') REDACTEDREDACTED
            </span>
          </template>
...
import { CreateAccountModal, EditAccountModal, ReAuthAccountModal, AccountStatsModal REDACTED from '@/components/account'
...
const columns = computed<Column[]>(() => [
  ...
  { key: 'platform', label: t('admin.accounts.columns.platform'), sortable: true REDACTED,
  { key: 'type', label: t('admin.accounts.columns.type'), sortable: true REDACTED,
