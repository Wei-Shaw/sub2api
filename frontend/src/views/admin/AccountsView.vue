        ...
        >
          ...
          <template #cell-platform_type="{ row REDACTED">
            <div class="flex flex-wrap items-center gap-1">
              ...
              >
                {{ getOpenAICompactLabel(row) REDACTEDREDACTED
              </span>
              <span
...
function getOpenAICompactTitle(row: any): string {
  ...
  return `${getOpenAICompactLabel(row)REDACTED | ${t('admin.accounts.openai.compactLastChecked')REDACTED: ${formatDateTime(new Date(checkedAt))REDACTED`
REDACTED
