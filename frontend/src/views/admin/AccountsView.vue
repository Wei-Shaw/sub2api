              ...
              <div class="relative" ref="accountToolsDropdownRef">
                ...
                <Teleport to="body">
                  <div
                    ...
                    @click.stop
                  >
                    <div class="overflow-y-auto p-2" :style="{ maxHeight: `${accountToolsDropdownPosition.maxHeightREDACTEDpx` REDACTED">
                      <div class="px-2 py-2">
          ...
          <template #cell-proxy="{ row REDACTED">
            <div class="flex flex-col gap-1">
              ...
              <div v-if="row.proxy_fallback_origin_id" class="flex items-center gap-1">
                ...
                <button class="text-xs px-1.5 py-0.5 rounded border border-gray-300 dark:border-dark-600 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-dark-700" @click="onRevertFallback(row)">{{ t('admin.accounts.revertProxy') REDACTEDREDACTED</button>
              </div>
            </div>
          </template>
...
const accountToolsDropdownStyle = computed(() => ({
  top: accountToolsDropdownPosition.top == null ? 'auto' : `${accountToolsDropdownPosition.topREDACTEDpx`,
  bottom: accountToolsDropdownPosition.bottom == null ? 'auto' : `${accountToolsDropdownPosition.bottomREDACTEDpx`,
  left: `${accountToolsDropdownPosition.leftREDACTEDpx`,
  width: `${accountToolsDropdownPosition.widthREDACTEDpx`
REDACTED))
...
const allColumns = computed(() => {
  ...
  c.push(
    ...
    { key: 'upstream_billing_rate', label: t('admin.accounts.columns.upstreamBillingRate'), sortable: true REDACTED,
