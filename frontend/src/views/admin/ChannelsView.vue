      ...
      <div class="channel-dialog-body">
        ...
        <div class="flex items-center border-b border-gray-200 dark:border-dark-700 flex-shrink-0 -mx-4 sm:-mx-6 px-4 sm:px-6 -mt-3 sm:-mt-4">
          ...
          >
            ...
            <span :class="getPlatformTextColor(section.platform)">{{ t('admin.groups.platforms.' + section.platform, section.platform) REDACTEDREDACTED</span>
          </button>
        </div>
            ...
            <div class="space-y-3">
              ...
              <div class="flex flex-wrap gap-2">
                ...
                >
                  ...
                  <span :class="getPlatformTextColor(p)">{{ t('admin.groups.platforms.' + p, p) REDACTEDREDACTED</span>
                </label>
              </div>
            </div>
              ...
              <div class="max-h-40 overflow-auto rounded-lg border border-gray-200 bg-gray-50 p-2 dark:border-dark-600 dark:bg-dark-900">
                ...
                <div v-else class="flex flex-wrap gap-1">
                  ...
                  >
                    ...
                    />
                    <span :class="['font-medium', getPlatformTextColor(group.platform)]">{{ group.name REDACTEDREDACTED</span>
                    <span
              ...
              >
                ...
                <div>
                  ...
                  <div class="mt-1 flex flex-wrap gap-1">
                    ...
                    >
                      ...
                      <span>{{ getGroupNameById(gid) REDACTEDREDACTED</span>
                    </label>
                  </div>
                ...
                <div>
                  ...
                  <div class="mt-1 flex flex-wrap gap-1">
                    ...
                    >
                      <span>{{ getRuleAccountLabel(accountId) REDACTEDREDACTED</span>
