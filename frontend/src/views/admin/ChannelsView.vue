  ...
  <AppLayout>
    ...
    >
      <form id="channel-form" @submit.prevent="handleSubmit" class="space-y-5">
            ...
            <template v-else>
              ...
              >
                ...
                <label
                  ...
                  :class="{ 'opacity-50': isGroupInOtherChannel(group.id) REDACTED"
                >
                  <input
                    type="checkbox"
                  ...
                  />
                  <span class="text-sm text-gray-700 dark:text-gray-300">{{ group.name REDACTEDREDACTED</span>
                  <span
                    :class="['ml-auto rounded-full px-1.5 py-0.5 text-[10px] font-medium', getRateBadgeClass(group.platform)]"
                  >
                    {{ group.rate_multiplier REDACTEDREDACTEDx
                  </span>
                  <span class="text-xs text-gray-400">
                    {{ group.account_count || 0 REDACTEDREDACTED
                  </span>
                  <span
                    v-if="isGroupInOtherChannel(group.id)"
                    class="text-xs text-gray-400"
                  >
                    {{ getGroupInOtherChannelLabel(group.id) REDACTEDREDACTED
                  </span>
                </label>
              </div>
            </template>
        ...
        <div>
          <label class="input-label">{{ t('admin.channels.form.billingModelSource', 'Billing Model') REDACTEDREDACTED</label>
