  ...
  <AppLayout>
    ...
    >
      <form id="channel-form" @submit.prevent="handleSubmit" class="space-y-5">
        <!-- Name -->
        <div>
          <label class="input-label">{{ t('admin.channels.form.name', 'Name') REDACTEDREDACTED</label>
          <input
            v-model="form.name"
            type="text"
            required
        ...
        <!-- Group Association -->
        <div>
          <label class="input-label">{{ t('admin.channels.form.groups', 'Associated Groups') REDACTEDREDACTED</label>
        ...
        <div>
          <div class="mb-2 flex items-center justify-between">
            <label class="input-label mb-0">{{ t('admin.channels.form.modelPricing', 'Model Pricing') REDACTEDREDACTED</label>
