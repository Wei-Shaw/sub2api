      ...
      <template v-else-if="stats">
        ...
        <div class="card p-4">
          ...
          <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
            ...
            <button
              type="button"
              class="group flex items-center gap-3 rounded-lg bg-gray-50 p-3 text-left transition-colors hover:bg-gray-50 dark:bg-dark-800/50 dark:hover:bg-gray-900/20"
              @click="router.push('/admin/groups')"
            >
              <span class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-gray-100 text-gray-600 dark:bg-gray-900/30 dark:text-gray-400">
              ...
              <Icon name="chevronRight" size="sm" class="text-gray-400 group-hover:text-gray-500" />
            </button>
          </div>
        </div>
