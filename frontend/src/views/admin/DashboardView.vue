        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('admin.dashboard.apiKeys') REDACTEDREDACTED
                </p>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('admin.dashboard.accounts') REDACTEDREDACTED
                </p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">
                  {{ stats.total_accounts REDACTEDREDACTED
                </p>
                <p class="text-xs">
                  <span class="text-green-600 dark:text-green-400"
                    >{{ stats.normal_accounts REDACTEDREDACTED {{ t('common.active') REDACTEDREDACTED</span
                  >
                  <span v-if="stats.error_accounts > 0" class="ml-1 text-red-500"
                    >{{ stats.error_accounts REDACTEDREDACTED {{ t('common.error') REDACTEDREDACTED</span
                  >
                </p>
              </div>
            </div>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('admin.dashboard.todayRequests') REDACTEDREDACTED
                </p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('admin.dashboard.users') REDACTEDREDACTED
                </p>
                <p class="text-xl font-bold text-emerald-600 dark:text-emerald-400">
                  +{{ stats.today_new_users REDACTEDREDACTED
                </p>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('common.total') REDACTEDREDACTED: {{ formatNumber(stats.total_users) REDACTEDREDACTED
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('admin.dashboard.todayTokens') REDACTEDREDACTED
                </p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">
                ...
                <p class="text-xs">
                  ...
                  <span
                    ...
                    >${{ formatCost(stats.today_account_cost) REDACTEDREDACTED</span
                  >
                  <span class="text-gray-400 dark:text-gray-500"> / </span>
                  <span
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('admin.dashboard.totalTokens') REDACTEDREDACTED
                </p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">
                ...
                <p class="text-xs">
                  ...
                  <span
                    class="text-orange-500 dark:text-orange-400"
                    :title="t('admin.dashboard.accountCost')"
                    >${{ formatCost(stats.total_account_cost) REDACTEDREDACTED</span
                  >
                  <span class="text-gray-400 dark:text-gray-500"> / </span>
                  <span
                    class="text-gray-400 dark:text-gray-500"
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div class="flex-1">
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('admin.dashboard.performance') REDACTEDREDACTED
                </p>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('admin.dashboard.avgResponse') REDACTEDREDACTED
                </p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">
                  {{ formatDuration(stats.average_duration_ms) REDACTEDREDACTED
                </p>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ stats.active_users REDACTEDREDACTED {{ t('admin.dashboard.activeUsers') REDACTEDREDACTED
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="card p-4">
          <div class="mb-3 flex items-center justify-between">
            <h2 class="text-sm font-semibold text-gray-900 dark:text-white">
              {{ t('admin.dashboard.quickActions') REDACTEDREDACTED
            </h2>
          </div>
          <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
            ...
            >
              ...
              <span class="min-w-0 flex-1">
                <span class="block text-sm font-medium text-gray-900 dark:text-white">
                  {{ t('admin.dashboard.batchImage') REDACTEDREDACTED
                </span>
                <span class="block text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.dashboard.batchImageDesc') REDACTEDREDACTED
                </span>
              </span>
            ...
            >
              ...
              <span class="min-w-0 flex-1">
                <span class="block text-sm font-medium text-gray-900 dark:text-white">
                  {{ t('admin.dashboard.groupPricing') REDACTEDREDACTED
                </span>
                <span class="block text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.dashboard.groupPricingDesc') REDACTEDREDACTED
                </span>
              </span>
        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-wrap items-center gap-4">
              <div class="flex items-center gap-2">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t('admin.dashboard.timeRange') REDACTEDREDACTED:</span
                >
                <DateRangePicker
          ...
          <div class="card p-4">
            <h3 class="mb-4 text-sm font-semibold text-gray-900 dark:text-white">
              {{ t('admin.dashboard.recentUsage') REDACTEDREDACTED (Top 12)
            </h3>
            <div class="h-64">
...
const userTrendChartData = computed(() => {
  ...
  const getDisplayName = (point: UserUsageTrendPoint): string => {
    ...
    return t('admin.redeem.userPrefix', { id: point.user_id REDACTED)
  REDACTED

  // Group by user_id to avoid merging different users with the same display name
  const userGroups = new Map<number, { name: string; data: Map<string, number> REDACTED>()
  ...
  userTrend.value.forEach((point) => {
    ...
    if (!userGroups.has(key)) {
      userGroups.set(key, { name: getDisplayName(point), data: new Map() REDACTED)
    REDACTED
