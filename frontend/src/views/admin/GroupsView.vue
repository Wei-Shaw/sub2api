      ...
      >
        ...
        <div class="border-t pt-4">
          ...
          >
            ...
            >
              <span class="text-gray-500 dark:text-gray-400">
                已选 {{ createModelsListSelectedCount REDACTEDREDACTED /
                {{ createModelsListState.items.length REDACTEDREDACTED
              </span>
      ...
      >
        ...
        <div class="border-t pt-4">
          ...
          >
            ...
            >
              <span class="text-gray-500 dark:text-gray-400">
                已选 {{ editModelsListSelectedCount REDACTEDREDACTED /
                {{ editModelsListState.items.length REDACTEDREDACTED
              </span>
              <div class="flex items-center gap-1.5">
                <button
                  type="button"
