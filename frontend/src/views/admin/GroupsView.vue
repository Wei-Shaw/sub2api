<template>
  <AppLayout>
        ...
        >
          ...
          >
            ...
            >
              ...
              {{ t("admin.groups.sortOrder") REDACTEDREDACTED
            </button>
            <button
            ...
            >
              ...
              {{ t("admin.groups.createGroup") REDACTEDREDACTED
            </button>
          </div>
        </div>
      </template>
        ...
        >
          ...
          <template #cell-id="{ value REDACTED">
            <span class="font-mono text-xs text-gray-500 dark:text-gray-400"
              >#{{ value REDACTEDREDACTED</span
            >
          </template>

          <template #cell-platform="{ value REDACTED">
            <span
              :class="[
            ...
            >
              ...
              {{ t("admin.groups.platforms." + value) REDACTEDREDACTED
            </span>
          </template>
            ...
            <div class="space-y-1">
              ...
              >
                ...
                >
                  <span v-if="row.daily_limit_usd" class="whitespace-nowrap">
                    ...
                    <span class="text-gray-400 dark:text-gray-500">
                      / {{ formatUsd(row.daily_limit_usd) REDACTEDREDACTED/{{
                  ...
                  <span v-if="row.weekly_limit_usd" class="whitespace-nowrap"
                    >{{ formatUsd(row.weekly_limit_usd) REDACTEDREDACTED/{{
                  ...
                  <span v-if="row.monthly_limit_usd" class="whitespace-nowrap"
                    >{{ formatUsd(row.monthly_limit_usd) REDACTEDREDACTED/{{
                ...
                <div class="text-gray-400 dark:text-gray-500">
                  {{ t("admin.groups.usageTotal") REDACTEDREDACTED
          ...
          <template #cell-rate_multiplier="{ value REDACTED">
            <span class="text-sm text-gray-700 dark:text-gray-300"
              >{{ value REDACTEDREDACTEDx</span
            >
          </template>

          <template #cell-is_exclusive="{ value REDACTED">
            ...
            <div class="space-y-0.5 text-xs">
              <div>
                ...
                <span
                  ...
                  >{{ row.active_account_count || 0 REDACTEDREDACTED</span
                >
                <span
                  ...
                  >{{ t("admin.groups.accountsUnit") REDACTEDREDACTED</span
                >
              </div>
              <div v-if="row.rate_limited_account_count">
                ...
                <span
                  ...
                  >{{ row.rate_limited_account_count REDACTEDREDACTED</span
                >
                <span
                  class="ml-1 inline-flex items-center rounded bg-gray-100 px-1.5 py-0.5 font-medium text-gray-800 dark:bg-dark-600 dark:text-gray-300"
                  >{{ t("admin.groups.accountsUnit") REDACTEDREDACTED</span
              ...
              <div>
                ...
                <span
                  ...
                  >{{ row.account_count || 0 REDACTEDREDACTED</span
                >
                <span
                  class="ml-1 inline-flex items-center rounded bg-gray-100 px-1.5 py-0.5 font-medium text-gray-800 dark:bg-dark-600 dark:text-gray-300"
                  >{{ t("admin.groups.accountsUnit") REDACTEDREDACTED</span
    ...
    >
      ...
      >
        <div>
          <label class="input-label">{{ t("admin.groups.form.name") REDACTEDREDACTED</label>
          <input
        ...
        <div>
          ...
          />
          <p class="input-hint">{{ t("admin.groups.platformHint") REDACTEDREDACTED</p>
        </div>
        <!-- 从分组复制账号 -->
        <div v-if="copyAccountsGroupOptions.length > 0">
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t("admin.groups.copyAccounts.title") REDACTEDREDACTED
            </label>
              ...
              >
                ...
                >
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t("admin.groups.copyAccounts.tooltip") REDACTEDREDACTED
                  </p>
                  <div
          ...
          >
            <option value="">
              {{ t("admin.groups.copyAccounts.selectPlaceholder") REDACTEDREDACTED
            </option>
            <option
          ...
          <p class="input-hint">{{ t("admin.groups.copyAccounts.hint") REDACTEDREDACTED</p>
        </div>
        <div>
          <label class="input-label">{{
          ...
          />
          <p class="input-hint">{{ t("admin.groups.rateMultiplierHint") REDACTEDREDACTED</p>
        </div>
        <div>
          <label class="input-label">{{ t("admin.groups.form.rpmLimit") REDACTEDREDACTED</label>
          <input
          ...
          />
          <p class="input-hint">{{ t("admin.groups.form.rpmLimitHint") REDACTEDREDACTED</p>
        </div>
        ...
        >
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t("admin.groups.form.exclusive") REDACTEDREDACTED
            </label>
            <!-- Help Tooltip -->
            <div class="group relative inline-flex">
              <Icon
              ...
              >
                ...
                >
                  <p class="mb-2 text-xs font-medium">
                    {{ t("admin.groups.exclusiveTooltip.title") REDACTEDREDACTED
                  </p>
                  <p class="mb-2 text-xs leading-relaxed text-gray-300">
                    {{ t("admin.groups.exclusiveTooltip.description") REDACTEDREDACTED
                  </p>
                  <div class="rounded bg-gray-800 p-2 dark:bg-gray-700">
                    <p class="text-xs leading-relaxed text-gray-300">
                      <span
                        ...
                        {{ t("admin.groups.exclusiveTooltip.example") REDACTEDREDACTED</span
                      >
                      {{ t("admin.groups.exclusiveTooltip.exampleContent") REDACTEDREDACTED
                    </p>
                  </div>
                  <!-- Arrow -->
                  <div
        ...
        <div class="mt-4 border-t pt-4">
          <div>
            ...
            />
            <p class="input-hint">
              {{ t("admin.groups.subscription.typeHint") REDACTEDREDACTED
            </p>
          </div>
        ...
        <div class="border-t pt-4">
          <div class="mb-3 flex items-center justify-between gap-3">
            <div>
              <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                {{ t("admin.groups.modelsList.title") REDACTEDREDACTED
              </label>
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                {{ t("admin.groups.modelsList.hint") REDACTEDREDACTED
              </p>
            </div>
            <button
              type="button"
          ...
          >
            ...
            >
              ...
              <div class="flex items-center gap-1.5">
                ...
                >
                  {{ t("admin.groups.modelsList.selectAll") REDACTEDREDACTED
                </button>
                <button
                  type="button"
                ...
                >
                  {{ t("admin.groups.modelsList.invertSelection") REDACTEDREDACTED
                </button>
              </div>
            </div>
            <div
            ...
            >
              <p v-if="createModelsListLoading" class="text-xs text-gray-500 dark:text-gray-400">
                {{ t("admin.groups.modelsList.loading") REDACTEDREDACTED
              </p>
              <p
                v-else-if="createModelsListState.items.length === 0"
                class="text-xs text-gray-500 dark:text-gray-400"
              >
                {{ t("admin.groups.modelsList.empty") REDACTEDREDACTED
              </p>
              <div
        ...
        >
          ...
          <div class="mt-2 rounded-lg bg-gray-50 p-3 text-xs text-gray-700 dark:bg-gray-800 dark:text-gray-300">
            ...
            <div class="grid grid-cols-3 gap-2">
              <div
                ...
                :key="item.label"
              >
                {{ item.label REDACTEDREDACTED: {{ item.value REDACTEDREDACTED
              </div>
            </div>
          </div>
          <div v-if="createForm.platform === 'gemini' && createForm.allow_image_generation" class="mt-4 border-t border-dashed border-gray-200 pt-4 dark:border-dark-700">
            ...
            >
              <input
                ...
                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              {{ t("admin.groups.imagePricing.allowBatchImageGeneration") REDACTEDREDACTED
            </label>
            <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
              {{ t("admin.groups.imagePricing.batchSectionHint") REDACTEDREDACTED
            </p>
            <div
          ...
          >
            {{ t("admin.groups.imagePricing.batchGeminiOnlyHint") REDACTEDREDACTED
          </p>
        </div>
        ...
        >
          <label
            class="block mb-2 font-medium text-gray-700 dark:text-gray-300"
          >
            {{ t(videoPricingI18nKey("title")) REDACTEDREDACTED
          </label>
          <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">
            {{ t(videoPricingI18nKey("description")) REDACTEDREDACTED
          </p>
          <div class="mb-4">
            <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
              <input
                ...
                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              {{ t(videoPricingI18nKey("independentMultiplier")) REDACTEDREDACTED
            </label>
          </div>
          <div
          ...
          >
            <p class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t("admin.groups.videoPricing.modelOverridesTitle") REDACTEDREDACTED
            </p>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t("admin.groups.videoPricing.modelOverridesDescription") REDACTEDREDACTED
            </p>
              ...
              >
                ...
                >
                  <span class="mb-1 block text-xs text-gray-500 dark:text-gray-400">
                    {{ resolution.label REDACTEDREDACTED ($/s)
                  </span>
                  <input
                    ...
                    min="0"
                    class="input"
                    :data-testid="`create-grok-video-price-${family.keyREDACTED-${resolution.keyREDACTED`"
                  />
                </label>
              </div>
            </div>
          ...
          <p class="mt-3 text-xs text-gray-500 dark:text-gray-400">
            {{ t(videoPricingI18nKey("modeHint")) REDACTEDREDACTED
          </p>
          <div class="mt-2 rounded-lg bg-gray-50 p-3 text-xs text-gray-700 dark:bg-gray-800 dark:text-gray-300">
            <div class="mb-1 font-medium">
              {{ t(videoPricingI18nKey("finalPricePreview")) REDACTEDREDACTED
            </div>
            <div class="grid grid-cols-3 gap-2">
              <div
        ...
        <div v-if="createForm.subscription_type === 'subscription'" class="border-t pt-4">
          <div class="mb-4 grid grid-cols-1 gap-3 md:grid-cols-2">
            <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
              <input
                ...
                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              <span>{{ t("admin.groups.peakRate.enable") REDACTEDREDACTED</span>
            </label>
          </div>
          <div
          ...
          >
            <div>
              <label class="input-label">{{ t("admin.groups.peakRate.peakStart") REDACTEDREDACTED</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t("admin.groups.peakRate.peakEnd") REDACTEDREDACTED</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t("admin.groups.peakRate.peakMultiplier") REDACTEDREDACTED</label>
              <input
        ...
        <div v-if="isProfitControlPlatform(createForm.platform)" class="border-t pt-4">
          <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
            <input
              ...
              class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
            />
            <span>{{ t("admin.groups.profitControl.enable") REDACTEDREDACTED</span>
          </label>
          ...
          >
            <div>
              <label class="input-label">{{ t("admin.groups.profitControl.minMargin") REDACTEDREDACTED</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t("admin.groups.profitControl.safetyBuffer") REDACTEDREDACTED</label>
              <input
        ...
        <div v-if="createForm.platform === 'antigravity'" class="border-t pt-4">
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t("admin.groups.supportedScopes.title") REDACTEDREDACTED
            </label>
            <!-- Help Tooltip -->
            <div class="group relative inline-flex">
              <Icon
              ...
              >
                ...
                >
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t("admin.groups.supportedScopes.tooltip") REDACTEDREDACTED
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"
                  ></div>
          ...
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            {{ t("admin.groups.supportedScopes.hint") REDACTEDREDACTED
          </p>
        </div>
        ...
        <div v-if="createForm.platform === 'antigravity'" class="border-t pt-4">
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t("admin.groups.mcpXml.title") REDACTEDREDACTED
            </label>
            <div class="group relative inline-flex">
              <Icon
                name="questionCircle"
              ...
              >
                ...
                >
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t("admin.groups.mcpXml.tooltip") REDACTEDREDACTED
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"
                  ></div>
        ...
        <div v-if="createForm.platform === 'anthropic'" class="border-t pt-4">
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t("admin.groups.claudeCode.title") REDACTEDREDACTED
            </label>
            <!-- Help Tooltip -->
            <div class="group relative inline-flex">
              <Icon
              ...
              >
                ...
                >
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t("admin.groups.claudeCode.tooltip") REDACTEDREDACTED
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"
                  ></div>
          ...
          <div v-if="createForm.claude_code_only" class="mt-3">
            ...
            />
            <p class="input-hint">
              {{ t("admin.groups.claudeCode.fallbackHint") REDACTEDREDACTED
            </p>
          </div>
        </div>
        ...
        >
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
            {{ t("admin.groups.webSearchPricing.title") REDACTEDREDACTED
          </h4>
          <div>
            <label class="input-label">{{
            ...
            />
            <p class="input-hint">
              {{ t("admin.groups.webSearchPricing.pricePerCallHint") REDACTEDREDACTED
            </p>
            <div
        ...
        <div class="border-t border-gray-200 pt-4 mt-4 dark:border-dark-400">
          <div class="flex items-start justify-between gap-4">
            <div>
              <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ t("admin.groups.modelPricing.title") REDACTEDREDACTED</h4>
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ t("admin.groups.modelPricing.description") REDACTEDREDACTED</p>
            </div>
            <button type="button" class="btn btn-secondary" @click="addGroupPricing(createForm.model_pricing)">
              <Icon name="plus" size="sm" class="mr-1" />{{ t("admin.groups.modelPricing.add") REDACTEDREDACTED
            </button>
          </div>
          <label class="mt-3 flex items-start gap-2">
            <input v-model="createForm.long_context_pricing_enabled" type="checkbox" class="mt-0.5" />
            <span><span class="block text-sm text-gray-700 dark:text-gray-300">{{ t("admin.groups.modelPricing.longContext") REDACTEDREDACTED</span><span class="block text-xs text-gray-500">{{ t("admin.groups.modelPricing.longContextHint") REDACTEDREDACTED</span></span>
          </label>
          <div class="mt-3 space-y-2">
            <PricingEntryCard v-for="(entry, index) in createForm.model_pricing" :key="index" :entry="entry" :platform="createForm.platform" @update="createForm.model_pricing[index] = $event" @remove="createForm.model_pricing.splice(index, 1)" />
          </div>
        </div>
        ...
        >
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            {{ t("admin.groups.explicitPricing.title") REDACTEDREDACTED
          </h4>
          <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">
            {{ t("admin.groups.explicitPricing.description") REDACTEDREDACTED
          </p>
          <div class="grid grid-cols-1 gap-3 md:grid-cols-3">
            <div>
              <label class="input-label">{{ t("admin.groups.explicitPricing.searchPricePer1k") REDACTEDREDACTED</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t("admin.groups.voicePricing.audioRealtimePerMin") REDACTEDREDACTED</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t("admin.groups.voicePricing.audioTtsPerMillionChars") REDACTEDREDACTED</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t("admin.groups.voicePricing.audioSttPerHour") REDACTEDREDACTED</label>
              <input
        ...
        >
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
            {{ t("admin.groups.openaiLive.title") REDACTEDREDACTED
          </h4>
          ...
          <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
            {{ t("admin.groups.openaiLive.hint") REDACTEDREDACTED
          </p>
        </div>
        ...
        >
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
            {{ t("admin.groups.openaiMessages.title") REDACTEDREDACTED
          </h4>
          ...
          <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
            {{ t("admin.groups.openaiMessages.allowDispatchHint") REDACTEDREDACTED
          </p>
          ...
          <div v-if="createForm.allow_messages_dispatch" class="mt-3">
            ...
            >
              ...
              >
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.groups.openaiMessages.familyMappingHint") REDACTEDREDACTED
                </p>
              </div>
              <div class="p-4">
              ...
              >
                <div class="flex items-start justify-between gap-3">
                  <div>
                    ...
                    >
                      {{ t("admin.groups.openaiMessages.exactMappingHint") REDACTEDREDACTED
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="p-4 bg-gray-50/30 dark:bg-dark-800/30">
                ...
                >
                  ...
                  >
                    ...
                    {{ t("admin.groups.openaiMessages.addExactMapping") REDACTEDREDACTED
                  </button>
                </div>
        ...
        >
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
            {{ t("admin.groups.accountFilters.title") REDACTEDREDACTED
          </h4>
          ...
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm text-gray-600 dark:text-gray-400"
                >{{ t("admin.groups.accountFilters.oauthOnly") REDACTEDREDACTED</label
              >
          ...
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm text-gray-600 dark:text-gray-400"
                >{{ t("admin.groups.accountFilters.privacySetOnly") REDACTEDREDACTED</label
              >
              <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                {{
        ...
        >
          ...
          />
          <p class="input-hint">
            {{ t("admin.groups.invalidRequestFallback.hint") REDACTEDREDACTED
          </p>
        </div>
        ...
        <div v-if="createForm.platform === 'anthropic'" class="border-t pt-4">
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t("admin.groups.modelRouting.title") REDACTEDREDACTED
            </label>
            <!-- Help Tooltip -->
            <div class="group relative inline-flex">
              <Icon
              ...
              >
                ...
                >
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t("admin.groups.modelRouting.tooltip") REDACTEDREDACTED
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"
                  ></div>
          ...
          >
            {{ t("admin.groups.modelRouting.disabledHint") REDACTEDREDACTED
          </p>
          <p v-else class="text-xs text-gray-500 dark:text-gray-400 mb-3">
            {{ t("admin.groups.modelRouting.noRulesHint") REDACTEDREDACTED
          </p>
          <!-- 路由规则列表（仅在启用时显示） -->
                      ...
                      >
                        ...
                        >
                          ...
                          <span class="ml-2 text-xs text-gray-400"
                            >#{{ account.id REDACTEDREDACTED</span
                          >
                        </button>
                      </div>
                    </div>
                    <p class="text-xs text-gray-400 mt-1">
                      {{ t("admin.groups.modelRouting.accountsHint") REDACTEDREDACTED
                    </p>
                  </div>
                </div>
                <button
          ...
          >
            <Icon name="plus" size="sm" />
            {{ t("admin.groups.modelRouting.addRule") REDACTEDREDACTED
          </button>
        </div>
      </form>
      ...
      <template #footer>
        <div class="flex justify-end gap-3 pt-4">
          ...
          >
            ...
            {{ submitting ? t("admin.groups.creating") : t("common.create") REDACTEDREDACTED
          </button>
        </div>
      </template>
    </BaseDialog>
      ...
      >
        ...
        <div>
          ...
          <Select
            ...
            data-tour="group-form-platform"
          />
          <p class="input-hint">{{ t("admin.groups.platformNotEditable") REDACTEDREDACTED</p>
        </div>
        <!-- 从分组复制账号（编辑时） -->
        <div v-if="copyAccountsGroupOptionsForEdit.length > 0">
          <div class="mb-1.5 flex items-center gap-1">
            ...
            <div class="group relative inline-flex">
              ...
              >
                ...
                >
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t("admin.groups.copyAccounts.tooltipEdit") REDACTEDREDACTED
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"
                  ></div>
          ...
          <p class="input-hint">
            {{ t("admin.groups.copyAccounts.hintEdit") REDACTEDREDACTED
          </p>
        </div>
        <div>
          <label class="input-label">{{
        ...
        <div>
          <label class="input-label">{{ t("admin.groups.form.status") REDACTEDREDACTED</label>
        ...
        <div class="mt-4 border-t pt-4">
          <div>
            ...
            />
            <p class="input-hint">
              {{ t("admin.groups.subscription.typeNotEditable") REDACTEDREDACTED
            </p>
          </div>
              ...
              >
                ...
                >
                  ...
                  <input
                    ...
                    min="0"
                    class="input"
                    :data-testid="`edit-grok-video-price-${family.keyREDACTED-${resolution.keyREDACTED`"
                  />
                </label>
              </div>
            </div>
        ...
        <div class="border-t border-gray-200 pt-4 mt-4 dark:border-dark-400">
          ...
          <div class="mt-3 space-y-2">
            <PricingEntryCard v-for="(entry, index) in editForm.model_pricing" :key="index" :entry="entry" :platform="editForm.platform" @update="editForm.model_pricing[index] = $event" @remove="editForm.model_pricing.splice(index, 1)" />
          </div>
        </div>
      ...
      <template #footer>
        <div class="flex justify-end gap-3 pt-4">
          ...
          >
            ...
            {{ submitting ? t("admin.groups.updating") : t("common.update") REDACTEDREDACTED
          </button>
        </div>
      </template>
    </BaseDialog>
    ...
    >
      <div class="space-y-4">
        <p class="text-sm text-gray-500 dark:text-gray-400">
          {{ t("admin.groups.sortOrderHint") REDACTEDREDACTED
        </p>
        <VueDraggable
          ...
          >
            ...
            <div class="flex-1">
              ...
              <div class="text-xs text-gray-500 dark:text-gray-400">
                ...
                >
                  {{ t("admin.groups.platforms." + group.platform) REDACTEDREDACTED
                </span>
              </div>
            </div>
            <div class="text-sm text-gray-400">#{{ group.id REDACTEDREDACTED</div>
          </div>
        </VueDraggable>
      </div>
      ...
      <template #footer>
        <div class="flex justify-end gap-3 pt-4">
          ...
          >
            ...
            {{ sortSubmitting ? t("common.saving") : t("common.save") REDACTEDREDACTED
          </button>
        </div>
      </template>
    </BaseDialog>
        ...
        <section class="min-w-0">
          <div class="mb-3 flex items-center justify-between gap-3">
            <h3 class="text-sm font-semibold text-gray-900 dark:text-white">
              {{ t("admin.groups.compositeRoutes.routes") REDACTEDREDACTED
            </h3>
            <button
              type="button"
          ...
          >
            ...
            <div
              ...
              class="flex h-36 items-center justify-center text-sm text-gray-500 dark:text-gray-400"
            >
              {{ t("admin.groups.compositeRoutes.empty") REDACTEDREDACTED
            </div>
            <div v-else class="overflow-x-auto">
              <table class="min-w-full divide-y divide-gray-200 text-sm dark:divide-dark-600">
                <thead class="bg-gray-50 text-left text-xs font-medium uppercase tracking-wide text-gray-500 dark:bg-dark-800 dark:text-gray-400">
                  <tr>
                    <th class="px-3 py-2">
                      {{ t("admin.groups.compositeRoutes.publicModel") REDACTEDREDACTED
                    </th>
                    <th class="px-3 py-2">
                      {{ t("admin.groups.compositeRoutes.target") REDACTEDREDACTED
                    </th>
                    <th class="px-3 py-2">
                      {{ t("admin.groups.compositeRoutes.scope") REDACTEDREDACTED
                    </th>
                    <th class="px-3 py-2 text-right">
                      {{ t("admin.groups.columns.actions") REDACTEDREDACTED
                    </th>
                  </tr>
                </thead>
                  ...
                  >
                    <td class="max-w-[15rem] px-3 py-2">
                      <div class="break-all font-medium text-gray-900 dark:text-white">
                        {{ route.public_model REDACTEDREDACTED
                      </div>
                      <div class="mt-1 flex flex-wrap items-center gap-1.5">
                        ...
                        >
                          {{ t("admin.accounts.status.inactive") REDACTEDREDACTED
                        </span>
                      </div>
                    </td>
                    <td class="px-3 py-2">
                      <div class="flex items-center gap-1.5 text-gray-900 dark:text-white">
                        ...
                        <span>{{ formatCompositePlatform(route.target_platform) REDACTEDREDACTED</span>
                      </div>
                      <div class="mt-1 break-all text-xs text-gray-500 dark:text-gray-400">
                        {{ route.upstream_model || route.public_model REDACTEDREDACTED
                      </div>
                    </td>
                    <td class="px-3 py-2">
                      <div class="text-gray-700 dark:text-gray-300">
                        {{ formatCompositeEndpoint(route.endpoint) REDACTEDREDACTED
                      </div>
                      <div class="text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.groups.compositeRoutes.priority") REDACTEDREDACTED:
                        {{ route.priority REDACTEDREDACTED
                      </div>
                    </td>
                    <td class="px-3 py-2">
        ...
        <section class="space-y-5">
          <form class="space-y-3" @submit.prevent="saveCompositeRoute">
            ...
            <div>
              ...
              />
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                {{ t("admin.groups.compositeRoutes.upstreamModelHint") REDACTEDREDACTED
              </p>
            </div>
            ...
            <div class="flex items-center justify-between gap-3">
              <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                <input
                  ...
                  class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500 dark:border-dark-600 dark:bg-dark-700"
                />
                {{ t("admin.groups.compositeRoutes.enabled") REDACTEDREDACTED
              </label>
              <button
                type="submit"
                class="btn btn-primary"
              ...
              >
                <Icon
                  ...
                  class="mr-2"
                />
                {{ compositeRouteEditingId ? t("common.update") : t("common.create") REDACTEDREDACTED
              </button>
            </div>
          </form>
          ...
          <div class="border-t border-gray-200 pt-4 dark:border-dark-600">
            <h3 class="mb-3 text-sm font-semibold text-gray-900 dark:text-white">
              {{ t("admin.groups.compositeRoutes.preview") REDACTEDREDACTED
            </h3>
            <div class="space-y-3">
              <input
              ...
              >
                ...
                >
                  <div>
                    {{ t("admin.groups.compositeRoutes.targetPlatform") REDACTEDREDACTED:
                    {{
                  ...
                  <div class="break-all">
                    {{ t("admin.groups.compositeRoutes.upstreamModel") REDACTEDREDACTED:
                    {{ compositePreviewDecision.upstream_model REDACTEDREDACTED
                  </div>
                </div>
                <div
                  v-else
                ...
                >
                  {{ compositePreviewDecision.reason REDACTEDREDACTED
                </div>
              </div>
            </div>
          </div>
...
import {
  ...
  perTokenToMTok,
  toNullableNumber,
REDACTED from "@/components/admin/channel/types";
import type { ChannelModelPricing REDACTED from "@/api/admin/channels";
...
const allColumns = computed<Column[]>(() => [
  { key: "name", label: t("admin.groups.columns.name"), sortable: true REDACTED,
  { key: "id", label: t("admin.groups.columns.id"), sortable: true REDACTED,
  {
    key: "platform",
...
const statusOptions = computed(() => [
  { value: "", label: t("admin.groups.allStatus") REDACTED,
...
const exclusiveOptions = computed(() => [
  { value: "", label: t("admin.groups.allGroups") REDACTED,
  { value: "true", label: t("admin.groups.exclusive") REDACTED,
...
const compositeRouteEndpointOptions = computed(() => [
  { value: "any", label: t("admin.groups.compositeRoutes.endpoints.any") REDACTED,
  {
    value: "messages",
  ...
  REDACTED,
  { value: "images", label: t("admin.groups.compositeRoutes.endpoints.images") REDACTED,
  { value: "gemini", label: t("admin.groups.compositeRoutes.endpoints.gemini") REDACTED,
]);

const compositeRouteMatchOptions = computed(() => [
  { value: "exact", label: t("admin.groups.compositeRoutes.match.exact") REDACTED,
  { value: "prefix", label: t("admin.groups.compositeRoutes.match.prefix") REDACTED,
]);
...
const subscriptionTypeOptions = computed(() => [
  { value: "standard", label: t("admin.groups.subscription.standard") REDACTED,
  { value: "subscription", label: t("admin.groups.subscription.subscription") REDACTED,
]);

// 降级分组选项（创建时）- 仅包含 anthropic 平台且未启用 claude_code_only 的分组
const fallbackGroupOptions = computed(() => {
  const options: { value: number | null; label: string REDACTED[] = [
    { value: null, label: t("admin.groups.claudeCode.noFallback") REDACTED,
  ];
  ...
  eligibleGroups.forEach((g) => {
    options.push({ value: g.id, label: g.name REDACTED);
  REDACTED);
  return options;
REDACTED);
...
const invalidRequestFallbackOptions = computed(() => {
  const options: { value: number | null; label: string REDACTED[] = [
    { value: null, label: t("admin.groups.invalidRequestFallback.noFallback") REDACTED,
  ];
  const eligibleGroups = groups.value.filter(
    (g) =>
      g.platform === "anthropic" &&
...
const copyAccountsGroupLabel = (g: AdminGroup) => {
  ...
  return `${g.nameREDACTED - ${platformREDACTED (${t("admin.groups.accountsCount", { count REDACTED)REDACTED)`;
REDACTED;
...
const liveCapability = ref<{ supported: boolean; reason?: string REDACTED | null>(null);
...
const getCreateRuleSearchKey = (rule: ModelRoutingRule) =>
  `create-${resolveCreateRuleKey(rule)REDACTED`;
const getEditRuleSearchKey = (rule: ModelRoutingRule) =>
  `edit-${resolveEditRuleKey(rule)REDACTED`;
...
// 账号搜索相关状态
const accountSearchKeyword = ref<Record<string, string>>({REDACTED);
const accountSearchResults = ref<Record<string, SimpleAccount[]>>({REDACTED);
const showAccountDropdown = ref<Record<string, boolean>>({REDACTED);
...
const clearAllAccountSearchState = () => {
  accountSearchKeyword.value = {REDACTED;
  accountSearchResults.value = {REDACTED;
  showAccountDropdown.value = {REDACTED;
REDACTED;

const accountSearchRunner = useKeyedDebouncedSearch<SimpleAccount[]>({
  delay: 300,
  search: async (keyword, { signal REDACTED) => {
    ...
    return res.items.map((account) => ({ id: account.id, name: account.name REDACTED));
  REDACTED,
...
const addCreateRoutingRule = () => {
  createModelRoutingRules.value.push({ pattern: "", accounts: [] REDACTED);
REDACTED;
...
const addEditRoutingRule = () => {
  editModelRoutingRules.value.push({ pattern: "", accounts: [] REDACTED);
REDACTED;
...
const loadModelsListCandidates = async (
  ...
  const request = { mode, groupID, platform REDACTED;
...
const convertRoutingRulesToApiFormat = (
  ...
  const result: Record<string, number[]> = {REDACTED;
  ...
  for (const [pattern, accountIds] of Object.entries(apiFormat)) {
    ...
    for (const id of accountIds) {
      try {
        ...
        accounts.push({ id: account.id, name: account.name REDACTED);
      REDACTED catch {
        // 如果账号不存在，仍然显示 ID
        accounts.push({ id, name: `#${idREDACTED` REDACTED);
      REDACTED
    REDACTED
    rules.push({ pattern, accounts REDACTED);
  REDACTED
  return rules;
REDACTED;
...
const imagePricingTiers = [
  { key: "image_price_1k", label: "1K" REDACTED,
  { key: "image_price_2k", label: "2K" REDACTED,
  { key: "image_price_4k", label: "4K" REDACTED,
] as const;

const videoPricingTiers = [
  { key: "video_price_480p", label: "480p" REDACTED,
  { key: "video_price_720p", label: "720p" REDACTED,
  { key: "video_price_1080p", label: "1080p" REDACTED,
] as const;
...
const formatImagePricePreview = (value: number | string | null | undefined) => {
  ...
  if (!Number.isFinite(price) || price < 0) {
    return t("admin.groups.imagePricing.notConfigured");
  REDACTED
  return `$${price.toFixed(6).replace(/0+$/, "").replace(/\.$/, "")REDACTED`;
REDACTED;
...
const deleteConfirmMessage = computed(() => {
  ...
  if (deletingGroup.value.subscription_type === "subscription") {
    ...
    REDACTED);
  REDACTED
  return t("admin.groups.deleteConfirm", { name: deletingGroup.value.name REDACTED);
REDACTED);
...
const loadLiveCapability = async () => {
  ...
  if (!liveCapabilityRequest) {
    liveCapabilityRequest = adminAPI.groups
      .getLiveCapability()
      .catch(() => ({ supported: false REDACTED))
      .finally(() => {
        liveCapabilityRequest = null;
      REDACTED);
  REDACTED
  liveCapability.value = await liveCapabilityRequest;
  return liveCapability.value ?? { supported: false REDACTED;
REDACTED;
...
const loadGroups = async () => {
  ...
  const { signal REDACTED = currentController;
  loading.value = true;
  try {
...
const validateProfitControlForm = (form: ProfitControlFormState): boolean => {
  ...
  if (errorKey) {
    appStore.showError(t(`admin.groups.profitControl.${errorKeyREDACTED`));
    return false;
  REDACTED
  return true;
REDACTED;
  ...
  try {
    ...
    const requestData = {
      ...
      ...(Object.keys(videoModelPrices).length > 0
        ? { video_model_prices: videoModelPrices REDACTED
        : {REDACTED),
...
const handleEdit = async (group: AdminGroup) => {
  ...
  editForm.long_context_pricing_enabled =
    group.long_context_pricing_enabled ?? false;
...
const addCreateMessagesDispatchMapping = () => {
  createForm.exact_model_mappings.push({ claude_model: "", target_model: "" REDACTED);
REDACTED;
...
const addEditMessagesDispatchMapping = () => {
  editForm.exact_model_mappings.push({ claude_model: "", target_model: "" REDACTED);
REDACTED;
...
const handleDuplicate = async (group: AdminGroup) => {
  ...
  try {
    ...
    appStore.showSuccess(
      t("admin.groups.duplicateSuccess", { name: duplicate.name REDACTED),
    );
    await loadGroups();
...
const formatCompositePlatform = (platform: string) => {
  if (!platform) return "—";
  return t(`admin.groups.platforms.${platformREDACTED`);
REDACTED;
