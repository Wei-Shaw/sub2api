          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              ...
              >
                <div>
                  <label class="font-medium text-gray-900 dark:text-white">{{
                    t("admin.settings.site.availableModelsEnabled")
                  }}</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.site.availableModelsEnabledHint") }}
                  </p>
                </div>
                <Toggle v-model="form.available_models_enabled" data-testid="available-models-toggle" />
              </div>
            </div>
          </div>
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      available_models_enabled: form.available_models_enabled,
