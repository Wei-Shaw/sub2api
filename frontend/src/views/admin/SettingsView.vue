    ...
    <div class="mx-auto max-w-4xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
            ...
            <template v-else>
              ...
              >
                <div>
                  ...
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t('admin.settings.overloadCooldown.cooldownMinutesHint') REDACTEDREDACTED
                  </p>
                </div>
              </div>
              ...
              <div class="flex justify-end border-t border-gray-100 pt-4 dark:border-dark-700">
                ...
                >
                  ...
                  {{ overloadCooldownSaving ? t('common.saving') : t('common.save') REDACTEDREDACTED
                </button>
              </div>
            </template>
          </div>
            ...
            <template v-else>
                ...
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                      {{ t('admin.settings.rectifier.thinkingSignatureHint') REDACTEDREDACTED
                    </p>
                  </div>
              ...
              <div class="flex justify-end border-t border-gray-100 pt-4 dark:border-dark-700">
                ...
                >
                  ...
                  {{ rectifierSaving ? t('common.saving') : t('common.save') REDACTEDREDACTED
                </button>
              </div>
            </template>
          </div>
            ...
            <template v-else>
              ...
              >
                ...
                <div class="mt-3">
                  ...
                  <div class="flex flex-wrap items-center gap-1.5">
                    <span class="text-xs text-gray-400 dark:text-gray-500">{{ t('admin.settings.betaPolicy.commonPatterns') REDACTEDREDACTED:</span>
                    <button
              ...
              <div class="flex justify-end border-t border-gray-100 pt-4 dark:border-dark-700">
                ...
                >
                  ...
                  {{ betaPolicySaving ? t('common.saving') : t('common.save') REDACTEDREDACTED
                </button>
              </div>
            </template>
          </div>
        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            ...
            <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
              ...
              REDACTEDREDACTED</label>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t('admin.settings.registration.emailSuffixWhitelistHint') REDACTEDREDACTED
              </p>
              <div
              ...
              <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                {{ t('admin.settings.registration.emailSuffixWhitelistInputHint') REDACTEDREDACTED
              </p>
            </div>
            ...
            <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
              <div class="mb-3 flex items-center justify-between">
                <div>
                  ...
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t('admin.settings.defaults.defaultSubscriptionsHint') REDACTEDREDACTED
                  </p>
                </div>
                <button
                  type="button"
              ...
              <div v-else class="space-y-3">
                ...
                >
                  ...
                  <div>
                    <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">
                      {{ t('admin.settings.defaults.subscriptionValidityDays') REDACTEDREDACTED
                    </label>
                    <input
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ localText('认证来源默认值', 'Auth Source Defaults') REDACTEDREDACTED
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{
                localText(
          ...
          <div class="space-y-6 p-6">
            <div class="flex items-center justify-between rounded border border-gray-200 px-4 py-3 dark:border-dark-700">
              <div>
                <label class="font-medium text-gray-900 dark:text-white">
                  {{ localText('第三方注册强制补充邮箱', 'Require email on third-party signup') REDACTEDREDACTED
                </label>
                <p class="text-sm text-gray-500 dark:text-gray-400">
                  {{
                    localText(
            ...
            <div class="grid grid-cols-1 gap-4 xl:grid-cols-2">
              ...
              >
                <div class="mb-4">
                  <div class="font-medium text-gray-900 dark:text-white">{{ authSource.title REDACTEDREDACTED</div>
                  <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                ...
                <div class="mt-4 grid grid-cols-1 gap-3 md:grid-cols-2">
                  <div class="flex items-center justify-between rounded border border-gray-200 px-4 py-3 dark:border-dark-700">
                    <div>
                      <label class="font-medium text-gray-900 dark:text-white">
                        {{ localText('注册即授权', 'Grant on signup') REDACTEDREDACTED
                      </label>
                  ...
                  <div class="flex items-center justify-between rounded border border-gray-200 px-4 py-3 dark:border-dark-700">
                    <div>
                      <label class="font-medium text-gray-900 dark:text-white">
                        {{ localText('首次绑定时授权', 'Grant on first bind') REDACTEDREDACTED
                      </label>
                      <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                        {{
                          localText(
                ...
                <div class="mt-4 border-t border-gray-100 pt-4 dark:border-dark-700">
                  <div class="mb-3 flex items-center justify-between">
                    <div>
                      <label class="font-medium text-gray-900 dark:text-white">
                        {{ localText('默认订阅', 'Default subscriptions') REDACTEDREDACTED
                      </label>
                      <p class="text-sm text-gray-500 dark:text-gray-400">
                        {{
                          localText(
          ...
          <div class="p-6">
            <div class="space-y-4">
              ...
              <div class="flex items-center justify-between rounded border border-gray-200 px-4 py-3 dark:border-dark-700">
                <div>
                  <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                    {{ localText('OpenAI 实验调度策略', 'OpenAI experimental scheduler policy') REDACTEDREDACTED
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
                      localText(
        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.gatewayForwarding.fingerprintUnification') REDACTEDREDACTED
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.gatewayForwarding.fingerprintUnificationHint') REDACTEDREDACTED
                </p>
              </div>
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.gatewayForwarding.metadataPassthrough') REDACTEDREDACTED
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.gatewayForwarding.metadataPassthroughHint') REDACTEDREDACTED
                </p>
              </div>
            ...
            <div v-if="webSearchConfig.enabled" class="space-y-4">
              ...
              <div v-for="(provider, pIdx) in webSearchConfig.providers" :key="pIdx"
                ...
                >
                  <div class="flex items-center gap-3">
                    ...
                    <span class="text-xs text-gray-400">
                      {{ provider.quota_used ?? 0 REDACTEDREDACTED / {{ provider.quota_limit != null && provider.quota_limit > 0 ? provider.quota_limit : '∞' REDACTEDREDACTED
                    </span>
                    <span v-if="!expandedProviders[pIdx] && provider.api_key_configured" class="text-xs text-green-500">
                      {{ t('admin.settings.webSearchEmulation.apiKeyConfigured') REDACTEDREDACTED
                    </span>
                  </div>
                  <button type="button" class="text-red-500 hover:text-red-700 text-xs" @click.stop="removeWebSearchProvider(pIdx)">
                    {{ t('admin.settings.webSearchEmulation.removeProvider') REDACTEDREDACTED
                  </button>
                </div>
                ...
                <div v-if="expandedProviders[pIdx]" class="space-y-3 border-t border-gray-100 px-4 pb-4 pt-3 dark:border-dark-700">
                  ...
                  <div>
                    <label class="text-xs text-gray-500">{{ t('admin.settings.webSearchEmulation.apiKey') REDACTEDREDACTED</label>
                    <div class="relative">
                      <input
                      ...
                      <div v-if="provider.api_key || provider.api_key_configured" class="absolute inset-y-0 right-0 flex items-center pr-1.5">
                        ...
                        <button
                          type="button"
                          class="rounded p-1 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
                          :class="{ 'opacity-30 cursor-not-allowed': !provider.api_key REDACTED"
                  ...
                  <div class="grid grid-cols-2 gap-3">
                    <div>
                      <label class="text-xs text-gray-500">{{ t('admin.settings.webSearchEmulation.quotaLimit') REDACTEDREDACTED</label>
                      <input v-model="provider.quota_limit" type="number" min="1" class="input text-sm" :placeholder="'∞'" />
                      <p class="mt-0.5 text-xs text-gray-400">{{ t('admin.settings.webSearchEmulation.quotaLimitHint') REDACTEDREDACTED</p>
                    </div>
                    <div>
                      <label class="text-xs text-gray-500">{{ t('admin.settings.webSearchEmulation.subscribedAt') REDACTEDREDACTED</label>
                      <input
                      ...
                      />
                      <p class="mt-0.5 text-xs text-gray-400">{{ t('admin.settings.webSearchEmulation.subscribedAtHint') REDACTEDREDACTED</p>
                    </div>
                  </div>

                  <!-- Usage display -->
                  <div class="flex items-center gap-2">
                    <span class="text-xs text-gray-500">{{ t('admin.settings.webSearchEmulation.quotaUsage') REDACTEDREDACTED:</span>
                    <div v-if="provider.quota_limit != null && provider.quota_limit > 0" class="flex-1 rounded-full bg-gray-200 dark:bg-dark-600" style="height: 6px">
                      <div
                        ...
                        :style="{ width: Math.min(quotaPercentage(provider), 100) + '%' REDACTED"
                      />
                    </div>
                    <div v-else class="flex-1" />
                    <span class="text-xs text-gray-500">{{ provider.quota_used ?? 0 REDACTEDREDACTED / {{ provider.quota_limit != null && provider.quota_limit > 0 ? provider.quota_limit : '∞' REDACTEDREDACTED</span>
                    <button
                  ...
                  <div class="flex items-end gap-3">
                    <div class="flex-1">
                      <label class="text-xs text-gray-500">{{ t('admin.settings.webSearchEmulation.proxy') REDACTEDREDACTED</label>
        ...
        <div v-if="wsTestDialogOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50" @click.self="wsTestDialogOpen = false">
          <div class="mx-4 w-full max-w-lg rounded-xl bg-white p-6 shadow-xl dark:bg-dark-800">
            ...
            <div class="flex items-center gap-2">
              ...
              >
                {{ wsTestLoading ? t('admin.settings.webSearchEmulation.testing') : t('admin.settings.webSearchEmulation.test') REDACTEDREDACTED
              </button>
            </div>
            <!-- Test results -->
            <div v-if="wsTestResult" class="mt-4 max-h-80 overflow-y-auto rounded-lg bg-gray-50 p-4 dark:bg-dark-700">
              <p class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                {{ t('admin.settings.webSearchEmulation.testResultProvider') REDACTEDREDACTED: {{ wsTestResult.provider REDACTEDREDACTED
              </p>
              ...
              <div v-for="(r, rIdx) in wsTestResult.results" :key="rIdx" class="mt-2 border-t border-gray-200 pt-2 first:mt-0 first:border-0 first:pt-0 dark:border-dark-600">
                <a :href="r.url" target="_blank" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-400">{{ r.title REDACTEDREDACTED</a>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">{{ r.snippet REDACTEDREDACTED</p>
              </div>
            </div>
                ...
                >
                  <div class="mb-3 flex items-center justify-between">
                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">
                      {{ t('admin.settings.site.customEndpoints.itemLabel', { n: index + 1 REDACTED) REDACTEDREDACTED
                    </span>
                    <button
                      type="button"
                  ...
                  <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    ...
                    <div>
                      <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">
                        {{ t('admin.settings.site.customEndpoints.endpointUrl') REDACTEDREDACTED
                      </label>
                      <input
                        v-model="ep.endpoint"
                        type="url"
                    ...
                    <div class="sm:col-span-2">
                      <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">
                        {{ t('admin.settings.site.customEndpoints.descriptionLabel') REDACTEDREDACTED
                      </label>
                      <input
        ...
        <div class="card">
          ...
          <div class="space-y-4 p-6">
            ...
            >
              <div class="mb-3 flex items-center justify-between">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.customMenu.itemLabel', { n: index + 1 REDACTED) REDACTEDREDACTED
                </span>
                <div class="flex items-center gap-2">
                  <!-- Move up -->
                  <button
              ...
              <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <select v-model="item.visibility" class="input text-sm">
                    <option value="user">{{ t('admin.settings.customMenu.visibilityUser') REDACTEDREDACTED</option>
                    <option value="admin">{{ t('admin.settings.customMenu.visibilityAdmin') REDACTEDREDACTED</option>
                  </select>
                </div>
...
<!-- Tab: Payment -->
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('admin.settings.payment.title') REDACTEDREDACTED</h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
          ...
          <div class="space-y-4 p-6">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="font-medium text-gray-900 dark:text-white">{{ t('admin.settings.payment.enabled') REDACTEDREDACTED</label>
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ t('admin.settings.payment.enabledHint') REDACTEDREDACTED</p>
              </div>
            ...
            <template v-if="form.payment_enabled">
              ...
              <div class="grid grid-cols-3 gap-3">
                <div><label class="input-label">{{ t('admin.settings.payment.productNamePrefix') REDACTEDREDACTED</label><input v-model="form.payment_product_name_prefix" type="text" class="input" placeholder="Sub2API" /></div>
                <div><label class="input-label">{{ t('admin.settings.payment.productNameSuffix') REDACTEDREDACTED</label><input v-model="form.payment_product_name_suffix" type="text" class="input" placeholder="CNY" /></div>
                <div><label class="input-label">{{ t('admin.settings.payment.preview') REDACTEDREDACTED</label><div class="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-600 dark:border-dark-600 dark:bg-dark-800 dark:text-gray-300">{{ (form.payment_product_name_prefix || 'Sub2API') + ' 100 ' + (form.payment_product_name_suffix || 'CNY') REDACTEDREDACTED</div></div>
              </div>
              <!-- Row 2: Balance toggle + amounts -->
              <div class="grid grid-cols-2 gap-3 sm:grid-cols-5">
                <div><label class="input-label">{{ t('admin.settings.payment.minAmount') REDACTEDREDACTED</label><input :value="form.payment_min_amount || ''" @input="form.payment_min_amount = parseFloat(($event.target as HTMLInputElement).value) || 0" type="number" step="0.01" min="0" class="input" :placeholder="t('admin.settings.payment.noLimit')" /></div>
                <div><label class="input-label">{{ t('admin.settings.payment.maxAmount') REDACTEDREDACTED</label><input :value="form.payment_max_amount || ''" @input="form.payment_max_amount = parseFloat(($event.target as HTMLInputElement).value) || 0" type="number" step="0.01" min="0" class="input" :placeholder="t('admin.settings.payment.noLimit')" /></div>
                <div><label class="input-label">{{ t('admin.settings.payment.dailyLimit') REDACTEDREDACTED</label><input :value="form.payment_daily_limit || ''" @input="form.payment_daily_limit = parseFloat(($event.target as HTMLInputElement).value) || 0" type="number" step="0.01" min="0" class="input" :placeholder="t('admin.settings.payment.noLimit')" /></div>
                <div>
                  <label class="input-label">{{ t('admin.settings.payment.balanceRechargeMultiplier') REDACTEDREDACTED</label>
                  ...
                  <p class="mt-0.5 text-xs text-gray-400">{{ t('admin.settings.payment.balanceRechargeMultiplierHint') REDACTEDREDACTED</p>
                  <p class="mt-1 text-xs font-medium text-primary-600 dark:text-primary-400">{{ t('admin.settings.payment.balanceRechargePreview', { usd: (Number(form.payment_balance_recharge_multiplier) || 1).toFixed(2) REDACTED) REDACTEDREDACTED</p>
                </div>
                <div>
                  <label class="input-label">{{ t('admin.settings.payment.rechargeFeeRate') REDACTEDREDACTED</label>
                  <div class="relative">
                  ...
                  <p class="mt-0.5 text-xs text-gray-400">{{ t('admin.settings.payment.rechargeFeeRateHint') REDACTEDREDACTED</p>
                  <p v-if="(Number(form.payment_recharge_fee_rate) || 0) > 0" class="mt-1 text-xs font-medium text-primary-600 dark:text-primary-400">{{ t('admin.settings.payment.rechargeFeePreview', { fee: (Number(form.payment_recharge_fee_rate) || 0).toFixed(2) REDACTED) REDACTEDREDACTED</p>
                </div>
                <div><label class="input-label">{{ t('admin.settings.payment.orderTimeout') REDACTEDREDACTED <span class="text-red-500">*</span></label><input v-model.number="form.payment_order_timeout_minutes" type="number" min="1" class="input" required /><p class="mt-0.5 text-xs text-gray-400">{{ t('admin.settings.payment.orderTimeoutHint') REDACTEDREDACTED</p></div>
              </div>
              <!-- Row 3: Pending orders + load balance + cancel rate limit (all in one row) -->
              <div class="flex flex-wrap items-end gap-4">
                <div class="w-28"><label class="input-label">{{ t('admin.settings.payment.maxPendingOrders') REDACTEDREDACTED</label><input v-model.number="form.payment_max_pending_orders" type="number" min="1" class="input" /></div>
                <div>
                  <label class="input-label">{{ t('admin.settings.payment.loadBalanceStrategy') REDACTEDREDACTED</label>
                  <Select v-model="form.payment_load_balance_strategy" :options="loadBalanceOptions" class="w-40" />
                </div>
                <div>
                  <label class="input-label">{{ t('admin.settings.payment.cancelRateLimit') REDACTEDREDACTED</label>
                  <div class="flex items-center gap-2">
                    <button
                      type="button"
                      :class="[
                    ...
                    <span :class="['text-sm whitespace-nowrap', form.payment_cancel_rate_limit_enabled ? 'text-gray-700 dark:text-gray-300' : 'text-gray-400 dark:text-gray-600']">{{ t('admin.settings.payment.cancelRateLimitEvery') REDACTEDREDACTED</span>
                    ...
                    <span :class="['text-sm whitespace-nowrap', form.payment_cancel_rate_limit_enabled ? 'text-gray-700 dark:text-gray-300' : 'text-gray-400 dark:text-gray-600']">{{ t('admin.settings.payment.cancelRateLimitAllowMax') REDACTEDREDACTED</span>
                    ...
                    <span :class="['text-sm whitespace-nowrap', form.payment_cancel_rate_limit_enabled ? 'text-gray-700 dark:text-gray-300' : 'text-gray-400 dark:text-gray-600']">{{ t('admin.settings.payment.cancelRateLimitTimes') REDACTEDREDACTED</span>
                  </div>
                </div>
              </div>
              <!-- Row 4: Enabled payment types (provider badges like sub2apipay) -->
              <div>
                <label class="input-label">{{ t('admin.settings.payment.enabledPaymentTypes') REDACTEDREDACTED</label>
                <div class="mt-1.5 flex flex-wrap gap-2">
                  ...
                  >{{ pt.label REDACTEDREDACTED</button>
                </div>
                ...
                >
                  <div class="flex items-center justify-between">
                    <div>
                      <label class="font-medium text-gray-900 dark:text-white">
                        {{
                          localText(
                            `${visibleMethod.titleREDACTED 可见方式`,
                            `${visibleMethod.titleREDACTED visible method`
                          )
                        REDACTEDREDACTED
                      </label>
                      <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  ...
                  <div class="mt-4">
                    <label class="input-label">
                      {{ localText('支付来源', 'Payment source') REDACTEDREDACTED
                    </label>
                    <Select
              ...
              <div class="grid grid-cols-2 gap-3">
                <div>
                  <label class="input-label">{{ t('admin.settings.payment.helpImage') REDACTEDREDACTED</label>
                  <ImageUpload v-model="form.payment_help_image_url" :placeholder="t('admin.settings.payment.helpImagePlaceholder')" />
                </div>
                <div>
                  <label class="input-label">{{ t('admin.settings.payment.helpText') REDACTEDREDACTED</label>
        ...
        <div class="card">
          ...
          <div class="px-6 py-6 space-y-4">
            <div class="flex items-center justify-between">
              <label class="mb-0 block text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('admin.settings.balanceNotify.enabled') REDACTEDREDACTED</label>
              <Toggle v-model="form.balance_low_notify_enabled" />
            </div>
            <div v-if="form.balance_low_notify_enabled">
              <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('admin.settings.balanceNotify.threshold') REDACTEDREDACTED</label>
              <div class="relative">
                <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">$</span>
                <input v-model.number="form.balance_low_notify_threshold" type="number" min="0" step="0.01" class="input pl-7" />
              </div>
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ t('admin.settings.balanceNotify.thresholdHint') REDACTEDREDACTED</p>
            </div>
            <div>
              <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('admin.settings.balanceNotify.rechargeUrl') REDACTEDREDACTED</label>
              <input v-model="form.balance_low_notify_recharge_url" type="url" class="input" :placeholder="currentOrigin" />
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ t('admin.settings.balanceNotify.rechargeUrlHint') REDACTEDREDACTED</p>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="px-6 py-6 space-y-4">
            <div class="flex items-center justify-between">
              <label class="mb-0 block text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('admin.settings.quotaNotify.enabled') REDACTEDREDACTED</label>
              <Toggle v-model="form.account_quota_notify_enabled" />
            </div>
            <div v-if="form.account_quota_notify_enabled">
              <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('admin.settings.quotaNotify.emails') REDACTEDREDACTED</label>
              <div class="space-y-2">
              ...
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ t('admin.settings.quotaNotify.emailsHint') REDACTEDREDACTED</p>
            </div>
          </div>
        </div>
        </div><!-- /Tab: Email -->
...
const form = reactive<SettingsForm>({
  ...
  custom_menu_items: [] as Array<{id: string; label: string; icon_svg: string; url: string; visibility: 'user' | 'admin'; sort_order: numberREDACTED>,
  custom_endpoints: [] as Array<{name: string; endpoint: string; description: stringREDACTED>,
  frontend_url: '',
  smtp_host: '',
  smtp_port: 587,
  smtp_username: '',
...
const authSourceDefaults = reactive<AuthSourceDefaultsState>(buildAuthSourceDefaultsState({REDACTED))
...
function validatePaymentVisibleMethodSelections(): boolean {
  for (const visibleMethod of paymentVisibleMethodCards.value) {
    ...
    appStore.showError(
      localText(
        `${visibleMethod.titleREDACTED 已启用，请先选择支付来源`,
        `Select a payment source before enabling ${visibleMethod.titleREDACTED`
      )
    )
    return false
  REDACTED
...
async function resetWebSearchUsage(idx: number) {
  ...
  try {
    await adminAPI.settings.resetWebSearchUsage({ provider_type: provider.type REDACTED)
...
const addQuotaNotifyEmail = () => {
  ...
  REDACTED
  form.account_quota_notify_emails.push({ email: '', disabled: false, verified: true REDACTED)
REDACTED
...
async function saveSettings() {
  ...
  try {
    ...
    for (const authSource of authSourceDefaultsMeta.value) {
      ...
      if (duplicate) {
        appStore.showError(
          `${authSource.titleREDACTED: ${t('admin.settings.defaults.defaultSubscriptionsDuplicate', {
...
function applyBetaPreset(
  ...
  preset: { action: 'pass' | 'filter' | 'block'; model_whitelist: string[]; fallback_action: 'pass' | 'filter' | 'block' REDACTED
) {
...
function slog(...args: unknown[]) { console.warn('[payment]', ...args) REDACTED
...
const loadBalanceOptions = computed(() => [
  { value: 'round-robin', label: t('admin.settings.payment.strategyRoundRobin') REDACTED,
  { value: 'least-amount', label: t('admin.settings.payment.strategyLeastAmount') REDACTED,
])

const cancelRateLimitUnitOptions = computed(() => [
  { value: 'minute', label: t('admin.settings.payment.cancelRateLimitUnitMinute') REDACTED,
...
const cancelRateLimitModeOptions = computed(() => [
  { value: 'rolling', label: t('admin.settings.payment.cancelRateLimitWindowModeRolling') REDACTED,
...
async function handleReorderProviders(updates: { id: number; sort_order: number REDACTED[]) {
  try {
    await Promise.all(
      updates.map(u => adminAPI.payment.updateProvider(u.id, { sort_order: u.sort_order REDACTED as Partial<ProviderInstance>))
    )
