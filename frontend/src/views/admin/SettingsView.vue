                  ...
                  <div class="border-t border-gray-100 pt-3 dark:border-dark-700">
                    ...
                    <div v-if="wsTestResult" class="mt-2 rounded-lg bg-gray-50 p-3 text-xs dark:bg-dark-700">
                      ...
                      <div v-for="(r, rIdx) in wsTestResult.results.slice(0, 3)" :key="rIdx" class="mt-1">
                        <a :href="r.url" target="_blank" class="font-medium text-blue-600 hover:underline dark:text-blue-400">{{ r.title REDACTEDREDACTED</a>
                        <p class="text-gray-500 dark:text-gray-400">{{ r.snippet && r.snippet.length > 120 ? r.snippet.slice(0, 120) + '...' : r.snippet REDACTEDREDACTED</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="card">
          ...
          <div class="px-6 py-6 space-y-4">
            ...
            <div v-if="form.balance_low_notify_enabled" class="space-y-3">
              ...
              <div>
                <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('admin.settings.balanceNotify.thresholdType') REDACTEDREDACTED</label>
                <div class="flex gap-4">
                  <label class="flex items-center gap-1.5 text-sm cursor-pointer">
                    <input type="radio" v-model="form.balance_low_notify_threshold_type" value="fixed" class="accent-primary-500" />
                    {{ t('admin.settings.balanceNotify.typeFixed') REDACTEDREDACTED
                  </label>
                  <label class="flex items-center gap-1.5 text-sm cursor-pointer">
                    <input type="radio" v-model="form.balance_low_notify_threshold_type" value="percentage" class="accent-primary-500" />
                    {{ t('admin.settings.balanceNotify.typePercentage') REDACTEDREDACTED
                  </label>
                </div>
              </div>
              <!-- Threshold value -->
              <div>
                ...
                <div class="relative">
                  <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                    {{ form.balance_low_notify_threshold_type === 'percentage' ? '%' : '$' REDACTEDREDACTED
                  </span>
                  <input
