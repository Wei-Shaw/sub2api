...
/* ============ 系统设置 Tab 导航 ============ */
.settings-tabs-shell {
  @apply sticky z-20 -mx-1 rounded-sm border border-gray-200 bg-[#f8f6f1]/95 p-1.5 backdrop-blur-xl;
  top: 4.75rem;
  box-shadow: none;
}
...
.settings-tab {
  @apply relative isolate flex h-10 min-w-[6.75rem] shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-sm border border-transparent px-3 text-sm font-medium text-gray-600 outline-none transition-colors duration-200 ease-out dark:text-gray-300;
}
...
.settings-tab::before {
  @apply absolute inset-0 -z-10 rounded-sm bg-black/[0.035] opacity-0 transition-opacity duration-200 dark:bg-white/[0.045];
  content: "";
}
...
.settings-tab-active {
  @apply border-[#d8c397] bg-[#eee5d2] text-[#705729] dark:border-[#8f7542] dark:bg-[#241f17] dark:text-[#d7bc7e];
  box-shadow: none;
}
...
.settings-tab-icon {
  @apply flex h-7 w-7 shrink-0 items-center justify-center rounded-sm text-gray-500 transition-colors duration-200 dark:text-gray-400;
}
...
.settings-tab-active .settings-tab-icon {
  @apply bg-[#e5d7b9] text-[#795e2b] dark:bg-[#3a3020] dark:text-[#d7bc7e];
}
