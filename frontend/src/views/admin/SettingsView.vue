      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
          ...
          >
            <div class="settings-tabs">
              <button
                ...
                :key="tab.key"
                :id="`settings-tab-${tab.keyREDACTED`"
                type="button"
                role="tab"
              ...
              >
                ...
                <span class="settings-tab-label">{{
                  t(`admin.settings.tabs.${tab.keyREDACTED`)
        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.overloadCooldown.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.overloadCooldown.description") REDACTEDREDACTED
              </p>
            </div>
              ...
              <template v-else>
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.overloadCooldown.enabledHint") REDACTEDREDACTED
                    </p>
                  </div>
                ...
                >
                  <div>
                    ...
                    >
                      {{ t("admin.settings.overloadCooldown.cooldownMinutes") REDACTEDREDACTED
                    </label>
                    <input
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.rateLimit429Cooldown.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.rateLimit429Cooldown.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div
              ...
              <template v-else>
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    REDACTEDREDACTED</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.rateLimit429Cooldown.enabledHint") REDACTEDREDACTED
                    </p>
                  </div>
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="error">
                        {{ t("admin.settings.streamTimeout.actionError") REDACTEDREDACTED
                      </option>
                      <option value="none">
                        {{ t("admin.settings.streamTimeout.actionNone") REDACTEDREDACTED
                      </option>
                    </select>
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.rectifier.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.rectifier.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <!-- Loading State -->
              ...
              <template v-else>
                ...
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    REDACTEDREDACTED</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.rectifier.enabledHint") REDACTEDREDACTED
                    </p>
                  </div>
                ...
                >
                  ...
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      >
                      <p class="text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.rectifier.thinkingBudgetHint") REDACTEDREDACTED
                      </p>
                    </div>
                  ...
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      >
                      <p class="text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.rectifier.apikeySignatureHint") REDACTEDREDACTED
                      </p>
                    </div>
                  ...
                  >
                    <div>
                      ...
                      >
                      <p class="text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.rectifier.apikeyPatternsHint") REDACTEDREDACTED
                      </p>
                    </div>
                    <div
                      v-for="(
                    ...
                    >
                      + {{ t("admin.settings.rectifier.addPattern") REDACTEDREDACTED
                    </button>
                  </div>
                </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.betaPolicy.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.betaPolicy.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <!-- Loading State -->
                ...
                >
                  ...
                  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      >
                        {{ t("admin.settings.betaPolicy.action") REDACTEDREDACTED
                      </label>
                      <Select
                    ...
                    <div>
                      <label
                        class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                      >
                        {{ t("admin.settings.betaPolicy.scope") REDACTEDREDACTED
                      </label>
                      <Select
                  ...
                  <div v-if="rule.action === 'block'" class="mt-3">
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.betaPolicy.errorMessage") REDACTEDREDACTED
                    </label>
                    <input
                    ...
                    <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">
                      {{ t("admin.settings.betaPolicy.errorMessageHint") REDACTEDREDACTED
                    </p>
                  </div>
                  ...
                  <div v-if="betaPresets[rule.beta_token]?.length" class="mt-3">
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.betaPolicy.quickPresets") REDACTEDREDACTED
                    </label>
                  ...
                  <div class="mt-3">
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.betaPolicy.modelWhitelist") REDACTEDREDACTED
                    </label>
                    <p class="mb-2 text-xs text-gray-400 dark:text-gray-500">
                      {{ t("admin.settings.betaPolicy.modelWhitelistHint") REDACTEDREDACTED
                    </p>
                    <!-- Existing patterns -->
                    <div
                    ...
                    >
                      ...
                      {{ t("admin.settings.betaPolicy.addModelPattern") REDACTEDREDACTED
                    </button>
                  ...
                  >
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.betaPolicy.fallbackAction") REDACTEDREDACTED
                    </label>
                    <Select
                    ...
                    />
                    <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">
                      {{ t("admin.settings.betaPolicy.fallbackActionHint") REDACTEDREDACTED
                    </p>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.openaiFastPolicy.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.openaiFastPolicy.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <!-- Empty state -->
              ...
              >
                {{ t("admin.settings.openaiFastPolicy.empty") REDACTEDREDACTED
              </div>
              ...
              >
                ...
                <div
                  ...
                  :data-testid="`openai-fast-policy-summary-${ruleIndexREDACTED`"
                >
                  ...
                  >
                    {{ openaiFastPolicyActionSummary(rule.action) REDACTEDREDACTED
                  </span>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                  ...
                  <div>
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.openaiFastPolicy.serviceTier") REDACTEDREDACTED
                    </label>
                    <Select
                  ...
                  <div>
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.openaiFastPolicy.action") REDACTEDREDACTED
                    </label>
                    <Select
                      :modelValue="rule.action"
                      @update:modelValue="
                  ...
                  <div>
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.openaiFastPolicy.scope") REDACTEDREDACTED
                    </label>
                    <Select
                      :modelValue="rule.scope"
                      @update:modelValue="
                ...
                <div class="mt-3">
                  <label
                    class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                  >
                    {{ t("admin.settings.openaiFastPolicy.userIds") REDACTEDREDACTED
                  </label>
                  <p class="mb-2 text-xs text-gray-400 dark:text-gray-500">
                    {{ t("admin.settings.openaiFastPolicy.userIdsHint") REDACTEDREDACTED
                  </p>
                ...
                <div v-if="rule.action === 'block'" class="mt-3">
                  <label
                    class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                  >
                    {{ t("admin.settings.openaiFastPolicy.errorMessage") REDACTEDREDACTED
                  </label>
                  <input
                    v-model="rule.error_message"
                    type="text"
                  ...
                  />
                  <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">
                    {{ t("admin.settings.openaiFastPolicy.errorMessageHint") REDACTEDREDACTED
                  </p>
                </div>
                ...
                <div
                  class="mt-3"
                  role="group"
                  :aria-labelledby="`openai-fast-policy-models-label-${ruleIndexREDACTED`"
                  :aria-describedby="`openai-fast-policy-models-hint-${ruleIndexREDACTED`"
                >
                  <label
                    :id="`openai-fast-policy-models-label-${ruleIndexREDACTED`"
                    class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                  >
                    {{ t("admin.settings.openaiFastPolicy.modelWhitelist") REDACTEDREDACTED
                  </label>
                  <p
                    :id="`openai-fast-policy-models-hint-${ruleIndexREDACTED`"
                  ...
                  >
                    ...
                    {{ t("admin.settings.openaiFastPolicy.addModelPattern") REDACTEDREDACTED
                  </button>
                </div>
                ...
                >
                  <label
                    class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                  >
                    {{ t("admin.settings.openaiFastPolicy.fallbackAction") REDACTEDREDACTED
                  </label>
                  <Select
                    :modelValue="rule.fallback_action || 'pass'"
                    @update:modelValue="
              ...
              <div>
                ...
                >
                  ...
                  {{ t("admin.settings.openaiFastPolicy.addRule") REDACTEDREDACTED
                </button>
                <p class="mt-2 text-xs text-gray-400 dark:text-gray-500">
                  {{ t("admin.settings.openaiFastPolicy.saveHint") REDACTEDREDACTED
                </p>
              </div>
            </div>
          </div>
        ...
        <div v-show="activeTab === 'security'" class="space-y-6">
            ...
            <div class="space-y-5 p-6">
              ...
              <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                ...
                >
                  <div class="flex flex-wrap items-center gap-2">
                    ...
                    >
                      <span>{{ suffix REDACTEDREDACTED</span>
                      <button
                        type="button"
              ...
              >
                <div>
                  ...
                  REDACTEDREDACTED</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.registration.emailDomainQuotaHint") REDACTEDREDACTED
                  </p>
                </div>
                <Toggle
              ...
              >
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.registration.frontendUrl") REDACTEDREDACTED
                </label>
                <input
                ...
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.registration.frontendUrlHint") REDACTEDREDACTED
                </p>
              </div>
              ...
              >
                <div class="flex items-start justify-between gap-4">
                  <div>
                    ...
                    REDACTEDREDACTED</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.security.passkeyHint") REDACTEDREDACTED
                    </p>
                  </div>
                  <Toggle
                ...
                >
                  ...
                  <p class="mt-1 break-all">
                    {{ t("admin.settings.security.passkeyRPID") REDACTEDREDACTED:
                    {{
                      form.passkey_rp_id ||
                  ...
                  <p class="mt-1 break-all">
                    {{ t("admin.settings.security.passkeyOrigins") REDACTEDREDACTED:
                    {{
                  ...
                  <p v-if="!form.passkey_configured" class="mt-2">
                    {{ t("admin.settings.security.passkeyDeploymentHint") REDACTEDREDACTED
                  </p>
                </div>
              </div>
              ...
              >
                <div>
                  ...
                  REDACTEDREDACTED</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.security.stepUpHint") REDACTEDREDACTED
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  REDACTEDREDACTED</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.security.sessionBindingHint") REDACTEDREDACTED
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  REDACTEDREDACTED</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.security.auditRetentionHint") REDACTEDREDACTED
                  </p>
                </div>
                <input
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.apiKeyAcl.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.apiKeyAcl.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div class="flex items-center justify-between gap-4">
                <div>
                  <label class="font-medium text-gray-900 dark:text-white">
                    {{ t("admin.settings.apiKeyAcl.trustForwardedIp") REDACTEDREDACTED
                  </label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.apiKeyAcl.trustForwardedIpHint") REDACTEDREDACTED
                  </p>
                </div>
              ...
              >
                ...
                >
                  {{ t("admin.settings.apiKeyAcl.forwardedClientIpHeaders") REDACTEDREDACTED
                </label>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.apiKeyAcl.forwardedClientIpHeadersHint") REDACTEDREDACTED
                </p>
                <div
                  class="mt-3 rounded-lg border border-gray-300 bg-white p-2 dark:border-dark-500 dark:bg-dark-700"
                >
                  <div class="flex flex-wrap items-center gap-2">
                    <span
                      ...
                      class="inline-flex items-center gap-1 rounded bg-gray-100 px-2 py-1 text-xs font-mono text-gray-700 dark:bg-dark-600 dark:text-gray-200"
                    >
                      <span>{{ header REDACTEDREDACTED</span>
                      <button
                        type="button"
                        class="rounded-full text-gray-500 hover:bg-gray-200 hover:text-gray-700 dark:text-gray-300 dark:hover:bg-dark-500 dark:hover:text-white"
                        :aria-label="t('admin.settings.apiKeyAcl.removeForwardedClientIpHeader', { header REDACTED)"
                ...
                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.apiKeyAcl.forwardedClientIpHeadersRiskHint") REDACTEDREDACTED
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            >
              <div class="flex items-center gap-2">
                ...
                />
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                  {{ t("admin.settings.panelRateLimit.title") REDACTEDREDACTED
                </h2>
              </div>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.panelRateLimit.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div
              ...
              <template v-else>
                ...
                >
                  <div class="flex items-start">
                    ...
                    <p class="ml-3 text-sm text-sky-700 dark:text-sky-300">
                      {{ t("admin.settings.panelRateLimit.proxySafeNote") REDACTEDREDACTED
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    REDACTEDREDACTED</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.panelRateLimit.enabledHint") REDACTEDREDACTED
                    </p>
                  </div>
                ...
                >
                  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                      <label
                        class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                      >
                        {{ t("admin.settings.panelRateLimit.userRpm") REDACTEDREDACTED
                      </label>
                      <div class="flex items-center gap-2">
                        <input
                        ...
                        <span class="text-sm text-gray-500 dark:text-gray-400">
                          {{ t("admin.settings.panelRateLimit.perMinute") REDACTEDREDACTED
                        </span>
                      </div>
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.panelRateLimit.userRpmHint") REDACTEDREDACTED
                      </p>
                    </div>
                    ...
                    <div>
                      <label
                        class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                      >
                        {{ t("admin.settings.panelRateLimit.heavyRpm") REDACTEDREDACTED
                      </label>
                      <div class="flex items-center gap-2">
                        <input
                      ...
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.panelRateLimit.heavyRpmHint") REDACTEDREDACTED
                      </p>
                    </div>
                    ...
                    <div>
                      <label
                        class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                      >
                        {{ t("admin.settings.panelRateLimit.publicIpRpm") REDACTEDREDACTED
                      </label>
                      <div class="flex items-center gap-2">
                        <input
                      ...
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.panelRateLimit.publicIpRpmHint") REDACTEDREDACTED
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div>
                      ...
                      REDACTEDREDACTED</label>
                      <p class="text-sm text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.panelRateLimit.exemptAdminHint") REDACTEDREDACTED
                      </p>
                    </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.captcha.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.captcha.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <!-- Enable Captcha -->
              <div class="flex items-center justify-between">
                <div>
                  ...
                  REDACTEDREDACTED</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.captcha.enableHint") REDACTEDREDACTED
                  </p>
                </div>
                <Toggle
              ...
              >
                ...
                <div class="mb-6">
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.captcha.provider") REDACTEDREDACTED
                  </label>
                  <div
                  ...
                  >
                    ...
                    >
                      {{ t("admin.settings.captcha.providerTurnstile") REDACTEDREDACTED
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      {{ t("admin.settings.captcha.providerTencent") REDACTEDREDACTED
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      {{ t("admin.settings.captcha.providerAliyun") REDACTEDREDACTED
                    </button>
                  </div>
                </div>
                ...
                <div v-else-if="captchaProviderSelection === 'tencent'">
                  <div class="mb-6 max-w-sm">
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                      {{ t("admin.settings.tencentCaptcha.region") REDACTEDREDACTED
                    </label>
                    <div class="grid grid-cols-2 gap-2 rounded-lg bg-gray-100 p-1 dark:bg-dark-700">
                      ...
                      >
                        {{ t("admin.settings.tencentCaptcha.regionCn") REDACTEDREDACTED
                      </button>
                      <button
                        type="button"
                      ...
                      >
                        {{ t("admin.settings.tencentCaptcha.regionIntl") REDACTEDREDACTED
                      </button>
                    </div>
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.tencentCaptcha.regionHint") REDACTEDREDACTED
                    </p>
                  </div>
                  <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div class="md:col-span-2">
                      <h3 class="text-sm font-semibold text-gray-900 dark:text-white">
                        {{ t("admin.settings.tencentCaptcha.appCredentialsTitle") REDACTEDREDACTED
                      </h3>
                      <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.tencentCaptcha.appCredentialsHint") REDACTEDREDACTED
                      </p>
                    </div>
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ t("admin.settings.tencentCaptcha.appId") REDACTEDREDACTED
                      </label>
                      <input
                    ...
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ t("admin.settings.tencentCaptcha.appSecretKey") REDACTEDREDACTED
                      </label>
                      <input
                      ...
                      />
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ form.tencent_captcha_app_secret_key_configured ? t("admin.settings.tencentCaptcha.configured") : t("admin.settings.tencentCaptcha.required") REDACTEDREDACTED
                      </p>
                    </div>
                    <div class="border-t border-gray-100 pt-5 md:col-span-2 dark:border-dark-700">
                      <h3 class="text-sm font-semibold text-gray-900 dark:text-white">
                        {{ t("admin.settings.tencentCaptcha.cloudCredentialsTitle") REDACTEDREDACTED
                      </h3>
                      <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.tencentCaptcha.cloudCredentialsHint") REDACTEDREDACTED
                      </p>
                    </div>
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ t("admin.settings.tencentCaptcha.cloudSecretId") REDACTEDREDACTED
                      </label>
                      <input
                      ...
                      />
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ form.tencent_captcha_cloud_secret_id_configured ? t("admin.settings.tencentCaptcha.configured") : t("admin.settings.tencentCaptcha.required") REDACTEDREDACTED
                      </p>
                    </div>
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ t("admin.settings.tencentCaptcha.cloudSecretKey") REDACTEDREDACTED
                      </label>
                      <input
                      ...
                      />
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ form.tencent_captcha_cloud_secret_key_configured ? t("admin.settings.tencentCaptcha.configured") : t("admin.settings.tencentCaptcha.required") REDACTEDREDACTED
                      </p>
                    </div>
                  </div>
                  <p class="mt-5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.tencentCaptcha.camPermissionHint") REDACTEDREDACTED
                  </p>
                  <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.tencentCaptcha.aidEncryptedHint") REDACTEDREDACTED
                  </p>
                  <div class="mt-3 flex flex-wrap gap-x-4 gap-y-2 text-sm">
                    <a
                      ...
                      class="text-primary-600 hover:text-primary-500"
                    >
                      {{ t("admin.settings.tencentCaptcha.openCaptchaConsole") REDACTEDREDACTED
                    </a>
                    <a
                      ...
                      class="text-primary-600 hover:text-primary-500"
                    >
                      {{ t("admin.settings.tencentCaptcha.createCloudKeys") REDACTEDREDACTED
                    </a>
                    <a
                      ...
                      class="text-primary-600 hover:text-primary-500"
                    >
                      {{ t("admin.settings.tencentCaptcha.openWebDocs") REDACTEDREDACTED
                    </a>
                  </div>
                </div>
                  ...
                  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                      <label
                        class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                      >
                        {{ t("admin.settings.aliyunCaptcha.region") REDACTEDREDACTED
                      </label>
                      <div
                      ...
                      >
                        ...
                        >
                          {{ t("admin.settings.aliyunCaptcha.regionCn") REDACTEDREDACTED
                        </button>
                        <button
                          type="button"
                          class="inline-flex items-center justify-center rounded-md px-3 py-1.5 text-sm font-medium transition"
                        ...
                        >
                          {{ t("admin.settings.aliyunCaptcha.regionSgp") REDACTEDREDACTED
                        </button>
                      </div>
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.aliyunCaptcha.regionHint") REDACTEDREDACTED
                      </p>
                    </div>
                    <div>
                      <label
                        class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                      >
                        {{ t("admin.settings.aliyunCaptcha.prefix") REDACTEDREDACTED
                      </label>
                      <input
                      ...
                      />
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.aliyunCaptcha.prefixHint") REDACTEDREDACTED
                      </p>
                    </div>
                  </div>
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.aliyunCaptcha.sceneId") REDACTEDREDACTED
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.aliyunCaptcha.sceneIdHint") REDACTEDREDACTED
                    </p>
                  </div>
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.aliyunCaptcha.accessKeyId") REDACTEDREDACTED
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.aliyunCaptcha.accessKeyIdHint") REDACTEDREDACTED
                    </p>
                  </div>
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.aliyunCaptcha.accessKeySecret") REDACTEDREDACTED
                    </label>
                    <input
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ localText("邮箱快捷登录", "Email OAuth Sign-in") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{
                  localText(
              ...
              <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
                <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-700">
                  ...
                  <div v-if="form.github_oauth_enabled" class="mt-4 space-y-4">
                    ...
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ localText("后端回调地址", "Backend Callback URL") REDACTEDREDACTED
                      </label>
                      <input
                      ...
                      <div class="mt-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
                        ...
                        >
                          {{ localText("生成并复制", "Generate and copy") REDACTEDREDACTED
                        </button>
                        <code
                          v-if="githubOAuthRedirectUrlSuggestion"
                          class="select-all break-all rounded bg-gray-50 px-2 py-1 font-mono text-xs text-gray-600 dark:bg-dark-800 dark:text-gray-300"
                        >
                          {{ githubOAuthRedirectUrlSuggestion REDACTEDREDACTED
                        </code>
                      </div>
                    </div>
                    ...
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ localText("前端回跳地址", "Frontend Callback URL") REDACTEDREDACTED
                      </label>
                      <input
                    ...
                    <div>
                      ...
                      <div class="mt-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
                        ...
                        <code
                          ...
                          class="select-all break-all rounded bg-gray-50 px-2 py-1 font-mono text-xs text-gray-600 dark:bg-dark-800 dark:text-gray-300"
                        >
                          {{ googleOAuthRedirectUrlSuggestion REDACTEDREDACTED
                        </code>
                      </div>
                    </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.wechatConnect.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.wechatConnect.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  REDACTEDREDACTED</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.wechatConnect.enabledHint") REDACTEDREDACTED
                  </p>
                </div>
                <Toggle
              ...
              >
                <div class="space-y-4">
                  ...
                  >
                    <div class="flex items-start justify-between gap-4">
                      <div>
                        <h3 class="font-medium text-gray-900 dark:text-white">
                          {{ localText("PC 应用", "PC App") REDACTEDREDACTED
                        </h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                          {{
                            localText(
                    ...
                    >
                      <div>
                        <label
                          class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >
                          {{ localText("PC AppID", "PC App ID") REDACTEDREDACTED
                        </label>
                        <input
                      ...
                      <div>
                        <label
                          class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >
                          {{ localText("PC AppSecret", "PC App Secret") REDACTEDREDACTED
                        </label>
                        <input
                  ...
                  >
                    <div class="flex items-start justify-between gap-4">
                      <div>
                        <h3 class="font-medium text-gray-900 dark:text-white">
                          {{ localText("公众号", "Official Account") REDACTEDREDACTED
                        </h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                          {{
                            localText(
                    ...
                    >
                      <div>
                        <label
                          class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >
                          {{ localText("公众号 AppID", "Official Account App ID") REDACTEDREDACTED
                        </label>
                        <input
                  ...
                  >
                    <div class="flex items-start justify-between gap-4">
                      <div>
                        <h3 class="font-medium text-gray-900 dark:text-white">
                          {{ localText("移动应用", "Mobile App") REDACTEDREDACTED
                        </h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                          {{
                            localText(
                    ...
                    >
                      <div>
                        <label
                          class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >
                          {{ localText("移动应用 AppID", "Mobile App ID") REDACTEDREDACTED
                        </label>
                        <input
                      ...
                      <div>
                        <label
                          class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >
                          {{ localText("移动应用 AppSecret", "Mobile App Secret") REDACTEDREDACTED
                        </label>
                        <input
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  <div>
                    ...
                    >
                      ...
                      >
                        {{ t("admin.settings.wechatConnect.generateAndCopy") REDACTEDREDACTED
                      </button>
                      <code
                        v-if="wechatRedirectUrlSuggestion"
                        class="select-all break-all rounded bg-gray-50 px-2 py-1 font-mono text-xs text-gray-600 dark:bg-dark-800 dark:text-gray-300"
                      >
                        {{ wechatRedirectUrlSuggestion REDACTEDREDACTED
                      </code>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.wechatConnect.frontendRedirectUrlLabel") REDACTEDREDACTED
                  </label>
                  <input
                  ...
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.wechatConnect.frontendRedirectUrlHint") REDACTEDREDACTED
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.dingtalk.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.dingtalk.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  REDACTEDREDACTED</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.dingtalk.enableHint") REDACTEDREDACTED
                  </p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.dingtalk.clientId") REDACTEDREDACTED
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.dingtalk.clientIdHint") REDACTEDREDACTED
                    </p>
                  </div>
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.dingtalk.clientSecret") REDACTEDREDACTED
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.dingtalk.redirectUrl") REDACTEDREDACTED
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.dingtalk.redirectUrlHint") REDACTEDREDACTED
                    </p>
                  </div>
                  ...
                  <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                      {{ t("admin.settings.dingtalk.corpPolicy.label") REDACTEDREDACTED
                    </label>
                    <p class="mb-3 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.dingtalk.corpPolicy.hint") REDACTEDREDACTED
                    </p>
                    <div class="space-y-2">
                      <label class="flex cursor-pointer items-center gap-3">
                        ...
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                          {{ t("admin.settings.dingtalk.corpPolicy.none") REDACTEDREDACTED
                        </span>
                      </label>
                      <label class="flex cursor-pointer items-center gap-3">
                        <input
                        ...
                        />
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                          {{ t("admin.settings.dingtalk.corpPolicy.internalOnly") REDACTEDREDACTED
                        </span>
                      </label>
                    </div>
                  </div>
                  ...
                  >
                    <div>
                      ...
                      REDACTEDREDACTED</label>
                      <p class="text-sm text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.dingtalk.bypassRegistrationHint") REDACTEDREDACTED
                      </p>
                    </div>
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <div>
                        ...
                        REDACTEDREDACTED</label>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                          {{ t("admin.settings.dingtalk.syncDisplayNameHint") REDACTEDREDACTED
                        </p>
                      </div>
                    ...
                    <div v-if="form.dingtalk_connect_sync_display_name" class="space-y-2">
                      <div class="flex items-center gap-2">
                        <label class="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap min-w-[5rem]">
                          {{ t("admin.settings.dingtalk.syncDisplayNameTarget") REDACTEDREDACTED
                        </label>
                        <input
                      ...
                      <div class="flex items-center gap-2">
                        <label class="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap min-w-[5rem]">
                          {{ t("admin.settings.dingtalk.syncAttrDisplayName") REDACTEDREDACTED
                        </label>
                        <input
                    ...
                    <p v-if="form.dingtalk_connect_sync_display_name" class="text-xs text-gray-400 dark:text-gray-500">
                      {{ t("admin.settings.dingtalk.syncDisplayNameTargetHint") REDACTEDREDACTED
                    </p>
                  </div>
                  <div
                    v-if="form.dingtalk_connect_corp_restriction_policy === 'internal_only'"
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <div>
                        ...
                        REDACTEDREDACTED</label>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                          {{ t("admin.settings.dingtalk.syncCorpEmailHint") REDACTEDREDACTED
                        </p>
                        <p class="text-xs text-amber-600 dark:text-amber-400 mt-1">
                          {{ t("admin.settings.dingtalk.syncCorpEmailPermissionHint") REDACTEDREDACTED
                        </p>
                      </div>
                    ...
                    <div v-if="form.dingtalk_connect_sync_corp_email" class="space-y-2">
                      <div class="flex items-center gap-2">
                        <label class="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap min-w-[5rem]">
                          {{ t("admin.settings.dingtalk.syncCorpEmailTarget") REDACTEDREDACTED
                        </label>
                        <input
                    ...
                    <p v-if="form.dingtalk_connect_sync_corp_email" class="text-xs text-gray-400 dark:text-gray-500">
                      {{ t("admin.settings.dingtalk.syncCorpEmailTargetHint") REDACTEDREDACTED
                    </p>
                  </div>
                  <div
                    v-if="form.dingtalk_connect_corp_restriction_policy === 'internal_only'"
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <div>
                        ...
                        REDACTEDREDACTED</label>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                          {{ t("admin.settings.dingtalk.syncDeptHint") REDACTEDREDACTED
                        </p>
                        <p class="text-xs text-amber-600 dark:text-amber-400 mt-1">
                          {{ t("admin.settings.dingtalk.syncDeptPermissionHint") REDACTEDREDACTED
                        </p>
                      </div>
                    ...
                    <div v-if="form.dingtalk_connect_sync_dept" class="space-y-2">
                      <div class="flex items-center gap-2">
                        <label class="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap min-w-[5rem]">
                          {{ t("admin.settings.dingtalk.syncDeptTarget") REDACTEDREDACTED
                        </label>
                        <input
                    ...
                    <p v-if="form.dingtalk_connect_sync_dept" class="text-xs text-gray-400 dark:text-gray-500">
                      {{ t("admin.settings.dingtalk.syncDeptTargetHint") REDACTEDREDACTED
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.oidc.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.oidc.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  REDACTEDREDACTED</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.oidc.enableHint") REDACTEDREDACTED
                  </p>
                </div>
              ...
              >
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.providerName") REDACTEDREDACTED
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.clientId") REDACTEDREDACTED
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.clientSecret") REDACTEDREDACTED
                    </label>
                    <input
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.issuerUrl") REDACTEDREDACTED
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.discoveryUrl") REDACTEDREDACTED
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.authorizeUrl") REDACTEDREDACTED
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.tokenUrl") REDACTEDREDACTED
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.userinfoUrl") REDACTEDREDACTED
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.jwksUrl") REDACTEDREDACTED
                    </label>
                    <input
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.scopes") REDACTEDREDACTED
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.oidc.scopesHint") REDACTEDREDACTED
                    </p>
                  </div>
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.redirectUrl") REDACTEDREDACTED
                    </label>
                    <input
                    ...
                    >
                      ...
                      >
                        {{ t("admin.settings.oidc.quickSetCopy") REDACTEDREDACTED
                      </button>
                      <code
                        v-if="oidcRedirectUrlSuggestion"
                        class="select-all break-all rounded bg-gray-50 px-2 py-1 font-mono text-xs text-gray-600 dark:bg-dark-800 dark:text-gray-300"
                      >
                        {{ oidcRedirectUrlSuggestion REDACTEDREDACTED
                      </code>
                    </div>
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.oidc.redirectUrlHint") REDACTEDREDACTED
                    </p>
                  </div>
                  ...
                  <div class="lg:col-span-2">
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.frontendRedirectUrl") REDACTEDREDACTED
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.oidc.frontendRedirectUrlHint") REDACTEDREDACTED
                    </p>
                  </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.tokenAuthMethod") REDACTEDREDACTED
                    </label>
                    <select
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.clockSkewSeconds") REDACTEDREDACTED
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.allowedSigningAlgs") REDACTEDREDACTED
                    </label>
                    <input
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                  ...
                  >
                    <div>
                      <label class="font-medium text-gray-900 dark:text-white">
                        {{ t("admin.settings.oidc.usePkce") REDACTEDREDACTED
                      </label>
                    </div>
                    <Toggle
                  ...
                  >
                    <div>
                      <label class="font-medium text-gray-900 dark:text-white">
                        {{ t("admin.settings.oidc.validateIdToken") REDACTEDREDACTED
                      </label>
                    </div>
                    <Toggle
                  ...
                  >
                    <div>
                      <label class="font-medium text-gray-900 dark:text-white">
                        {{ t("admin.settings.oidc.requireEmailVerified") REDACTEDREDACTED
                      </label>
                    </div>
                    <Toggle
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.userinfoEmailPath") REDACTEDREDACTED
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.userinfoIdPath") REDACTEDREDACTED
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.userinfoUsernamePath") REDACTEDREDACTED
                    </label>
                    <input
        ...
        <div v-show="activeTab === 'users'" class="space-y-6">
            ...
            <div class="space-y-6 p-6">
              <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.defaults.defaultUserRpmLimit") REDACTEDREDACTED
                  </label>
                  <input
                  ...
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.defaults.defaultUserRpmLimitHint") REDACTEDREDACTED
                  </p>
                </div>
              </div>
              ...
              <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                <div class="mb-3 flex items-center justify-between">
                  <div>
                    <label class="font-medium text-gray-900 dark:text-white">
                      {{ t("admin.settings.defaults.defaultSubscriptions") REDACTEDREDACTED
                    </label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{
                  ...
                  >
                    {{ t("admin.settings.defaults.addDefaultSubscription") REDACTEDREDACTED
                  </button>
                </div>
                ...
                >
                  {{ t("admin.settings.defaults.defaultSubscriptionsEmpty") REDACTEDREDACTED
                </div>

                <div v-else class="space-y-3">
                  <div
                    v-for="(item, index) in form.default_subscriptions"
                    :key="`default-sub-${indexREDACTED`"
                  ...
                  >
                    <div>
                      <label
                        class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                      >
                        {{ t("admin.settings.defaults.subscriptionGroup") REDACTEDREDACTED
                      </label>
                      <Select
              ...
              <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                <div class="mb-3">
                  <label class="font-medium text-gray-900 dark:text-white">
                    {{ t("admin.settings.defaults.defaultPlatformQuotas") REDACTEDREDACTED
                  </label>
                  <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.defaults.defaultPlatformQuotasHint") REDACTEDREDACTED
                  </p>
                  <p class="mt-0.5 text-xs text-amber-600 dark:text-amber-400">
                    {{ t("admin.settings.defaults.platformQuotaNotice") REDACTEDREDACTED
                  </p>
                </div>
                  ...
                  <table class="min-w-full text-sm">
                    <thead>
                      <tr class="text-left text-xs text-gray-500 dark:text-gray-400">
                        <th class="pb-2 pr-4 font-medium">{{ t("admin.settings.platformQuota.platform") REDACTEDREDACTED</th>
                        <th class="pb-2 pr-4 font-medium">{{ t("admin.settings.platformQuota.daily") REDACTEDREDACTED</th>
                        <th class="pb-2 pr-4 font-medium">{{ t("admin.settings.platformQuota.weekly") REDACTEDREDACTED</th>
                        <th class="pb-2 font-medium">{{ t("admin.settings.platformQuota.monthly") REDACTEDREDACTED</th>
                      </tr>
                    </thead>
                    <tbody class="space-y-2">
                      <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity', 'grok'] as const)" :key="p" class="align-top">
                        <td class="pr-4 py-1">
                          <span class="font-mono text-xs text-gray-700 dark:text-gray-300">{{ p REDACTEDREDACTED</span>
                        </td>
                        <td class="pr-4 py-1">
                          <input
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.authSourceDefaults.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.authSourceDefaults.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-6 p-6">
              <div
              ...
              >
                <div>
                  <label class="font-medium text-gray-900 dark:text-white">
                    {{ t("admin.settings.authSourceDefaults.requireEmailLabel") REDACTEDREDACTED
                  </label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.authSourceDefaults.requireEmailHint") REDACTEDREDACTED
                  </p>
                </div>
                  ...
                  <div class="flex items-center justify-between gap-4">
                    <div>
                      <div class="font-medium text-gray-900 dark:text-white">
                        {{ authSource.title REDACTEDREDACTED
                      </div>
                      <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        {{ authSource.description REDACTEDREDACTED
                      </p>
                    </div>
                    <Toggle
                      v-model="
                      ...
                      "
                      :data-testid="`auth-source-${authSource.sourceREDACTED-enabled`"
                    />
                  </div>

                  <div
                    v-if="authSourceDefaults[authSource.source].grant_on_signup"
                    :data-testid="`auth-source-${authSource.sourceREDACTED-panel`"
                    class="mt-4 space-y-4 border-t border-gray-100 pt-4 dark:border-dark-700"
                  >
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.authSourceDefaults.enabledHint") REDACTEDREDACTED
                    </p>
                    ...
                    >
                      <div>
                        <label
                          class="font-medium text-gray-900 dark:text-white"
                        >
                          {{ t("admin.settings.authSourceDefaults.grantOnFirstBindLabel") REDACTEDREDACTED
                        </label>
                        <p
                          class="mt-0.5 text-xs text-gray-500 dark:text-gray-400"
                        >
                          {{ t("admin.settings.authSourceDefaults.grantOnFirstBindHint") REDACTEDREDACTED
                        </p>
                      </div>
                      <Toggle
                        v-model="
                    ...
                    <div class="mb-3 flex items-center justify-between">
                      <div>
                        <label
                          class="font-medium text-gray-900 dark:text-white"
                        >
                          {{ t("admin.settings.authSourceDefaults.defaultSubscriptionsLabel") REDACTEDREDACTED
                        </label>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                          {{ t("admin.settings.authSourceDefaults.defaultSubscriptionsHint") REDACTEDREDACTED
                        </p>
                      </div>
                      <button
                        type="button"
                    ...
                    <div
                      ...
                      class="rounded border border-dashed border-gray-300 px-4 py-3 text-sm text-gray-500 dark:border-dark-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.authSourceDefaults.noSourceSubscriptions") REDACTEDREDACTED
                    </div>
                    ...
                    <div v-else class="space-y-3">
                      <div
                        ...
                        :key="`${authSource.sourceREDACTED-sub-${indexREDACTED`"
                        class="grid grid-cols-1 gap-3 rounded border border-gray-200 p-3 md:grid-cols-[1fr_160px_auto] dark:border-dark-600"
                      >
                        <div>
                          <label
                    ...
                    <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                      <div class="mb-3">
                        <label class="font-medium text-gray-900 dark:text-white">
                          {{ t("admin.settings.authSourceDefaults.platformQuotasOverride") REDACTEDREDACTED
                        </label>
                        <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                          {{ t("admin.settings.authSourceDefaults.platformQuotasOverrideHint") REDACTEDREDACTED
                        </p>
                      </div>
                      <div class="overflow-x-auto">
                        <table class="min-w-full text-sm">
                          ...
                          <tbody>
                            <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity', 'grok'] as const)" :key="`${authSource.sourceREDACTED-pq-${pREDACTED`" class="align-top">
                              <td class="pr-4 py-1">
                                <span class="font-mono text-xs text-gray-700 dark:text-gray-300">{{ p REDACTEDREDACTED</span>
                              </td>
                              <td class="pr-4 py-1">
        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
            ...
            <div class="p-6">
              ...
              <div class="mt-4">
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.claudeCode.maxVersion") REDACTEDREDACTED
                </label>
                <input
                ...
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.claudeCode.maxVersionHint") REDACTEDREDACTED
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.gatewayForwarding.codexHardeningTitle") REDACTEDREDACTED
              </h2>
            </div>
            <div class="p-6 space-y-4">
                <div>
                  <h3 class="text-base font-semibold text-gray-900 dark:text-white">
                    {{ t("admin.settings.gatewayForwarding.codexClientRestrictionTitle") REDACTEDREDACTED
                  </h3>
                  <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.codexHardeningDesc") REDACTEDREDACTED
                  </p>
                </div>
                <div class="grid gap-4 sm:grid-cols-2">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.gatewayForwarding.minCodexVersion") REDACTEDREDACTED
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.gatewayForwarding.maxCodexVersion") REDACTEDREDACTED
                    </label>
                    <input
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.gatewayForwarding.codexVersionHint") REDACTEDREDACTED
                </p>

                <div>
                  <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    {{ t("admin.settings.gatewayForwarding.codexFingerprintSignals") REDACTEDREDACTED
                  </label>
                  <p class="mb-2 mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.codexFingerprintSignalsDesc") REDACTEDREDACTED
                  </p>
                  <div
                    v-for="(row, i) in codexFingerprintRows"
                    :key="`codex-fp-${iREDACTED`"
                    class="mb-2 flex items-center gap-2"
                  >
                    <select v-model="row.type" class="input w-32 text-sm">
                      <option value="header_exact">{{ t("admin.settings.gatewayForwarding.codexFpTypeHeaderExact") REDACTEDREDACTED</option>
                      <option value="header_prefix">{{ t("admin.settings.gatewayForwarding.codexFpTypeHeaderPrefix") REDACTEDREDACTED</option>
                      <option value="body_path">{{ t("admin.settings.gatewayForwarding.codexFpTypeBodyPath") REDACTEDREDACTED</option>
                    </select>
                    <input
                      v-model="row.match"
                      type="text"
                    ...
                    <label class="flex shrink-0 items-center gap-1 text-xs text-gray-600 dark:text-gray-400">
                      ...
                      {{ t("admin.settings.gatewayForwarding.codexFpRequired") REDACTEDREDACTED
                    </label>
                    <button
                      type="button"
                    ...
                    >
                      {{ t("admin.settings.gatewayForwarding.codexRemoveRow") REDACTEDREDACTED
                    </button>
                  </div>
                  <button type="button" class="btn btn-secondary btn-sm" @click="addCodexFingerprintRow">
                    {{ t("admin.settings.gatewayForwarding.codexAddRow") REDACTEDREDACTED
                  </button>
                  <p
                    v-if="codexFingerprintNoRequired"
                    class="mt-2 text-xs text-amber-600 dark:text-amber-500"
                  >
                    {{ t("admin.settings.gatewayForwarding.codexFingerprintNoRequiredWarn") REDACTEDREDACTED
                  </p>
                </div>
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.gatewayForwarding.codexBlacklist") REDACTEDREDACTED
                  </label>
                  <p class="mb-2 mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.codexBlacklistDesc") REDACTEDREDACTED
                  </p>
                  <div
                    v-for="(row, i) in codexBlacklistRows"
                    :key="`codex-bl-${iREDACTED`"
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.gatewayForwarding.codexWhitelist") REDACTEDREDACTED
                  </label>
                  <p class="mb-2 mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.codexWhitelistDesc") REDACTEDREDACTED
                  </p>
                  <div
                    v-for="(row, i) in codexWhitelistRows"
                    :key="`codex-wl-${iREDACTED`"
                    class="mb-2 flex gap-2"
                  >
                    <input
                      v-model="row.originator"
          ...
          <div class="card" data-testid="upstream-billing-probe-settings">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.upstreamBillingProbe.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.upstreamBillingProbe.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div
              ...
              <template v-else>
                <div class="flex items-center justify-between gap-4">
                  <div>
                    <label class="font-medium text-gray-900 dark:text-white">
                      {{ t("admin.settings.upstreamBillingProbe.enabled") REDACTEDREDACTED
                    </label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.upstreamBillingProbe.enabledHint") REDACTEDREDACTED
                    </p>
                  </div>
                  <Toggle
                ...
                >
                  ...
                  >
                    {{ t("admin.settings.upstreamBillingProbe.intervalMinutes") REDACTEDREDACTED
                  </label>
                  <input
                  ...
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.upstreamBillingProbe.intervalHint") REDACTEDREDACTED
                  </p>
                </div>
          ...
          <div class="card" data-testid="ollama-cloud-usage-global-settings">
            <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.ollamaCloudUsage.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.ollamaCloudUsage.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              ...
              <template v-else>
                <div class="flex items-center justify-between gap-4">
                  <div>
                    <label class="font-medium text-gray-900 dark:text-white">
                      {{ t("admin.settings.ollamaCloudUsage.enabled") REDACTEDREDACTED
                    </label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.ollamaCloudUsage.enabledHint") REDACTEDREDACTED
                    </p>
                  </div>
                  <Toggle
                ...
                <div v-if="ollamaCloudUsageForm.enabled" class="space-y-4 border-t border-gray-100 pt-4 dark:border-dark-700">
                  <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300" for="ollama-cloud-usage-debounce">
                      {{ t("admin.settings.ollamaCloudUsage.debounceMinutes") REDACTEDREDACTED
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.ollamaCloudUsage.debounceHint") REDACTEDREDACTED
                    </p>
                  </div>
                  <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300" for="ollama-cloud-usage-interval">
                      {{ t("admin.settings.ollamaCloudUsage.intervalMinutes") REDACTEDREDACTED
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.ollamaCloudUsage.intervalHint") REDACTEDREDACTED
                    </p>
                  </div>
                </div>
                <div class="flex justify-end border-t border-gray-100 pt-4 dark:border-dark-700">
                  ...
                  >
                    {{ ollamaCloudUsageSaving ? t("common.saving") : t("common.save") REDACTEDREDACTED
                  </button>
                </div>
              </template>
            </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.scheduling.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.scheduling.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div class="flex items-center justify-between">
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.scheduling.allowUngroupedKey") REDACTEDREDACTED
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.scheduling.allowUngroupedKeyHint") REDACTEDREDACTED
                  </p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
                  ...
                  >
                    ...
                    <input
                      ...
                      step="1"
                      class="input mt-3"
                      :data-testid="`account-scheduling-threshold-${platformREDACTED`"
                      placeholder="100"
                    />
                  </div>
                </div>
              ...
              >
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.openaiExperimentalScheduler.lowRatePriorityTitle") REDACTEDREDACTED
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
              ...
              >
                <div class="min-w-0">
                  ...
                  >
                    {{ t("admin.settings.openaiExperimentalScheduler.oauthRateTitle") REDACTEDREDACTED
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.openaiExperimentalScheduler.oauthRatePriorityDescription") REDACTEDREDACTED
                  </p>
                </div>
              ...
              <div class="flex items-center justify-between border-t border-gray-100 pt-5 dark:border-dark-700">
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.openaiExperimentalScheduler.title") REDACTEDREDACTED
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
              ...
              >
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.openaiExperimentalScheduler.stickyWeightedTitle") REDACTEDREDACTED
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
              ...
              >
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.openaiExperimentalScheduler.subscriptionPriorityTitle") REDACTEDREDACTED
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
              ...
              >
                <div class="min-w-0">
                  ...
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.openaiExperimentalScheduler.oauthRateWeightedDescription") REDACTEDREDACTED
                  </p>
                </div>
                <div class="relative w-full shrink-0 sm:w-32">
                  <input
              ...
              >
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.openaiExperimentalScheduler.weightsTitle") REDACTEDREDACTED
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.gatewayForwarding.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.gatewayForwarding.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div class="grid gap-5 border-b border-gray-100 pb-5 dark:border-dark-700 md:grid-cols-[minmax(0,1fr)_auto] md:items-end">
                <div>
                  <label
                    ...
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.gatewayForwarding.grokDefaultTextModel") REDACTEDREDACTED
                  </label>
                  <input
                  ...
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.grokDefaultTextModelHint") REDACTEDREDACTED
                  </p>
                </div>
                <div class="flex items-center justify-between gap-5 md:min-w-72">
                  <div>
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                      {{ t("admin.settings.gatewayForwarding.grokCrossClientMap") REDACTEDREDACTED
                    </label>
                    <p class="mt-0.5 max-w-sm text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.gatewayForwarding.grokCrossClientMapHint") REDACTEDREDACTED
                    </p>
                  </div>
                  <Toggle
                ...
                <div class="md:col-span-2">
                  <label
                    ...
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.gatewayForwarding.grokDefaultBaseURLMode") REDACTEDREDACTED
                  </label>
                  <select
                  ...
                  >
                    <option value="cli">{{ t("admin.settings.gatewayForwarding.grokBaseURLModeCLI") REDACTEDREDACTED</option>
                    <option value="api">{{ t("admin.settings.gatewayForwarding.grokBaseURLModeAPI") REDACTEDREDACTED</option>
                    <option value="us-east-1">{{ t("admin.settings.gatewayForwarding.grokBaseURLModeUSEast1") REDACTEDREDACTED</option>
                    <option value="us-west-2">{{ t("admin.settings.gatewayForwarding.grokBaseURLModeUSWest2") REDACTEDREDACTED</option>
                    <option value="eu-west-1">{{ t("admin.settings.gatewayForwarding.grokBaseURLModeEUWest1") REDACTEDREDACTED</option>
                  </select>
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.grokDefaultBaseURLModeHint") REDACTEDREDACTED
                  </p>
                </div>
              ...
              <div class="flex items-center justify-between">
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.gatewayForwarding.cchSigning") REDACTEDREDACTED
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.cchSigningHint") REDACTEDREDACTED
                  </p>
                </div>
              ...
              <div>
                    ...
                    >
                      <div class="min-w-0">
                        ...
                        <div
                          class="mt-0.5 text-xs text-gray-500 dark:text-gray-400"
                        >
                          {{ getClaudeOAuthPresetLabel(block.preset) REDACTEDREDACTED
                        </div>
                      </div>
                      <div class="flex items-center gap-2">
                        <button
                    ...
                    <div v-show="block.expanded">
                      ...
                      <div class="mt-3">
                        <label
                          class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-300"
                        >
                          {{ t("admin.settings.gatewayForwarding.systemBlockText") REDACTEDREDACTED
                        </label>
                        <textarea
                          v-model="block.text"
                          rows="6"
                ...
                <div class="mt-3 flex flex-wrap gap-2">
                  ...
                  >
                    ...
                    {{ t("admin.settings.gatewayForwarding.addSystemBlock") REDACTEDREDACTED
                  </button>
                  <button
                    type="button"
                    class="btn btn-secondary btn-sm"
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p
                    ...
                    class="mt-0.5 text-xs text-gray-500 dark:text-gray-400"
                  >
                    {{ codexSyncedVersionLabel REDACTEDREDACTED
                  </p>
                </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.webSearchEmulation.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.webSearchEmulation.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-5 p-6">
              <!-- Global Toggle -->
              <div class="flex items-center justify-between">
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.webSearchEmulation.enabled") REDACTEDREDACTED
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.webSearchEmulation.enabledHint") REDACTEDREDACTED
                  </p>
                </div>
              ...
              <div v-if="webSearchConfig.enabled" class="space-y-4">
                <div class="flex items-center justify-between">
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.webSearchEmulation.providers") REDACTEDREDACTED
                  </label>
                  <button
                    type="button"
                    class="btn btn-secondary btn-sm"
                  ...
                  >
                    {{ t("admin.settings.webSearchEmulation.addProvider") REDACTEDREDACTED
                  </button>
                </div>
                ...
                >
                  {{ t("admin.settings.webSearchEmulation.noProviders") REDACTEDREDACTED
                </div>
                ...
                >
                  ...
                  >
                    <div class="flex items-center gap-3">
                      <svg
                        ...
                        :class="{ 'rotate-90': expandedProviders[pIdx] REDACTED"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                      ...
                      <Select
                        ...
                        :options="[
                          { value: 'brave', label: 'Brave Search' REDACTED,
                          { value: 'tavily', label: 'Tavily' REDACTED,
                        ]"
                        class="w-36"
                        @click.stop
                      />
                      ...
                      <span class="text-xs text-gray-400">
                        {{ provider.quota_used ?? 0 REDACTEDREDACTED /
                        {{
                  ...
                  >
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      >
                        {{ t("admin.settings.webSearchEmulation.resetUsage") REDACTEDREDACTED
                      </button>
                    </div>
                    ...
                    <div class="flex items-end gap-3">
                      ...
                      >
                        {{ t("admin.settings.webSearchEmulation.test") REDACTEDREDACTED
                      </button>
                    </div>
                  </div>
                </div>
          ...
          >
            ...
            >
              ...
              >
                {{ t("admin.settings.webSearchEmulation.testResultTitle") REDACTEDREDACTED
              </h3>
              <div class="flex items-center gap-2">
                <input
                  v-model="wsTestQuery"
              ...
              >
                ...
                >
                  ...
                  REDACTEDREDACTED: {{ wsTestResult.provider REDACTEDREDACTED
                </p>
                <div
                  v-if="wsTestResult.results.length === 0"
                  class="text-sm text-gray-400"
                >
                  {{ t("admin.settings.webSearchEmulation.testNoResults") REDACTEDREDACTED
                </div>
                <div
                ...
                >
                  <a
                    ...
                    >{{ r.title REDACTEDREDACTED</a
                  >
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ r.snippet REDACTEDREDACTED
                  </p>
                </div>
              </div>
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.usageRecords.title') REDACTEDREDACTED
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.usageRecords.description') REDACTEDREDACTED
            </p>
          </div>
          <div class="space-y-4 p-6">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.user_error_view.label') REDACTEDREDACTED
                </label>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.user_error_view.description') REDACTEDREDACTED
                </p>
              </div>
              <label class="toggle">
        ...
        <div v-show="activeTab === 'general'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              ...
              >
                <div>
                  <h3 class="text-sm font-medium text-gray-900 dark:text-white">
                    {{ t("admin.settings.site.backendMode") REDACTEDREDACTED
                  </h3>
                  <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.site.backendModeDescription") REDACTEDREDACTED
                  </p>
	                </div>
              ...
              <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                <h3 class="text-sm font-medium text-gray-900 dark:text-white">
                  {{ t("admin.settings.site.tablePreferencesTitle") REDACTEDREDACTED
                </h3>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.site.tablePreferencesDescription") REDACTEDREDACTED
                </p>
                <div class="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.site.tableDefaultPageSize") REDACTEDREDACTED
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.site.tableDefaultPageSizeHint") REDACTEDREDACTED
                    </p>
                  </div>
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.site.tablePageSizeOptions") REDACTEDREDACTED
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.site.tablePageSizeOptionsHint") REDACTEDREDACTED
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.site.customEndpoints.title") REDACTEDREDACTED
                </label>
                <p class="mb-3 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.site.customEndpoints.description") REDACTEDREDACTED
                </p>
                    ...
                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                      <div>
                        <label
                          class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                        >
                          {{ t("admin.settings.site.customEndpoints.name") REDACTEDREDACTED
                        </label>
                        <input
                          v-model="ep.name"
                          type="text"
                ...
                >
                  ...
                  {{ t("admin.settings.site.customEndpoints.add") REDACTEDREDACTED
                </button>
              </div>
              ...
              <div class="flex items-center justify-between border-t border-gray-100 pt-4 dark:border-dark-700">
                <div>
                  ...
                  REDACTEDREDACTED</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.site.compactHomeHint") REDACTEDREDACTED
                  </p>
                </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.customMenu.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.customMenu.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="space-y-4 p-6">
              <!-- Existing menu items -->
              ...
              >
                <div class="mb-3 flex items-center justify-between">
                  ...
                  >
                    {{
                      t("admin.settings.customMenu.itemLabel", { n: index + 1 REDACTED)
                    REDACTEDREDACTED
                  </span>
                  <div class="flex items-center gap-2">
                    <!-- Move up -->
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  ...
                  <div>
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.customMenu.name") REDACTEDREDACTED
                    </label>
                    <input
                      v-model="item.label"
                      type="text"
                  ...
                  <div>
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.customMenu.visibility") REDACTEDREDACTED
                    </label>
                    <select v-model="item.visibility" class="input text-sm">
                      <option value="user">
                        {{ t("admin.settings.customMenu.visibilityUser") REDACTEDREDACTED
                      </option>
                      <option value="admin">
                        {{ t("admin.settings.customMenu.visibilityAdmin") REDACTEDREDACTED
                      </option>
                    </select>
                  </div>
                  ...
                  <div class="sm:col-span-2">
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.customMenu.url") REDACTEDREDACTED
                    </label>
                    <input
                      v-model="item.url"
                      type="url"
                  ...
                  <div class="sm:col-span-2">
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.customMenu.iconSvg") REDACTEDREDACTED
                    </label>
                    <ImageUpload
              ...
              >
                ...
                {{ t("admin.settings.customMenu.add") REDACTEDREDACTED
              </button>
            </div>
          </div>
	        </div>
	        ...
	        <div v-show="activeTab === 'agreement'" class="space-y-6">
	          <div class="card">
	            <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
	              <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
	                <div>
	                  <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
	                    {{ localText("登录条款确认", "Login agreement") REDACTEDREDACTED
	                  </h2>
	                  <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
	                    {{
	                      localText(
	                ...
	                <div class="flex items-center gap-3">
	                  <span class="text-sm text-gray-600 dark:text-gray-300">
	                    {{ form.login_agreement_enabled ? localText("已启用", "Enabled") : localText("未启用", "Disabled") REDACTEDREDACTED
	                  </span>
	            ...
	            <div class="space-y-6 p-6">
	              <div class="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1fr)_220px]">
	                <div>
	                  <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
	                    {{ localText("展示形式", "Display mode") REDACTEDREDACTED
	                  </label>
	                  <div class="grid grid-cols-2 gap-2 rounded-lg bg-gray-100 p-1 dark:bg-dark-700">
                    <button
                      type="button"
                    ...
                    >
                      ...
                      {{ localText("弹窗", "Modal") REDACTEDREDACTED
                    </button>
                    <button
                      type="button"
                      class="inline-flex items-center justify-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition"
                    ...
                    >
                      ...
                      {{ localText("复选框", "Checkbox") REDACTEDREDACTED
                    </button>
                  </div>
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
                ...
                <div>
                  <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                    {{ localText("条款更新日期", "Updated date") REDACTEDREDACTED
                  </label>
                  <input
                  ...
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ localText("日期或文档内容变化后，用户需要重新同意。", "Changing the date or content requires fresh consent.") REDACTEDREDACTED
                  </p>
                </div>
              </div>
              ...
              <div>
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <h3 class="text-sm font-medium text-gray-900 dark:text-white">
                      {{ localText("协议文档", "Agreement documents") REDACTEDREDACTED
                    </h3>
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                      {{
                        localText(
                  ...
                  >
                    ...
                    {{ localText("添加文档", "Add document") REDACTEDREDACTED
                  </button>
                </div>
                ...
                <div class="mt-4 space-y-3">
                  ...
                  >
                      ...
                      <div class="flex min-w-0 items-center gap-3">
                        ...
                        <div class="min-w-0">
                          <p class="truncate text-sm font-semibold text-gray-900 dark:text-white">
                            {{ doc.title || localText("未命名文档", "Untitled document") REDACTEDREDACTED
                          </p>
                          <p class="truncate text-xs text-gray-500 dark:text-gray-400">
                            {{ loginAgreementRoutePath(doc, index) REDACTEDREDACTED
                          </p>
                        </div>
                      </div>
                      <button
                    ...
                    <div class="grid grid-cols-1 gap-3 lg:grid-cols-2">
                      <div>
                        <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">
                          {{ localText("文档名称", "Document title") REDACTEDREDACTED
                        </label>
                        <input
                          v-model="doc.title"
                          type="text"
                      ...
                      <div>
                        <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">
                          {{ localText("路由标识", "Route slug") REDACTEDREDACTED
                        </label>
                    ...
                    <div class="mt-3">
                      <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">
                        {{ localText("Markdown 内容", "Markdown content") REDACTEDREDACTED
                      </label>
                        <textarea
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.features.channelMonitor.title') REDACTEDREDACTED
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.features.channelMonitor.description') REDACTEDREDACTED
            </p>
            <p class="mt-1.5 text-xs">
              ...
              >
                {{ t('admin.settings.features.channelMonitor.configureLink') REDACTEDREDACTED
                <span aria-hidden="true">→</span>
              </router-link>
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.channelMonitor.enabled') REDACTEDREDACTED
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.channelMonitor.enabledHint') REDACTEDREDACTED
                </p>
              </div>
            ...
            <div v-if="form.channel_monitor_enabled" class="space-y-5">
              <div>
                <label class="input-label">
                  {{ t('admin.settings.features.channelMonitor.mode') REDACTEDREDACTED
                </label>
                <div class="mt-1.5 inline-flex w-full max-w-md rounded-lg border border-gray-200 bg-gray-50 p-1 dark:border-dark-600 dark:bg-dark-900/40">
                  ...
                  >
                    {{ t('admin.settings.features.channelMonitor.modeV2') REDACTEDREDACTED
                  </button>
                  <button
                    type="button"
                    class="inline-flex flex-1 items-center justify-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition"
                  ...
                  >
                    {{ t('admin.settings.features.channelMonitor.modeV1') REDACTEDREDACTED
                  </button>
                </div>
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{
                ...
                <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">
                  {{ t('admin.settings.features.channelMonitor.modeHint') REDACTEDREDACTED
                </p>
              </div>

              <div v-if="form.channel_monitor_mode === 'v1'">
                <label class="input-label">
                  {{ t('admin.settings.features.channelMonitor.defaultInterval') REDACTEDREDACTED
                ...
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.channelMonitor.defaultIntervalHint') REDACTEDREDACTED
                </p>
              </div>
              ...
              <div v-if="form.channel_monitor_mode === 'v2'" class="flex items-start justify-between gap-4">
                <div class="min-w-0">
                  <p class="text-sm font-medium text-gray-900 dark:text-white">
                    {{ t('admin.settings.features.channelMonitor.hideThroughput') REDACTEDREDACTED
                  </p>
                  <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t('admin.settings.features.channelMonitor.hideThroughputHint') REDACTEDREDACTED
                  </p>
                </div>
              ...
              <div v-if="form.channel_monitor_mode === 'v1'" class="flex items-start justify-between gap-4">
                <div class="min-w-0">
                  <p class="text-sm font-medium text-gray-900 dark:text-white">
                    {{ t('admin.settings.features.channelMonitor.showQuota') REDACTEDREDACTED
                  </p>
                  <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t('admin.settings.features.channelMonitor.showQuotaHint') REDACTEDREDACTED
                  </p>
                </div>
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.features.availableChannels.title') REDACTEDREDACTED
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.features.availableChannels.description') REDACTEDREDACTED
            </p>
            <p class="mt-1.5 text-xs">
              <router-link
                ...
                class="inline-flex items-center gap-1 text-primary-600 hover:underline dark:text-primary-400"
              >
                {{ t('admin.settings.features.availableChannels.configureLink') REDACTEDREDACTED
                <span aria-hidden="true">→</span>
              </router-link>
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.availableChannels.enabled') REDACTEDREDACTED
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.availableChannels.enabledHint') REDACTEDREDACTED
                </p>
              </div>
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.features.modelPlaza.title') REDACTEDREDACTED
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.features.modelPlaza.description') REDACTEDREDACTED
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.modelPlaza.enabled') REDACTEDREDACTED
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.modelPlaza.enabledHint') REDACTEDREDACTED
                </p>
              </div>
            ...
            <div v-if="form.model_plaza_enabled" class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.modelPlaza.requireAuth') REDACTEDREDACTED
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.modelPlaza.requireAuthHint') REDACTEDREDACTED
                </p>
              </div>
            ...
            <div v-if="form.model_plaza_enabled">
              <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                {{ t('admin.settings.features.modelPlaza.priceDescription') REDACTEDREDACTED
              </label>
              <p class="mb-2 mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                {{ t('admin.settings.features.modelPlaza.priceDescriptionHint') REDACTEDREDACTED
              </p>
              <textarea
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.features.pluginManagement.title') REDACTEDREDACTED
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.features.pluginManagement.description') REDACTEDREDACTED
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between gap-4">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.pluginManagement.enabled') REDACTEDREDACTED
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.pluginManagement.enabledHint') REDACTEDREDACTED
                </p>
              </div>
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.features.riskControl.title') REDACTEDREDACTED
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.features.riskControl.description') REDACTEDREDACTED
            </p>
            <p class="mt-1.5 text-xs">
              <router-link
                ...
                class="inline-flex items-center gap-1 text-primary-600 hover:underline dark:text-primary-400"
              >
                {{ t('admin.settings.features.riskControl.configureLink') REDACTEDREDACTED
                <span aria-hidden="true">→</span>
              </router-link>
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.riskControl.enabled') REDACTEDREDACTED
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.riskControl.enabledHint') REDACTEDREDACTED
                </p>
              </div>
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.riskControl.cyberSessionBlock') REDACTEDREDACTED
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.riskControl.cyberSessionBlockHint') REDACTEDREDACTED
                </p>
              </div>
            ...
            <div v-if="form.cyber_session_block_enabled">
              <label class="input-label">
                {{ t('admin.settings.features.riskControl.cyberSessionBlockTTL') REDACTEDREDACTED
                <span class="text-red-500">*</span>
              </label>
              <input
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.features.affiliate.title') REDACTEDREDACTED
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.features.affiliate.description') REDACTEDREDACTED
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.affiliate.enabled') REDACTEDREDACTED
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.affiliate.enabledHint') REDACTEDREDACTED
                </p>
              </div>
            ...
            <div v-if="form.affiliate_enabled" class="space-y-6">
              <div class="flex items-center justify-between">
                <div>
                  <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                    {{ t('admin.settings.features.affiliate.adminRechargeRebate') REDACTEDREDACTED
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t('admin.settings.features.affiliate.adminRechargeRebateHint') REDACTEDREDACTED
                  </p>
                </div>
              ...
              <div>
                <label class="input-label">
                  {{ t('admin.settings.features.affiliate.rebateRate') REDACTEDREDACTED
                </label>
                <div class="relative">
                  <input
                ...
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.rebateRateHint') REDACTEDREDACTED
                </p>
              </div>

              <div>
                <label class="input-label">
                  {{ t('admin.settings.features.affiliate.freezeHours') REDACTEDREDACTED
                </label>
                <input
                ...
                />
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.freezeHoursDesc') REDACTEDREDACTED
                </p>
              </div>

              <div>
                <label class="input-label">
                  {{ t('admin.settings.features.affiliate.durationDays') REDACTEDREDACTED
                </label>
                <input
                ...
                />
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.durationDaysDesc') REDACTEDREDACTED
                </p>
              </div>

              <div>
                <label class="input-label">
                  {{ t('admin.settings.features.affiliate.perInviteeCap') REDACTEDREDACTED
                </label>
                <input
                ...
                />
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.perInviteeCapDesc') REDACTEDREDACTED
                </p>
              </div>
              ...
              <div class="border-t border-gray-100 pt-6 dark:border-dark-700">
                <div class="mb-3 flex items-center justify-between">
                  <div>
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white">
                      {{ t('admin.settings.features.affiliate.customUsers.title') REDACTEDREDACTED
                    </h3>
                    <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t('admin.settings.features.affiliate.customUsers.description') REDACTEDREDACTED
                    </p>
                  </div>
                  <button
                    type="button"
                  ...
                  >
                    + {{ t('admin.settings.features.affiliate.customUsers.addButton') REDACTEDREDACTED
                  </button>
                </div>
                ...
                <div class="mb-3 flex items-center gap-2">
                  ...
                  >
                    {{ t('admin.settings.features.affiliate.customUsers.batchButton', { count: affiliateState.selected.length REDACTED) REDACTEDREDACTED
                  </button>
                </div>
                  ...
                  <table class="min-w-full divide-y divide-gray-200 dark:divide-dark-700">
                    <thead class="bg-gray-50 dark:bg-dark-800">
                      <tr>
                        ...
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-gray-500">{{ t('admin.settings.features.affiliate.customUsers.col.email') REDACTEDREDACTED</th>
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-gray-500">{{ t('admin.settings.features.affiliate.customUsers.col.username') REDACTEDREDACTED</th>
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-gray-500">{{ t('admin.settings.features.affiliate.customUsers.col.code') REDACTEDREDACTED</th>
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-gray-500">{{ t('admin.settings.features.affiliate.customUsers.col.rate') REDACTEDREDACTED</th>
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-gray-500">{{ t('admin.settings.features.affiliate.customUsers.col.actions') REDACTEDREDACTED</th>
                      </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 bg-white dark:divide-dark-700 dark:bg-dark-900">
                      ...
                      <tr v-else-if="affiliateState.entries.length === 0">
                        <td colspan="6" class="px-3 py-6 text-center text-sm text-gray-500">
                          {{ t('admin.settings.features.affiliate.customUsers.empty') REDACTEDREDACTED
                        </td>
                      </tr>
                      <tr v-for="entry in affiliateState.entries" :key="entry.user_id">
                        ...
                        <td class="px-3 py-2 text-sm text-gray-900 dark:text-white">{{ entry.email REDACTEDREDACTED</td>
                        <td class="px-3 py-2 text-sm text-gray-600 dark:text-gray-300">{{ entry.username REDACTEDREDACTED</td>
                        <td class="px-3 py-2 text-sm font-mono">
                          {{ entry.aff_code REDACTEDREDACTED
                          <span
                          ...
                          >{{ t('admin.settings.features.affiliate.customUsers.customBadge') REDACTEDREDACTED</span>
                        </td>
                        <td class="px-3 py-2 text-sm">
                          <span v-if="entry.aff_rebate_rate_percent != null">{{ entry.aff_rebate_rate_percent REDACTEDREDACTED%</span>
                          <span v-else class="text-gray-400">{{ t('admin.settings.features.affiliate.customUsers.useGlobal') REDACTEDREDACTED</span>
                        </td>
                        <td class="px-3 py-2 text-sm">
                          <div class="flex items-center gap-2">
                ...
                <div v-if="affiliateState.total > affiliateState.pageSize" class="mt-3 flex items-center justify-between text-sm">
                  <span class="text-gray-500">
                    {{ t('admin.settings.features.affiliate.customUsers.totalLabel', { total: affiliateState.total REDACTED) REDACTEDREDACTED
                  </span>
                  <div class="flex items-center gap-2">
                    <button
                      type="button"
                    ...
                    <span class="text-gray-500">{{ affiliateState.page REDACTEDREDACTED / {{ Math.max(1, Math.ceil(affiliateState.total / affiliateState.pageSize)) REDACTEDREDACTED</span>
                    <button
                      type="button"
                      class="btn btn-secondary btn-sm"
        ...
        >
          <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-dark-900">
            <h3 class="mb-4 text-lg font-semibold">
              {{ affiliateModal.mode === 'add' ? t('admin.settings.features.affiliate.modal.addTitle') : t('admin.settings.features.affiliate.modal.editTitle') REDACTEDREDACTED
            </h3>
            <div class="space-y-4">
              <div v-if="affiliateModal.mode === 'add'">
                <label class="input-label">{{ t('admin.settings.features.affiliate.modal.userLabel') REDACTEDREDACTED</label>
                ...
                >
                  <div class="text-sm">
                    <span class="font-medium text-gray-900 dark:text-white">{{ affiliateModal.selectedUser.email REDACTEDREDACTED</span>
                    <span class="ml-1 text-xs text-gray-500">({{ affiliateModal.selectedUser.username REDACTEDREDACTED)</span>
                  </div>
                  <button
                    type="button"
                ...
                <template v-else>
                  ...
                  >
                    ...
                    >
                      {{ u.email REDACTEDREDACTED <span class="text-xs text-gray-500">({{ u.username REDACTEDREDACTED)</span>
                    </button>
                  </div>
                </template>
              </div>
              ...
              <div>
                <label class="input-label">{{ t('admin.settings.features.affiliate.modal.codeLabel') REDACTEDREDACTED</label>
                <input
                ...
                />
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.modal.codeHint') REDACTEDREDACTED
                </p>
              </div>

              <div>
                <label class="input-label">{{ t('admin.settings.features.affiliate.modal.rateLabel') REDACTEDREDACTED</label>
                <div class="relative">
                  <input
                ...
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.modal.rateHint') REDACTEDREDACTED
                </p>
              </div>
            </div>
            ...
            <div class="mt-6 flex items-center justify-between gap-3">
              ...
              >
                {{ t('admin.settings.features.affiliate.modal.errorEmpty') REDACTEDREDACTED
              </p>
              <span v-else></span>
              <div class="flex gap-2">
                ...
                >
                  {{ affiliateModal.saving ? t('common.saving') : t('common.save') REDACTEDREDACTED
                </button>
              </div>
            </div>
          </div>
        ...
        >
          <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-dark-900">
            <h3 class="mb-4 text-lg font-semibold">
              {{ t('admin.settings.features.affiliate.batchModal.title', { count: affiliateState.selected.length REDACTED) REDACTEDREDACTED
            </h3>
            <p class="mb-4 text-sm text-gray-500">
              {{ t('admin.settings.features.affiliate.batchModal.hint') REDACTEDREDACTED
            </p>
            <div class="relative">
              <input
            ...
            <p class="mt-2 text-xs text-gray-400">
              {{ t('admin.settings.features.affiliate.batchModal.clearHint') REDACTEDREDACTED
            </p>
            <div class="mt-6 flex justify-end gap-2">
              ...
              >
                {{ affiliateBatchModal.saving ? t('common.saving') : t('common.save') REDACTEDREDACTED
              </button>
            </div>
          </div>
        </div>
        ...
        <div v-show="activeTab === 'payment'" class="space-y-6">
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.payment.title") REDACTEDREDACTED
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.payment.description") REDACTEDREDACTED
                <a
                ...
                >
                  ...
                  {{ t("admin.settings.payment.configGuide") REDACTEDREDACTED
                </a>
              </p>
            </div>
            <div class="space-y-4 p-6">
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  REDACTEDREDACTED</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.payment.enabledHint") REDACTEDREDACTED
                  </p>
                </div>
              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-2 gap-3 sm:grid-cols-5">
                  ...
                  <div>
                    ...
                    <p class="mt-0.5 text-xs text-gray-400">
                      {{ t("admin.settings.payment.rechargeFeeRateHint") REDACTEDREDACTED
                    </p>
                    <p
                  ...
                  <div>
                    <label class="input-label"
                      >{{ t("admin.settings.payment.orderTimeout") REDACTEDREDACTED
                    ...
                    />
                    <p class="mt-0.5 text-xs text-gray-400">
                      {{ t("admin.settings.payment.orderTimeoutHint") REDACTEDREDACTED
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div class="mt-1.5 flex flex-wrap gap-2">
                    ...
                    >
                      {{ pt.label REDACTEDREDACTED
                    </button>
                  </div>
                  <p class="mt-2 text-xs text-gray-400 dark:text-gray-500">
                    {{ t("admin.settings.payment.enabledPaymentTypesHint") REDACTEDREDACTED
                    <a
                    ...
                    >
                      {{ t("admin.settings.payment.findProvider") REDACTEDREDACTED
                      <svg
        ...
        <div v-show="activeTab === 'email'" class="space-y-6">
          ...
          <div v-if="!form.email_verify_enabled" class="card">
            <div class="p-6">
              <div class="flex items-start gap-3">
                ...
                <div>
                  <h3 class="font-medium text-gray-900 dark:text-white">
                    {{ t("admin.settings.emailTabDisabledTitle") REDACTEDREDACTED
                  </h3>
                  <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.emailTabDisabledHint") REDACTEDREDACTED
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            ...
            >
              <h3 class="text-base font-medium text-gray-900 dark:text-white">
                {{ t("admin.settings.subscriptionExpiryNotify.title") REDACTEDREDACTED
              </h3>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.subscriptionExpiryNotify.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="px-6 py-6">
              <div class="flex items-center justify-between gap-4">
                <div>
                  ...
                  >
                    {{ t("admin.settings.subscriptionExpiryNotify.enabled") REDACTEDREDACTED
                  </label>
                  <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.subscriptionExpiryNotify.enabledHint") REDACTEDREDACTED
                  </p>
                </div>
          ...
          <div class="card">
            ...
            >
              <h3 class="text-base font-medium text-gray-900 dark:text-white">
                {{ t("admin.settings.balanceNotify.title") REDACTEDREDACTED
              </h3>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.balanceNotify.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="px-6 py-6 space-y-4">
              <div class="flex items-center justify-between">
                <label
                  class="mb-0 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.settings.balanceNotify.enabled") REDACTEDREDACTED</label
                >
              ...
              <div v-if="form.balance_low_notify_enabled">
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.settings.balanceNotify.threshold") REDACTEDREDACTED</label
                >
                <div class="relative">
                  <span
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.balanceNotify.thresholdHint") REDACTEDREDACTED
                </p>
              </div>
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.settings.balanceNotify.rechargeUrl") REDACTEDREDACTED</label
                >
                <input
                ...
                />
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.balanceNotify.rechargeUrlHint") REDACTEDREDACTED
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            >
              <h3 class="text-base font-medium text-gray-900 dark:text-white">
                {{ t("admin.settings.quotaNotify.title") REDACTEDREDACTED
              </h3>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.quotaNotify.description") REDACTEDREDACTED
              </p>
            </div>
            <div class="px-6 py-6 space-y-4">
              <div class="flex items-center justify-between">
                <label
                  class="mb-0 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.settings.quotaNotify.enabled") REDACTEDREDACTED</label
                >
              ...
              <div v-if="form.account_quota_notify_enabled">
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.settings.quotaNotify.emails") REDACTEDREDACTED</label
                >
                <div class="space-y-2">
                  <div
                  ...
                  <button
                    ...
                    type="button"
                  >
                    + {{ t("admin.settings.quotaNotify.addEmail") REDACTEDREDACTED
                  </button>
                </div>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.quotaNotify.emailsHint") REDACTEDREDACTED
                </p>
              </div>
            </div>
          </div>
...
import { ref, reactive, computed, onMounted, watch REDACTED from "vue";
...
import { affiliatesAPI, type AffiliateAdminEntry, type SimpleUser as AffiliateSimpleUser REDACTED from "@/api/admin/affiliates";
...
const settingsTabs = [
  ...
  { key: "agreement" as SettingsTab, icon: "document" as const REDACTED,
  { key: "features" as SettingsTab, icon: "bolt" as const REDACTED,
  { key: "security" as SettingsTab, icon: "shield" as const REDACTED,
  { key: "users" as SettingsTab, icon: "user" as const REDACTED,
  { key: "gateway" as SettingsTab, icon: "server" as const REDACTED,
  { key: "payment" as SettingsTab, icon: "creditCard" as const REDACTED,
...
function focusSettingsTab(tab: SettingsTab): void {
  window.requestAnimationFrame(() => {
    document.getElementById(`settings-tab-${tabREDACTED`)?.focus();
  REDACTED);
REDACTED
...
function loginAgreementRoutePath(
  ...
  const id =
    normalizeLoginAgreementDocumentId(doc.id || doc.title) || `doc-${index + 1REDACTED`;
  return `/legal/${idREDACTED`;
REDACTED
...
function nextClaudeOAuthSystemPromptBlockID(): string {
  ...
  return `claude-oauth-system-prompt-block-${claudeOAuthSystemPromptBlockIDREDACTED`;
REDACTED
...
function detectClaudeOAuthSystemPromptPreset(
  ...
  if (trimmed === "{billing_headerREDACTED") {
    return "billing";
  REDACTED
  if (
    trimmed === "{claude_code_system_promptREDACTED" ||
    trimmed === defaultClaudeCodeSystemPrompt
  ) {
    return "system";
  REDACTED
  if (
    trimmed === "{claude_code_expansion_promptREDACTED" ||
...
function normalizeClaudeOAuthSystemPromptBlockText(
  ...
  const trimmed = text.trim();
  if (trimmed === "{claude_code_system_promptREDACTED") {
    return defaultClaudeCodeSystemPrompt;
  REDACTED
  if (trimmed === "{claude_code_expansion_promptREDACTED") {
...
function createClaudeOAuthSystemPromptBlock(
  overrides: Partial<ClaudeOAuthSystemPromptBlock> = {REDACTED,
...
REDACTED {
  if (cacheControl === true) {
    return { enabled: true, ttl: "5m" REDACTED;
  REDACTED
  if (
    cacheControl &&
    ...
    REDACTED;
  REDACTED
  return { enabled: false, ttl: "5m" REDACTED;
REDACTED
...
function parseClaudeOAuthSystemPromptBlocks(
  ...
  try {
    const parsed = JSON.parse(trimmed) as
      ...
      | { blocks?: ClaudeOAuthSystemPromptRawBlock[] REDACTED;
...
const claudeOAuthSystemPromptCacheTTLOptions = computed(() => [
  { value: "5m", label: t("admin.settings.gatewayForwarding.cacheTTL5m") REDACTED,
  { value: "1h", label: t("admin.settings.gatewayForwarding.cacheTTL1h") REDACTED,
]);
...
function applyClaudeOAuthSystemPromptPreset(
  ...
  block.type = "text";
  if (preset === "billing") {
    block.text = "{billing_headerREDACTED";
    block.cacheControlEnabled = false;
    block.cacheControlTTL = "5m";
  REDACTED else if (preset === "system") {
    block.text = defaultClaudeCodeSystemPrompt;
    block.cacheControlEnabled = false;
    block.cacheControlTTL = "5m";
  REDACTED else if (preset === "expansion") {
    block.text =
...
function syncCaptchaProviderSelection(): void {
  ...
  REDACTED else if (form.aliyun_captcha_enabled) {
    captchaProviderSelection.value = "aliyun";
  REDACTED else if (form.turnstile_enabled) {
...
const authSourceDefaults = reactive<AuthSourceDefaultsState>(
  buildAuthSourceDefaultsState({REDACTED),
);
...
const expandedProviders = reactive<Record<number, boolean>>({REDACTED);
const apiKeyVisible = reactive<Record<number, boolean>>({REDACTED);
...
function removeWebSearchProvider(idx: number) {
  ...
  const newExpanded: Record<number, boolean> = {REDACTED;
  const newVisible: Record<number, boolean> = {REDACTED;
...
function addWebSearchProvider() {
  ...
  webSearchConfig.providers.push({
    ...
    proxy_id: null,
    expires_at: null,
  REDACTED as WebSearchProviderConfig);
...
function formatSubscribedAt(ts: number | null): string {
  ...
  return `${yREDACTED-${mREDACTED-${dayREDACTED`;
REDACTED
...
async function loadWebSearchConfig() {
  try {
    const [resp, proxiesResp] = await Promise.all([
      ...
      adminAPI.proxies.list().catch(() => ({ items: [] as Proxy[] REDACTED)),
    ]);
    if (resp) {
  ...
  REDACTED catch (err: unknown) {
    ...
    const status = (err as { status?: number REDACTED)?.status;
...
function normalizeForwardedClientIpHeader(raw: string): string {
  ...
  return header
    .toLowerCase()
    .split("-")
    .map((part) => `${part.charAt(0).toUpperCase()REDACTED${part.slice(1)REDACTED`)
    .join("-");
REDACTED
...
function buildApiCallbackUrl(path: string): string {
  ...
  const apiRoot = base.endsWith("/api/v1") ? base : `${baseREDACTED/api/v1`;
  return `${apiRootREDACTED${path.startsWith("/") ? path : `/${pathREDACTED`REDACTED`;
REDACTED
...
function addEndpoint() {
  form.custom_endpoints.push({ name: "", endpoint: "", description: "" REDACTED);
REDACTED
...
function addLoginAgreementDocument() {
  form.login_agreement_documents.push({
    id: `custom-${Date.now().toString(36)REDACTED`,
    title: "",
    content_md: "",
  REDACTED);
REDACTED
...
function addCodexFingerprintRow(): void {
  codexFingerprintRows.value.push({ type: "header_exact", match: "", required: false REDACTED);
REDACTED
...
function addCodexBlacklistRow(): void {
  codexBlacklistRows.value.push({ originator: "", uaContains: "" REDACTED);
REDACTED
...
async function saveSettings() {
  ...
  try {
    ...
    if (duplicateLoginAgreementDocumentId) {
      appStore.showError(
        localText(
          `登录条款文档路由不能重复：/legal/${duplicateLoginAgreementDocumentIdREDACTED`,
          `Login agreement document routes cannot be duplicated: /legal/${duplicateLoginAgreementDocumentIdREDACTED`,
        ),
      );
      return;
    REDACTED
    ...
    const payload: UpdateSettingsRequest = {
      ...
      registration_email_suffix_whitelist:
        registrationEmailSuffixWhitelistTags.value.map((suffix) =>
          suffix.startsWith("*.") ? suffix : `@${suffixREDACTED`,
        ),
  ...
  REDACTED catch (error: unknown) {
    ...
    if (
      (error as { reason?: string REDACTED)?.reason === "STEP_UP_ENABLE_REQUIRES_TOTP"
    ) {
...
const betaPolicyActionOptions = computed(() => [
  { value: "pass", label: t("admin.settings.betaPolicy.actionPass") REDACTED,
  { value: "filter", label: t("admin.settings.betaPolicy.actionFilter") REDACTED,
  { value: "block", label: t("admin.settings.betaPolicy.actionBlock") REDACTED,
]);

const betaPolicyScopeOptions = computed(() => [
  { value: "all", label: t("admin.settings.betaPolicy.scopeAll") REDACTED,
  { value: "oauth", label: t("admin.settings.betaPolicy.scopeOAuth") REDACTED,
  { value: "apikey", label: t("admin.settings.betaPolicy.scopeAPIKey") REDACTED,
  { value: "bedrock", label: t("admin.settings.betaPolicy.scopeBedrock") REDACTED,
]);
...
const openaiFastPolicyTierOptions = computed(() => [
  { value: "all", label: t("admin.settings.openaiFastPolicy.tierAll") REDACTED,
  {
    value: "priority",
    label: t("admin.settings.openaiFastPolicy.tierPriority"),
  REDACTED,
  { value: "flex", label: t("admin.settings.openaiFastPolicy.tierFlex") REDACTED,
]);

const openaiFastPolicyActionOptions = computed(() => [
  { value: "pass", label: t("admin.settings.openaiFastPolicy.actionPass") REDACTED,
  { value: "filter", label: t("admin.settings.openaiFastPolicy.actionFilter") REDACTED,
  {
    value: "force_priority",
    label: t("admin.settings.openaiFastPolicy.actionForcePriority"),
  REDACTED,
  { value: "block", label: t("admin.settings.openaiFastPolicy.actionBlock") REDACTED,
]);

function openaiFastPolicyActionSummary(
  action: OpenAIFastPolicyRule["action"],
) {
  return t(`admin.settings.openaiFastPolicy.summaryAction.${actionREDACTED`);
REDACTED
...
const openaiFastPolicyScopeOptions = computed(() => [
  { value: "all", label: t("admin.settings.openaiFastPolicy.scopeAll") REDACTED,
  { value: "oauth", label: t("admin.settings.openaiFastPolicy.scopeOAuth") REDACTED,
  { value: "apikey", label: t("admin.settings.openaiFastPolicy.scopeAPIKey") REDACTED,
  {
    value: "bedrock",
...
const allPaymentTypes = computed(() => [
  { value: "easypay", label: t("payment.methods.easypay") REDACTED,
...
async function disableProvidersByType(type: string) {
  ...
  for (const p of matching) {
    try {
      await adminAPI.payment.updateProvider(p.id, { enabled: false REDACTED);
      p.enabled = false;
    REDACTED catch (err: unknown) {
...
const providerKeyOptions = computed(() => [
  { value: "easypay", label: t("admin.settings.payment.providerEasypay") REDACTED,
  { value: "alipay", label: t("admin.settings.payment.providerAlipay") REDACTED,
  { value: "wxpay", label: t("admin.settings.payment.providerWxpay") REDACTED,
  { value: "stripe", label: t("admin.settings.payment.providerStripe") REDACTED,
  { value: "airwallex", label: t("admin.settings.payment.providerAirwallex") REDACTED,
]);
...
const cancelRateLimitUnitOptions = computed(() => [
  ...
  REDACTED,
  { value: "hour", label: t("admin.settings.payment.cancelRateLimitUnitHour") REDACTED,
  { value: "day", label: t("admin.settings.payment.cancelRateLimitUnitDay") REDACTED,
]);
...
function getProviderVisibleMethods(
  ...
  if (provider.provider_key === "alipay") {
    ...
    REDACTED else {
      ...
      REDACTED);
    REDACTED
  REDACTED else if (provider.provider_key === "wxpay") {
    if (supportedTypes.length === 0) {
      methods.add("wxpay");
    REDACTED else {
      supportedTypes.forEach((type) => {
      ...
      REDACTED);
    REDACTED
  REDACTED else if (provider.provider_key === "easypay") {
...
): { method: "alipay" | "wxpay"; conflicting: ProviderInstance REDACTED | null {
...
function showProviderEnablementConflict(
  conflict: { method: "alipay" | "wxpay"; conflicting: ProviderInstance REDACTED,
) {
  appStore.showError(
    t("admin.settings.payment.enableConflict", {
      method: t(`payment.methods.${conflict.methodREDACTED`),
...
async function handleToggleField(
  ...
  const payload: Record<string, boolean> = { [field]: newValue REDACTED;
...
async function handleReorderProviders(
  updates: { id: number; sort_order: number REDACTED[],
) {
  try {
    await Promise.all(
      updates.map((u) =>
        ...
        REDACTED as Partial<ProviderInstance>),
      ),
    );
    await loadProviders();
  REDACTED catch (err: unknown) {
...
function debounceTimer(slot: { searchTimer: number | null REDACTED, delayMs: number, run: () => void) {
...
const affiliateModalCanSubmit = computed(() => {
  ...
  REDACTED else if (!affiliateModal.editingEntry) {
    return false;
  REDACTED
...
async function submitAffiliateModal() {
  ...
  const payload: Parameters<typeof affiliatesAPI.updateUserSettings>[1] = {REDACTED;
...
function askResetAffiliateUser(entry: AffiliateAdminEntry) {
  openAffiliateConfirm(
    ...
    t("admin.settings.features.affiliate.customUsers.resetMessage", {
      email: entry.email || `#${entry.user_idREDACTED`,
    REDACTED),
    t("common.delete"),
...
async function submitAffiliateBatchModal() {
  ...
  const payload: Parameters<typeof affiliatesAPI.batchSetRate>[0] =
    rateInput === null
      ? { user_ids: userIDs, clear: true REDACTED
      : { user_ids: userIDs, aff_rebate_rate_percent: rateInput REDACTED;
