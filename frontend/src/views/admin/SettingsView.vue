              ...
              <div v-for="(provider, pIdx) in webSearchConfig.providers" :key="pIdx"
                ...
                >
                  <div class="flex items-center gap-3">
                    ...
                    <span v-if="!expandedProviders[pIdx]" class="text-xs text-gray-400">
                      {{ provider.quota_used ?? 0 REDACTEDREDACTED / {{ provider.quota_limit > 0 ? provider.quota_limit : '∞' REDACTEDREDACTED
                    </span>
                ...
                <div v-if="expandedProviders[pIdx]" class="space-y-3 border-t border-gray-100 px-4 pb-4 pt-3 dark:border-dark-700">
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <span class="text-xs text-gray-500">{{ provider.quota_used ?? 0 REDACTEDREDACTED / {{ provider.quota_limit > 0 ? provider.quota_limit : '∞' REDACTEDREDACTED</span>
                  </div>
