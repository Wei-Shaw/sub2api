          ...
          <div class="flex flex-1 flex-wrap items-center gap-3">
            ...
            >
              ...
              <button
                ...
                type="button"
                class="absolute right-2 top-1/2 -translate-y-1/2 text-ink-tertiary hover:text-ink-secondary"
              ...
              >
                <div
                  ...
                  class="px-4 py-3 text-sm text-ink-secondary"
                >
                  {{ t('common.loading') }}
                </div>
                <div
                ...
                >
                  ...
                  <span class="ml-2 text-ink-secondary">#{{ user.id }}</span>
                </button>
              </div>
            </div>
        ...
        >
          ...
          <template #cell-usage="{ row }">
            <div class="min-w-[280px] space-y-2">
              ...
              >
                <!--
                  "No limit" is the absence of a quota, not a healthy quota, so
                  it stops being a green gradient chip. The glyph carries it.
                -->
          ...
          <template #cell-expires_at="{ value }">
            <div v-if="value">
              ...
              >
                <div v-if="remainingExpiry" class="text-xs text-ink-secondary">
                  {{ remainingExpiry }}
                </div>
              </template>
            </div>
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-ink-secondary transition-colors hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-blue-900/20 dark:hover:text-blue-400"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-ink-secondary transition-colors hover:bg-orange-50 hover:text-orange-600 dark:hover:bg-orange-900/20 dark:hover:text-orange-400 disabled:cursor-not-allowed disabled:opacity-50"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-ink-secondary transition-colors hover:bg-green-50 hover:text-green-600 dark:hover:bg-green-900/20 dark:hover:text-green-400"
              >
                <Icon name="refresh" size="sm" />
        ...
        <div>
          ...
          >
            <template #selected="{ option }">
              ...
              />
              <span v-else class="text-ink-tertiary">{{ t('admin.subscriptions.selectGroup') }}</span>
            </template>
    ...
    >
      ...
      >
        <div class="rounded-lg bg-gray-50 p-4 dark:bg-dark-700">
          ...
          <p v-if="extendingSubscription.expires_at" class="mt-1 text-sm text-ink-secondary">
      ...
      <transition name="modal">
        <div v-if="showGuideModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" @mousedown.self="showGuideModal = false">
          ...
          <div class="relative max-h-[85vh] w-full max-w-2xl overflow-y-auto rounded-xl bg-white p-6 shadow-2xl dark:bg-dark-800">
            ...
            <p class="mb-5 text-sm text-ink-secondary">{{ t('admin.subscriptions.guide.subtitle') }}</p>
...
.usage-label {
  @apply w-10 flex-shrink-0 text-xs font-medium text-ink-secondary;
}

.usage-amount {
  @apply whitespace-nowrap text-xs tabular-nums text-ink-secondary;
}

.reset-info {
  @apply flex items-center gap-1 pl-12 text-[10px] text-info;
}
</style>
