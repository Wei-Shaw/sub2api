...
const handleRankingSelectUser = (userId: number, email: string) => {
  filters.value = { ...filters.value, user_id: userId REDACTED
...
const detailTabs = computed(() => [
  { key: 'usage' as const, label: t('usage.tabs.usage'), icon: 'document' as const REDACTED,
  { key: 'errors' as const, label: t('usage.tabs.errors'), icon: 'exclamationTriangle' as const REDACTED,
  { key: 'ranking' as const, label: t('usage.tabs.ranking'), icon: 'chart' as const REDACTED,
])
