...
const routeSearchQuery = Array.isArray(route.query.search) ? route.query.search[0] : route.query.search
const searchQuery = ref(typeof routeSearchQuery === 'string' ? routeSearchQuery.slice(0, 100) : '')
