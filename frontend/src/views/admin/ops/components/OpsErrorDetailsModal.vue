...
import { opsAPI, type OpsErrorLog REDACTED from '@/api/admin/ops'
import { buildOpsErrorTimeParams REDACTED from '../utils/opsErrorParams'
...
const viewModeSelectOptions = computed(() => {
  return [
    { value: 'errors', label: t('admin.ops.errorDetails.viewErrors') || 'errors' REDACTED,
    { value: 'excluded', label: t('admin.ops.errorDetails.viewExcluded') || 'excluded' REDACTED,
...
const phaseSelectOptions = computed(() => {
  const options = [
    ...
    { value: 'account_auth', label: t('admin.ops.errorDetails.phase.account_auth') || 'account_auth' REDACTED,
    ...
    <div class="flex h-full min-h-0 flex-col">
      ...
      <div class="flex min-h-0 flex-1 flex-col">
        <div class="mb-2 flex-shrink-0 text-xs text-gray-500 dark:text-gray-400">
          {{ t('admin.ops.errorDetails.total') REDACTEDREDACTED {{ total REDACTEDREDACTED
        </div>
