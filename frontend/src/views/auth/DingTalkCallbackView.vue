        ...
        >
          ...
          <template v-if="needsInvitation">
            ...
            <div class="space-y-3">
              ...
              >
                {{ t('auth.dingtalk.completeRegistration') }}
              </Button>
            </div>
          </template>
          ...
          <template v-else-if="needsBindLogin">
            ...
            -->
            <div class="space-y-3">
              <FormField id="dingtalk-bind-login-email" :label="t('auth.emailLabel')">
              ...
              <FormField id="dingtalk-bind-login-password" :label="t('auth.passwordLabel')">
                <template #default="{ describedBy }">
                  <input
          ...
          <template v-else-if="needsTotpChallenge">
            ...
            <div class="space-y-3">
              <FormField id="dingtalk-bind-login-totp" :label="t('auth.verificationCode')">
                <template #default="{ describedBy }">
                  <input
