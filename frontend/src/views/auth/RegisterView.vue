    ...
    <div class="space-y-6">
      ...
      <form v-else @submit.prevent="handleRegister" class="space-y-5">
        ...
        <div v-if="invitationCodeEnabled">
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="key" size="md" :class="invitationValidation.valid ? 'text-gray-500' : 'text-gray-400 dark:text-dark-500'" />
            </div>
            <input
              id="invitation_code"
              ...
              :class="{
                'border-gray-500 focus:border-gray-500 focus:ring-gray-500': invitationValidation.valid,
            ...
            <div v-else-if="invitationValidation.valid" class="absolute inset-y-0 right-0 flex items-center pr-3.5">
              <Icon name="checkCircle" size="md" class="text-gray-500" />
            </div>
          ...
          <transition name="fade">
            <div v-if="invitationValidation.valid" class="mt-2 flex items-center gap-2 rounded-lg bg-gray-50 px-3 py-2 dark:bg-gray-900/20">
              <Icon name="checkCircle" size="sm" class="text-gray-600 dark:text-gray-400" />
        ...
        <div v-if="promoCodeEnabled">
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="gift" size="md" :class="promoValidation.valid ? 'text-gray-500' : 'text-gray-400 dark:text-dark-500'" />
            </div>
            <input
              id="promo_code"
              ...
              class="input pl-11 pr-10"
              :class="{
                'border-gray-500 focus:border-gray-500 focus:ring-gray-500': promoValidation.valid,
