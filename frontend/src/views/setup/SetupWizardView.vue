  ...
  >
    <div class="w-full max-w-2xl">
      ...
      <div class="mb-8 text-center">
        ...
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">{{ t('setup.title') REDACTEDREDACTED</h1>
        <p class="mt-2 text-gray-500 dark:text-dark-400">{{ t('setup.description') REDACTEDREDACTED</p>
      </div>
            ...
            <div class="flex items-center">
              ...
              >
                <Icon
                  ...
                  :stroke-width="2"
                />
                <span v-else>{{ index + 1 REDACTEDREDACTED</span>
              </div>
              <span
      ...
      <div class="rounded-2xl bg-white p-8 shadow-xl dark:bg-dark-800">
        ...
        <div v-if="currentStep === 0" class="space-y-6">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label class="input-label">{{ t('setup.database.host') REDACTEDREDACTED</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t('setup.database.port') REDACTEDREDACTED</label>
              <input
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label class="input-label">{{ t('setup.database.username') REDACTEDREDACTED</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t('setup.database.password') REDACTEDREDACTED</label>
              <input
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label class="input-label">{{ t('setup.database.databaseName') REDACTEDREDACTED</label>
              <input
        ...
        <div v-if="currentStep === 1" class="space-y-6">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label class="input-label">{{ t('setup.redis.host') REDACTEDREDACTED</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t('setup.redis.port') REDACTEDREDACTED</label>
              <input
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label class="input-label">{{ t('setup.redis.username') REDACTEDREDACTED</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t('setup.redis.password') REDACTEDREDACTED</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t('setup.redis.database') REDACTEDREDACTED</label>
              <input
        ...
        <div v-if="currentStep === 2" class="space-y-6">
          ...
          <div>
            <label class="input-label">{{ t('setup.admin.email') REDACTEDREDACTED</label>
            <input
          ...
          <div>
            <label class="input-label">{{ t('setup.admin.password') REDACTEDREDACTED</label>
            <input
          ...
          <div>
            <label class="input-label">{{ t('setup.admin.confirmPassword') REDACTEDREDACTED</label>
            <input
            ...
            >
              {{ t('setup.admin.passwordMismatch') REDACTEDREDACTED
            </p>
          </div>
        </div>
          ...
          <div class="space-y-4">
            <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-700">
              <h3 class="mb-2 text-sm font-medium text-gray-500 dark:text-dark-400">
                {{ t('setup.ready.database') REDACTEDREDACTED
              </h3>
              <p class="text-gray-900 dark:text-white">
                {{ formData.database.user REDACTEDREDACTED@{{ formData.database.host REDACTEDREDACTED:{{
                  formData.database.port
                REDACTEDREDACTED/{{ formData.database.dbname REDACTEDREDACTED
              </p>
            </div>

            <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-700">
              <h3 class="mb-2 text-sm font-medium text-gray-500 dark:text-dark-400">
                {{ t('setup.ready.redis') REDACTEDREDACTED
              </h3>
              <p class="text-gray-900 dark:text-white">
                {{ formData.redis.host REDACTEDREDACTED:{{ formData.redis.port REDACTEDREDACTED
              </p>
            </div>

            <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-700">
              <h3 class="mb-2 text-sm font-medium text-gray-500 dark:text-dark-400">
                {{ t('setup.ready.adminEmail') REDACTEDREDACTED
              </h3>
              <p class="text-gray-900 dark:text-white">{{ formData.admin.email REDACTEDREDACTED</p>
            </div>
          </div>
        </div>
...
async function testDatabaseConnection() {
  ...
  REDACTED catch (error: unknown) {
    const err = error as { response?: { data?: { detail?: string; message?: string REDACTED REDACTED; message?: string REDACTED
    errorMessage.value =
