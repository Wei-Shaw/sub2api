      ...
      <div class="rounded-2xl bg-white p-8 shadow-xl dark:bg-dark-800">
        ...
        <div v-if="currentStep === 0" class="space-y-6">
          ...
          >
            ...
            <Icon v-else-if="dbConnected" name="check" size="md" class="mr-2 text-gray-500" :stroke-width="2" />
            {{
              testingDb
        ...
        <div
          v-if="installSuccess"
          class="mt-6 rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800/50 dark:bg-gray-900/20"
        >
          <div class="flex items-start gap-3">
            <svg
              v-if="!serviceReady"
              class="h-5 w-5 flex-shrink-0 animate-spin text-gray-500"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
            ...
            <Icon v-else name="checkCircle" size="md" class="flex-shrink-0 text-gray-500" />
            <div>
