...
const inviteLink = computed(() => {
  ...
  if (typeof window === 'undefined') return `/login?ref=${encodeURIComponent(detail.value.aff_code)}`
  return `${window.location.origin}/login?ref=${encodeURIComponent(detail.value.aff_code)}`
})
