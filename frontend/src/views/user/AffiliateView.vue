        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div class="card p-5">
            <p class="flex items-center gap-1.5 text-sm text-gray-500 dark:text-dark-400">
              ...
              {{ t('affiliate.stats.rebateRate') REDACTEDREDACTED
            </p>
            <p class="mt-2 text-2xl font-semibold text-primary-600 dark:text-primary-400">
              {{ formattedRebateRate REDACTEDREDACTED<span class="ml-0.5 text-base font-medium">%</span>
            </p>
            <p class="mt-1 text-xs text-gray-400 dark:text-dark-500">
              {{ t('affiliate.stats.rebateRateHint') REDACTEDREDACTED
            </p>
          </div>
          <div class="card p-5">
          ...
          <div class="card p-5">
            ...
            <p v-if="detail.aff_frozen_quota > 0" class="mt-1 text-xs text-amber-600 dark:text-amber-400">
              {{ t('affiliate.stats.frozenQuota') REDACTEDREDACTED: {{ formatCurrency(detail.aff_frozen_quota) REDACTEDREDACTED
            </p>
          </div>
        </div>
        ...
        <div class="card p-6">
          ...
          <div class="mt-5 grid gap-4 md:grid-cols-2">
            <div class="space-y-2">
              ...
              <div class="flex flex-col items-stretch gap-2 rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 dark:border-dark-700 dark:bg-dark-900 sm:flex-row sm:items-center">
                <code class="min-w-0 break-all text-sm font-semibold text-gray-900 dark:text-white sm:flex-1 sm:truncate">{{ detail.aff_code REDACTEDREDACTED</code>
            ...
            <div class="space-y-2">
              ...
              <div class="flex flex-col items-stretch gap-2 rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 dark:border-dark-700 dark:bg-dark-900 sm:flex-row sm:items-center">
                <code class="min-w-0 break-all text-sm text-gray-700 dark:text-gray-300 sm:flex-1 sm:truncate">{{ inviteLink REDACTEDREDACTED</code>
          ...
          <div class="mt-5 rounded-xl border border-primary-200 bg-primary-50 p-4 dark:border-primary-900/40 dark:bg-primary-900/20">
            ...
            <ul class="mt-2 space-y-1 text-sm text-primary-700 dark:text-primary-300">
              ...
              <li>2. {{ t('affiliate.tips.line2', { rate: `${formattedRebateRateREDACTED%` REDACTED) REDACTEDREDACTED</li>
              <li>3. {{ t('affiliate.tips.line3') REDACTEDREDACTED</li>
              <li v-if="detail.aff_frozen_quota > 0">4. {{ t('affiliate.tips.line4') REDACTEDREDACTED</li>
            </ul>
          </div>
        </div>
            ...
            <table class="w-full min-w-[560px] text-left text-sm">
              <thead>
                <tr class="border-b border-gray-200 text-gray-500 dark:border-dark-700 dark:text-dark-400">
                  ...
                  <th class="px-3 py-2 font-medium text-right">{{ t('affiliate.invitees.columns.rebate') REDACTEDREDACTED</th>
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="px-3 py-3 text-right font-medium text-emerald-600 dark:text-emerald-400">{{ formatCurrency(item.total_rebate) REDACTEDREDACTED</td>
