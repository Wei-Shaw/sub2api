...
import userChannelsAPI, { type UserAvailableChannel REDACTED from '@/api/channels'
...
const columns = computed(() => [
  { key: 'name', label: t('availableChannels.columns.name') REDACTED,
  { key: 'groups', label: t('availableChannels.columns.groups') REDACTED,
  { key: 'supported_models', label: t('availableChannels.columns.supportedModels') REDACTED
])
