...
.toc-close-btn {
  @apply p-1 rounded text-gray-400 hover:text-gray-600 dark:hover:text-slate-200 hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors;
}
...
.toc-item {
  ...
  @apply text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200 dark:hover:bg-slate-600;
}
...
.toc-toggle-btn {
  ...
  @apply text-gray-600 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-600;
...
.custom-open-fab {
  ...
  @apply shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/80 dark:supports-[backdrop-filter]:bg-slate-800/80;
}
