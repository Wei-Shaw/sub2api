...
import { ref, computed, onMounted REDACTED from 'vue'; import { useAuthStore REDACTED from '@/stores/auth'; import { usageAPI, type UserDashboardStats as UserStatsType REDACTED from '@/api/usage'
import AppLayout from '@/components/layout/AppLayout.vue'; import LoadingSpinner from '@/components/common/LoadingSpinner.vue'
import UserDashboardStats from '@/components/user/dashboard/UserDashboardStats.vue'; import UserDashboardCharts from '@/components/user/dashboard/UserDashboardCharts.vue'
import UserDashboardRecentUsage from '@/components/user/dashboard/UserDashboardRecentUsage.vue'; import UserDashboardQuickActions from '@/components/user/dashboard/UserDashboardQuickActions.vue'
import type { UsageLog, TrendDataPoint, ModelStat, PlatformQuotaItem REDACTED from '@/types'
import { getMyPlatformQuotas REDACTED from '@/api/user'
import { formatDateLocalInput REDACTED from '@/utils/format'
...
const loadPlatformQuotas = async () => { try { const data = await getMyPlatformQuotas(); platformQuotas.value = data.platform_quotas ?? [] REDACTED catch (error) { console.warn('Failed to load platform quotas:', error); platformQuotas.value = [] REDACTED REDACTED
const refreshAll = () => { loadStats(); loadCharts(); loadRecent(); loadPlatformQuotas() REDACTED

onMounted(() => { refreshAll() REDACTED)
</script>
