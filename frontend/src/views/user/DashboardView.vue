      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.balance') REDACTEDREDACTED</p>
                <p class="text-xl font-bold text-emerald-600 dark:text-emerald-400">${{ formatBalance(user?.balance || 0) REDACTEDREDACTED</p>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.apiKeys') REDACTEDREDACTED</p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">{{ stats.total_api_keys REDACTEDREDACTED</p>
                <p class="text-xs text-green-600 dark:text-green-400">{{ stats.active_api_keys REDACTEDREDACTED {{ t('common.active') REDACTEDREDACTED</p>
              </div>
            </div>
          </div>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.todayRequests') REDACTEDREDACTED</p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">{{ stats.today_requests REDACTEDREDACTED</p>
                <p class="text-xs text-gray-500 dark:text-gray-400">{{ t('common.total') REDACTEDREDACTED: {{ formatNumber(stats.total_requests) REDACTEDREDACTED</p>
              </div>
            </div>
          </div>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.todayCost') REDACTEDREDACTED</p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">
                  <span class="text-purple-600 dark:text-purple-400" :title="t('dashboard.actual')">${{ formatCost(stats.today_actual_cost) REDACTEDREDACTED</span>
                  <span class="text-sm font-normal text-gray-400 dark:text-gray-500" :title="t('dashboard.standard')"> / ${{ formatCost(stats.today_cost) REDACTEDREDACTED</span>
                </p>
                <p class="text-xs">
                  <span class="text-gray-500 dark:text-gray-400">{{ t('common.total') REDACTEDREDACTED: </span>
                  <span class="text-purple-600 dark:text-purple-400" :title="t('dashboard.actual')">${{ formatCost(stats.total_actual_cost) REDACTEDREDACTED</span>
                  <span class="text-gray-400 dark:text-gray-500" :title="t('dashboard.standard')"> / ${{ formatCost(stats.total_cost) REDACTEDREDACTED</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xl font-bold text-gray-900 dark:text-white">{{ formatTokens(stats.today_tokens) REDACTEDREDACTED</p>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.input') REDACTEDREDACTED: {{ formatTokens(stats.today_input_tokens) REDACTEDREDACTED / {{ t('dashboard.output') REDACTEDREDACTED: {{ formatTokens(stats.today_output_tokens) REDACTEDREDACTED
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xl font-bold text-gray-900 dark:text-white">{{ formatTokens(stats.total_tokens) REDACTEDREDACTED</p>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.input') REDACTEDREDACTED: {{ formatTokens(stats.total_input_tokens) REDACTEDREDACTED / {{ t('dashboard.output') REDACTEDREDACTED: {{ formatTokens(stats.total_output_tokens) REDACTEDREDACTED
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.cacheToday') REDACTEDREDACTED</p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">{{ formatTokens(stats.today_cache_read_tokens) REDACTEDREDACTED</p>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('common.create') REDACTEDREDACTED: {{ formatTokens(stats.today_cache_creation_tokens) REDACTEDREDACTED
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.avgResponse') REDACTEDREDACTED</p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">{{ formatDuration(stats.average_duration_ms) REDACTEDREDACTED</p>
                <p class="text-xs text-gray-500 dark:text-gray-400">{{ t('dashboard.averageTime') REDACTEDREDACTED</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-6">
          ...
          <div class="card p-4">
            <div class="flex flex-wrap items-center gap-4">
              <div class="flex items-center gap-2">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('dashboard.timeRange') REDACTEDREDACTED:</span>
                <DateRangePicker
              ...
              <div class="flex items-center gap-2 ml-auto">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('dashboard.granularity') REDACTEDREDACTED:</span>
                <div class="w-28">
                  <Select
                    v-model="granularity"
          ...
          <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div class="card p-4">
              <h3 class="text-sm font-semibold text-gray-900 dark:text-white mb-4">{{ t('dashboard.modelDistribution') REDACTEDREDACTED</h3>
                  ...
                  <table class="w-full text-xs">
                    <thead>
                      <tr class="text-gray-500 dark:text-gray-400">
                        <th class="text-left pb-2">{{ t('dashboard.model') REDACTEDREDACTED</th>
                        <th class="text-right pb-2">{{ t('dashboard.requests') REDACTEDREDACTED</th>
                        <th class="text-right pb-2">{{ t('dashboard.tokens') REDACTEDREDACTED</th>
                        <th class="text-right pb-2">{{ t('dashboard.actual') REDACTEDREDACTED</th>
                        <th class="text-right pb-2">{{ t('dashboard.standard') REDACTEDREDACTED</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr v-for="model in modelStats" :key="model.model" class="border-t border-gray-100 dark:border-gray-700">
                        <td class="py-1.5 text-gray-900 dark:text-white font-medium truncate max-w-[100px]" :title="model.model">{{ model.model REDACTEDREDACTED</td>
                        <td class="py-1.5 text-right text-gray-600 dark:text-gray-400">{{ formatNumber(model.requests) REDACTEDREDACTED</td>
                        <td class="py-1.5 text-right text-gray-600 dark:text-gray-400">{{ formatTokens(model.total_tokens) REDACTEDREDACTED</td>
                        <td class="py-1.5 text-right text-green-600 dark:text-green-400">${{ formatCost(model.actual_cost) REDACTEDREDACTED</td>
                        <td class="py-1.5 text-right text-gray-400 dark:text-gray-500">${{ formatCost(model.cost) REDACTEDREDACTED</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div class="card p-4">
              <h3 class="text-sm font-semibold text-gray-900 dark:text-white mb-4">{{ t('dashboard.tokenUsageTrend') REDACTEDREDACTED</h3>
              <div class="h-48">
          ...
          <div class="lg:col-span-2">
            <div class="card">
              <div class="px-6 py-4 border-b border-gray-100 dark:border-dark-700 flex items-center justify-between">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('dashboard.recentUsage') REDACTEDREDACTED</h2>
                ...
                <div v-else class="space-y-3">
                  ...
                  >
                    <div class="flex items-center gap-4">
                      ...
                      <div>
                        <p class="text-sm font-medium text-gray-900 dark:text-white">{{ log.model REDACTEDREDACTED</p>
                    ...
                    <div class="text-right">
                      <p class="text-sm font-semibold">
                        <span class="text-green-600 dark:text-green-400" title="实际扣除">${{ formatCost(log.actual_cost) REDACTEDREDACTED</span>
                        <span class="text-gray-400 dark:text-gray-500 font-normal" title="标准计费"> / ${{ formatCost(log.total_cost) REDACTEDREDACTED</span>
                      </p>
                      <p class="text-xs text-gray-500 dark:text-dark-400">
          ...
          <div class="lg:col-span-1">
            <div class="card">
              <div class="px-6 py-4 border-b border-gray-100 dark:border-dark-700">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('dashboard.quickActions') REDACTEDREDACTED</h2>
              </div>
              <div class="p-4 space-y-3">
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-gray-900 dark:text-white">{{ t('dashboard.createApiKey') REDACTEDREDACTED</p>
                    <p class="text-xs text-gray-500 dark:text-dark-400">{{ t('dashboard.generateNewKey') REDACTEDREDACTED</p>
                  </div>
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-gray-900 dark:text-white">{{ t('dashboard.viewUsage') REDACTEDREDACTED</p>
                    <p class="text-xs text-gray-500 dark:text-dark-400">{{ t('dashboard.checkDetailedLogs') REDACTEDREDACTED</p>
                  </div>
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-gray-900 dark:text-white">{{ t('dashboard.redeemCode') REDACTEDREDACTED</p>
                    <p class="text-xs text-gray-500 dark:text-dark-400">{{ t('dashboard.addBalanceWithCode') REDACTEDREDACTED</p>
                  </div>
