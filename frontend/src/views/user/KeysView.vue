          ...
          <template #cell-group="{ row REDACTED">
            <div class="relative group/dropdown">
              ...
              >
                ...
                />
                <span v-else class="text-sm text-gray-400 dark:text-dark-500">{{ t('keys.noGroup') REDACTEDREDACTED</span>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-5">
        ...
        <div class="flex justify-end gap-3 pt-4">
          ...
          >
            ...
            {{ submitting ? t('keys.saving') : (showEditModal ? t('common.update') : t('common.create')) REDACTEDREDACTED
          </button>
        </div>
      </form>
    </Modal>
