                  ...
                  <aside class="space-y-5 lg:sticky lg:top-6 lg:self-start">
                    <section class="rounded-2xl border border-blue-100 bg-white p-5 shadow-lg shadow-blue-900/10 dark:border-slate-700 dark:bg-slate-900">
                      ...
                      <div class="mt-3 flex items-end gap-1">
                        <span class="text-5xl font-bold tracking-normal text-blue-600">{{ formatSelectedPaymentAmount(totalAmount) }}</span>
                      </div>
                      ...
                      <div class="space-y-3 text-sm">
                        <div class="flex items-center justify-between">
                          ...
                          <span class="font-medium text-slate-900 dark:text-white">{{ formatSelectedPaymentAmount(validAmount) }}</span>
                        </div>
                        <div v-if="feeRate > 0" class="flex items-center justify-between">
                          ...
                          <span class="font-medium text-slate-900 dark:text-white">{{ formatSelectedPaymentAmount(feeAmount) }}</span>
                        </div>
...
const rechargeHeaderBadge = computed(() => {
  ...
  return maxPackageAmount > 0 ? `最高 ${formatSelectedPaymentAmount(maxPackageAmount)}` : '套餐配置'
})
