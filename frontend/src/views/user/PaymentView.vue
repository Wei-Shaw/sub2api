...
const amountError = computed(() => {
  ...
  if (ml) {
    if (ml.single_min > 0 && validAmount.value < ml.single_min) return t('payment.amountTooLow', { min: ml.single_min REDACTED)
    if (ml.single_max > 0 && validAmount.value > ml.single_max) return t('payment.amountTooHigh', { max: ml.single_max REDACTED)
  REDACTED
  return ''
REDACTED)
