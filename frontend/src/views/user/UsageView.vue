...
const errorFilter = ref<{ model: string; category: string; api_key_id: number | null REDACTED>({
  model: '',
  category: '',
  api_key_id: null,
REDACTED)
...
const onErrorFilter = (filter: { model: string; category: string; api_key_id: number | null REDACTED) => {
