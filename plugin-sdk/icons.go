...
const (
	...
	// IconTag is a placeholder. We do not currently ship verified Heroicons
	// path data for "tag" outline; populate it once the path is copied from a
	// trusted source, otherwise plugins should fall back to IconPuzzle.
	//
	// TODO(plugin-sdk): supply the verified outline-tag path data from the
	// Heroicons project (tailwindlabs/heroicons) and remove the empty value.
	IconTag = ""
)
