/**
 * English i18n — `admin.channels.*` namespace (channel CRUD + pricing form).
 *
...
export default {
  ...
  emptyModelsInPricing: 'A pricing entry under {platform} has no models. Please add models or remove the entry.',
  unnamedModelLabel: 'unnamed',
  intervalError: '{platform} - {model}: {error}',
