/**
 * OpenAI WebSocket mode constants and utilities.
 * Inlined from host @/utils/openaiWsMode to avoid host-internal imports.
 */
...
function normalizeOpenAIWSMode(mode: unknown): OpenAIWSMode | null {
...
function openAIWSModeFromEnabled(enabled: unknown): OpenAIWSMode | null {
