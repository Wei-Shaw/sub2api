...
func (_q *PaymentAuditLogQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *PaymentAuditLogQuery) FirstIDX(ctx context.Context) int {
...
func (_q *PaymentAuditLogQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *PaymentAuditLogQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *PaymentAuditLogQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *PaymentAuditLogQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PaymentAuditLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(paymentauditlog.Table, paymentauditlog.Columns, sqlgraph.NewFieldSpec(paymentauditlog.FieldID, field.TypeInt))
	_spec.From = _q.sql
