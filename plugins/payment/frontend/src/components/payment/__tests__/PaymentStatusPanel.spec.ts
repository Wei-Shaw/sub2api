 ...
 *
 * The original spec (PaymentStatusPanel.spec.ts) was copied from the host frontend during the
...
describe.skip('PaymentStatusPanel.spec.ts (migration placeholder)', () => {
