 ...
 *
 * The original spec (paymentWechatResume.spec.ts) was copied from the host frontend during the
...
describe.skip('paymentWechatResume.spec.ts (migration placeholder)', () => {
