...
//     via pluginsdk.RequestMeta() rather than core JWT context
//   - service injection wired in plugin.go after services move out of WIP
// Build tag is removed once handler+service migration completes.
