...
node scripts/sub2api-admin.js accounts bulk-update --ids 40,39 --json '{"concurrency":10REDACTED'
node scripts/sub2api-admin.js redeem-codes list --page-size 20
node scripts/sub2api-admin.js redeem-codes generate --json '{"count":1,"type":"balance","value":10REDACTED' --idempotency-key redeem-$(date +%s)
node scripts/sub2api-admin.js redeem-codes create-and-redeem --json '{"code":"order_123","type":"balance","value":10,"user_id":123REDACTED' --idempotency-key order-123
